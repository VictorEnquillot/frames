...
let elementary_context_databox_skeletondata_symbol_off_elementary_context_symbol sym_eco = 
  let sym_ecd = elementary_context_databox_symbol_off_elementary_context_symbol sym_eco in
    Elementary_context_databox_symbol_v.elementary_context_databox_skeletondata_symbol_off_elementary_context_databox_symbol sym_ecd
;;

let elementary_context_databox_figuredata_symbol_off_elementary_context_symbol sym_eco = 
  let sym_ecd = elementary_context_databox_symbol_off_elementary_context_symbol sym_eco in
    Elementary_context_databox_symbol_v.elementary_context_databox_figuredata_symbol_off_elementary_context_databox_symbol sym_ecd
;;
...
let is_elementary_context_databox_skeletondata_constructor sym_eco =
  if not (is_elementary_context_databox_symbol_off_elementary_context_symbol sym_eco)
  then false
  else
    begin
      let sym_ecd = elementary_context_databox_symbol_off_elementary_context_symbol sym_eco in
      Elementary_context_databox_symbol_v.is_elementary_context_databox_skeletondata_constructor sym_ecd
    end
;;

let is_elementary_context_databox_figuredata_constructor sym_eco =
  if not (is_elementary_context_databox_symbol_off_elementary_context_symbol sym_eco)
  then false
  else
    begin
      let sym_ecd = elementary_context_databox_symbol_off_elementary_context_symbol sym_eco in
      Elementary_context_databox_symbol_v.is_elementary_context_databox_figuredata_constructor sym_ecd
    end
;;
...
let is_elementary_context_databox_skeletondata_symbol_off_elementary_context_symbol sym_eco =
  if not (is_elementary_context_databox_symbol_off_elementary_context_symbol sym_eco)
  then false
  else
    begin
  let sym_ecd = elementary_context_databox_symbol_off_elementary_context_symbol sym_eco in
  Elementary_context_databox_symbol_v.is_elementary_context_databox_skeletondata_symbol_off_elementary_context_databox_symbol sym_ecd
    end
;;

let is_elementary_context_databox_figuredata_symbol_off_elementary_context_symbol sym_eco =
  if not (is_elementary_context_databox_symbol_off_elementary_context_symbol sym_eco)
  then false
  else
    begin
  let sym_ecd = elementary_context_databox_symbol_off_elementary_context_symbol sym_eco in
  Elementary_context_databox_symbol_v.is_elementary_context_databox_figuredata_symbol_off_elementary_context_databox_symbol sym_ecd
    end
;;
...
let elementary_context_symbol_of_elementary_context_databox_skeletondata_symbol sym_eds = 
  let sym_ecd = Elementary_context_databox_symbol_v.elementary_context_databox_symbol_of_elementary_context_databox_skeletondata_symbol sym_eds in
    elementary_context_symbol_of_elementary_context_databox_symbol sym_ecd
;;

let elementary_context_symbol_of_elementary_context_databox_figuredata_symbol sym_edf = 
  let sym_ecd = Elementary_context_databox_symbol_v.elementary_context_databox_symbol_of_elementary_context_databox_figuredata_symbol sym_edf in
    elementary_context_symbol_of_elementary_context_databox_symbol sym_ecd
;;
...
let elementary_context_databox_skeletondata_constructor s = elementary_context_symbol_of_elementary_context_databox_symbol (Elementary_context_databox_symbol_v.elementary_context_databox_skeletondata_constructor s);;

let elementary_context_databox_figuredata_constructor s = elementary_context_symbol_of_elementary_context_databox_symbol (Elementary_context_databox_symbol_v.elementary_context_databox_figuredata_constructor s);;
...
(** Elementary_context_symbol_v at 11:52:22 on 9 May 2016. created by version v2.4 of generator *)
