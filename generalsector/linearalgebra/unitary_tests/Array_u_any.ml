...
let psi_m = Array1_v.pair_tensor_of_array_of_array str_a int_a;;
let tr_psi_m = Array2_v.transposed psi_m;;

let pis_a = Array1_v.pair_array_of_array_of_array int_a str_a ;;
let pis_m = Array1_v.pair_tensor_of_array_of_array int_a str_a ;;
...
test_number 7 (
Arr_v.sum_fun_on_i (fun x -> 2. *. x) [|1.; 2.|] 
= 
6.0
);;
