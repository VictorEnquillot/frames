...
testing "Segment_buried Symbol Implementation Extracting Caml_paragraph_value_v";;

(* toplevel 
   #use "tsegment_buried_symbol_implementation_extracting_caml_paragraph_value_v.ml";; 
 *)

let nam_cod = "tsegment_buried_symbol_implementation_extracting_caml_paragraph_value_v.ml";; 
...
[Entity_symbol_t.Entity_proper_symbol
  (Entity_symbol_t.Entity_local_symbol "segment_buried_regular");
 Entity_symbol_t.Entity_proper_symbol
...
[Constructor_symbol_t.Constructor_proper_symbol
  (Constructor_symbol_t.Constructor_several_symbol "segment_buried_regular");
 Constructor_symbol_t.Constructor_proper_symbol
...
[(Entitycategorycodefile_t.Ens_t.Entity_proper_symbol
   (Entitycategorycodefile_t.Ens_t.Entity_local_symbol "segment_buried_regular"),
...
[(Entitycategorysuffix_t.Ens_t.Entity_proper_symbol
   (Entitycategorysuffix_t.Ens_t.Entity_local_symbol "segment_buried_regular"),
...
(* : string *)
= 
"segment_buried_symbol_typing_type_definition_t.ml"
);;
...
["type segment_buried_symbol =";
 "  | Segment_buried_regular_symbol of Prs_t.segment_buried_regular_symbol";
