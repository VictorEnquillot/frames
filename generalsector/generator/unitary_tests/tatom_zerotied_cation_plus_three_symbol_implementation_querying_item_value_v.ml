...
testing "Atom_zerotied_cation_plus_three Symbol Implementation Querying Item_value_v";;

(* toplevel 
   #use "tatom_zerotied_cation_plus_three_symbol_implementation_querying_item_value_v.ml";; 
 *)
...
(** smb_cpg is hinted from ctt_cpg through the tag
    ...
    2 -> function
*)
let nam_cod = "tatom_zerotied_cation_plus_three_symbol_implementation_querying_item_value_v.ml";; 
...
(* : string *)
= 
"atom_zerotied_cation_plus_three_symbol_querying_v.ml"
);;
...
(* : Item_value_t.item_value *)
  =
Item_value_t.Tre_t.Leaf ["(** {6 Querying.} *)"]
);;
