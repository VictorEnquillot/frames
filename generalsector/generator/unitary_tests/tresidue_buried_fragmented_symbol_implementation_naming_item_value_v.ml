...
testing "Residue_buried_fragmented Symbol Implementation Naming Item_value_v";;
...
(** smb_cpg is hinted from ctt_cpg through the tag
    ...
    2 -> function
*)
let nam_cod = "tresidue_buried_fragmented_symbol_implementation_naming_item_value_v.ml";; 
...
(* : string *)
= 
"residue_buried_fragmented_symbol_naming_v.ml"
);;
