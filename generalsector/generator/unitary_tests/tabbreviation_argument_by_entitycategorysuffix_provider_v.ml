...
testing "Abbreviation_argument_by_entitycategorysuffix_provider_v";;
...
let abb_atm = Aaecsp_v.provide ecs_atm;;
let abb_pde = Aaecsp_v.provide ecs_pde;;
let abb_prg = Aaecsp_v.provide ecs_prg;;
let abb_pgn = Aaecsp_v.provide ecs_pgn;;
let abb_ppn = Aaecsp_v.provide ecs_ppn;;
let abb_str = Aaecsp_v.provide ecs_str;;
let abb_f_s = Aaecsp_v.provide ecs_f_s;;
