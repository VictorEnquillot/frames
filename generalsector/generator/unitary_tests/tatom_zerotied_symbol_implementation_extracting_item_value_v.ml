...
testing "Atom_zerotied Symbol Implementation Extracting Item_value_v";;
...
(** smb_cpg is hinted from ctt_cpg through the tag
    ...
    2 -> function
*)
let nam_cod = "tatom_zerotied_symbol_implementation_extracting_item_value_v.ml";; 
...
(* : string *)
= 
"atom_zerotied_symbol_extracting_v.ml"
);;
