...
(* toplevel 
   #use "tlet_s_off_t_function_caml_line_formula_v.ml";; 
 *)
...
let smb_cli_fun = Cls_v.let_s_off_t_function;;
let kyl_cli_fun = ("caml_line", Cls_v.name smb_cli_fun) :: kyl_cpg_fun;;
...
let frm_cli_fun = Clf_v.retrieve pth_cnt_atw kyl_cli_fun;;
