...
testing "Atom_onetied_conjugated Constructor_tag_tree_v";;

(* toplevel 
   #use "tatom_onetied_conjugated_constructor_tag_tree_v.ml";; 
 *)
...
Tree_t.Node
 ...
 [Tree_t.Leaf
   (Constructor_symbol_t.Constructor_fictive_symbol
     (Constructor_symbol_t.Constructor_bare_symbol "o_c"))])
);;
