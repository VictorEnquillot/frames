...
testing "Atom_zerotied_cation_plus_three Symbol Implementation Typing Item_value_v";;
...
(** smb_cpg is hinted from ctt_cpg through the tag
    ...
    2 -> function
*)
let nam_cod = "tatom_zerotied_cation_plus_three_symbol_implementation_typing_item_value_v.ml";; 
...
([(Caml_paragraph_context_t.Cnp_t.Cnm_t.Cns_t.Constructor_proper_symbol
   ...
   [1])],
 [("item", "typing"); ("codefile", "implementation");
...
(* : string *)
= 
"atom_zerotied_cation_plus_three_symbol_typing_v.ml"
);;
...
(* : Item_value_t.item_value *)
  =
Item_value_t.Tre_t.Leaf ["(** {6 Typing.} *)"]
);;
