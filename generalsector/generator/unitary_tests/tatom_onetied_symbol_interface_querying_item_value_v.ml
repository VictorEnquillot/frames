...
testing "Atom_onetied Symbol Interface Querying Item_value_v";;

(* toplevel 
   #use "tatom_onetied_symbol_interface_querying_item_value_v.ml";; 
 *)

let nam_cod = "tatom_onetied_symbol_interface_querying_item_value_v.ml";; 
 ...
 [Item_value_t.Tre_t.Inner ([],
   [Item_value_t.Tre_t.Leaf
     ["val is_atom_onetied_symbol_off_atom_onetied_conjugated_symbol :";
      "  Atom_onetied_symbol_t.atom_onetied_symbol ->"; "    bool"; 
      ";;"];
    Item_value_t.Tre_t.Leaf
...
(* : string *)
= 
"atom_onetied_symbol_querying_v.mli"
);;
