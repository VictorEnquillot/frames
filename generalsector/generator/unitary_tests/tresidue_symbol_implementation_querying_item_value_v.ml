...
testing "Residue Symbol Implementation Querying Item_value_v";;
...
(** smb_cpg is hinted from ctt_cpg through the tag
    ...
    2 -> function
*)
let nam_cod = "tresidue_symbol_implementation_querying_item_value_v.ml";; 
 ...
 [Item_value_t.Tre_t.Inner ([],
   [Item_value_t.Tre_t.Inner
     (["let is_residue_nterminal_symbol_off_residue_symbol = function";
       "  | Res_t.Residue_nterminal_symbol _ -> true"; "  | _ -> false";
       ";;"],
    ...
    Item_value_t.Tre_t.Inner
     (["let is_residue_buried_symbol_off_residue_symbol = function";
       "  | Res_t.Residue_buried_symbol _ -> true"; "  | _ -> false"; ";;"],
     [Item_value_t.Tre_t.Leaf
