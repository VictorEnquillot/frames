...
testing "Aggregate Symbol Implementation Codefile_value_v";;

(* toplevel 
   #use "taggregate_symbol_implementation_codefile_value_v.ml";; 
 *)

let nam_cod = "taggregate_symbol_implementation_codefile_value_v.ml";;
...
=
[Codefile_value_t.Itv_t.Tre_t.Inner (["(** {3 A Symbol for a Aggregate.} *)"],
