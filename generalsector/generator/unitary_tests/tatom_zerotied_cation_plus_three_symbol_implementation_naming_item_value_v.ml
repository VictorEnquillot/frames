...
testing "Atom_zerotied_cation_plus_three Symbol Implementation Naming Item_value_v";;
...
(** smb_cpg is hinted from ctt_cpg through the tag
    ...
    2 -> function
*)
let nam_cod = "tatom_zerotied_cation_plus_three_symbol_implementation_naming_item_value_v.ml";; 
...
(* : string *)
= 
"atom_zerotied_cation_plus_three_symbol_naming_v.ml"
);;
