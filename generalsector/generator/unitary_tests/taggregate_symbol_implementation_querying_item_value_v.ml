...
testing "Aggregate Symbol Implementation Querying Item_value_v";;
...
(** smb_cpg is hinted from ctt_cpg through the tag
    ...
    2 -> function
*)
let nam_cod = "taggregate_symbol_implementation_querying_item_value_v.ml";; 
...
let smb_cpg_t = Itf_v.retrieve_querying_datastructure mrk_cnt_t kyl_itm ;;
...
(* : string *)
= 
"aggregate_symbol_querying_v.ml"
);;
