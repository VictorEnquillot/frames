...
testing "entitycategorytype_dot_entitycategory_by_entitycategorysuffix_implementation_provider_v";;

(* toplevel 
   #use "tentitycategorytype_dot_entitycategory_by_entitycategorysuffix_implementation_provider_v.ml";;
 *)

let nam_cod = "tentitycategorytype_dot_entitycategory_by_entitycategorysuffix_implementation_provider_v.ml";;
