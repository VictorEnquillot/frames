...
testing "Atom_zerotied_cation_plus_three Symbol Implementation Codefile_value_v";;

(* toplevel 
   #use "tatom_zerotied_cation_plus_three_symbol_implementation_codefile_value_v.ml";; 
 *)

let nam_cod = "tatom_zerotied_cation_plus_three_symbol_implementation_codefile_value_v.ml";;
...
Ecs_v.name ecs
=
"atom_zerotied_cation_plus_three_symbol_v"
);;
...
(Entitycategorysuffix_t.Ens_t.Entity_proper_symbol
  (Entitycategorysuffix_t.Ens_t.Entity_local_symbol "atom_zerotied_cation_plus_three"),
...
(* : string *)
= 
"atom_zerotied_cation_plus_three_symbol_v.ml"
);;
