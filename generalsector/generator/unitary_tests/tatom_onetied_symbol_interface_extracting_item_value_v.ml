...
testing "Atom_onetied Interface Extracting Item_value_v";;

(* toplevel 
   #use "tatom_onetied_symbol_interface_extracting_item_value_v.ml";; 
 *)

let nam_cod = "tatom_onetied_symbol_interface_extracting_item_value_v.ml";;
...
kyl_itm 
= 
[("item", "extracting"); ("codefile", "interface");
...
(* : string *)
= 
"atom_onetied_symbol_extracting_v.mli"
);;
