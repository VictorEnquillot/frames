 ...
 [Tree_t.Leaf
   (Caml_paragraph_symbol_t.Functions_definitions_symbol
     (Caml_paragraph_symbol_t.Function_argument_symbol
       (Caml_paragraph_symbol_t.Function_name_argument
         ([(Caml_paragraph_symbol_t.Cpc_t.Cnp_t.Cnm_t.Cns_t.Constructor_proper_symbol
             (Caml_paragraph_symbol_t.Cpc_t.Cnp_t.Cnm_t.Cns_t.Constructor_oneline_symbol
               (Caml_paragraph_symbol_t.Cpc_t.Cnp_t.Cnm_t.Cns_t.Constructor_external_symbol
                 (Caml_paragraph_symbol_t.Cpc_t.Cnp_t.Cnm_t.Cns_t.Exs_t.Entity_external_datastructure_symbol
                   Caml_paragraph_symbol_t.Cpc_t.Cnp_t.Cnm_t.Cns_t.Exs_t.Doublet))),
            [1; 1]);
           (Caml_paragraph_symbol_t.Cpc_t.Cnp_t.Cnm_t.Cns_t.Constructor_proper_symbol
             (Caml_paragraph_symbol_t.Cpc_t.Cnp_t.Cnm_t.Cns_t.Constructor_oneline_symbol
               (Caml_paragraph_symbol_t.Cpc_t.Cnp_t.Cnm_t.Cns_t.Constructor_proper_datastructure_symbol
 ...
 [Item_formula_t.Tre_t.Leaf
   (Item_formula_t.Cps_t.Functions_definitions_symbol
     (Item_formula_t.Cps_t.Function_argument_symbol
       (Item_formula_t.Cps_t.Function_name_argument
         ([(Item_formula_t.Cps_t.Cpc_t.Cnp_t.Cnm_t.Cns_t.Constructor_proper_symbol
             (Item_formula_t.Cps_t.Cpc_t.Cnp_t.Cnm_t.Cns_t.Constructor_oneline_symbol
...
=
  [Caml_paragraph_formula_t.Cls_t.Singlet_symbol
    (Caml_paragraph_formula_t.Cls_t.Let_name_t_eq_symbol
