...
testing "Residue_buried_fragmented Symbol Implementation Extracting Caml_paragraph_value_v";;

(* toplevel 
   #use "tresidue_buried_fragmented_symbol_implementation_extracting_caml_paragraph_value_v.ml";; 
 *)

let nam_cod = "tresidue_buried_fragmented_symbol_implementation_extracting_caml_paragraph_value_v.ml";; 
...
(* : string *)
= 
"residue_buried_fragmented_symbol_extracting_empty_v.ml"
);;
