...
testing "Atom_zerotied_symbol Implementation Modules Item_value_v";;

(* toplevel 
   #use "tatom_zerotied_symbol_implementation_modules_item_value_v.ml";; 
 *)

let nam_cod = "tatom_zerotied_symbol_implementation_modules_item_v.ml";;
...
[(Cmtp_v.Csdt_t.Cnm_t.Cns_t.Constructor_proper_symbol
   (Cmtp_v.Csdt_t.Cnm_t.Cns_t.Constructor_several_symbol "atom_zerotied"),
  [1]);
 (Cmtp_v.Csdt_t.Cnm_t.Cns_t.Constructor_proper_symbol
...
(* : string *)
= 
"atom_zerotied_symbol_modules_v.ml"
);;
