...
testing "Abbreviation_module_by_entitycategorysuffix_provider_v";;

(* toplevel 
   #use "tabbreviation_module_by_entitycategorysuffix_provider_v.ml";;
 *)

let nam_cod = "tabbreviation_module_by_entitycategorysuffix_provider_v.ml";;
...
let abb_atm = Maecsp_v.provide ecs_atm;;
let abb_pde = Maecsp_v.provide ecs_pde;;
let abb_prg = Maecsp_v.provide ecs_prg;;
let abb_pgn = Maecsp_v.provide ecs_pgn;;
let abb_ppn = Maecsp_v.provide ecs_ppn;;
let abb_str = Maecsp_v.provide ecs_str;;
let abb_f_s = Maecsp_v.provide ecs_f_s;;
