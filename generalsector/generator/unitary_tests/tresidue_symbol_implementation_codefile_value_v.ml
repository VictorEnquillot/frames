...
testing "Residue Symbol Implementation Codefile_value_v";;

(* toplevel 
   #use "tresidue_symbol_implementation_codefile_value_v.ml";; 
 *)

let nam_cod = "tresidue_symbol_implementation_codefile_value_v.ml";;
...
(Entitycategorysuffix_t.Ens_t.Entity_proper_symbol
  (Entitycategorysuffix_t.Ens_t.Entity_local_symbol "residue"),
