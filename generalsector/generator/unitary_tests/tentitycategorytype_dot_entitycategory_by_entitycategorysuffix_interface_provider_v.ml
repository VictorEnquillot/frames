...
testing "entitycategorytype_dot_entitycategory_by_entitycategorysuffix_interface_provider_v";;

(* toplevel 
   #use "tentitycategorytype_dot_entitycategory_by_entitycategorysuffix_interface_provider_v.ml";;
 *)

let nam_cod = "tentitycategorytype_dot_entitycategory_by_entitycategorysuffix_interface_provider_v.ml";;
...
let smb_cfi = Cfs_v.make "interface";;
...
let abb_atm = Ecsdecp_v.provide ecs_atm;;
let abb_pde = Ecsdecp_v.provide ecs_pde;;
let abb_prg = Ecsdecp_v.provide ecs_prg;;
let abb_pgn = Ecsdecp_v.provide ecs_pgn;;
let abb_ppn = Ecsdecp_v.provide ecs_ppn;;
let abb_str = Ecsdecp_v.provide ecs_str;;
let abb_f_s = Ecsdecp_v.provide ecs_f_s;;
...
(* : string *)
= 
"Polypeptide_symbol_v.polypeptide_symbol"
);;
