...
testing "Segment_buried Symbol Implementation Extracting_heading Caml_paragraph_value_v";;

(* toplevel 
   #use "tsegment_buried_symbol_implementation_extracting_heading_caml_paragraph_value_v.ml";; 
 *)

let nam_cod = "tsegment_buried_symbol_implementation_extracting_heading_caml_paragraph_value_v.ml";; 
...
(* : string *)
= 
"segment_buried_symbol_extracting_heading_v.ml"
);;
