...
testing "Residue_buried_fragmented Symbol Implementation Naming Caml_paragraph_value_v";;

(* toplevel 
   #use "tresidue_buried_fragmented_symbol_implementation_naming_caml_paragraph_value_v.ml";; 
 *)

let nam_cod = "tresidue_buried_fragmented_symbol_implementation_naming_caml_paragraph_value_v.ml";; 
...
[Caml_paragraph_formula_t.Cls_t.Constant_symbol
 ...
 Caml_paragraph_formula_t.Cls_t.Pair_symbol
  (Caml_paragraph_formula_t.Cls_t.Name_pipe_t_dot_s_arrow_s_symbol
    ([(Caml_paragraph_formula_t.Cls_t.Cpc_t.Cnp_t.Cnm_t.Cns_t.Constructor_fictive_symbol
     ...
     [("item", "naming"); ("codefile", "implementation");
      ("category", "symbol"); ("entity", "residue_buried_fragmented")]));
 Caml_paragraph_formula_t.Cls_t.Pair_symbol
  (Caml_paragraph_formula_t.Cls_t.Pipe_t_dot_s_s_arrow_symbol
    ([(Caml_paragraph_formula_t.Cls_t.Cpc_t.Cnp_t.Cnm_t.Cns_t.Constructor_proper_symbol
        (Caml_paragraph_formula_t.Cls_t.Cpc_t.Cnp_t.Cnm_t.Cns_t.Constructor_several_symbol
          "molecule_aminoacid_regular"),
       [2; 1]);
 ...
 Caml_paragraph_formula_t.Cls_t.Singlet_symbol
  (Caml_paragraph_formula_t.Cls_t.S_name_s_symbol
    ([(Caml_paragraph_formula_t.Cls_t.Cpc_t.Cnp_t.Cnm_t.Cns_t.Constructor_proper_symbol
        (Caml_paragraph_formula_t.Cls_t.Cpc_t.Cnp_t.Cnm_t.Cns_t.Constructor_several_symbol
          "molecule_aminoacid_regular"),
       [2; 1]);
...
(* : string *)
= 
"residue_buried_fragmented_symbol_naming_function_name_function_v.ml"
);;
