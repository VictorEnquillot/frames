...
testing "Atom Implementation Heading Item_value_v";;

(* toplevel 
   #use "tatom_symbol_implementation_heading_item_value_v.ml";; 
 *)

let nam_cod = "tatom_symbol_implementation_heading_item_value_v.ml";; 
...
=
Item_value_t.Tre_t.Inner (["(** {3 A Symbol for a Atom.} *)"],
 [Item_value_t.Tre_t.Leaf ["let nam_cod = \"atom_symbol_v.ml\";;"]])
);;
