...
testing "Residue Symbol Implementation Extracting Item_value_v";;
...
(** smb_cpg is hinted from ctt_cpg through the tag
    ...
    2 -> function
*)
let nam_cod = "tresidue_symbol_implementation_extracting_item_value_v.ml";; 
...
(* : string *)
= 
"residue_symbol_extracting_v.ml"
);;
