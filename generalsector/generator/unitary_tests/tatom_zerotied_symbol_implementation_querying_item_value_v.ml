...
testing "Atom_zerotied Symbol Implementation Querying Item_value_v";;
...
(** smb_cpg is hinted from ctt_cpg through the tag
    ...
    2 -> function
*)
let nam_cod = "tatom_zerotied_symbol_implementation_querying_item_value_v.ml";; 
...
(* : string *)
= 
"atom_zerotied_symbol_querying_v.ml"
);;
