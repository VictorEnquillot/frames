...
testing "Aggregate Symbol Type Typing Caml_paragraph_value_v";;

(* toplevel 
   #use "taggregate_symbol_type_typing_caml_paragraph_value_v.ml";; 
 *)

let nam_cod = "taggregate_symbol_type_typing_caml_paragraph_value_v.ml";; 
...
let smb_cli_l = Cpv_v.caml_line_value_list_off_caml_paragraph_value val_cpg;;
...
Caml_line_symbol_t.Datastructure_symbol
 (Caml_line_symbol_t.Type_pipe_doublet_a_b_symbol
   [([(Caml_line_symbol_t.Cpc_t.Cnp_t.Cnm_t.Cns_t.Constructor_fictive_symbol
        (Caml_line_symbol_t.Cpc_t.Cnp_t.Cnm_t.Cns_t.Constructor_barebasic_symbol
          Caml_line_symbol_t.Cpc_t.Cnp_t.Cnm_t.Cns_t.Ens_t.String),
       [1; 1]);
    ...
    ([(Caml_line_symbol_t.Cpc_t.Cnp_t.Cnm_t.Cns_t.Constructor_proper_symbol
        (Caml_line_symbol_t.Cpc_t.Cnp_t.Cnm_t.Cns_t.Constructor_oneline_symbol
          (Caml_line_symbol_t.Cpc_t.Cnp_t.Cnm_t.Cns_t.Constructor_external_symbol
            Caml_line_symbol_t.Cpc_t.Cnp_t.Cnm_t.Cns_t.Exs_t.Ordinal)),
       [1; 1]);
      (Caml_line_symbol_t.Cpc_t.Cnp_t.Cnm_t.Cns_t.Constructor_proper_symbol
        (Caml_line_symbol_t.Cpc_t.Cnp_t.Cnm_t.Cns_t.Constructor_oneline_symbol
          (Caml_line_symbol_t.Cpc_t.Cnp_t.Cnm_t.Cns_t.Constructor_proper_datastructure_symbol
