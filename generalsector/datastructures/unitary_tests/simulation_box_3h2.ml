...
let nam_mod = "Tsimulation_Box_3h2";;;;
...
(** {3 10 Steps Simulation of one H2 Molecule in one Box of one System.} *)

testing "Simulation_Box_3h2";;


(* toplevel #use "simulation_box_3h2.ml";; *)


(** {9 First Box : 3 H2 Molecules.} *)
(** {9 The 0th System of the Simulation.} *)
(** composed of :
       - a Box of 3 H2 Molecule. *)
(** {9 Any cadet System of the Simulation.} *)
(** {9 A Simulation named "H2".} *)
(** pre-define all symbols and pathes. *)

let smb_mol = Molecule_symbol_t.H2;;
let smb_box = Box_symbol_t.Box_3h2;;
let smb_sys = System_symbol_t.Sys_box_3h2;;
let smb_sim = Simulation_symbol_t.Sim_nsys_box_3h2;;
...
let sim_box_3h2 = Provider_simulation_site_v.provide pth_sim;;

let sys_5 = Site_v.component_of_int_of_set_site sim_box_3h2 5;;
...
let mol_h2_2_sys_5 = Molecule_site_v.on_atom_site_of_molecule_site 
             (Site_v.component_of_int_of_set_site box_0_sys_5 2);;
let pth_mol_h2_2_sys_5 = Site_v.path_of_set_site mol_h2_2_sys_5;;

let sys_10 = Site_v.component_of_int_of_set_site sim_box_3h2 10;;
...
let mol_h2_2_sys_10 = Molecule_site_v.on_atom_site_of_molecule_site 
             (Site_v.component_of_int_of_set_site box_0_sys_10 2);;
let pth_mol_h2_2_sys_10 = Site_v.path_of_set_site mol_h2_2_sys_10;;

let atm_h_1_mol_h2_2_sys_5 = 
  Site_v.component_of_int_of_set_site mol_h2_2_sys_5 0;; 
let atm_h_2_mol_h2_2_sys_10 = 
  Site_v.component_of_int_of_set_site mol_h2_2_sys_10 1;; 

test_number 1 (
Site_v.path_of_web_site atm_h_1_mol_h2_2_sys_5
=
Path_t.Level
...
Trajectory_formatted_v.write_configuration_of_simulation sim_box_3h2;;
