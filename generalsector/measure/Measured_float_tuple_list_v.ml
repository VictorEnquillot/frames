(** {3 Measured_float_tuple_list_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : MEA:Measured_float_tuple_list_v";
   "Needs : MEA:Units_tuple_v";
   "Needed-by: ";
   "What-is-it : a Measured_float_tuple_list type couples a float Tuple and a Units";
   "How-is-it-done: ";
   "Abbreviation : flo_mt";
