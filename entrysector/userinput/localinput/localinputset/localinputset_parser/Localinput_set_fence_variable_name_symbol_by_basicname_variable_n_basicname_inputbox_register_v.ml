(** {3 Localinput_set_fence_variable_name_symbol_by_basicname_variable_n_basicname_inputbox_register} *)

let documentation () = 
  [
   "Current : PARLOI:Localinput_set_fence_variable_name_symbol_by_basicname_variable_n_basicname_inputbox_register_v";
   "Author : François Colonna 02 juin 2016 at 11:55:00+02:00";
 ]
;;
...
let name_of_value val_ =
  Localinput_set_fence_variable_name_symbol_v.fullname val_
;;
...
(* done with do_register.sh force on mardi 31 janvier 2017, 10:50:31 (UTC+0100) *)
