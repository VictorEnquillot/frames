...
testing "Localinput_set_fence_variable_kind_symbol_by_basicname_variable_n_basicname_inputbox_provider_v with
    Localinput_set_fence_variable_kind_symbol_by_basicname_variable_n_basicname_inputbox_provider_u_print_perimeter_triangle_w.ml";;
...
(* toplevel 
   #use "Localinput_set_fence_variable_kind_symbol_by_basicname_variable_n_basicname_inputbox_provider_u_print_perimeter_triangle_w.ml";; 

*)

open Localinput_set_fence_variable_kind_symbol_by_basicname_variable_n_basicname_inputbox_provider_v;;
