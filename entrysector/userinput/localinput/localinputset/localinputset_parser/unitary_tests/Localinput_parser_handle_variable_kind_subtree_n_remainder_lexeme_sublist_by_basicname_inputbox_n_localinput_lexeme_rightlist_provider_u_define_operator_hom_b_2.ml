...
let sym_loi_han_st = Tree_v.make_of_node sym_loi_han [sym_loi_f; sym_loi_blo_st];;
...
test_number 12 (
(sym_loi_st, sym_lex_rem_sl) = provide (bna_ibo, sym_lex_sl)
);;

let sym_loi_inn_l = Tree_v.inner_node_list_off_tree x;;
