...
(* toplevel 
   #use "Localinput_lexer_u_triangle.ml";; 
...
(* : Localinput_lexer_t.input_lexeme list *)
  ...
  [Localinput_lexer_symbol_t.Localinput_lexer_command_symbol
   ...
   Localinput_lexer_symbol_t.Localinput_lexer_token "triangle_isosceles_equilateral";
   Localinput_lexer_symbol_t.Localinput_lexer_basic_symbol
    (Localinput_lexer_basic_symbol_t.Localinput_lexer_basic_word "T");
   Localinput_lexer_symbol_t.Localinput_lexer_keyword_symbol
    (Localinput_lexer_keyword_symbol_t.Localinput_lexer_keyword_named_ended_symbol
