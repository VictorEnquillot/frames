...
(* toplevel 
   #use "Localinput_lexer_lexical_analysis_u_print_point_a_short.ml";; 
...
let nof = "Print_point_a_short.loc";;
let fno = fnd ^ "/" ^ nof;;

test_number 1 (
( fno : string ) =
  "/home/colonna/sources/ocaml_top/setup/frames/entrysector/userinput/localinput/localinputset/localinputset_files/Print_point_a_short.loc"
);;
...
let pre_sym_beg s = Localinput_lexer_symbol_v.is_localinput_lexer_keyword_units s;;
let pre_sym_end s = Localinput_lexer_symbol_v.is_localinput_lexer_token_r_bracket s;;
