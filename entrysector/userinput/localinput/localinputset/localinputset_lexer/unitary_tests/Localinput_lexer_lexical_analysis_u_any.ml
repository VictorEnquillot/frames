...
let nam_iba = Trio_v.right_off_trio nam_tri;;
    Inputbox_fullnameoffile_by_inputbox_name_n_inputbase_name_provider_v.provide
      (nam_iba, nam_ibo)
;;
...
let fno_ibo = Inputbox_fullnameoffile_by_inputbox_name_n_inputbase_name_provider_v.provide
      (nam_iba, nam_ibo);;
