...
testing "Localinput_lexer_as_basic_word_capitalized_symbol_n_localinput_lexer_as_variable_kind_symbol_list_by_inputbox_name_provider_v
...
(* toplevel 
   #use "Localinput_lexer_as_basic_word_capitalized_symbol_n_localinput_lexer_as_variable_kind_symbol_list_by_inputbox_name_provider_u_print_length_segment_bc.ml";;

*)

open Localinput_lexer_as_basic_word_capitalized_symbol_n_localinput_lexer_as_variable_kind_symbol_list_by_inputbox_name_provider_v;;
