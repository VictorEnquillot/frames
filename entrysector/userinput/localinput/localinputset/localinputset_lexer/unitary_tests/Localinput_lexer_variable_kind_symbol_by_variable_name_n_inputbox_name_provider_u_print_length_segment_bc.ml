...
(* toplevel 
   #use "Localinput_lexer_variable_kind_symbol_by_variable_name_n_inputbox_name_provider_u_print_length_segment_bc.ml";;
...
let nam_n_sym_lvk_l =
    Variable_name_n_localinput_lexer_variable_kind_symbol_list_by_inputbox_name_provider_v.provide
      nam_ibo;;
