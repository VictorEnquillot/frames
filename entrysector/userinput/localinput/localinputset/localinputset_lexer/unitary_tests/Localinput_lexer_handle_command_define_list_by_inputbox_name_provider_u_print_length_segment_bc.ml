...
testing "Localinput_lexer_handle_command_define_list_by_inputbox_name_provider_v
...
(* toplevel 
   #use "Localinput_lexer_handle_command_define_list_by_inputbox_name_provider_u_print_length_segment_bc.ml";;

*)

open Localinput_lexer_handle_command_define_list_by_inputbox_name_provider_v;;

let nam_ibo = "Print_length_segment_bc";;

let sym_lex_com_l = 
    Localinput_lexer_handle_command_list_or_stop_by_inputbox_name_provider_v.provide 
      nam_ibo
;;
