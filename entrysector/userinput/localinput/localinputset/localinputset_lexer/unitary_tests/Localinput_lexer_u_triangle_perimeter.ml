...
(* toplevel 
   #use "Localinput_lexer_u_triangle_perimeter.ml";; 
...
(* : string *)
  =
"/home/colonna/sources/ocaml_top/setup/frames/inputset/files/Triangle_perimeter.inp"
);;
...
(sub_lex_l1 : Localinput_lexer_symbol_t.input_lexer_symbol list ) =
  [Localinput_lexer_symbol_t.Localinput_lexer_command_symbol
   ...
   Localinput_lexer_symbol_t.Localinput_lexer_basic_symbol
    (Localinput_lexer_basic_symbol_t.Localinput_lexer_basic_word_symbol
      (Localinput_lexer_basic_word_symbol_t.Localinput_lexer_basic_word_lowercase "db1"));
   Localinput_lexer_symbol_t.Localinput_lexer_token_symbol
    Localinput_lexer_token_symbol_t.Localinput_lexer_token_double_quote;
   Localinput_lexer_symbol_t.Localinput_lexer_keyword_symbol
...
test_number 3 (
(sub_lex_l2 : Localinput_lexer_symbol_t.input_lexer_symbol list ) =
  [Localinput_lexer_symbol_t.Localinput_lexer_command_symbol
    Localinput_lexer_command_symbol_t.Localinput_lexer_command_define;
   Localinput_lexer_symbol_t.Localinput_lexer_token_symbol
    Localinput_lexer_token_symbol_t.Localinput_lexer_token_double_quote;
