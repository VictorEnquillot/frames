(** {3 Localinput_lexer_symbol_list_by_basicname_inputbox_register} *)

let documentation () = 
  [
   "Current : LANLOI:Localinput_lexer_symbol_list_by_basicname_inputbox_register_v";
   "Needed-by :"; 
   "Author : François Colonna 29 mars 2017 at 09:40:52+02:00";
 ]
;;
...
let name_of_value val_ =
  List_v.name_in_column 
    Localinput_lexer_symbol_v.fullname 
    val_
;;
...
(* done with do_register.sh force on vendredi 20 janvier 2017, 11:46:53 (UTC+0100) *)
