(** {3 Localinput_lexer_as_variable_kind_symbol_list_by_basicname_inputbox_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : LANLOI:Localinput_lexer_as_variable_kind_symbol_list_by_basicname_inputbox_provider_v";
   "Needs : LEXLOI:Localinput_lexer_symbol_list_by_basicname_inputbox_provider_v";
   "Author : François Colonna 29 mars 2017 at 09:50:00+02:00";
 ]
;;
