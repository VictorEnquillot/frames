(** {3 Localinput_lexer_handle_command_define_by_basicname_variable_n_basicname_inputbox_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : LANLOI:Localinput_lexer_handle_command_define_by_basicname_variable_n_basicname_inputbox_provider_v";
   "Needs: LEXLOI:Localinput_lexer_handle_command_define_by_basicname_variable_n_basicname_inputbox_provider_v";
   "Bnf : <handle_command_define> ::= define <block_define>";
   "Bnf : <block_define>          ::= >variable_name< <handle_variable_kind>";
   "Bnf :                              end";
   "How-is-it-done : by using the String_off the Command of the Handle";
