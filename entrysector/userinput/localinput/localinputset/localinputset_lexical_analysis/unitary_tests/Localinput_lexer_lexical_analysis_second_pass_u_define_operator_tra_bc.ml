...
testing "Localinput_parser_v with
        Localinput_lexer_lexical_analysis_second_pass_u_define_operator_tra_bc.ml";;
...
(* toplevel 
   #use "Localinput_lexer_lexical_analysis_second_pass_u_define_operator_tra_bc.ml";; 
...
test_number 1 (
( fno_ibo : string ) =
"/home/colonna/sources/ocaml_top/setup/frames/entrysector/userinput/localinput/localinputfiles/Define_operator_tra_bc.loc"
);;

let sbu = File_v.scanbuf_of_fullname fno_ibo;;

let sym_lex_1_l = localinput_lexer_symbol_list_first_pass_of_inputbox_name_of_scanbuf sbu;;
