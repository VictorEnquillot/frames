...
testing "Localinput_parser_v with
    Localinput_lexer_lexical_analysis_first_pass_u_print_point_a.ml";;
...
(* toplevel 
   #use "Localinput_lexer_lexical_analysis_first_pass_u_print_point_a.ml";; 
...
let sym_lex_1_sl = localinput_lexer_symbol_list_first_pass_of_scanbuf sbu;;
...
let sbu = File_v.scanbuf_of_fullname fno_ibo;;
let sym_lex_l = localinput_lexer_symbol_list_first_pass_of_scanbuf sbu;;
