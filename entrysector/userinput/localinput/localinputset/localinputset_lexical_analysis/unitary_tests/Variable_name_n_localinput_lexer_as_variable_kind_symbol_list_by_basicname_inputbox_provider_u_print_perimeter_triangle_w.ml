...
testing "Variable_name_n_localinput_lexer_as_variable_kind_symbol_list_by_basicname_inputbox_provider_v
        Variable_name_n_localinput_lexer_as_variable_kind_symbol_list_by_basicname_inputbox_provider_u_print_perimeter_triangle_w.ml";;
...
(* toplevel 
   #use "Variable_name_n_localinput_lexer_as_variable_kind_symbol_list_by_basicname_inputbox_provider_u_print_perimeter_triangle_w.ml";;

*)

open Variable_name_n_localinput_lexer_as_variable_kind_symbol_list_by_basicname_inputbox_provider_v;;
