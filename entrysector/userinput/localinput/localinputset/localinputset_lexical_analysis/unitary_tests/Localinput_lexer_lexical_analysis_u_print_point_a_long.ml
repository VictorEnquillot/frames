...
(* toplevel 
   #use "Localinput_lexer_lexical_analysis_u_print_point_a_long.ml";; 
...
let nof = "Print_point_a_long.loc";;
let fno = fnd ^ "/" ^ nof;;

test_number 1 (
( fno : string ) =
  "/home/colonna/sources/ocaml_top/setup/frames/entrysector/userinput/localinput/localinputset/localinputset_files/Print_point_a_long.loc"
);;
...
let pre_lex_end s = Localinput_lexer_symbol_v.is_localinput_lexer_keyword_defnamed_end s;;
