...
let fno_ibo = 
    Inputbox_fullnameoffile_by_basicname_inputboxoffile_provider_v.provide 
      nof_ibo;;
...
let pre_lex_beg s = Localinput_lexer_symbol_v.is_localinput_lexer_keyword_nextstringed_cofactor_constructor s;;
...
(sym_lex_sl : Localinput_lexer_symbol_t.localinput_lexer_symbol list ) =
 [Localinput_lexer_symbol_t.Localinput_lexer_keyword_symbol
    (Localinput_lexer_keyword_symbol_t.Localinput_lexer_keyword_named_symbol
      (Localinput_lexer_keyword_named_symbol_t.Localinput_lexer_keyword_nextstringed_cofactor_symbol
        (Localinput_lexer_keyword_nextstringed_cofactor_symbol_t.Localinput_lexer_keyword_nextstringed_cofactor_constructor
          "Cen_b")));
   Localinput_lexer_symbol_t.Localinput_lexer_keyword_symbol
    (Localinput_lexer_keyword_symbol_t.Localinput_lexer_keyword_named_symbol
      (Localinput_lexer_keyword_named_symbol_t.Localinput_lexer_keyword_varnamed_cofactor_entity_symbol
        (Localinput_lexer_keyword_varnamed_cofactor_entity_symbol_t.Localinput_lexer_keyword_varnamed_cofactor_entity_constructor
          "Cen_b")));
   Localinput_lexer_symbol_t.Localinput_lexer_basic_symbol
    (Localinput_lexer_basic_symbol_t.Localinput_lexer_basic_word_symbol
      (Localinput_lexer_basic_word_symbol_t.Localinput_lexer_basic_word_bare_symbol
   ...
   Localinput_lexer_symbol_t.Localinput_lexer_keyword_symbol
    (Localinput_lexer_keyword_symbol_t.Localinput_lexer_keyword_named_symbol
      (Localinput_lexer_keyword_named_symbol_t.Localinput_lexer_keyword_nextstringed_cofactor_basic_symbol
        (Localinput_lexer_keyword_nextstringed_cofactor_basic_symbol_t.Localinput_lexer_keyword_nextstringed_cofactor_basic_constructor
          "2.0")));
   Localinput_lexer_symbol_t.Localinput_lexer_basic_symbol
