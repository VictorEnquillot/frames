...
testing "Input_entity_variable_name_by_input_entity_as_property_subentity_symbol_predicate_n_as_variable_name_provider_v with
...
(* toplevel 
   #use "Input_entity_variable_name_by_input_entity_as_property_subentity_symbol_predicate_n_as_variable_name_provider_u_point_homothety.ml";; 
...
open Input_entity_variable_name_by_input_entity_as_property_subentity_symbol_predicate_n_as_variable_name_provider_v;;

let sym_sub_pre = Input_entity_symbol_v.is_input_entity_property_center;;
let tag_ien_sub_st =
...
let nam_iev_cen = Input_entity_variable_name_by_input_entity_as_property_subentity_symbol_predicate_n_as_variable_name_provider_v.provide (sym_sub_pre, nam_iev);;
