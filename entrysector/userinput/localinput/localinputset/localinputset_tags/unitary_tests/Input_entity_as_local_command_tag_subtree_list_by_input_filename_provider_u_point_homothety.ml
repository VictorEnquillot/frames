...
testing "Input_entity_as_local_command_tag_subtree_list_by_input_filename_provider_v with
...
(* toplevel 
   #use "Input_entity_as_local_command_tag_subtree_list_by_input_filename_provider_u_point_homothety.ml";; 
...
let tag_ien_com_stl = Input_entity_as_local_command_tag_subtree_list_by_input_filename_provider_v.provide fin_inp;;
let sym_ien_com_stl = List.map (Tree_v.map Tag_v.entity_off_tag) tag_ien_com_stl;;
...
let tag_ien_com_st = List.nth tag_ien_com_stl 0;;
