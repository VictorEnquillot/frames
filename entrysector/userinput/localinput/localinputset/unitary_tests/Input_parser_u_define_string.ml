...
testing "Input_parser_v with
    Input_parser_u_define_string.ml";;

(* toplevel 
   #use "Input_parser_u_define_string.ml";; 
   ...
   [Tree_t.Inner
     ...
     [Tree_t.Leaf
       (Input_entity_symbol_t.Input_entity_local_variable_symbol
         (Input_entity_local_variable_symbol_t.Input_entity_local_variable_free "text"));
      Tree_t.Inner
    ...
    Tree_t.Inner
     ...
     [Tree_t.Leaf
       (Input_entity_symbol_t.Input_entity_local_variable_symbol
         (Input_entity_local_variable_symbol_t.Input_entity_local_variable_free "r_name"));
      Tree_t.Inner
       (Input_entity_symbol_t.Input_keyword_symbol
         Input_keyword_symbol_t.Input_as,
       [Tree_t.Leaf
    ...
    Tree_t.Inner
     ...
     [Tree_t.Leaf
       (Input_entity_symbol_t.Input_entity_local_variable_symbol
         (Input_entity_local_variable_symbol_t.Input_entity_local_variable_free "s_word"));
      Tree_t.Inner
       (Input_entity_symbol_t.Input_keyword_symbol
         Input_keyword_symbol_t.Input_as,
       [Tree_t.Leaf
     ...
     [Tree_t.Leaf
       (Input_entity_symbol_t.Input_entity_local_variable_symbol
         (Input_entity_local_variable_symbol_t.Input_entity_local_variable_reserved_symbol
           Input_entity_local_variable_reserved_symbol_t.Input_title));
      Tree_t.Inner
       (Input_entity_symbol_t.Input_keyword_symbol
         Input_keyword_symbol_t.Input_as,
       [Tree_t.Leaf
    ...
    Tree_t.Inner
     ...
     [Tree_t.Leaf
       (Input_entity_symbol_t.Input_entity_local_variable_symbol
         (Input_entity_local_variable_symbol_t.Input_entity_local_variable_free "t"));
      Tree_t.Inner
       (Input_entity_symbol_t.Input_keyword_symbol
         Input_keyword_symbol_t.Input_as,
       [Tree_t.Leaf
         (Input_entity_symbol_t.Input_entity_frames_symbol
           (Input_entity_frames_symbol_t.Input_entity_frames_constructor
             "string [ <Run> calculates scale_factor <R_name> ]"));
        Tree_t.Leaf
         (Input_entity_symbol_t.Input_keyword_symbol
           Input_keyword_symbol_t.Input_end)]);
      Tree_t.Leaf
