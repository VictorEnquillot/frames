...
testing "Input_entity_as_local_keyword_input_asby_tag_subtree_by_input_entity_variable_name_provider_v with
...
(* toplevel 
   #use "Input_entity_as_local_keyword_input_asby_tag_subtree_by_input_entity_variable_name_provider_u_point_homothety.ml";;
...
let tag_ien_asby_stl = List.map Input_entity_as_local_keyword_input_asby_tag_subtree_by_input_entity_variable_name_provider_v.provide nam_iev_l;;

(* H_b_2 *)

let nam_iev = "H_b_2";;
let tag_ien_asby_st = List.nth tag_ien_asby_stl 2;;
...
let nam_iev = "P_h_val";;
let tag_ien_asby_st = List.nth tag_ien_asby_stl 3;;
