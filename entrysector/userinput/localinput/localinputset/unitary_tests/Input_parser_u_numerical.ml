...
(* toplevel 
   #use "Input_parser_u_numerical.ml";; 
       ...
       [Tree_t.Inner
         ...
         [Tree_t.Leaf
           (Input_entity_symbol_t.Input_entity_basic_symbol
             (Input_entity_basic_symbol_t.Input_entity_basic_string "none"))]);
        Tree_t.Inner
         (Input_entity_symbol_t.Input_entity_local_symbol
           (Input_entity_local_symbol_t.Input_entity_local_keyword_symbol
             Input_entity_local_keyword_symbol_t.Input_function),
         [Tree_t.Leaf
           (Input_entity_symbol_t.Input_entity_basic_symbol
             (Input_entity_basic_symbol_t.Input_entity_basic_string "none"))]);
        Tree_t.Leaf
       ...
       [Tree_t.Leaf
         (Input_entity_symbol_t.Input_entity_local_symbol
           (Input_entity_local_symbol_t.Input_entity_local_constant_symbol
             (Input_entity_local_constant_symbol_t.Input_entity_local_constant_integer
               " 2")));
        Tree_t.Leaf
         (Input_entity_symbol_t.Input_entity_local_symbol
           (Input_entity_local_symbol_t.Input_entity_local_keyword_symbol
