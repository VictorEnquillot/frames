...
(* toplevel 
   #use "Input_parser_u_define_title.ml";; 
  ...
  Input_lexeme_symbol_t.Input_lexeme_basic_symbol
   (Input_lexeme_basic_symbol_t.Input_lexeme_basic_word_capitalized_symbol
     (Input_lexeme_basic_word_capitalized_symbol_t.Input_lexeme_basic_word_capitalized_reserved_symbol
       Input_lexeme_basic_word_capitalized_reserved_symbol_t.Input_lexeme_title))
);;
...
=
 [Input_lexeme_symbol_t.Input_lexeme_keyword_symbol
    (Input_lexeme_keyword_symbol_t.Input_lexeme_keyword_unary_symbol
      Input_lexeme_keyword_unary_symbol_t.Input_lexeme_string);
   Input_lexeme_symbol_t.Input_lexeme_symbol_symbol
    Input_lexeme_symbol_symbol_t.Input_lexeme_l_parenthesis;
   Input_lexeme_symbol_t.Input_lexeme_symbol_symbol
    Input_lexeme_symbol_symbol_t.Input_lexeme_double_quote;
   Input_lexeme_symbol_t.Input_lexeme_basic_symbol
    (Input_lexeme_basic_symbol_t.Input_lexeme_basic_string "input for Run : ");
   Input_lexeme_symbol_t.Input_lexeme_symbol_symbol
    Input_lexeme_symbol_symbol_t.Input_lexeme_double_quote]
);;
