...
(* toplevel 
   #use "Input_parser_u_set_debug.ml";; 
     ...
     [Tree_t.Inner
       ...
       [Tree_t.Leaf
         (Input_entity_symbol_t.Input_entity_frames_symbol
           (Input_entity_frames_symbol_t.Input_entity_frames_function
             "input_lexeme_basic_word_symbol_of_string"));
        Tree_t.Leaf
         (Input_entity_symbol_t.Input_entity_frames_symbol
...
let nam_mod_l = Register_v.key_list_of_value Debug_by_module_name_register_v.register "debug";;
