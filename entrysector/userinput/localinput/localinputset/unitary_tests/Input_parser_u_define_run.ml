...
let sym_lex_cur = Stack.top sym_lex_s ;;
...
(*   entity_identifier_block Run *)

let sym_ien_id_t = 
    Input_parser_tools_v.entity_identifier_block_subtree_of_input_lexeme_symbol 
      sym_lex_cur;;
...
let lex_sl = List_v.sublist_of_int_of_length_of_list 2 6 sym_lex_l;;
...
=
  [Input_lexeme_symbol_t.Input_lexeme_keyword_symbol
    (Input_lexeme_keyword_symbol_t.Input_lexeme_keyword_ended_symbol
      Input_lexeme_keyword_ended_symbol_t.Input_lexeme_as);
   Input_lexeme_symbol_t.Input_lexeme_keyword_symbol
   ...
   Input_lexeme_symbol_t.Input_lexeme_basic_symbol
    (Input_lexeme_basic_symbol_t.Input_lexeme_basic_word "this_is_a_run");
   Input_lexeme_symbol_t.Input_lexeme_symbol_symbol
    Input_lexeme_symbol_symbol_t.Input_lexeme_double_quote;
   Input_lexeme_symbol_t.Input_lexeme_keyword_symbol
...
(* let sym_ent = Input_parser_define_v.entity_symbol_of_entity_what_of_input_lexeme_symbol_stack "word" sym_lex_s;; *)
...
=
  Tree_t.Leaf
   (Input_entity_symbol_t.Input_entity_basic_symbol
     (Input_entity_basic_symbol_t.Input_entity_basic_string "this_is_a_run"))
);;
