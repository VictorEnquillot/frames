...
testing "Input_file_parsed_by_domain_tag_provider_v with
    Input_file_parsed_by_domain_tag_provider_u_any.ml";;

(* toplevel 
   #use "Input_file_parsed_by_domain_tag_provider_u_any.ml";; 
...
let par_inp = Input_file_parsed_by_domain_tag_provider_v.provide tag_dom;;
