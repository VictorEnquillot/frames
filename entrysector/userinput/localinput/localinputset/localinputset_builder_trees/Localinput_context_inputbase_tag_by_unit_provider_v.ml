(** {3 Localinput_context_inputbase_tag_by_unit_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BLOI:Localinput_context_inputbase_tag_by_unit_provider_v";
   "Needs : BLOI:Localinput_basicname_trio_by_unit_provider_v";
   "Needs : CONS:Context_sole_index_by_basicname_trio_provider_v";
   "Author : François Colonna 04 avril 2017 at 11:10:28+02:00";
 ]
;;
...
(* done with do_provider_without_register.sh Localinput_context_inputbase_tag_by_unit_provider_v.ml force on lundi 31 octobre 2016, 14:54:07 (UTC+0100) *)
