...
let documentation () = 
  [
   "Current : BLOI:Localinput_context_inputbox_sole_index_by_any_sole_index_provider_v";
...
let build soi_any =
  let nam_con_t = Localinput_basicname_trio_by_unit_provider_v.provide () in
...
(* done with do_provider_without_register.sh Localinput_context_inputbox_sole_index_by_any_sole_index_provider_v.ml force on lundi 31 octobre 2016, 14:54:07 (UTC+0100) *)
