(** {3 Localinput_symbol_subtree_by_basicname_inputbox_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : CONS:Localinput_symbol_subtree_by_basicname_inputbox_register_v";
...
let name_of_value val_ =
  Tree_v.name Localinput_symbol_v.fullname val_
;;
