(** {3 Localinput_as_context_domain_tag_by_unit_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BLOI:Localinput_as_context_domain_tag_by_unit_provider_v";
   ...
   "Author : François Colonna 04 avril 2017 at 11:31:53+02:00";
 ]
;;
...
(* done with do_provider_without_register.sh Localinput_as_context_domain_tag_by_unit_provider_v.ml force on lundi 31 octobre 2016, 14:54:05 (UTC+0100) *)
