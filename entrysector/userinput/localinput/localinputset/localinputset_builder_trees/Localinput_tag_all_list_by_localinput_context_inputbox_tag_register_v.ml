(** {3 Localinput_tag_all_list_by_localinput_context_inputbox_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
    "Current : BLOI:Localinput_tag_all_list_by_localinput_context_inputbox_tag_register_v";
 ]
;;
...
let register : 
    (
     Localinput_context_inputbox_tag_t.localinput_context_inputbox_tag,
     Localinput_tag_t.localinput_tag list
    ) 
    Register_t.register = 
...
let name_of_key key =
  Localinput_context_inputbox_tag_v.fullname key
;;

let name_of_value val_ =
  List_v.name Localinput_tag_v.fullname val_
;;
...
(* done with do_register.sh force on lundi 31 octobre 2016, 14:53:59 (UTC+0100) *)
