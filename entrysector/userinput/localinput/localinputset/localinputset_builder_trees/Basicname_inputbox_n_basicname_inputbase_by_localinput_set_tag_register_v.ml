(** {3 Basicname_inputbox_n_basicname_inputbase_by_localinput_set_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BLOI:Basicname_inputbox_n_basicname_inputbase_by_localinput_set_tag_register_v";
   "Author : François Colonna 28 mars 2017 at 12:03:03+02:00";
 ]
;;
...
let register : 
    (Localinput_set_tag_t.localinput_set_tag,
...
let name_of_key key =
  Localinput_set_tag_v.fullname key
;;
