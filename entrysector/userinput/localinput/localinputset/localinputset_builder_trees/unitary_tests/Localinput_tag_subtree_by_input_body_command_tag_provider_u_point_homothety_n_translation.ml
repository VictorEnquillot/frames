...
let tag_inp_ll = List_v.burst_left_included_of_predicate_of_list (fun (e, s) -> Localinput_symbol_v.is_input_body_handle_command_tounit_print_constructor e) tag_inp_l;;
let tag_inp_poa_l = List.nth tag_inp_ll 1;;
let tag_inp_com = List.hd tag_inp_poa_l;;

test_number 1 (
(tag_inp_com : Localinput_symbol_t.input_symbol Tag_t.tag )
=
...
let tag_ico = Tag_v.map_entity Localinput_symbol_v.input_body_handle_command_symbol_off_input_symbol tag_inp_com;;

test_number 2 (
(tag_ico : Localinput_body_handle_command_symbol_t.input_body_handle_command_symbol Tag_t.tag )
  =
(Localinput_body_handle_command_symbol_t.Localinput_body_handle_command_tounit_print_constructor, [10; 28])
);;


let tag_inp_st = Localinput_tag_subtree_by_input_body_handle_command_tag_provider_v.provide tag_ico;;
  
test_number 3 (
(tag_inp_st : Localinput_symbol_t.input_symbol Tag_t.tag Tree_t.tree )
=
  Tree_t.Inner
   ((Localinput_symbol_t.Localinput_body_handle_command_symbol
      Localinput_body_handle_command_symbol_t.Localinput_body_handle_command_tounit_print_constructor,
