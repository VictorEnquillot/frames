...
testing "Localinput_tag_by_input_entity_variable_name_provider_v with
...
(* toplevel 
   #use "Localinput_tag_by_input_entity_variable_name_provider_u_point_homothety.ml";;
...
open Localinput_tag_by_input_entity_variable_name_provider_v;;
...
let tag_inp_def_st = 
    Localinput_as_body_handle_command_define_tag_subtree_by_input_entity_variable_name_provider_v.provide 
      nam_iev;;
...
let tag_inp_l = List.map Localinput_tag_by_input_entity_variable_name_provider_v.provide nam_iev_l;;
