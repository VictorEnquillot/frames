...
testing "Localinput_symbol_tree_by_input_fullname_provider_v with
...
(* toplevel 
   #use "Localinput_symbol_tree_by_input_fullname_provider_u_point_homothety.ml";; 
...
open Localinput_symbol_tree_by_input_fullname_provider_v;;
...
let pre_tre =
  let pre_lea = Localinput_symbol_v.is_input_variable_name_constructor in
  let pre_nod = Localinput_symbol_v.is_input_keyword_context in
...
test_number 2 (
(sym_inp_con_stl : Localinput_symbol_t.input_symbol Tree_t.tree list ) =
  [Tree_t.Inner
    (Localinput_symbol_t.Localinput_body_handle_command_symbol
      Localinput_body_handle_command_symbol_t.Localinput_command_define,
    [Tree_t.Leaf
...
let pre_tre =
  let pre_lea = Localinput_symbol_v.is_input_variable_name_constructor in
  let pre_nod = Localinput_symbol_v.is_input_keyword_operator in
  Tree_v.has_a_topson_leaf_and_a_topson_node_of_leaf_predicate_of_node_predicate_off_tree pre_lea pre_nod 
;;
...
test_number 3 (
(sym_inp_ope_stl : Localinput_symbol_t.input_symbol Tree_t.tree list ) =
 [Tree_t.Inner
    (Localinput_symbol_t.Localinput_body_handle_command_symbol
      Localinput_body_handle_command_symbol_t.Localinput_command_define,
    [Tree_t.Leaf
