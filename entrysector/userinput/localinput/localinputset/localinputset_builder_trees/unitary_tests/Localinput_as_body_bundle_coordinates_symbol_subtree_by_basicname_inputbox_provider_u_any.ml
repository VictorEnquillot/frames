...
testing "Localinput_as_body_bundle_coordinates_symbol_subtree_by_basicname_inputbox_provider_v with
    Localinput_as_body_bundle_coordinates_symbol_subtree_by_basicname_inputbox_provider_u_any.ml";;
...
(* toplevel 
   #use "Localinput_as_body_bundle_coordinates_symbol_subtree_by_basicname_inputbox_provider_u_any.ml";; 

*)

open Localinput_as_body_bundle_coordinates_symbol_subtree_by_basicname_inputbox_provider_v;;
...
let sym_loc_dbc_st = Tree_v.subtree_of_node_predicate_off_tree 
    Localinput_symbol_v.is_localinput_body_bundle_coordinates_symbol_off_localinput_symbol 
    sym_loc_st;;
...
test_number 3 (
sym_loc_dbc_st = provide nam_ibo
);;
