...
testing "Make_argument_by_target_input_variable_name_provider_v with
...
(* toplevel 
   #use "Make_argument_by_target_input_variable_name_provider_u_point_homothety.ml";; 
...
let sym_kin_ivn = Localinput_variable_kind_by_input_variable_name_provider_v.provide nam_ivn;;

test_number 2 ( 
(sym_kin_ivn : Localinput_symbol_t.input_symbol ) =
Localinput_symbol_t.Localinput_keyword_symbol
  Localinput_keyword_symbol_t.Localinput_keyword_target
);;
...
let arg_mak = Make_argument_by_target_input_variable_name_provider_v.provide nam_ivn;;
