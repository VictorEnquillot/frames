...
testing "Localinput_as_body_handle_command_tounit_tag_subtree_list_by_basicname_inputbox_provider_v with
    Localinput_as_body_handle_command_tounit_tag_subtree_list_by_basicname_inputbox_provider_u_point_homothety.ml";;
...
(* toplevel 
   #use "Localinput_as_body_handle_command_tounit_tag_subtree_list_by_basicname_inputbox_provider_u_point_homothety.ml";; 
...
open Localinput_as_body_handle_command_tounit_tag_subtree_list_by_basicname_inputbox_provider_v;;
