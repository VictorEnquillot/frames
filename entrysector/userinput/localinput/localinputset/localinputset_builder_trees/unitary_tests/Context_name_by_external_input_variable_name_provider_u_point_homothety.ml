...
testing "Context_name_by_external_input_variable_name_provider_v with
...
(* toplevel 
   #use "Context_name_by_external_input_variable_name_provider_u_point_homothety.ml";; 
...
let sym_con = Context_name_by_external_input_variable_name_provider_v.provide nam_ivn;;
