...
let cou = List.length tag_inp_cde_stl;;
...
let pre_tag_ope (s, i) = Localinput_symbol_v.is_input_body_block_variable_operator s;;
let pre_tag_eco (s, i) = Localinput_symbol_v.is_input_body_handle_cofactor s;;
let pre_tag_kty (s, i) = Localinput_symbol_v.is_input_fence_keyword_type s;;
let pre_tag_cto (s, i) = Localinput_symbol_v.is_input_fence_cell_target_operator_constructor s;;
...
let tag_inp_ope_l = List.filter pre_tag_ope tag_inp_l;;

test_number 2 (
(tag_inp_ope_l : Localinput_symbol_t.input_symbol Tag_t.tag list ) =
...
let tag_inp_ope_stl = List.filter pre_tag_tre tag_inp_cde_stl;;

test_number 3 (
(tag_inp_ope_stl : Localinput_symbol_t.input_symbol Tag_t.tag Tree_t.tree list ) =
  [Tree_t.Inner
    ((Localinput_symbol_t.Localinput_body_symbol
