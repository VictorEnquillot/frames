...
(* toplevel 
   #use "Localinput_variable_name_list_by_input_entity_as_property_subentity_symbol_predicate_n_as_variable_name_provider_u_point_homothety.ml";; 
...
let sym_cen_pre = Localinput_symbol_v.is_input_entity_property_center;;
let tag_inp_sub_st =
...
let nam_iev_cen_l = Localinput_variable_name_list_by_input_entity_as_property_subentity_symbol_predicate_n_as_variable_name_provider_v.provide (sym_cen_pre, nam_iev);;
