...
testing "Segment_input_variable_name_by_operator_input_variable_name_provider_v with
...
(* toplevel 
   #use "Segment_input_variable_name_by_operator_input_variable_name_provider_u_point_homothety_n_translation.ml";; 
...
let sym_inp_dom_t = 
    Tree_v.subtree_of_node_predicate_off_tree 
      Localinput_symbol_v.is_input_keyword_segment
      sym_inp_cde_t;;
...
let sym_dom = Segment_input_variable_name_by_operator_input_variable_name_provider_v.provide nam_iva;;
