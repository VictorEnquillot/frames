...
let nam_opr_l = List.map Operator_name_by_target_input_variable_name_provider_v.provide nam_tar_l;;
...
let nam_opd_l = List.map Operand_name_by_target_input_variable_name_provider_v.provide nam_tar_l;;
