...
testing "Localinput_as_body_handle_command_tag_subtree_by_input_body_handle_command_tag_provider_v with
...
(* toplevel 
   #use "Localinput_as_body_handle_command_tag_subtree_by_input_body_handle_command_tag_provider_u_point_homothety.ml";; 
...
(* Argument tag_bhc Poi_h Command Define *)
...
open Localinput_as_body_handle_command_tag_subtree_by_input_body_handle_command_tag_provider_v;;

(* Argument Command tag *)

let tag_bhc = Tag_v.map_entity 
    Localinput_symbol_v.input_body_handle_command_symbol_off_input_symbol
    tag_inp_ccd_poi_h
;;

let soi_bhc = Tag_v.sole_index_off_tag tag_bhc;;

let tag_inp_bhc = Tag_v.map_entity 
    Localinput_symbol_v.input_symbol_of_input_body_handle_command_symbol
    tag_bhc;;

test_number 2 (
(tag_inp_bhc : Localinput_symbol_t.input_symbol Tag_t.tag) =
  (Localinput_symbol_t.Localinput_body_symbol
    (Localinput_body_symbol_t.Localinput_body_handle_symbol
      (Localinput_body_handle_symbol_t.Localinput_body_handle_command_symbol
        (Localinput_body_handle_command_symbol_t.Localinput_body_handle_command_creation_symbol
...
let soi_inp_bhc = Tag_v.sole_index_off_tag tag_inp_bhc;;
...
let tag_inp_bhc_stl = 
    Localinput_as_body_handle_command_tag_subtree_list_by_input_fullnameoffile_provider_v.provide
    fno_inp;;

let tag_inp_bhc_roo_l = List.map Tree_v.root_node_off_tree tag_inp_bhc_stl;;
List.iter2 Localinput_tag_subtree_by_input_as_root_tag_register_v.store tag_inp_bhc_roo_l tag_inp_bhc_stl;;
...
let tag_inp_bhc_st = provide tag_bhc;;
let sym_inp_bhc_st = Tree_v.map Tag_v.entity_off_tag tag_inp_bhc_st;;

test_number 5 (
(sym_inp_bhc_st : Localinput_symbol_t.input_symbol Tree_t.tree ) =
  Tree_t.Inner
   (Localinput_symbol_t.Localinput_body_symbol
     (Localinput_body_symbol_t.Localinput_body_handle_symbol
       (Localinput_body_handle_symbol_t.Localinput_body_handle_command_symbol
...
test_number 6 (
tag_inp_bhc_st = Localinput_tag_subtree_by_input_as_root_tag_provider_v.provide tag_inp_bhc
);;

(* Argument tag_hcu Poi_h Command Unit *)

let nam_var = "Poi_h";;
let pre_tag_hcu_sof sof (s, i) = (Localinput_symbol_v.is_input_body_handle_command_tounit_symbol_off_input_symbol s) && (Localinput_symbol_v.string_off s = sof);;

let tag_inp_hcu_poi_h = List_v.only_element_of_predicate_off_list (pre_tag_hcu_sof nam_var) tag_inp_l;;

test_number 7 (
(tag_inp_hcu_poi_h : Localinput_symbol_t.input_symbol Tag_t.tag ) =
  (Localinput_symbol_t.Localinput_body_symbol
    (Localinput_body_symbol_t.Localinput_body_handle_symbol
      (Localinput_body_handle_symbol_t.Localinput_body_handle_command_symbol
        (Localinput_body_handle_command_symbol_t.Localinput_body_handle_command_tounit_symbol
...
let tag_hcu = Tag_v.map_entity 
    Localinput_symbol_v.input_body_handle_command_tounit_symbol_off_input_symbol
    tag_inp_hcu_poi_h
;;
...
test_number 12 (
tag_inp_bhc_roo_l = List.map Tree_v.root_node_off_tree tag_inp_bhc_stl
);;
