...
let sym_inp_st = provide fno_inp;;

(* Check Leaf as Fence *)

let sym_inp_lea_l = Tree_v.leaf_node_list_off_tree sym_inp_st;;
let sym_inp_bod_l = List.filter Localinput_symbol_v.is_input_body_symbol_off_input_symbol sym_inp_lea_l;;

test_number 1 (
(sym_inp_bod_l : Localinput_symbol_t.input_symbol list ) =
[]
);;
...
let sym_inp_fen_l = List.filter Localinput_symbol_v.is_input_fence_symbol_off_input_symbol sym_inp_nle_l;;

test_number 2 (
(sym_inp_fen_l : Localinput_symbol_t.input_symbol list ) =
[]
);;
...
test_number 3 (
(sym_inp_rts_l : Localinput_symbol_t.input_symbol list ) =
...
let pre_tre_con sof = Tree_v.has_node_of_node_predicate_off_tree (fun n -> Localinput_symbol_v.input_fence_variable_name_context_constructor sof = n);;

let sym_inp_con_loc_st = List_v.only_element_of_predicate_off_list (pre_tre_con "Con_loc") sym_inp_tso_stl;;

test_number 4 (
(sym_inp_con_loc_st : Localinput_symbol_t.input_symbol Tree_t.tree) =
  Tree_t.Inner
   (Localinput_symbol_t.Localinput_body_symbol
     (Localinput_body_symbol_t.Localinput_body_handle_symbol
       (Localinput_body_handle_symbol_t.Localinput_body_handle_command_symbol
...
test_number 5 (
(sym_inp_con_hom_st : Localinput_symbol_t.input_symbol Tree_t.tree) =
Tree_t.Inner
   (Localinput_symbol_t.Localinput_body_symbol
     (Localinput_body_symbol_t.Localinput_body_handle_symbol
       (Localinput_body_handle_symbol_t.Localinput_body_handle_command_symbol
...
let pre_tre_ext sof = Tree_v.has_node_of_node_predicate_off_tree (fun n -> Localinput_symbol_v.input_fence_variable_name_entity_external_constructor sof = n);;

let sym_inp_cen_b_st = List_v.only_element_of_predicate_off_list (pre_tre_ext "Cen_b") sym_inp_tso_stl;;

test_number 6 (
(sym_inp_cen_b_st : Localinput_symbol_t.input_symbol Tree_t.tree) =
  Tree_t.Inner
   (Localinput_symbol_t.Localinput_body_symbol
     (Localinput_body_symbol_t.Localinput_body_handle_symbol
       (Localinput_body_handle_symbol_t.Localinput_body_handle_command_symbol
...
test_number 7 (
(sym_inp_poi_a_st : Localinput_symbol_t.input_symbol Tree_t.tree) =
  Tree_t.Inner
   (Localinput_symbol_t.Localinput_body_symbol
     (Localinput_body_symbol_t.Localinput_body_handle_symbol
       (Localinput_body_handle_symbol_t.Localinput_body_handle_command_symbol
