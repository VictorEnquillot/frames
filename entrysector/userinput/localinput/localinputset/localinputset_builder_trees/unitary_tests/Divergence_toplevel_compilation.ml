...
File "Localinput_as_body_handle_command_tag_subtree_list_by_input_fullnameoffile_provider_u_define_operator_hom_b_2.ml", line 153, characters 18-113:
Error: The type of this expression,
       (Localinput_symbol_t.input_symbol * '_a) Tree_t.tree -> bool,
