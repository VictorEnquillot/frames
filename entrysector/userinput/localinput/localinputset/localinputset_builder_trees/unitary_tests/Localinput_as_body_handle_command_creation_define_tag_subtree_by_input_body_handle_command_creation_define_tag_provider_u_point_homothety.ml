...
testing "Localinput_as_body_handle_command_creation_define_tag_subtree_by_input_body_handle_command_creation_define_tag_provider_v with
...
(* toplevel 
   #use "Localinput_as_body_handle_command_creation_define_tag_subtree_by_input_body_handle_command_creation_define_tag_provider_u_point_homothety.ml";; 
*)
...
let tag_inp_ccd_poi_h = List_v.only_element_of_predicate_off_list (pre_tag_ccd_sof nam_var) tag_inp_l;;

test_number 1 (
(tag_inp_ccd_poi_h : Localinput_symbol_t.input_symbol Tag_t.tag ) =
...
open Localinput_as_body_handle_command_creation_define_tag_subtree_by_input_body_handle_command_creation_define_tag_provider_v;;

(* Command define tag *)

let tag_ccd = Tag_v.map_entity 
    Localinput_symbol_v.input_body_handle_command_creation_define_symbol_off_input_symbol
    tag_inp_ccd_poi_h
;;
...
let soi_inp_ccd = Tag_v.sole_index_off_tag tag_inp_ccd;;
...
let nam_var_ccd = Localinput_tag_v.string_off tag_inp_ccd;;
...
let tag_inp_ccd_st = List_v.only_element_of_predicate_off_list (pre_tag_ccd_roo_sof nam_var_ccd) tag_inp_stl;;
...
test_number 5 (
tag_inp_ccd_st = provide tag_ccd
);;
