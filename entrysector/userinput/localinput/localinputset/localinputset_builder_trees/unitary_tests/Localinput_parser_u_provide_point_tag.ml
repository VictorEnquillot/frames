...
let nof_inp = "Provide_point_tag_a.inp";;

(* 
let sym_lex_l = Localinput_lexer_lexical_analysis_v.input_lexer_symbol_list_of_input_name nof_inp;; 
*)

let sym_lex_s = Localinput_parser_v.input_entity_symbol_stack_of_input_name nof_inp;;
let sym_lex_s = Localinput_parser_v.input_entity_symbol_stack_of_input_name nof_inp;;
(* ------------------------- start of debug -------------------------------------*)
...
let sym_inp_t = Localinput_parser_v.input_entity_symbol_tree_of_input_fullnameoffile nof_inp;;

test_number 4 (
sym_inp_t
(* : Localinput_lexer_symbol_t.input_lexer_symbol Tree_t.tree *)
  =
  Tree_t.Inner
   (Localinput_symbol_t.Localinput_local_symbol
     (Localinput_local_symbol_t.Localinput_local_calculation
       "Provide_point_tag_a.inp"),
   [Tree_t.Inner
     (Localinput_symbol_t.Localinput_local_symbol
