...
Localinput_fullnameoffile_by_domain_tag_provider_v.provide tag_dom
  ...
  let tag_inp_tar_l = List.map 
	 ...
	 Localinput_symbol_v.input_symbol_of_target_symbol) 
      tag_tar_l
 ;;
 ...
 ;;
  let tag_inp_mod_l = List.map
      (Tag_v.map_entity (* coerce up *)
	 Localinput_symbol_v.input_symbol_of_model_symbol)
      tag_mod_l
 ;;
...
let tag_inp_l = Localinput_tag_all_list_by_domain_tag_provider_v.provide tag_dom;;
