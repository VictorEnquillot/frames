...
testing "Make_argument_by_operator_input_variable_name_provider_v with
...
(* toplevel 
   #use "Make_argument_by_operator_input_variable_name_provider_u_point_homothety.ml";; 
...
let sym_inp_typ_t = 
    Tree_v.subtree_of_node_predicate_off_tree 
      Localinput_symbol_v.is_input_keyword_type
      sym_inp_cde_t;;

test_number 4 (
( sym_inp_typ_t : Localinput_symbol_t.input_symbol Tree_t.tree ) =
  Tree_t.Inner
   (Localinput_symbol_t.Localinput_keyword_symbol
     Localinput_keyword_symbol_t.Localinput_keyword_type,
   [Tree_t.Leaf
...
let sym_inp_bas_st = Tree_v.subtree_of_node_predicate_off_tree Localinput_symbol_v.is_input_basic_string sym_inp_con_t;;

test_number 5 (
( sym_inp_bas_st : Localinput_symbol_t.input_symbol Tree_t.tree ) =
  Tree_t.Leaf
   (Localinput_symbol_t.Localinput_basic_symbol
     (Localinput_basic_symbol_t.Localinput_basic_string "Cen_b"))
);;

let nam_mak = Make_argument_by_operator_input_variable_name_provider_v.provide nam_ivn;;
