...
testing "Localinput_fence_variable_name_entity_implicit_tag_by_input_body_handle_command_tounit_tag_provider_v with
...
(* toplevel 
   #use "Localinput_fence_variable_name_entity_implicit_tag_by_input_body_handle_command_tounit_tag_provider_u_point_homothety.ml";; 
...
let tag_bhc_l = Localinput_body_handle_command_tag_list_by_input_fullnameoffile_provider_v.provide fno_inp;;
...
open Localinput_fence_variable_name_entity_implicit_tag_by_input_body_handle_command_tounit_tag_provider_v;;
...
let nam_hcu = Localinput_body_handle_command_tounit_tag_v.string_off tag_hcu;;
  
let pre_tag_nei_sof sof (s, i) = 
  (Localinput_symbol_v.input_fence_variable_name_entity_implicit_constructor sof = s)
;;

let tag_inp_nei = Tree_v.only_node_of_node_predicate_off_tree (pre_tag_nei_sof nam_hcu) tag_inp_hcu_st;;
