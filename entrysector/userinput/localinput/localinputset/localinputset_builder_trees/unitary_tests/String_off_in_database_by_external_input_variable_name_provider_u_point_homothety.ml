...
(* toplevel 
   #use "String_off_in_database_by_external_input_variable_name_provider_u_point_homothety.ml";; 
...
let sym_dom = String_off_in_database_by_external_input_variable_name_provider_v.provide nam_iva;;
