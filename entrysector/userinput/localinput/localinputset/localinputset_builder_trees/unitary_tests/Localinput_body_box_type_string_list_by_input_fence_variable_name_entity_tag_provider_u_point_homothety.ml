...
testing "Localinput_body_box_type_string_list_by_input_fence_variable_name_entity_tag_provider_v with
...
(* toplevel 
   #use "Localinput_body_box_type_string_list_by_input_fence_variable_name_entity_tag_provider_u_point_homothety.ml";; 
...
open Localinput_body_box_type_string_list_by_input_fence_variable_name_entity_tag_provider_v;;
...
let tag_inp_vne = List_v.only_element_of_predicate_off_list (pre_tag_vne_sof sof_vne) tag_inp_l;;
...
let tag_bbt = (* Coerce Down *) 
    Localinput_body_box_type_tag_v.input_body_box_type_tag_off_input_tag 
      tag_inp_bbt;;

let str_l = Localinput_body_box_type_string_list_by_input_body_box_type_tag_provider_v.provide tag_bbt;;
