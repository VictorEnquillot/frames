...
testing "Center_input_variable_name_by_operator_input_variable_name_provider_v with
...
(* toplevel 
   #use "Center_input_variable_name_by_operator_input_variable_name_provider_u_point_homothety.ml";; 
...
let sym_inp_dom_t = 
    Tree_v.subtree_of_node_predicate_off_tree 
      Localinput_symbol_v.is_input_keyword_center
      sym_inp_cde_t;;
...
let nam_ivn_cen = Center_input_variable_name_by_operator_input_variable_name_provider_v.provide nam_ivn;;
...
let sof_cen = String_off_in_database_by_external_input_variable_name_provider_v.provide nam_ivn_cen;;
