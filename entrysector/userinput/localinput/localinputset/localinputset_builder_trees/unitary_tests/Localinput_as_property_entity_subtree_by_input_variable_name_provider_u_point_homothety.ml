...
testing "Localinput_as_property_entity_tag_subtree_by_input_variable_name_provider_v with
    Localinput_as_property_entity_tag_subtree_by_input_variable_name_provider_u_point_homothety.ml";;

(* toplevel 
   #use "Localinput_as_property_entity_tag_subtree_by_input_variable_name_provider_u_point_homothety.ml";; 
...
let tag_inp_com_stl = Localinput_as_property_entity_tag_subtree_by_input_variable_name_provider_v.provide fno_inp;;
let sym_inp_com_stl = List.map (Tree_v.map Tag_v.entity_off_tag) tag_inp_com_stl;;
...
=
  [Tree_t.Inner
   ...
   Tree_t.Inner
    (Localinput_symbol_t.Localinput_local_symbol
      (Localinput_local_symbol_t.Localinput_local_command_symbol
        Localinput_local_command_symbol_t.Localinput_body_handle_command_tounit_print_constructor),
    [Tree_t.Leaf
      (Localinput_symbol_t.Localinput_local_symbol
        (Localinput_local_symbol_t.Localinput_local_variable_symbol
          (Localinput_local_variable_symbol_t.Localinput_local_variable_free
...
let tag_inp_com_st = List.nth tag_inp_com_stl 0;;
