...
(* toplevel 
   #use "Domain_name_by_context_input_variable_name_provider_u_point_homothety.ml";; 
...
let sym_dom = Domain_name_by_context_input_variable_name_provider_v.provide nam_iva;;
