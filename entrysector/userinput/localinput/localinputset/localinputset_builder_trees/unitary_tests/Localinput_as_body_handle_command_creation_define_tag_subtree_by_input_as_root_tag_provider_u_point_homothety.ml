...
testing "Localinput_as_body_handle_command_creation_define_tag_subtree_by_input_as_root_tag_provider_v with
...
(* toplevel 
   #use "Localinput_as_body_handle_command_creation_define_tag_subtree_by_input_as_root_tag_provider_u_point_homothety.ml";; 
*)
...
open Localinput_as_body_handle_command_creation_define_tag_subtree_by_input_as_root_tag_provider_v;;
