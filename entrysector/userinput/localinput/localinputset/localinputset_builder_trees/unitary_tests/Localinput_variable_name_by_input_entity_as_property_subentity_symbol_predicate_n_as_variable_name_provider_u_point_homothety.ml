...
testing "Localinput_variable_name_by_input_entity_as_property_subentity_symbol_predicate_n_as_variable_name_provider_v with
...
(* toplevel 
   #use "Localinput_variable_name_by_input_entity_as_property_subentity_symbol_predicate_n_as_variable_name_provider_u_point_homothety.ml";; 
...
open Localinput_variable_name_by_input_entity_as_property_subentity_symbol_predicate_n_as_variable_name_provider_v;;

let sym_sub_pre = Localinput_symbol_v.is_input_entity_property_center;;
let tag_inp_sub_st =
...
let nam_iev_cen = Localinput_variable_name_by_input_entity_as_property_subentity_symbol_predicate_n_as_variable_name_provider_v.provide (sym_sub_pre, nam_iev);;
