...
let pre_sym_hcd_sof sof s = Localinput_symbol_v.input_body_handle_command_creation_define_constructor sof = s;;
...
let pre_sym_bbu_sof sof s = Localinput_symbol_v.input_body_box_units_constructor sof = s;;

let sym_inp_ctc_a_st = Tree_v.subtree_find_of_node_predicate_off_tree (pre_sym_bbu_sof "Ctc_a") sym_inp_t;;

test_number 3 (
(sym_inp_ctc_a_st : Localinput_symbol_t.input_symbol Tree_t.tree) =
Tree_t.Inner
 (Localinput_symbol_t.Localinput_body_symbol
...
let pre_sym_nee_sof sof s = Localinput_symbol_v.input_fence_variable_name_entity_external_constructor sof = s;;

let sym_inp_uni_len_st = Tree_v.subtree_find_of_node_predicate_off_tree (pre_sym_nee_sof "Uni_len") sym_inp_t;;

test_number 4 (
(sym_inp_uni_len_st : Localinput_symbol_t.input_symbol Tree_t.tree) =
  Tree_t.Leaf
   (Localinput_symbol_t.Localinput_fence_symbol
     (Localinput_fence_symbol_t.Localinput_fence_variable_name_symbol
       (Localinput_fence_variable_name_symbol_t.Localinput_fence_variable_name_entity_symbol
...
let pre_sym_pri_sof sof s = Localinput_symbol_v.input_body_handle_command_tounit_print_constructor sof = s;;

let sym_inp_pri_st = Tree_v.subtree_find_of_node_predicate_off_tree (pre_sym_pri_sof "Ctc_a") sym_inp_t;;

test_number 5 (
( sym_inp_pri_st : Localinput_symbol_t.input_symbol Tree_t.tree ) =
  Tree_t.Inner
   (Localinput_symbol_t.Localinput_body_symbol
     (Localinput_body_symbol_t.Localinput_body_handle_symbol
       (Localinput_body_handle_symbol_t.Localinput_body_handle_command_symbol
