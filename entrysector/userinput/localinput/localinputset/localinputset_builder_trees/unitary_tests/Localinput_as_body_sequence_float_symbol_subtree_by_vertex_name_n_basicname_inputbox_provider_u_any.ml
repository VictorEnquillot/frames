...
testing "Localinput_as_body_sequence_float_symbol_subtree_by_vertex_name_n_basicname_inputbox_provider_v with
        Localinput_as_body_sequence_float_symbol_subtree_by_vertex_name_databox_n_name_provider_u_any.ml";;
...
(* toplevel 
   #use "Localinput_as_body_sequence_float_symbol_subtree_by_vertex_name_n_basicname_inputbox_provider_u_any.ml";; 

*)

open Localinput_as_body_sequence_float_symbol_subtree_by_vertex_name_n_basicname_inputbox_provider_v;;

let nam_ibo = "Point_a_print";;
let nam_ver = "A_A";;

let sym_loc_drv_st = 
    Localinput_as_body_record_vertex_symbol_subtree_by_vertex_name_n_basicname_inputbox_provider_v.provide 
      (nam_ver, nam_ibo);;
...
let sym_loc_drv_rtl = Tree_v.root_topson_node_list_off_tree sym_loc_drv_st;;

test_number 2 (
(sym_loc_drv_rtl : Localinput_symbol_t.localinput_symbol list ) =
 [Localinput_symbol_t.Localinput_body_symbol
    (Localinput_body_symbol_t.Localinput_body_record_symbol
      (Localinput_body_record_symbol_t.Localinput_body_record_vertex_symbol
        (Localinput_body_record_vertex_symbol_t.Localinput_body_record_vertex_constructor
...
let sym_loc_drv_st = Tree_v.subtree_of_node_predicate_off_tree  
    Localinput_symbol_v.is_localinput_body_sequence_float_constructor
    sym_loc_drv_st;;
