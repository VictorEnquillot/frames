...
testing "Localinput_fence_cell_datafile_string_off_by_input_fence_variable_name_entity_string_off_provider_v with
...
Trace_what_by_module_name_register_v.store "Localinput_fence_cell_datafile_string_off_by_input_fence_variable_name_entity_string_Localinput_context_sole_index_by_input_context_symbol_provider_v.mloff_provider_v" "cpu debug provide";;

(* toplevel 
   #use "Localinput_fence_cell_datafile_string_off_by_input_fence_variable_name_entity_string_off_provider_u_parameter_tuple_aopef_hes11_print.ml";; 
...
open Localinput_fence_cell_datafile_string_off_by_input_fence_variable_name_entity_string_off_provider_v;;
...
let tag_fcd =  
  Localinput_fence_cell_datafile_tag_by_input_fence_variable_name_context_tag_provider_v.provide
    tag_vnc;;

test_number 5 (
( tag_fcd :
  Localinput_fence_cell_datafile_symbol_t.input_fence_cell_datafile_symbol
  Tag_t.tag ) =
  (Localinput_fence_cell_datafile_symbol_t.Localinput_fence_cell_datafile_constructor
    "test_ao",
   [1; 2; 2; 2; 1; 33; 11])
);;

let sof_fcd = Localinput_fence_cell_datafile_tag_v.string_off tag_fcd;;
