(** {3 Localinput_tag_tree_by_basicname_inputbox_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BLOI:Localinput_tag_tree_by_basicname_inputbox_register_v";
   "Author : François Colonna 29 mars 2017 at 09:12:47+02:00";
 ]
;;
...
let name_of_value val_ =
  Tree_v.name Localinput_tag_v.fullname val_
;;
...
(* done with do_register.sh force on lundi 31 octobre 2016, 14:54:00 (UTC+0100) *)
