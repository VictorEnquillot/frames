(** {3 Localinput_symbol_by_sole_index_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BLOI:Localinput_symbol_by_sole_index_register_v";
 ]
;;

(** {6 Register.} *)

let nam_reg = "Localinput_symbol_by_sole_index_register_v";;
...
let name_of_value val_ =
  Localinput_symbol_v.fullname val_
;;
...
(* done with do_dddd_symbol_by_sole_index_register.sh force on lundi 31 octobre 2016, 14:54:11 (UTC+0100) *)
