(** {3 Localinput_as_context_databox_tag_by_basicname_inputbox_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BLOI:Localinput_as_context_databox_tag_by_basicname_inputbox_provider_v";
...
let build bna_ibo =
  ...
  let sym_loi_lbo = 
    Localinput_symbol_v.localinput_context_inputbox_constructor 
      nam_ibo 
  in

  Tag_v.make sym_loi_lbo soi_lbo
;;
...
(* done with do_provider_without_register.sh Localinput_as_context_databox_tag_by_basicname_inputbox_provider_v.ml force on lundi 31 octobre 2016, 14:54:05 (UTC+0100) *)
