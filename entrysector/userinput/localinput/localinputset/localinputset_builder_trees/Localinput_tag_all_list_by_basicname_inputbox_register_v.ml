(** {3 Localinput_tag_all_list_by_basicname_inputbox_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BLOI:Localinput_tag_all_list_by_basicname_inputbox_register_v";
   "Author : François Colonna 29 mars 2017 at 09:14:22+02:00";
 ]
;;
