(** {3 Basicname_operation_by_basicname_variable_operator_n_basicname_inputbox_register_v} *)

let documentation () = 
  [
   "Current : VARLOI:Basicname_operation_by_basicname_variable_operator_n_basicname_inputbox_register_v";
   "Author : François Colonna 23 avril 2017 at 13:05:23+02:00";
 ]
;;
