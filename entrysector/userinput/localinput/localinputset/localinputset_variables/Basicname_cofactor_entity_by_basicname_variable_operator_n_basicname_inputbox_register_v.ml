(** {3 Basicname_cofactor_entity_by_basicname_variable_operator_n_basicname_inputbox_register_v} *)

let documentation () = 
  [
   "Current : VARLOI:Basicname_cofactor_entity_by_basicname_variable_operator_n_basicname_inputbox_register_v";
   "Author : François Colonna 26 avril 2017 at 10:12:31+02:00";
 ]
;;
