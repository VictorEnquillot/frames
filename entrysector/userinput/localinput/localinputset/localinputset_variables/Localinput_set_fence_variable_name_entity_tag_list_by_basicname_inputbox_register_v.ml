(** {3 Localinput_set_fence_variable_name_entity_tag_list_by_basicname_inputbox_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : VARLOI:Localinput_set_fence_variable_name_entity_tag_list_by_basicname_inputbox_register_v";
   "Author : François Colonna 29 mars 2017 at 08:39:32+02:00";
 ]
;;
...
let register : 
    (Basicname_t.basicname,
     Localinput_set_fence_variable_name_entity_tag_t.localinput_set_fence_variable_name_entity_tag list
    ) 
    Register_t.register = 
