(** {3 Basicname_databox_by_basicname_variable_context_n_basicname_inputbox_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : VARLOI:Basicname_databox_by_basicname_variable_context_n_basicname_inputbox_provider_v";
   ...
   "Register : VARLOI:Basicname_databox_by_basicname_variable_context_n_basicname_inputbox_register_v";
   "Needed-by :"; 
   "What-is-it : for a given Basicname Variable_context it provides its Basicname Databox from its Basicname Variable_context";
...
let build (bna_var_con, bna_ibo) =
  ...
  Basicname_v.basicname_databox_of_string sof_loi_dbo
;;
...
let store (bna_var, bna_ibo) val_ =
  ...
  Basicname_databox_by_basicname_variable_context_n_basicname_inputbox_register_v.store nam_mod (bna_var, bna_ibo) val_;
...
let retrieve (bna_var, bna_ibo) =
  ...
  let pro_cpu = Management_v.entering_of_module_name_of_function_name nam_mod nam_fun in
  let result = Basicname_databox_by_basicname_variable_context_n_basicname_inputbox_register_v.retrieve nam_mod (bna_var, bna_ibo) in
  Management_v.exiting_of_process_times_of_module_name_of_function_name pro_cpu nam_mod nam_fun;
  result
;;
...
let provide_without_trace (bna_var, bna_ibo) =
  if Basicname_databox_by_basicname_variable_context_n_basicname_inputbox_register_v.is_stored (bna_var, bna_ibo)
