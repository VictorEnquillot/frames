(** {3 Localinput_set_fence_variable_name_context_tag_list_by_basicname_inputbox_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : VARLOI:Localinput_set_fence_variable_name_context_tag_list_by_basicname_inputbox_register_v";
   "Needed-by: ";
   "What-is-it: ";
   "How-is-it-done: ";
   "Example: ";
...
let register : 
    (Basicname_t.basicname,
     Localinput_set_fence_variable_name_context_tag_t.localinput_set_fence_variable_name_context_tag list
    ) 
    Register_t.register = 
...
let name_of_value val_ =
  List_v.name
    Localinput_set_fence_variable_name_context_tag_v.fullname 
    val_
;;
