...
let documentation () = 
  [
   "Current : VARLOI:Localinput_set_body_box_type_string_list_by_basicname_variable_n_basicname_inputbox_register_v";
   "Author : François Colonna 09 novembre 2016 at 11:41:03+01:00";
 ]
;;
...
(* done with do_register.sh  on mercredi 9 novembre 2016, 11:44:08 (UTC+0100) *)
