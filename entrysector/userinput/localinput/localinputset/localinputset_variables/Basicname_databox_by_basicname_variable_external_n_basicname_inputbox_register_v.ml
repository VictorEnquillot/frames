(** {3 Basicname_databox_by_basicname_variable_external_n_basicname_inputbox_register_v} *)

let documentation () = 
  [
   "Current : VARLOI:Basicname_databox_by_basicname_variable_external_n_basicname_inputbox_register_v";
