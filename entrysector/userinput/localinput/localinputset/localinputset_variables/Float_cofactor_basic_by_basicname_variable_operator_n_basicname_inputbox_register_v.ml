(** {3 Float_cofactor_basic_by_basicname_variable_operator_n_basicname_inputbox_register_v} *)

let documentation () = 
  [
   "Current : VARLOI:Float_cofactor_basic_by_basicname_variable_operator_n_basicname_inputbox_register_v";
   "Author : François Colonna 31 mai 2017 at 09:15:49+02:00";
