...
testing "Localinput_as_body_handle_command_unit_print_tag_subtree_list_by_basicname_inputbox_provider_v with
...
(* toplevel 
   #use "Localinput_as_body_handle_command_unit_print_tag_subtree_list_by_basicname_inputbox_provider_u_point_homothety.ml";; 
...
open Localinput_as_body_handle_command_unit_print_tag_subtree_list_by_basicname_inputbox_provider_v;;

let tag_loi_lhc_stl =
    Localinput_as_body_handle_command_tag_subtree_list_by_basicname_inputbox_provider_v.provide 
    nam_ibo;;

let pre_tag_lcu (s, i) = Localinput_symbol_v.is_localinput_body_handle_command_unit_print_symbol_off_localinput_symbol s;;
