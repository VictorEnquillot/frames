...
testing "Localinput_fence_variable_name_entity_tag_by_localinput_fence_cell_target_operand_tag_provider_v with
...
(* toplevel 
   #use "Localinput_fence_variable_name_entity_tag_by_localinput_fence_cell_target_operand_tag_provider_u_point_homothety.ml";; 
...
let tag_cto_l = 
  Localinput_fence_cell_target_operand_tag_list_by_basicname_inputbox_provider_v.provide
      fno_inp;;
...
let nam_var = "Poi_a";;
let pre_tag_cto_sof sof (s, i) = Localinput_fence_cell_target_operand_symbol_v.localinput_fence_cell_target_operand_constructor sof = s;;
...
open Localinput_fence_variable_name_entity_tag_by_localinput_fence_cell_target_operand_tag_provider_v;;
...
let pre_tag_vne_sof sof (s, i) = 
    (Localinput_fence_variable_name_entity_symbol_v.localinput_fence_variable_name_entity_external_constructor sof = s) 
  ||
    (Localinput_fence_variable_name_entity_symbol_v.localinput_fence_variable_name_entity_target_constructor sof = s) 
;;

let tag_vne = List_v.only_element_of_predicate_off_list (pre_tag_vne_sof sof_cto) tag_vne_l;;

test_number 5 (
(tag_vne : Localinput_fence_variable_name_entity_symbol_t.localinput_fence_variable_name_entity_symbol
   Tag_t.tag )
  =
(Localinput_fence_variable_name_entity_symbol_t.Localinput_fence_variable_name_entity_external_symbol
   (Localinput_fence_variable_name_entity_external_symbol_t.Localinput_fence_variable_name_entity_external_constructor
