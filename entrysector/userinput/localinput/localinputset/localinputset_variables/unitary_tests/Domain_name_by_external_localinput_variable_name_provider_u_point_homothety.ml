...
testing "Domain_name_by_external_localinput_variable_name_provider_v with
...
(* toplevel 
   #use "Domain_name_by_external_localinput_variable_name_provider_u_point_homothety.ml";; 
...
let nam_dom = Domain_name_by_external_localinput_variable_name_provider_v.provide nam_iva;;
