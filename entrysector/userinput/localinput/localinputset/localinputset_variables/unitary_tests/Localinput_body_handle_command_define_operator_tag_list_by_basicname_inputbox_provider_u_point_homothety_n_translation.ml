...
testing "Localinput_body_handle_command_define_operator_tag_list_by_basicname_inputbox_provider_v with
...
(* toplevel 
   #use "Localinput_body_handle_command_define_operator_tag_list_by_basicname_inputbox_provider_u_point_homothety_n_translation.ml";;
...
open Localinput_body_handle_command_define_operator_tag_list_by_basicname_inputbox_provider_v;;

let tag_loi_cde_stl = 
    Localinput_body_handle_command_define_tag_subtree_list_by_basicname_inputbox_provider_v.provide
      nam_ibo;;

let tag_pre_tre =
  let pre_lea t = Localinput_symbol_v.is_localinput_variable_name_constructor (Tag_v.entity_off_tag t) in
  let pre_nod t = Localinput_symbol_v.is_localinput_keyword_operator (Tag_v.entity_off_tag t)in
  Tree_v.has_a_topson_leaf_and_a_topson_node_of_leaf_predicate_of_node_predicate_off_tree pre_lea pre_nod 
;;

let tag_loi_pro_stl = List.filter 
    tag_pre_tre
    tag_loi_cde_stl;;

test_number 1 (
( tag_loi_pro_stl : Localinput_symbol_t.localinput_symbol Tag_t.tag Tree_t.tree list ) =
  [Tree_t.Inner
...
let len = List.length tag_loi_pro_stl;;
...
let tag_loi_pro_l = Localinput_body_handle_command_define_operator_tag_list_by_basicname_inputbox_provider_v.provide nam_ibo;;

test_number 3 (
(tag_loi_pro_l : Localinput_symbol_t.localinput_symbol Tag_t.tag list ) =
  [(Localinput_symbol_t.Localinput_body_handle_command_symbol
     Localinput_body_handle_command_symbol_t.Localinput_command_define,
    [3; 28]);
   (Localinput_symbol_t.Localinput_body_handle_command_symbol
