...
testing "Localinput_body_box_type_string_list_by_localinput_fence_variable_name_entity_tag_provider_v with
...
(* toplevel 
   #use "Localinput_body_box_type_string_list_by_localinput_fence_variable_name_entity_tag_provider_u_point_homothety.ml";; 
...
open Localinput_body_box_type_string_list_by_localinput_fence_variable_name_entity_tag_provider_v;;
...
let tag_loi_vne = List_v.only_element_of_predicate_off_list (pre_tag_vne_sof sof_vne) tag_loi_l;;
...
let tag_loi_bbt = Tree_v.only_node_of_node_predicate_off_tree 
      (pre_tag_bbt_sof sof_vne) 
      tag_loi_lcd_st;;

let tag_bbt = (* Coerce Down *) 
    Localinput_body_box_type_tag_v.localinput_body_box_type_tag_off_localinput_tag 
      tag_loi_bbt;;

let str_l = Localinput_body_box_type_string_list_by_localinput_body_box_type_tag_provider_v.provide tag_bbt;;

test_number 4 (
(str_l : string list ) = 
["user"; "fence"; "point"; "constructor"]
);; 

test_number 5 (
str_l = provide tag_vne
);;
