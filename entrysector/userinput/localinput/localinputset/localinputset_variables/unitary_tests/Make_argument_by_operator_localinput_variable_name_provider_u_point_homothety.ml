...
testing "Make_argument_by_operator_localinput_variable_name_provider_v with
...
(* toplevel 
   #use "Make_argument_by_operator_localinput_variable_name_provider_u_point_homothety.ml";; 
...
test_number 2 (
(sym_inp_cde_t : Localinput_symbol_t.localinput_symbol Tree_t.tree ) =
  Tree_t.Inner
...
let sym_inp_con_t = 
    Tree_v.subtree_of_node_predicate_off_tree 
      Localinput_symbol_v.is_localinput_keyword_operator
      sym_inp_cde_t;;

test_number 3 (
(sym_inp_con_t : Localinput_symbol_t.localinput_symbol Tree_t.tree ) =
  Tree_t.Inner
   (Localinput_symbol_t.Localinput_keyword_symbol
     (Localinput_keyword_symbol_t.Localinput_keyword_operator_symbol
       Localinput_keyword_operator_symbol_t.Localinput_keyword_operator_constructor),
...
let sym_inp_typ_t = 
    Tree_v.subtree_of_node_predicate_off_tree 
      Localinput_symbol_v.is_localinput_keyword_type
      sym_inp_cde_t;;

test_number 4 (
( sym_inp_typ_t : Localinput_symbol_t.localinput_symbol Tree_t.tree ) =
  Tree_t.Inner
   (Localinput_symbol_t.Localinput_keyword_symbol
     Localinput_keyword_symbol_t.Localinput_keyword_type,
   [Tree_t.Leaf
...
let sym_inp_bas_st = Tree_v.subtree_of_node_predicate_off_tree Localinput_symbol_v.is_localinput_basic_string sym_inp_con_t;;

test_number 5 (
( sym_inp_bas_st : Localinput_symbol_t.localinput_symbol Tree_t.tree ) =
  Tree_t.Leaf
   (Localinput_symbol_t.Localinput_basic_symbol
     (Localinput_basic_symbol_t.Localinput_basic_string "Cen_b"))
);;

let nam_mak = Make_argument_by_operator_localinput_variable_name_provider_v.provide nam_ivn;;

test_number 6 (
(nam_mak : string ) = 
"operator_transformation_homothety Hom_b_2"
);;
