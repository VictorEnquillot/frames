...
(* toplevel 
   #use "Domain_name_by_context_localinput_variable_name_provider_u_print.ml";; 
...
let sym_dom = Domain_name_by_context_localinput_variable_name_provider_v.provide nam_ivn;;
