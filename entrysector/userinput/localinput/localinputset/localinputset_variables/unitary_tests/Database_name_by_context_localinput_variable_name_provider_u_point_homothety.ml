...
testing "Database_name_by_context_localinput_variable_name_provider_v with
...
(* toplevel 
   #use "Database_name_by_context_localinput_variable_name_provider_u_point_homothety.ml";; 
...
let boo = Tree_v.has_node_of_node_predicate_off_tree Localinput_symbol_v.is_localinput_keyword_database sym_inp_cde_t;;
...
let sym_inp_iba_t = 
    Tree_v.subtree_of_node_predicate_off_tree 
      Localinput_symbol_v.is_localinput_keyword_database
      sym_inp_cde_t;;
...
let sym_inp_lea_l = Tree_v.subtree_of_node_predicate_off_tree Localinput_symbol_v.is_localinput_basic_string sym_inp_iba_t;;
...
let sym_iba = Database_name_by_context_localinput_variable_name_provider_v.provide nam_ivn;;
