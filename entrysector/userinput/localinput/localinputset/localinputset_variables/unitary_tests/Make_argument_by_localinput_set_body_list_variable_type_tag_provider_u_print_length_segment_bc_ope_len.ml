...
testing "Make_argument_by_localinput_set_body_list_variable_type_tag_provider_v
        Make_argument_by_localinput_set_body_list_variable_type_tag_provider_u_print_length_segment_bc_ope_len.ml";;
...
(* toplevel 
   #use "Make_argument_by_localinput_set_body_list_variable_type_tag_provider_u_print_length_segment_bc_ope_len.ml";;
...
test_number 3 (
(str_l : string list) =
  ["operator"; "set"; "body"; "creation"; "tomeasure"; "constructor"]
);;
...
test_number 4 (
(str_arg : string ) = 
"operator_set_body_creation_tomeasure_constructor"
);;
