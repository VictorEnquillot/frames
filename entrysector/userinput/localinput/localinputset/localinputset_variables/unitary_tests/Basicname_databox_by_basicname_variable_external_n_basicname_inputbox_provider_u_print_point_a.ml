...
testing "Basicname_databox_by_basicname_variable_external_n_basicname_inputbox_provider_v
        Basicname_databox_by_basicname_variable_external_n_basicname_inputbox_provider_u_print_point_a.ml";;
...
(* toplevel 
   #use "Basicname_databox_by_basicname_variable_external_n_basicname_inputbox_provider_u_print_point_a.ml";;
...
(bna_ext_con : Basicname_t.basicname ) =
  Basicname_t.External_context "Con_a"
);;
...
(bna_var_con : Basicname_t.basicname ) =
  Basicname_t.Variable_context "Con_a"
);;
