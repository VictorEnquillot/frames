...
testing "Localinput_as_local_variable_free_referenced_tag_list_by_basicname_inputbox_provider_v with
...
(* toplevel 
   #use "Localinput_as_local_variable_free_referenced_tag_list_by_basicname_inputbox_provider_u_point_homothety.ml";; 
...
let nam_ibo = Filename_p.filename nam_ibo;;

let tag_loi_def_stl = Localinput_as_body_handle_command_define_tag_subtree_list_by_basicname_inputbox_provider_v.provide nam_ibo;;
let sym_inp_def_stl = List.map (Tree_v.map Tag_v.entity_off_tag) tag_loi_def_stl;;
...
let tag_loi_def_st = List.nth tag_loi_def_stl 0;;

test_number 2 (
tag_loi_def_st
(* : Localinput_symbol_t.localinput_entity_symbol Tree_t.tree *)
=
  Tree_t.Inner
   ((Localinput_symbol_t.Localinput_local_symbol
      (Localinput_local_symbol_t.Localinput_local_command_symbol
...
let tag_loi_lvf_l = Localinput_as_local_variable_free_tag_list_by_basicname_inputbox_provider_v.provide nam_ibo;;
...
let tag_loi_vfd_l = Localinput_as_local_variable_free_defined_tag_list_by_basicname_inputbox_provider_v.provide nam_ibo;;
...
let tag_loi_vfr_l = Localinput_as_local_variable_free_referenced_tag_list_by_basicname_inputbox_provider_v.provide nam_ibo;;
