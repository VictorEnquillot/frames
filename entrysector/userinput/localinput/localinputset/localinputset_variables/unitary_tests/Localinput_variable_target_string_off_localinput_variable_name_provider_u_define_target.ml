...
testing "Localinput_variable_target_string_off_by_localinput_variable_name_provider_v with
...
(* toplevel 
   #use "Localinput_variable_target_string_off_localinput_variable_name_provider_u_define_target.ml";; 
...
let str_l = String_off_in_database_by_external_localinput_variable_name_provider_v.provide nam_ivn;;
