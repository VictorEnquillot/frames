...
let tag_com_l = Tree_v.node_list_of_node_predicate_off_tree pre_tag_com tag_loi_t;;

test_number 2 (
(tag_com_l : Localinput_symbol_t.localinput_symbol Tag_t.tag list ) =
...
let tag_vna_l = Tree_v.node_list_of_node_predicate_off_tree pre_tag_vna tag_loi_t;;

test_number 3 (
(tag_vna_l : Localinput_symbol_t.localinput_symbol Tag_t.tag list ) =
...
let pre_nod_sof sof = 
    (fun (s, i) ->
      (Localinput_symbol_v.is_localinput_body_block_variable_external_constructor s) && (Localinput_symbol_v.string_off s = sof)
    );;

let tag_loi_cen_b_st = (Tree_v.subtree_find_of_node_predicate_off_tree (pre_nod_sof "Cen_b")) tag_loi_t;;

test_number 4 (
( tag_loi_cen_b_st : Localinput_symbol_t.localinput_symbol Tag_t.tag Tree_t.tree ) =
Tree_t.Inner
   ((Localinput_symbol_t.Localinput_body_symbol
...
let tag_loi_cen_b_fl = Tree_v.leaf_node_list_off_tree tag_loi_cen_b_st;;

test_number 5 (
( tag_loi_cen_b_fl : Localinput_symbol_t.localinput_symbol Tag_t.tag list ) =
  [(Localinput_symbol_t.Localinput_fence_symbol
     (Localinput_fence_symbol_t.Localinput_fence_keyword_symbol
       (Localinput_fence_keyword_symbol_t.Localinput_fence_keyword_word_symbol
         (Localinput_fence_keyword_word_symbol_t.Localinput_fence_keyword_word_type_symbol
...
let pre_tag_hvo_sof sof (s, i) = (Localinput_symbol_v.localinput_body_handle_variable_operator_constructor sof = s);;

let tag_loi_hvo_st = Tree_v.subtree_of_node_predicate_off_tree (pre_tag_hvo_sof "Hom_b_2") tag_loi_t;;

let sym_inp_hvo_st = Tree_v.map Tag_v.entity_off_tag tag_loi_hvo_st;;

test_number 6 (
(sym_inp_hvo_st : Localinput_symbol_t.localinput_symbol Tree_t.tree ) =
Tree_t.Inner
 (Localinput_symbol_t.Localinput_body_symbol
   (Localinput_body_symbol_t.Localinput_body_handle_symbol
...
let tag_loi_bty_st = Tree_v.subtree_of_node_predicate_off_tree pre_tag_bty tag_loi_hvo_st;;
...
let tag_loi_bwl_l = Tree_v.node_list_of_node_predicate_off_tree  pre_tag_bwl  tag_loi_bty_st;;
