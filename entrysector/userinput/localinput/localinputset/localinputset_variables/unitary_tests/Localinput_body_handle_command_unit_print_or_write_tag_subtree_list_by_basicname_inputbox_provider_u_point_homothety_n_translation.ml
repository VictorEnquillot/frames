...
(* toplevel 
   #use "Localinput_body_handle_command_unit_print_or_write_tag_subtree_list_by_basicname_inputbox_provider_u_point_homothety_n_translation.ml";; 
...
tag_loi_pow_stl
=
Localinput_body_handle_command_unit_print_or_write_tag_subtree_list_by_basicname_inputbox_provider_v.provide nam_ibo
);;
