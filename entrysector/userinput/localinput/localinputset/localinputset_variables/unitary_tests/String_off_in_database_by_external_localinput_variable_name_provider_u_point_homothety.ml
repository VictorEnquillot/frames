...
(* toplevel 
   #use "String_off_in_database_by_external_localinput_variable_name_provider_u_point_homothety.ml";; 
...
let sym_inp_con_t = 
    Tree_v.subtree_of_node_predicate_off_tree 
      Localinput_symbol_v.is_localinput_keyword_external
      sym_inp_cde_t;;
...
let sym_inp_dom_t = 
    Tree_v.subtree_of_node_predicate_off_tree 
      Localinput_symbol_v.is_localinput_keyword_name
      sym_inp_cde_t;;
...
let sym_dom = String_off_in_database_by_external_localinput_variable_name_provider_v.provide nam_iva;;
