...
testing "Scale_factor_name_by_operator_localinput_variable_name_provider_v with
...
(* toplevel 
   #use "Scale_factor_name_by_operator_localinput_variable_name_provider_u_point_homothety.ml";; 
...
let sym_inp_dom_t = 
    Tree_v.subtree_of_node_predicate_off_tree 
      Localinput_symbol_v.is_localinput_keyword_scale_factor
      sym_inp_cde_t;;
...
let sym_inp_lea_l = Tree_v.subtree_of_node_predicate_off_tree Localinput_symbol_v.is_localinput_basic_float sym_inp_dom_t;;
...
let sym_dom = Scale_factor_name_by_operator_localinput_variable_name_provider_v.provide nam_iva;;
