...
testing "Localinput_as_variable_external_symbol_by_localinput_variable_name_provider_v with
...
(* toplevel 
   #use "Localinput_as_variable_external_symbol_by_localinput_variable_name_provider_u_define_external.ml";; 
...
let sym_inp = Localinput_as_variable_external_symbol_by_localinput_variable_name_provider_v.provide nam_ivn;;
