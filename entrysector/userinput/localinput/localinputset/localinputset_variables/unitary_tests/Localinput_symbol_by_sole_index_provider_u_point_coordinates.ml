...
let bna_ibo = Basicname_v.basicname_inputbox_of_string "/keep/sources/ocaml_top/setup/frames/figureset/functional_tests/point_coordinates";;
...
let str = (Parameters_figureset_localinput_by_string_trio_register_v.dump ());;
