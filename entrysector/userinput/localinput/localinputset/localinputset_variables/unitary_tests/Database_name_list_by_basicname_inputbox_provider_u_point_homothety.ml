...
let nam_con_l = Context_name_list_by_basicname_inputbox_provider_v.provide nam_ibo;;
...
let nam_con_ok_l =
    List.filter 
     Database_name_by_context_localinput_variable_name_provider_v.has_database_of_context_localinput_variable_name 
      nam_con_l;;
...
let nam_iba_l = List.map
    Database_name_by_context_localinput_variable_name_provider_v.provide
    nam_con_ok_l;;
...
let nam_iba_l = Database_name_list_by_basicname_inputbox_provider_v.provide nam_ibo;;
