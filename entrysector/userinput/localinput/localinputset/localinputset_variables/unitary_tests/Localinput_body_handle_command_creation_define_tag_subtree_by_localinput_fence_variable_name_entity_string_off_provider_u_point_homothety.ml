...
testing "Localinput_body_handle_command_creation_define_tag_subtree_by_localinput_fence_variable_name_entity_string_off_provider_v with
...
Trace_what_by_module_name_register_v.store "Localinput_body_handle_command_creation_define_tag_subtree_by_localinput_fence_variable_name_entity_string_off_provider_v" "cpu";;

(* Debuging *)

(* toplevel 
   #use "Localinput_body_handle_command_creation_define_tag_subtree_by_localinput_fence_variable_name_entity_string_off_provider_u_point_homothety.ml";; 
...
open Localinput_body_handle_command_creation_define_tag_subtree_by_localinput_fence_variable_name_entity_string_off_provider_v;;
