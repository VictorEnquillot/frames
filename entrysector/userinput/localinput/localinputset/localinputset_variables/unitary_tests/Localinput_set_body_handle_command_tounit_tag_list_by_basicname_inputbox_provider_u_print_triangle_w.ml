...
testing "Localinput_set_body_handle_command_tounit_tag_list_by_basicname_inputbox_provider_v
        Localinput_set_body_handle_command_tounit_tag_list_by_basicname_inputbox_provider_u_print_triangle_w.ml";;
...
(* toplevel 
   #use "Localinput_set_body_handle_command_tounit_tag_list_by_basicname_inputbox_provider_u_print_triangle_w.ml";;

*)

open Localinput_set_body_handle_command_tounit_tag_list_by_basicname_inputbox_provider_v;;

let bna_ibo = Basicname_v.basicname_inputbox_of_string "Print_triangle_w";;
