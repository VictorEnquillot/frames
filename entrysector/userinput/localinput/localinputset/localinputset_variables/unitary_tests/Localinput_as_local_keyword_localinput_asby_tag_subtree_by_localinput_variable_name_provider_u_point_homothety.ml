...
testing "Localinput_as_local_keyword_localinput_asby_tag_subtree_by_localinput_variable_name_provider_v with
...
(* toplevel 
   #use "Localinput_as_local_keyword_localinput_asby_tag_subtree_by_localinput_variable_name_provider_u_point_homothety.ml";;
...
let tag_loi_asby_stl = List.map Localinput_as_local_keyword_localinput_asby_tag_subtree_by_localinput_variable_name_provider_v.provide nam_iev_l;;

(* H_b_2 *)

let nam_iev = "H_b_2";;
let tag_loi_asby_st = List.nth tag_loi_asby_stl 2;;
...
let nam_iev = "P_h_val";;
let tag_loi_asby_st = List.nth tag_loi_asby_stl 3;;
