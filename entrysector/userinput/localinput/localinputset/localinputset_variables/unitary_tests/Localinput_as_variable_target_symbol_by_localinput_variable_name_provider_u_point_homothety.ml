...
testing "Localinput_as_variable_target_symbol_by_localinput_variable_name_provider_v with
...
(* toplevel 
   #use "Localinput_as_variable_target_symbol_by_localinput_variable_name_provider_u_point_homothety.ml";; 
...
let sof_inp_mak = 
    Make_argument_by_target_localinput_variable_name_provider_v.provide
      nam_ivn;;
...
let sym_inp = Localinput_as_variable_target_symbol_by_localinput_variable_name_provider_v.provide nam_ivn;;

test_number 5 (
(sym_inp : Localinput_symbol_t.localinput_symbol ) =
  Localinput_symbol_t.Localinput_variable_symbol
