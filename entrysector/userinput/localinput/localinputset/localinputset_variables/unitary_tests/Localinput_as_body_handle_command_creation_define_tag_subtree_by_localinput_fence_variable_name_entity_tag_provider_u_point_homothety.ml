...
testing "Localinput_as_body_handle_command_creation_define_tag_subtree_by_localinput_fence_variable_name_entity_tag_provider_v with
...
(* toplevel 
   #use "Localinput_as_body_handle_command_creation_define_tag_subtree_by_localinput_fence_variable_name_entity_tag_provider_u_point_homothety.ml";; 
*)
...
open Localinput_as_body_handle_command_creation_define_tag_subtree_by_localinput_fence_variable_name_entity_tag_provider_v;;
