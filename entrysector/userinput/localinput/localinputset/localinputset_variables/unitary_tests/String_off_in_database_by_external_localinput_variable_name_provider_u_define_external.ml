...
testing "String_off_in_database_by_external_localinput_variable_name_provider_v with
...
(* toplevel 
   #use "String_off_in_database_by_external_localinput_variable_name_provider_u_define_external.ml";; 
...
let nam_ivn = "Poi_a";;
let tag_loi_cde_st = Localinput_as_body_handle_command_define_tag_subtree_by_localinput_variable_name_provider_v.provide nam_ivn;;
...
let sym_inp_cde_st = Tree_v.map Tag_v.entity_off_tag tag_loi_cde_st;;

let sof_ivn = String_off_in_database_by_external_localinput_variable_name_provider_v.provide nam_ivn;;
...
let sym_inp = Tree_v.leaf_of_leaf_predicate_of_node_predicate_off_tree Localinput_symbol_v.is_localinput_basic_string Localinput_symbol_v.is_localinput_keyword_name sym_inp_cde_st;;
