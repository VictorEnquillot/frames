...
testing "Localinput_variable_name_list_by_localinput_entity_as_property_subentity_symbol_predicate_n_as_variable_name_provider_v with
...
(* toplevel 
   #use "Localinput_variable_name_list_by_localinput_entity_as_property_subentity_symbol_predicate_n_as_variable_name_provider_u_point_homothety.ml";; 
...
open Localinput_variable_name_list_by_localinput_entity_as_property_subentity_symbol_predicate_n_as_variable_name_provider_v;;

let sym_cen_pre = Localinput_symbol_v.is_localinput_entity_property_center;;
let tag_loi_sub_st =
    input_entity_as_property_subentity_tag_tree_of_subpredicate_localinput_variable_name
      sym_cen_pre
      nam_iev;;
...
let nam_iev_cen_l = string_list_of_topson_leaf_predicate_off_symbol_tree
    Localinput_symbol_v.is_localinput_entity_local_variable_free 
    sym_inp_sub_st;;
...
let nam_iev_cen_l = Localinput_variable_name_list_by_localinput_entity_as_property_subentity_symbol_predicate_n_as_variable_name_provider_v.provide (sym_cen_pre, nam_iev);;
