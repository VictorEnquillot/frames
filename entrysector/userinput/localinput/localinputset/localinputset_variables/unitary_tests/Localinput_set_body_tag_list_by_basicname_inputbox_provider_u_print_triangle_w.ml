...
testing "Localinput_set_body_tag_list_by_basicname_inputbox_provider_v with
        Localinput_set_body_tag_list_by_basicname_inputbox_provider_u_print_triangle_w.ml";;
...
(* toplevel 
   #use "Localinput_set_body_tag_list_by_basicname_inputbox_provider_u_print_triangle_w.ml";; 
