...
testing "Localinput_as_body_handle_command_unit_tag_entity_implicit_subtree_list_by_basicname_inputbox_provider_v with
...
(* toplevel 
   #use "Localinput_as_body_handle_command_unit_tag_entity_implicit_subtree_list_by_basicname_inputbox_provider_u_point_homothety.ml";; 
...
open Localinput_as_body_handle_command_unit_tag_entity_implicit_subtree_list_by_basicname_inputbox_provider_v;; 

let tag_loi_lcu_stl =
    Localinput_as_body_handle_command_unit_tag_subtree_list_by_basicname_inputbox_provider_v.provide 
      nam_ibo;;
