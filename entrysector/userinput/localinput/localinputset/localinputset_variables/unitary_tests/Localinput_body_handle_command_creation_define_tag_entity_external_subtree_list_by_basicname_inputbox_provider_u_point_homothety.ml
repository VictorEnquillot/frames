...
testing "Localinput_body_handle_command_creation_define_tag_entity_external_subtree_list_by_basicname_inputbox_provider_v with
...
(* toplevel 
   #use "Localinput_body_handle_command_creation_define_tag_entity_external_subtree_list_by_basicname_inputbox_provider_u_point_homothety.ml";; 
...
open Localinput_body_handle_command_creation_define_tag_entity_external_subtree_list_by_basicname_inputbox_provider_v;; 
