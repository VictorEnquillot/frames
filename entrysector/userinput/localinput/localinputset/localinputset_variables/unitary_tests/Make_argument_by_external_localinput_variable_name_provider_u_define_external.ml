...
testing "Make_argument_by_external_localinput_variable_name_provider_v with
...
(* toplevel 
   #use "Make_argument_by_external_localinput_variable_name_provider_u_define_external.ml";; 
...
let str_typ_l = Localinput_variable_type_string_list_by_localinput_variable_name_provider_v.provide nam_iev;;
...
let str_ivx = Make_argument_by_external_localinput_variable_name_provider_v.provide nam_iev;;
