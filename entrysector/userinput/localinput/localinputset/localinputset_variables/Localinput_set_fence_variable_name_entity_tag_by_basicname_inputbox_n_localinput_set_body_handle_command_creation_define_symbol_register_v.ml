(** {3 Localinput_set_fence_variable_name_entity_tag_by_basicname_inputbox_n_localinput_set_fence_variable_name_entity_symbol_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : VARLOI:Localinput_set_fence_variable_name_entity_tag_by_basicname_inputbox_n_localinput_set_fence_variable_name_entity_symbol_register_v";
   "Needed-by: ";
   "What-is-it: ";
   "How-is-it-done: ";
   "Example: ";
...
let register : 
    ((string, Localinput_set_fence_variable_name_entity_symbol_t.localinput_set_fence_variable_name_entity_symbol) Doublet_t.doublet,
     Localinput_set_fence_variable_name_entity_tag_t.localinput_set_fence_variable_name_entity_tag
    ) 
    Register_t.register = 
...
let name_of_key key =
  Doublet_v.name (fun s->s) Localinput_set_fence_variable_name_entity_symbol_v.fullname key
;;

let name_of_value val_ =
    Localinput_set_fence_variable_name_entity_tag_v.fullname 
    val_
;;
