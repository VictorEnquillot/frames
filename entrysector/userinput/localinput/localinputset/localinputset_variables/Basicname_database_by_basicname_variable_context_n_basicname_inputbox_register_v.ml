(** {3 Basicname_database_by_basicname_variable_context_n_basicname_inputbox_register_v} *)

let documentation () = 
  [
   "Current : VARLOI:Basicname_database_by_basicname_variable_context_n_basicname_inputbox_register_v";
