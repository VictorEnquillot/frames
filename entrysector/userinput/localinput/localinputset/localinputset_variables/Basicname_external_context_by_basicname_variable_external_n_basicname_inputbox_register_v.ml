(** {3 Basicname_external_context_by_basicname_variable_external_n_basicname_inputbox_register_v} *)

let documentation () = 
  [
   "Current : VARLOI:Basicname_external_context_by_basicname_variable_external_n_basicname_inputbox_register_v";
   "Author : François Colonna 25 avril 2017 at 11:53:27+02:00";
 ]
;;
...
let name_of_key key =
  Duo_v.name Basicname_v.stringedname key
;;

let name_of_value val_ =
  Basicname_v.stringedname val_
;;
...
(* done with do_register.sh on vendredi 20 mai 2016, 13:40:56 (UTC+0200) *)
