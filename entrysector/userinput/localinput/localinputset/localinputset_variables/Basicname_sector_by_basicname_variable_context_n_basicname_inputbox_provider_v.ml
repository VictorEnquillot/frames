(** {3 Basicname_sector_by_basicname_variable_context_n_basicname_inputbox_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : VARLOI:Basicname_sector_by_basicname_variable_context_n_basicname_inputbox_provider_v";
   ...
   "Register : VARLOI:Basicname_sector_by_basicname_variable_context_n_basicname_inputbox_register_v";
   "Needed-by :"; 
   "What-is-it : for a given Basicname Variable_context it provides its Basicname Sector from its Basicname Variable_context";
...
let build (bna_var_con, bna_ibo) =
  ...
  let tag_loi_dbo = Tree_v.only_node_of_node_predicate_off_tree
      (fun (s, i) -> 
        Localinput_symbol_v.is_localinput_set_fence_cell_sector_symbol_off_localinput_symbol s)
      tag_loi_lcd_st 
  in
  
  let sof_loi_dbo = Localinput_tag_v.string_off tag_loi_dbo in

  Basicname_v.basicname_sector_of_string sof_loi_dbo
;;
