(** {3 Localinput_as_set_fence_cell_target_operator_tag_by_localinput_set_fence_variable_name_entity_target_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : VARLOI:Localinput_as_set_fence_cell_target_operator_tag_by_localinput_set_fence_variable_name_entity_target_provider_v";
   ...
   "How-is-it-done : and extracting Leaf Localinput_set_fence_cell_target_operator_constructor from it";
 ]
;;
...
let build tag_net =
  ...
  let tag_loi_lcd = Tag_v.map_entity 
      ...
      tag_lcd
  in
  let tag_lcd_st = Localinput_tag_subtree_by_localinput_tag_provider_v.provide tag_loi_lcd in
  
  let pre_tag_cto (s, i) = 
    Localinput_symbol_v.is_localinput_set_fence_cell_target_operator_symbol_off_localinput_symbol s 
  in
  
  let tag_loi_cto = Tree_v.only_node_of_node_predicate_off_tree pre_tag_cto tag_lcd_st in

  Localinput_set_fence_cell_target_operator_tag_v.localinput_set_fence_cell_target_operator_tag_off_localinput_tag tag_loi_cto
;;
