(** {3 Basicname_ondomain_by_basicname_variable_operator_n_basicname_inputbox_register_v} *)

let documentation () = 
  [
   "Current : VARLOI:Basicname_ondomain_by_basicname_variable_operator_n_basicname_inputbox_register_v";
