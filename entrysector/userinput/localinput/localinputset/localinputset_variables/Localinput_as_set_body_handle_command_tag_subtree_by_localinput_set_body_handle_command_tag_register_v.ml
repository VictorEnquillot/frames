(** {3 Localinput_as_set_body_handle_command_tag_subtree_by_localinput_set_body_handle_command_tag_register} *)

let documentation () = 
  [
   "Current : VARLOI:Localinput_as_set_body_handle_command_tag_subtree_by_localinput_set_body_handle_command_tag_register_v";
 ]
;;
...
let register : 
    (Localinput_set_body_handle_command_tag_t.localinput_set_body_handle_command_tag, 
     Localinput_tag_t.localinput_tag Tree_t.tree) 
    Register_t.register
     = 
...
let name_of_key key =
  Localinput_set_body_handle_command_tag_v.fullname key 
;;

let name_of_value val_ =
  Tree_v.name_with_separator 
    Localinput_tag_v.fullname ";\n  " ";\n   "
    val_
;;
...
(* done with do_register.sh on vendredi 20 mai 2016, 13:40:55 (UTC+0200) *)
