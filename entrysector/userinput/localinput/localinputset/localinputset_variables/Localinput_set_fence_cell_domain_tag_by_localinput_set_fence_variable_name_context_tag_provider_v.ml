(** {3 Localinput_set_fence_cell_domain_tag_by_localinput_set_fence_variable_name_context_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : VARLOI:Localinput_set_fence_cell_domain_tag_by_localinput_set_fence_variable_name_context_provider_v";
   ...
   "How-is-it-done : and extracting Leaf Localinput_set_fence_cell_domain_constructor from it";
...
let build tag_lvc =
  ...
  let pre_tag_fcd (s, i) = Localinput_symbol_v.is_localinput_set_fence_cell_domain_constructor s in
  
  let tag_loi_fcd = Tree_v.only_node_of_node_predicate_off_tree pre_tag_fcd tag_loi_lcd_st in

(* Coerce Down *)
  Localinput_set_fence_cell_domain_tag_v.localinput_set_fence_cell_domain_tag_off_localinput_tag tag_loi_fcd 
;;
