(** {3 Localinput_set_body_box_type_string_list_by_localinput_set_fence_variable_name_entity_tag_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : VARLOI:Localinput_set_body_box_type_string_list_by_localinput_set_fence_variable_name_entity_tag_provider_v";
...
let build tag_lne =
  let nam_var = Localinput_set_fence_variable_name_entity_tag_v.string_off tag_lne in
