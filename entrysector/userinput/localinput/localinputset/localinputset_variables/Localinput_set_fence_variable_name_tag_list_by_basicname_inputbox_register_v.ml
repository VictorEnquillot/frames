...
let documentation () = 
  [
   "Current : VARLOI:Localinput_set_fence_variable_name_tag_list_by_basicname_inputbox_register_v";
   "Author : François Colonna 08 novembre 2016 at 17:28:55+01:00";
 ]
;;
...
let register : 
    (Basicname_t.basicname,
     Localinput_set_fence_variable_name_tag_t.localinput_set_fence_variable_name_tag list
    ) 
    Register_t.register = 
...
let name_of_value val_ =
  List_v.name
    Localinput_set_fence_variable_name_tag_v.fullname 
    val_
;;
