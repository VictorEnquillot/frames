(** {3 Localinput_set_fence_cell_sector_tag_by_localinput_set_fence_variable_name_context_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : VARLOI:Localinput_set_fence_cell_sector_tag_by_localinput_set_fence_variable_name_context_provider_v";
   ...
   "How-is-it-done : and extracting Leaf Localinput_set_fence_cell_sector_constructor from it";
   "Author : François Colonna 29 mars 2017 at 11:25:10+02:00";
 ]
;;
...
let build tag_lvc =
  ...
  let nam_ibo = Inputbox_name_by_any_sole_index_provider_v.provide soi_lvc in
  ...
  let pre_tag_fcd (s, i) = Localinput_symbol_v.is_localinput_set_fence_cell_sector_constructor s in
  
  let tag_loi_fcd = Tree_v.only_node_of_node_predicate_off_tree pre_tag_fcd tag_loi_lcd_st in

(* Coerce Down *)
  Localinput_set_fence_cell_sector_tag_v.localinput_set_fence_cell_sector_tag_off_localinput_tag tag_loi_fcd 
;;
