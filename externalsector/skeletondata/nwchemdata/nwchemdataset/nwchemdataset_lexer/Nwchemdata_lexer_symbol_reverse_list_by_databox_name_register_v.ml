(** {3 Nwchemdata_lexer_symbol_reverse_list_by_databox_name_register_v} *)

(** {6 Documenting} *)

let documentation () = 
[
  "Current : LEXNWC:Nwchemdata_lexer_symbol_reverse_list_by_databox_name_register_v";
]
;;
...
let register : 
    (string,
     Nwchemdata_lexer_symbol_t.nwchemdata_lexer_symbol list
    ) 
    Register_t.register = 
...
let name_of_value val_ =
  List_v.name_with_separator 
    Nwchemdata_lexer_symbol_v.name ";\n  "
    val_
;;
...
(* done with do_register.sh on vendredi 20 mai 2016, 17:18:33 (UTC+0200) *)
