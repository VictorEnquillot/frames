...
test_number 3 (
( nof_l : string list ) =
["gaussian_nwchem_cc_pvtz.nwc";
 "gaussian_nwchem_6_31gss.nwc";
 "gaussian_nwchem_comment.nwc";
 "gaussian_nwchem_test_ecp.nwc";
 "gaussian_nwchem_test.nwc";
 "gaussian_nwchem_lanl2dz.nwc";
 "gaussian_nwchem_3_21g.nwc";
 "gaussian_nwchem_ecp.nwc";
 "gaussian_nwchem_6_31gssp.nwc";
 "gaussian_nwchem_basis.nwc"]
);;
