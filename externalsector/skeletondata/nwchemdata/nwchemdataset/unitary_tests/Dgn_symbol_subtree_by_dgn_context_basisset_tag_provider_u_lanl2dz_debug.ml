...
testing "Dgn_symbol_subtree_by_dgn_context_basisset_tag_provider_v with
    Dgn_symbol_subtree_by_dgn_context_basisset_tag_provider_u_lanl2dz_debug.ml";;
...
(* toplevel 
   #use "Dgn_symbol_subtree_by_dgn_context_basisset_tag_provider_u_lanl2dz_debug.ml";; 
...
open Dgn_symbol_subtree_by_dgn_context_basisset_tag_provider_v;;

let tag_dcb = Dgn_context_basisset_tag_by_unit_provider_v.provide ();;

test_number 1 (
(tag_dcb : Dgn_context_basisset_symbol_t.nwchem_context_basisset_symbol Tag_t.tag ) =
  (Dgn_context_basisset_symbol_t.Dgn_context_basisset_constructor "gaussian_nwchem",
   [5; 3])
);;

let sof_dcb = Dgn_context_basisset_tag_v.string_off tag_dcb;;
