...
testing "Nwchemdata_parser_v with
    Nwchemdata_parser_u_cc_pVTZ.ml";;
...
(* toplevel 
   #use "Nwchemdata_parser_u_cc_pVTZ.ml";; 

*)

(*
Debug_by_module_name_register_v.store "Nwchemdata_lexer_lexical_analysis_v" "nodebug";;
Debug_by_module_name_register_v.store "Nwchemdata_lexer_lexical_analysis_tools_v" "nodebug";;
  ...
  Tree_t.Inner
   (Nwchemdata_symbol_t.Nwchemdata_body_symbol
     (Nwchemdata_body_symbol_t.Nwchemdata_body_node_symbol
       (Nwchemdata_body_node_symbol_t.Nwchemdata_body_node_aocomment_block "cc_pVTZ")),
   [Tree_t.Leaf
     (Nwchemdata_symbol_t.Nwchemdata_body_symbol
...
let sym_nwc_t =
  Nwchemdata_parser_v.nwchemdata_symbol_tree_of_databox_name nam_dbo;;
...
(sym_nwc_tso_l : Nwchemdata_symbol_t.nwchemdata_symbol list ) =
  [Nwchemdata_symbol_t.Nwchemdata_context_symbol
   ...
   Nwchemdata_symbol_t.Nwchemdata_body_symbol
    (Nwchemdata_body_symbol_t.Nwchemdata_body_node_symbol
      (Nwchemdata_body_node_symbol_t.Nwchemdata_body_node_aobasis_block "cc_pVTZ"))]
);;
