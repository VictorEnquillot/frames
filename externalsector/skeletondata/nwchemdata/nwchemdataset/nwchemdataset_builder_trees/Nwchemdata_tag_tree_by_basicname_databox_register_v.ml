(** {3 Nwchemdata_tag_tree_by_basicname_databox_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BNWC:Nwchemdata_tag_tree_by_basicname_databox_register_v";
   "Author : François Colonna 01 avril 2017 at 12:20:24+02:00";
 ]
;;
...
let register : 
    (Basicname_t.basicname,
     Nwchemdata_tag_t.nwchemdata_tag Tree_t.tree
    ) 
    Register_t.register = 
...
let name_of_value val_ =
  Tree_v.name Nwchemdata_tag_v.fullname val_
;;
