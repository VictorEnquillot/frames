(** {3 Nwchemdata_set_fence_by_nwchemdata_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BNWC:Nwchemdata_set_fence_by_nwchemdata_tag_register_v";
   "Author : François Colonna 05 décembre 2016 at 07:36:33+01:00";
 ]
;;
...
let register : 
    (Nwchemdata_tag_t.nwchemdata_tag,
...
let name_of_key key =
  Nwchemdata_tag_v.name key
;;

let name_of_value val_ =
  List_v.name
    Nwchemdata_tag_v.name 
    val_
;;
