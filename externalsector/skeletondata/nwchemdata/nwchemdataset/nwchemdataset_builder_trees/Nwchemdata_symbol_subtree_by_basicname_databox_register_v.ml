(** {3 Nwchemdata_symbol_subtree_by_basicname_databox_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : CONS:Nwchemdata_symbol_subtree_by_basicname_databox_register_v";
   "Author : François Colonna 01 avril 2017 at 12:30:01+02:00";
 ]
;;
...
let nam_reg = "Nwchemdata_symbol_subtree_by_basicname_databox_register_v";;

let register : 
    (Basicname_t.basicname,
     Nwchemdata_symbol_t.nwchemdata_symbol Tree_t.tree)
    Register_t.register = 
...
let name_of_key key =
  Basicname_v.name key
;;

let name_of_value val_ =
  Tree_v.name Nwchemdata_symbol_v.fullname val_
;;
