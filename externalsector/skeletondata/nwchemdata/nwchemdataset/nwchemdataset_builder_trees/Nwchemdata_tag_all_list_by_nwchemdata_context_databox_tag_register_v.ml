(** {3 Nwchemdata_tag_all_list_by_nwchemdata_context_databox_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
    "Current : BNWC:Nwchemdata_tag_all_list_by_nwchemdata_context_databox_tag_register_v";
 ]
;;
...
let register : 
    (
     ...
     Nwchemdata_tag_t.nwchemdata_tag list
    ) 
    Register_t.register = 
...
let name_of_value val_ =
  List_v.name Nwchemdata_tag_v.fullname val_
;;
