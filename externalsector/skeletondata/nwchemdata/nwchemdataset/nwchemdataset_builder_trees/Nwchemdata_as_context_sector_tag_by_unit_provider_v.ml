(** {3 Nwchemdata_as_context_sector_tag_by_unit_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BNWC:Nwchemdata_as_context_sector_tag_by_unit_provider_v";
   "Needs : CONS:Context_sole_index_by_basicname_sector_provider_v";
   "Author : François Colonna 01 avril 2017 at 11:35:45+02:00";
 ]
;;
...
(* done with do_provider_without_register.sh Nwchemdata_as_context_sector_tag_by_unit_provider_v.ml force on lundi 10 octobre 2016, 15:52:06 (UTC+0200) *)
