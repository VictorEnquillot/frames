...
testing "Datafile_name_list_by_nwchemdata_context_database_tag_provider_v with
    Datafile_name_list_by_nwchemdata_context_database_tag_provider_u_any.ml";;
...
(* toplevel 
   #use "Datafile_name_list_by_nwchemdata_context_database_tag_provider_u_any.ml";; 

*)

(* Debug *)

open Datafile_name_list_by_nwchemdata_context_database_tag_provider_v;;
...
let nof_l = Nwchemdata_nameoffile_list_by_nwchemdata_context_database_tag_provider_v.provide tag_dcd;;
...
let nam_dfi = Nwchemdata_context_database_tag_v.string_off tag_dcd;;
