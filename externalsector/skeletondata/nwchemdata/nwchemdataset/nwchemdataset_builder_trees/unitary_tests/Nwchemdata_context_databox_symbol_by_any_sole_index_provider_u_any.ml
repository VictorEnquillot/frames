...
testing "Nwchemdata_context_databox_symbol_by_any_sole_index_provider_v with
...
(* toplevel 
   #use "Nwchemdata_context_databox_symbol_by_any_sole_index_provider_u_any.ml";; 

*)


open Nwchemdata_context_databox_symbol_by_any_sole_index_provider_v;;
...
let nam_nbo = 
    Nwchemdata_context_databox_name_by_any_sole_index_provider_v.provide 
      soi_any;;
...
let sym_nbo = Nwchemdata_context_databox_symbol_v.nwchemdata_context_databox_constructor 
      nam_nbo;;
