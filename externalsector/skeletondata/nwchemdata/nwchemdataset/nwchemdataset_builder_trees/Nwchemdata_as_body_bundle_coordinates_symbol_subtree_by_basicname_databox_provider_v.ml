(** {3 Nwchemdata_as_body_bundle_coordinates_symbol_subtree_by_basicname_databox_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BNWC:Nwchemdata_as_body_bundle_coordinates_symbol_subtree_by_basicname_databox_provider_v";
...
let build bna_dbo =
  ...
  Tree_v.subtree_of_node_predicate_off_tree  
    Nwchemdata_symbol_v.is_nwchemdata_set_body_bundle_coordinates_constructor
    sym_nwc_st
;;
...
(* done with do_provider_without_register.sh Nwchemdata_as_body_bundle_coordinates_symbol_subtree_by_basicname_databox_provider_v.ml force on lundi 10 octobre 2016, 15:52:05 (UTC+0200) *)
