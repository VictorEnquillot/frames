(** {3 Basicname_databox_n_basicname_database_by_nwchemdata_context_databox_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BNWC:Basicname_databox_n_basicname_database_by_nwchemdata_context_databox_tag_register_v";
   "Author : François Colonna 01 avril 2017 at 11:54:56+02:00";
 ]
;;
...
let register : 
    (
     Nwchemdata_context_databox_tag_t.nwchemdata_context_databox_tag,
...
let name_of_key key =
  Nwchemdata_context_databox_tag_v.fullname key
;;
...
(* done with do_register.sh force on lundi 10 octobre 2016, 15:51:59 (UTC+0200) *)
