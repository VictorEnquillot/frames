(** {3 Nwchemdata_symbol_by_sole_index_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BNWC:Nwchemdata_symbol_by_sole_index_register_v";
 ]
;;

(** {6 Register.} *)

let nam_reg = "Nwchemdata_symbol_by_sole_index_register_v";;

let register : 
    (Sole_index_t.sole_index, 
     Nwchemdata_symbol_t.nwchemdata_symbol) 
    Register_t.register
     = 
...
let name_of_value val_ =
  Nwchemdata_symbol_v.fullname val_
;;
...
(* done with do_dddd_symbol_by_sole_index_register.sh force on lundi 10 octobre 2016, 15:52:10 (UTC+0200) *)
