(** {3 Nwchemdata_tag_all_list_by_basicname_databox_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BNWC:Nwchemdata_tag_all_list_by_basicname_databox_register_v";
   "Author : François Colonna 01 avril 2017 at 12:30:45+02:00";
 ]
;;
