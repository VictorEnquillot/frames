...
testing "Group_bsu_tag_list_by_database_db1_component_triangle_isoacuteag_provider_v";;

(* toplevel 
   #use "Group_bsu_tag_list_by_database_db1_component_triangle_isoacuteag_provider_u_any.ml";; 

*)

let nam_cod = "Group_bsu_tag_list_by_database_db1_component_triangle_isoacuteag_provider_u_any.ml";;
