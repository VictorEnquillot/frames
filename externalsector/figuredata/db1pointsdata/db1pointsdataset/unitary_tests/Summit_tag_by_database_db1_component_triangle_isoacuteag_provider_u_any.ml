...
testing "Summit_tag_by_database_db1_component_triangle_isoacuteag_provider_v
   Summit_tag_by_database_db1_component_triangle_isoacuteag_provider_u_any.ml";;

(* toplevel 
   #use "Summit_tag_by_database_db1_component_triangle_isoacuteag_provider_u_any.ml";;

*)

let nam_cod = "Summit_tag_by_database_db1_component_triangle_isoacuteag_provider_u_any.ml";;
