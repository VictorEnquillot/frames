...
let tag_eco_l = Database_db1_component_tag_list_by_database_db1_database_tag_provider_v.provide tag_ed1;;
...
let tag_eel = List.hd tag_eel_l;;

test_number 7 (
 tag_eew_l 
(* : Database_db1_element_vertex_symbol_t.database_db1_element_vertex_symbol
  Tag_t.tag list *)
=
  [(Database_db1_element_vertex_symbol_t.Database_db1_element_vertex_constructor
     "A",
