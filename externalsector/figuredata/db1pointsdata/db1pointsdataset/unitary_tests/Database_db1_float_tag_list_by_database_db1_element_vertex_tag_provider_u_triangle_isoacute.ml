...
testing "Database_db1_float_tag_list_by_database_db1_element_vertex_tag_provider_v with 
   Database_db1_float_tag_list_by_database_db1_element_vertex_tag_provider_u_triangle_isoacute.ml";;

(* toplevel 
   #use "Database_db1_float_tag_list_by_database_db1_element_vertex_tag_provider_u_triangle_isoacute.ml";; 
...
let tag_ew1 = Tag_v.map_entity Database_db1_element_symbol_v.database_db1_element_vertex_symbol_off_database_db1_element_symbol tag_ee1;;
let tag_flo_l = Database_db1_float_tag_list_by_database_db1_element_vertex_tag_provider_v.provide tag_ew1;;
