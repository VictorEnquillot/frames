...
testing "Cluster_tag_list_by_database_db1_component_triangle_isoacuteag_provider_v
   Cluster_tag_list_by_database_db1_component_triangle_isoacuteag_provider_u_any.ml";;

(* toplevel 
   #use "Cluster_tag_list_by_database_db1_component_triangle_isoacuteag_provider_u_any.ml";;

*)

let nam_cod = "Cluster_tag_list_by_database_db1_component_triangle_isoacuteag_provider_u_any.ml";;
...
let tag_clu_l = Cluster_tag_list_by_database_db1_component_triangle_isoacuteag_provider_v.provide tag_tri;;
