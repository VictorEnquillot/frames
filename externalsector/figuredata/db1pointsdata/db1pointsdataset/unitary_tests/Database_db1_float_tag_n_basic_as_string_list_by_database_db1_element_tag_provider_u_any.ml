...
testing "Database_db1_float_tag_n_basic_as_string_list_by_database_db1_element_tag_provider_v with
   Database_db1_float_tag_n_basic_as_string_list_by_database_db1_element_tag_provider_u_any.ml";;

(* toplevel 
   #use "Database_db1_float_tag_n_basic_as_string_list_by_database_db1_element_tag_provider_u_any.ml";; 
...
let tag_ld1 = Database_db1_database_tag_by_domain_tag_provider_v.provide tag_dom;;
...
let tag_ec1_l = Database_db1_component_tag_list_by_database_db1_database_tag_provider_v.provide tag_ld1;;
...
(* : string list *)
= 
  [((Database_db1_float_symbol_t.Database_db1_float_constructor, [1; 3; 2; 1; 1; 3]), "2.");
   ((Database_db1_float_symbol_t.Database_db1_float_constructor
     ,
     [2; 3; 2; 1; 1; 3]),
    "0.");
