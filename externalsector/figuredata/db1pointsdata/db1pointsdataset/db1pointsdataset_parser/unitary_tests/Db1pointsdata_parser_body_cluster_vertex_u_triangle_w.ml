...
testing "Db1pointsdata_parser_body_cluster_vertex_v with
        Db1pointsdata_parser_body_cluster_vertex_u_triangle_w.ml";;
...
(* toplevel 
   #use "Db1pointsdata_parser_body_cluster_vertex_u_triangle_w.ml";; 
...
let sym_lex_s = Db1pointsdata_parser_tools_v.db1pointsdata_lexer_symbol_stack_of_basicname_databox bna_dbo;;
...
let sym_db1_t = db1pointsdata_symbol_tree_root_databox_of_basicname_databox bna_dbo;;
          ...
          (Db1pointsdata_set_fence_token_coordinates_symbol_t.Db1pointsdata_set_fence_token_coordinates_units_symbol
            (Db1pointsdata_set_fence_token_coordinates_units_symbol_t.Db1pointsdata_set_fence_token_coordinates_units_length_symbol
              (Db1pointsdata_set_fence_token_coordinates_units_length_symbol_t.Db1pointsdata_set_fence_token_coordinates_units_length_nanometer_symbol
                (Db1pointsdata_set_fence_token_coordinates_units_length_nanometer_symbol_t.Db1pointsdata_set_fence_token_coordinates_units_length_nanometer_constructor
                  "W")))))));
   Db1pointsdata_symbol_t.Db1pointsdata_set_symbol
    (Db1pointsdata_set_symbol_t.Db1pointsdata_set_fence_symbol
      (Db1pointsdata_set_fence_symbol_t.Db1pointsdata_set_fence_token_symbol
