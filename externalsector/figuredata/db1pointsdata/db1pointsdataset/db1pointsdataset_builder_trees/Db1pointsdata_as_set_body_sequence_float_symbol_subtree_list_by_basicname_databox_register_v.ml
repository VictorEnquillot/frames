(** {3 Db1pointsdata_as_set_body_sequence_float_symbol_subtree_list_by_db1pointsdata_context_databox_name_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BDB1:Db1pointsdata_as_set_body_sequence_float_symbol_subtree_list_by_db1pointsdata_context_databox_name_register_v";
   "Author : François Colonna 30 septembre 2016 at 17:56:52+02:00";
]
;;
...
(* done with do_register.sh on mercredi 7 septembre 2016, 09:25:13 (UTC+0200) *)
