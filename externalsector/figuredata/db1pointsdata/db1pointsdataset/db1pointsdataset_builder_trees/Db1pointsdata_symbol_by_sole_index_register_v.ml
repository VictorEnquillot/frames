(** {3 Db1pointsdata_symbol_by_sole_index_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BDB1:Db1pointsdata_symbol_by_sole_index_register_v";
 ]
;;

(** {6 Register.} *)

let nam_reg = "Db1pointsdata_symbol_by_sole_index_register_v";;

let register : 
    (Sole_index_t.sole_index, 
     Db1pointsdata_symbol_t.db1pointsdata_symbol) 
    Register_t.register
     = 
...
let name_of_value val_ =
  Db1pointsdata_symbol_v.fullname val_
;;
...
(* using template_dddd_symbol_by_sole_index_register_v.ml *)
(* done with do_dddd_symbol_by_sole_index_register.sh force on lundi 26 septembre 2016, 07:27:07 (UTC+0200) *)
