(** {3 Db1pointsdata_as_set_fence_token_figure_kind_symbol_by_basicname_databox_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BDB1:Db1pointsdata_as_set_fence_token_figure_kind_symbol_by_basicname_databox_provider_v";
...
(* done with do_provider_without_register.sh Db1pointsdata_as_set_fence_token_figure_kind_symbol_by_basicname_databox_provider_v.ml on samedi 21 mai 2016, 11:46:45 (UTC+0200) *)
