(** {3 Measure_list_by_db1pointsdata_set_body_sequence_float_tag_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BDB1:Measure_list_by_db1pointsdata_set_body_sequence_float_tag_provider_v";
