(** {3 Basicname_databox_n_basicname_database_by_db1pointsdata_context_databox_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BDB1:Basicname_databox_n_basicname_database_by_db1pointsdata_context_databox_tag_register_v";
   "Author : François Colonna 31 mars 2017 at 12:49:18+02:00";
 ]
;;
...
let register : 
    (
     Db1pointsdata_context_databox_tag_t.db1pointsdata_context_databox_tag,
...
let name_of_key key =
  Db1pointsdata_context_databox_tag_v.fullname key
;;

let name_of_value val_ =
  Duo_v.name Basicname_v.name val_
;;
...
(* done with do_register.sh force on lundi 26 septembre 2016, 07:26:57 (UTC+0200) *)
