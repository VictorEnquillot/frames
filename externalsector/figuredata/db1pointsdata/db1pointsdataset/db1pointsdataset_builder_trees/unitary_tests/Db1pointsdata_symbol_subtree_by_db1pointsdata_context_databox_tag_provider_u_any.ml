...
testing "Db1pointsdata_symbol_subtree_by_db1pointsdata_context_databox_tag_provider_v with
...
(* toplevel 
   #use "Db1pointsdata_symbol_subtree_by_db1pointsdata_context_databox_tag_provider_u_any.ml";; 

*)

open Db1pointsdata_symbol_subtree_by_db1pointsdata_context_databox_tag_provider_v;;
...
test_number 1 ( 
(tag_dbo :
  Db1pointsdata_context_databox_symbol_t.db1pointsdata_context_databox_symbol Tag_t.tag ) =
...
test_number 2 (
nam_dbo = Db1pointsdata_context_databox_tag_v.string_off tag_dbo 
);;
