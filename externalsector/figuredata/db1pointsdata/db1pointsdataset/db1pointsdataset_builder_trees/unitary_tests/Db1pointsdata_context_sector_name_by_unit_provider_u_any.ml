...
testing "Db1pointsdata_context_sector_name_by_unit_provider_v with
...
(* toplevel 
   #use "Db1pointsdata_context_sector_name_by_unit_provider_u_any.ml";; 

*)

open Db1pointsdata_context_sector_name_by_unit_provider_v;;


let (_, _, nam_sec) = Db1pointsdata_context_name_trio_by_unit_provider_v.provide ();;
