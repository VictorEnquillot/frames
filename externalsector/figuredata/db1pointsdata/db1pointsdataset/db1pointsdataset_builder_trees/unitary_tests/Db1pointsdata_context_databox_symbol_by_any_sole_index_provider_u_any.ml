...
testing "Db1pointsdata_context_databox_symbol_by_any_sole_index_provider_v with
...
(* toplevel 
   #use "Db1pointsdata_context_databox_symbol_by_any_sole_index_provider_u_any.ml";; 

*)


open Db1pointsdata_context_databox_symbol_by_any_sole_index_provider_v;;
...
test_number 3 (
nam_dbo = Db1pointsdata_context_basicname_databox_by_any_sole_index_provider_v.provide soi_any
);;
