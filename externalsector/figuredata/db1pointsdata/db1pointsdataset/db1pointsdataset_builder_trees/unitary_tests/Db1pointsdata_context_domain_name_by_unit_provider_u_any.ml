...
testing "Db1pointsdata_context_domain_name_by_unit_provider_v with
...
(* toplevel 
   #use "Db1pointsdata_context_domain_name_by_unit_provider_u_any.ml";; 

*)

(* Debug *)

open Db1pointsdata_context_domain_name_by_unit_provider_v;;

let (_, nam_dom, _) = Db1pointsdata_context_name_trio_by_unit_provider_v.provide ();;
