...
testing "Db1pointsdata_tag_tree_by_basicname_databox_provider_v with
        Db1pointsdata_tag_tree_by_basicname_databox_provider_u_any.ml";;
...
(* toplevel 
   #use "Db1pointsdata_tag_tree_by_basicname_databox_provider_u_any.ml";; 

*)

open Db1pointsdata_tag_tree_by_basicname_databox_provider_v;;

let nam_dbo = "Point_a";;
let nam_mod = "Db1pointsdata_tag_tree_by_basicname_databox_provider_u_any";;
...
let soi_nfe = [2; 3; 1; 2; 10; 1; 7; 2] ;;

let tag_nfe = Db1pointsdata_any_category_by_sole_index_extractor_v.db1pointsdata_set_fence_tag_off_sole_index soi_nfe;;
let tag_db1_fen = Tag_v.map_entity Db1pointsdata_symbol_v.db1pointsdata_symbol_of_db1pointsdata_set_fence_symbol tag_nfe;;
