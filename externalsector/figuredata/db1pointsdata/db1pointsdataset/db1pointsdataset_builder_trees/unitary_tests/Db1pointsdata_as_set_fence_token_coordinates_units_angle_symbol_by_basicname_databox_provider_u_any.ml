...
testing "Db1pointsdata_as_set_fence_token_coordinates_units_angle_symbol_by_basicname_databox_provider_v with
    Db1pointsdata_as_set_fence_token_coordinates_units_angle_symbol_by_basicname_databox_provider_u_any.ml";;
...
(* toplevel 
   #use "Db1pointsdata_as_set_fence_token_coordinates_units_angle_symbol_by_basicname_databox_provider_u_any.ml";; 

*)

open Db1pointsdata_as_set_fence_token_coordinates_units_angle_symbol_by_basicname_databox_provider_v;;
...
test_number 2 (
(sym_db1_dua : Db1pointsdata_symbol_t.db1pointsdata_symbol ) =
  Db1pointsdata_symbol_t.Db1pointsdata_set_symbol
