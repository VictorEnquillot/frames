(** {3 Db1pointsdata_as_set_body_record_vertex_symbol_subtree_list_by_db1pointsdata_context_databox_name_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BDB1:Db1pointsdata_as_set_body_record_vertex_symbol_subtree_list_by_db1pointsdata_context_databox_name_register_v";
   "Author : François Colonna 31 mars 2017 at 13:18:00+02:00";
]
;;
