(** {3 Db1pointsdata_tag_all_list_by_basicname_databox_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BDB1:Db1pointsdata_tag_all_list_by_basicname_databox_register_v";
   "Author : François Colonna 31 mars 2017 at 13:16:16+02:00";
 ]
;;
