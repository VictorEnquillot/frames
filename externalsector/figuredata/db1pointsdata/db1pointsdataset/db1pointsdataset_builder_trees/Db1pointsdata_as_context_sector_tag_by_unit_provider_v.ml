(** {3 Db1pointsdata_as_context_sector_tag_by_unit_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BDB1:Db1pointsdata_as_context_sector_tag_by_unit_provider_v";
...
let build () =
  ...
  let sym_db1_dcs = 
    Db1pointsdata_symbol_v.db1pointsdata_context_sector_constructor 
      nam_sec 
  in
  Tag_v.make sym_db1_dcs soi_sec
;;
...
(* done with do_provider_without_register.sh Db1pointsdata_as_context_sector_tag_by_unit_provider_v.ml force on lundi 26 septembre 2016, 07:27:03 (UTC+0200) *)
