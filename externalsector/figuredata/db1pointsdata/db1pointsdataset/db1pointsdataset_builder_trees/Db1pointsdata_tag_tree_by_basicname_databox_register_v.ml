(** {3 Db1pointsdata_tag_tree_by_basicname_databox_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BDB1:Db1pointsdata_tag_tree_by_basicname_databox_register_v";
   "Author : François Colonna 31 mars 2017 at 13:11:55+02:00";
 ]
;;
...
let register : 
    (Basicname_t.basicname,
     Db1pointsdata_tag_t.db1pointsdata_tag Tree_t.tree
    ) 
    Register_t.register = 
...
let name_of_value val_ =
  Tree_v.name Db1pointsdata_tag_v.fullname val_
;;
