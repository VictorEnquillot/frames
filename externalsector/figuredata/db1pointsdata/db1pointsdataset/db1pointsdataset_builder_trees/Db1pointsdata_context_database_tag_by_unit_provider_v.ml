(** {3 Db1pointsdata_context_database_tag_by_unit_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BDB1:Db1pointsdata_context_database_tag_by_unit_provider_v";
   "Needs : BDB1:Db1pointsdata_basicname_trio_by_unit_provider_v";
   "Needs : CONS:Context_sole_index_by_basicname_trio_provider_v";
   "Needs : SDB1:Db1pointsdata_context_database_symbol_v";
   "Author : François Colonna 31 mars 2017 at 11:41:26+02:00";
 ]
;;
...
(* done with do_provider_without_register.sh Db1pointsdata_context_database_tag_by_unit_provider_v.ml force on lundi 26 septembre 2016, 07:27:04 (UTC+0200) *)
