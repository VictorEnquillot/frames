(** {3 Db1pointsdata_as_set_body_bundle_figure_symbol_subtree_by_basicname_databox_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BDB1:Db1pointsdata_as_set_body_bundle_figure_symbol_subtree_by_basicname_databox_provider_v";
   ...
   "Author : François Colonna 31 mars 2017 at 13:33:07+02:00";
 ]
;;
...
(* done with do_provider_without_register.sh Db1pointsdata_as_set_body_bundle_figure_symbol_subtree_by_basicname_databox_provider_v.ml force on lundi 26 septembre 2016, 07:27:03 (UTC+0200) *)
