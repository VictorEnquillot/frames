(** {3 Db1pointsdata_symbol_subtree_by_basicname_databox_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : CONS:Db1pointsdata_symbol_subtree_by_basicname_databox_register_v";
   "Author : François Colonna 31 mars 2017 at 13:10:56+02:00";
 ]
;;
...
let nam_reg = "Db1pointsdata_symbol_subtree_by_basicname_databox_register_v";;
...
let name_of_value val_ =
  Tree_v.name Db1pointsdata_symbol_v.fullname val_
;;
