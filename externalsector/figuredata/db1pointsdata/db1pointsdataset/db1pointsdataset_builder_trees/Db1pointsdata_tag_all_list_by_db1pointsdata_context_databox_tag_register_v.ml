(** {3 Db1pointsdata_tag_all_list_by_db1pointsdata_context_databox_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
    "Current : BDB1:Db1pointsdata_tag_all_list_by_db1pointsdata_context_databox_tag_register_v";
 ]
;;
...
let register : 
    (
     ...
     Db1pointsdata_tag_t.db1pointsdata_tag list
    ) 
    Register_t.register = 
...
let name_of_value val_ =
  List_v.name Db1pointsdata_tag_v.fullname val_
;;
...
(* done with do_register.sh force on lundi 26 septembre 2016, 07:26:58 (UTC+0200) *)
