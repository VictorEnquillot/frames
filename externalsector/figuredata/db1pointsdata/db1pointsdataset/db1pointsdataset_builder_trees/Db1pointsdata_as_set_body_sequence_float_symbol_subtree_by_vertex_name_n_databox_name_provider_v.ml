(** {3 Db1pointsdata_as_set_body_sequence_float_symbol_subtree_by_vertex_name_n_databox_name_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BDB1:Db1pointsdata_as_set_body_sequence_float_symbol_subtree_by_vertex_name_n_databox_name_provider_v";
   "Needs : BDB1:Db1pointsdata_as_set_body_record_vertex_symbol_subtree_by_vertex_name_n_databox_name_provider_v";
   "Needed-by :"; 
   "What-is-it : the Subtree of Db1pointsdata_symbol Rooted by a sequence_float of a vertex";
...
let build (nam_ver, nam_dbo) =
  let sym_db1_drv_st = 
    Db1pointsdata_as_set_body_record_vertex_symbol_subtree_by_vertex_name_n_databox_name_provider_v.provide 
      (nam_ver, nam_dbo) 
  in
