(** {3 Db1pointsdata_father_tag_by_db1pointsdata_son_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BCOO:Db1pointsdata_father_tag_by_db1pointsdata_son_tag_register_v";
   "Author : François Colonna 25 décembre 2016 at 18:43:44+01:00";
]
;;
...
let name_of_key key =
  Db1pointsdata_tag_v.fullname key
;;

let name_of_value val_ =
  Db1pointsdata_tag_v.fullname val_
;;
