(** {3 Db1pointsdata_creation_module_name_by_sole_index_register_v} *)
...
[
 "Needs: ";
 "Current : BDB1:Db1pointsdata_creation_module_name_by_sole_index_register_v";
 "Needed-by: ";
 "What-is-it: the Register which stores the module name where a Sole_index is created";
 "How-is-it-done : ";
 "Example: ";
]
;;
