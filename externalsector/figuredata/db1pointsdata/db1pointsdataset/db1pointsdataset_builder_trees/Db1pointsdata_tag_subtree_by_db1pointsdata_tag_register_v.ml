(** {3 Db1pointsdata_tag_subtree_by_db1pointsdata_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
[
   "Current : BDB1:Db1pointsdata_tag_subtree_by_db1pointsdata_tag_register_v";
  "Needs: ";
  "Needed-by: ";
  "What-is-it: ";
    "How-is-it-done : ";
...
let register : 
    (Db1pointsdata_tag_t.db1pointsdata_tag,
...
let name_of_key key =
  Db1pointsdata_tag_v.name key
;;

let name_of_value val_ =
  Tree_v.name
    Db1pointsdata_tag_v.name 
    val_
;;
