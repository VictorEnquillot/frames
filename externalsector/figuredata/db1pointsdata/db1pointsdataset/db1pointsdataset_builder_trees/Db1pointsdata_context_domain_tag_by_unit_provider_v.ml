(** {3 Db1pointsdata_context_domain_tag_by_unit_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BDB1:Db1pointsdata_context_domain_tag_by_unit_provider_v";
   ...
   "Needs : SDB1:Db1pointsdata_context_domain_symbol_v";
   "Author : François Colonna 31 mars 2017 at 11:56:31+02:00";
 ]
;;
...
(* done with do_provider_without_register.sh Db1pointsdata_context_domain_tag_by_unit_provider_v.ml force on lundi 26 septembre 2016, 07:27:04 (UTC+0200) *)
