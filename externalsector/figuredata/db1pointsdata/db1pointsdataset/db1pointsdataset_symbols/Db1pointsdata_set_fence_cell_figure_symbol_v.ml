...
let longname sym_dcf =
  Format.sprintf "Db1pointsdata_set_fence_cell_figure_symbol_t.%s" (String.capitalize (name sym_dcf))
;;
...
(** Db1pointsdata_set_fence_cell_figure_symbol_v at 12:40:39 on 4 Jun 2017. created by version v2.4 of generator *)
