...
let longname sym_dtf =
  Format.sprintf "Db1pointsdata_set_fence_token_figure_symbol_t.%s" (String.capitalize (name sym_dtf))
;;
...
(** Db1pointsdata_set_fence_token_figure_symbol_v at 12:40:42 on 4 Jun 2017. created by version v2.4 of generator *)
