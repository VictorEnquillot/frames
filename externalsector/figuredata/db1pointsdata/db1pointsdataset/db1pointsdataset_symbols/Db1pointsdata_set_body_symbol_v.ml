...
let longname sym_dsb =
  Format.sprintf "Db1pointsdata_set_body_symbol_t.%s" (String.capitalize (name sym_dsb))
;;
...
(** Db1pointsdata_set_body_symbol_v at 12:40:36 on 4 Jun 2017. created by version v2.4 of generator *)
