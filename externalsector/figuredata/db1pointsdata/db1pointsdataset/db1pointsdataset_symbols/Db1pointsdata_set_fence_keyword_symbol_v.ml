...
let longname sym_dfk =
  Format.sprintf "Db1pointsdata_set_fence_keyword_symbol_t.%s" (String.capitalize (name sym_dfk))
;;
...
(** Db1pointsdata_set_fence_keyword_symbol_v at 12:40:39 on 4 Jun 2017. created by version v2.4 of generator *)
