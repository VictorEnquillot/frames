...
let longname sym_dcu =
  Format.sprintf "Db1pointsdata_set_fence_cell_coordinates_units_symbol_t.%s" (String.capitalize (name sym_dcu))
;;
...
(** Db1pointsdata_set_fence_cell_coordinates_units_symbol_v at 12:40:39 on 4 Jun 2017. created by version v2.4 of generator *)
