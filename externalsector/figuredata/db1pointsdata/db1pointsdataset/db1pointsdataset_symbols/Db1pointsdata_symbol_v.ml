...
let longname sym_db1 =
  Format.sprintf "Db1pointsdata_symbol_t.%s" (String.capitalize (name sym_db1))
;;
...
(** Db1pointsdata_symbol_v at 12:40:34 on 4 Jun 2017. created by version v2.4 of generator *)
