...
let longname sym_dck =
  Format.sprintf "Db1pointsdata_set_fence_token_coordinates_kind_symbol_t.%s" (String.capitalize (name sym_dck))
;;
...
(** Db1pointsdata_set_fence_token_coordinates_kind_symbol_v at 12:40:41 on 4 Jun 2017. created by version v2.4 of generator *)
