...
let longname sym_dbn =
  Format.sprintf "Db1pointsdata_set_body_name_symbol_t.%s" (String.capitalize (name sym_dbn))
;;
...
(** Db1pointsdata_set_body_name_symbol_v at 12:40:37 on 4 Jun 2017. created by version v2.4 of generator *)
