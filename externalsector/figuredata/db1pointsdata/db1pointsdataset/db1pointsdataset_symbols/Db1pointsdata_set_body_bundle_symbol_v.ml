...
let longname sym_dbb =
  Format.sprintf "Db1pointsdata_set_body_bundle_symbol_t.%s" (String.capitalize (name sym_dbb))
;;
...
(** Db1pointsdata_set_body_bundle_symbol_v at 12:40:36 on 4 Jun 2017. created by version v2.4 of generator *)
