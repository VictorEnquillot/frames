...
let longname sym_tbd =
  Format.sprintf "Camlline_for_formula_trio_top_builder_data_symbol_t.%s" (String.capitalize (name sym_tbd))
;;
...
let make nam s =
  ...
  with Failure "Not_a_topson_bare:Camlline_for_formula_trio_top_builder_data_symbol_v.ml:make_of_topson_bare" ->
  try make_of_topson_ofstring nam s
  with Failure "Not_a_topson_ofstring:Camlline_for_formula_trio_top_builder_data_symbol_v.ml:make_of_topson_ofstring" ->
  try make_of_topson_notleaf nam s
  with Failure "Not_a_topson_notleaf:Camlline_for_formula_trio_top_builder_data_symbol_v.ml:make_of_topson_notleaf" ->
   let _ =
      Error_messages_v.print_error nam_cod "make"
      (Format.sprintf "strings \"%s\" and \"%s\" represent an existing Camlline_for_formula_trio_top_builder_data subtype" nam s)
      "it does not exists"
      "Check file camlline_for_formula_trio_top_builder_data_symbol_v.ml"
    in
    failwith "Not_a_valid_camlline_for_formula_trio_top_builder_data_symbol:Camlline_for_formula_trio_top_builder_data_symbol_v.ml:make"
;;
