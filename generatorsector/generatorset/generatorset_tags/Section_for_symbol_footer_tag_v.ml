(** {3 Section_for_symbol_footer_tag_v} *)

let nam_cod = "Section_for_symbol_footer_v.ml";;

(** {6 Tupling} *)

let section_for_symbol_footer_octtup_off_section_for_symbol_footer_tag tag_sec =
