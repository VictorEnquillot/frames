(** {3 Section_for_symbol_header_current_tag_v} *)

let nam_cod = "Section_for_symbol_header_current_v.ml";;

(** {6 Tupling} *)

let section_for_symbol_header_current_octtup_off_section_for_symbol_header_current_tag tag_sec =
