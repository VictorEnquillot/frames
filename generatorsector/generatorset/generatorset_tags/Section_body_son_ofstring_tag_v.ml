(** {3 Section_body_son_ofstring_tag_v} *)

let nam_cod = "Section_body_son_ofstring_v.ml";;

(** {6 Tupling} *)

let section_body_son_ofstring_octtup_off_section_body_son_ofstring_tag tag_sec =
