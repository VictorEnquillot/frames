(** {3 Group_for_formula_body_data_alone_tag_v} *)

let nam_cod = "Group_for_formula_body_data_alone_tag_v.ml";;

(** {6 Tupling} *)

let group_for_formula_body_data_alone_nontup_off_group_for_formula_body_data_alone_tag tag_gro =
