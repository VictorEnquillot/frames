(** {3 Section_for_any_footer_constant_tag_v} *)

let nam_cod = "Section_for_any_footer_constant_tag_v.ml";;

(** {6 Naming} *)

(** {6 Tupling} *)

let section_for_any_footer_constant_octtup_off_section_for_any_function_tag tag_sec =
