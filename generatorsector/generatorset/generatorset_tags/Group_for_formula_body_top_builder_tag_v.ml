(** {3 Group_for_formula_body_top_builder_tag_v} *)

let nam_cod = "Group_for_formula_body_top_builder_tag_v.ml";;

(** {6 Tupling} *)

let group_for_formula_body_top_builder_nontup_off_group_for_formula_body_top_builder_tag tag_gro =
