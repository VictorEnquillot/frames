(** {3 Section_body_son_try_top_of_son_with_failure_arrow_tag_v} *)

let nam_cod = "Section_body_son_try_top_of_son_with_failure_arrow_v.ml";;

(** {6 Tupling} *)

let section_body_son_try_top_of_son_with_failure_arrow_octtup_off_section_body_son_try_top_of_son_with_failure_arrow_tag tag_sec =
