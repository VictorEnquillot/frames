(** {3 Section_for_formula_body_top_main_tag_v} *)

let nam_cod = "Section_for_formula_body_top_main_v.ml";;

(** {6 Tupling} *)

let section_for_formula_body_top_main_octtup_off_section_for_formula_body_top_main_tag tag_sec =
