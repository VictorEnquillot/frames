(** {3 Usagefile_for_formula_v}  *)

let nam_cod = "Usagefile_for_formula_tag_v.ml";;

(** {6 Naming} *)

(** {6 Tupling} *)

let usagefile_for_formula_quitup_off_usagefile_for_formula_tag tag_uim =
  let sym_uim = Tag_v.entity_off_tag tag_uim in
  let tag_usf = Usagefile_tag_v.usagefile_tag_of_usagefile_for_formula_tag tag_uim in
