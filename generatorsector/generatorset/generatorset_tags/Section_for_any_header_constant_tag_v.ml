(** {3 Section_for_any_header_constant_tag_v} *)

let nam_cod = "Section_for_any_header_constant_v.ml";;

(** {6 Tupling} *)

let section_for_any_header_constant_octtup_off_section_for_any_header_constant_tag tag_sec =
