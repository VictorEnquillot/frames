(** {3 Section_for_formula_body_son_top_builder_tag_v} *)

let nam_cod = "Section_for_formula_body_son_top_builder_v.ml";;

(** {6 Tupling} *)

let section_for_formula_body_son_top_builder_octtup_off_section_for_formula_body_son_top_builder_tag tag_sec =
