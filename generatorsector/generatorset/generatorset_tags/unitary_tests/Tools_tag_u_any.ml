...
testing "Tools_tag_v.ml with
   Tools_tag_u_any.ml";;

(* toplevel
   #use "Tools_tag_u_any.ml";;
...
let sym_ent = Entity_symbol_v.top_has_notopsonleaf nam_ent;;
let sym_ent = Entity_symbol_v.top_has_sometopsonleaf nam_ent;;
...
let tag_upw = Tools_tag_v.upwards_generatorset_tag_of_predicate_off_current_tag Generatorset_symbol_v.is_category_symbol_off_generatorset_symbol tag_ite;;
test_number 6 (
tag_upw
(* : Generatorset_symbol_t.generatorset_symbol Tag_t.tag *)
  =
(Generatorset_symbol_t.Category_symbol Category_symbol_t.Tag, [8; 1])
);;

test_number 7 (
tag_upw = Tag_v.make gss_cat soi_cat
);;
