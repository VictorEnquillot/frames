...
testing "Camlline_tag_v with
   Camlline_tag_u_triangle.ml";;

(* toplevel 
   #use "Camlline_tag_u_triangle.ml";;
...
let sym_gro = Group_symbol_v.try_make_of_topson_leaf_with_failure_arrow;;
let idx_gro = 99;;
let soi_gro = Sole_index_v.make idx_gro soi_sec;;
...
let tag_gro = Tag_v.make sym_gro soi_gro;;
...
=
  (Group_symbol_t.Group_for_symbol_symbol
   ...
   [99; 88; 28; 22; 1; 3; 2; 8; 4])
);;

let non_gro = Group_tag_v.group_nontup_off_group_tag tag_gro;;

test_number 8 (
 non_gro
(* : Group_symbol_t.group_symbol * Section_symbol_t.section_symbol *
  Camlparagraph_symbol_t.camlparagraph_symbol * Item_symbol_t.item_symbol *
  Usagefile_symbol_t.usagefile_symbol *
  Contentfile_symbol_t.contentfile_symbol * Entity_symbol_t.entity_symbol *
  Category_symbol_t.category_symbol * Domainset_symbol_t.domainset_symbol *)
...
let sym_cal = Camlline_symbol_v.try_et_symbol_of_es_symbol;;
let idx_cal = 100;;
let soi_cal = Sole_index_v.make idx_cal soi_gro;;
...
test_number 10 (
 dec_cdf 
(* : Camlline_duo_function_symbol_t.camlline_duo_function_symbol *
  Group_symbol_t.group_symbol * Section_symbol_t.section_symbol *
  Camlparagraph_symbol_t.camlparagraph_symbol * Item_symbol_t.item_symbol *
  Usagefile_symbol_t.usagefile_symbol *
  Contentfile_symbol_t.contentfile_symbol * Entity_symbol_t.entity_symbol *
...
=
  (Camlline_duo_function_symbol_t.Try_et_symbol_of_es_symbol,
   ...
   Entity_symbol_t.Entity_proper_symbol
    (Entity_proper_symbol_t.Currententity "triangle"),
   Category_symbol_t.Tag, Domainset_symbol_t.Figureset)
);;
