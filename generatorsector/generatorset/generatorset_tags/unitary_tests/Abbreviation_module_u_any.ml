...
testing "Abbreviation_module_u_any.ml";;
...
let sym_cof_v = Contentfile_symbol_t.Value_alone;;
...
test_number 10 (
Abbreviation_module_v.abbreviation_module_of_contentfile_symbol_of_category_symbol_of_entity_symbol sym_cof_v sym_cat sym_ent_zc3 
=
"A0c3s_v"
);;
