(** {3 Camlline_for_any_uno_camltype_top_interface_v} *)
...
let documentation () = 
  [
   ...
   "Needs : IGNR:None";
   "Current : IGNR:Camlline_for_any_uno_camltype_top_interface_v";
   "Needed-by : FGNR:Camlline_for_any_uno_camltype_top_interface_v";
