(** {3 Item_for_symbol_each_topson_bare_interface_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Needs : SGNR:Item_for_symbol_each_topson_bare_symbol_v";
   "Needs : IGNR:Entity_topson_bare_symbol_list_by_entity_tritup_provider_v";
   "Current : IGNR:Item_for_symbol_each_topson_bare_interface_v";
   "Needed-by : FGNR:Item_for_symbol_each_topson_bare_v";
...
let make_of_tuple sex_ifs =
  ...
  | Item_for_symbol_each_topson_bare_symbol_t.Abbreviating_topson_bare_for_symbol ->
      ...
      let sym_ca2 = Camlparagraph_for_symbol_let_abbreviate_symbol_v.let_abbreviate_topson_bare in
  ...
  | Item_for_symbol_each_topson_bare_symbol_t.Querying_topson_bare_for_symbol ->
	...
	then     
	  Camlparagraph_for_symbol_let_match_symbol_v.let_is_onlyson_bare
	else
	  Camlparagraph_for_symbol_let_match_symbol_v.let_is_topson_bare
      in
