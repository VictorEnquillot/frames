(** {3 Entity_grandson_ofstring_symbol_list_by_entity_tritup_provider_v} *)
...
let documentation () = 
  [
   ...
   "Current : IGNR:Entity_grandson_ofstring_symbol_list_by_entity_tritup_provider_v";
   "Needed-by : IGNR:";
...
let build tri_ent =
  let sym_ent_lea_l =
    Entity_grandson_leaf_symbol_list_by_entity_tritup_provider_v.provide 
      tri_ent
  in
  List.filter Entity_symbol_v.is_ofstring sym_ent_lea_l
;;
