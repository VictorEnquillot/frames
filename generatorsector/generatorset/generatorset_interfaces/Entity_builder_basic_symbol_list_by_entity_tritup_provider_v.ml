(** {3 Entity_builder_basic_symbol_list_by_entity_tritup_provider_v} *)
...
let documentation () = 
  [
   ...
   "Current : IGNR:Entity_builder_basic_symbol_list_by_entity_tritup_provider_v";
   "Needed-by : ";
   "Definition : an Entity_builder_basic is an Entity_proper builder defined in formulas.set databasic";
   "Definition : an Entity_builder_basic_symbol is the Entity_symbol translated from Entity_builder_basicname";
 ]
;;
...
let build tri_ent =
  ...
  Entity_builder_basic_symbol_list_by_entity_fictive_nullary_tritup_provider_v.provide tri_efn
;;
