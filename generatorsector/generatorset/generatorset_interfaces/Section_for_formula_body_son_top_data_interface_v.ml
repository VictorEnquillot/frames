(** {6 Section_for_formula_body_son_top_data_interface} *)
...
let documentation () = 
  [
   "Needs : IGNR:";
   "Current : IGNR:Section_for_formula_body_son_top_data_interface_v";
   "Needed-by : FGNR:Section_for_formula_body_son_top_data_v";
   "What-is-it : It defines the Son_top_data_symbol Datastructure for a Leaf Entity"; 
   "Improve : should be read from domain_son_top_dataset_formulas.set";
 ]
;;
...
let make_of_tuple oct_smb =
  ...
  (* | ... repeat *)
      ...
      let sym_gr1 = Group_for_formula_body_son_top_data_symbol_v.data_tag_list_topson_pattern_bare_for_formula in
      let sym_gro = Group_symbol_v.group_symbol_of_group_for_formula_body_son_top_data_symbol sym_gr1 in
  ...
  (* | ... repeat *)
      ...
      let sym_gr1 = Group_for_formula_body_son_top_data_symbol_v.data_tag_list_topson_pattern_notleaf_for_formula in
      let sym_gro = Group_symbol_v.group_symbol_of_group_for_formula_body_son_top_data_symbol sym_gr1 in
  ...
  (* | ... repeat *)
      ...
      let sym_gr1 = Group_for_formula_body_son_top_data_symbol_v.data_tag_list_topson_pattern_ofstring_for_formula in
      let sym_gro = Group_symbol_v.group_symbol_of_group_for_formula_body_son_top_data_symbol sym_gr1 in
