(** {3 Entity_grandson_notleaf_symbol_list_by_entity_tritup_provider_v} *)
...
let documentation () = 
  [
   ...
   "Current : IGNR:Entity_grandson_notleaf_symbol_list_by_entity_tritup_provider_v";
   "Needed-by : IGNR:Camlparagraph_symbol_list_by_item_for_symbol_each_grandson_notleaf_abbreviating_grandson_tritup_provider_v";
   "What-is-it : it defines each Entity_current_grandson_notleaf_symbol list associated with each Item_for_symbol_each_notleaf_tag";
 ]
;;
...
let nam_reg = "entity_grandson_notleaf_symbol_list_by_entity_tritup_register";;

let entity_grandson_notleaf_symbol_list_by_entity_tritup_register : 
...
let store tri_ent sym_ent_l =
  try Register_v.store
      entity_grandson_notleaf_symbol_list_by_entity_tritup_register
      tri_ent 
      sym_ent_l
...
let is_stored tri_ent =
  Register_v.is_stored 
    entity_grandson_notleaf_symbol_list_by_entity_tritup_register tri_ent
;;
