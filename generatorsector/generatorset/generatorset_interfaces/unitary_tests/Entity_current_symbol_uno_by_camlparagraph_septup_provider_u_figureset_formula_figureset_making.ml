...
testing "Entity_current_symbol_uno_by_camlparagraph_septup_provider_v with
   Entity_current_symbol_uno_by_camlparagraph_septup_provider_u_figure_formula_figure_making.ml";;

(* toplevel 
   #use "Entity_current_symbol_uno_by_camlparagraph_septup_provider_u_figure_formula_figure_making.ml";; 
...
=
  (Camlparagraph_symbol_v.item_title "making", [1; 23; 1; 3; 1; 2; 4])
);;

let sym_ent_cur = Entity_current_symbol_uno_by_camlparagraph_septup_provider_v.provide sep_cap;;
