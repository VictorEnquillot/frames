...
(* toplevel 
   #use "Entity_symbol_constructor_tree_by_domain_symbol_provider_u_moleculeset_symbol.ml";; 
...
let sym_ent_son_tl = List.map (Entity_symbol_constructor_tree_by_domain_symbol_provider_v.leaf_entity_symbol_self_or_string_or_datastructure_of_tree nam_con_t) nam_con_son_tl;;
