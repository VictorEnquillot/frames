...
testing "Entity_current_symbol_camlparagraph_septup_doublet_list_by_item_sextup_provider_v with 
   Entity_current_symbol_camlparagraph_septup_doublet_list_by_item_sextup_provider_u_figure_symbol_figure_upgrading.ml";;

(* toplevel 
   #use "Entity_current_symbol_camlparagraph_septup_doublet_list_by_item_sextup_provider_u_figure_symbol_figure_upgrading.ml";; 
...
test_number 3 (
sym_enc_tag_cap_dol = Entity_current_symbol_camlparagraph_septup_doublet_list_by_item_each_grandson_notleaf_sextup_provider_v.provide tag_ign
);;
...
test_number 6 (
sym_enc_tag_cap_dol = Entity_current_symbol_camlparagraph_septup_doublet_list_by_item_each_topson_notleaf_sextup_provider_v.provide tag_itn
);;
