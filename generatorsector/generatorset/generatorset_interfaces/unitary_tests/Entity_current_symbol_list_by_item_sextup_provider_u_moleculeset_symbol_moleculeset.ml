...
(* toplevel 
   #use "Entity_current_symbol_list_by_item_sextup_provider_u_moleculeset_symbol_moleculeset.ml";; 
...
test_number 3 (
select_path_of_head_name "butane" pat_sym_ent_abb_l
...
test_number 4 (
select_path_of_head_name "fragment_closed_fromid" pat_sym_ent_abb_l
(* : Entity_symbol_t.entity_symbol list list *)
=
[[Entity_symbol_t.Entity_fictive_symbol
