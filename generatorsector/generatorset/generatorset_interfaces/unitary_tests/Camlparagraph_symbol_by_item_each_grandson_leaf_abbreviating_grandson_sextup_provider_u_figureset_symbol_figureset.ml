...
testing "Camlparagraph_symbol_by_item_each_grandson_leaf_abbreviating_grandson_sextup_provider_v with
   Camlparagraph_symbol_by_item_each_grandson_leaf_abbreviating_grandson_sextup_provider_u_figure_symbol_figure.ml";;

(* toplevel 
   #use "Camlparagraph_symbol_by_item_each_grandson_leaf_abbreviating_grandson_sextup_provider_u_figure_symbol_figure.ml";;
...
let sym_cap = Camlparagraph_symbol_by_item_each_grandson_leaf_abbreviating_grandson_sextup_provider_v.provide sex_igl;;
