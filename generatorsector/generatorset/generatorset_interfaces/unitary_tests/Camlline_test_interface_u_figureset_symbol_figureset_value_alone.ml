...
testing "Camlline_test_interface_v with
   Camlline_test_interface_u_figure_symbol_figure_value_alone.ml";;

(* toplevel 
   #use "Camlline_test_interface_u_figure_symbol_figure_value_alone.ml";;
...
(* 3 Group_for_symbol_body_son_top_symbol_t.Pipe_upgrade_name_leaf_ofstring_function *)
let sym_gro = List.nth sym_gro_l (idx_gro-1);;
let sym_gst = Group_symbol_v.group_for_symbol_body_son_top_symbol_off_group_symbol sym_gro;;
let non_gst = (sym_gst, sym_sec, sym_cap, sym_ite, sym_usf, sym_cof, sym_ent, sym_cat, sym_dos) ;;

let sym_cal_l = Group_for_symbol_body_son_top_interface_v.make non_gst soi_gro;;
