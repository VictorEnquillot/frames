...
testing "Entity_symbol_list_by_camlline_octtup_provider_v with
   Camlparagraph_for_symbol_let_match_proformula_u_figure_symbol_triangle_making.ml";;

(* toplevel 
   #use "Camlparagraph_for_symbol_let_match_proformula_u_figure_symbol_triangle_making.ml";;
...
let tag_slm = Camlparagraph_tag_v.camlparagraph_for_symbol_let_mixed_tag_off_camlparagraph_tag sep_cap;;
let sym_slm = Tag_v.symbol_off_tag tag_slm;;
let dol_efs = Camlparagraph_for_symbol_let_mixed_proformula_v.translate_and_couple soi_cap sym_slm;;
