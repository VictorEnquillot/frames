...
testing "Camlline_symbol_list_by_camlparagraph_septup_provider_v with
   Camlline_symbol_list_by_camlparagraph_septup_provider_u_figure_symbol_figure.ml";;

(* toplevel 
   #use "Camlline_symbol_list_by_camlparagraph_septup_provider_u_figure_symbol_figure.ml";;
...
let sym_cap_l_mak = Camlline_symbol_list_by_camlparagraph_septup_provider_v.provide tag_ite_mak;;
...
let sym_cap_l_nam = Camlline_symbol_list_by_camlparagraph_septup_provider_v.provide tag_ite_nam;;
...
let sym_cap_l_ext = Camlline_symbol_list_by_camlparagraph_septup_provider_v.provide tag_ite_ext;;
...
let sym_cap_l_upg = Camlline_symbol_list_by_camlparagraph_septup_provider_v.provide tag_ite_upg;;
...
let sym_cap_l_typ = Camlline_symbol_list_by_camlparagraph_septup_provider_v.provide tag_ite_typ;;
