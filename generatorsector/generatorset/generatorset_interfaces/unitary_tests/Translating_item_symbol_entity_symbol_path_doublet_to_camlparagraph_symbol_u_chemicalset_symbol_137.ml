...
testing "Entity_symbol_path_item_symbol_doublet_to_camlparagraph_symbol_v with
   Translating_item_symbol_entity_symbol_path_doublet_to_camlparagraph_symbol_u_chemicalset_symbol_137.ml";;

(* toplevel 
   #use "Translating_item_symbol_entity_symbol_path_doublet_to_camlparagraph_symbol_u_chemicalset_symbol_137.ml";;
*)
...
=
(Item_symbol_v.naming, [4; 1; 2; 137; 1; 1])
);;
...
(* : Item_symbol_t.item_symbol Tag_t.tag *)
=
(Item_symbol_v.extracting, [5; 1; 2; 137; 1; 1])
);;
...
=Camlparagraph_symbol_t.Camlparagraph_endmarked_symbol
 (Camlparagraph_endmarked_symbol_t.Camlparagraph_endmarked_let_symbol
   (Camlparagraph_endmarked_let_symbol_t.Camlparagraph_endmarked_let_match_symbol
     Camlparagraph_endmarked_let_match_symbol_t.Let_ess_off_est_onlyson))
);;
...
(* : Item_symbol_t.item_symbol Tag_t.tag *)
=
(Item_symbol_v.upgrading_grandson, [7; 1; 2; 137; 1; 1])
);;
