...
testing "Entity_current_symbol_list_by_item_only_top_sextup_provider_v with
   Entity_current_symbol_list_by_item_only_top_sextup_provider_u_figure_formula_triangle_isoceles.ml";; 

(* toplevel 
   #use "Entity_current_symbol_list_by_item_only_top_sextup_provider_u_figure_formula_triangle_isoceles.ml";; 
