...
testing "Entity_symbol_list_camlline_symbol_doublet_list_by_camlparagraph_septup_provider_v with
   Entity_symbol_list_camlline_symbol_doublet_list_by_camlparagraph_septup_provider_u_figure_symbol_figure.ml";;

(* toplevel 
   #use "Entity_symbol_list_camlline_symbol_doublet_list_by_camlparagraph_septup_provider_u_figure_symbol_figure.ml";;
...
let sym_cap = Camlparagraph_symbol_v.empty;;
...
let tag_cap_hea = Tag_v.make sym_cap soi_cap;;
  
let pat_sym_ent_l = Entity_current_symbol_uno_by_camlparagraph_septup_provider_v.provide tag_cap_hea;;
let sym_ent_sym_cal_dol_hea = Entity_symbol_list_camlline_symbol_doublet_list_by_camlparagraph_septup_provider_v.provide tag_cap_hea;;
...
(* Camlparagraph : Let_make_nam_s_equal_function_for_symbol *)
