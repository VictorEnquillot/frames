...
(* toplevel 
   #use "Entity_symbol_list_by_camlline_octtup_provider_u_moleculeset_symbol_moleculeset.ml";;
...
let sym_ent_l_abb = Entity_symbol_list_by_camlline_octtup_provider_v.provide tag_cal_abb;;
...
let pat_sym_ent_l_mak = Entity_current_symbol_uno_by_camlparagraph_septup_provider_v.provide tag_cap_mak;;
*)
