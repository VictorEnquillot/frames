...
testing "Camlparagraph_for_formula_let_function_proformula_v with
   Camlparagraph_for_formula_let_entity_proper_proformula_u_figure_formula_triangle_isoceles_naming.ml";;

(* toplevel 
   #use "Camlparagraph_for_formula_let_entity_proper_proformula_u_figure_formula_triangle_isoceles_naming.ml";;
...
(* Camlparagraph : 2 Let_name_nam_s_equal_function_for_symbol *)
...
let sym_cfn = Camlparagraph_symbol_v.let_name_entity_proper_for_formula;;
