...
(* toplevel 
   #use "Entity_builder_symbol_tree_by_entity_proper_tritup_provider_u_naturalset.ml";;

*)

let nam_cod = "Entity_builder_symbol_tree_by_entity_proper_tritup_provider_u_naturalset.ml"
...
(* : (Entity_proper_symbol_t.entity_proper_symbol,
   ...
   Triplet_t.triplet *)
  =
(Entity_proper_symbol_t.Entity_proper_with_sons "natural",
...
[(Entity_proper_symbol_t.Entity_proper_with_sons "expression",
  Category_symbol_t.Formula, Domain_symbol_t.Natural)]
);;
