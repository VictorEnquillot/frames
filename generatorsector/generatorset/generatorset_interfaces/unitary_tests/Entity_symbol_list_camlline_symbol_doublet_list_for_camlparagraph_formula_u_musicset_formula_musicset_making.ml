...
(* toplevel 
   #use "Entity_symbol_list_camlline_symbol_doublet_list_for_camlparagraph_formula_u_musicset_formula_musicset_making.ml";;
...
let sym_ent_sym_cal_dol = Entity_symbol_list_camlline_symbol_doublet_list_for_camlparagraph_formula_v.translate_and_couple sep_cap;;
