...
testing "Camlparagraph_symbol_list_by_item_sextup_provider_v with
   Camlparagraph_septup_list_by_item_sextup_provider_u_figure_symbol_figure_documenting.ml";;

(* toplevel 
   #use "Camlparagraph_septup_list_by_item_sextup_provider_u_figure_symbol_figure_documenting.ml";;
...
let tag_ign = Item_tag_v.item_only_top_tag_off_item_tag sex_ite;;

test_number 3 (
sym_enc_l = Entity_current_symbol_list_by_item_only_top_sextup_provider_v.provide tag_ign
);;

let sym_enc_n_tag_cap_dol = Entity_current_symbol_camlparagraph_septup_doublet_list_by_item_only_top_sextup_provider_v.provide tag_ign;;
