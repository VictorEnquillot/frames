...
testing "Entity_builder_basic_symbol_list_by_entity_fictive_nullary_tritup_provider_v 
   Entity_builder_basic_symbol_list_by_entity_fictive_nullary_tritup_provider_u_figure_list.ml"

(* toplevel 
   #use "Entity_builder_basic_symbol_list_by_entity_fictive_nullary_tritup_provider_u_figure_list.ml";;
...
let sym_efb_l = List.map Entity_builder_basic_symbol_list_by_entity_fictive_nullary_tritup_provider_v.provide tri_efn_l;;

test_number 1 (
sym_efb_l
(* : Entity_fictive_basicnullary_symbol_t.entity_fictive_basicnullary_symbol
  list list *)
=
...
let dou_l = List.map2 Doublet_v.make sym_efn_l sym_efb_l;;
