...
testing "Entity_symbol_list_by_camlline_octtup_provider_v with
   Camlparagraph_for_symbol_let_argument_proformula_u_figure_symbol_triangle_isoceles_making.ml";;

(* toplevel 
   #use "Camlparagraph_for_symbol_let_argument_proformula_u_figure_symbol_triangle_isoceles_making.ml";;
...
test_number 2 (
Tools_ignr_v.is_main_type_of_entity_proper_tag tag_enp
=
false
);;
