...
testing "Entity_symbol_builder_subtree_by_entity_fictive_nullary_tritup_provider_v with
   Entity_symbol_builder_subtree_by_entity_fictive_nullary_tritup_provider_u_figure_formula_point_constructor.ml";;

(* toplevel 
   #use "Entity_symbol_builder_subtree_by_entity_fictive_nullary_tritup_provider_u_figure_formula_point_constructor.ml";;
...
(* : Entity_fictive_nullary_symbol_t.entity_fictive_nullary_symbol Tag_t.tag *)
  =
(Entity_fictive_nullary_symbol_t.Nonsonnullary "point_constructor", 
 [35; 2; 4])
);;
