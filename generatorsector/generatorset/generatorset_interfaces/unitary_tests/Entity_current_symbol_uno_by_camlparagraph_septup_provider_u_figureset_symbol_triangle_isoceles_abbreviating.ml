...
testing "Entity_current_symbol_uno_by_camlparagraph_septup_provider_v with
   Entity_current_symbol_uno_by_camlparagraph_septup_provider_u_figure_symbol_triangle_isoceles_abbreviating.ml";;

(* toplevel 
   #use "Entity_current_symbol_uno_by_camlparagraph_septup_provider_u_figure_symbol_triangle_isoceles_abbreviating.ml";; 
...
=
  (Camlparagraph_symbol_v.item_title "abbreviating",
   [1; 8; 1; 3; 698516742; 7; 4])
);;
...
(* : Camlparagraph_symbol_t.camlparagraph_symbol Tag_t.tag *)
=
  (Camlparagraph_symbol_v.let_abbreviate_infather,
   [2; 8; 1; 3; 698516742; 7; 4])
);;
...
(* Camlparagraph : 5 Let_abbreviate_infather *)
...
(* : Camlparagraph_symbol_t.camlparagraph_symbol Tag_t.tag *)
=
  (Camlparagraph_symbol_v.let_abbreviate_infather, [5; 8; 1; 3; 698516742; 7; 4])
);;
