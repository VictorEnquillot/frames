...
testing "Entity_builder_base_symbol_list_by_entity_fictive_nullary_tritup_provider_v with
   Entity_builder_base_symbol_list_by_entity_fictive_nullary_tritup_provider_u_figure_formula_point.ml"

(* toplevel 
   #use "Entity_builder_base_symbol_list_by_entity_fictive_nullary_tritup_provider_u_figure_formula_point.ml";;

*)

let nam_cod = "Entity_builder_base_symbol_list_by_entity_fictive_nullary_tritup_provider_u_figure_formula_point.ml"
...
let nam_bui_l = Builder_basename_list_by_entity_leaf_trail_provider_v.provide tra_ent;;
...
List.hd sym_bui_l 
=
Tools_ignr_2_v.builder_symbol_of_entity_tritup tri_ent
);;
