...
testing "Camlline_symbol_list_by_camlparagraph_septup_provider_v with
   Camlline_symbol_list_by_camlparagraph_septup_provider_u_figure_formula_x_naming.ml";;

(* toplevel 
   #use "Camlline_symbol_list_by_camlparagraph_septup_provider_u_figure_formula_x_naming.ml";; 
    ...
    Camlline_symbol_t.Camlline_datastructure_symbol
     (Camlline_datastructure_symbol_t.Camlline_datastructure_function_symbol
       (Camlline_datastructure_function_symbol_t.Camlline_datastructure_function_name_symbol
         (Camlline_datastructure_function_name_symbol_t.Das_vdot_name_nam_a_for_at
           "singlet"))));
   ([],
...
let sym_cap = Camlparagraph_symbol_v.let_name_entity_fictive_nullary_for_formula;;
