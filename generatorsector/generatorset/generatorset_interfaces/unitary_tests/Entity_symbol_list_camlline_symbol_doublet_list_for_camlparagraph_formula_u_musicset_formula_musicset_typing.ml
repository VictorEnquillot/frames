...
(* toplevel 
   #use "Entity_symbol_list_camlline_symbol_doublet_list_for_camlparagraph_formula_u_musicset_formula_musicset_typing.ml";;
...
=
  (Camlparagraph_symbol_t.Camlparagraph_for_any_comment_symbol
    (Camlparagraph_for_any_comment_symbol_t.Item_title "typing"),
   [1; 7; 1; 1; 383488616; 2; 4])
);;

let sym_ent_sym_cal_dol_typ = Entity_symbol_list_camlline_symbol_doublet_list_for_camlparagraph_formula_v.translate_and_couple sep_cap;;
