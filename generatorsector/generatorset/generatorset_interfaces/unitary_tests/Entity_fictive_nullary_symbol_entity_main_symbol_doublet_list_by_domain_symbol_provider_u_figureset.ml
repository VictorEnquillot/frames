...
testing "Entity_fictive_nullary_symbol_entity_main_symbol_doublet_list_by_domain_symbol_provider_v with
   Entity_fictive_nullary_symbol_entity_main_symbol_doublet_list_by_domain_symbol_provider_u_figure.ml";;

(* toplevel 
   #use "Entity_fictive_nullary_symbol_entity_main_symbol_doublet_list_by_domain_symbol_provider_u_figure.ml";;
...
let sym_lea_sym_mai_dol = Entity_fictive_nullary_symbol_entity_main_symbol_doublet_list_by_domain_symbol_provider_v.provide sym_dos;;
