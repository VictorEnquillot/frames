...
testing "Camlline_test_interface_v with
   Camlline_test_interface_u_figure_symbol_figure_type_alone.ml";;

(* toplevel 
   #use "Camlline_test_interface_u_figure_symbol_figure_type_alone.ml";;
...
let sym_cap = List.nth sym_cap_l 0;;
