...
testing "Entity_symbol_list_by_camlline_octtup_provider_v with
   Camlparagraph_for_symbol_any_function_proformula_u_figure_symbol_figure.ml";;

(* toplevel 
   #use "Camlparagraph_for_symbol_any_function_proformula_u_figure_symbol_figure.ml";;
...
let dol_efs = Camlparagraph_for_symbol_any_function_proformula_v.couple_list_of_camlparagraph_endmarked_let_function sym_elf_mak soi_cap;;
...
let dol_efs = Camlparagraph_for_symbol_any_function_proformula_v.couple_list_of_camlparagraph_endmarked_let_function sym_elf_nam soi_cap;;
...
let dol_off = Camlparagraph_for_symbol_any_function_proformula_v.translate_and_couple sym_elf_off soi_cap;;
