...
testing "Camlparagraph_for_tag_type_proformula_v with
   Camlparagraph_for_tag_type_proformula_u_figure_tag_figure_typing.ml";;

(* toplevel 
   #use "Camlparagraph_for_tag_type_proformula_u_figure_tag_figure_typing.ml";;
...
let sym_cpt = Camlparagraph_symbol_v.camlparagraph_for_tag_symbol_off_camlparagraph_symbol sym_cap;;

let pro_cap = Camlparagraph_for_tag_type_proformula_v.translate_and_couple soi_cap;;
