...
testing "Entity_symbol_list_by_camlline_octtup_provider_v with
   Entity_symbol_list_by_camlline_octtup_provider_u_figure_symbol_figure_typing.ml";;

(* toplevel 
   #use "Entity_symbol_list_by_camlline_octtup_provider_u_figure_symbol_figure_typing.ml";;
...
let pre_gss = Generatorset_symbol_v.is_camlparagraph_symbol_off_generatorset_symbol;;
let (gss_cap, soi_cap) = 
    Tools_tag_v.upwards_generatorset_tag_of_predicate_off_current_tag
      pre_gss 
      oct_cal
;;
