...
testing "Entity_current_symbol_list_by_item_sextup_provider_v with
   Entity_current_symbol_list_by_item_sextup_provider_u_figure_symbol_figure_making.ml";; 

(* toplevel 
   #use "Entity_current_symbol_list_by_item_sextup_provider_u_figure_symbol_figure_making.ml";; 
...
test_number 5 (
sym_enc_l = Entity_current_symbol_list_by_item_all_topsons_sextup_provider_v.provide tag_iat
);;

let sym_enc = List.nth sym_enc_l 1;;
let tag_enc = Tag_v.make sym_enc soi_enp;;
let tag_enp = Entity_tag_v.entity_proper_tag_off_entity_tag tag_enc;;
