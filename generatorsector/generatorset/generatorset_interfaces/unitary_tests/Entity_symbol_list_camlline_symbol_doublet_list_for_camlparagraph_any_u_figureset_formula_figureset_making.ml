...
testing "Entity_symbol_list_camlline_symbol_doublet_list_for_camlparagraph_any_v with
   Entity_symbol_list_camlline_symbol_doublet_list_for_camlparagraph_any_u_figure_formula_figure_making.ml";;

(* toplevel 
   #use "Entity_symbol_list_camlline_symbol_doublet_list_for_camlparagraph_any_u_figure_formula_figure_making.ml";;
...
let sym_ent_sym_cal_dol = Entity_symbol_list_camlline_symbol_doublet_list_for_camlparagraph_any_v.translate_and_couple sep_cap;;
