...
testing "Entity_builder_base_symbol_list_by_entity_fictive_nullary_tritup_provider_v with
   Entity_builder_base_symbol_list_by_entity_fictive_nullary_tritup_provider_u_figure_formula_coordinate_list.ml"

(* toplevel 
   #use "Entity_builder_base_symbol_list_by_entity_fictive_nullary_tritup_provider_u_figure_formula_coordinate_list.ml";;

*)

let nam_cod = "Entity_builder_base_symbol_list_by_entity_fictive_nullary_tritup_provider_u_figure_formula_coordinate_list.ml"
...
let sym_ent = Entity_symbol_v.ofstring "x";;
let tri_ent = (sym_ent, sym_cat, sym_dos);;
let sym_enp_l = Entity_builder_base_symbol_list_by_entity_tritup_provider_v.provide tri_ent;;
...
(* : (Entity_fictive_nullary_symbol_t.entity_fictive_nullary_symbol,
  ...
  Triplet_t.triplet *)
=
 (Entity_fictive_nullary_symbol_t.Ofstring "x", Category_symbol_t.Formula,
