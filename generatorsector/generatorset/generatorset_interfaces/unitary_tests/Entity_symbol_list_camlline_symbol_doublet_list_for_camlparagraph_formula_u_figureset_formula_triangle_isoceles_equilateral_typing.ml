...
testing "Entity_symbol_list_camlline_symbol_doublet_list_for_camlparagraph_formula_v with
   Entity_symbol_list_camlline_symbol_doublet_list_for_camlparagraph_formula_u_figure_formula_triangle_isoceles_equilateral_typing.ml";;

(* toplevel 
   #use "Entity_symbol_list_camlline_symbol_doublet_list_for_camlparagraph_formula_u_figure_formula_triangle_isoceles_equilateral_typing.ml";;
