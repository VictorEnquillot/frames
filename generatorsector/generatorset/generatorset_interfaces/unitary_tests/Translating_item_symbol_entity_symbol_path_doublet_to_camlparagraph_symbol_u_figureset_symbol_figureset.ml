...
testing "Entity_symbol_path_item_symbol_doublet_to_camlparagraph_symbol_v with
   Translating_item_symbol_entity_symbol_path_doublet_to_camlparagraph_symbol_u_figure_symbol_figure.ml";;

(* toplevel 
   #use "Translating_item_symbol_entity_symbol_path_doublet_to_camlparagraph_symbol_u_figure_symbol_figure.ml";;
