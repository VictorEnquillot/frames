...
testing "Entity_symbol_builder_subtree_by_entity_fictive_nullary_tritup_provider_v with
   Entity_symbol_builder_subtree_by_entity_fictive_nullary_tritup_provider_u_figure_symbol_triangle_isoceles_right.ml";;
(* toplevel 
   #use "Entity_symbol_builder_subtree_by_entity_fictive_nullary_tritup_provider_u_figure_symbol_triangle_isoceles_right.ml";;

*)

let nam_dos = "figure";;
let nam_cat = "formula";;
let nam_ent = "triangle_isoceles_right";;
