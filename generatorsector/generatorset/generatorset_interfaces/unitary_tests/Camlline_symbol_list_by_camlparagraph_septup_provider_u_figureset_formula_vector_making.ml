...
testing "Camlline_symbol_list_by_camlparagraph_septup_provider_v with
   Camlline_symbol_list_by_camlparagraph_septup_provider_u_figure_formula_vector_making.ml";;

(* toplevel 
   #use "Camlline_symbol_list_by_camlparagraph_septup_provider_u_figure_formula_vector_making.ml";; 
...
let nam_exd = Entity_external_datastructure_symbol_v.string_off sym_exd;;
 ...
 [([Entity_symbol_t.Entity_fictive_symbol
   ...
   ([Entity_symbol_t.Entity_external_symbol
    ...
    Camlline_symbol_t.Camlline_trio_symbol
     Camlline_trio_symbol_t.Space_Tools_fdos_vdot_duo_make_sym_as_soi_at_dos_of_ste);
   ([],
    Camlline_symbol_t.Camlline_constant_symbol
