...
testing "Entity_external_datastructure_symbol_by_entity_fictive_nullary_tritup_provider_v with
   Entity_external_datastructure_symbol_by_entity_fictive_nullary_tritup_provider_u_figure_symbol_triangle_isoceles.ml";;

(* toplevel 
   #use "Entity_external_datastructure_symbol_by_entity_fictive_nullary_tritup_provider_u_figure_symbol_triangle_isoceles.ml";;
...
let sym_exd = Entity_external_datastructure_symbol_by_entity_fictive_nullary_tritup_provider_v.provide tag_efn;;
