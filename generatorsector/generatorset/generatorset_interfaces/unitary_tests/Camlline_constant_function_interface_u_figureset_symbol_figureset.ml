...
testing "Camlline_constant_function_interface_v with
   Camlline_constant_function_interface_u_figure_symbol_figure.ml";;

(* toplevel 
   #use "Camlline_constant_function_interface_u_figure_symbol_figure.ml";;
