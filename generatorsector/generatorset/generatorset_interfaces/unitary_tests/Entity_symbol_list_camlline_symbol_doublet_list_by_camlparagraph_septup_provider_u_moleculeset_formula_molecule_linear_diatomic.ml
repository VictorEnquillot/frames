...
(* toplevel 
   #use "Entity_symbol_list_camlline_symbol_doublet_list_by_camlparagraph_septup_provider_u_moleculeset_formula_molecule_linear_diatomic.ml";;
...
let sym_ent_l_sym_cal_dol_typ = Entity_symbol_list_camlline_symbol_doublet_list_by_camlparagraph_septup_provider_v.provide tag_cap_typ;;
...
let sym_ent_l_sym_cal_dol_mak = Entity_symbol_list_camlline_symbol_doublet_list_by_camlparagraph_septup_provider_v.provide tag_cap_mak;;
...
test_number 7 (
List_v.sublist_of_int_of_int_of_list 0 5 sym_ent_l_sym_cal_dol_mak
