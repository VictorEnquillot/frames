...
testing "Entity_builder_leaf_symbol_list_by_entity_proper_tritup_provider_v 
   Entity_builder_leaf_symbol_list_by_entity_proper_tritup_provider_u_figure_list.ml"

(* toplevel 
   #use "Entity_builder_leaf_symbol_list_by_entity_proper_tritup_provider_u_figure_list.ml";;
...
let sym_eda = Entity_builder_leaf_symbol_list_by_entity_proper_tritup_provider_v.provide tri_enp;;
...
let sym_eda_l = List.map Entity_builder_leaf_symbol_list_by_entity_proper_tritup_provider_v.provide tri_nor_l;;
let dou_l = List.map2 Doublet_v.make sym_nor_l sym_eda_l;;

test_number 5 (
dou_l
(* :  (Entity_proper_symbol_t.entity_proper_symbol,
       Entity_fictive_basicnullary_symbol_t.entity_fictive_basicnullary_symbol list) Doublet_t.doublet list *)
=
