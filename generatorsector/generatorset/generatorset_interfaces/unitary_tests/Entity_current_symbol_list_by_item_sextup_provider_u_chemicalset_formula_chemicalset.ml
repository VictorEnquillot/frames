...
testing "Entity_current_symbol_list_by_item_sextup_provider_v with
   Entity_current_symbol_list_by_item_sextup_provider_u_chemicalset_formula_chemicalset.ml";; 

(* toplevel 
   #use "Entity_current_symbol_list_by_item_sextup_provider_u_chemicalset_formula_chemicalset.ml";; 
*)
...
[[Entity_symbol_t.Entity_proper_symbol
  ...
  Entity_symbol_t.Entity_proper_symbol
   (Entity_propert.Entity_proper_top_symbol
     (Entity_proper_top_symbol_t.Top_has_notopsonleaf "chemicalset"))];
 [Entity_symbol_t.Entity_proper_symbol
   (Entity_propert.Entity_proper_son_symbol
