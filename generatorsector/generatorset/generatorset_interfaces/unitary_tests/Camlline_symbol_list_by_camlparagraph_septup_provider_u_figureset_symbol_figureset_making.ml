...
testing "Camlline_symbol_list_by_camlparagraph_septup_provider_v with
   Camlline_symbol_list_by_camlparagraph_septup_provider_u_figure_symbol_figure_making.ml";;

(* toplevel 
   #use "Camlline_symbol_list_by_camlparagraph_septup_provider_u_figure_symbol_figure_making.ml";;
...
let sym_cap_l = Camlparagraph_symbol_list_by_item_all_topsons_making_sextup_provider_v.provide sex_iat;;
