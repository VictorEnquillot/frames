...
testing "Entity_symbol_list_by_camlline_octtup_provider_v with
   Entity_symbol_list_by_camlline_octtup_provider_u_chemicalset_symbol_cluster.ml";;

(* toplevel 
   #use "Entity_symbol_list_by_camlline_octtup_provider_u_chemicalset_symbol_cluster.ml";;
*)
...
let sym_cal_abb = Camlline_symbol_v.let_ess_arg_equal_est_tdot_ess_space_arg;;
...
let sym_cal_mak = Camlline_symbol_v.pipe_ecstring_arrow_ec_space_sarg;;
...
let sym_cal_nam = Camlline_symbol_v.pipe_est_tdot_ess_underscore_arrow_string;;
