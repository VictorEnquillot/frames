...
testing "Entity_current_symbol_list_by_item_only_top_sextup_provider_v with
   Entity_current_symbol_list_by_item_only_top_sextup_provider_u_figure_formula_triangle_isoceles_equilateral.ml";; 

(* toplevel 
   #use "Entity_current_symbol_list_by_item_only_top_sextup_provider_u_figure_formula_triangle_isoceles_equilateral.ml";; 
...
let nam_iot = "heading";;
let sym_iot = Item_only_top_symbol_v.make nam_iot;;
let sym_ite = Item_symbol_v.item_symbol_of_item_only_top_symbol sym_iot;;
...
let tag_iot = Tag_v.make sym_iot soi_ite;;
