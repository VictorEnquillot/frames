...
testing "Item_symbol_list_by_usagefile_quitup_provider_v with
   Item_symbol_list_by_usagefile_quitup_provider_u_figure_formula_coordinate_polar.ml";;

(* toplevel 
   #use "Item_symbol_list_by_usagefile_quitup_provider_u_figure_formula_coordinate_polar.ml";; 
...
(* Coordinate_polar : Stem of CT, Stem of BT *)
...
test_number 5 (
is_ct_stem && is_bt_stem && has_no_bpt
);;
...
let no_it3_it4_l = List_v.exclude_of_element_of_list sym_it4 Usagefile_for_formula_interface_v.all_item_symbol_list;;
