...
testing "Entity_symbol_constructor_tree_by_kind_trail_provider_u_figure_symbol.ml";;

(* toplevel 
   #use "Entity_symbol_constructor_tree_by_kind_trail_provider_u_figure_symbol.ml";; 
*)
...
Tree_t.Inner
 (Entity_symbol_t.Entity_proper_symbol
   (Entity_symbol_v.top_has_notopsonleaf "figure"),
 [Tree_t.Inner
   (Entity_symbol_t.Entity_proper_symbol
     (Entity_symbol_t.Entity_proper "triangle"),
   [Tree_t.Leaf
