...
testing "Entity_current_symbol_camlparagraph_septup_doublet_list_by_item_sextup_provider_v with 
   Entity_current_symbol_camlparagraph_septup_doublet_list_by_item_sextup_provider_u_figure_symbol_figure_making.ml";;

(* toplevel 
   #use "Entity_current_symbol_camlparagraph_septup_doublet_list_by_item_sextup_provider_u_figure_symbol_figure_making.ml";; 
