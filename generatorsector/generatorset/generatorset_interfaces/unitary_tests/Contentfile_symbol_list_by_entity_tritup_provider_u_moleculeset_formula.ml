...
testing "Contentfile_symbol_list_by_entity_tritup_provider_v with
   Contentfile_symbol_list_by_entity_tritup_provider_u_moleculeset_formula.ml";;

(* toplevel 
   #use "Contentfile_symbol_list_by_entity_tritup_provider_u_moleculeset_formula.ml";; 
...
tag_cof
=
Contentfile_symbol_t.Unconstraine
);;
