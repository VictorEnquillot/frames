...
testing "Entity_topson_symbol_list_by_entity_tritup_provider_v with
   Entity_topson_symbol_list_by_entity_tritup_provider_u_figure_symbol_figure.ml";;

(* toplevel 
   #use "Entity_topson_symbol_list_by_entity_tritup_provider_u_figure_symbol_figure.ml";; 
...
let sym_ent_l = Entity_topson_symbol_list_by_entity_tritup_provider_v.provide tri_ent;;
