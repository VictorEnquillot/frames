(** {3 Entity_grandson_symbol_list_by_entity_tritup_provider_v} *)
...
let documentation () = 
  [
   ...
   "Current : IGNR:Entity_grandson_symbol_list_by_entity_tritup_provider_v";
   "Needed-by : IGNR:Camlparagraph_symbol_list_by_item_for_symbol_each_grandson_leaf_abbreviating_grandson_tritup_provider_v";
   "What-is-it : it defines each Entity_current_grandson_symbol list associated with each Item_for_symbol_each_leaf_tag";
 ]
;;
