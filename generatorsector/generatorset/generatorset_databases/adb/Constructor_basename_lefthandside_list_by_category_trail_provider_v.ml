(** {3 Constructor_basename_lefthandside_list_by_category_trail_provider_v} *)
...
let documentation () = 
  [
   ...
   "Current : AGNR:Constructor_basename_lefthandside_list_by_category_trail_provider_v";
   "Needed-by : ";
   "What-is-it : same as Entity...";
 ]
;;
...
let nam_reg = "constructor_basename_lefthandside_list_by_category_trail_register";;

let constructor_basename_lefthandside_list_by_category_trail_register : 
    (Trail_t.trail, 
     string list)
...
let retrieve tra_cat =
  try Register_v.retrieve 
      constructor_basename_lefthandside_list_by_category_trail_register 
      tra_cat
