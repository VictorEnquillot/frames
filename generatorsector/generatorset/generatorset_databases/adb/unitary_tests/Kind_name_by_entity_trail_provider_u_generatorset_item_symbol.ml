...
testing "Kind_name_by_entity_trail_provider_v with
   Kind_name_by_entity_trail_provider_u_generatorset_item_symbol.ml";; 

(* toplevel 
   #use "Kind_name_by_entity_trail_provider_u_generatorset_item_symbol.ml";; 
...
=
  [("type", "generatorset_item", "triangle vector point coordinate");
...
"Not_stored:kind_name_by_entity_trail_provider_v.ml.retrieve for [(entity, triangle_isoceles_equilateral); (category, symbol); (domain, generatorset_item)]") Kind_name_by_entity_trail_provider_v.provide tra_ent_equ;;
