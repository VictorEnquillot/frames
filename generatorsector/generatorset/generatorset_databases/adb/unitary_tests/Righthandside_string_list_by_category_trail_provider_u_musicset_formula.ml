...
(* toplevel 
   #use "Righthandside_string_list_by_category_trail_provider_u_musicset_formula.ml";;
...
=
  ["singlet string"; 
   "doublet mp3_header mp3_data"; 
   "list mp3_frame";
   "doublet tag_id3v1 mp3_elementary_stream";
   "doublet tag_id3v2 mp3_elementary_stream"]
);;
