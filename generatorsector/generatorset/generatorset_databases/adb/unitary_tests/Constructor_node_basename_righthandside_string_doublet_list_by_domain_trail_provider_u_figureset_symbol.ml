...
testing "Constructor_node_basename_righthandside_string_doublet_list_by_domain_trail_provider_v
   Constructor_node_basename_righthandside_string_doublet_list_by_domain_trail_provider_u_figureset.ml";; 

(* toplevel 
   #use "Constructor_node_basename_righthandside_string_doublet_list_by_domain_trail_provider_u_figureset.ml";;
...
=
  [("figure", "triangle vector point coordinate");
