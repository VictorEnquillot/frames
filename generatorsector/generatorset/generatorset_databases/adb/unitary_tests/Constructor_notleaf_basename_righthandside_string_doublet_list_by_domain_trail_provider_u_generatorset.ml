...
(* toplevel 
   #use "Constructor_notleaf_basename_righthandside_string_doublet_list_by_domain_trail_provider_u_generatorset.ml";;
...
=
  [("coordinate",
   ...
   ("generatorset", "coordinate point triangle vector fake");
