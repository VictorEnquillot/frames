...
(* toplevel 
   #use "Righthandside_string_by_constructor_notleaf_trail_provider_u_naturalset_symbol.ml";; 
...
= 
 [("natural", "coordinate point triangle vector fake");
   ...
   ("vector", "vector_constructor"); ("point", "point_constructor:ofstring");
   ("coordinate",
...
let tra_ent_poi = Trail_v.make "entity" "xxxx" tra_cat;;
test_raises_this_exc (Failure  "Constructor_notleaf_basename_not_found:Righthandside_string_by_constructor_notleaf_trail_provider_v.ml:build") Righthandside_string_by_constructor_notleaf_trail_provider_v.provide tra_ent_poi;;
