...
testing "Builder_basename_list_by_constructor_leaf_trail_provider_v with
   Builder_basename_list_by_constructor_leaf_trail_provider_u_generatorset_item_formula.ml";; 

(* toplevel 
   #use "Builder_basename_list_by_constructor_leaf_trail_provider_u_generatorset_item_formula.ml";; 
...
(* : Trail_t.trail *)
=
  [("entity", "point_constructor:ofstring"); ("category", "formula"); ("domain", "generatorset_item")]
);;
