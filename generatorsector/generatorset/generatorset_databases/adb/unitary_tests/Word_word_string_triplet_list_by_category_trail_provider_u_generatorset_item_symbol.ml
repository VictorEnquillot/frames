...
testing "Word_word_string_triplet_list_by_category_trail_provider_v with
   Word_word_string_triplet_list_by_category_trail_provider_u_generatorset_item_symbol.ml";; 

(* toplevel 
   #use "Word_word_string_triplet_list_by_category_trail_provider_u_generatorset_item_symbol.ml";; 
...
let par_1 = List.filter (select_entity_off_triplet "item_for_symbol_each" 0 20) wws_trl;;
