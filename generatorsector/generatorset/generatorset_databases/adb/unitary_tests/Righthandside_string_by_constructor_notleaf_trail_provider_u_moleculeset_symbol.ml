...
testing "Righthandside_string_by_constructor_notleaf_trail_provider_v with
   Righthandside_string_by_constructor_notleaf_trail_provider_u_moleculeset_symbol.ml";; 

(* toplevel 
   #use "Righthandside_string_by_constructor_notleaf_trail_provider_u_moleculeset_symbol.ml";; 
...
let rhs_str_gro_con = Righthandside_string_by_constructor_notleaf_trail_provider_v.provide tra_ent_gro_con;;
let rhs_str_gro_des = Righthandside_string_by_constructor_notleaf_trail_provider_v.provide tra_ent_gro_des;;
let rhs_str_gro_typ = Righthandside_string_by_constructor_notleaf_trail_provider_v.provide tra_ent_gro_typ;;

let rhs_str_gua_con = Righthandside_string_by_constructor_notleaf_trail_provider_v.provide tra_ent_gua_con;;
let rhs_str_gua_des = Righthandside_string_by_constructor_notleaf_trail_provider_v.provide tra_ent_gua_des;;
let rhs_str_gua_typ = Righthandside_string_by_constructor_notleaf_trail_provider_v.provide tra_ent_gua_typ;;

let rhs_str_mld_con = Righthandside_string_by_constructor_notleaf_trail_provider_v.provide tra_ent_mld_con;;
let rhs_str_mld_des = Righthandside_string_by_constructor_notleaf_trail_provider_v.provide tra_ent_mld_des;;
let rhs_str_mld_typ = Righthandside_string_by_constructor_notleaf_trail_provider_v.provide tra_ent_mld_typ;;

let rhs_str_mol_con = Righthandside_string_by_constructor_notleaf_trail_provider_v.provide tra_ent_mol_con;;
let rhs_str_mol_des = Righthandside_string_by_constructor_notleaf_trail_provider_v.provide tra_ent_mol_des;;
let rhs_str_mol_typ = Righthandside_string_by_constructor_notleaf_trail_provider_v.provide tra_ent_mol_typ;;
