...
(* : string list *)
=
 ["figure"; "triangle"; "triangle_isoceles"; "triangle_scalene"; "vector"; "point"; "coordinate"; "coordinate_cartesian"; "coordinate_cylindrical"; "coordinate_spherical"; "coordinate_polar"]
);;
**)
