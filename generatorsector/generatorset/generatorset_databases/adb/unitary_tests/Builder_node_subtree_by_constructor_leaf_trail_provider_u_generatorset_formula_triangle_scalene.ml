...
testing "Builder_node_subtree_by_constructor_leaf_trail_provider_v with
   Builder_node_subtree_by_constructor_leaf_trail_provider_u_generatorset_formula_triangle_scalene.ml";; 

(* toplevel 
   #use "Builder_node_subtree_by_constructor_leaf_trail_provider_u_generatorset_formula_triangle_scalene.ml";; 
...
let nam_dat_nam_bui_t = Builder_node_subtree_by_constructor_leaf_trail_provider_v.provide tra_ent;;

test_number 1 (
fin
(* Filename_p.filename *) 
=
Filename_p.filename "/keep/sources/ocaml_top/setup/frames/generatorset/generator/generatorset_formulas.set"
);;

test_number 2 (
Tree_v.topson_node_list_off_tree nam_dat_nam_bui_t
(* : string list *)
  =
...
(* : (string * string) Tree_t.tree *)
  =
Tree_t.Inner (("triangle_scalene_acute", "doublet"),
