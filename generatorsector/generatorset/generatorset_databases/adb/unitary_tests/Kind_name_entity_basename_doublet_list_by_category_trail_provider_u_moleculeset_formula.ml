...
testing "Kind_name_entity_basename_doublet_list_by_category_trail_provider_v with
   Kind_name_entity_basename_doublet_list_by_category_trail_provider_u_moleculeset_formula.ml";; 

(* toplevel 
   #use "Kind_name_entity_basename_doublet_list_by_category_trail_provider_u_moleculeset_formula.ml";; 
