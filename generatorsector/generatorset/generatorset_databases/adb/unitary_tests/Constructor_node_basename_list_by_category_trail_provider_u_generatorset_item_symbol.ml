...
testing "Constructor_node_basename_list_by_category_trail_provider_v with
   Constructor_node_basename_list_by_category_trail_provider_u_generatorset_item_symbol.ml";; 

(* toplevel 
   #use "Constructor_node_basename_list_by_category_trail_provider_u_generatorset_item_symbol.ml";; 
...
(* : string list *)
=
  ["generatorset_item"; "triangle"; "triangle_isoceles"; "triangle_scalene";
