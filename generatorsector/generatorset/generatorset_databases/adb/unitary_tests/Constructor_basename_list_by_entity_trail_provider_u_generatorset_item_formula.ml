...
testing "Constructor_basename_list_by_entity_trail_provider_v with
   Constructor_basename_list_by_entity_trail_provider_u_generatorset_item_formula.ml";; 

(* toplevel 
   #use "Constructor_basename_list_by_entity_trail_provider_u_generatorset_item_formula.ml";;
...
(* : Trail_t.trail *)
  =
[("entity", "vector"); ("category", "formula"); ("domain", "generatorset_item")]
);;
...
(* : Trail_t.trail *)
 =
[("entity", "x_3d"); ("category", "formula"); ("domain", "generatorset_item")]
);;
