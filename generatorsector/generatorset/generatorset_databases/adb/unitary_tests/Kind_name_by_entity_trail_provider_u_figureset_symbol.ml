...
testing "Kind_name_by_entity_trail_provider_v with
   Kind_name_by_entity_trail_provider_u_figureset_symbol.ml";; 

(* toplevel 
   #use "Kind_name_by_entity_trail_provider_u_figureset_symbol.ml";; 
...
=
  [("type", "figure", "triangle vector point coordinate");
...
"Not_stored:kind_name_by_entity_trail_provider_v.ml.retrieve for [(entity, triangle_isoceles_equilateral); (category, symbol); (domain, figureset)]") Kind_name_by_entity_trail_provider_v.provide tra_ent_equ;;
