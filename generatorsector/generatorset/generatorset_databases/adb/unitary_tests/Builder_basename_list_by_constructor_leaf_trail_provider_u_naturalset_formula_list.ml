...
(* toplevel 
   #use "Builder_basename_list_by_constructor_leaf_trail_provider_u_naturalset_formula_list.ml";; 
...
(* : Trail_t.trail *)
=
  [("entity", "point_constructor:ofstring"); ("category", "formula"); ("domain", "natural")]
);;
