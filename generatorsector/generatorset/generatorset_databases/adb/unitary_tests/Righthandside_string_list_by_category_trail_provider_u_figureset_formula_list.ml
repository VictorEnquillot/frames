...
testing "Righthandside_string_list_by_category_trail_provider_v
   Righthandside_string_list_by_category_trail_provider_u_figureset_formula.ml";; 

(* toplevel 
   #use "Righthandside_string_list_by_category_trail_provider_u_figureset_formula_list.ml";;
