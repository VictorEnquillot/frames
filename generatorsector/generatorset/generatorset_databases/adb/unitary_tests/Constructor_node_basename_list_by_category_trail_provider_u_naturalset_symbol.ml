...
testing "Constructor_node_basename_list_by_category_trail_provider_v with
   Constructor_node_basename_list_by_category_trail_provider_u_naturalset_symbol.ml";; 

(* toplevel 
   #use "Constructor_node_basename_list_by_category_trail_provider_u_naturalset_symbol.ml";; 
...
(* : string list *)
=
  ["natural"; "triangle"; "triangle_isoceles"; "triangle_scalene";
