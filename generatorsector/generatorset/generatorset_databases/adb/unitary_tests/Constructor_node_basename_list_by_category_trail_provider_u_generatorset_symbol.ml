...
testing "Constructor_node_basename_list_by_category_trail_provider_v with
   Constructor_node_basename_list_by_category_trail_provider_u_generatorset_symbol.ml";; 

(* toplevel 
   #use "Constructor_node_basename_list_by_category_trail_provider_u_generatorset_symbol.ml";; 
...
(* : string list *)
=
  ["generatorset"; "triangle"; "triangle_isoceles"; "triangle_scalene";
