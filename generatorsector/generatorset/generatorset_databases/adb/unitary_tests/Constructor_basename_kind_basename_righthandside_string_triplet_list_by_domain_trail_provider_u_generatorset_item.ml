...
testing "Constructor_basename_kind_basename_righthandside_string_triplet_list_by_domain_trail_provider_v with
   Constructor_basename_kind_basename_righthandside_string_triplet_list_by_domain_trail_provider_u_generatorset_item.ml"


(* toplevel 
   #use "Constructor_basename_kind_basename_righthandside_string_triplet_list_by_domain_trail_provider_u_generatorset_item.ml";;
...
=
[("generatorset_item", "constructors", "coordinate point triangle vector fake");
