(** {3 Constructor_leaf_basename_datastructure_basename_doublet_list_by_domain_trail_provider_v} *)
...
let documentation () = 
  [
   ...
   "Current : AGNR:Constructor_leaf_basename_datastructure_basename_doublet_list_by_domain_trail_provider_v";
   "Needed-by : ";
   "What-is-it : it provides for each Domainset_trail the list of (Constructor_leaf_basename, datastructure_basename)";
   "How-is-it-done : from Constructor_basename_kind_basename_righthandside_string_triplet_list_by_category_trail_provider_v";
...
let nam_reg = "datastructure_basename_constructor_leaf_basename_doublet_list_by_domain_trail_register";;

let datastructure_basename_constructor_leaf_basename_doublet_list_by_domain_trail_register : 
    (Trail_t.trail, 
     (string, string) 
...
let retrieve tra_dos =
  try Register_v.retrieve 
      datastructure_basename_constructor_leaf_basename_doublet_list_by_domain_trail_register
      tra_dos
