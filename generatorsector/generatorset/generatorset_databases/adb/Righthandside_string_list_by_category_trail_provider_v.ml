(** {3 Righthandside_string_list_by_category_trail_provider_v} *)
...
let documentation () = 
  [
   ...
   "Current : AGNR:Righthandside_string_list_by_category_trail_provider_v";
   "Needed-by : ";
   "Definition : the Righthandside_string is the string at the right of the = sign";
   "What-is-it : it is the list of all Righthandside_string for a given Category trail";
   "How-is-it-done : by extracting each RightHandSide_string of the above doublet list";
   "Invariant : Result is a Once_list";
 ]
;;
...
let nam_reg = "righthandside_string_list_by_category_trail_register";;

let righthandside_string_list_by_category_trail_register : 
    (Trail_t.trail, 
     string list) 
...
let retrieve tra_cat =
  try Register_v.retrieve righthandside_string_list_by_category_trail_register tra_cat
  with Failure ("Not_stored:Register_v.ml:retrieve") ->
	...
	"\n" 
	righthandside_string_list_by_category_trail_register
    in
...
let is_stored tra_cat =
  Register_v.is_stored righthandside_string_list_by_category_trail_register tra_cat
;;
