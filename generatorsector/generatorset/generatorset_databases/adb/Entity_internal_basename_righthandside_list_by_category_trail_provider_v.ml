(** {3 Entity_internal_basename_righthandside_list_by_category_trail_provider_v} *)
...
let documentation () = 
  [
   ...
   "Current : AGNR:Entity_internal_basename_righthandside_list_by_category_trail_provider_v";
   "Needed-by : ";
   "What-is-it : all Entity_internal_basename in either set";
...
let nam_reg = "entity_internal_basename_righthandside_list_by_category_trail_register";;

let entity_internal_basename_righthandside_list_by_category_trail_register : 
    (Trail_t.trail, 
     string list)
...
let retrieve tra_cat =
  try Register_v.retrieve 
      entity_internal_basename_righthandside_list_by_category_trail_register 
      tra_cat
