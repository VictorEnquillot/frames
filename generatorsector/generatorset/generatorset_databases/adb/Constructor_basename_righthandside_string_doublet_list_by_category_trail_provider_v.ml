(** {3 Constructor_basename_righthandside_string_doublet_list_by_category_trail_provider_v} *)
...
let documentation () = 
  [
   ...
   "Current : AGNR:Constructor_basename_righthandside_string_doublet_list_by_category_trail_provider_v";
   ...
   "Definition : an Entity_node is a Node of the Constructor Tree (CT)";
...
let nam_reg = "constructor_basename_righthandside_string_doublet_list_by_category_trail_register";;

let constructor_basename_righthandside_string_doublet_list_by_category_trail_register : 
    (Trail_t.trail, 
     (string, string) 
...
let retrieve tra_cat =
  try Register_v.retrieve 
      constructor_basename_righthandside_string_doublet_list_by_category_trail_register
      tra_cat
...
let build tra_cat =
  ...
  List.map (fun (k, e, s) -> (e, s)) wws_ftl
;;
