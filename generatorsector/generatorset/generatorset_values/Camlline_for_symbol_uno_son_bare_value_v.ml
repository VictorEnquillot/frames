(** {3 Camlline_for_symbol_uno_son_bare_value_v}  *)
...
let documentation () = 
  [
   "Needs : FGNR:";
   "Current : VGNR:Camlline_for_symbol_uno_son_bare_value_v";
   "Needed-by : VGNR:Camlline_uno_son_bare_value_v";
...
let string_of sym_cfs soi_cal =
  ...
  let tag_ent_l = 
    Camlline_for_symbol_uno_son_bare_formula_v.entity_tag_list_off_camlline_for_symbol_uno_son_bare_tag 
      tag_cfs 
  in
  let sym_cal = 
    Camlline_symbol_v.camlline_symbol_of_camlline_for_symbol_uno_son_bare_symbol sym_cfs 	
  in
...
let make sym_cfs soi_cal =
  ...
  match sym_cfs with
  | Camlline_for_symbol_uno_son_bare_symbol_t.Pipe_esstring_arrow_es ->
     Camlline_for_symbol_uno_son_bare_value_t.Pipe_esstring_arrow_es str
...
let string_off val_cfs =
  match val_cfs with
  | Camlline_for_symbol_uno_son_bare_value_t.Pipe_esstring_arrow_es str -> str
