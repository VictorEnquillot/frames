(** {3 The functionalities for a Value for an Camlline_duo_function of a Camlfile.}  *)

let nam_cod = "Camlline_duo_function_value_v.ml";;
...
let make sym_cdf soi_cal =
  let sym_cal = 
    Camlline_symbol_v.camlline_symbol_of_camlline_duo_function_symbol sym_cdf 
  in
  ...
  match sym_cdf with
(* T S *)
  | Camlline_duo_function_symbol_t.Pipe_Mst_tdot_Mss_space_ass_arrow ->
  ...
  | Camlline_duo_function_symbol_t.Pipe_Mst_tdot_Mss_space_ass_arrow_ass ->
  ...
  | Camlline_duo_function_symbol_t.Try_mst_of_mss ->
      (* Ex.: try entity_symbol_of_entity_fictive_symbol *)
      let sym_ent_s = sym_ent_1 in
      let sym_ent_t = sym_ent_2 in

      Format.sprintf "  try %s_of_%s"
	(module_name sym_cat sym_ent_t) 
	(module_name sym_cat sym_ent_s)

(* naming T L *) 
  | Camlline_duo_function_symbol_t.Pipe_Mst_tdot_Esl_arrow_string ->
  ...
  | Camlline_duo_function_symbol_t.Pipe_Mst_tdot_Esl_arrow_ffppf_l ->
      Utils_v.not_yet_implemented nam_cod "Pipe_Mst_tdot_Esl_arrow_ffppf_l"

  | Camlline_duo_function_symbol_t.Pipe_string_arrow_Mst_tdot_Ec_space_string ->
  ...
  | Camlline_duo_function_symbol_t.Pipe_ecstring_arrow_Mst_tdot_Ec_space_string ->
  ...
  | Camlline_duo_function_symbol_t.Pipe_Efs_bof_b 
...
(* extracting let first line. son case *)
  | Camlline_duo_function_symbol_t.Let_mss_off_mst_equal_function ->
      let sym_ent_s = sym_ent_1 in
      let sym_ent_t = sym_ent_2 in
...
(* extracting let first line. current case *)
  | Camlline_duo_function_symbol_t.Let_mac_off_mat_space_aat_equal ->
      let sym_ent_c = sym_ent_1 in
      let sym_ent_t = sym_ent_2 in
...
(* extracting let second line *)
  | Camlline_duo_function_symbol_t.Let_ass_equal_mss_off_mst_space_ast_in -> 
      let sym_ent_s = sym_ent_1 in
      let sym_ent_t = sym_ent_2 in
      let space = function
...
(* extracting let third line *)
  | Camlline_duo_function_symbol_t.Ass_vdot_msc_off_mss_space_ass ->        
      let sym_ent_c = sym_ent_1 in
...
(* extracting print_fatal_error third line *)
  | Camlline_duo_function_symbol_t.Pipe_print_fatal_error_mss_off_mst_4_lines -> 
      let sym_ent_s = sym_ent_1 in
      let sym_ent_t = sym_ent_2 in
...
(* querying let first line *)
  | Camlline_duo_function_symbol_t.Let_is_mas_off_mat_equal_function ->  
      let sym_ent_s = sym_ent_1 in
      let sym_ent_t = sym_ent_2 in
  ...
  | Camlline_duo_function_symbol_t.Let_is_mac_off_mat_space_aat_equal ->
      let sym_ent_c = sym_ent_1 in
      let sym_ent_t = sym_ent_2 in
...
(* querying let second line *)
  | Camlline_duo_function_symbol_t.Pipe_Mst_tdot_Mss_arrow_true ->
      let sym_ent_s = sym_ent_1 in
      let sym_ent_t = sym_ent_2 in
  ...
  | Camlline_duo_function_symbol_t.If_not_is_mss_off_mst_space_ast ->
      let sym_ent_s = sym_ent_1 in
      let sym_ent_t = sym_ent_2 in
...
(* querying begin second line *)
  | Camlline_duo_function_symbol_t.Ass_vdot_is_msc_off_mss_space_ass -> 
      let sym_ent_c = sym_ent_1 in
      let sym_ent_s = sym_ent_2 in
 ...
 (* upgrading let first line for a son *)  
  | Camlline_duo_function_symbol_t.Let_mat_of_mas_space_aas_equal ->
      let sym_ent_s = sym_ent_1 in
      let sym_ent_t = sym_ent_2 in
 ...
 (* upgrading let second line for a son *)  
  | Camlline_duo_function_symbol_t.Mst_tdot_Mss_space_ass ->
      let sym_ent_s = sym_ent_1 in
      let sym_ent_t = sym_ent_2 in
...
(* upgrading let first line current case *)
  | Camlline_duo_function_symbol_t.Let_mat_of_mac_space_aac_equal ->
      let sym_ent_c = sym_ent_1 in
      let sym_ent_t = sym_ent_2 in
...
(* upgrading let second line *)
  | Camlline_duo_function_symbol_t.Let_ass_equal_As_vdot_mss_of_msc_space_asc_in ->
      let sym_ent_c = sym_ent_1 in
      let sym_ent_s = sym_ent_2 in
...
(* upgrading let third line *)
  | Camlline_duo_function_symbol_t.Space_mst_of_mss_space_ass ->
      let sym_ent_s = sym_ent_1 in
      let sym_ent_t = sym_ent_2 in
...
(* abbreviating a Leaf in a Father Entity when path length = 2 
  ...
  |  Camlline_duo_function_symbol_t.Let_ess_equal_Mst_tdot_Ess ->
...
(* abbreviating a Leaf in a Father for Self *)
  | Camlline_duo_function_symbol_t.Let_esl_equal_mst_of_msl_space_Msl_vdot_esl ->
...
(* abbreviating a Basicnullary *)
  | Camlline_duo_function_symbol_t.Let_ess_arg_equal_Mst_tdot_Ess_space_arg ->
...
(* Tag *)
  | Camlline_duo_function_symbol_t.Space_Tag_vdot_map_left_space_Mst_vdot_msc_off_mst_space_att ->
  ...
  | Camlline_duo_function_symbol_t.Space_Tag_vdot_map_left_space_Mst_vdot_is_msc_off_mst_space_att ->
  ...
  | Camlline_duo_function_symbol_t.Space_Tag_vdot_map_left_space_Mst_vdot_mst_of_msc_space_atc ->
