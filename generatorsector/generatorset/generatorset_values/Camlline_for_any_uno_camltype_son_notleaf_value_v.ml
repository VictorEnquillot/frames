(** {3 Camlline_for_any_uno_camltype_son_notleaf_value_v.}  *)
...
let documentation () = 
  [
   "Needs : FGNR:";
   "Current : VGNR:Camlline_for_any_uno_camltype_son_notleaf_value_v";
...
let string_of sym_ccs soi_cal =
  let sym_cal = 
    Camlline_symbol_v.camlline_symbol_of_camlline_for_any_uno_camltype_son_notleaf_symbol 
      sym_ccs 
  in
  ...
  match sym_ccs with
  | Camlline_for_any_uno_camltype_son_notleaf_symbol_t.Pipe_es_any_constructor_of_es_any_tdot_es_any -> (* | Triangle_symbol of Triangle_symbol_t.triangle_symbol *)

      Format.sprintf "  | %s of %s_t.%s"
...
let make sym_ccs soi_cal =
  ...
  | Camlline_for_any_uno_camltype_son_notleaf_symbol_t.Pipe_es_any_constructor_of_es_any_tdot_es_any ->
     Camlline_for_any_uno_camltype_son_notleaf_value_t.Pipe_es_any_constructor_of_es_any_tdot_es_any str
...
let string_off val_ccs =
  match val_ccs with
  | Camlline_for_any_uno_camltype_son_notleaf_value_t.Pipe_es_any_constructor_of_es_any_tdot_es_any str -> str
