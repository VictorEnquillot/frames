(** {3 Camlline_for_any_duo_son_top_ofstring_value_v}  *)
...
let documentation () = 
  [
   "Needs : FGNR:";
   "Current : VGNR:Camlline_for_any_duo_son_top_ofstring_value_v";
...
let string_of sym_cst soi_cal =
  let sym_cal = 
    Camlline_symbol_v.camlline_symbol_of_camlline_for_any_duo_son_top_ofstring_symbol sym_cst 
  in
  ...
  | Camlline_for_any_duo_son_top_ofstring_symbol_t.Pipe_et_any_tdot_es_underscore_arrow_true ->
   (*   | Geometry_symbol_t.Point _ -> true *)

      let sym_ent_s = sym_ent_1 in
      let sym_ent_t = sym_ent_2 in
      Format.sprintf "  | %s_symbol_t.%s _ -> true"
	(entity_name_capitalized sym_ent_t) 
...
let make sym_cst soi_cal =
  ...
  match sym_cst with
  | Camlline_for_any_duo_son_top_ofstring_symbol_t.Et_any_tdot_es_sarg ->
       Camlline_for_any_duo_son_top_ofstring_value_t.Et_any_tdot_es_sarg str

  | Camlline_for_any_duo_son_top_ofstring_symbol_t.Pipe_et_any_tdot_es_underscore_arrow_true ->
       Camlline_for_any_duo_son_top_ofstring_value_t.Pipe_et_any_tdot_es_underscore_arrow_true str
;;
...
let string_off val_cst =
  match val_cst with
  | Camlline_for_any_duo_son_top_ofstring_value_t.Et_any_tdot_es_sarg str -> str
  | Camlline_for_any_duo_son_top_ofstring_value_t.Pipe_et_any_tdot_es_underscore_arrow_true str -> str
;;
