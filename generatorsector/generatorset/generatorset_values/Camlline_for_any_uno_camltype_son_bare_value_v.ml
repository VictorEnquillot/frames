(** {3 Camlline_for_any_uno_camltype_son_bare_value_v.}  *)
...
let documentation () = 
  [
   "Needs : FGNR:";
   "Current : VGNR:Camlline_for_any_uno_camltype_son_bare_value_v";
...
let string_of sym_ccs soi_cal =
  let sym_cal = 
    Camlline_symbol_v.camlline_symbol_of_camlline_for_any_uno_camltype_son_bare_symbol 
      sym_ccs 
  in
  ...
  match sym_ccs with
  | Camlline_for_any_uno_camltype_son_bare_symbol_t.Pipe_es -> (* | Vector *)
...
let make sym_ccs soi_cal =
  ...
  | Camlline_for_any_uno_camltype_son_bare_symbol_t.Pipe_es ->
     Camlline_for_any_uno_camltype_son_bare_value_t.Pipe_es str
...
let string_off val_ccs =
  match val_ccs with
  | Camlline_for_any_uno_camltype_son_bare_value_t.Pipe_es str -> str
;;
