...
testing "Camlline_value_v with
   Camlline_value_u_figureset_symbol_figureset_string_offing_argument.ml";;

(* toplevel 
   #use "Camlline_value_u_figureset_symbol_figureset_string_offing_argument.ml";;

*)

let nam_cod = "Camlline_value_u_figureset_symbol_figureset_string_offing_argument.ml";;
...
(* : string *)
  =
  "./Figure_symbol_String_offing_for_symbol_Let_name_equal_function_for_symbol_v.ml"
);;
