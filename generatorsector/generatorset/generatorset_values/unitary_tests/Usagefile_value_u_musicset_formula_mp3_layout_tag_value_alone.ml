...
testing "Usagefile_value_v
   Usagefile_value_u_musicset_formula_value_alone.ml";;

(* toplevel 
   #use "Usagefile_value_u_musicset_formula_value_alone.ml";;

*)

let nam_cod = "Usagefile_value_u_musicset_formula_value_alone.ml";;

let nam_dom = "music";;
let nam_cof = "value_alone";;
let nam_ent = "mp3_layout_tag";;
let nam_cat = "formula";;
...
(* : Entity_symbol_t.entity_proper_symbol * Sole_index_t.sole_index *)
  ...
  (Entity_symbol_t.Entity_proper_symbol
    (Entity_proper_symbol_t.Entity_proper_with_sons "mp3_layout_tag"),
   [15; 2; 5])
);;
...
(* :  Contentfile_symbol_t.contentfile_symbol * Sole_index_t.sole_index *)
  =
(Contentfile_symbol_t.Value_alone, [2; 15; 2; 5])
);;
