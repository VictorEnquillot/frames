...
testing "Camlline_value_v with
   Camlline_value_u_figureset_symbol_coordinate_spherical_abbreviating_topson_bare.ml";;

(* toplevel 
   #use "Camlline_value_u_figureset_symbol_coordinate_spherical_abbreviating_topson_bare.ml";;

*)

let nam_cod = "Camlline_value_u_figureset_symbol_coordinate_spherical_abbreviating_topson_bare.ml";;

let nam_dom = "figure";;
let nam_cof = "value_alone";;
let nam_ent = "coordinate_spherical";;
let nam_cat = "symbol";;
...
tag_cof
=
(Contentfile_symbol_t.Value_alone, [2; 6; 7; 2])
);;
...
(* : string *)
  =
 "./Coordinate_spherical_symbol_Abbreviating_topson_bare_for_symbol_v.ml"
);;
...
(* "let vector = Coordinate_symbol_t.Vector;;" *)
...
(* : string list *)
=
  ["let spherical_rho = Coordinate_spherical_symbol_t.Spherical_rho;;"]
);;
...
(* 3 Camlparagraph_for_symbol_let_abbreviate_symbol_t.Let_abbreviate_topson_bare *)
...
(* : string list *)
=
  ["let spherical_phi = Coordinate_spherical_symbol_t.Spherical_phi;;"]
);;
...
=
  [(Entity_symbol_t.Entity_fictive_symbol
     (Entity_fictive_symbol_t.Entity_fictive_nullary_symbol
       (Entity_fictive_nullary_symbol_t.Bare "spherical_phi")),
    [1; 1; 1; 1; 3; 17; 1; 2; 6; 7; 2]);
   (Entity_symbol_t.Entity_proper_symbol (Entity_proper_symbol_t.Entity_proper_with_sons "coordinate_spherical"),
    [2; 1; 1; 1; 3; 17; 1; 2; 6; 7; 2])]
);;
