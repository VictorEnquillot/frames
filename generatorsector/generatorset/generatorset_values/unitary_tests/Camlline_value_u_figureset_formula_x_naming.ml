...
testing "Camlline_value_v
   Camlline_value_u_figureset_formula_x_naming.ml";;

(* toplevel 
   #use "Camlline_value_u_figureset_formula_x_naming.ml";;

*)

let nam_cod = "Camlline_value_u_figureset_formula_x_naming.ml";;
...
nam_fil
=
"./X_formula_naming_let_make_entity_fictive_nullary_for_formula_let_make_sym_as_soi_at_equal_v.ml"
);;
...
nam_fil
=
 "./X_formula_naming_let_make_entity_fictive_nullary_for_formula_Space_let_count_equal_zero_v.ml"
);;
...
nam_fil
  =  
  "./X_formula_naming_let_make_entity_fictive_nullary_for_formula_let_tag_a_equal_e_tag_vdot_make_soi_as_in_v.ml"
);;
