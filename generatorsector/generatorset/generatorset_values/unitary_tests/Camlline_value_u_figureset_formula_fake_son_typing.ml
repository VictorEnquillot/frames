...
testing "Camlline_value_v with
   Camlline_value_u_figureset_formula_fake_son_typing.ml";;

(* toplevel 
   #use "Camlline_value_u_figureset_formula_fake_son_typing.ml";;

*)

let nam_cod = "Camlline_value_u_figureset_formula_fake_son_typing.ml";;
...
tag_cof
=
(Contentfile_symbol_t.Type_alone, [1; 13; 2; 2])
);;
...
(* 1 Group_for_any_body_son_builder_symbol_t.Pipe_topson_formula_type_bare_one_constructor *)
...
(* : string *)
  =
 "  | Fake_son_constructor of String_tag_t.string_tag list"
);;
...
(* : string *)
  =
 "./Fake_son_formula_typing_for_formula_camlparagraph_for_formula_type_t.ml"
);;
...
(* : string *)
  =
"./Fake_son_formula_typing_for_formula_t.ml"
);;
