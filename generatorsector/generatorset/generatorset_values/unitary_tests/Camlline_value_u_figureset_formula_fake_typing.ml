...
testing "Camlline_value_v with
   Camlline_value_u_figureset_formula_fake_typing.ml";;

(* toplevel 
   #use "Camlline_value_u_figureset_formula_fake_typing.ml";;

*)

let nam_cod = "Camlline_value_u_figureset_formula_fake_typing.ml";;
...
tag_cof
=
(Contentfile_symbol_t.Type_alone, [1; 12; 2; 2])
);;
...
(* : string *)
  =
 "./Fake_formula_typing_for_formula_camlparagraph_for_formula_type_t.ml"
);;
...
(* : string list *)
  =
["(** {6 Typing_for_formula} *)"; "type fake_formula =";
 "  | Fake_son_formula of Fake_son_formula_t.fake_son_formula";
 ";;"]
);;
...
(* : string *)
  =
"./Fake_formula_typing_for_formula_t.ml"
);;
...
(* : string list *)
=
["(** {3 Fake_formula_t} *)"; "(** {6 Typing_for_formula} *)";
 "type fake_formula =";
 "  | Fake_son_formula of Fake_son_formula_t.fake_son_formula";
 ";;"]
);;
