...
testing "Item_symbol_value_v
   Item_value_u_figureset_symbol_triangle_isoceles_naming.ml";;

(* toplevel 
   #use "Item_value_u_figureset_symbol_triangle_isoceles_naming.ml";;

*)

let nam_cod = "Item_value_u_figureset_symbol_triangle_isoceles_naming.ml";;
...
=
"./Triangle_isoceles_symbol_naming_v.ml"
);;
