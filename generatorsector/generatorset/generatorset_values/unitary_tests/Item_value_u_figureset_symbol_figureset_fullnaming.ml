...
testing "Item_symbol_value_v
   Item_value_u_figureset_symbol_figureset_fullnaming.ml";;

(* toplevel 
   #use "Item_value_u_figureset_symbol_figureset_fullnaming.ml";;

*)

let nam_cod = "Item_value_u_figureset_symbol_figureset_fullnaming.ml";;
...
nam_fil
=
 "./Figure_symbol_Fullnaming_for_symbol_v.ml"
);;
