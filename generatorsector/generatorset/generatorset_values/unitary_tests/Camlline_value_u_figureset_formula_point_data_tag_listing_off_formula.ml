...
testing "Camlline_value_v with
   Camlline_value_u_figureset_formula_point_data_tag_listing_off_formula.ml";;

(* toplevel 
   #use "Camlline_value_u_figureset_formula_point_data_tag_listing_off_formula.ml";;
...
(* 2 Camlparagraph_for_formula_let_match_symbol_t.Let_data_tag_list_off_top_formula *)
...
(* 1 Group_for_formula_header_top_builder_symbol_t.Let_data_tag_list_off_top_formula *)
...
(* 2 Section_for_formula_body_son_top_builder_symbol_t.Data_tag_list_topson_pattern_notleaf_for_formula *)
...
(* section_for_formula_body_son_top_builder : data_tag_list_topson_pattern_ofstring_for_formula *)
(* group_for_formula_body_son_top_builder : data_tag_list_topson_pattern_ofstring_for_formula *)
...
(* 4 Section_for_formula_body_son_top_builder_symbol_t.Data_tag_list_topson_pattern_bare_for_formula *)

(* section_for_formula_body_son_top_builder : data_tag_list_topson_pattern_bare_for_formula *)
(* group_for_formula_body_son_top_builder : data_tag_list_topson_pattern_bare_for_formula *)
...
(* : string *)
  =
"./Point_formula_data_tag_listing_off_formula_v.ml"
);;
