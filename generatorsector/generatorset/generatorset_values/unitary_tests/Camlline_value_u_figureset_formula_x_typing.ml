...
testing "Camlline_value_v with
   Camlline_value_u_figureset_formula_x_typing.ml";;

(* toplevel 
   #use "Camlline_value_u_figureset_formula_x_typing.ml";;

*)

let nam_cod = "Camlline_value_u_figureset_formula_x_typing.ml";;
let nam_dom = "figure";;
let nam_cat = "formula";;
let nam_ent = "x";;
...
nam_fil
=
"./X_formula_typing_camlparagraph_for_formula_entity_fictive_nullary_type_type_eft_equal_t.ml"
);;
...
nam_fil
=
 "./X_formula_typing_camlparagraph_for_formula_entity_fictive_nullary_type_lpar_a_tag_rpar_t.ml"
);;
