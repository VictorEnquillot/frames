...
testing "Camlline_value_v with
   Camlline_value_u_figureset_symbol_figureset_naming_notleaf.ml";;

(* toplevel 
   #use "Camlline_value_u_figureset_symbol_figureset_naming_notleaf.ml";;

*)

let nam_cod = "Camlline_value_u_figureset_symbol_figureset_naming_notleaf.ml";;
...
(* 5 Item_for_symbol_by_group_topsons_symbol_t.Naming_for_symbol_notleaf *)

let nam_ite = "naming_for_symbol_notleaf";;
...
(* 2 Camlparagraph_for_symbol_let_match_symbol_t.Let_name_of_topson_notleaf_equal_function_for_symbol *)
...
(*   | _ -> *)
(*   failwith "Not_a_topson_notleaf:Figure_symbol_v.ml:name_of_topson_notleaf" *)
(* ;; *)
...
(* : string *)
  =
  "./Figure_symbol_Naming_for_symbol_notleaf_Let_name_of_topson_notleaf_equal_function_for_symbol_v.ml"
);;

Camlparagraph_value_v.write "./" tag_cap;;

(* 1 Section_for_symbol_header_constant_symbol_t.Let_name_of_topson_notleaf_equal_function *)
...
(* 1 Group_for_symbol_header_constant_symbol_t.Let_name_of_topson_notleaf_equal_function *)
...
(* 1 Camlline_constant_function_symbol_t.Let_name_of_topson_notleaf_nam_equal *)
...
(* 2 Section_for_symbol_body_son_top_symbol_t.Name_topson_pattern_notleaf_for_symbol *)
...
(* 2 Camlline_for_symbol_uno_son_notleaf_symbol_t.Es_symbol_vdot_name_sym_as *)
   ...
   (Camlline_symbol_t.Camlline_for_symbol_symbol
     (Camlline_for_symbol_symbol_t.Camlline_for_symbol_uno_symbol
       (Camlline_for_symbol_uno_symbol_t.Camlline_for_symbol_uno_top_symbol
         Camlline_for_symbol_uno_top_symbol_t.Space_failwith_not_a_topson_notleaf_et_symbol_name)),
    [2; 1; 3; 2; 5; 1; 2; 1; 7; 2]);
   (Camlline_symbol_t.Camlline_constant_symbol
