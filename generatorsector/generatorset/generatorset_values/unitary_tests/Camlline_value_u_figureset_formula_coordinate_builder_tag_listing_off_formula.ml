...
testing "Camlline_value_v with
   Camlline_value_u_figureset_formula_coordinate_builder_tag_listing_off_formula.ml";;

(* toplevel 
   #use "Camlline_value_u_figureset_formula_coordinate_builder_tag_listing_off_formula.ml";;
...
=
 (Entity_symbol_t.Entity_proper_symbol
    (Entity_proper_symbol_t.Entity_proper_with_one_son "coordinate"),
   [7; 2; 2])
);;
...
(* : string list *)
=
  ["let coordinate_tag_list_off_coordinate_formula = function"]
);;
...
=
  ["let coordinate_tag_list_off_coordinate_formula = function";
   "  | Coordinate_formula_t.Coordinate_constructor (s, tag_coo_l) -> tag_coo_l";
   ";;"]
);;
...
(* : string *)
  =
"./Coordinate_formula_builder_tag_listing_off_formula_let_builder_tag_list_off_top_formula_v.ml"
);;
...
(* : string *)
  =
"./Coordinate_formula_builder_tag_listing_off_formula_v.ml"
);;
