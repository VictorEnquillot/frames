...
(* toplevel 
   #use "Camlline_uno_camltype_value_u_chemicalset_tag_atom_zerotied.ml";;
*)
...
let tag_cap = Doublet_list_v.find_if_left 
    Camlparagraph_symbol_v.is_type_definition_for_tag for_ite;; 
...
(* : string *)
=
"type atom_zerotied_tag = Atom_zerotied_symbol_t.atom_zerotied_symbol Tag_t.tag"
);;

test_number 6 (
Camlline_value_v.fullnameoffile "./" tag_cal
=
"./atom_zerotied_tag_typing_type_definition_for_tag_type_ett_equal_est_tdot_est_tag_t.ml"
);;
(*
