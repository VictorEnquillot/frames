...
testing "Camlline_value_v with
   Camlline_value_u_figureset_symbol_figureset_naming_bare.ml";;

(* toplevel 
   #use "Camlline_value_u_figureset_symbol_figureset_naming_bare.ml";;

*)

let nam_cod = "Camlline_value_u_figureset_symbol_figureset_naming_bare.ml";;
...
let sym_etl_l = Entity_topson_leaf_symbol_list_by_entity_tritup_provider_v.provide tri_ent;;
...
(* 3 Item_for_symbol_by_group_topsons_symbol_t.Naming_for_symbol_bare *)

let nam_ite = "naming_for_symbol_bare";;
...
(* 2 Camlparagraph_for_symbol_let_match_symbol_t.Let_name_of_topson_bare_equal_function_for_symbol *)

(* let name_of_topson_bare = function *)
(*   | Figure_symbol_t.Vector -> "vector" *)
(*   | _ -> *)
(*   failwith "Not_a_topson_bare:Figure_symbol_v.ml:name_of_topson_bare" *)
(* ;; *)
...
(* : string *)
  =
 "./Figure_symbol_Naming_for_symbol_bare_Let_name_of_topson_bare_equal_function_for_symbol_v.ml"
);;

Camlparagraph_value_v.write "./" tag_cap;;

(* 1 Section_for_symbol_header_constant_symbol_t.Let_name_of_topson_bare_equal_function *)
...
(* 1 Group_for_symbol_header_constant_symbol_t.Let_name_of_topson_bare_equal_function *)
...
(* 1 Camlline_constant_function_symbol_t.Let_name_of_topson_bare_nam_equal *)
...
(* 2 Section_for_symbol_body_son_top_symbol_t.Name_topson_pattern_bare_for_symbol *)
...
let sym_ctn = Camlline_for_symbol_duo_son_top_bare_symbol_t.Pipe_et_symbol_tdot_es_arrow_string;;
let soi_cal = Tag_v.sole_index_off_tag tag_cal;;
let tag_ctn = Tag_v.make sym_ctn soi_cal;;
  let dec_ctn = 
    Camlline_for_any_duo_son_top_bare_tag_v.camlline_for_any_duo_son_top_bare_dectup_off_camlline_for_any_duo_son_top_bare_tag 
      tag_ctn;;
let sym_ent_top = Decuplet_v.right_third_off_decuplet dec_ctn;;

  let sym_ite = 
    Generatorset_symbol_by_sole_index_provider_v.item_symbol_off_sole_index
      soi_cal 
  ;;
  let sym_ifs = Item_symbol_v.item_for_symbol_symbol_off_item_symbol sym_ite;;
let sym_ent_tos_l = 
	Tools_ignr_v.entity_topson_bare_symbol_list_of_dectup 
	  dec_ctn ;;
    let idx_gro = Sole_index_v.father_index_off_sole_index soi_cal;;
let sym_ent_son =List.nth sym_ent_tos_l (idx_gro-1) ;;
...
(* 1 Camlline_for_symbol_uno_son_bare_symbol_t.Pipe_esstring_arrow_es *)
...
(* 1 Group_for_symbol_footer_top_symbol_t.Pipe_underscore_failwith_not_a_topson_bare *)
   ...
   (Camlline_symbol_t.Camlline_for_symbol_symbol
     (Camlline_for_symbol_symbol_t.Camlline_for_symbol_uno_symbol
       (Camlline_for_symbol_uno_symbol_t.Camlline_for_symbol_uno_top_symbol
         Camlline_for_symbol_uno_top_symbol_t.Space_failwith_not_a_topson_bare_et_symbol_name)),
    [2; 1; 3; 2; 3; 1; 2; 1; 7; 2]);
   (Camlline_symbol_t.Camlline_constant_symbol
