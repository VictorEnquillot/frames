...
testing "Camlline_value_v
   Camlline_value_u_figureset_formula_x_2d_iterating.ml";;

(* toplevel 
   #use "Camlline_value_u_figureset_formula_x_2d_iterating.ml";;

*)

let nam_cod = "Camlline_value_u_figureset_formula_x_2d_iterating.ml";;
...
nam_fil
=
 "./X_2d_formula_iterating_let_iterating_entity_fictive_nullary_for_formula_let_map_equal_das_vdot_map_v.ml"
);;
