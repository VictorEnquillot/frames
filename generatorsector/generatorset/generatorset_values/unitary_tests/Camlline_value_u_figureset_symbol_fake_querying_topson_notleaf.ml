...
testing "Camlline_value_v with
   Camlline_value_u_figureset_symbol_fake_querying_topson_notleaf.ml";;

(* toplevel 
   #use "Camlline_value_u_figureset_symbol_fake_querying_topson_notleaf.ml";;

*)

let nam_cod = "Camlline_value_u_figureset_symbol_fake_querying_topson_notleaf.ml";;
...
(* 2 Camlparagraph_for_symbol_let_match_symbol_t.Let_is_onlyson_notleaf *)
...
(* : string *)
  =
"./Fake_symbol_querying_topson_notleaf_for_symbol_let_is_onlyson_notleaf_symbol_off_top_symbol_v.ml"
);;

Camlparagraph_value_v.write "./" tag_cap;;

(* 1 Section_for_symbol_header_son_symbol_t.Let_is_onlyson_notleaf *)
...
(* : string list *)
=
 ["let is_fake_son_symbol_off_fake_symbol = function"]
);;
 
(* Camlline_constant_function_symbol_t.Let_name_of_onlyson_notleaf_equal *)
...
=
  [(Entity_symbol_t.Entity_proper_symbol
     (Entity_proper_symbol_t.Entity_proper_with_one_son "fake_son"),
    [1; 1; 1; 1; 2; 11; 1; 2; 12; 7; 2]);
   (Entity_symbol_t.Entity_proper_symbol
     (Entity_proper_symbol_t.Entity_proper_with_one_son "fake"),
    [2; 1; 1; 1; 2; 11; 1; 2; 12; 7; 2])]
);;

(* 2 Section_for_symbol_body_son_top_symbol_t.Is_one_onlyson_notleaf_off_pattern_for_symbol *)
...
(* 1 Group_for_symbol_body_son_top_symbol_t.Pipe_is_onlyson_notleaf_symbol_off_top_symbol *)
...
(* : string list *)
=
["  | Fake_symbol_t.Fake_son_symbol _ -> true"]
);;
...
=
  [(Entity_symbol_t.Entity_proper_symbol
     (Entity_proper_symbol_t.Entity_proper_with_one_son "fake_son"),
    [1; 1; 1; 2; 2; 11; 1; 2; 12; 7; 2]);
   (Entity_symbol_t.Entity_proper_symbol
     (Entity_proper_symbol_t.Entity_proper_with_one_son "fake"),
    [2; 1; 1; 2; 2; 11; 1; 2; 12; 7; 2])]
);;
