...
testing "Creating ./atom_zerotied_symbol_v.ml using usagefile_symbol_value_u_1.ml";;

(* toplevel 
   #use "Tatom_zerotied_symbol_u_1.ml";;
*)
...
=
[(Item_symbol_t.Item_heading, [1; 1; 2; 3; 1; 1]);
 (Item_symbol_t.Item_documenting, [2; 1; 2; 3; 1; 1]);
 (Item_symbol_t.Item_making, [3; 1; 2; 3; 1; 1]);
 (Item_symbol_t.Item_naming, [4; 1; 2; 3; 1; 1]);
 (Item_symbol_t.Item_extracting, [5; 1; 2; 3; 1; 1]);
 (Item_symbol_t.Item_querying, [6; 1; 2; 3; 1; 1]);
 (Item_symbol_t.Item_upgrading, [7; 1; 2; 3; 1; 1]);
 (Item_symbol_t.Item_abbreviating, [8; 1; 2; 3; 1; 1]);
 (Item_symbol_t.Item_ending, [9; 1; 2; 3; 1; 1])]
);;
