...
testing "item_typing_symbol_type_implementation_value_u_2.ml";;

(* toplevel 
   #use "Item_value_u_chemicalset_symbol_typing_atom_zerotied_anion_minusone.ml";;
*)

let nam_cod = "Item_value_u_chemicalset_symbol_typing_atom_zerotied_anion_minusone.ml";;
...
=
"./atom_zerotied_anion_minusone_symbol_typing_t.ml"
);;
