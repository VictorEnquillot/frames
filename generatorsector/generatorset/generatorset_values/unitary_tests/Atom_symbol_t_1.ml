...
testing "Creating atom_symbol_t.ml using Usagefile_value_u_1.ml";;

(* toplevel 
   #use "tatom_symbol_t.ml";;
*)
...
=
(Usagefile_symbol_t.Implementation, [1; 1; 2; 1; 1])
);;
...
=
[(Item_symbol_t.Item_heading, [1; 1; 1; 2; 1; 1]);
 (Item_symbol_t.Item_documenting, [2; 1; 1; 2; 1; 1]);
 (Item_symbol_t.Item_typing, [3; 1; 1; 2; 1; 1]);
 (Item_symbol_t.Item_ending, [4; 1; 1; 2; 1; 1])]
);;
