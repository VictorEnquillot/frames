...
testing "Camlline_duo_function_symbol_value_v
   Camlline_duo_function_value_u_figureset_formula_triangle_typing.ml";;

(* toplevel 
   #use "Camlline_duo_function_value_u_figureset_formula_triangle_typing.ml";;

*)

let nam_cod = "Camlline_duo_function_value_u_figureset_formula_triangle_typing.ml";;
let nam_dom = "figure";;
let nam_cat = "formula";;
...
=
"./triangle_symbol_typing_type_definition_for_symbol_type_est_equal_t.ml"
);;
...
Camlline_value_v.fullnameoffile "./" tag_cal
=
"./triangle_symbol_typing_type_definition_for_symbol_pipe_ess_bof_ess_tdot_ess_t.ml"
);;
