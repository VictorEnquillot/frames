...
testing "Item_symbol_value_v
   Item_value_u_figureset_symbol_figureset_querying.ml";;

(* toplevel 
   #use "Item_value_u_figureset_symbol_figureset_querying.ml";;

*)

let nam_cod = "Item_value_u_figureset_symbol_figureset_querying.ml";;
...
nam_fil
=
 "./Figure_symbol_Querying_topson_notleaf_for_symbol_v.ml"
);;
...
=  
 ["(** {6 Querying_grandson_notleaf_for_symbol} *)";
   "let is_coordinate_cartesian_symbol_off_figure_symbol sym_geo =";
   ...
   "    end";
   ";;";
   "let is_coordinate_cylindrical_symbol_off_figure_symbol sym_geo =";
   "  if not (is_coordinate_symbol_off_figure_symbol sym_geo)";
   "  then false";
   "  else";
   "    begin";
   ...
   "    end";
   ";;";
   "let is_coordinate_polar_symbol_off_figure_symbol sym_geo =";
   "  if not (is_coordinate_symbol_off_figure_symbol sym_geo)";
   "  then false";
   "  else";
   "    begin";
   ...
   "    end";
   ";;";
   "let is_coordinate_spherical_symbol_off_figure_symbol sym_geo =";
   "  if not (is_coordinate_symbol_off_figure_symbol sym_geo)";
   "  then false";
   "  else";
   "    begin";
   ...
   "    end";
   ";;";
   "let is_triangle_isoceles_symbol_off_figure_symbol sym_geo =";
   "  if not (is_triangle_symbol_off_figure_symbol sym_geo)";
   "  then false";
   "  else";
   "    begin";
   ...
   "    end";
   ";;";
   "let is_triangle_scalene_symbol_off_figure_symbol sym_geo =";
   "  if not (is_triangle_symbol_off_figure_symbol sym_geo)";
   "  then false";
   "  else";
   "    begin";
...
nam_fil
=
 "./Figure_symbol_Querying_grandson_notleaf_for_symbol_v.ml"
);;
