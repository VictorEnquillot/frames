...
testing "Usagefile_symbol_value_v
   Usagefile_value_u_figureset_symbol_triangle_type_alone.ml";;

(* toplevel 
   #use "Usagefile_value_u_figureset_symbol_triangle_type_alone.ml";;

*)

let nam_cod = "Usagefile_value_u_figureset_symbol_triangle_type_alone.ml";;
...
=
  (Usagefile_symbol_t.Implementation, [1; 1; 2; 7; 2])
);;
...
=
  [[["(** {3 Triangle_symbol_t} *)"]];
   [["let documentation () = ";
     "[";
     "  \"Needs: \";";
     "  \"Current : CDOS:Triangle_symbol_t\";";
     "  \"Needed-by: \";";
     "  \"What-is-it: \";";
     "  \"How-is-it-done: \";";
     "  \"Example: \";";
   ...
   [["(** {6 Typing} *)"];
    ["type triangle_symbol =";
     ...
     "  | Triangle_scalene_symbol of Triangle_scalene_symbol_t.triangle_scalene_symbol";
     ";;"]]]
);;
