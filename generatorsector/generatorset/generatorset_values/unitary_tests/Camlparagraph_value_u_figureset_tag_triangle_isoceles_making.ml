...
testing "Camlparagraph_value_v
   Camlparagraph_value_u_figureset_tag_triangle_isoceles_making.ml";;

(* toplevel 
   #use "Camlparagraph_value_u_figureset_tag_triangle_isoceles_making.ml";;

*)

let nam_cod = "Camlparagraph_value_u_figureset_tag_triangle_isoceles_making.ml";;
let nam_dom = "figure";;
let nam_cat = "tag";;
...
nam_fil
= 
"./Triangle_isoceles_tag_making_let_make_soi_nam_s_equal_for_tag_v.ml"
);;
