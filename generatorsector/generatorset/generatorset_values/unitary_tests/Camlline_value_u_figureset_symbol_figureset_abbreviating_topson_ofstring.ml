...
testing "Camlline_value_v with
   Camlline_value_u_figureset_symbol_figureset_abbreviating_topson_ofstring.ml";;

(* toplevel 
   #use "Camlline_value_u_figureset_symbol_figureset_abbreviating_topson_ofstring.ml";;

*)

let nam_cod = "Camlline_value_u_figureset_symbol_figureset_abbreviating_topson_ofstring.ml";;
...
(* : string *)
  =
  "./Figure_symbol_abbreviating_topson_ofstring_for_symbol_let_abbreviate_topson_ofstring_v.ml"
);;
...
(* : string list *)
=
 ["let point s = Figure_symbol_t.Point s;;"]
);;
