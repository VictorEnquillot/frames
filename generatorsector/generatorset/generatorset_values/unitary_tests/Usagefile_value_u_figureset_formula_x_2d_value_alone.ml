...
testing "Usagefile_value_v
   Usagefile_value_u_figureset_formula_x_2d_value_alone.ml";;

(* toplevel 
   #use "Usagefile_value_u_figureset_formula_x_2d_value_alone.ml";;

*)

let nam_cod = "Usagefile_value_u_figureset_formula_x_2d_value_alone.ml";;
...
(* : Usagefile_value_t.usagefile_value *)
  ...
  [[["(** {3 X_2d_formula_v} *)"]];
   [["let documentation () = "; "["; "  \"Needs: \";";
     "  \"Current : CDOS:X_2d_formula_v\";"; "  \"Needed-by: \";";
