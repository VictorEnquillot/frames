...
testing "Camlline_value_v with
   Camlline_value_u_figureset_symbol_point_querying_topson_of_string.ml";;

(* toplevel 
   #use "Camlline_value_u_figureset_symbol_point_querying_topson_of_string.ml";;

*)

let nam_cod = "Camlline_value_u_figureset_symbol_point_querying_topson_of_string.ml";;
