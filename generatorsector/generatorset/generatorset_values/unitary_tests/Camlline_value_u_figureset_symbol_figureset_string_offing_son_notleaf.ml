...
testing "Camlline_value_v with
   Camlline_value_u_figureset_symbol_figureset_string_offing_son_notleaf.ml";;

(* toplevel 
   #use "Camlline_value_u_figureset_symbol_figureset_string_offing_son_notleaf.ml";;

*)

let nam_cod = "Camlline_value_u_figureset_symbol_figureset_string_offing_son_notleaf.ml";;
...
(* : string *)
=
  "./Figure_symbol_string_offing_let_make_of_topson_notleaf_nam_s_equal_for_symbol_v.ml"
);;
