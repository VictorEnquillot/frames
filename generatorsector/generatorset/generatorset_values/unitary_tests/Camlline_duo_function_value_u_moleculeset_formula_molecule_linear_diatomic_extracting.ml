...
testing "Camlline_duo_function_value_v with
   Camlline_duo_function_value_u_moleculeset_formula_molecule_linear_diatomic.ml";;

(* toplevel 
   #use "Camlline_duo_function_value_u_moleculeset_formula_molecule_linear_diatomic.ml";;
*)

let nam_cod = "Camlline_duo_function_value_u_moleculeset_formula_molecule_linear_diatomic.ml";;
...
let tag_cat = Doublet_list_v.find_if_left 
    Category_symbol_v.is_formula_off_category_symbol for_dom;; 
...
=
[(
   (Entity_symbol_t.Sonentity "molecule_linear_diatomic_raregas"),
  [1; 1; 2; 5; 1; 2; 3; 1; 1]);
 (
   (Entity_symbol_t.Topentity "molecule_linear_diatomic"),
  [2; 1; 2; 5; 1; 2; 3; 1; 1])]
);;
...
(* : string *)
=
"let molecule_linear_diatomic_raregas_symbol_off_molecule_linear_diatomic_symbol = function"
);;
...
=
"./molecule_linear_diatomic_symbol_extracting_let_ess_off_est_function_let_ess_off_est_equal_function_v.ml"
);;
