...
testing "Camlline_duo_function_symbol_value_v
   Camlline_value_u_figureset_symbol_triangle_abbreviating.ml";;

(* toplevel 
   #use "Camlline_value_u_figureset_symbol_triangle_abbreviating.ml";;

*)

let nam_cod = "Camlline_value_u_figureset_symbol_triangle_abbreviating.ml";;
...
(* Camlparagraph : Item_title "abbreviating_topson" *)
...
=
  [(Camlline_symbol_t.Camlline_trio_symbol
     Camlline_trio_symbol_t.Let_esl_equal_est_of_ess_Ess_vdot_esl,
    [1; 2; 11; 1; 2; 2; 7; 2])]
);;

(* Camlline : Let_esl_equal_est_of_ess_Ess_vdot_esl *)
...
Camlline_value_v.fullnameoffile "./" tag_cal
  =
"./Triangle_symbol_abbreviating_grandson_let_abbreviate_grandson_nullary_let_ess_arg_equal_est_bof_ess_lpar_ess_vdot_esl_arg_rpar_v.ml"
);;
