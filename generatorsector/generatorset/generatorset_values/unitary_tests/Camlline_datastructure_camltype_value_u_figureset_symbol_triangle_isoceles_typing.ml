...
testing "Camlline_duo_function_value_v with
   Camlline_datastructure_camltype_value_u_figureset_symbol_molecule_linear_diatomic_typing.ml";;

(* toplevel 
   #use "Camlline_datastructure_camltype_value_u_figureset_symbol_molecule_linear_diatomic_typing.ml";;

*)

let nam_cod = "Camlline_datastructure_camltype_value_u_figureset_symbol_molecule_linear_diatomic_typing.ml";;


let nam_dom = "figure";;
let nam_enp = "triangle_isoceles_typing";;
...
let fnd_cal_typ = Camlline_symbol_v.is_type_est_equal;;
let fnd_cal_pip = Camlline_symbol_v.is_pipe_esl;;
...
[(
   (Entity_symbol_t.Entity_proper_top_symbol
     (Entity_proper_top_symbol_t.Top_has_sometopsonleaf "triangle_isoceles_typing")),
  [1; 1; 2; 3; 1; 1; 7; 3; 3])]
);;
...
(* : string *)
=
"type triangle_isoceles_typing_symbol ="
);;
...
=
"./triangle_isoceles_typing_symbol_typing_let_ess_off_est_function_let_ess_off_est_equal_function_v.ml"
);;
