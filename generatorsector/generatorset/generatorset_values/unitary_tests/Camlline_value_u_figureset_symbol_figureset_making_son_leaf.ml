...
testing "Camlline_value_v with
   Camlline_value_u_figureset_symbol_figureset_making_son_leaf.ml";;

(* toplevel 
   #use "Camlline_value_u_figureset_symbol_figureset_making_son_leaf.ml";;

*)

let nam_cod = "Camlline_value_u_figureset_symbol_figureset_making_son_leaf.ml";;
...
(* : string *)
=
  "./Figure_symbol_making_let_make_of_topson_leaf_nam_s_equal_for_symbol_v.ml"
);;
