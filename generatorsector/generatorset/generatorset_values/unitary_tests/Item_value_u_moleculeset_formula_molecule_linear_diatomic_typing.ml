...
(* toplevel 
   #use "Item_value_u_moleculeset_formula_molecule_linear_diatomic_typing.ml";;
         
*)

let nam_cod = "Item_value_u_moleculeset_formula_molecule_linear_diatomic_typing.ml";;
...
=
"./molecule_linear_diatomic_formula_typing_t.ml"
);;
