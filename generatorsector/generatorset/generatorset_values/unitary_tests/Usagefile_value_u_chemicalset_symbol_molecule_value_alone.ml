...
testing "Usagefile_symbol_value_v
   Usagefile_value_u_chemicalset_symbol_molecule_value_alone.ml";;

(* toplevel 
   #use "Usagefile_value_u_chemicalset_symbol_molecule_value_alone.ml";;

*)

let nam_cod = "Usagefile_value_u_chemicalset_formula_molecule_value_alone.ml";;

let nam_dom = "chemical";;
let nam_cof = "value_alone";;
let nam_ent = "molecule";;
let nam_cat = "symbol";;
...
(* : Entity_symbol_t.entity_proper_symbol * Sole_index_t.sole_index *)
 ...
 (Entity_symbol_t.Entity_proper_symbol
    (Entity_proper_symbol_t.Entity_proper_with_sons "molecule"),
   [2; 7; 1])
);;
...
(* :  Contentfile_symbol_t.contentfile_symbol * Sole_index_t.sole_index *)
  =
(Contentfile_symbol_t.Value_alone, [2; 2; 7; 1])
);;
