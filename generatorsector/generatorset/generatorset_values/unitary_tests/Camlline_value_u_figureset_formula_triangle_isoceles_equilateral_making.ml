...
testing "Camlline_value_v
   Camlline_value_u_figureset_formula_triangle_isoceles_equilateral_making.ml";;

(* toplevel 
   #use "Camlline_value_u_figureset_formula_triangle_isoceles_equilateral_making.ml";;

*)

let nam_cod = "Camlline_value_u_figureset_formula_triangle_isoceles_equilateral_making.ml";;
...
nam_fil
=
  "./Triangle_isoceles_equilateral_formula_making_let_make_entity_fictive_nullary_for_formula_let_make_sym_as_soi_at_equal_v.ml"
);;
...
nam_fil
=
 "./Triangle_isoceles_equilateral_formula_making_let_make_entity_fictive_nullary_for_formula_Space_let_count_equal_zero_v.ml"
);;
...
(* Camlline : 6 Space_let_dos_of_ste_equal_Dos_vdot_fun_in *)
...
nam_fil
=
  "./Triangle_isoceles_equilateral_formula_making_let_make_entity_fictive_nullary_for_formula_let_dos_of_ste_equal_dos_vdot_fun_in_v.ml"
);;
...
=
  [(Entity_symbol_t.Entity_external_symbol
   ...
   (Entity_symbol_t.Entity_fictive_symbol
     (Entity_fictive_symbol_t.Entity_fictive_nullary_symbol
       (Entity_fictive_nullary_symbol_t.Nonsonnullary "vector_3d")),
    [3; 13; 2; 5; 1; 2; 28; 2; 2])]
);;
...
nam_fil
=
"./Triangle_isoceles_equilateral_formula_making_let_make_entity_fictive_nullary_for_formula_das_vdot_make_tag_a_tag_b_v.ml"
);;
