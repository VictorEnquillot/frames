...
testing "Camlline_duo_function_value_v with
   Camlline_datastructure_camltype_value_u_chemicalset_formula_molecule_linear_diatomic_typing.ml";;

(* toplevel 
   #use "Camlline_datastructure_camltype_value_u_chemicalset_formula_molecule_linear_diatomic_typing.ml";;

*)

let nam_cod = "Camlline_datastructure_camltype_value_u_chemicalset_formula_molecule_linear_diatomic_typing.ml";;
...
let fnd_cal_pip = Camlline_symbol_v.is_pipe_a_b_datastructure_of_a_b_datastructure;;
...
let sym_cdc_pip = Camlline_symbol_v.camlline_datastructure_camltype_symbol_off_camlline_symbol sym_cal_pip;;
...
=
"./molecule_linear_diatomic_symbol_typing_let_ess_off_est_function_let_ess_off_est_equal_function_v.ml"
);;
