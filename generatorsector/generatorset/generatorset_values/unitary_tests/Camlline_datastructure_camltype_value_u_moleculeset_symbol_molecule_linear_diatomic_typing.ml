...
(* toplevel 
   #use "Camlline_datastructure_camltype_value_u_moleculeset_symbol_molecule_linear_diatomic_typing.ml";;

*)

let nam_cod = "Camlline_datastructure_camltype_value_u_moleculeset_symbol_molecule_linear_diatomic_typing.ml";;
