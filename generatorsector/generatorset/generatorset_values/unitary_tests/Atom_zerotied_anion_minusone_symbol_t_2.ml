...
testing "Creating ./atom_zerotied_anion_minusone_symbol_v.ml using usagefile_symbol_value_t_2.ml";;

(* toplevel 
   #use "tatom_zerotied_anion_minusone_symbol_u_t.ml";;
*)
...
=
(Usagefile_symbol_t.Implementation, [1; 1; 6; 1; 1])
);;
...
=
[(Item_symbol_t.Item_heading, [1; 1; 1; 6; 1; 1]);
 (Item_symbol_t.Item_documenting, [2; 1; 1; 6; 1; 1]);
 (Item_symbol_t.Item_typing, [3; 1; 1; 6; 1; 1]);
 (Item_symbol_t.Item_ending, [4; 1; 1; 6; 1; 1])]
);;
...
=
"./atom_zerotied_anion_minusone_symbol_t.ml"
);;
