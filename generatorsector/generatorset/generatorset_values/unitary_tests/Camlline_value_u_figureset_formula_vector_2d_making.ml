...
testing "Camlline_value_v
   Camlline_value_u_figureset_formula_vector_2d_making.ml";;

(* toplevel 
   #use "Camlline_value_u_figureset_formula_vector_2d_making.ml";;

*)

let nam_cod = "Camlline_value_u_figureset_formula_vector_2d_making.ml";;

let nam_dom = "figure";;
let nam_cat = "formula";;
let nam_ent = "vector_2d";;
...
(* : Contentfile_symbol_t.contentfile_symbol Tag_t.tag list *)
  =
[(Contentfile_symbol_t.Type_alone, [1; 35; 2; 2]);
 (Contentfile_symbol_t.Value_alone, [2; 35; 2; 2])]
);;
...
=
  (Usagefile_symbol_t.Implementation, [1; 2; 35; 2; 2])
);;
...
=
  [(Camlline_symbol_t.Camlline_duo_symbol
   ...
   (Camlline_symbol_t.Camlline_trio_symbol
     Camlline_trio_symbol_t.Space_Tools_fdos_vdot_duo_make_sym_as_soi_at_dom_of_ste,
    [6; 2; 5; 1; 2; 35; 2; 2]);
   (Camlline_symbol_t.Camlline_constant_symbol
...
=
  [(Entity_symbol_t.Entity_fictive_symbol
     (Entity_fictive_symbol_t.Entity_fictive_nullary_symbol
       (Entity_fictive_nullary_symbol_t.Nonsonnullary "vector_2d")),
    [1; 1; 2; 5; 1; 2; 35; 2; 2]);
   (
...
nam_fil
=
"./Vector_2d_formula_making_let_make_entity_fictive_nullary_for_formula_let_make_sym_as_soi_at_equal_v.ml"
);;
...
nam_fil
=
 "./Vector_2d_formula_making_let_make_entity_fictive_nullary_for_formula_Space_let_count_equal_zero_v.ml"
);;
...
nam_fil
=
 "./Vector_2d_formula_making_let_make_entity_fictive_nullary_for_formula_tools_fdos_vdot_duo_make_sym_as_soi_at_dom_of_ste_v.ml"
);;
...
(* : Camlline_value_t.camlline_value *)
  =
 "  Tools_fgeo_v.duo_make sym_po2 soi_vec dos_of_ste"
);; 
