...
testing "Camlline_value_v with
   Camlline_value_u_figureset_formula_triangle_builder_tag_listing.ml";;

(* toplevel 
   #use "Camlline_value_u_figureset_formula_triangle_builder_tag_listing.ml";;
...
=
  [(Entity_symbol_t.Entity_proper_symbol
     (Entity_proper_symbol_t.Entity_proper_with_sons "triangle"),
    [1; 2; 1; 2; 2; 7; 1; 2; 8; 2; 2]);
   (Entity_symbol_t.Entity_proper_symbol
     (Entity_proper_symbol_t.Entity_proper_with_one_son "point"),
    [2; 2; 1; 2; 2; 7; 1; 2; 8; 2; 2])]
);;
