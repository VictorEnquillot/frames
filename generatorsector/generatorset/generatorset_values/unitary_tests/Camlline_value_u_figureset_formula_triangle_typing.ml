...
testing "Camlline_value_v with
   Camlline_value_u_figureset_formula_triangle_typing.ml";;

(* toplevel 
   #use "Camlline_value_u_figureset_formula_triangle_typing.ml";;

*)

let nam_cod = "Camlline_value_u_figureset_formula_triangle_typing.ml";;
...
tag_cof
=
(Contentfile_symbol_t.Type_alone, [1; 8; 2; 2])
);;
...
(* : string list*)
 =
  ["  | Triangle_isoceles_formula of Triangle_isoceles_formula_t.triangle_isoceles_formula"]
);;
...
=
  ["type triangle_formula =";
   "  | Triangle_isoceles_formula of Triangle_isoceles_formula_t.triangle_isoceles_formula";
   "  | Triangle_scalene_formula of Triangle_scalene_formula_t.triangle_scalene_formula";
   ";;"]
);;
...
(* : string *)
  =
 "./Triangle_formula_typing_for_formula_camlparagraph_for_formula_type_t.ml"
);;
