...
testing "Camlline_duo_function_value_v with
   Camlline_duo_function_value_u_chemicalset_formula_atom_zerotied_extracting.ml";;

(* toplevel 
   #use "Camlline_duo_function_value_u_chemicalset_formula_atom_zerotied_extracting.ml";;
*)
...
let fnd_cap = Camlparagraph_symbol_v.is_let_mfs_off_eft_function;;
let fnd_cal = Camlline_symbol_v.is_pipe_ess_bof_mfs_tdot_efs;;

let nam_cod = "Camlline_duo_function_value_u_chemicalset_formula_atom_zerotied_extracting.ml";;
