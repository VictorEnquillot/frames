...
testing "Camlline_duo_function_tag_value_v
   Camlline_value_u_chemicalset_tag_atom_zerotied_upgrading.ml";;

(* toplevel 
   #use "Camlline_value_u_chemicalset_tag_atom_zerotied_upgrading.ml";;
*)
...
let tag_cap = Doublet_list_v.find_if_left 
    Camlparagraph_symbol_v.is_let_ett_of_mtc_argument for_ite;;
...
[(Camlline_symbol_t.Camlline_duo_symbol
 ...
 (Camlline_symbol_t.Camlline_duo_symbol
   (Camlline_duo_symbol_t.Camlline_duo_function_symbol
     Camlline_duo_function_symbol_t.Space_Tag_vdot_map_left_Est_vdot_est_of_esc_atc),
  [2; 2; 7; 1; 2; 3; 2; 1]);
...
let tag_cal = Doublet_list_v.find_if_left 
    Camlline_symbol_v.is_let_et_any_of_ec_any_ac_ac_equal for_cap;; 
...
(* : string *)
=
"let atom_zerotied_tag_of_atom_zerotied_raregas_tag tag_a0r = "
);;

test_number 7 (
Camlline_value_v.fullnameoffile "./" tag_cal
=
"./atom_zerotied_tag_upgrading_let_ett_of_mtc_argument_let_est_of_esc_asc_equal_v.ml"
);;
