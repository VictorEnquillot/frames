...
(* toplevel 
   #use "Usagefile_value_u_chemicalset_symbol_atom_value_alone.ml";;

*)

let nam_cod = "Usagefile_value_u_chemicalset_formula_atom_value_alone.ml";;
...
(* : Entity_symbol_t.entity_proper_symbol * Sole_index_t.sole_index *)
 ...
 (Entity_symbol_t.Entity_proper_symbol
    (Entity_proper_symbol_t.Entity_proper_with_sons "atom"),
   [2; 7; 1])
);;
