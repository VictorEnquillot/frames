...
(* toplevel 
   #use "Camlline_value_u_chemicalset_symbol_atom_zerotied_anion_minusone_upgrading.ml";;
*)

let nam_cod = "Camlline_value_u_chemicalset_symbol_atom_zerotied_anion_minusone_upgrading.ml";;
...
=
"./atom_zerotied_anion_minusone_symbol_upgrading_item_title_item_title_v.ml"
);;
