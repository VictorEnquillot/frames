...
testing "Usagefile_value_v
   Usagefile_value_u_figureset_formula_triangle_isoceles_equilateral_value_alone.ml";;

(* toplevel 
   #use "Usagefile_value_u_figureset_formula_triangle_isoceles_equilateral_value_alone.ml";;

*)

let nam_dos = "figureset";;
let nam_cof = "value_alone";;
let nam_ent = "trinagle_isoceles_equilateral";;
let nam_cat = "formula";;
...
(* : Entity_symbol_t.entity_proper_symbol * Sole_index_t.sole_index *)
  ...
  (Entity_symbol_t.Entity_proper_symbol
    (Entity_proper_symbol_t.Entity_proper_with_one_son "trinagle_isoceles_equilateral"),
   [13; 2; 2])
);;
...
=
"./Trinagle_isoceles_equilateral_formula_v.ml"
);;
...
(* : Usagefile_value_t.usagefile_value *)
  =
  ["(** {3 Trinagle_isoceles_equilateral_formula_v} *)";
   "(** {6 Symbolizing_for_formula} *)";
   "let symbol_of_formula = function";
   "  | Trinagle_isoceles_equilateral_formula_t.Trinagle_isoceles_equilateral_constructor _ ->";
   "  Trinagle_isoceles_equilateral_formula_t.Trinagle_isoceles_equilateral_constructor ";
   ";;";
   "(** {6 Building_and_storing_basic_sons} *)";
   "let build_n_store sym_fas soi_fak =";
   "  let sym_str_l = Trinagle_isoceles_equilateral_interface_v.make_of_symbol sym_fas in";
   "  let soi_str_l =";
   ...
   "  match sym_fas with";
   "  | Trinagle_isoceles_equilateral_symbol_t.Trinagle_isoceles_equilateral_constructor ->";
   "      let tag_str_l = build_n_store sym_fas soi_fak in";
   "        Trinagle_isoceles_equilateral_formula_t.Trinagle_isoceles_equilateral_constructor tag_str_l";
   ";;";
   "(** {6 Retrieving_for_formula} *)";
   "let retrieve tag_fas =";
   "  let soi_fak = Tag_v.sole_index_off_tag tag_fas in";
   "  let sym_fas = Trinagle_isoceles_equilateral_tag_v.symbol_off_tag tag_fas in";
   "  make sym_fas soi_fak";
   ";;";
   "(** {6 Data_tag_listing_off_formula} *)";
   "let string_tag_list_off_trinagle_isoceles_equilateral_formula for_fas =";
   "  | Trinagle_isoceles_equilateral_formula_t.Trinagle_isoceles_equilateral_constructor tag_str_l -> tag_str_l";
   ";;";
   "(** {6 Data_tag_listing_off_tag} *)";
   "let string_tag_list_off_trinagle_isoceles_equilateral_tag tag_fas =";
   "  let for_fas = retrieve tag_fas in";
   "  string_tag_list_off_trinagle_isoceles_equilateral_formula for_fas";
   ";;"]
);;
