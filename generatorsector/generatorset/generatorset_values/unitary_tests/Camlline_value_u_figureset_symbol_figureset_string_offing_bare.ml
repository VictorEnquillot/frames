...
testing "Camlline_value_v with
   Camlline_value_u_figureset_symbol_figureset_string_offing_bare.ml";;

(* toplevel 
   #use "Camlline_value_u_figureset_symbol_figureset_string_offing_bare.ml";;

*)

let nam_cod = "Camlline_value_u_figureset_symbol_figureset_string_offing_bare.ml";;
...
(* 3 Item_for_symbol_by_group_topsons_symbol_t.String_offing_for_symbol_bare *)

let nam_ite = "string_offing_for_symbol_bare";;
...
(* 2 Camlparagraph_for_symbol_let_match_symbol_t.Let_string_off_of_topson_bare_equal_function_for_symbol *)

(* let string_off_of_topson_bare = function *)
(*   | Figure_symbol_t.Vector -> "" *)
(*   | _ -> *)
(*   failwith "Not_a_topson_bare:Figure_symbol_v.ml:string_off_of_topson_bare" *)
(* ;; *)
...
(* : string *)
  =
 "./Figure_symbol_String_offing_for_symbol_bare_Let_string_off_of_topson_bare_equal_function_for_symbol_v.ml"
);;

Camlparagraph_value_v.write "./" tag_cap;;

(* 1 Section_for_symbol_header_constant_symbol_t.Let_string_off_of_topson_bare_equal_function *)
...
(* 1 Group_for_symbol_header_constant_symbol_t.Let_string_off_of_topson_bare_equal_function *)
...
(* 1 Camlline_constant_function_symbol_t.Let_string_off_of_topson_bare_nam_equal *)
   ...
   (Camlline_symbol_t.Camlline_for_symbol_symbol
     (Camlline_for_symbol_symbol_t.Camlline_for_symbol_uno_symbol
       (Camlline_for_symbol_uno_symbol_t.Camlline_for_symbol_uno_top_symbol
         Camlline_for_symbol_uno_top_symbol_t.Space_failwith_not_a_topson_bare_et_symbol_string_off)),
    [2; 1; 3; 2; 7; 1; 2; 1; 7; 2]);
   (Camlline_symbol_t.Camlline_constant_symbol
