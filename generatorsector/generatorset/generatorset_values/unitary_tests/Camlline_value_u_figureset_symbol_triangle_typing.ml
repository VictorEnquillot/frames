...
testing "Camlline_duo_function_symbol_value_v
   Camlline_value_u_figureset_symbol_triangle_typing.ml";;

(* toplevel 
   #use "Camlline_value_u_figureset_symbol_triangle_typing.ml";;

*)

let nam_cod = "Camlline_value_u_figureset_symbol_triangle_typing.ml";;
