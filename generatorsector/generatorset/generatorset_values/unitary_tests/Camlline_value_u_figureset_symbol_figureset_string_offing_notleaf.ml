...
testing "Camlline_value_v with
   Camlline_value_u_figureset_symbol_figureset_string_offing_notleaf.ml";;

(* toplevel 
   #use "Camlline_value_u_figureset_symbol_figureset_string_offing_notleaf.ml";;

*)

let nam_cod = "Camlline_value_u_figureset_symbol_figureset_string_offing_notleaf.ml";;
...
(* 5 Item_for_symbol_by_group_topsons_symbol_t.String_offing_for_symbol_notleaf *)

let nam_ite = "string_offing_for_symbol_notleaf";;
...
(* 2 Camlparagraph_for_symbol_let_match_symbol_t.Let_string_off_of_topson_notleaf_equal_function_for_symbol *)
...
(*   | _ -> *)
(*   failwith "Not_a_topson_notleaf:Figure_symbol_v.ml:string_off_of_topson_notleaf" *)
(* ;; *)
...
=
  ["let string_off_of_topson_notleaf = function";
   ...
   "  Coordinate_symbol_v.string_off sym_coo";
   "  | Figure_symbol_t.Triangle_symbol sym_tri ->";
   "  Triangle_symbol_v.string_off sym_tri"; "  | _ ->";
   "  failwith \"Not_a_topson_notleaf:Figure_symbol_v.ml:string_off_of_topson_notleaf\"";
   ";;"]
);;
...
(* : string *)
  =
  "./Figure_symbol_String_offing_for_symbol_notleaf_Let_string_off_of_topson_notleaf_equal_function_for_symbol_v.ml"
);;

Camlparagraph_value_v.write "./" tag_cap;;

(* 1 Section_for_symbol_header_constant_symbol_t.Let_string_off_of_topson_notleaf_equal_function *)
...
(* 1 Group_for_symbol_header_constant_symbol_t.Let_string_off_of_topson_notleaf_equal_function *)
...
(* 1 Camlline_constant_function_symbol_t.Let_string_off_of_topson_notleaf_nam_equal *)
...
(* 2 Section_for_symbol_body_son_top_symbol_t.String_off_topson_pattern_notleaf_for_symbol *)
...
(* 2 Group_for_symbol_body_son_top_symbol_t.Pipe_upgrade_string_off_notleaf_function *)
...
(* 2 Camlline_for_symbol_uno_son_notleaf_symbol_t.Es_symbol_vdot_string_off_sym_as *)
...
(* 1 Group_for_symbol_footer_top_symbol_t.Pipe_underscore_failwith_not_a_topson_notleaf *)
   ...
   (Camlline_symbol_t.Camlline_for_symbol_symbol
     (Camlline_for_symbol_symbol_t.Camlline_for_symbol_uno_symbol
       (Camlline_for_symbol_uno_symbol_t.Camlline_for_symbol_uno_top_symbol
         Camlline_for_symbol_uno_top_symbol_t.Space_failwith_not_a_topson_notleaf_et_symbol_string_off)),
    [2; 1; 3; 2; 9; 1; 2; 1; 7; 2]);
   (Camlline_symbol_t.Camlline_constant_symbol
