...
testing "Camlline_value_v with
   Camlline_value_u_figureset_formula_polar_rho_building_and_storing.ml";;

(* toplevel 
   #use "Camlline_value_u_figureset_formula_polar_rho_building_and_storing.ml";;
...
(Entity_symbol_t.Entity_proper_symbol
   (Entity_proper_symbol_t.Entity_proper_with_sons "polar_rho"),
 [2; 2; 2])
);;
...
=
  [Entity_symbol_t.Entity_proper_symbol
    (Entity_proper_symbol_t.Entity_proper_with_sons "polar_rho_cartesian");
   Entity_symbol_t.Entity_proper_symbol
    (Entity_proper_symbol_t.Entity_proper_with_sons "polar_rho_cylindrical");
   Entity_symbol_t.Entity_proper_symbol
    (Entity_proper_symbol_t.Entity_proper_with_sons "polar_rho_polar");
   Entity_symbol_t.Entity_proper_symbol
    (Entity_proper_symbol_t.Entity_proper_with_sons "polar_rho_spherical")]
);;
...
(* : string list *)
=
["let build_n_store sym_coo soi_coo ="]
);;
...
=
  [(Entity_symbol_t.Entity_proper_symbol
     (Entity_proper_symbol_t.Entity_proper_with_sons "polar_rho"),
    [1; 1; 1; 1; 2; 3; 1; 2; 2; 2; 2]);
   (Entity_symbol_t.Entity_proper_symbol
     (Entity_proper_symbol_t.Entity_proper_with_sons "polar_rho"),
    [2; 1; 1; 1; 2; 3; 1; 2; 2; 2; 2])]
);;
...
(* : string *)
  =
   "  let sex_coo = Polar_rho_tag_v.polar_rho_sextup_off_polar_rho_tag tag_coo in"
);;
...
(* : string *)
  =
"  let sym_poi_l = Polar_rho_interface_v.make sex_coo in"
);;
...
=
  [(Entity_symbol_t.Entity_proper_symbol
     (Entity_proper_symbol_t.Entity_proper_with_sons "polar_rho"),
    [1; 4; 2; 2; 2; 3; 1; 2; 2; 2; 2]);
   (Entity_symbol_t.Entity_proper_symbol
     (Entity_proper_symbol_t.Entity_proper_with_one_son "point"),
    [2; 4; 2; 2; 2; 3; 1; 2; 2; 2; 2])]
);;
...
(* : string *)
  =
"    1 (List.length sym_poi_l) soi_coo in"
);;
...
(* : string *)
  =
  "./Polar_rho_formula_building_and_storing_basic_sons_let_build_n_store_basic_sons_v.ml"
);;
