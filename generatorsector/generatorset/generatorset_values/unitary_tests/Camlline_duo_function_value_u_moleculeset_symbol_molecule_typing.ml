...
(* toplevel 
   #use "Camlline_duo_function_value_u_moleculeset_symbol_molecule_typing.ml";;

*)

let nam_cod = "Camlline_duo_function_value_u_moleculeset_symbol_molecule_typing.ml";;
...
let fnd_cal_pip = Camlline_symbol_v.is_pipe_ess_bof_ess_tdot_ess;;
