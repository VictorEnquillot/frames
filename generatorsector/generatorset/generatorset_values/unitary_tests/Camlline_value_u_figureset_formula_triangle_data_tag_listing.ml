...
testing "Camlline_value_v with
   Camlline_value_u_figureset_formula_triangle_data_tag_listing.ml";;

(* toplevel 
   #use "Camlline_value_u_figureset_formula_triangle_data_tag_listing.ml";;
...
=
  [(Entity_symbol_t.Entity_proper_symbol
     (Entity_proper_symbol_t.Entity_proper_with_sons "triangle_isoceles"),
    [1; 1; 1; 2; 2; 7; 1; 2; 8; 2; 2]);
   (Entity_symbol_t.Entity_proper_symbol
     (Entity_proper_symbol_t.Entity_proper_with_sons "triangle"),
    [2; 1; 1; 2; 2; 7; 1; 2; 8; 2; 2])]
);;
...
=
 [(Entity_symbol_t.Entity_proper_symbol
     (Entity_proper_symbol_t.Entity_proper_with_sons "triangle_scalene"),
    [1; 1; 2; 2; 2; 7; 1; 2; 8; 2; 2]);
   (Entity_symbol_t.Entity_proper_symbol
     (Entity_proper_symbol_t.Entity_proper_with_sons "triangle"),
    [2; 1; 2; 2; 2; 7; 1; 2; 8; 2; 2])]
);;
...
(* : string *)
  =
  "./Triangle_formula_data_tag_listing_off_formula_let_data_tag_list_off_top_formula_v.ml"
);;
...
=
  [(Entity_symbol_t.Entity_proper_symbol
     (Entity_proper_symbol_t.Entity_proper_with_sons "triangle"),
    [1; 1; 1; 1; 2; 8; 1; 2; 8; 2; 2]);
   (Entity_symbol_t.Entity_fictive_symbol
     (Entity_fictive_symbol_t.Entity_fictive_basicnullary_symbol
       (Entity_fictive_basicnullary_symbol_t.Float "")),
    [2; 1; 1; 1; 2; 8; 1; 2; 8; 2; 2])]
);;
...
=
  [(Entity_symbol_t.Entity_proper_symbol
     (Entity_proper_symbol_t.Entity_proper_with_sons "triangle"),
    [1; 2; 1; 2; 2; 8; 1; 2; 8; 2; 2]);
   (Entity_symbol_t.Entity_fictive_symbol
     (Entity_fictive_symbol_t.Entity_fictive_basicnullary_symbol
       (Entity_fictive_basicnullary_symbol_t.Float "")),
    [2; 2; 1; 2; 2; 8; 1; 2; 8; 2; 2])]
);;
...
(* : string *)
  =
  "./Triangle_formula_data_tag_listing_off_tag_let_data_tag_list_off_top_tag_v.ml"
);;
