...
testing "Item_symbol_value_v
   Item_value_u_figureset_symbol_figureset_longnaming.ml";;

(* toplevel 
   #use "Item_value_u_figureset_symbol_figureset_longnaming.ml";;

*)

let nam_cod = "Item_value_u_figureset_symbol_figureset_longnaming.ml";;
...
let nam_ite = "longnaming_for_symbol";;
...
(* : string list *)
=  
  ["(** {6 Longnaming_for_symbol} *)"; "let longname geo =";
   "  Format.sprintf \"Figure_symbol_t.%s\" (String.capitalize (name sym_geo))";
   ";;"]
);;
...
str_ite_l
=
Item_value_v.string_list_off_item_tag tag_ite
);;
...
nam_fil
=
 "./Figure_symbol_Longnaming_for_symbol_v.ml"
);;
