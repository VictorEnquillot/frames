...
testing "Item_symbol_value_v
   Item_value_u_figureset_symbol_figureset_upgrading.ml";;

(* toplevel 
   #use "Item_value_u_figureset_symbol_figureset_upgrading.ml";;

*)

let nam_cod = "Item_value_u_figureset_symbol_figureset_upgrading.ml";;
...
let nam_ite = "upgrading_topson_for_symbol";;
...
(* : string list *)
=  
["(** {6 Upgrading_topson_for_symbol} *)";
 "let figure_symbol_of_triangle_symbol sym_tri = ";
 "  Figure_symbol_t.Triangle_symbol sym_tri"; 
 ";;";
 "let figure_symbol_of_coordinate_symbol sym_coo = ";
...
nam_fil
=
 "./Figure_symbol_Upgrading_topson_for_symbol_v.ml"
);;
...
=  
  ["(** {6 Upgrading_grandson_for_symbol} *)";
   "let figure_symbol_of_triangle_isoceles_symbol sym_tis = ";
   "  let sym_tri = Triangle_symbol_v.triangle_symbol_of_triangle_isoceles_symbol sym_tis in";
   "    figure_symbol_of_triangle_symbol sym_tri";
   ";;";
   "let figure_symbol_of_triangle_scalene_symbol sym_trs = ";
   "  let sym_tri = Triangle_symbol_v.triangle_symbol_of_triangle_scalene_symbol sym_trs in";
   "    figure_symbol_of_triangle_symbol sym_tri";
   ";;";
   "let figure_symbol_of_coordinate_cartesian_symbol sym_coc = ";
   "  let sym_coo = Coordinate_symbol_v.coordinate_symbol_of_coordinate_cartesian_symbol sym_coc in";
   "    figure_symbol_of_coordinate_symbol sym_coo";
   ";;";
   "let figure_symbol_of_coordinate_cylindrical_symbol sym_coc = ";
   "  let sym_coo = Coordinate_symbol_v.coordinate_symbol_of_coordinate_cylindrical_symbol sym_coc in";
   "    figure_symbol_of_coordinate_symbol sym_coo";
   ";;";
   "let figure_symbol_of_coordinate_polar_symbol sym_cop = ";
   "  let sym_coo = Coordinate_symbol_v.coordinate_symbol_of_coordinate_polar_symbol sym_cop in";
   "    figure_symbol_of_coordinate_symbol sym_coo";
   ";;";
   "let figure_symbol_of_coordinate_spherical_symbol sym_cos = ";
...
nam_fil
=
 "./Figure_symbol_Upgrading_grandson_for_symbol_v.ml"
);;
