...
testing "Camlline_value_v with
   Camlline_value_u_figureset_formula_fake_son_making_for_formula.ml";;

(* toplevel 
   #use "Camlline_value_u_figureset_formula_fake_son_making_for_formula.ml";;

*)

let nam_cod = "Camlline_value_u_figureset_formula_fake_son_making.ml";;
...
(* Making_for_formula_off_tag *)

let nam_ite = "making_for_formula_off_tag";;
...
(* Making_for_formula_off_formula *)

let nam_ite = "making_for_formula_off_formula";;
let sel_ite = (fun i -> Item_symbol_v.name i = nam_ite);;
