...
testing "usagefile_symbol_value_implementation_value_u_3.ml";;

(* toplevel 
   #use "Tusagefile_symbol_value_implementation_value_u_3.ml";;
*)

let fnd_cat = Category_symbol_v.is_symbol_off_category_symbol;;
let fnd_enp = (fun e -> Entity_symbol_v.string_off e = "halfbridge")
...
let fnd_cal = Camlline_symbol_v.is_let_ass_equal_t_tdot_s;;
