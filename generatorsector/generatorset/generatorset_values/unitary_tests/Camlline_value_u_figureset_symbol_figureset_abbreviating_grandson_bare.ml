...
testing "Camlline_value_v with
   Camlline_value_u_figureset_symbol_figureset_abbreviating_grandson_bare.ml";;

(* toplevel 
   #use "Camlline_value_u_figureset_symbol_figureset_abbreviating_grandson_bare.ml";;

*)

let nam_cod = "Camlline_value_u_figureset_symbol_figureset_abbreviating_grandson_bare.ml";;
...
let nam_ite = "abbreviating_grandson_bare_for_symbol";;
...
(* 2 Camlparagraph_for_symbol_let_abbreviate_symbol_t.Let_abbreviate_grandson_bare *)
...
(* : string *)
  =
  "./Figure_symbol_Abbreviating_grandson_bare_for_symbol_Let_abbreviate_grandson_bare_v.ml"
);;

Camlparagraph_value_v.write "./" tag_cap;;

(* 1 Section_for_symbol_header_constant_symbol_t.Let_make_of_grandson_bare_nam_equal *)
...
(* 1 Group_for_symbol_header_current_son_top_symbol_t.Let_abbreviate_grandson_bare *)
...
(* 1 Camlline_for_any_trio_current_son_top_symbol_t.Let_ec_equal_et_any_of_es_any_es_any_vdot_ec_any *)
