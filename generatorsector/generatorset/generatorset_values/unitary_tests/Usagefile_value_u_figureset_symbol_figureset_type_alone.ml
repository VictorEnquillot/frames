...
testing "Usagefile_symbol_value_v
   Usagefile_value_u_figureset_symbol_figureset_type_alone.ml";;

(* toplevel 
   #use "Usagefile_value_u_figureset_symbol_figureset_type_alone.ml";;

*)

let nam_cod = "Usagefile_value_u_figureset_symbol_figureset_type_alone.ml";;
...
let sel_enp = (fun e -> Entity_symbol_v.string_off e = nam_ent);;
...
let tag_cof_l = Entity_formula_v.contentfile_tag_list_off_entity_formula for_enp;;
