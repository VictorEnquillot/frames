...
testing "Camlline_value_v with
   Camlline_value_u_figureset_formula_point_typing.ml";;

(* toplevel 
   #use "Camlline_value_u_figureset_formula_point_typing.ml";;

*)

let nam_cod = "Camlline_value_u_figureset_formula_point_typing.ml";;
...
tag_cof
=
(Contentfile_symbol_t.Type_alone, [1; 7; 2; 2])
);;
...
let sym_efn = Entity_fictive_nullary_symbol_t.Ofstring "point_constructor";;
let tri_efn = Triplet_v.reset_of_left_off_triplet sym_efn tri_ent_top;;
let sym_enb_l =
...
(* : string *)
  =
 "  | Point_constructor of string * Coordinate_tag_t.coordinate_tag list"
);;
...
(* : string *)
  =
 "./Point_formula_typing_for_formula_camlparagraph_for_formula_type_t.ml"
);;
...
(* : string list *)
=
 ["(** {6 Typing_for_formula} *)"; "type point_formula =";
   "  | Point_constructor of string * Coordinate_tag_t.coordinate_tag list";
   ";;"]
);;
...
(* : string *)
  =
"./Point_formula_typing_for_formula_t.ml"
);;
