...
(* toplevel 
   #use "Camlparagraph_value_u_moleculeset_formula_molecule_linear_diatomic_typing.ml";;

*)

let nam_cod = "Camlparagraph_value_u_moleculeset_formula_molecule_linear_diatomic_typing.ml";;
...
=
"./molecule_linear_diatomic_formula_typing_type_definition_for_formula_t.ml"
);;
