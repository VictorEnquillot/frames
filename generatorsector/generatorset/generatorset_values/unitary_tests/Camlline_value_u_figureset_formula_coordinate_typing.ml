...
testing "Camlline_value_v with
   Camlline_value_u_figureset_formula_coordinate_typing.ml";;

(* toplevel 
   #use "Camlline_value_u_figureset_formula_coordinate_typing.ml";;

*)

let nam_cod = "Camlline_value_u_figureset_formula_coordinate_typing.ml";;
...
(* : string *)
  =
 "./Coordinate_formula_typing_for_formula_camlparagraph_for_formula_type_t.ml"
);;
...
(* : string list *)
  =
["(** {6 Typing_for_formula} *)"; "type coordinate_formula =";
 "  | Coordinate_cartesian_formula of Coordinate_cartesian_formula_t.coordinate_cartesian_formula";
 "  | Coordinate_cylindrical_formula of Coordinate_cylindrical_formula_t.coordinate_cylindrical_formula";
 "  | Coordinate_polar_formula of Coordinate_polar_formula_t.coordinate_polar_formula";
 "  | Coordinate_spherical_formula of Coordinate_spherical_formula_t.coordinate_spherical_formula";
...
(* : string *)
  =
"./Coordinate_formula_typing_for_formula_t.ml"
);;
...
(* : string list *)
=
  ["(** {3 Coordinate_formula_t} *)"; "(** {6 Typing_for_formula} *)";
   "type coordinate_formula =";
   "  | Coordinate_cartesian_formula of Coordinate_cartesian_formula_t.coordinate_cartesian_formula";
   "  | Coordinate_cylindrical_formula of Coordinate_cylindrical_formula_t.coordinate_cylindrical_formula";
   "  | Coordinate_polar_formula of Coordinate_polar_formula_t.coordinate_polar_formula";
