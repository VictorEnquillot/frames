...
testing "Camlline_value_v
   Camlline_value_u_figureset_formula_x_2d_making.ml";;

(* toplevel 
   #use "Camlline_value_u_figureset_formula_x_2d_making.ml";;

*)

let nam_cod = "Camlline_value_u_figureset_formula_x_2d_making.ml";;
...
nam_fil
=
"./X_2d_formula_making_let_make_entity_fictive_nullary_for_formula_let_make_sym_as_soi_at_equal_v.ml"
);;
...
nam_fil
=
 "./X_2d_formula_making_let_make_entity_fictive_nullary_for_formula_Space_let_count_equal_zero_v.ml"
);;
...
nam_fil
  =  
  "./X_2d_formula_making_let_make_entity_fictive_nullary_for_formula_let_tag_a_equal_e_tag_vdot_make_soi_as_in_v.ml"
);;
...
let sym_ent = Tools_vgnr_v.uno_off_list nam_cod "make" sym_cal sym_ent_l;;
...
let abb_ent = Tools_vgnr_v.abbreviation_argument sym_ent;;
let sym_efb = Entity_symbol_v.entity_fictive_basicnullary_symbol_off_entity_symbol sym_ent;;
let abb_arg = Abbreviation_argument_v.abbreviation_argument_of_entity_fictive_basicnullary_symbol sym_efb;;
let abb_arg = Abbreviation_argument_v.abbreviation_argument_of_entity_symbol sym_ent;;
