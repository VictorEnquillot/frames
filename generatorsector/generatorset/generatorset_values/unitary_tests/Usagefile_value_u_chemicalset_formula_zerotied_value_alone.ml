...
(* toplevel 
   #use "Usagefile_value_u_chemicalset_formula_zerotied_value_alone.ml";;

*)

let nam_cod = "Usagefile_value_u_chemicalset_formula_zerotied_value_alone.ml";;
...
(* :  Contentfile_symbol_t.contentfile_symbol * Sole_index_t.sole_index *)
  =
(Contentfile_symbol_t.Value_alone, [2; 10; 2; 1])
);;
