...
testing "Usagefile_value_v
   Usagefile_value_u_figureset_formula_figureset_value_alone.ml";;

(* toplevel 
   #use "Usagefile_value_u_figureset_formula_figureset_value_alone.ml";;

*)

let nam_cod = "Usagefile_value_u_figureset_formula_figureset_value_alone.ml";;
...
(* : Usagefile_value_t.usagefile_value *)
  ...
  ["(** {3 Figure_formula_v} *)";
   ...
   "  | Figure_formula_t.Figureset_isoceles_formula for_tis ->";
   "    Figure_formula_t.Figureset_isoceles_formula";
   "      (Figureset_isoceles_formula_v.symbol_of_formula for_tis)";
   "  | Figure_formula_t.Figureset_scalene_formula for_trs ->";
   "    Figure_formula_t.Figureset_scalene_formula";
   "      (Figureset_scalene_formula_v.symbol_of_formula for_trs)";
   ";;";
   "(** {6 Making_for_formula} *)";
   "let make sym_tri soi_tri =";
   "  match sym_tri with";
   "  | Figure_symbol_t.Figureset_isoceles_symbol sym_tis ->";
   "    Figure_formula_t.Figureset_isoceles_formula";
   "      (Figureset_isoceles_formula_v.make sym_tis soi_tri)";
   "  | Figure_symbol_t.Figureset_scalene_symbol sym_trs ->";
   "    Figure_formula_t.Figureset_scalene_formula";
   "      (Figureset_scalene_formula_v.make sym_trs soi_tri)";
   ";;";
   "(** {6 Retrieving_for_formula} *)";
   "let retrieve tag_tri =";
   "  let soi_tri = Tag_v.sole_index_off_tag tag_tri in";
   "  let sym_tri = Figure_tag_v.symbol_off_tag tag_tri in";
   "  make sym_tri soi_tri";
   ";;";
   "(** {6 Builder_tag_listing_off_formula} *)";
   "let point_tag_list_off_figure_formula = function";
   "  | Figure_formula_t.Figureset_isoceles_formula for_tis ->";
   "      Figureset_isoceles_formula_v.point_tag_list_off_figureset_isoceles_formula for_tis";
   "  | Figure_formula_t.Figureset_scalene_formula for_trs ->";
   "      Figureset_scalene_formula_v.point_tag_list_off_figureset_scalene_formula for_trs";
   ";;";
   "(** {6 Builder_tag_listing_off_tag} *)";
   "let point_tag_list_off_figure_tag tag_tri =";
   "  let for_tri = retrieve tag_tri in";
   "  point_tag_list_off_figure_formula for_tri";
   ";;";
   "(** {6 Data_tag_listing_off_formula} *)";
   "let float_tag_list_off_figure_formula for_tri =";
   "  | Figure_formula_t.Figureset_isoceles_formula for_tis ->";
   "      Figureset_isoceles_formula_v.float_tag_list_off_figureset_isoceles_formula for_tis";
   "  | Figure_formula_t.Figureset_scalene_formula for_trs ->";
   "      Figureset_scalene_formula_v.float_tag_list_off_figureset_scalene_formula for_trs";
   ";;";
   "(** {6 Data_tag_listing_off_tag} *)";
   "let float_tag_list_off_figure_tag tag_tri =";
   "  let for_tri = retrieve tag_tri in";
   "  float_tag_list_off_figure_formula for_tri";
   ";;"]
);;
