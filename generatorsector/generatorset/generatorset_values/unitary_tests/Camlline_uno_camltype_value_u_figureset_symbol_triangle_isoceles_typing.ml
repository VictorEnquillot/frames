...
testing "camlline_uno_camltype_value_v
   Camlline_uno_camltype_value_u_figureset_symbol_triangle_isoceles_typing.ml";;

(* toplevel 
   #use "Camlline_uno_camltype_value_u_figureset_symbol_triangle_isoceles_typing.ml";;

*)

let nam_cod = "Camlline_uno_camltype_value_u_figureset_symbol_triangle_isoceles_typing.ml";;
let nam_dom = "figure";;
...
let sel_cal i = (fun soi -> List.hd soi = i);;
let tag_cal = Doublet_list_v.find_if_right (sel_cal 1) for_cap;;
...
let tag_cal = Doublet_list_v.find_if_right (sel_cal 2) for_cap;;
let for_cal = Camlline_formula_v.retrieve tag_cal;;
let val_cal = Camlline_value_v.make tag_cal;;
...
let tag_cal = Doublet_list_v.find_if_right (sel_cal 5) for_cap;;
let for_cal = Camlline_formula_v.retrieve tag_cal;;
let val_cal = Camlline_value_v.make tag_cal;;
