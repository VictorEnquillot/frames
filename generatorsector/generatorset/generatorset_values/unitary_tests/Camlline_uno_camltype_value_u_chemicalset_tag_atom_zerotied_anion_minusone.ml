...
(* toplevel 
   #use "Camlline_uno_camltype_value_u_chemicalset_tag_atom_zerotied_anion_minusone.ml";;
*)
...
let fnd_cap = Camlparagraph_symbol_v.is_type_definition_for_tag;;
...
=
["type atom_zerotied_anion_minusone_tag = Atom_zerotied_anion_minusone_symbol_t.atom_zerotied_anion_minusone_symbol Tag_t.tag";
 ";;"]
);;
...
=
"./atom_zerotied_anion_minusone_tag_typing_type_definition_for_tag_type_ett_equal_est_tdot_est_tag_t.ml"
);;
