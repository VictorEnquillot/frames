...
testing "camlline_duo_function_symbol_value_implementation_value_u_1.ml";;

(* toplevel 
   #use "Camlline_duo_function_value_u_chemicalset_symbol_atom_zerotied.ml";;
*)

let nam_cod = "Camlline_duo_function_value_u_chemicalset_symbol_atom_zerotied.ml";;
