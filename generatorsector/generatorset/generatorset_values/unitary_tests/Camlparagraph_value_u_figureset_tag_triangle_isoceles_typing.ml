...
testing "Camlparagraph_value_v
   Camlparagraph_value_u_figureset_tag_triangle_isoceles_typing.ml";;

(* toplevel 
   #use "Camlparagraph_value_u_figureset_tag_triangle_isoceles_typing.ml";;
...
nam_fil
=
"./Triangle_isoceles_tag_typing_camlparagraph_for_tag_type_t.ml"
);;
