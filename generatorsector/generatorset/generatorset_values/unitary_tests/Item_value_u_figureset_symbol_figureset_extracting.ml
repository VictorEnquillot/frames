...
testing "Item_symbol_value_v
   Item_value_u_figureset_symbol_figureset_extracting.ml";;

(* toplevel 
   #use "Item_value_u_figureset_symbol_figureset_extracting.ml";;

*)

let nam_cod = "Item_value_u_figureset_symbol_figureset_extracting.ml";;
...
nam_fil
=
 "./Figure_symbol_Extracting_topson_for_symbol_v.ml"
);;
...
=  
 ["(** {6 Extracting_grandson_for_symbol} *)";
   "let triangle_isoceles_symbol_off_figure_symbol sym_geo = ";
   ...
   ";;";
   "let coordinate_cylindrical_symbol_off_figure_symbol sym_geo = ";
   "  let sym_coo = coordinate_symbol_off_figure_symbol sym_geo in ";
   "    Coordinate_symbol_v.coordinate_cylindrical_symbol_off_coordinate_symbol sym_coo";
   ";;";
   "let coordinate_polar_symbol_off_figure_symbol sym_geo = ";
   "  let sym_coo = coordinate_symbol_off_figure_symbol sym_geo in ";
   "    Coordinate_symbol_v.coordinate_polar_symbol_off_coordinate_symbol sym_coo";
   ";;";
   "let coordinate_spherical_symbol_off_figure_symbol sym_geo = ";
   "  let sym_coo = coordinate_symbol_off_figure_symbol sym_geo in ";
...
nam_fil
=
 "./Figure_symbol_Extracting_grandson_for_symbol_v.ml"
);;
