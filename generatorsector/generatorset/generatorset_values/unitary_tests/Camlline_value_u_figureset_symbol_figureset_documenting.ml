...
testing "Camlline_value_v with
   Camlline_value_u_figureset_symbol_figureset_documenting.ml";;

(* toplevel 
   #use "Camlline_value_u_figureset_symbol_figureset_documenting.ml";;

*)

let nam_cod = "Camlline_value_u_figureset_symbol_figureset_documenting.ml";;
...
(* 1 Section_for_any_header_top_symbol_t.Item_title *)
...
(* 2 Camlparagraph_for_any_function_symbol_t.Let_documentation *)
...
(* 1 Section_for_any_header_top_symbol_t.Let_documentation *)
...
(* : Group_symbol_t.group_symbol Tag_t.tag list *)
 =
  [(Group_symbol_t.Group_for_any_symbol
     (Group_for_any_symbol_t.Group_for_any_header_symbol
       (Group_for_any_header_symbol_t.Group_for_any_header_top_symbol
         Group_for_any_header_top_symbol_t.Let_documentation)),
    [1; 1; 2; 2; 1; 2; 1; 7; 2])]
);;
...
(* 1 Group_for_any_header_top_symbol_t.Let_documentation *)
...
(* 2 Section_for_any_body_top_symbol_t.Documentation_list *)
  ...
  [(Group_symbol_t.Group_for_any_symbol
     (Group_for_any_symbol_t.Group_for_any_body_symbol
       (Group_for_any_body_symbol_t.Group_for_any_body_top_symbol
         Group_for_any_body_top_symbol_t.Documentation_list)),
    [1; 2; 2; 2; 1; 2; 1; 7; 2])]
);;

(* 1 Group_for_any_body_top_symbol_t.Documentation_list *)
   ...
   (Camlline_symbol_t.Camlline_for_any_symbol
     (Camlline_for_any_symbol_t.Camlline_for_any_uno_symbol
       (Camlline_for_any_uno_symbol_t.Camlline_for_any_uno_top_symbol
         Camlline_for_any_uno_top_symbol_t.Space_double_quote_current)),
    [3; 1; 2; 2; 2; 1; 2; 1; 7; 2]);
   (Camlline_symbol_t.Camlline_constant_symbol
     (Camlline_constant_symbol_t.Camlline_constant_function_symbol
...
(* 3 Camlline_for_any_uno_function_symbol_t.Space_double_quote_current *)
...
=
  [(
    ...
    [1; 3; 1; 2; 2; 2; 1; 2; 1; 7; 2])]
);;

(* 4 Camlline_constant_function_symbol_t.Space_double_quote_needed *)
...
(* : string *)
  =  
"./Figure_symbol_Documenting_let_nam_cod_equal_v.ml"
);;
...
(* : string *)
  =  
 "./Figure_symbol_Documenting_v.ml"
);;
