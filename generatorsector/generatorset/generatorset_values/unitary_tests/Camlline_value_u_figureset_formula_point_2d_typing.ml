...
testing "Camlline_value_v with
   Camlline_value_u_figureset_formula_point_2d_typing.ml";;

(* toplevel 
   #use "Camlline_value_u_figureset_formula_point_2d_typing.ml";;

*)

let nam_cod = "Camlline_value_u_figureset_formula_point_2d_typing.ml";;
let nam_dom = "figure";;
let nam_cat = "formula";;
...
nam_fil
=
"./Point_2d_formula_typing_camlparagraph_for_formula_entity_fictive_nullary_type_type_eft_equal_t.ml"
);;
...
nam_fil
=
  "./Point_2d_formula_typing_camlparagraph_for_formula_entity_fictive_nullary_type_lpar_a_b_tag_rpar_t.ml"
);;
...
(* : Camlline_value_t.camlline_value *)
  =
"  (Coordinate_cartesian_2d_tag_t.coordinate_cartesian_2d_tag, Coordinate_cartesian_2d_tag_t.coordinate_cartesian_2d_tag) Doublet_t.doublet"
);;
