...
(* toplevel 
   #use "Camlline_datastructure_camltype_value_u_moleculeset_formula_molecule_linear_diatomic_typing.ml";;
...
let nam_cal = "Type_definition_for_formula";;
...
(* Camlline : Pipe_A_b_datastructure_of_a_b_datastructure *)

let nam_cal = "Pipe_A_b_datastructure_of_a_b_datastructure";;
let sel_cal = (fun c -> Camlline_symbol_v.name c = nam_cal)
let tag_cal = Doublet_list_v.find_if_left sel_cal for_cap;;
let for_cal = Camlline_formula_v.retrieve tag_cal;;
