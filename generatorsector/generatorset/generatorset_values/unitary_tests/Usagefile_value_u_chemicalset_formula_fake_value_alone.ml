...
(* toplevel 
   #use "Usagefile_value_u_chemicalset_formula_onetied_value_alone.ml";;

*)

let nam_cod = "Usagefile_value_u_chemicalset_formula_onetied_value_alone.ml";;
