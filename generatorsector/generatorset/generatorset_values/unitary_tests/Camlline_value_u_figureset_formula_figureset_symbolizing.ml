...
testing "Camlline_value_v with
   Camlline_value_u_figureset_formula_figure_symbolizing.ml";;

(* toplevel 
   #use "Camlline_value_u_figureset_formula_figure_symbolizing.ml";;

*)

let nam_cod = "Camlline_value_u_figureset_formula_figure_symbolizing.ml";;
...
let nam_ite = "symbolizing_for_formula";;
...
(* 1 Section_for_formula_header_constant_symbol_t.Let_symbol_of_formula_equal_function *)
...
(* 1 Camlline_constant_function_symbol_t.Let_symbol_of_formula_equal_function *)
...
(* 1 Group_for_formula_body_son_top_symbol_t.Symbol_of_formula_topson_pattern_notleaf *)
  (* | Top_formula_t.Son_formula for_son -> *)
  (*     Top_symbol_t.Son_symbol  *)
  (*       (Top_formula_v.symbol_of_formula for_son) *)
...
=
  [(Entity_symbol_t.Entity_proper_symbol
     (Entity_proper_symbol_t.Entity_proper_with_sons "coordinate"),
    [1; 1; 1; 2; 2; 3; 1; 2; 1; 2; 2]);
   (Entity_symbol_t.Entity_proper_symbol
     (Entity_proper_symbol_t.Entity_proper_with_sons "figure"),
    [2; 1; 1; 2; 2; 3; 1; 2; 1; 2; 2])]
);;
...
(* : string *)
  =
 "  | Figure_formula_t.Coordinate_formula for_coo ->"
);;
...
(* : string *)
  =
"      (Coordinate_formula_v.symbol_of_formula for_coo)"
);;
...
=
  [(Entity_symbol_t.Entity_proper_symbol
     (Entity_proper_symbol_t.Entity_proper_with_one_son "point"),
    [1; 1; 2; 2; 2; 3; 1; 2; 1; 2; 2]);
   (Entity_symbol_t.Entity_proper_symbol
     (Entity_proper_symbol_t.Entity_proper_with_sons "figure"),
    [2; 1; 2; 2; 2; 3; 1; 2; 1; 2; 2])]
);;
...
(* : string *)
  =
"  | Figure_formula_t.Point_formula for_poi ->"
);;
...
=
  ["  | Figure_formula_t.Point_formula for_poi ->";
   ...
   "      (Point_formula_v.symbol_of_formula for_poi)"]
);;
...
(* : string list*)
 ...
 ["  | Figure_formula_t.Coordinate_formula for_coo ->";
   ...
   "    Figure_formula_t.Point_formula";
   "      (Point_formula_v.symbol_of_formula for_poi)";
   "  | Figure_formula_t.Triangle_formula for_tri ->";
   "    Figure_formula_t.Triangle_formula";
   "      (Triangle_formula_v.symbol_of_formula for_tri)";
   "  | Figure_formula_t.Vector_formula for_vec ->";
   "    Figure_formula_t.Vector_formula";
   "      (Vector_formula_v.symbol_of_formula for_vec)";
   "  | Figure_formula_t.Fake_formula for_fak ->";
   "    Figure_formula_t.Fake_formula";
   "      (Fake_formula_v.symbol_of_formula for_fak)"]
);;

(* 3 Section_for_formula_body_son_top_symbol_t.Symbol_of_formula_topson_pattern_ofstring *)
...
(* : string *)
  =
 "./Figure_formula_symbolizing_for_formula_let_symbol_of_formula_equal_function_v.ml"
);;
