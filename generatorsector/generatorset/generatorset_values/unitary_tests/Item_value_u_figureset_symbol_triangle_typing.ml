...
testing "Item_symbol_value_v
   Item_value_u_figureset_symbol_triangle_typing.ml";;

(* toplevel 
   #use "Item_value_u_figureset_symbol_triangle_typing.ml";;

*)

let nam_cod = "Item_value_u_figureset_symbol_triangle_typing.ml";;
