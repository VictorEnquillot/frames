...
testing "Camlline_value_v with
   Camlline_value_u_figureset_symbol_coordinate_abbreviating_topson_bare.ml";;

(* toplevel 
   #use "Camlline_value_u_figureset_symbol_coordinate_abbreviating_topson_bare.ml";;

*)

let nam_cod = "Camlline_value_u_figureset_symbol_coordinate_abbreviating_topson_bare.ml";;
...
(* : string *)
  =
  "./Coordinate_symbol_Abbreviating_topson_bare_for_symbol_Let_abbreviate_topson_bare_v.ml"
);;
...
=
  [(Entity_symbol_t.Entity_fictive_symbol
     (Entity_fictive_symbol_t.Entity_fictive_nullary_symbol
       (Entity_fictive_nullary_symbol_t.Bare "vector")),
    [1; 1; 1; 1; 2; 13; 1; 2; 2; 7; 2]);
   (Entity_symbol_t.Entity_proper_symbol (Entity_proper_symbol_t.Entity_proper_with_sons "coordinate"),
    [2; 1; 1; 1; 2; 13; 1; 2; 2; 7; 2])]
);;
