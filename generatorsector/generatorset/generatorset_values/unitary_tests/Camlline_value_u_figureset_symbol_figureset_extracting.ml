...
let val_cap_l = List.map Camlparagraph_value_v.retrieve tag_cap_l;;
...
(* let triangle_symbol_off_figure_symbol = function *)
(*   | Figure_symbol_t.Triangle_symbol sym_tri -> sym_tri *)
(*   | sym_geo -> Error_messages_v.print_fatal_error *)
(*       nam_cod "triangle_symbol_off_figure_symbol" *)
(*       "Triangle_symbol" *)
(*       (name sym_geo) "check" *)
(* ;; *)
  ...
  [(Group_symbol_t.Group_for_symbol_symbol
     (Group_for_symbol_symbol_t.Group_for_symbol_header_symbol
       (Group_for_symbol_header_symbol_t.Group_for_symbol_header_son_top_symbol
         Group_for_symbol_header_son_top_symbol_t.Let_topson_notleaf_symbol_off_top_symbol)),
    [1; 1; 2; 7; 1; 2; 1; 7; 2])]
);;
...
(*   | Figure_symbol_t.Coordinate_symbol sym_tri -> sym_tri *)
(*   | sym_geo -> Error_messages_v.print_fatal_error *)
...
(* | Figure_symbol_t.Coordinate_symbol sym_tri -> *)
...
(* : string *)
  =  
"./Figure_symbol_Extracting_topson_let_topson_notleaf_symbol_off_top_symbol_v.ml"
);;
...
(* : string *)
  =  
 "./Figure_symbol_Extracting_topson_v.ml"
);;
