...
testing "Camlline_value_v with
   Camlline_value_u_figureset_symbol_figureset_querying_grandson_bare.ml";;

(* toplevel 
   #use "Camlline_value_u_figureset_symbol_figureset_querying_grandson_bare.ml";;

*)

let nam_cod = "Camlline_value_u_figureset_symbol_figureset_querying_grandson_bare.ml";;
...
(* 2 Camlparagraph_for_symbol_let_match_symbol_t.Let_is_grandson_bare *)

(* let is_x sym_coo = *)
(*   if not (is_coordinate_cartesian_symbol_off_coordinate_symbol sym_coo) *)
(*   then false *)
(*   else *)
(*     begin *)
(*       let sym_coc = coordinate_cartesian_symbol_off_coordinate_symbol sym_coo in *)
(*       Coordinate_cartesian_symbol_v.is_x sym_coc *)
(*     end *)
(* ;; *)
...
(* : string *)
  =
 "./Figure_symbol_Querying_grandson_bare_for_symbol_Let_is_grandson_bare_v.ml"
);;

Camlparagraph_value_v.write "./" tag_cap;;

(* 1 Section_for_symbol_header_son_symbol_t.Let_is_grandson_bare *)
...
(* 1 Group_for_symbol_header_current_top_symbol_t.Let_is_grandson_bare *)

(* let is_x sym_geo = *)

(*   if not (is_coordinate_symbol_off_figure_symbol sym_geo) *)
(*   then false *)
(*   else *)
(*     begin *)
(*       let sym_coo = coordinate_symbol_off_figure_symbol sym_geo in *)
(*       Coordinate_symbol_v.is_x sym_coo *)
(*     end *)
(* ;; *)
...
(* : string list *)
=
["let is_cylindrical_rho sym_geo ="]
);;
 
(* Camlline_constant_function_symbol_t.Let_name_of_grandson_notleaf_equal *)
...
(* 2 Section_for_symbol_body_son_top_symbol_t.Is_one_grandson_bare_off_pattern_for_symbol *)
...
(* 1 Group_for_symbol_body_current_son_top_symbol_t.If_not_is_topson_begin_leaf_end *)
...
=
  ["  if not (is_coordinate_symbol_off_figure_symbol sym_geo)";
   ...
   "    begin";
   "      let sym_coo = coordinate_symbol_off_figure_symbol sym_geo in";
   "      Coordinate_symbol_v.is_cylindrical_rho sym_coo";
   "    end"]
);;
...
(* 2 Camlline_constant_pervasive_symbol_t.Then_false *)
