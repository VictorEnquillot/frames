...
testing "Camlline_duo_function_symbol_value_v
   Camlline_duo_function_value_u_figureset_symbol_figureset_typing.ml";;

(* toplevel 
   #use "Camlline_duo_function_value_u_figureset_symbol_figureset_typing.ml";;

*)

let nam_cod = "Camlline_duo_function_value_u_figureset_symbol_figureset_typing.ml";;
