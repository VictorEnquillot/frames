...
testing "Item_symbol_value_v
   Item_value_u_figureset_symbol_triangle_isoceles_upgrading.ml";;

(* toplevel 
   #use "Item_value_u_figureset_symbol_triangle_isoceles_upgrading.ml";;

*)

let nam_cod = "Item_value_u_figureset_symbol_triangle_isoceles_upgrading.ml";;
...
nam_fil
=
"./Triangle_isoceles_symbol_upgrading_grandson_v.ml"
);;
