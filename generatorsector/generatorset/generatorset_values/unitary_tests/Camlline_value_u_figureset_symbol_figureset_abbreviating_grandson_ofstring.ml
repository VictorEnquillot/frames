...
testing "Camlline_value_v with
   Camlline_value_u_figureset_symbol_figureset_abbreviating_grandson_ofstring.ml";;

(* toplevel 
   #use "Camlline_value_u_figureset_symbol_figureset_abbreviating_grandson_ofstring.ml";;

*)

let nam_cod = "Camlline_value_u_figureset_symbol_figureset_abbreviating_grandson_ofstring.ml";;
...
let nam_ite = "abbreviating_grandson_ofstring_for_symbol";;
...
(* 2 Camlparagraph_for_symbol_let_abbreviate_symbol_t.Let_abbreviate_grandson_ofstring *)
...
(* : string *)
  =
  "./Figure_symbol_abbreviating_grandson_ofstring_for_symbol_let_abbreviate_grandson_ofstring_v.ml"
);;

Camlparagraph_value_v.write "./" tag_cap;;

(* 1 Section_for_symbol_header_constant_symbol_t.Let_make_of_grandson_ofstring_nam_equal *)
...
(* 1 Group_for_symbol_header_current_son_top_symbol_t.Let_abbreviate_grandson_ofstring *)
...
(* : string list *)
=
 ["let x s = figure_symbol_of_coordinate_symbol (Coordinate_symbol_v.x s);;"]
);;
