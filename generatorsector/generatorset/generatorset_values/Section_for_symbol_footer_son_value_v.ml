(** {3 Section_for_symbol_footer_son_value_v}  *)
...
let documentation () = 
  [
   "Needs : FGNR:";
   "Current : VGNR:Section_for_symbol_footer_son_value_v";
...
let make sym_sfs soi_sec =
  ...
  | Section_for_symbol_footer_son_symbol_t.Section_for_symbol_footer_son_empty ->
      Section_for_symbol_footer_son_value_t.Section_for_symbol_footer_son_empty
;;
...
let string_list_off_section_for_symbol_footer_son_tag tag_sfs =
  []
;;

let group_value_list_off_section_for_symbol_footer_son_value val_sfs =
  match val_sfs with
  | Section_for_symbol_footer_son_value_t.Section_for_symbol_footer_son_empty -> []
;;
