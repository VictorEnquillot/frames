(** {3 Group_for_any_footer_son_value_v}  *)
...
let documentation () = 
  [
   "Needs : FGNR:";
   "Current : VGNR:Group_for_any_footer_son_value_v";
...
let make sym_gft soi_gro =
  ...
  | Group_for_any_footer_son_symbol_t.Group_for_any_footer_son_empty ->
      Group_for_any_footer_son_value_t.Group_for_any_footer_son_empty
;;
...
let string_list_off_group_for_any_footer_son_tag tag_gft =
  []
;;

let camlline_value_list_off_group_for_any_footer_son_value val_ghc =
  match val_ghc with
  | Group_for_any_footer_son_value_t.Group_for_any_footer_son_empty -> []
;;
