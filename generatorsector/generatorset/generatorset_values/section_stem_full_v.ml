...
let make sym_sss soi_sec =
  ...
  | Section_stem_symbol_t.Leaf_1 ->
      Section_stem_value_t.Leaf_1 val_gro_l

  | Section_stem_symbol_t.Leaf_2 ->
      Section_stem_value_t.Leaf_2 val_gro_l

  | Section_stem_symbol_t.Leaf_3 ->
      Section_stem_value_t.Leaf_3 val_gro_l

  | Section_stem_symbol_t.Leaf_4 ->
      Section_stem_value_t.Leaf_4 val_gro_l

  | Section_stem_symbol_t.Leaf_5 ->
      Section_stem_value_t.Leaf_5 val_gro_l

  | Section_stem_symbol_t.Leaf_6 ->
      Section_stem_value_t.Leaf_6 val_gro_l
;;
...
let group_value_list_off_section_stem_value val_sss =
  match val_sss with
  | Section_stem_value_t.Leaf_1 val_gro_l -> val_gro_l
	
  | Section_stem_value_t.Leaf_2 val_gro_l -> val_gro_l

  | Section_stem_value_t.Leaf_3 val_gro_l -> val_gro_l

  | Section_stem_value_t.Leaf_4 val_gro_l -> val_gro_l

  | Section_stem_value_t.Leaf_5 val_gro_l -> val_gro_l

  | Section_stem_value_t.Leaf_6 val_gro_l -> val_gro_l
;;
