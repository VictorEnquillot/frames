...
let symbol_of_formula for_smb =
  match for_smb with
  | Section_stem_builder_formula_t.Let_builder_tag_list_off_top_formula _ -> 
      Section_stem_builder_symbol_t.Let_builder_tag_list_off_top_formula
...
let name for_smb = 
  ...
  Section_stem_builder_symbol_v.name sym_smb
;;
(* ***

let string_off for_smb =
  let sym_smb = symbol_of_formula for_smb in
  Section_stem_builder_symbol_v.string_off sym_smb
;;

let longname for_smb =
  Format.sprintf "Section_stem_builder_formula_t.%s" 
...
let build_n_store sym_smb soi_sec =
  ...
  let oct_smb = 
    Section_stem_builder_tag_v.section_stem_builder_octtup_off_section_stem_builder_tag 
      tag_smb 
  in
...
let make sym_smb soi_sec =
  ...
  match sym_smb with 
  | Section_stem_builder_symbol_t.Leaf_1 -> 
      Section_stem_builder_formula_t.Leaf_1 tag_gro_l
...
let group_tag_list_off_section_stem_builder_formula for_smb =
  match for_smb with
  | Section_stem_builder_formula_t.Leaf_1 tag_cap_l -> 
      tag_cap_l
...
let group_tag_list_off_section_stem_builder_tag tag_smb =
  let for_smb = retrieve tag_smb in
  group_tag_list_off_section_stem_builder_formula for_smb
;; 

let camlline_tag_list_off_section_stem_builder_formula for_smb =
  let tag_gro_l = 
    group_tag_list_off_section_stem_builder_formula 
      for_smb 
  in
...
let camlline_tag_list_off_section_stem_builder_tag tag_smb =
  let for_smb = retrieve tag_smb in
  camlline_tag_list_off_section_stem_builder_formula for_smb
;; 

(** {6 Iterating_for_formula} *)

let map f_of_tag_gro for_smb = 
  let tag_gro_l = group_tag_list_off_section_stem_builder_formula for_smb in
...
let map2 f_of_tag_gro for_smb_1 for_smb_2  = 
  let tag_gro_l_1 = group_tag_list_off_section_stem_builder_formula for_smb_1 in
  let tag_gro_l_2 = group_tag_list_off_section_stem_builder_formula for_smb_2 in
