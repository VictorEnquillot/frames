...
let documentation () = 
  [
   "Needs : IGNR:";
   "Current : FGNR:Section_for_any_body_son_top_formula_v";
   "Needed-by : FGNR:";
...
let symbol_of_formula for_sst = 
  match for_sst with
  | Section_for_any_body_son_top_formula_t.Section_for_any_body_son_top_empty ->
      Section_for_any_body_son_top_symbol_t.Section_for_any_body_son_top_empty
;;
...
let name for_sst =
  ...
  Section_for_any_body_son_top_symbol_v.name sym_sst
;;
(* ***
let longname for_sst =
  let sym_sst = symbol_of_formula for_sst in
  Section_for_any_body_son_top_symbol_v.longname sym_sst
;;

let string_off for_sst =
  let sym_sst = symbol_of_formula for_sst in
  Section_for_any_body_son_top_symbol_v.string_off sym_sst
;;
...
let group_tag_list_off_section_for_any_body_son_top_formula for_sst = 
  match for_sst with
  | Section_for_any_body_son_top_formula_t.Section_for_any_body_son_top_empty ->
      []
;;
...
let camlline_tag_list_off_section_node_formula for_sst =
  let tag_gro_l = 
    group_tag_list_off_section_for_any_body_son_top_formula
      for_sst
  in
...
let map f for_sst = 
  let tag_gro_l = group_tag_list_off_section_for_any_body_son_top_formula for_sst in
...
let map2 f for_sst_1 for_sst_2  = 
  let tag_gro_l_1 = group_tag_list_off_section_for_any_body_son_top_formula for_sst_1 in
  let tag_gro_l_2 = group_tag_list_off_section_for_any_body_son_top_formula for_sst_2 in
