...
(* group_for_formula_body_top_builder_data : documentation_list_for_formula *)
  [
   ...
   "Remark : It is a CT_Node and BT_Stem type";
 ]
;;
...
(** {6 Building_and_storing_} *) (* ???? *)

let build_n_store sym_cur soi_top =

  let sym_bui_l =
    Top_interface_v.make
      sym_cur
  in
  let soi_bui_l =               (* Sole_index_datastructure_of_datastructure_of_sole_index *)
