...
let symbol_of_formula for_sss =
  ...
  | Section_stem_formula_t.Leaf_3 _ -> 
      Section_stem_symbol_t.Leaf_3

  | Section_stem_formula_t.Leaf_4 _ -> 
      Section_stem_symbol_t.Leaf_4

  | Section_stem_formula_t.Leaf_5 _ -> 
      Section_stem_symbol_t.Leaf_5

  | Section_stem_formula_t.Leaf_6 _ -> 
      Section_stem_symbol_t.Leaf_6

  | Section_stem_formula_t.Leaf_7_ -> 
      Section_stem_symbol_t.Leaf_7

  | Section_stem_formula_t.Leaf_8 _ -> 
      Section_stem_symbol_t.Leaf_8
;;
...
let make sym_sss soi_sec =
  ...
  | Section_stem_symbol_t.Leaf_3 _ -> 
      Section_stem_formula_t.Leaf_3 tag_gro_l

  | Section_stem_symbol_t.Leaf_4 -> 
      Section_stem_formula_t.Leaf_4 tag_gro_l

  | Section_stem_symbol_t.Leaf_5 -> 
      Section_stem_formula_t.Leaf_5 tag_gro_l

  | Section_stem_symbol_t.Leaf_6 _ -> 
      Section_stem_formula_t.Leaf_6 tag_gro_l

  | Section_stem_symbol_t.Leaf_7 -> 
      Section_stem_formula_t.Leaf_7 tag_gro_l

  | Section_stem_symbol_t.Leaf_8 _ -> 
      Section_stem_formula_t.Leaf_8 tag_gro_l
...
let group_tag_list_off_section_stem_formula for_sss =
  ...
  | Section_stem_formula_t.Leaf_3 tag_cap_l -> 
      tag_cap_l

  | Section_stem_formula_t.Leaf_4 tag_cap_l -> 
      tag_cap_l

  | Section_stem_formula_t.Leaf_5 tag_cap_l -> 
      tag_cap_l

  | Section_stem_formula_t.Leaf_6 tag_cap_l -> 
      tag_cap_l

  | Section_stem_formula_t.Leaf_7 tag_cap_l -> 
      tag_cap_l

  | Section_stem_formula_t.Leaf_8 tag_cap_l -> 
      tag_cap_l
