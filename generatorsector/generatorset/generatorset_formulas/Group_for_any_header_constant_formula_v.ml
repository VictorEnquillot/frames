(** {3 Group_for_any_header_constant_formula_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Needs : IGNR:Group_for_any_header_constant_interface_v";
   "Current : FGNR:Group_for_any_header_constant_formula_v";
...
let symbol_of_formula for_ghc =
  match for_ghc with
  | Group_for_any_header_constant_formula_t.Let_documentation _ -> 
      Group_for_any_header_constant_symbol_t.Let_documentation

  | Group_for_any_header_constant_formula_t.Let_nam_cod_equal _ -> 
      Group_for_any_header_constant_symbol_t.Let_nam_cod_equal

  | Group_for_any_header_constant_formula_t.Type_et_any_equal _ -> 
...
let longname for_ghc =
  Format.sprintf "Group_for_any_header_constant_formula_t.%s" 
...
let build_n_store sym_ghc soi_gro =
  let sym_cal_l = Group_for_any_header_constant_interface_v.make sym_ghc in
...
let make sym_ghc soi_gro =
  ...
  match sym_ghc with 
  | Group_for_any_header_constant_symbol_t.Let_documentation -> 
      Group_for_any_header_constant_formula_t.Let_documentation tag_cal_l

  | Group_for_any_header_constant_symbol_t.Let_nam_cod_equal -> 
      Group_for_any_header_constant_formula_t.Let_nam_cod_equal tag_cal_l

  | Group_for_any_header_constant_symbol_t.Type_et_any_equal -> 
      Group_for_any_header_constant_formula_t.Type_et_any_equal tag_cal_l
;;
...
let camlline_tag_list_off_group_for_any_header_constant_formula for_ghc =
  match for_ghc with
  | Group_for_any_header_constant_formula_t.Let_documentation tag_cal_l -> 
      tag_cal_l
...
let camlline_tag_list_off_group_for_any_header_constant_tag tag_ghc =
  let for_ghc = retrieve tag_ghc in
  camlline_tag_list_off_group_for_any_header_constant_formula for_ghc
;; 

(** {6 Iterating_for_formula_for_any_header_constant.} *)

let map f_of_tag_cal for_ghc = 
  let tag_cal_l = camlline_tag_list_off_group_for_any_header_constant_formula for_ghc in
...
let map2 f_of_tag_cal for_ghc_1 for_ghc_2  = 
  let tag_cal_l_1 = camlline_tag_list_off_group_for_any_header_constant_formula for_ghc_1 in
  let tag_cal_l_2 = camlline_tag_list_off_group_for_any_header_constant_formula for_ghc_2 in
