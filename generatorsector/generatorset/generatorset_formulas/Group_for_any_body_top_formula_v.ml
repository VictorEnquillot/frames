(** {3 Group_for_any_body_top_formula_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Needs : IGNR:Group_for_any_body_top_interface_v";
   "Current : FGNR:Group_for_any_body_top_formula_v";
...
let symbol_of_formula for_gbt =
  match for_gbt with
  | Group_for_any_body_top_formula_t.Sprintf_for_any_fullname _ ->
     Group_for_any_body_top_symbol_t.Sprintf_for_any_fullname
  | Group_for_any_body_top_formula_t.Sprintf_for_any_longname _ ->
...
let longname for_gbt =
  Format.sprintf "Group_for_any_body_top_formula_t.%s" 
...
let build_n_store sym_gbt soi_gro =
  let sym_cal_l = Group_for_any_body_top_interface_v.make sym_gbt in
...
let make sym_gbt soi_gro =
  ...
  match sym_gbt with 
  | Group_for_any_body_top_symbol_t.Sprintf_for_any_fullname ->
     Group_for_any_body_top_formula_t.Sprintf_for_any_fullname tag_cal_l
  | Group_for_any_body_top_symbol_t.Sprintf_for_any_longname ->
     Group_for_any_body_top_formula_t.Sprintf_for_any_longname tag_cal_l
...
let camlline_tag_list_off_group_for_any_body_top_formula for_gbt =
  match for_gbt with
  | Group_for_any_body_top_formula_t.Sprintf_for_any_fullname tag_cal_l -> tag_cal_l
  | Group_for_any_body_top_formula_t.Sprintf_for_any_longname tag_cal_l -> tag_cal_l

;;

let camlline_tag_list_off_group_for_any_body_top_tag tag_gbt =
  let for_gbt = retrieve tag_gbt in
  camlline_tag_list_off_group_for_any_body_top_formula for_gbt
;; 

(** {6 Iterating_for_formula_for_any_body_top.} *)

let map f_of_tag_cal for_gbt = 
  let tag_cal_l = camlline_tag_list_off_group_for_any_body_top_formula for_gbt in
...
let map2 f_of_tag_cal for_gbt_1 for_gbt_2  = 
  let tag_cal_l_1 = camlline_tag_list_off_group_for_any_body_top_formula for_gbt_1 in
  let tag_cal_l_2 = camlline_tag_list_off_group_for_any_body_top_formula for_gbt_2 in
