...
let symbol_of_formula for_ccc =
  ...
  | Camlline_stem_formula_t.Leaf_2 _ -> 
      Camlline_stem_symbol_t.Leaf_2

  | Camlline_stem_formula_t.Leaf_3 _ -> 
      Camlline_stem_symbol_t.Leaf_3

  | Camlline_stem_formula_t.Leaf_4 _ -> 
      Camlline_stem_symbol_t.Leaf_4

  | Camlline_stem_formula_t.Leaf_5 _ -> 
      Camlline_stem_symbol_t.Leaf_5

  | Camlline_stem_formula_t.Leaf_6 _ -> 
      Camlline_stem_symbol_t.Leaf_6

  | Camlline_stem_formula_t.Leaf_7 _ -> 
      Camlline_stem_symbol_t.Leaf_7

  | Camlline_stem_formula_t.Leaf_8 _ -> 
      Camlline_stem_symbol_t.Leaf_8

  | Camlline_stem_formula_t.Leaf_9 _ -> 
      Camlline_stem_symbol_t.Leaf_9

  | Camlline_stem_formula_t.Leaf_10 _ -> 
      Camlline_stem_symbol_t.Leaf_10
;;
...
let build_n_store sym_ccc soi_cal =
  ...
  let sym_ent_cur = 
	...
	(Format.sprintf "None of them for Camlline >%s< when idx_gro = %i" 
	   (Camlline_stem_symbol_v.name sym_ccc) idx_gro
	)
	"Check"
  in
...
let make sym_ccc soi_cal =
  ...
  | Camlline_stem_symbol_t.Leaf_2 -> 
      Camlline_stem_formula_t.Leaf_2 tag_ent_l

  | Camlline_stem_symbol_t.Leaf_3 _ -> 
      Camlline_stem_formula_t.Leaf_3 tag_ent_l

  | Camlline_stem_symbol_t.Leaf_4 -> 
      Camlline_stem_formula_t.Leaf_4 tag_ent_l

  | Camlline_stem_symbol_t.Leaf_5 -> 
      Camlline_stem_formula_t.Leaf_5 tag_ent_l

  | Camlline_stem_symbol_t.Leaf_6 -> 
      Camlline_stem_formula_t.Leaf_6 tag_ent_l

  | Camlline_stem_symbol_t.Leaf_7 -> 
      Camlline_stem_formula_t.Leaf_7 tag_ent_l

  | Camlline_stem_symbol_t.Leaf_8 -> 
      Camlline_stem_formula_t.Leaf_8 tag_ent_l

  | Camlline_stem_symbol_t.Leaf_9 -> 
      Camlline_stem_formula_t.Leaf_9 tag_ent_l

  | Camlline_stem_symbol_t.Leaf_10 -> 
      Camlline_stem_formula_t.Leaf_10 tag_ent_l
...
let entity_tag_list_off_camlline_stem_formula for_ccc =
  match for_ccc with
  | Camlline_stem_formula_t.Leaf_1 tag_ent_l ->       tag_ent_l

  | Camlline_stem_formula_t.Leaf_2 tag_ent_l ->       tag_ent_l

  | Camlline_stem_formula_t.Leaf_3 tag_ent_l ->       tag_ent_l

  | Camlline_stem_formula_t.Leaf_4 tag_ent_l ->       tag_ent_l

  | Camlline_stem_formula_t.Leaf_5 tag_ent_l ->       tag_ent_l

  | Camlline_stem_formula_t.Leaf_6 tag_ent_l ->       tag_ent_l

  | Camlline_stem_formula_t.Leaf_7 tag_ent_l ->      tag_ent_l

  | Camlline_stem_formula_t.Leaf_8 tag_ent_l ->      tag_ent_l

  | Camlline_stem_formula_t.Leaf_9 tag_ent_l ->      tag_ent_l

  | Camlline_stem_formula_t.Leaf_10 tag_ent_l ->      tag_ent_l
;;
