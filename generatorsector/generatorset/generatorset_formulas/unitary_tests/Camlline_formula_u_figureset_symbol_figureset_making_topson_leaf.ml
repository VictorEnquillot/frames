...
testing "Camlline_formula_v with
   Camlline_formula_u_figureset_symbol_figureset_making_topson_leaf.ml";;

(* toplevel 
   #use "Camlline_formula_u_figureset_symbol_figureset_making_topson_leaf.ml";;

*)

let nam_cod = "Camlline_formula_u_figureset_symbol_figureset_making_topson_leaf.ml";;
...
(*   | _ -> failwith "Not_a_topson_leaf:Figureset_symbol_v.ml:make" *)
(*;; *)
...
Camlparagraph_formula_t.Camlparagraph_for_symbol_formula
   (Camlparagraph_for_symbol_formula_t.Camlparagraph_for_symbol_let_formula
     (Camlparagraph_for_symbol_let_formula_t.Camlparagraph_for_symbol_let_argument_formula
       (Camlparagraph_for_symbol_let_argument_formula_t.Let_make_of_topson_leaf_nam_s_equal_for_symbol
	  tag_sec_l)))
);;
...
test_number 15 (
tag_gro_l
(* : Section_formula_t.section_formula *)
=
...
Section_formula_t.Section_for_symbol_formula
  (Section_for_symbol_formula_t.Section_for_symbol_header_formula
	...
	(Section_for_symbol_header_constant_formula_t.Let_make_of_topson_leaf_nam_s_equal
	   tag_gro_l)))
);;
  ...
  Group_formula_t.Group_for_symbol_formula
   (Group_for_symbol_formula_t.Group_for_symbol_header_formula
     (Group_for_symbol_header_formula_t.Group_for_symbol_header_constant_formula
       (Group_for_symbol_header_constant_formula_t.Let_make_of_topson_leaf_nam_s_equal
         [(Camlline_symbol_t.Camlline_constant_symbol
            (Camlline_constant_symbol_t.Camlline_constant_function_symbol
              Camlline_constant_function_symbol_t.Let_make_of_topson_leaf_nam_s_equal),
           [1; 1; 1; 2; 12; 1; 2; 1; 7; 2])])))
...
=
 [(Entity_symbol_t.Entity_fictive_symbol
    ...
    [1; 1; 2; 2; 2; 12; 1; 2; 1; 7; 2])]
);;

(* Section_for_symbol_footer_top_symbol_t.Pipe_underscore_failwith_not_a_topson_leaf *)

(*   | _ -> *)
(*  failwith "Not_a_topson_leaf:Figureset_symbol_v.ml:make" *)
(*;; *)
...
=
  [(Camlline_symbol_t.Camlline_constant_symbol
   ...
   (Camlline_symbol_t.Camlline_uno_symbol
     (Camlline_uno_symbol_t.Camlline_uno_function_symbol
       (Camlline_uno_function_symbol_t.Camlline_uno_function_symbol_symbol
         Camlline_uno_function_symbol_symbol_t.Space_failwith_not_a_topson_leaf_Et_symbol_make)),
    [2; 1; 3; 2; 12; 1; 2; 1; 7; 2]);
   (Camlline_symbol_t.Camlline_constant_symbol
     (Camlline_constant_symbol_t.Camlline_constant_pervasive_symbol
       Camlline_constant_pervasive_symbol_t.Double_semicolon),
    [3; 1; 3; 2; 12; 1; 2; 1; 7; 2])]
);;
