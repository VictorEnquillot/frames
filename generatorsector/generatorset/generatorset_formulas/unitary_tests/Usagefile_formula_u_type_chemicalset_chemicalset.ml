...
testing "Usagefile_formula_u_type_chemicalset_chemicalset.ml";;

(* toplevel 
   #use "Usagefile_formula_u_type_chemicalset_chemicalset.ml";;
*)
...
(* : Usagefile_symbol_v.Usagefile_symbol_t.usagefile_symbol * Tag_t.Sole_index_t.sole_index *)
  =
(Contentfile_symbol_t.Type_alone, [1; 1; 1; 1])
);;
...
(* : Usagefile_symbol_v.Usagefile_symbol_t.usagefile_symbol * Tag_t.Sole_index_t.sole_index *)
  =
(Usagefile_symbol_t.Implementation, [1; 1; 1; 1; 1])
);;
...
=
[(Item_symbol_v.heading, [1; 1; 1; 1; 1; 1]);
 (Item_symbol_v.documenting, [2; 1; 1; 1; 1; 1]);
 (Item_symbol_v.typing, [3; 1; 1; 1; 1; 1]);
 (Item_symbol_v.ending, [4; 1; 1; 1; 1; 1])]
);;
