...
testing "Item_all_topsons_making_formula_v with 
   Item_all_topsons_making_formula_u_figureset_symbol_figureset.ml";;

(* toplevel 
   #use "Item_all_topsons_making_formula_u_figureset_symbol_figureset.ml";;

*)

let nam_cod = "Item_all_topsons_making_formula_u_figureset_symbol_figureset";;
