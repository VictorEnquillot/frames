...
(* toplevel 
   #use "Camlline_formula_u_figureset_symbol_triangle_naming.ml";;

*)

let nam_cod = "Camlline_formula_u_figureset_symbol_triangle_naming.ml";;
  ...
  [(Camlline_symbol_t.Camlline_for_any_symbol
     (Camlline_for_any_symbol_t.Camlline_for_any_duo_symbol
       (Camlline_for_any_duo_symbol_t.Camlline_for_any_duo_son_top_symbol
         Camlline_for_any_duo_son_top_symbol_t.Pipe_et_any_tdot_es_any_space_ac_as_arrow)),
    [1; 1; 2; 2; 3; 1; 2; 2; 7; 2]);
   (Camlline_symbol_t.Camlline_for_symbol_symbol
     (Camlline_for_symbol_symbol_t.Camlline_for_symbol_uno_symbol
       (Camlline_for_symbol_uno_symbol_t.Camlline_for_symbol_uno_son_symbol
         Camlline_for_symbol_uno_son_symbol_t.Space2_es_symbol_vdot_name_sym_as)),
    [2; 1; 2; 2; 3; 1; 2; 2; 7; 2])]
);;
...
=
  [(
     (Entity_symbol_t.Entity_proper "triangle_isoceles"),
    [1; 1; 1; 2; 2; 3; 1; 2; 2; 7; 2]);
   (
     (Entity_symbol_t.Entity_proper "triangle"),
    [2; 1; 1; 2; 2; 3; 1; 2; 2; 7; 2])]
);;
...
(*     Triangle_scalene_symbol_v.name sym_trs *)
...
=
  [(
     (Entity_symbol_t.Entity_proper "triangle_scalene"),
    [1; 1; 2; 2; 2; 3; 1; 2; 2; 7; 2]);
   (
     (Entity_symbol_t.Entity_proper "triangle"),
    [2; 1; 2; 2; 2; 3; 1; 2; 2; 7; 2])]
);;

(* 2 Camlline_duo_function_symbol_t.Pipe_Et_symbol_tdot_Es_symbol_space_ass_arrow *)
(*     Triangle_scalene_symbol_v.name sym_tis *)
