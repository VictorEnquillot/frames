...
(* toplevel 
   #use "Camlline_formula_u_figureset_symbol_figureset_fullnaming.ml";;

*)

let nam_cod = "Camlline_formula_u_figureset_symbol_figureset_fullnaming.ml";;
...
let nam_ite = "Fullnaming_for_symbol";;
...
(* 2 Camlparagraph_for_symbol_let_argument_symbol_t.Let_fullname_argument_for_symbol *)
(* let fullname sym_geo = *)
(*   Format.sprintf "%s \"%s\"" (longname sym_geo) (string_off sym_geo) *)
(* ;; *)
   ...
   (Section_symbol_t.Section_for_symbol_symbol
     (Section_for_symbol_symbol_t.Section_for_symbol_body_symbol
       (Section_for_symbol_body_symbol_t.Section_for_symbol_body_top_symbol
         Section_for_symbol_body_top_symbol_t.Sprintf_for_symbol_fullname)),
    [2; 2; 6; 1; 2; 1; 7; 2]);
...
(* 1 Section_for_symbol_header_top_symbol_t.Let_fullname_argument_equal *)
(* let fullname sym_geo = *)
  ...
  [(Group_symbol_t.Group_for_symbol_symbol
     (Group_for_symbol_symbol_t.Group_for_symbol_header_symbol
       (Group_for_symbol_header_symbol_t.Group_for_symbol_header_top_symbol
         Group_for_symbol_header_top_symbol_t.Let_fullname_argument_equal)),
    [1; 1; 2; 6; 1; 2; 1; 7; 2])]
);;
...
(* 1 Group_for_symbol_header_top_symbol_t.Let_fullname_argument_equal *)
(* let fullname sym_geo = *)
...
(* 2 Section_for_symbol_body_top_symbol_t.Sprintf_for_symbol_fullname *)
(*   Format.sprintf "%s \"%s\"" (longname sym_geo) (string_off sym_geo) *)
  ...
  [(Group_symbol_t.Group_for_symbol_symbol
     (Group_for_symbol_symbol_t.Group_for_symbol_body_symbol
       (Group_for_symbol_body_symbol_t.Group_for_symbol_body_top_symbol
         Group_for_symbol_body_top_symbol_t.Sprintf_for_symbol_fullname)),
    [1; 2; 2; 6; 1; 2; 1; 7; 2])]
);;

(* 1 Group_for_symbol_body_top_symbol_t.Sprintf_for_symbol_fullname *)
(*   Format.sprintf "%s \"%s\"" (longname sym_geo) (string_off sym_geo) *)
 ...
 [(Camlline_symbol_t.Camlline_for_symbol_symbol
     (Camlline_for_symbol_symbol_t.Camlline_for_symbol_uno_symbol
       (Camlline_for_symbol_uno_symbol_t.Camlline_for_symbol_uno_top_symbol
         Camlline_for_symbol_uno_top_symbol_t.Space_sprintf_for_symbol_fullname)),
    [1; 1; 2; 2; 6; 1; 2; 1; 7; 2])]
);;
...
(* 1 Camlline_for_symbol_uno_top_symbol_t.Space_sprintf_for_symbol_fullname *)
(*   Format.sprintf "%s \"%s\"" (longname sym_geo) (string_off sym_geo) *)
