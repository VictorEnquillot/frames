...
testing "Camlline_formula_v with 
   Camlline_formula_u_figureset_symbol_figureset_naming.ml";;

(* toplevel 
   #use "Camlline_formula_u_figureset_symbol_figureset_naming.ml";;

*)

let nam_cod = "Camlline_formula_u_figureset_symbol_figureset_naming";;
...
let sym_ent_tsb_l = Entity_topson_leaf_bare_symbol_list_by_entity_tritup_provider_v.provide tri_enp;;
...
let sym_ent_tso_l = Entity_topson_leaf_ofstring_symbol_list_by_entity_tritup_provider_v.provide tri_enp;;
...
(* 1 Item_for_symbol_all_topsons_symbol_t.Naming_for_symbol *)
...
=
  Item_formula_t.Item_for_symbol_formula
   (Item_for_symbol_formula_t.Item_for_symbol_all_topsons_formula
     (Item_for_symbol_all_topsons_formula_t.Naming_for_symbol
	tag_cap_l ))
);;
  ...
  [(Group_symbol_t.Group_for_symbol_symbol
     (Group_for_symbol_symbol_t.Group_for_symbol_body_symbol
       (Group_for_symbol_body_symbol_t.Group_for_symbol_body_son_top_symbol
         Group_for_symbol_body_son_top_symbol_t.Pipe_upgrade_name_leaf_bare_function)),
    [1; 2; 2; 3; 1; 2; 1; 7; 2])]
);;

(* 1 Group_for_symbol_body_son_top_symbol_t.Pipe_upgrade_name_leaf_bare_function *)
...
let dec_cdf =Camlline_for_symbol_duo_son_top_bare_tag_v.camlline_for_symbol_duo_son_top_bare_dectup_off_camlline_for_symbol_duo_son_top_bare_tag tag_cdf;;
let sym_ent_cur = Tools_ignr_v.entity_topson_leaf_bare_symbol_list_of_dectup dec_cdf;;
