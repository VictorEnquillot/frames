...
(* toplevel 
   #use "Contentfile_formula_u_figureset_tag_triangle_isoceles.ml";;

*)

let nam_cod = "Contentfile_formula_u_figureset_tag_triangle_isoceles.ml";;
...
test_number 4 (
for_cat 
(* : Category_formula_t.category_formula *)
=
...
=
  [(Usagefile_symbol_t.Implementation, [1; 2; 3; 8; 2]);
   (Usagefile_symbol_t.Interface, [2; 2; 3; 8; 2])]
);;
