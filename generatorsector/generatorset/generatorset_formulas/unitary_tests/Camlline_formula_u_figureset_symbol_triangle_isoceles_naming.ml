...
(* toplevel 
   #use "Camlline_formula_u_figureset_symbol_triangle_isoceles_naming.ml";;

*)

let nam_cod = "Camlline_formula_u_figureset_symbol_triangle_isoceles_naming.ml";;
...
=
  Item_formula_t.Item_all_topsons_formula
   (Item_all_topsons_formula_t.Item_all_topsons_for_symbol_formula
     (Item_all_topsons_for_symbol_formula_t.Naming_for_symbol
	tag_cap_l ))
);;
...
=
  [(Entity_symbol_t.Entity_fictive_symbol
     (Entity_fictive_symbol_t.Entity_fictive_nullary_symbol
       (Entity_fictive_nullary_symbol_t.Bare
         "triangle_isoceles_equilateral")),
    [1; 1; 1; 2; 2; 3; 1; 2; 3; 7; 2]);
   (
     (Entity_symbol_t.Entity_proper "triangle_isoceles"),
    [2; 1; 1; 2; 2; 3; 1; 2; 3; 7; 2])]
);;

(* 4 Group_for_symbol_body_son_top_symbol_t.Pipe_upgrade_name_leaf_bare_function *)
(* | Triangle_isoceles_symbol_t.Triangle_isoceles_obtuse -> "Triangle_isoceles_obtuse" *)
...
=
  [(Entity_symbol_t.Entity_fictive_symbol
     (Entity_fictive_symbol_t.Entity_fictive_nullary_symbol
       (Entity_fictive_nullary_symbol_t.Bare
         "triangle_isoceles_obtuse")),
    [1; 1; 4; 2; 2; 3; 1; 2; 3; 7; 2]);
   (
     (Entity_symbol_t.Entity_proper "triangle_isoceles"),
    [2; 1; 4; 2; 2; 3; 1; 2; 3; 7; 2])]
);;
