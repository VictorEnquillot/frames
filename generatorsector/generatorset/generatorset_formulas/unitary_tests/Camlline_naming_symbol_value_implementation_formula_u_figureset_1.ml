...
testing "Camlline_naming_symbol_value_implementation_formula_u_figureset_1.ml";;

(* toplevel 
   #use "Camlline_naming_symbol_value_implementation_formula_u_figureset_1.ml";;
*)
...
let tag_enp = Doublet_list_v.find_if_left (fun e -> Entity_symbol_v.string_off e = "figureset") for_cat;;
...
(* :  Tag_t.tag list *) 
  =
[(
   (Entity_symbol_t.Sonentity "triangle"),
  [1; 2; 2; 4; 1; 2; 1; 1; 2]);
 (
   (Entity_symbol_t.Topentity "figureset"),
  [2; 2; 2; 4; 1; 2; 1; 1; 2])]
);;
