...
(* 1 Camlline_for_any_duo_son_top_symbol_t.Pipe_et_any_tdot_es_any_space_ac_as_arrow_ac_as *)
(*  | Figureset_symbol_t.Triangle_symbol sym_tri -> sym_tri *)
...
(* 2 Camlline_for_any_duo_son_top_symbol_t.Pipe_print_fatal_error_es_any_off_et_any_4_lines *)
(* | sym_geo -> Error_messages_v.print_fatal_error *)
(*     nam_cod "triangle_symbol_off_figureset_symbol" *)
(*     "Triangle_symbol" *)
(*     (name sym_geo) "check" *)
