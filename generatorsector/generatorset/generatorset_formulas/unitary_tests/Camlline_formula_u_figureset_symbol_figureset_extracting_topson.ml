...
(* toplevel 
   #use "Camlline_formula_u_figureset_symbol_figureset_extracting_topson.ml";;

*)

let nam_cod = "Camlline_formula_u_figureset_symbol_figureset_extracting_topson.ml";;
...
=
  [(Entity_symbol_t.Entity_proper "figureset", [1; 7; 2]);
   (Entity_symbol_t.Entity_proper "coordinate", [2; 7; 2]);
   (Entity_symbol_t.Entity_proper "coordinate_cartesian", [3; 7; 2]);
   (Entity_symbol_t.Entity_proper "coordinate_cylindrical", [4; 7; 2]);
   (Entity_symbol_t.Entity_proper "coordinate_polar", [5; 7; 2]);
   (Entity_symbol_t.Entity_proper "coordinate_spherical", [6; 7; 2]);
   (Entity_symbol_t.Entity_proper "triangle", [7; 7; 2]);
   (Entity_symbol_t.Entity_proper "triangle_isoceles", [8; 7; 2]);
   (Entity_symbol_t.Entity_proper "triangle_scalene", [9; 7; 2])]
...
let nam_ite = "extracting_topson_for_symbol";;
...
(*   | Figureset_symbol_t.Coordinate_symbol sym_coo -> sym_coo *)
(*   | sym_geo -> Error_messages_v.print_fatal_error *)
(*       nam_cod "coordinate_symbol_off_figureset_symbol" *)
(*       "Coordinate_symbol" *)
(*       (name sym_geo) "check" *)
(* ;; *)

(* let triangle_symbol_off_figureset_symbol = function *)
(*   | Figureset_symbol_t.Triangle_symbol sym_tri -> sym_tri *)
(*   | sym_geo -> Error_messages_v.print_fatal_error *)
(*       nam_cod "triangle_symbol_off_figureset_symbol" *)
(*       "Triangle_symbol" *)
(*       (name sym_geo) "check" *)
(* ;; *)

let tag_cap_l = Item_formula_v.camlparagraph_tag_list_off_item_tag tag_ite;;
let tag_cal_l = Item_formula_v.camlline_tag_list_off_item_tag tag_ite;;
...
for_ite
=
 Item_formula_t.Item_each_topson_notleaf_formula 
  (Item_each_topson_notleaf_formula_t.Item_each_topson_notleaf_for_symbol_formula
     (Item_each_topson_notleaf_for_symbol_formula_t.Extracting_topson_for_symbol
	tag_cap_l ))
);;


let tag_ite_l = Usagefile_formula_v.item_tag_list_off_usagefile_formula for_usf;;
let for_ite_l = List.map Item_formula_v.retrieve tag_ite_l;;

let tag_cal_l = Item_formula_v.camlline_tag_list_off_item_formula for_ite;;

(* 2 Camlparagraph_for_symbol_let_match_symbol_t.Let_name_equal_function_for_symbol *)

(* let coordinate_symbol_off_figureset_symbol = function *)
(*   | Figureset_symbol_t.Coordinate_symbol sym_tri -> sym_tri *)
(*   | sym_geo -> Error_messages_v.print_fatal_error *)
(*       nam_cod "coordinate_symbol_off_figureset_symbol" *)
(*       "Coordinate_symbol" *)
(*       (name sym_geo) "check" *)
...
(* 1 Section_for_symbol_header_son_top_symbol_t.Let_topson_notleaf_symbol_off_top_symbol *)
 ...
 [(Camlline_symbol_t.Camlline_for_any_symbol
     (Camlline_for_any_symbol_t.Camlline_for_any_duo_symbol
       (Camlline_for_any_duo_symbol_t.Camlline_for_any_duo_son_top_symbol
         Camlline_for_any_duo_son_top_symbol_t.Let_es_any_off_et_any_equal_function)),
    [1; 1; 1; 2; 7; 1; 2; 1; 7; 2])]
);;
...
(* : Camlline_symbol_t.camlline_symbol Tag_t.tag list *)
  ...
  [(Camlline_symbol_t.Camlline_for_any_symbol
     (Camlline_for_any_symbol_t.Camlline_for_any_duo_symbol
       (Camlline_for_any_duo_symbol_t.Camlline_for_any_duo_son_top_symbol
         Camlline_for_any_duo_son_top_symbol_t.Pipe_et_any_tdot_es_any_space_ac_as_arrow_ac_as)),
    [1; 1; 2; 2; 7; 1; 2; 1; 7; 2]);
   (Camlline_symbol_t.Camlline_for_any_symbol
     (Camlline_for_any_symbol_t.Camlline_for_any_duo_symbol
       (Camlline_for_any_duo_symbol_t.Camlline_for_any_duo_son_top_symbol
         Camlline_for_any_duo_son_top_symbol_t.Pipe_print_fatal_error_es_any_off_et_any_4_lines)),
    [2; 1; 2; 2; 7; 1; 2; 1; 7; 2])]
);;
...
(* 3 Camlparagraph_for_symbol_let_match_symbol_t.Let_topson_notleaf_symbol_off_top_symbol *)
