...
(* toplevel 
   #use "Item_formula_u_moleculeset_symbol_molecule_linear_diatomic_making.ml";;

*)

let nam_cod = "Item_formula_u_moleculeset_symbol_molecule_linear_diatomic_making.ml";;
...
let sel_ite = Item_symbol_v.is_making;;
...
test_raises_this_failure "Not_found:doublet_list_v.ml:find_if_left" (Doublet_list_v.find_if_left sel_ite) for_usf 
