...
(* toplevel 
   #use "Camlline_formula_u_figureset_symbol_figureset_typing.ml";;
...
let sym_ent_tos_l = Entity_topson_symbol_list_by_entity_tritup_provider_v.provide tri_enp;;
...
Item_formula_t.Item_all_topsons_formula
  (Item_all_topsons_formula_t.Item_all_topsons_for_symbol_formula
     (Item_all_topsons_for_symbol_formula_t.Typing_for_symbol
	tag_cap_l))
);;
   ...
   (Section_symbol_t.Section_for_symbol_symbol
     (Section_for_symbol_symbol_t.Section_for_symbol_body_symbol
       (Section_for_symbol_body_symbol_t.Section_for_symbol_body_son_symbol
         Section_for_symbol_body_son_symbol_t.Pipe_topson_symbol_type_notleaf_constructors)),
    [2; 2; 3; 1; 1; 1; 7; 2]);
   (Section_symbol_t.Section_for_symbol_symbol
     (Section_for_symbol_symbol_t.Section_for_symbol_body_symbol
       (Section_for_symbol_body_symbol_t.Section_for_symbol_body_son_symbol
...
(* 1 Camlline_for_any_uno_camltype_top_symbol_t.Type_et_any_equal *)
 ...
 [(Group_symbol_t.Group_for_any_symbol
     (Group_for_any_symbol_t.Group_for_any_body_symbol
       (Group_for_any_body_symbol_t.Group_for_any_body_son_symbol
         Group_for_any_body_son_symbol_t.Pipe_es_any_notleaf_type_constructor)),
    [1; 2; 2; 3; 1; 1; 1; 7; 2]);
   (Group_symbol_t.Group_for_any_symbol
     (Group_for_any_symbol_t.Group_for_any_body_symbol
       (Group_for_any_body_symbol_t.Group_for_any_body_son_symbol
...
(* : Camlline_symbol_t.camlline_symbol Tag_t.tag list *)
  ...
  [(Camlline_symbol_t.Camlline_for_any_symbol
     (Camlline_for_any_symbol_t.Camlline_for_any_uno_symbol
       (Camlline_for_any_uno_symbol_t.Camlline_for_any_uno_camltype_symbol
         (Camlline_for_any_uno_camltype_symbol_t.Camlline_for_any_uno_camltype_son_symbol
           Camlline_for_any_uno_camltype_son_symbol_t.Pipe_es_any_space_of_space_es_any_tdot_es_any))),
    [1; 1; 2; 2; 3; 1; 1; 1; 7; 2])]
);;
  ...
  [(Group_symbol_t.Group_for_symbol_symbol
     (Group_for_symbol_symbol_t.Group_for_symbol_body_symbol
       (Group_for_symbol_body_symbol_t.Group_for_symbol_body_son_symbol
         Group_for_symbol_body_son_symbol_t.Pipe_es_symbol_leaf_bare_type_constructor)),
    [1; 3; 2; 3; 1; 1; 1; 7; 2]);
   (Group_symbol_t.Group_for_symbol_symbol
     (Group_for_symbol_symbol_t.Group_for_symbol_body_symbol
       (Group_for_symbol_body_symbol_t.Group_for_symbol_body_son_symbol
...
(* 1 Group_for_symbol_body_son_symbol_t.Pipe_es_symbol_leaf_bare_type_constructor *)
(*   | Vector *)
...
(* : Camlline_symbol_t.camlline_symbol Tag_t.tag list *)
  ...
  [(Camlline_symbol_t.Camlline_for_symbol_symbol
     (Camlline_for_symbol_symbol_t.Camlline_for_symbol_uno_symbol
       (Camlline_for_symbol_uno_symbol_t.Camlline_for_symbol_uno_camltype_symbol
         Camlline_for_symbol_uno_camltype_symbol_t.Pipe_es)),
    [1; 1; 3; 2; 3; 1; 1; 1; 7; 2])]
);;

(* 1 Camlline_for_symbol_uno_camltype_symbol_t.Pipe_es *)
(* | Vector *)
...
=
  [(Entity_symbol_t.Entity_fictive_symbol
     (Entity_fictive_symbol_t.Entity_fictive_nullary_symbol
       (Entity_fictive_nullary_symbol_t.Bare "vector")),
    [1; 1; 1; 3; 2; 3; 1; 1; 1; 7; 2])]
);;

(* 2 Group_for_symbol_body_son_symbol_t.Pipe_es_symbol_leaf_bare_type_constructor *)
(*   | Point  *)
...
=
  [(Entity_symbol_t.Entity_fictive_symbol
     (Entity_fictive_symbol_t.Entity_fictive_nullary_symbol
       (Entity_fictive_nullary_symbol_t.Ofstring "point")),
    [1; 1; 2; 3; 2; 3; 1; 1; 1; 7; 2])]
);;

(* 4 Section_for_symbol_body_son_symbol_t.Pipe_topson_symbol_type_ofstring_constructors *)
(* Empty *)
...
(* 5 Section_for_any_footer_constant_symbol_t.Double_semicolon *)
(* ;; *)
