...
testing "Camlparagraph_formula_v with 
   Camlparagraph_formula_u_figureset_symbol_triangle_abbreviating.ml";;

(* toplevel 
   #use "Camlparagraph_formula_u_figureset_symbol_triangle_abbreviating.ml";;

*)

let nam_cod = "Camlparagraph_formula_u_figureset_symbol_triangle_abbreviating";;
...
tag_cof
=
(Contentfile_symbol_t.Value_alone, [2; 2; 7; 5])
);;

test_number 2 (
tag_usf
  =
(Usagefile_symbol_t.Implementation, [1; 2; 2; 7; 5])
);;
