...
testing "Item_formula_v with 
   Item_formula_u_querying_chemicalset_atom_zerotied.ml";;

(* toplevel 
   #use "Item_formula_u_querying_chemicalset_atom_zerotied.ml";;
*)
...
let tag_cof = Doublet_list_v.find_if_left Contentfile_symbol_v.is_value_alone for_enp;; 
let for_cof = Contentfile_formula_v.retrieve tag_cof;;

let tag_usf = Doublet_list_v.find_if_left Usagefile_symbol_v.is_implementation_off_usagefile_symbol for_cof;; 
let for_usf = Usagefile_formula_v.retrieve tag_usf;;

let tag_ite = Doublet_list_v.find_if_left Item_symbol_v.is_querying for_usf;; 
...
=
(Item_symbol_v.querying, [6; 1; 2; 3; 1; 1])
);;
