...
(* toplevel 
   #use "Camlline_formula_u_figureset_symbol_triangle_isoceles_string_offing.ml";;

*)

let nam_cod = "Camlline_formula_u_figureset_symbol_triangle_isoceles_string_offing.ml";;
...
=
  Item_formula_t.Item_all_topsons_formula
   (Item_all_topsons_formula_t.Item_all_topsons_for_symbol_formula
     (Item_all_topsons_for_symbol_formula_t.String_offing_for_symbol
	tag_cap_l ))
);;

(* 2 Camlparagraph_for_symbol_let_match_symbol_t.Let_string_equal_function_for_symbol *)
   ...
   (Section_symbol_t.Section_for_symbol_symbol
     (Section_for_symbol_symbol_t.Section_for_symbol_body_symbol
       (Section_for_symbol_body_symbol_t.Section_for_symbol_body_son_top_symbol
         Section_for_symbol_body_son_top_symbol_t.String_off_topson_pattern_for_symbol)),
    [2; 2; 4; 1; 2; 3; 7; 2]);
...
(* 1 Section_for_symbol_header_constant_symbol_t.Let_string_off_equal_function *)
...
(* 1 Camlline_constant_function_symbol_t.Let_string_off_equal_function *)
(* let string_off = function *)
...
(* 2 Section_for_symbol_body_son_top_symbol_t.String_off_topson_pattern_for_symbol *)
(* | Triangle_isoceles_symbol_t.Triangle_isoceles_equilateral -> "Triangle_isoceles_equilateral" *)
(* | Triangle_isoceles_symbol_t.Triangle_isoceles_right -> "Triangle_isoceles_right" *)
(* | Triangle_isoceles_symbol_t.Triangle_isoceles_acute -> "Triangle_isoceles_acute" *)
(* | Triangle_isoceles_symbol_t.Triangle_isoceles_obtuse -> "Triangle_isoceles_obtuse" *)
  ...
  [(Group_symbol_t.Group_for_symbol_symbol
     (Group_for_symbol_symbol_t.Group_for_symbol_body_symbol
       (Group_for_symbol_body_symbol_t.Group_for_symbol_body_son_top_symbol
         Group_for_symbol_body_son_top_symbol_t.Pipe_upgrade_string_off_leaf_bare_function)),
    [1; 2; 2; 4; 1; 2; 3; 7; 2]);
   (Group_symbol_t.Group_for_symbol_symbol
     (Group_for_symbol_symbol_t.Group_for_symbol_body_symbol
       (Group_for_symbol_body_symbol_t.Group_for_symbol_body_son_top_symbol
...
(* 1 Group_for_symbol_body_son_top_symbol_t.Pipe_upgrade_string_off_leaf_bare_function *) 
(* | Triangle_isoceles_symbol_t.Triangle_isoceles_equilateral -> "Triangle_isoceles_equilateral" *)
 ...
 [(Camlline_symbol_t.Camlline_for_symbol_symbol
     (Camlline_for_symbol_symbol_t.Camlline_for_symbol_duo_symbol
       (Camlline_for_symbol_duo_symbol_t.Camlline_for_symbol_duo_son_top_symbol
         Camlline_for_symbol_duo_son_top_symbol_t.Pipe_et_symbol_tdot_es_arrow_string)),
    [1; 1; 2; 2; 4; 1; 2; 3; 7; 2])]
);;

(* 1 Camlline_for_any_duo_son_top_symbol_t.Pipe_et_any_tdot_es_any_space_ac_as_arrow *)
(* | Triangle_isoceles_symbol_t.Triangle_isoceles_equilateral -> "Triangle_isoceles_equilateral" *)
...
=
  [(Entity_symbol_t.Entity_fictive_symbol
     (Entity_fictive_symbol_t.Entity_fictive_nullary_symbol
       (Entity_fictive_nullary_symbol_t.Bare
         "triangle_isoceles_equilateral")),
    [1; 1; 1; 2; 2; 4; 1; 2; 3; 7; 2]);
   (
     (Entity_symbol_t.Entity_proper "triangle_isoceles"),
    [2; 1; 1; 2; 2; 4; 1; 2; 3; 7; 2])]
);;

(* 4 Group_for_symbol_body_son_top_symbol_t.Pipe_upgrade_string_off_leaf_bare_function *)
(* | Triangle_isoceles_symbol_t.Triangle_isoceles_obtuse -> "Triangle_isoceles_obtuse" *)
...
=
  [(Entity_symbol_t.Entity_fictive_symbol
     (Entity_fictive_symbol_t.Entity_fictive_nullary_symbol
       (Entity_fictive_nullary_symbol_t.Bare
         "triangle_isoceles_obtuse")),
    [1; 1; 4; 2; 2; 4; 1; 2; 3; 7; 2]);
   (
     (Entity_symbol_t.Entity_proper "triangle_isoceles"),
    [2; 1; 4; 2; 2; 4; 1; 2; 3; 7; 2])]
);;
