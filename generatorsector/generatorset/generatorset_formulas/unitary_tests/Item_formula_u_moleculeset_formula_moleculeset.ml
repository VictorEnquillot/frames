...
testing "Item_formula_v with
   Item_formula_u_moleculeset_formula_moleculeset.ml";;

(* toplevel 
   #use "Item_formula_u_moleculeset_formula_moleculeset.ml";;
...
tag_cof_val
=
(Contentfile_symbol_t.Value_alone, [2; 1; 2; 7])
);;

test_number 10 (
tag_usf_val
  =
(Usagefile_symbol_t.Implementation, [1; 2; 1; 2; 7])
);;
