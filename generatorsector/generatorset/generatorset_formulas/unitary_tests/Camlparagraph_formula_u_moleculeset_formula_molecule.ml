...
testing "Camlparagraph_formula_v with
   Camlparagraph_formula_u_moleculeset_formula_molecule.ml";;

(* toplevel 
   #use "Camlparagraph_formula_u_moleculeset_formula_molecule.ml";;
...
tag_cof_val
=
(Contentfile_symbol_t.Value_alone, [2; 4; 1; 3])
);;

test_number 16 (
tag_usf_val
  =
(Usagefile_symbol_t.Implementation, [1; 2; 4; 1; 3])
);;
