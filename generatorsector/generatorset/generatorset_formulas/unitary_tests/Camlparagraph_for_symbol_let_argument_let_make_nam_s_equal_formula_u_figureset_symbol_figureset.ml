...
testing "Camlparagraph_formula_v with
   Camlparagraph_for_symbol_let_argument_let_make_nam_s_equal_formula_u_figureset_symbol_figureset.ml";;

(* toplevel 
   #use "Camlparagraph_for_symbol_let_argument_let_make_nam_s_equal_formula_u_figureset_symbol_figureset.ml";;

*)

let nam_cod = "Camlparagraph_for_symbol_let_argument_let_make_nam_s_equal_formula_u_figureset_symbol_figureset.ml";;
...
=
  [(Section_symbol_t.Section_for_symbol_symbol
   ...
   (Section_symbol_t.Section_for_symbol_symbol
     (Section_for_symbol_symbol_t.Section_for_symbol_footer_symbol
       (Section_for_symbol_footer_symbol_t.Section_for_symbol_footer_top_symbol
         Section_for_symbol_footer_top_symbol_t.Try_make_of_topson_leaf_nam_s)),
    [3; 3; 12; 1; 2; 1; 7; 2])]
);; 
