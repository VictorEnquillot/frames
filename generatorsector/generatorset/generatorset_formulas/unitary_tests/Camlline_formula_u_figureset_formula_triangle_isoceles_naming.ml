...
testing "Camlline_formula_v with 
   Camlline_formula_u_figureset_formula_triangle_isoceles_naming.ml";;

(* toplevel 
   #use "Camlline_formula_u_figureset_formula_triangle_isoceles_naming.ml";;

*)

let nam_cod = "Camlline_formula_u_figureset_formula_triangle_isoceles_naming";;
