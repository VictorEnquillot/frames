...
(* toplevel 
   #use "Item_formula_u_figureset_symbol_triangle_abbreviating.ml";;

*)

let nam_cod = "Item_formula_u_figureset_symbol_triangle_abbreviating.ml";;
...
let sym_ent_l = Entity_grandson_symbol_list_by_entity_tritup_provider_v.provide tri_enp;;
...
let nam_ite = "abbreviating_grandson_for_symbol";;
...
for_ite
=
  Item_formula_t.Item_each_grandson_leaf_formula
   (Item_each_grandson_leaf_formula_t.Item_each_grandson_leaf_for_symbol_formula
     (Item_each_grandson_leaf_for_symbol_formula_t.Abbreviating_grandson_for_symbol
	tag_cap_l ))
);;
  ...
  [(Section_symbol_t.Section_for_symbol_symbol
     (Section_for_symbol_symbol_t.Section_for_symbol_header_symbol
       (Section_for_symbol_header_symbol_t.Section_for_symbol_header_current_son_top_symbol
         Section_for_symbol_header_current_son_top_symbol_t.Let_abbreviate_ingrandfather)),
    [1; 2; 14; 1; 2; 2; 7; 2])]
);; 

(* 1 Section_for_symbol_header_current_son_top_symbol_t.Let_abbreviate_ingrandfather *)
  ...
  [(Group_symbol_t.Group_for_symbol_symbol
     (Group_for_symbol_symbol_t.Group_for_symbol_header_symbol
       (Group_for_symbol_header_symbol_t.Group_for_symbol_header_current_son_top_symbol
         Group_for_symbol_header_current_son_top_symbol_t.Let_abbreviate_ingrandfather)),
    [1; 1; 2; 14; 1; 2; 2; 7; 2])]
);;
  ...
  [(Camlline_symbol_t.Camlline_for_any_symbol
     (Camlline_for_any_symbol_t.Camlline_for_any_trio_symbol
       (Camlline_for_any_trio_symbol_t.Camlline_for_any_trio_current_son_top_symbol
         Camlline_for_any_trio_current_son_top_symbol_t.Let_ec_space_equal_space_et_any_of_es_any_space_es_any_vdot_ec_any)),
    [1; 1; 1; 2; 14; 1; 2; 2; 7; 2])]
);;
...
(* "triangle_symbol_off_figureset_symbol sym_geo = " *)
