...
testing "Item_all_topsons_formula_v with 
   Item_all_topsons_formula_u_figureset_symbol_figureset.ml";;

(* toplevel 
   #use "Item_all_topsons_formula_u_figureset_symbol_figureset.ml";;

*)

let nam_cod = "Item_all_topsons_formula_u_figureset_symbol_figureset";;
...
let for_iat = Item_all_topsons_making_formula_v.retrieve tag_iat;;
...
let tag_iat = Item_tag_v.item_all_topsons_tag_off_item_tag tag_ite;;
let for_iat = Item_all_topsons_naming_formula_v.retrieve tag_iat;;
