...
testing "Item_formula_u_making_chemicalset_atom_zerotied.ml";;

(* toplevel 
   #use "Item_formula_u_making_chemicalset_atom_zerotied.ml";;
*)
 ...
 (Camlparagraph_symbol_t.Camlparagraph_endmarked_symbol
   (Camlparagraph_endmarked_symbol_t.Camlparagraph_endmarked_let_symbol
     (Camlparagraph_endmarked_let_symbol_t.Camlparagraph_endmarked_let_function_symbol
       Camlparagraph_endmarked_let_function_symbol_t.Let_make_function_for_symbol)),
  [2; 4; 1; 2; 3; 1; 1])]
);;
