...
testing "Item_each_grandson_leaf_upgrading_grandson_formula_v with 
   Item_each_grandson_leaf_upgrading_grandson_formula_u_figureset_symbol_figureset.ml";;

(* toplevel 
   #use "Item_each_grandson_leaf_upgrading_grandson_formula_u_figureset_symbol_figureset.ml";;

*)

let nam_cod = "Item_each_grandson_leaf_upgrading_grandson_formula_u_figureset_symbol_figureset";;
...
=
(Item_symbol_t.Item_each_grandson_leaf_symbol Item_each_grandson_leaf_symbol_t.Upgrading_grandson,
 [9; 1; 2; 1; 7; 2])
);;

let tag_iat = Item_tag_v.item_each_grandson_leaf_tag_off_item_tag tag_ite;;
let for_iat = Item_each_grandson_leaf_upgrading_grandson_formula_v.retrieve tag_iat;;
