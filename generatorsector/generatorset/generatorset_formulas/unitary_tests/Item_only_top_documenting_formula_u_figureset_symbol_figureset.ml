...
testing "Item_only_top_documenting_formula_v with 
   Item_only_top_documenting_formula_u_figureset_symbol_figureset.ml";;

(* toplevel 
   #use "Item_only_top_documenting_formula_u_figureset_symbol_figureset.ml";;

*)

let nam_cod = "Item_only_top_documenting_formula_u_figureset_symbol_figureset";;
...
let tag_iat = Item_tag_v.item_only_top_tag_off_item_tag tag_ite;;
let for_iat = Item_only_top_documenting_formula_v.retrieve tag_iat;;
 ...
 =
  [(Camlparagraph_symbol_t.Camlparagraph_for_any_symbol
     (Camlparagraph_for_any_symbol_t.Camlparagraph_for_any_comment_symbol
       (Camlparagraph_for_any_comment_symbol_t.Item_title "documenting")),
    [1; 2; 1; 2; 1; 7; 2]);
   (Camlparagraph_symbol_t.Camlparagraph_for_any_symbol
