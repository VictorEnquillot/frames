...
(* toplevel 
   #use "Camlparagraph_formula_u_moleculeset_symbol_molecule.ml";;
...
tag_cof_typ
=
(Contentfile_symbol_t.Type_alone, [1; 4; 7; 7])
);;

test_number 7 (
tag_usf_typ
  =
(Usagefile_symbol_t.Implementation, [1; 1; 4; 7; 7])
);;
...
tag_cof_val
=
(Contentfile_symbol_t.Value_alone, [2; 4; 7; 7])
);;

test_number 16 (
tag_usf_val
  =
(Usagefile_symbol_t.Implementation, [1; 2; 4; 7; 7])
);;
