...
testing "Item_each_topson_leaf_abbreviating_topson_formula_v with 
   Item_each_topson_leaf_abbreviating_topson_formula_u_figureset_symbol_figureset.ml";;

(* toplevel 
   #use "Item_each_topson_leaf_abbreviating_topson_formula_u_figureset_symbol_figureset.ml";;

*)

let nam_cod = "Item_each_topson_leaf_abbreviating_topson_formula_u_figureset_symbol_figureset";;
...
=
(Item_symbol_t.Item_each_topson_leaf_symbol Item_each_topson_leaf_symbol_t.Abbreviating_topson,
 [10; 1; 2; 1; 7; 2])
);;

let tag_itl = Item_tag_v.item_each_topson_leaf_tag_off_item_tag tag_ite;;
let for_itl = Item_each_topson_leaf_abbreviating_topson_formula_v.retrieve tag_itl;;
