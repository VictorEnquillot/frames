...
(* toplevel 
   #use "Item_formula_u_moleculeset_symbol_molecule_linear_diatomic_naming.ml";;

*)

let nam_cod = "Item_formula_u_moleculeset_symbol_molecule_linear_diatomic_naming.ml";;
