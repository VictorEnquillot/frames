...
(* toplevel 
   #use "Camlline_formula_u_figureset_symbol_triangle_isoceles_abbreviating.ml";;

*)

let nam_cod = "Camlline_formula_u_figureset_symbol_triangle_isoceles_abbreviating.ml";;
...
let sym_ent_tsl_l = Entity_topson_leaf_symbol_list_by_entity_tritup_provider_v.provide tri_enp;;
...
(* (\** {6 Abbreviating_topson_for_symbol} *\) *)

(* 2 let triangle_isoceles_equilateral = Triangle_isoceles_symbol_t.Triangle_isoceles_equilateral;; *)

(* 3 let triangle_isoceles_right = Triangle_isoceles_symbol_t.Triangle_isoceles_right;; *)

(* 4 let triangle_isoceles_acute = Triangle_isoceles_symbol_t.Triangle_isoceles_acute;; *)

(* 5 let triangle_isoceles_obtuse = Triangle_isoceles_symbol_t.Triangle_isoceles_obtuse;; *)
...
(* 2 Camlparagraph_for_symbol_let_abbreviate_symbol_t.Let_abbreviate_topson_nullary *)
...
(* 1 Group_for_symbol_header_son_top_symbol_t.Let_abbreviate_infather *)
(*   let triangle_isoceles_equilateral = Triangle_isoceles_symbol_t.Triangle_isoceles_equilateral;; *)
...
let sym_cdf = Camlline_for_symbol_duo_son_top_symbol_t.Let_es_equal_et_symbol_tdot_es;;
  let tag_cdf = Tag_v.make sym_cdf soi_cal;;
  let dec_cdf = 
    Camlline_for_symbol_duo_son_top_tag_v.camlline_for_symbol_duo_son_top_dectup_off_camlline_for_symbol_duo_son_top_tag 
      tag_cdf 
  ;;
let sym_ent_l = Tools_ignr_v.entity_topson_leaf_symbol_list_of_dectup dec_cdf;;
let sym_ent_cur =
    Tools_fgnr_v.entity_current_symbol_for_item_each_of_entity_symbol_list_of_sole_index 
      sym_ent_l soi_cal;;
...
(* 5 Camlparagraph_for_symbol_let_abbreviate_symbol_t.Let_abbreviate_topson_nullary *)
...
=
  [(Entity_symbol_t.Entity_fictive_symbol
     (Entity_fictive_symbol_t.Entity_fictive_nullary_symbol
       (Entity_fictive_nullary_symbol_t.Bare
         "triangle_isoceles_obtuse")),
    [1; 1; 1; 1; 5; 13; 1; 2; 3; 7; 2]);
   (
     (Entity_symbol_t.Entity_proper "triangle_isoceles"),
    [2; 1; 1; 1; 5; 13; 1; 2; 3; 7; 2])]
);;
