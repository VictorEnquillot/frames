...
testing "Item_formula_v with
   Item_formula_u_value_chemicalset_atom_zerotied.ml";;

(* toplevel 
   #use "Item_formula_u_value_chemicalset_atom_zerotied.ml";;
*)
...
let tag_ite = Doublet_list_v.find_if_left Item_symbol_v.is_heading for_usf;; 
