...
(* toplevel 
   #use "Camlparagraph_formula_u_figureset_symbol_triangle_upgrading.ml";;

*)

let nam_cod = "Camlparagraph_formula_u_figureset_symbol_triangle_upgrading.ml";;
...
tag_usf
  =
(Usagefile_symbol_t.Implementation, [1; 2; 2; 7; 2])
);;
