...
testing "Camlparagraph_formula_v with
   Camlparagraph_formula_u_figureset_symbol_triangle_isoceles_making.ml";;

(* toplevel 
   #use "Camlparagraph_formula_u_figureset_symbol_triangle_isoceles_making.ml";;

*)

let nam_cod = "Camlparagraph_formula_u_figureset_symbol_triangle_isoceles_making.ml";;
