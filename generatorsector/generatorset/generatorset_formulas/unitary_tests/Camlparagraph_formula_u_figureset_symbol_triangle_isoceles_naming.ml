...
(* toplevel 
   #use "Camlparagraph_formula_u_figureset_symbol_triangle_isoceles_naming.ml";;

*)

let nam_cod = "Camlparagraph_formula_u_figureset_symbol_triangle_isoceles_naming.ml";;
