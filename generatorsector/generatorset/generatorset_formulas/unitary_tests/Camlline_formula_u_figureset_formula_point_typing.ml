...
(* toplevel 
   #use "Camlline_formula_u_figureset_formula_point_typing.ml";;
...
=
(Usagefile_symbol_t.Implementation, [1; 1; 13; 2; 2])
);;
  ...
  [(Camlline_symbol_t.Camlline_uno_symbol
   ...
   (Camlline_symbol_t.Camlline_datastructure_symbol
     (Camlline_datastructure_symbol_t.Camlline_datastructure_camltype_symbol
       (Camlline_datastructure_camltype_symbol_t.Lpar_a_b_c_tag_rpar
         "triplet")),
    [2; 2; 3; 1; 1; 13; 2; 2]);
   (Camlline_symbol_t.Camlline_constant_symbol
     (Camlline_constant_symbol_t.Camlline_constant_pervasive_symbol
...
=
  (Camlline_symbol_t.Camlline_datastructure_symbol
    (Camlline_datastructure_symbol_t.Camlline_datastructure_camltype_symbol
      (Camlline_datastructure_camltype_symbol_t.Lpar_a_b_c_tag_rpar "triplet")),
   [2; 2; 3; 1; 1; 13; 2; 2])
);;
...
=
  [Entity_symbol_t.Entity_fictive_symbol
   ...
   Entity_symbol_t.Entity_fictive_symbol
    (Entity_fictive_symbol_t.Entity_fictive_nullary_symbol
      (Entity_fictive_nullary_symbol_t.Bare "z"))]
);;
