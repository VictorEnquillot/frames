...
(* toplevel 
   #use "Camlline_formula_u_figureset_formula_vector_making.ml";;
...
=
  [(Entity_fictive_nullary_symbol_t.Bare "coordinate_1d",
   ...
   (Entity_fictive_nullary_symbol_t.Bare "cylindrical_zed",
    [18; 2; 2]);
   (Entity_fictive_nullary_symbol_t.Bare "point_1d", [19; 2; 2]);
   (Entity_fictive_nullary_symbol_t.Bare "point", [20; 2; 2]);
   (Entity_fictive_nullary_symbol_t.Bare "point", [21; 2; 2]);
   (Entity_fictive_nullary_symbol_t.Bare "polar_rho", [22; 2; 2]);
   (Entity_fictive_nullary_symbol_t.Bare "polar_theta", [23; 2; 2]);
   ...
   (Entity_fictive_nullary_symbol_t.Bare "triangle_scalene_right",
    [33; 2; 2]);
   (Entity_fictive_nullary_symbol_t.Bare "vector_1d", [34; 2; 2]);
   (Entity_fictive_nullary_symbol_t.Bare "vector", [35; 2; 2]);
   (Entity_fictive_nullary_symbol_t.Bare "vector", [36; 2; 2]);
   (Entity_fictive_nullary_symbol_t.Bare "x", [37; 2; 2]);
   (Entity_fictive_nullary_symbol_t.Bare "x_3d", [38; 2; 2]);
   (Entity_fictive_nullary_symbol_t.Bare "y", [39; 2; 2]);
   (Entity_fictive_nullary_symbol_t.Bare "y_3d", [40; 2; 2]);
   (Entity_fictive_nullary_symbol_t.Bare "z_3d", [41; 2; 2])]
);;
