...
testing "Entity_formula_v with
   Entity_proper_formula_u_chemicalset_tag_atom_zerotied.ml";;

(* toplevel 
   #use "Entity_proper_formula_u_chemicalset_tag_atom_zerotied.ml";;
*)
...
let tag_cat = Doublet_list_v.find_if_left Category_symbol_v.is_tag_off_category_symbol for_dos;; 
...
=
(Entity_symbol_t.Entity_proper "atom_zerotied", [24; 2; 1])
);;
...
=
[(Contentfile_symbol_t.Type_alone, [1; 24; 2; 1]);
 (Contentfile_symbol_t.Value_alone, [2; 24; 2; 1])]
);;
