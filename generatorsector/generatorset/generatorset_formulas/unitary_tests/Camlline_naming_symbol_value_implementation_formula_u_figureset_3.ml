...
testing "Camlline_naming_symbol_value_implementation_formula_u_figureset_3.ml";;

(* toplevel 
   #use "Camlline_naming_symbol_value_implementation_formula_u_figureset_3.ml";;
*)
...
let tag_enp = Doublet_list_v.find_if_left (fun e -> Entity_symbol_v.string_off e = "point") for_cat;;
...
[(Entity_symbol_t.Entity_fictive_symbol
  ...
  [1; 2; 2; 4; 1; 2; 7; 1; 2]);
 (
   (Entity_symbol_t.Topentity "point"),
  [2; 2; 2; 4; 1; 2; 7; 1; 2])]
);;
