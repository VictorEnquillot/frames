...
let symbol_of_formula for_ccc = 
  ...
  | Camlline_node_formula_t.Camlline_node_sub_7_formula for_cc7 ->
      Camlline_node_symbol_t.Camlline_node_sub_7_symbol
        (Camlline_node_sub_7_formula_v.symbol_of_formula for_cc7)

  | Camlline_node_formula_t.Camlline_node_sub_8_formula for_cc8 ->
      Camlline_node_symbol_t.Camlline_node_sub_8_symbol
        (Camlline_node_sub_8_formula_v.symbol_of_formula for_cc8)

  | Camlline_node_formula_t.Camlline_node_sub_9_formula for_cc9 ->
      Camlline_node_symbol_t.Camlline_node_sub_9_symbol
        (Camlline_node_sub_9_formula_v.symbol_of_formula for_cc9)

  | Camlline_node_formula_t.Camlline_node_sub10_formula for_cc10 ->
      Camlline_node_symbol_t.Camlline_node_sub10_symbol
        (Camlline_node_sub10_formula_v.symbol_of_formula for_cc10)
;;
...
let make sym_ccc soi_cal =
  ...
  | Camlline_node_symbol_t.Camlline_node_sub_7_symbol sym_cc7 ->
      Camlline_node_formula_t.Camlline_node_sub_7_formula 
        (Camlline_node_sub_7_formula_v.make sym_cc7 soi_cal)

  | Camlline_node_symbol_t.Camlline_node_sub_8_symbol sym_cc8 ->
      Camlline_node_formula_t.Camlline_node_sub_8_formula 
        (Camlline_node_sub_8_formula_v.make sym_cc8 soi_cal)

  | Camlline_node_symbol_t.Camlline_node_sub_9_symbol sym_cc9 ->
      Camlline_node_formula_t.Camlline_node_sub_9_formula 
        (Camlline_node_sub_9_formula_v.make sym_cc9 soi_cal)

  | Camlline_node_symbol_t.Camlline_node_sub10_symbol sym_cc10 ->
      Camlline_node_formula_t.Camlline_node_sub10_formula 
        (Camlline_node_sub10_formula_v.make sym_cc10 soi_cal)
;;
...
let entity_tag_list_off_camlline_node_formula for_ccc =
  ...
  | Camlline_node_formula_t.Camlline_node_sub_7_formula for_cc7 ->
        Camlline_node_sub_7_formula_v.entity_tag_list_off_camlline_node_sub_7_formula for_cc7

  | Camlline_node_formula_t.Camlline_node_sub_8_formula for_cc8 ->
        Camlline_node_sub_8_formula_v.entity_tag_list_off_camlline_node_sub_8_formula for_cc8

  | Camlline_node_formula_t.Camlline_node_sub_9_formula for_cc9 ->
        Camlline_node_sub_9_formula_v.entity_tag_list_off_camlline_node_sub_9_formula for_cc9

  | Camlline_node_formula_t.Camlline_node_sub10_formula for_cc10 ->
        Camlline_node_sub10_formula_v.entity_tag_list_off_camlline_node_sub10_formula for_cc10
;;
