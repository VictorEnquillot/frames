(** {3 Group_for_any_body_top_main_formula_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Needs : IGNR:Group_for_any_body_top_main_interface_v";
   "Current : FGNR:Group_for_any_body_top_main_formula_v";
...
let symbol_of_formula for_gtm =
  match for_gtm with
  | Group_for_any_body_top_main_formula_t.Make_tag_top _ -> 
...
let longname for_gtm =
  Format.sprintf "Group_for_any_body_top_main_formula_t.%s" 
...
(***
  ...
  let non_gtm = 
    Group_for_any_body_top_main_tag_v.group_for_any_body_top_main_nontup_off_group_for_any_body_top_main_tag 
      tag_gtm 
  in
***)
  let sym_cal_l = Group_for_any_body_top_main_interface_v.make sym_gtm in
...
let make sym_gtm soi_gro =
  ...
  match sym_gtm with 
  | Group_for_any_body_top_main_symbol_t.Make_tag_top -> 
      Group_for_any_body_top_main_formula_t.Make_tag_top tag_cal_l
...
let camlline_tag_list_off_group_for_any_body_top_main_formula for_gtm =
  match for_gtm with
  | Group_for_any_body_top_main_formula_t.Make_tag_top tag_cal_l -> 
      tag_cal_l
;;

let camlline_tag_list_off_group_for_any_body_top_main_tag tag_gtm =
  let for_gtm = retrieve tag_gtm in
  camlline_tag_list_off_group_for_any_body_top_main_formula for_gtm
;; 

(** {6 Iterating_for_formula_for_any_body_top_main.} *)

let map f_of_tag_cal for_gtm = 
  let tag_cal_l = camlline_tag_list_off_group_for_any_body_top_main_formula for_gtm in
...
let map2 f_of_tag_cal for_gtm_1 for_gtm_2  = 
  let tag_cal_l_1 = camlline_tag_list_off_group_for_any_body_top_main_formula for_gtm_1 in
  let tag_cal_l_2 = camlline_tag_list_off_group_for_any_body_top_main_formula for_gtm_2 in
