(** {3 Camlline_uno_function_symbol_pipe_ecstring_arrow_ec_formula_v} *)
...
let documentation () = 
  [
   "Needs : IGNR:";
   "Current : FGNR:Camlline_uno_function_symbol_pipe_ecstring_arrow_ec_formula_v";
   "Needed-by : FGNR:";
...
let longname for_cfs =
  Format.sprintf "Camlline_uno_function_symbol_pipe_ecstring_arrow_ec_t.%s" 
...
let entity_topson_leaf_symbol_list dec_cfs =
...
let build dec_cfs idx_gro =
  let sym_son_l = entity_topson_leaf_symbol_list dec_cfs in
