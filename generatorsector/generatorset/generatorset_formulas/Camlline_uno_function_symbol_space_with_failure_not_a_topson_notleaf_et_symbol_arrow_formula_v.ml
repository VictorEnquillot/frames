(** {3 Camlline_uno_function_symbol_with_failure_not_a_topson_notleaf_et_symbol_arrow_formula_v} *)
...
let documentation () = 
  [
   "Needs : IGNR:";
   "Current : FGNR:Camlline_uno_function_symbol_with_failure_not_a_topson_notleaf_et_symbol_arrow_formula_v";
   "Needed-by : FGNR:";
...
let name for_cfs = "with_failure_not_a_topson_notleaf_arrow_formula";;

let longname for_cfs =
  Format.sprintf "Camlline_uno_function_symbol_with_failure_not_a_topson_notleaf_et_symbol_arrow_t.%s" 
