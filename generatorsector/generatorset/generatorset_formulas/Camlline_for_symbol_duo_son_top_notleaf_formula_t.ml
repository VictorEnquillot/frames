...
type camlline_for_symbol_duo_son_top_notleaf_formula =
  | Et_symbol_of_es_symbol_sym_as of Entity_tag_t.entity_tag list  
  | Et_symbol_tdot_es_symbol of Entity_tag_t.entity_tag list  
  ...
  | Pipe_et_symbol_tdot_es_symbol_sym_as_arrow of Entity_tag_t.entity_tag list 
