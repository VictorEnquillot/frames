(** {3 Group_for_symbol_header_current_son_top_formula_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Needs : IGNR:Group_for_symbol_header_current_son_top_interface_v";
   "Current : FGNR:Group_for_symbol_header_current_son_top_formula_v";
...
let symbol_of_formula for_gst =
  match for_gst with
  | Group_for_symbol_header_current_son_top_formula_t.Let_abbreviate_grandson_bare _ -> 
      Group_for_symbol_header_current_son_top_symbol_t.Let_abbreviate_grandson_bare

  | Group_for_symbol_header_current_son_top_formula_t.Let_abbreviate_grandson_ofstring _ -> 
...
let longname for_gst =
  Format.sprintf "Group_for_symbol_header_current_son_top_formula_t.%s" 
...
let build_n_store sym_gst soi_gro =
  let sym_cal_l = Group_for_symbol_header_current_son_top_interface_v.make sym_gst in
...
let make sym_gst soi_gro =
  ...
  match sym_gst with 
  | Group_for_symbol_header_current_son_top_symbol_t.Let_abbreviate_grandson_bare -> 
      Group_for_symbol_header_current_son_top_formula_t.Let_abbreviate_grandson_bare tag_cal_l

  | Group_for_symbol_header_current_son_top_symbol_t.Let_abbreviate_grandson_ofstring -> 
      Group_for_symbol_header_current_son_top_formula_t.Let_abbreviate_grandson_ofstring tag_cal_l
;;
...
let camlline_tag_list_off_group_for_symbol_header_current_son_top_formula for_gst =
  match for_gst with
  | Group_for_symbol_header_current_son_top_formula_t.Let_abbreviate_grandson_bare tag_cal_l -> tag_cal_l
  | Group_for_symbol_header_current_son_top_formula_t.Let_abbreviate_grandson_ofstring tag_cal_l -> tag_cal_l
;;

let camlline_tag_list_off_group_for_symbol_header_current_son_top_tag tag_gst =
  let for_gst = retrieve tag_gst in
  camlline_tag_list_off_group_for_symbol_header_current_son_top_formula for_gst
;; 

(** {6 Iterating_for_formula_for_symbol_header_current_son_top.} *)

let map f_of_tag_cal for_gst = 
  let tag_cal_l = camlline_tag_list_off_group_for_symbol_header_current_son_top_formula for_gst in
...
let map2 f_of_tag_cal for_gst_1 for_gst_2  = 
  let tag_cal_l_1 = camlline_tag_list_off_group_for_symbol_header_current_son_top_formula for_gst_1 in
  let tag_cal_l_2 = camlline_tag_list_off_group_for_symbol_header_current_son_top_formula for_gst_2 in
