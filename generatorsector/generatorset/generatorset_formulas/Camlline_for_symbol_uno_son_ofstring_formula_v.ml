(** {3 Camlline_for_symbol_uno_son_ofstring_formula_v} *)
...
let documentation () = 
  [
   "Needs : IGNR:";
   "Current : FGNR:Camlline_for_symbol_uno_son_ofstring_formula_v";
   "Needed-by : FGNR:Camlline_uno_son_ofstring_formula_v";
...
let symbol_of_formula for_cuf =
  match for_cuf with
  | Camlline_for_symbol_uno_son_ofstring_formula_t.Pipe_esstring_arrow_es_sarg _ ->
...
let name for_cuf = 
  ...
  Camlline_for_symbol_uno_son_ofstring_symbol_v.name sym_cuf
;;
(* ***

let string_off for_cuf =
  let sym_cuf = symbol_of_formula for_cuf in
  Camlline_for_symbol_uno_son_ofstring_symbol_v.string_off sym_cuf
;;

let longname for_cuf =
  Format.sprintf "Camlline_for_symbol_uno_son_ofstring_formula_t.%s" 
...
let build_n_store sym_cuf soi_cal =
  ...
  let dec_cuf = 
    Camlline_for_symbol_uno_son_ofstring_tag_v.camlline_for_symbol_uno_son_ofstring_dectup_off_camlline_for_symbol_uno_son_ofstring_tag 
      tag_cuf 
  in

  let idx_gro = Sole_index_v.father_index_off_sole_index soi_cal in
  let sym_ent_tos_l = Tools_ignr_v.entity_topson_ofstring_symbol_list_of_dectup dec_cuf in
  let sym_ent_son = 
	...
	(Format.sprintf "None of them for Camlline >%s< when idx_gro = %i" 
	   (Camlline_for_symbol_uno_son_ofstring_symbol_v.name sym_cuf) idx_gro
	)
	"Check"
  in
...
(* BT builders *)
  ...
  let sym_ent_l = 
    Camlline_for_symbol_uno_son_ofstring_interface_v.make 
      sym_cuf 
      sym_ent_son
  in
...
let make sym_cuf soi_cal =
  ...
  match sym_cuf with
  | Camlline_for_symbol_uno_son_ofstring_symbol_t.Pipe_esstring_arrow_es_sarg ->
      Camlline_for_symbol_uno_son_ofstring_formula_t.Pipe_esstring_arrow_es_sarg tag_ent_l
...
let entity_tag_list_off_camlline_for_symbol_uno_son_ofstring_formula for_cuf =
  match for_cuf with
  | Camlline_for_symbol_uno_son_ofstring_formula_t.Pipe_esstring_arrow_es_sarg tag_ent_l ->
     tag_ent_l
...
let entity_tag_list_off_camlline_for_symbol_uno_son_ofstring_tag tag_cuf =
  let for_cuf = retrieve tag_cuf in
  entity_tag_list_off_camlline_for_symbol_uno_son_ofstring_formula for_cuf
;; 

(** {6 Iterating_for_formula_uno_son_ofstring_symbol.} *)

let map f_of_tag_ent for_cuf = 
  let tag_ent_l = entity_tag_list_off_camlline_for_symbol_uno_son_ofstring_formula for_cuf in
...
let map2 f_of_tag_ent for_cuf_1 for_cuf_2  = 
  let tag_ent_l_1 = entity_tag_list_off_camlline_for_symbol_uno_son_ofstring_formula for_cuf_1 in
  let tag_ent_l_2 = entity_tag_list_off_camlline_for_symbol_uno_son_ofstring_formula for_cuf_2 in
