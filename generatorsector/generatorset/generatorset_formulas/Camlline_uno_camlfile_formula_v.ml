(** {3 Camlline_uno_camlfile_formula_v} *)
...
let documentation () = 
  [
   "Needs : IGNR:";
   "Current : FGNR:Camlline_uno_camlfile_formula_v";
...
let symbol_of_formula for_ccc =
  match for_ccc with
  | Camlline_uno_camlfile_formula_t.Camlfile_createdby _ -> 
      Camlline_uno_camlfile_symbol_t.Camlfile_createdby

  | Camlline_uno_camlfile_formula_t.Camlfile_title _ -> 
      Camlline_uno_camlfile_symbol_t.Camlfile_title
;;
...
let name for_ccc = 
  ...
  Camlline_uno_camlfile_symbol_v.name sym_ccc
;;
(* ***

let string_off for_ccc =
  let sym_ccc = symbol_of_formula for_ccc in
  Camlline_uno_camlfile_symbol_v.string_off sym_ccc
;;

let longname for_ccc =
  Format.sprintf "Camlline_uno_camlfile_formula_t.%s" 
...
let build_n_store sym_ccc soi_cal =
  ...
  let dec_ccc = 
    Camlline_uno_camlfile_tag_v.camlline_uno_camlfile_dectup_off_camlline_uno_camlfile_tag 
      tag_ccc 
  in
  let sym_ent_l = Camlline_uno_camlfile_interface_v.make dec_ccc soi_cal in
...
let make sym_ccc soi_cal =
  ...
  match sym_ccc with 
  | Camlline_uno_camlfile_symbol_t.Camlfile_createdby -> 
      Camlline_uno_camlfile_formula_t.Camlfile_createdby tag_ent_l

  | Camlline_uno_camlfile_symbol_t.Camlfile_title -> 
      Camlline_uno_camlfile_formula_t.Camlfile_title tag_ent_l
;;
...
let entity_tag_list_off_camlline_uno_camlfile_formula for_ccc =
  match for_ccc with
  | Camlline_uno_camlfile_formula_t.Camlfile_createdby tag_ent_l -> 
      tag_ent_l
...
let entity_tag_list_off_camlline_uno_camlfile_tag tag_ccc =
  let for_ccc = retrieve tag_ccc in
  entity_tag_list_off_camlline_uno_camlfile_formula for_ccc
;; 

(** {6 Iterating_for_formula_uno_camlfile.} *)

let map f_of_tag_ent for_ccc = 
  let tag_ent_l = entity_tag_list_off_camlline_uno_camlfile_formula for_ccc in
...
let map2 f_of_tag_ent for_ccc_1 for_ccc_2  = 
  let tag_ent_l_1 = entity_tag_list_off_camlline_uno_camlfile_formula for_ccc_1 in
  let tag_ent_l_2 = entity_tag_list_off_camlline_uno_camlfile_formula for_ccc_2 in
