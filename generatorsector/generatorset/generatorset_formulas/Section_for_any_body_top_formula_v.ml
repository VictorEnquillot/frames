(** {3 Section_for_any_body_top_formula_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Needs : IGNR:Section_for_any_body_top_interface_v";
   "Current : FGNR:Section_for_any_body_top_formula_v";
...
let symbol_of_formula for_sbt =
  match for_sbt with
  | Section_for_any_body_top_formula_t.Sprintf_for_any_fullname _ ->
     Section_for_any_body_top_symbol_t.Sprintf_for_any_fullname
  | Section_for_any_body_top_formula_t.Sprintf_for_any_longname _ ->
...
let longname for_sbt =
  Format.sprintf "Section_for_any_body_top_formula_t.%s" 
...
let build_n_store sym_sbt soi_sec =
  let sym_gro_l = Section_for_any_body_top_interface_v.make sym_sbt in
...
let make sym_sbt soi_sec =
  ...
  match sym_sbt with 
  | Section_for_any_body_top_symbol_t.Sprintf_for_any_fullname ->
     Section_for_any_body_top_formula_t.Sprintf_for_any_fullname tag_gro_l
  | Section_for_any_body_top_symbol_t.Sprintf_for_any_longname ->
     Section_for_any_body_top_formula_t.Sprintf_for_any_longname tag_gro_l
...
let group_tag_list_off_section_for_any_body_top_formula for_sbt =
  match for_sbt with
  | Section_for_any_body_top_formula_t.Sprintf_for_any_fullname tag_gro_l -> tag_gro_l
  | Section_for_any_body_top_formula_t.Sprintf_for_any_longname tag_gro_l -> tag_gro_l

;;

let group_tag_list_off_section_for_any_body_top_tag tag_sbt =
  let for_sbt = retrieve tag_sbt in
  group_tag_list_off_section_for_any_body_top_formula for_sbt
;; 

let camlline_tag_list_off_section_for_any_body_top_formula for_sbt =
  let tag_gro_l = 
    group_tag_list_off_section_for_any_body_top_formula 
      for_sbt 
  in
...
let camlline_tag_list_off_section_for_any_body_top_tag tag_sbt =
  let for_sbt = retrieve tag_sbt in
  camlline_tag_list_off_section_for_any_body_top_formula for_sbt
;; 

(** {6 Iterating_for_formula} *)

let map f_of_tag_gro for_sbt = 
  let tag_gro_l = group_tag_list_off_section_for_any_body_top_formula for_sbt in
...
let map2 f_of_tag_gro for_sbt_1 for_sbt_2  = 
  let tag_gro_l_1 = group_tag_list_off_section_for_any_body_top_formula for_sbt_1 in
  let tag_gro_l_2 = group_tag_list_off_section_for_any_body_top_formula for_sbt_2 in
