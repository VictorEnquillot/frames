...
let symbol_of_formula for_ggg =
  ...
  | Group_stem_formula_t.Leaf_2 _ -> 
      Group_stem_symbol_t.Leaf_2

  | Group_stem_formula_t.Leaf_3 _ -> 
      Group_stem_symbol_t.Leaf_3

  | Group_stem_formula_t.Leaf_4 _ -> 
      Group_stem_symbol_t.Leaf_4

  | Group_stem_formula_t.Leaf_5 _ -> 
      Group_stem_symbol_t.Leaf_5

  | Group_stem_formula_t.Leaf_6 _ -> 
      Group_stem_symbol_t.Leaf_6

  | Group_stem_formula_t.Leaf_7_ -> 
      Group_stem_symbol_t.Leaf_7

  | Group_stem_formula_t.Leaf_8 _ -> 
      Group_stem_symbol_t.Leaf_8
;;
...
let make sym_ggg soi_gro =
  ...
  | Group_stem_symbol_t.Leaf_2 -> 
      Group_stem_formula_t.Leaf_2 tag_cal_l

  | Group_stem_symbol_t.Leaf_3 _ -> 
      Group_stem_formula_t.Leaf_3 tag_cal_l

  | Group_stem_symbol_t.Leaf_4 -> 
      Group_stem_formula_t.Leaf_4 tag_cal_l

  | Group_stem_symbol_t.Leaf_5 -> 
      Group_stem_formula_t.Leaf_5 tag_cal_l

  | Group_stem_symbol_t.Leaf_6 _ -> 
      Group_stem_formula_t.Leaf_6 tag_cal_l

  | Group_stem_symbol_t.Leaf_7 -> 
      Group_stem_formula_t.Leaf_7 tag_cal_l

  | Group_stem_symbol_t.Leaf_8 _ -> 
      Group_stem_formula_t.Leaf_8 tag_cal_l
