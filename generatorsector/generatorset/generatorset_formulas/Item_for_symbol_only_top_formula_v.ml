(** {3 Item_for_symbol_only_top_formula_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Needs : IGNR:Item_for_symbol_only_top_interface_v";
   "Current : FGNR:Item_for_symbol_only_top_formula_v";
...
let symbol_of_formula for_ifs =
  match for_ifs with
  | Item_for_symbol_only_top_formula_t.Documenting_for_symbol _ -> 
      Item_for_symbol_only_top_symbol_t.Documenting_for_symbol

  | Item_for_symbol_only_top_formula_t.Longnaming_for_symbol _ -> 
      Item_for_symbol_only_top_symbol_t.Longnaming_for_symbol

  | Item_for_symbol_only_top_formula_t.Fullnaming_for_symbol _ -> 
...
let name for_ifs = 
  ...
  Item_for_symbol_only_top_symbol_v.name sym_ifs
;;
(* ***

let string_off for_ifs =
  let sym_ifs = symbol_of_formula for_ifs in
  Item_for_symbol_only_top_symbol_v.string_off sym_ifs
;;

let longname for_ifs =
  Format.sprintf "Item_for_symbol_only_top_formula_t.%s" 
...
let build_n_store sym_ifs soi_ite =
  let sym_cap_l = 
    Item_for_symbol_only_top_interface_v.make 
      sym_ifs
  in
...
let make sym_ifs soi_cap =
  ...
  match sym_ifs with 
  | Item_for_symbol_only_top_symbol_t.Documenting_for_symbol -> 
      Item_for_symbol_only_top_formula_t.Documenting_for_symbol tag_cap_l

  | Item_for_symbol_only_top_symbol_t.Longnaming_for_symbol -> 
      Item_for_symbol_only_top_formula_t.Longnaming_for_symbol tag_cap_l

  | Item_for_symbol_only_top_symbol_t.Fullnaming_for_symbol -> 
      Item_for_symbol_only_top_formula_t.Fullnaming_for_symbol tag_cap_l
;;

(** {6 Builder_tag_listing} *)

let camlparagraph_tag_list_off_item_for_symbol_only_top_formula for_ifs =
  match for_ifs with
  | Item_for_symbol_only_top_formula_t.Documenting_for_symbol tag_cap_l -> 
      tag_cap_l
...
let camlline_tag_list_off_item_for_symbol_only_top_formula for_ifs =
  let tag_cap_l = 
    camlparagraph_tag_list_off_item_for_symbol_only_top_formula 
      for_ifs 
  in
...
(** {6 Iterating_for_formula_only_top_for_symbol.} *)

let map f_of_tag_cap for_ifs = 
  let tag_cap_l = camlline_tag_list_off_item_for_symbol_only_top_formula for_ifs in
...
let map2 f_of_tag_cap for_ifs_1 for_ifs_2  = 
  let tag_cap_l_1 = camlline_tag_list_off_item_for_symbol_only_top_formula for_ifs_1 in
  let tag_cap_l_2 = camlline_tag_list_off_item_for_symbol_only_top_formula for_ifs_2 in
