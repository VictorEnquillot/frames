(** {3 Camlline_for_tag_uno_camltype_formula_v} *)
...
let documentation () = 
  [
   "Needs : IGNR:";
   "Current : FGNR:Camlline_for_tag_uno_camltype_formula_v";
...
let symbol_of_formula for_cuc =
  match for_cuc with
  | Camlline_for_tag_uno_camltype_formula_t.Type_et_tag_equal_et_symbol_tdot_et_symbol_tag _ -> 
...
let name for_cuc = 
  ...
  Camlline_for_tag_uno_camltype_symbol_v.name sym_cuc
;;
(* ***

let string_off for_cuc =
  let sym_cuc = symbol_of_formula for_cuc in
  Camlline_for_tag_uno_camltype_symbol_v.string_off sym_cuc
;;

let longname for_cuc =
  Format.sprintf "Camlline_for_tag_uno_camltype_formula_t.%s" 
...
let build_n_store sym_cuc soi_cal =
  ...
  let dec_cuc = 
    Camlline_for_tag_uno_camltype_tag_v.camlline_for_tag_uno_camltype_dectup_off_camlline_for_tag_uno_camltype_tag 
      tag_cuc 
  in
...
(* BT builders *)
  ...
  let sym_ent_l = 
    Camlline_for_tag_uno_camltype_interface_v.make 
      sym_cuc 
      sym_ent_top
  in
...
let make sym_cuc soi_cal =
  ...
  match sym_cuc with 
  | Camlline_for_tag_uno_camltype_symbol_t.Type_et_tag_equal_et_symbol_tdot_et_symbol_tag -> 
      Camlline_for_tag_uno_camltype_formula_t.Type_et_tag_equal_et_symbol_tdot_et_symbol_tag tag_ent_l
;;
...
let entity_tag_list_off_camlline_for_tag_uno_camltype_formula for_cuc =
  match for_cuc with
  | Camlline_for_tag_uno_camltype_formula_t.Type_et_tag_equal_et_symbol_tdot_et_symbol_tag tag_ent_l -> 
      tag_ent_l
;;

let entity_tag_list_off_camlline_for_tag_uno_camltype_tag tag_cuc =
  let for_cuc = retrieve tag_cuc in
  entity_tag_list_off_camlline_for_tag_uno_camltype_formula for_cuc
;; 

(** {6 Iterating_for_formula_for_tag_uno_camltype.} *)

let map f_of_tag_ent for_cuc = 
  let tag_ent_l = entity_tag_list_off_camlline_for_tag_uno_camltype_formula for_cuc in
...
let map2 f_of_tag_ent for_cuc_1 for_cuc_2  = 
  let tag_ent_l_1 = entity_tag_list_off_camlline_for_tag_uno_camltype_formula for_cuc_1 in
  let tag_ent_l_2 = entity_tag_list_off_camlline_for_tag_uno_camltype_formula for_cuc_2 in
