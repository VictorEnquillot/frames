(** {3 Camlline_for_formula_trio_top_builder_data_formula_v} *)
...
let documentation () = 
  [
   "Needs : IGNR:";
   "Current : FGNR:Camlline_for_formula_trio_top_builder_data_formula_v";
...
let symbol_of_formula for_cbd =
  match for_cbd with
  | Camlline_for_formula_trio_top_builder_data_formula_t.Let_tag_ab_l_equal_ed_tag_list_off_et_formula_for_at_in _ ->
...
let name for_cbd = 
  ...
  Camlline_for_formula_trio_top_builder_data_symbol_v.name sym_cbd
;;
(* ***

let string_off for_cbd =
  let sym_cbd = symbol_of_formula for_cbd in
  Camlline_for_formula_trio_top_builder_data_symbol_v.string_off sym_cbd
;;

let longname for_cbd =
  Format.sprintf "Camlline_for_formula_trio_top_builder_data_formula_t.%s" 
...
let build_n_store sym_cbd soi_cal =
  ...
  let dec_cbd = 
    Camlline_for_formula_trio_top_builder_data_tag_v.camlline_for_formula_trio_top_builder_data_dectup_off_camlline_for_formula_trio_top_builder_data_tag 
      tag_cbd 
  in
...
(* BT builders *)
  ...
  let sym_ent_l = 
    Camlline_for_formula_trio_top_builder_data_interface_v.make
      sym_cbd
      sym_ent_top
      sym_ent_bui
      sym_ent_dat
...
let make sym_cbd soi_cal =
  ...
  match sym_cbd with 
  | Camlline_for_formula_trio_top_builder_data_symbol_t.Let_tag_ab_l_equal_ed_tag_list_off_et_formula_for_at_in ->
     Camlline_for_formula_trio_top_builder_data_formula_t.Let_tag_ab_l_equal_ed_tag_list_off_et_formula_for_at_in tag_ent_l
...
let entity_tag_list_off_camlline_for_formula_trio_top_builder_data_formula for_cbd =
  match for_cbd with
  | Camlline_for_formula_trio_top_builder_data_formula_t.Let_tag_ab_l_equal_ed_tag_list_off_et_formula_for_at_in tag_ent_l -> tag_ent_l

;;

let entity_tag_list_off_camlline_for_formula_trio_top_builder_data_tag tag_cbd =
  let for_cbd = retrieve tag_cbd in
  entity_tag_list_off_camlline_for_formula_trio_top_builder_data_formula for_cbd
;; 

(** {6 Iterating_for_formula_for_formula_trio_top_builder_data.} *)

let map f_of_tag_ent for_cbd = 
  let tag_ent_l = entity_tag_list_off_camlline_for_formula_trio_top_builder_data_formula for_cbd in
...
let map2 f_of_tag_ent for_cbd_1 for_cbd_2  = 
  let tag_ent_l_1 = entity_tag_list_off_camlline_for_formula_trio_top_builder_data_formula for_cbd_1 in
  let tag_ent_l_2 = entity_tag_list_off_camlline_for_formula_trio_top_builder_data_formula for_cbd_2 in
