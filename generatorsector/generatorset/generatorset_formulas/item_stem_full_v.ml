...
let symbol_of_formula for_iii =
  match for_iii with
  | Item_stem_formula_t.Leaf_1 _ -> 
      Item_stem_symbol_t.Leaf_1

  | Item_stem_formula_t.Leaf_2 _ -> 
      Item_stem_symbol_t.Leaf_2

  | Item_stem_formula_t.Leaf_3 _ -> 
      Item_stem_symbol_t.Leaf_3

  | Item_stem_formula_t.Leaf_4 _ -> 
      Item_stem_symbol_t.Leaf_4

  | Item_stem_formula_t.Leaf_5 _ -> 
      Item_stem_symbol_t.Leaf_5

  | Item_stem_formula_t.Leaf_6 _ -> 
      Item_stem_symbol_t.Leaf_6

  | Item_stem_formula_t.Leaf_7 _ -> 
      Item_stem_symbol_t.Leaf_7

  | Item_stem_formula_t.Leaf_8 _ -> 
...
let make sym_iii soi_ite =
  ...
  match sym_iii with 
  | Item_stem_symbol_t.Leaf_1 -> 
      Item_stem_formula_t.Leaf_1 tag_cap_l

  | Item_stem_symbol_t.Leaf_2 -> 
      Item_stem_formula_t.Leaf_2 tag_cap_l

  | Item_stem_symbol_t.Leaf_3 _ -> 
      Item_stem_formula_t.Leaf_3 tag_cap_l

  | Item_stem_symbol_t.Leaf_4 -> 
      Item_stem_formula_t.Leaf_4 tag_cap_l

  | Item_stem_symbol_t.Leaf_5 -> 
      Item_stem_formula_t.Leaf_5 tag_cap_l

  | Item_stem_symbol_t.Leaf_6 _ -> 
      Item_stem_formula_t.Leaf_6 tag_cap_l

  | Item_stem_symbol_t.Leaf_7 -> 
      Item_stem_formula_t.Leaf_7 tag_cap_l

  | Item_stem_symbol_t.Leaf_8 _ -> 
      Item_stem_formula_t.Leaf_8 tag_cap_l
