...
(* group_for_formula_body_top_builder_data : documentation_list_for_formula *)
  [
   ...
   "Remark : It is a CT_Stem and BT_Stem type";
 ]
;;
...
(* Section_for_formula_body_localset_data : data_tag_list  *)

(* Group_for_formula_body_localset_data : localset_symbol_data_list *)
  let dss_of_sym = Domain_symbol_v.localset_symbol_of_data_symbol in
  let dss_dat_l = List.map dss_of_sym sym_dat_l in

(* Group_for_formula_body_localset_data : store_data_tag_list *)
  List.iter2 Domain_symbol_by_sole_index_register_v.store soi_dat_l dss_dat_l;
...
(* group_for_formula_body_son_top_data : data_tag_list_topson_pattern_notleaf_for_formula *)
...
(* group_for_formula_body_son_top_data : data_tag_list_topson_pattern_bare_for_formula *)
...
(* camlparagraph_for_formula_let_match : let_data_tag_list_off_top_tag *)
