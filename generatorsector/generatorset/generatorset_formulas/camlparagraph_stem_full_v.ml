...
let symbol_of_formula for_ccc =
  ...
  | Camlparagraph_stem_formula_t.Leaf_2 _ -> 
      Camlparagraph_stem_symbol_t.Leaf_2

  | Camlparagraph_stem_formula_t.Leaf_3 _ -> 
      Camlparagraph_stem_symbol_t.Leaf_3

  | Camlparagraph_stem_formula_t.Leaf_4 _ -> 
      Camlparagraph_stem_symbol_t.Leaf_4

  | Camlparagraph_stem_formula_t.Leaf_5 _ -> 
      Camlparagraph_stem_symbol_t.Leaf_5

  | Camlparagraph_stem_formula_t.Leaf_6 _ -> 
      Camlparagraph_stem_symbol_t.Leaf_6

  | Camlparagraph_stem_formula_t.Leaf_7 _ -> 
      Camlparagraph_stem_symbol_t.Leaf_7

  | Camlparagraph_stem_formula_t.Leaf_8 _ -> 
      Camlparagraph_stem_symbol_t.Leaf_8
;;
...
let make sym_ccc soi_sec =
  ...
  | Camlparagraph_stem_symbol_t.Leaf_2 -> 
      Camlparagraph_stem_formula_t.Leaf_2 tag_sec_l

  | Camlparagraph_stem_symbol_t.Leaf_3 -> 
      Camlparagraph_stem_formula_t.Leaf_3 tag_sec_l

  | Camlparagraph_stem_symbol_t.Leaf_4 -> 
      Camlparagraph_stem_formula_t.Leaf_4 tag_sec_l

  | Camlparagraph_stem_symbol_t.Leaf_5 -> 
      Camlparagraph_stem_formula_t.Leaf_5 tag_sec_l

  | Camlparagraph_stem_symbol_t.Leaf_6 -> 
      Camlparagraph_stem_formula_t.Leaf_6 tag_sec_l

  | Camlparagraph_stem_symbol_t.Leaf_7 -> 
      Camlparagraph_stem_formula_t.Leaf_7 tag_sec_l

  | Camlparagraph_stem_symbol_t.Leaf_8 -> 
      Camlparagraph_stem_formula_t.Leaf_8 tag_sec_l
...
let section_tag_list_off_camlparagraph_stem_formula for_ccc =
  ...
  | Camlparagraph_stem_formula_t.Leaf_2 tag_cap_l -> 
      tag_cap_l

  | Camlparagraph_stem_formula_t.Leaf_3 tag_cap_l -> 
      tag_cap_l

  | Camlparagraph_stem_formula_t.Leaf_4 tag_cap_l -> 
      tag_cap_l

  | Camlparagraph_stem_formula_t.Leaf_5 tag_cap_l -> 
      tag_cap_l

  | Camlparagraph_stem_formula_t.Leaf_6 tag_cap_l -> 
      tag_cap_l

  | Camlparagraph_stem_formula_t.Leaf_7 tag_cap_l -> 
      tag_cap_l

  | Camlparagraph_stem_formula_t.Leaf_8 tag_cap_l -> 
      tag_cap_l
