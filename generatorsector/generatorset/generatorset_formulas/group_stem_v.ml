...
let name for_sss = 
  ...
  Group_stem_symbol_v.name sym_sss
;;
(* ***

let string_off for_sss =
  let sym_sss = symbol_of_formula for_sss in
  Group_stem_symbol_v.string_off sym_sss
;;
...
let build_n_store sym_sss soi_gro =
  let sym_cal_l = Group_stem_interface_v.make sym_sss in
...
let make sym_sss soi_gro =
  let tag_cal_l = build_n_store sym_sss soi_gro in
...
let camlline_tag_list_off_group_stem_formula for_sss =

;;

let camlline_tag_list_off_group_stem_tag tag_sss =
  let for_sss = retrieve tag_sss in
  camlline_tag_list_off_group_stem_formula for_sss
;; 

(** {6 Iterating_for_formula_stem.} *)

let map f_of_tag_cal for_sss = 
  let tag_cal_l = camlline_tag_list_off_group_stem_formula for_sss in
  List.map f_of_tag_cal tag_cal_l
;;

let iter f_of_tag_cal for_sss = 
  let tag_cal_l = camlline_tag_list_off_group_stem_formula for_sss in
  List.iter f_of_tag_cal tag_cal_l ;;

let map2 f_of_tag_cal for_sss_1 for_sss_2  = 
  let tag_cal_l_1 = camlline_tag_list_off_group_stem_formula for_sss_1 in
  let tag_cal_l_2 = camlline_tag_list_off_group_stem_formula for_sss_2 in
  List.map2 f_of_tag_cal tag_cal_l_1 tag_cal_l_2
;;

let iter2 f_of_tag_cal for_sss_1 for_sss_2 = 
  let tag_cal_l_1 = camlline_tag_list_off_group_stem_formula for_sss_1 in
  let tag_cal_l_2 = camlline_tag_list_off_group_stem_formula for_sss_2 in
