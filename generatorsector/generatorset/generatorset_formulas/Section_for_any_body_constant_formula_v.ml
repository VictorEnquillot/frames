(** {3 Section_for_any_body_constant_formula_v} *)
...
let symbol_of_formula for_sbc = 
  match for_sbc with
  | Section_for_any_body_constant_formula_t.Section_for_any_body_constant_empty ->
      Section_for_any_body_constant_symbol_t.Section_for_any_body_constant_empty 
;;
...
let name for_sbc =
  ...
  Section_for_any_body_constant_symbol_v.name sym_sbc
;;
(* ***
let longname for_sbc =
  let sym_sbc = symbol_of_formula for_sbc in
  Section_for_any_body_constant_symbol_v.longname sym_sbc
;;

let string_off for_sbc =
  let sym_sbc = symbol_of_formula for_sbc in
  Section_for_any_body_constant_symbol_v.string_off sym_sbc
;;
...
let group_tag_list_off_section_for_any_body_constant_formula for_sbc = 
  match for_sbc with
  | Section_for_any_body_constant_formula_t.Section_for_any_body_constant_empty ->
      []
;;
...
let camlline_tag_list_off_section_node_formula for_sbc =
  let tag_gro_l = 
    group_tag_list_off_section_for_any_body_constant_formula
      for_sbc
  in
...
let map f for_sbc = 
  let tag_gro_l = group_tag_list_off_section_for_any_body_constant_formula for_sbc in
...
let map2 f for_sbc_1 for_sbc_2  = 
  let tag_gro_l_1 = group_tag_list_off_section_for_any_body_constant_formula for_sbc_1 in
  let tag_gro_l_2 = group_tag_list_off_section_for_any_body_constant_formula for_sbc_2 in
