(** {3 Camlline_for_any_uno_camltype_son_bare_formula_v} *)
...
let documentation () = 
  [
   "Needs : IGNR:";
   "Current : FGNR:Camlline_for_any_uno_camltype_son_bare_formula_v";
...
let symbol_of_formula for_cuc =
  match for_cuc with
  | Camlline_for_any_uno_camltype_son_bare_formula_t.Pipe_es _ -> 
...
let name for_cuc = 
  ...
  Camlline_for_any_uno_camltype_son_bare_symbol_v.name sym_cuc
;;
(* ***

let string_off for_cuc =
  let sym_cuc = symbol_of_formula for_cuc in
  Camlline_for_any_uno_camltype_son_bare_symbol_v.string_off sym_cuc
;;

let longname for_cuc =
  Format.sprintf "Camlline_for_any_uno_camltype_son_bare_formula_t.%s" 
...
let build_n_store sym_cuc soi_cal =
  ...
  let dec_cuc = 
    Camlline_for_any_uno_camltype_son_bare_tag_v.camlline_for_any_uno_camltype_son_bare_dectup_off_camlline_for_any_uno_camltype_son_bare_tag 
      tag_cuc 
  in
(***
  let idx_gro = Sole_index_v.father_index_off_sole_index soi_cal in
  let sym_ent_tos_l = Tools_ignr_v.entity_topson_bare_symbol_by_group_list_of_dectup dec_cuc in
  let sym_ent_son = 
	...
	(Format.sprintf "None of them for Camlline >%s< when idx_gro = %i" 
	   (Camlline_for_any_uno_camltype_son_bare_symbol_v.name sym_cuc) idx_gro
	)
	"Check"
  in
****)
(* BT builders *)
  ...
  in
  let sym_ent_l = 
    Camlline_for_any_uno_camltype_son_bare_interface_v.make 
      sym_cuc 
      sym_ent_son
  in
...
let make sym_cuc soi_cal =
  ...
  match sym_cuc with 
  | Camlline_for_any_uno_camltype_son_bare_symbol_t.Pipe_es -> 
      Camlline_for_any_uno_camltype_son_bare_formula_t.Pipe_es tag_ent_l
;;
...
let entity_tag_list_off_camlline_for_any_uno_camltype_son_bare_formula for_cuc =
  match for_cuc with
  | Camlline_for_any_uno_camltype_son_bare_formula_t.Pipe_es tag_ent_l ->       tag_ent_l
;;

let entity_tag_list_off_camlline_for_any_uno_camltype_son_bare_tag tag_cuc =
  let for_cuc = retrieve tag_cuc in
  entity_tag_list_off_camlline_for_any_uno_camltype_son_bare_formula for_cuc
;; 

(** {6 Iterating_for_formula_for_any_uno_camltype_son_bare.} *)

let map f_of_tag_ent for_cuc = 
  let tag_ent_l = entity_tag_list_off_camlline_for_any_uno_camltype_son_bare_formula for_cuc in
...
let map2 f_of_tag_ent for_cuc_1 for_cuc_2  = 
  let tag_ent_l_1 = entity_tag_list_off_camlline_for_any_uno_camltype_son_bare_formula for_cuc_1 in
  let tag_ent_l_2 = entity_tag_list_off_camlline_for_any_uno_camltype_son_bare_formula for_cuc_2 in
