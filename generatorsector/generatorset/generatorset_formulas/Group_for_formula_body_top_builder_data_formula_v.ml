(** {3 Group_for_formula_body_top_builder_data_formula_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Needs : IGNR:Group_for_formula_body_top_builder_data_interface_v";
   "Current : FGNR:Group_for_formula_body_top_builder_data_formula_v";
...
let symbol_of_formula for_gbd =
  match for_gbd with
  | Group_for_formula_body_top_builder_data_formula_t.Documentation_list_for_formula _ -> 
...
let longname for_gbd =
  Format.sprintf "Group_for_formula_body_top_builder_data_formula_t.%s" 
...
(***
  ...
  let non_gbd = 
    Group_for_formula_body_top_builder_data_tag_v.group_for_formula_body_top_builder_data_nontup_off_group_for_formula_body_top_builder_data_tag 
      tag_gbd 
  in
***)
  let sym_cal_l = Group_for_formula_body_top_builder_data_interface_v.make sym_gbd in
...
let make sym_gbd soi_gro =
  ...
  match sym_gbd with 
  | Group_for_formula_body_top_builder_data_symbol_t.Documentation_list_for_formula -> 
      Group_for_formula_body_top_builder_data_formula_t.Documentation_list_for_formula tag_cal_l
...
let camlline_tag_list_off_group_for_formula_body_top_builder_data_formula for_gbd =
  match for_gbd with
  | Group_for_formula_body_top_builder_data_formula_t.Documentation_list_for_formula tag_cal_l -> 
      tag_cal_l
;;

let camlline_tag_list_off_group_for_formula_body_top_builder_data_tag tag_gbd =
  let for_gbd = retrieve tag_gbd in
  camlline_tag_list_off_group_for_formula_body_top_builder_data_formula for_gbd
;; 

(** {6 Iterating_for_formula_for_formula_body_top_builder_data.} *)

let map f_of_tag_cal for_gbd = 
  let tag_cal_l = camlline_tag_list_off_group_for_formula_body_top_builder_data_formula for_gbd in
...
let map2 f_of_tag_cal for_gbd_1 for_gbd_2  = 
  let tag_cal_l_1 = camlline_tag_list_off_group_for_formula_body_top_builder_data_formula for_gbd_1 in
  let tag_cal_l_2 = camlline_tag_list_off_group_for_formula_body_top_builder_data_formula for_gbd_2 in
