(** {3 Camlline_uno_function_symbol_failwith_not_a_topson_leaf_et_symbol_make_formula_v} *)
...
let documentation () = 
  [
   "Needs : IGNR:";
   "Current : FGNR:Camlline_uno_function_symbol_failwith_not_a_topson_leaf_et_symbol_make_formula_v";
   "Needed-by : FGNR:";
...
let longname for_cfs =
  Format.sprintf "Camlline_uno_function_symbol_failwith_not_a_topson_leaf_et_symbol_make_t.%s" 
