(** {3 Camlline_uno_function_symbol_with_failure_not_es_symbol_arrow_formula_v} *)
...
let documentation () = 
  [
   "Needs : IGNR:";
   "Current : FGNR:Camlline_uno_function_symbol_with_failure_not_es_symbol_arrow_formula_v";
   "Needed-by : FGNR:";
...
let longname for_cfs =
  Format.sprintf "Camlline_uno_function_symbol_with_failure_not_es_symbol_arrow_t.%s" 
...
let entity_topson_notleaf_symbol_list dec_cfs =
...
let build dec_cfs idx_gro =
  let sym_son_l = entity_topson_notleaf_symbol_list dec_cfs in
