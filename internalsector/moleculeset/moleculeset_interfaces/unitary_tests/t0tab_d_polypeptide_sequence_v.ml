...
testing "0tab_d Polypeptide_sequence_v";;
 
(* toplevel 
   #use "t0tab_d_polypeptide_sequence_v.ml";; 
*)


let sym_plr = Pls_t.Tab_d;;
...
(* : Polypeptide_sequence_t.polypeptide_sequence *
    Polypeptide_sequence_t.polypeptide_sequence *)
=
 [Aas_v.glycine; Aas_v.proline; Aas_v.glycine; Aas_v.alanine;]
);;
