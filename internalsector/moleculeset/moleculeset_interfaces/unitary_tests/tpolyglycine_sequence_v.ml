(** {3 Polyglycine Sequence.} *)

open Make_test_v;;

testing "Polyglycine_sequence_v";;
 
(* toplevel 
   #use "tpolyglycine_sequence_v.ml";; 
*)


let sym_plp = Pls_v.polypeptide_symbol_of_polyglycine_symbol_count Idx_p.three;;
