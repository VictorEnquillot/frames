...
testing "Ggaggg Polypeptide_sequence_v";;
 
(* toplevel 
   #use "tggaggg_polypeptide_sequence_v.ml";; 
*)


let sym_plp = Pls_t.Ggaggg;;
...
(* : Polypeptide_sequence_t.polypeptide_sequence *
    Polypeptide_sequence_t.polypeptide_sequence *)
=
 [Aas_v.glycine; Aas_v.alanine; Aas_v.glycine; Aas_v.glycine; Aas_v.glycine]
);;
...
(* : Polypeptide_sequence_t.polypeptide_sequence *
    Polypeptide_sequence_t.polypeptide_sequence *)
=
[Aas_v.glycine; Aas_v.glycine; Aas_v.alanine;]
);;
...
(* : Polypeptide_sequence_t.polypeptide_sequence *
    Polypeptide_sequence_t.polypeptide_sequence *)
=
 [Aas_v.glycine; Aas_v.glycine; Aas_v.glycine]
);;
