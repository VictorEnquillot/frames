(** {3 Tryptophan Polypeptide_backbone Symbol Formula.} *)

open Make_test_v;;

testing "Trp_polypeptide_backbone Atom_recordpdb_keypdb_and_semipath_v";;

(* toplevel 
   #use "ttrp_polypeptide_backbone_atom_recordpdb_keypdb_and_semipath_v.ml";; 
*)
...
let sym_sdg = Sgs_v.symbol_of_molecule_aminoacid_symbol sym_ama;; (* MetheneIndol *)
