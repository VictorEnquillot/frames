(** {3 0tab_d Polypeptide formula constrained.} *)

open Make_test_v;;

testing "0tab_d Polypeptide_formula_constrained_v";;

(* toplevel 
   #use "t0tab_d_polypeptide_formula_constrained_v.ml";; 
*)
...
(* : string *)
=
"((Zbf_N_h_2C_h_,head),{((P1_Oo_CcocNch_C_h_2,Obf_CcocNch_C_h_),str)[{((P1_Oo_CcocNch_C_h_2,Obf_CcocNch_C_h_),str)[((P0_Oo_CcocNch_C_h_2,Oz_CdodO_h_),str) (Osz_C_h_3,stl)]} (Hbc,stl)]}(Osz_C_h_3,stl))"
);;

test_number 3 (
Polypeptide_formula_constrained_v.retrieve sym_plp
