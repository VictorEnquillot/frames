...
testing "Apg Extended_buried_polypeptide_backbone_fragment_symbol_list_v";;
 
(* toplevel 
   #use "tapg_extended_buried_polypeptide_backbone_fragment_symbol_list_v.ml";; 
*)


let sym_plp = Polypeptide_symbol_t.Apg;;
...
test_number 4 (
Ebb_v.name ebbfs_l
="Obf_CcocNch_C_h_:Obf_CcocNch_C_h_"
);;
