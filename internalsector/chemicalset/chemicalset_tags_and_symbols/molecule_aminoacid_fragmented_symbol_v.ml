...
let nam_mod = "Molecule_aminoacid_fragmented_symbol_v";;
...
let name = function
  | Mafs_t.Proline -> Format.sprintf "%s" "proline"
  | Mafs_t.Molecule_aminoacid_regular_symbol smb_mar -> 
      Mars_v.name smb_mar
;;

let print ppf = function
  | Mafs_t.Proline -> Format.fprintf ppf "%s" "proline"
  | Mafs_t.Molecule_aminoacid_regular_symbol smb_mar -> 
...
let print_fatal_error nam_fun nam_exp nam_fnd =
  Format.fprintf
    ...
    "@.@[<hov>%s.%s: --- Fatal Error ---\
     ...
     @.    found molecule_aminoacid_fragmented_symbol >%s<.\
     @.    cure : check.@]@."
...
let molecule_aminoacid_regular_symbol_off_molecule_aminoacid_fragmented_symbol = function
  | Mafs_t.Molecule_aminoacid_regular_symbol smb_mar -> smb_mar
  | s ->  print_fatal_error
...
let is_molecule_aminoacid_regular_symbol_off_molecule_aminoacid_fragmented_symbol = function
  | Mafs_t.Molecule_aminoacid_regular_symbol _ -> true
  | _ -> false
;;
...
let alanine = molecule_aminoacid_fragmented_symbol_of_molecule_aminoacid_regular_symbol Mars_t.Alanine;;

(** {9 Upgrading from Arginine through Molecule_aminoacid_regular to Molecule_aminoacid_fragmented.} *)

let arginine = molecule_aminoacid_fragmented_symbol_of_molecule_aminoacid_regular_symbol Mars_t.Arginine;;

(** {9 Upgrading from Asparagine through Molecule_aminoacid_regular to Molecule_aminoacid_fragmented.} *)

let asparagine = molecule_aminoacid_fragmented_symbol_of_molecule_aminoacid_regular_symbol Mars_t.Asparagine;;

(** {9 Upgrading from Aspartic through Molecule_aminoacid_regular to Molecule_aminoacid_fragmented.} *)

let aspartic = molecule_aminoacid_fragmented_symbol_of_molecule_aminoacid_regular_symbol Mars_t.Aspartic;;

(** {9 Upgrading from Cysteine through Molecule_aminoacid_regular to Molecule_aminoacid_fragmented.} *)

let cysteine = molecule_aminoacid_fragmented_symbol_of_molecule_aminoacid_regular_symbol Mars_t.Cysteine;;

(** {9 Upgrading from Glutamine through Molecule_aminoacid_regular to Molecule_aminoacid_fragmented.} *)

let glutamine = molecule_aminoacid_fragmented_symbol_of_molecule_aminoacid_regular_symbol Mars_t.Glutamine;;

(** {9 Upgrading from Glutamic through Molecule_aminoacid_regular to Molecule_aminoacid_fragmented.} *)

let glutamic = molecule_aminoacid_fragmented_symbol_of_molecule_aminoacid_regular_symbol Mars_t.Glutamic;;

(** {9 Upgrading from Histidine through Molecule_aminoacid_regular to Molecule_aminoacid_fragmented.} *)

let histidine = molecule_aminoacid_fragmented_symbol_of_molecule_aminoacid_regular_symbol Mars_t.Histidine;;

(** {9 Upgrading from Isoleucine through Molecule_aminoacid_regular to Molecule_aminoacid_fragmented.} *)

let isoleucine = molecule_aminoacid_fragmented_symbol_of_molecule_aminoacid_regular_symbol Mars_t.Isoleucine;;

(** {9 Upgrading from Leucine through Molecule_aminoacid_regular to Molecule_aminoacid_fragmented.} *)

let leucine = molecule_aminoacid_fragmented_symbol_of_molecule_aminoacid_regular_symbol Mars_t.Leucine;;

(** {9 Upgrading from Lysine through Molecule_aminoacid_regular to Molecule_aminoacid_fragmented.} *)

let lysine = molecule_aminoacid_fragmented_symbol_of_molecule_aminoacid_regular_symbol Mars_t.Lysine;;

(** {9 Upgrading from Methionine through Molecule_aminoacid_regular to Molecule_aminoacid_fragmented.} *)

let methionine = molecule_aminoacid_fragmented_symbol_of_molecule_aminoacid_regular_symbol Mars_t.Methionine;;

(** {9 Upgrading from Phenylalanine through Molecule_aminoacid_regular to Molecule_aminoacid_fragmented.} *)

let phenylalanine = molecule_aminoacid_fragmented_symbol_of_molecule_aminoacid_regular_symbol Mars_t.Phenylalanine;;

(** {9 Upgrading from Serine through Molecule_aminoacid_regular to Molecule_aminoacid_fragmented.} *)

let serine = molecule_aminoacid_fragmented_symbol_of_molecule_aminoacid_regular_symbol Mars_t.Serine;;

(** {9 Upgrading from Threonine through Molecule_aminoacid_regular to Molecule_aminoacid_fragmented.} *)

let threonine = molecule_aminoacid_fragmented_symbol_of_molecule_aminoacid_regular_symbol Mars_t.Threonine;;

(** {9 Upgrading from Tryptophan through Molecule_aminoacid_regular to Molecule_aminoacid_fragmented.} *)

let tryptophan = molecule_aminoacid_fragmented_symbol_of_molecule_aminoacid_regular_symbol Mars_t.Tryptophan;;

(** {9 Upgrading from Tyrosine through Molecule_aminoacid_regular to Molecule_aminoacid_fragmented.} *)

let tyrosine = molecule_aminoacid_fragmented_symbol_of_molecule_aminoacid_regular_symbol Mars_t.Tyrosine;;

(** {9 Upgrading from Valine through Molecule_aminoacid_regular to Molecule_aminoacid_fragmented.} *)

let valine = molecule_aminoacid_fragmented_symbol_of_molecule_aminoacid_regular_symbol Mars_t.Valine;;

(** created by ./do_entitysum_symbol_v_ml.sh molecule_aminoacid_fragmented 12 January 2011. *)
