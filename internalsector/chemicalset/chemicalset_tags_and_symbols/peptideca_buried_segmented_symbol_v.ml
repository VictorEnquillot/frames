...
let nam_mod = "Peptideca_buried_segmented_symbol_v";;
...
let name = function
  | Pbss_t.Molecule_aminoacid_glycine -> Format.sprintf "%s" "molecule_aminoacid_glycine"
;;

let print ppf = function
  | Pbss_t.Molecule_aminoacid_glycine -> Format.fprintf ppf "%s" "molecule_aminoacid_glycine"
;;
...
(** created by ./do_entitysum_symbol_v_ml.sh peptideca_buried_segmented 12 January 2011. *)
