...
module Ast_t = Chemicalset_tag_t
module Ast_v = Chemicalset_tag_v
...
module Mlt_t = Molecule_tag_t
module Mlt_v = Molecule_tag_v
...
=
{Tag_t.symbol =
  Chemicalset_tag_t.Css_t.Molecule_symbol
   (Chemicalset_tag_t.Css_t.Mls_t.Molecule_aminoacid_symbol
     (Chemicalset_tag_t.Css_t.Mls_t.Aas_t.Regular_symbol
       Chemicalset_tag_t.Css_t.Mls_t.Aas_t.Isoleucine));
 Tag_t.index =
  Chemicalset_tag_t.CsS_t.Molecule_index
   (Chemicalset_tag_t.CsS_t.MlS_t.Chemical_index
     (Chemicalset_tag_t.CsS_t.MlS_t.ChS_t.Protonation_index
       Protonation_index_t.Zwitterion));
 Tag_t.state = Chemicalset_tag_t.Csi_t.Molecule_state (Ordinal_p.three)}
);;
