...
ocamlc -warn-error A -g \
-o ghostset_generate_symbols_${file}.byt  \
Do_ghostset_symbols_${file}.cmo

echo "ghostset_generate_symbols_${file}.byt done"

ls -alt ghostset_generate_symbols_${file}.byt