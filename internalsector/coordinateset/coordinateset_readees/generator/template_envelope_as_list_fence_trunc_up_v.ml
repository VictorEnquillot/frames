...
let documentation () = 
  [
   "Current : VPAR:This_envelope_v";
   "Needs : VPAR:Coeup_symbol_v";
   "Needs : VPAR:Readee_by_this_tag_provider_v";
   "Needed-by : ";
   "Definition : an Envelopee = (Tagged_readee) is a Elementary_envelopee = Coordinate_envelopee | Parameter_envelopee";
   "Definition : a  Parameter_envelopee = (Coeup_tag, Readee). It is NOT coerced";
   ...
   "What-is-it : one element list of itself Coerced Up to Coeup";
...
let readee_of_tag tag_ttt =
  Readee_by_this_tag_provider_v.provide tag_ttt
;;

(** {6 Parameter_envelopee of Tag} *)

let parameter_envelopee_of_tag tag_ttt =
  let tag_psf = coerce_up_of_tag tag_ttt in
  let rea = readee_of_tag tag_ttt in
  Doublet_v.make tag_psf rea
;;
...
(** {9 Coeup_tag off Envelope} *)

let coeup_tag_off_envelope env_ttt =
  let eee_par = parameter_envelopee_off_envelope env_ttt in
  Parameter_envelopee_v.coeup_tag_off_parameter_envelopee eee_par
;;
