...
Coeup=`capitalize_first.sh ${coeup}`
Coeupup=`capitalize_first.sh ${coeupup}`
...
sed -e "s/this/$this/g"     -e "s/ttt/$ttt/g" -e "s/This/$This/g" \
    ...
    -e "s/coeupup/$coeupup/g" -e "s/Coeupup/$Coeupup/g" -e "s/cuu/$cuu/g" \
    -e "s/coeup/$coeup/g" -e "s/Coeup/$Coeup/g" -e "s/cup/$cup/g" \
