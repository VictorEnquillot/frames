(** {3 Measure_by_coordinate_set_fence_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : RCOO:Measure_by_coordinate_set_fence_tag_register_v";
   "Needed-by: ";
   "Author : François Colonna 03 juin 2017 at 12:33:06+02:00";
...
let register : 
    (Coordinate_set_fence_tag_t.coordinate_set_fence_tag,
     Measure_t.measure
    ) 
    Register_t.register = 
...
let name_of_key key =
  Coordinate_set_fence_tag_v.fullname key
;;

let name_of_value val_ =
    Measure_v.fullname val_
;;
