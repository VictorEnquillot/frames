...
testing "Coordinate_set_body_tuple_homogeneous_envelope_tuple_by_coordinate_set_body_tuple_tag_provider_v with
        Coordinate_set_body_tuple_homogeneous_envelope_tuple_by_coordinate_set_body_tuple_tag_provider_u_point_a.ml";;
...
(* toplevel 
   #use "Coordinate_set_body_tuple_homogeneous_envelope_tuple_by_coordinate_set_body_tuple_tag_provider_u_point_a.ml";;
...
test_number 7 (
(env_coo :  (Coordinate_set_fence_symbol_t.coordinate_set_fence_symbol,
   Readee_t.readee)
