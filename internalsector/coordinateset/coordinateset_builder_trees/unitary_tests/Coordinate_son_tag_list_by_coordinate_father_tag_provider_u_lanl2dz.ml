...
(* toplevel 
   #use "Coordinate_son_tag_list_by_coordinate_father_tag_provider_u_lanl2dz.ml";; 
...
let soi_db1 = Tag_v.sole_index_off_tag tag_db1_aos;;

let tag_dcb_x = Coordinate_any_category_by_sole_index_extractor_v.coordinate_context_databox_tag_off_sole_index soi_db1;;
