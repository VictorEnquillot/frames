...
testing "Coordinate_context_databox_symbol_by_any_sole_index_provider_v with
    Coordinate_context_databox_symbol_by_any_sole_index_provider_u_any.ml";;
...
(* toplevel 
   #use "Coordinate_context_databox_symbol_by_any_sole_index_provider_u_any.ml";; 

*)


open Coordinate_context_databox_symbol_by_any_sole_index_provider_v;;
...
let nam_nbo = 
    Coordinate_context_databox_name_by_any_sole_index_provider_v.provide 
      soi_any;;
...
let sym_nbo = Coordinate_context_databox_symbol_v.coordinate_context_databox_constructor 
      nam_nbo;;
