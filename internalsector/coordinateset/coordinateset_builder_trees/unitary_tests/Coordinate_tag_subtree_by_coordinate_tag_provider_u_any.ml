...
testing "Coordinate_tag_subtree_by_coordinate_tag_provider_v with
...
(* toplevel 
   #use "Coordinate_tag_subtree_by_coordinate_tag_provider_u_any.ml";; 

*)

open Coordinate_tag_subtree_by_coordinate_tag_provider_v;;
...
let tag_dbo = Coordinate_any_category_by_sole_index_extractor_v.coordinate_context_databox_tag_off_sole_index soi_coo;;
...
let tag_coo_t = Coordinate_tag_tree_by_coordinate_context_databox_tag_provider_v.provide tag_dbo;;

let tag_coo_st = Tree_v.subtree_of_node_predicate_off_tree (fun t -> t = tag_coo) tag_coo_t;;

test_number 4 (
(tag_coo_st : Coordinate_symbol_t.coordinate_symbol Tag_t.tag Tree_t.tree ) =
  Tree_t.Inner
   ((Coordinate_symbol_t.Coordinate_set_symbol
      (Coordinate_set_symbol_t.Coordinate_set_body_symbol
        (Coordinate_set_body_symbol_t.Coordinate_set_body_tuple_symbol
...
let tag_lea_l = Tree_v.leaf_node_list_off_tree tag_coo_st;;

test_number 5 (
( tag_lea_l : Coordinate_symbol_t.coordinate_symbol Tag_t.tag list ) =
  [(Coordinate_symbol_t.Coordinate_set_symbol
     (Coordinate_set_symbol_t.Coordinate_set_fence_symbol
       (Coordinate_set_fence_symbol_t.Coordinate_set_fence_heterogeneous_symbol
         (Coordinate_set_fence_heterogeneous_symbol_t.Coordinate_set_fence_heterogeneous_spherical_symbol
...
let tag_fen = List.filter (fun (s, i) -> (Coordinate_symbol_v.is_coordinate_set_fence_symbol_off_coordinate_symbol s) )  tag_lea_l;;

test_number 6 (
tag_fen = tag_lea_l
);;

let tag_fen_csp = List_v.only_element_of_predicate_off_list 
    (fun (s, i) -> Coordinate_symbol_v.is_coordinate_set_fence_heterogeneous_spherical_phi_constructor s)
    tag_fen;;

let tag_pat_csp = List.rev (Tree_v.path_of_node_predicate_off_tree (fun t -> t = tag_fen_csp) tag_coo_t);;

test_number 7 (
( tag_pat_csp : Coordinate_symbol_t.coordinate_symbol Tag_t.tag list ) =
