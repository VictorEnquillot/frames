...
let nam_mod = "Coordinate_tag_tree_by_databox_name_n_database_name_provider_u_any";;


(* toplevel 
   #use "Coordinate_tag_tree_by_databox_name_n_database_name_provider_u_any.ml";; 
...
(soi_coo_cbo_st : Sole_index_t.sole_index Tree_t.tree ) =
  Tree_t.Inner ([10; 1; 5; 5],
   [Tree_t.Inner ([1; 10; 1; 5; 5],
     [Tree_t.Leaf [1; 1; 10; 1; 5; 5]; Tree_t.Leaf [2; 1; 10; 1; 5; 5];
      Tree_t.Leaf [3; 1; 10; 1; 5; 5]])])
);;
