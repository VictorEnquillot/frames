(** {3 Basicname_databox_n_basicname_database_by_coordinate_context_databox_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BCOO:Basicname_databox_n_basicname_database_by_coordinate_context_databox_tag_register_v";
 ]
;;
...
let register : 
    (Coordinate_context_databox_tag_t.coordinate_context_databox_tag,
...
let name_of_key key =
  Coordinate_context_databox_tag_v.fullname key
;;
