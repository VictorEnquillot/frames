(** {3 Coordinate_context_domain_tag_by_unit_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BCOO:Coordinate_context_domain_tag_by_unit_provider_v";
...
let build () =
  ...
  in
  let sym_ecd = 
    Coordinate_context_domain_symbol_v.coordinate_context_domain_constructor 
      nam_dom 
  in
...
(* done with do_provider_without_register.sh Coordinate_context_domain_tag_by_unit_provider_v.ml force on lundi 10 octobre 2016, 09:13:01 (UTC+0200) *)
