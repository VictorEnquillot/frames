(** {3 Coordinate_symbol_by_sole_index_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BCOO:Coordinate_symbol_by_sole_index_register_v";
 ]
;;

(** {6 Register.} *)

let nam_reg = "Coordinate_symbol_by_sole_index_register_v";;
...
let name_of_value val_ =
  Coordinate_symbol_v.fullname val_
;;
...
(* done with do_dddd_symbol_by_sole_index_register.sh force on lundi 10 octobre 2016, 09:13:04 (UTC+0200) *)
