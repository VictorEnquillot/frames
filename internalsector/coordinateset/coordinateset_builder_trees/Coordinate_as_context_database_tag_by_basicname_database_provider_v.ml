(** {3 Coordinate_as_context_database_tag_by_basicname_database_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BCOO:Coordinate_as_context_database_tag_by_basicname_database_provider_v";
   ...
   "Author : François Colonna 29 mars 2017 at 16:15:03+02:00";
 ]
;;
...
let build bna_dba  =
  ...
  let sym_coo_cba = 
    Coordinate_symbol_v.coordinate_context_database_constructor 
      nam_dba
  in
  Tag_v.make sym_coo_cba soi_cba
;;
...
(* done with do_provider_without_register.sh Coordinate_as_context_database_tag_by_basicname_database_provider_v.ml force on lundi 10 octobre 2016, 09:13:00 (UTC+0200) *)
