(** {3 Coordinate_tag_tree_by_coordinate_context_databox_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BCOO:Coordinate_tag_tree_by_coordinate_context_databox_tag_register_v";
...
let register : 
    (
     ...
     Coordinate_tag_t.coordinate_tag Tree_t.tree 
    ) 
    Register_t.register = 
...
let name_of_key key =
  Coordinate_context_databox_tag_v.fullname
    key
;;
