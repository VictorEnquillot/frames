(** {3 Coordinate_tag_subtree_by_coordinate_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BCOO:Coordinate_tag_subtree_by_coordinate_tag_register_v";
   "Author : François Colonna 22 décembre 2016 at 18:55:11+01:00";
 ]
;;
