(** {3 Coordinate_tag_all_list_by_coordinate_context_databox_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BCOO:Coordinate_tag_all_list_by_coordinate_context_databox_tag_register_v";
   "Author : François Colonna 29 mars 2017 at 17:26:41+02:00";
 ]
;;
