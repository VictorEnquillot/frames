(** {3 Coordinate_tag_all_list_by_basicname_databox_n_basicname_database_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BCOO:Coordinate_tag_all_list_by_basicname_databox_n_basicname_database_provider_v";
   "Register : BCOO:Coordinate_tag_all_list_by_basicname_databox_n_basicname_database_register_v";
   "Register : BCOO:Coordinate_creation_module_name_by_sole_index_register_v";
   "Register : BCOO:Coordinate_symbol_by_sole_index_register_v";
...
let store_creation_module_n_symbol nam_mod (bna_dbo, bna_dba) =
  ...
  List.iter 
    (fun (s, i) ->
      Coordinate_creation_module_name_by_sole_index_register_v.store nam_mod i nam_mod; 
      Coordinate_symbol_by_sole_index_register_v.store nam_mod i s;
    )
    tag_db1_l;
...
let store (bna_dbo, bna_dba) tag_db1_l =
  ...
  let pro_cpu = Management_v.entering_of_module_name_of_function_name nam_mod nam_fun in
  Coordinate_tag_all_list_by_basicname_databox_n_basicname_database_register_v.store nam_mod (bna_dbo, bna_dba) tag_db1_l; 
  Management_v.exiting_of_process_times_of_module_name_of_function_name pro_cpu nam_mod nam_fun;
;;
...
let retrieve (bna_dbo, bna_dba) =
  ...
  let pro_cpu = Management_v.entering_of_module_name_of_function_name nam_mod nam_fun in
  let result = 
    Coordinate_tag_all_list_by_basicname_databox_n_basicname_database_register_v.retrieve 
      nam_mod 
      (bna_dbo, bna_dba) 
  in
  Management_v.exiting_of_process_times_of_module_name_of_function_name pro_cpu nam_mod nam_fun;
...
let provide_without_trace (bna_dbo, bna_dba) =
  if Coordinate_tag_all_list_by_basicname_databox_n_basicname_database_register_v.is_stored (bna_dbo, bna_dba)
...
(* done with do_provider_tag_all_list_by_basicname_databox_n_basicname_database.sh force on lundi 10 octobre 2016, 09:13:04 (UTC+0200) *)
