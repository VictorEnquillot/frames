(** {3 Coordinate_tag_tree_by_basicname_databox_n_basicname_database_register_v} *)

(** {6 Documenting} *)

let documentation () = 
[
 "Current : BCOO:Coordinate_tag_tree_by_basicname_databox_n_basicname_database_register_v";
