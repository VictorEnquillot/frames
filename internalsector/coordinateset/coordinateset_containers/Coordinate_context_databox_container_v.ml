(** {3 Coordinate_context_databox_container_v} *)

(** {6 Documenting_for_container} *)

let documentation () = 
  [
   "Current : FCOO:Coordinate_context_databox_container_v";
   ...
   "What-is-it : it is a Bud container of Context sub-Types and thus a List of its Coordinate_set_body_tuple Tag";
...
let name con_dbo =
  List_v.name 
    Coordinate_set_body_tuple_tag_v.name
    con_dbo
;;

let string_off con_dbo =
  List_v.name 
    Coordinate_set_body_tuple_tag_v.string_off
    con_dbo
;;

let longname con_dbo =
  List_v.name 
    Coordinate_set_body_tuple_tag_v.longname
    con_dbo
;;

let fullname con_dbo =
  List_v.name 
    Coordinate_set_body_tuple_tag_v.fullname
    con_dbo
;;
...
let builder_tag_list_of_tag tag_dbo =
  let tag_coo = coerce_up_tag tag_dbo in
...
let builder_tag_tuple_of_tag tag_dbo =
  let tag_bui_l = builder_tag_list_of_tag tag_dbo in
  Tuple_v.tuple_of_list tag_bui_l
;;

(** {9 Building as Builder Tag tuple} *)

let building_of_tag tag_dbo =
  builder_tag_list_of_tag tag_dbo
;;

(** {6 Container} *)

let containee_up_tag_list tag_dbo =
  let tag_bui_l = builder_tag_list_of_tag tag_dbo in
...
let fence_as_list_of_tag tag_dbo =
  let tag_coo = coerce_up_tag tag_dbo in
  Coordinate_fence_by_coordinate_tag_provider_v.provide tag_coo
;;

let fence_as_tuple_of_tag tag_dbo =
  let fen_l = fence_as_list_of_tag tag_dbo in
  Tuple_v.tuple_of_list fen_l
;;

let fence_as_tuple_list_of_tag tag_dbo =
  let fen_l = fence_as_list_of_tag tag_dbo in
  Tuple_list_v.make fen_l
;;

(* generated by ./do_container_as_list_context_bud_1containee_v.sh coordinate_context_databox dbo coordinate_set_body_tuple *)
