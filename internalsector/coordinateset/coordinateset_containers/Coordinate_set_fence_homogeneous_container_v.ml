(** {3 Coordinate_set_fence_homogeneous_container_v} *)

(** {6 Documenting_for_container} *)

let documentation () = 
  [
   "Current : FCOO:Coordinate_set_fence_homogeneous_container_v";
   "Needs : FCOO:Coordinate_set_fence_homogeneous_cartesian_tag_v";
   "Needs : FCOO:Coordinate_set_fence_homogeneous_planar_tag_v";
   "Needs : FCOO:Coordinate_set_fence_homogeneous_linear_tag_v";
   "Needed-by: ";
...
let coerce_up_tag tag_cfh =
  Tag_v.map_entity 
    Coordinate_symbol_v.coordinate_symbol_of_coordinate_set_fence_homogeneous_symbol
    tag_cfh
;;
...
let coerce_down_tag tag_coo =
  Tag_v.map_entity 
    Coordinate_symbol_v.coordinate_set_fence_homogeneous_symbol_off_coordinate_symbol
    tag_coo
;;
...
let container_of_tag tag_cfh =
  ...
  | Coordinate_set_fence_homogeneous_symbol_t.Coordinate_set_fence_homogeneous_cartesian_symbol sym_chc ->
      ...
      let con_chc = Coordinate_set_fence_homogeneous_cartesian_container_v.container_of_tag tag_chc in
      Coordinate_set_fence_homogeneous_container_t.Coordinate_set_fence_homogeneous_cartesian_container con_chc
  ...
  | Coordinate_set_fence_homogeneous_symbol_t.Coordinate_set_fence_homogeneous_planar_symbol sym_chp ->
      ...
      let con_chp = Coordinate_set_fence_homogeneous_planar_container_v.container_of_tag tag_chp in
      Coordinate_set_fence_homogeneous_container_t.Coordinate_set_fence_homogeneous_planar_container con_chp

  | Coordinate_set_fence_homogeneous_symbol_t.Coordinate_set_fence_homogeneous_linear_symbol sym_chl ->
      let tag_chl = Tag_v.make sym_chl soi_cfh in
      let con_chl = Coordinate_set_fence_homogeneous_linear_container_v.container_of_tag tag_chl in
      Coordinate_set_fence_homogeneous_container_t.Coordinate_set_fence_homogeneous_linear_container con_chl
;;
...
let name = function
  | Coordinate_set_fence_homogeneous_container_t.Coordinate_set_fence_homogeneous_cartesian_container con_chc ->
      (Coordinate_set_fence_homogeneous_cartesian_container_v.name con_chc)
        
  | Coordinate_set_fence_homogeneous_container_t.Coordinate_set_fence_homogeneous_planar_container con_chp ->
      (Coordinate_set_fence_homogeneous_planar_container_v.name con_chp)
        
  | Coordinate_set_fence_homogeneous_container_t.Coordinate_set_fence_homogeneous_linear_container con_chl ->
      (Coordinate_set_fence_homogeneous_linear_container_v.name con_chl)
;;

let string_off = function
  | Coordinate_set_fence_homogeneous_container_t.Coordinate_set_fence_homogeneous_cartesian_container con_chc ->
      (Coordinate_set_fence_homogeneous_cartesian_container_v.string_off con_chc)
        
  | Coordinate_set_fence_homogeneous_container_t.Coordinate_set_fence_homogeneous_planar_container con_chp ->
      (Coordinate_set_fence_homogeneous_planar_container_v.string_off con_chp)

  | Coordinate_set_fence_homogeneous_container_t.Coordinate_set_fence_homogeneous_linear_container con_chl ->
      (Coordinate_set_fence_homogeneous_linear_container_v.string_off con_chl)
;;

let longname = function
  | Coordinate_set_fence_homogeneous_container_t.Coordinate_set_fence_homogeneous_cartesian_container con_chc ->
      (Coordinate_set_fence_homogeneous_cartesian_container_v.longname con_chc)
        
  | Coordinate_set_fence_homogeneous_container_t.Coordinate_set_fence_homogeneous_planar_container con_chp ->
      (Coordinate_set_fence_homogeneous_planar_container_v.longname con_chp)

  | Coordinate_set_fence_homogeneous_container_t.Coordinate_set_fence_homogeneous_linear_container con_chl ->
      (Coordinate_set_fence_homogeneous_linear_container_v.longname con_chl)
;;

let fullname = function
  | Coordinate_set_fence_homogeneous_container_t.Coordinate_set_fence_homogeneous_cartesian_container con_chc ->
      (Coordinate_set_fence_homogeneous_cartesian_container_v.fullname con_chc)
        
  | Coordinate_set_fence_homogeneous_container_t.Coordinate_set_fence_homogeneous_planar_container con_chp ->
      (Coordinate_set_fence_homogeneous_planar_container_v.fullname con_chp)

  | Coordinate_set_fence_homogeneous_container_t.Coordinate_set_fence_homogeneous_linear_container con_chl ->
      (Coordinate_set_fence_homogeneous_linear_container_v.fullname con_chl)
;;


(* generated by ./do_container_as_uno_fence_trunc_3sibling_1containee_v.sh coordinate_set_fence_homogeneous cfh coordinate_set_fence_homogeneous_cartesian chc coordinate_set_fence_homogeneous_planar chp coordinate_set_fence_homogeneous_linear chl *)
