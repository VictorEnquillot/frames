(** {3 Coordinate_context_sector_container_v} *)

(** {6 Documenting_for_container} *)

let documentation () = 
  [
   "Current : FCOO:Coordinate_context_sector_container_v";
   "Needs : FCOO:Coordinate_context_domain_tag_v";
   ...
   "What-is-it : it is a Bud container of Context sub-Types and thus a List of its Coordinate_context_domain Tag";
...
let name con_ccs =
  List_v.name 
    Coordinate_context_domain_tag_v.name
    con_ccs
;;

let string_off con_ccs =
  List_v.name 
    Coordinate_context_domain_tag_v.string_off
    con_ccs
;;

let longname con_ccs =
  List_v.name 
    Coordinate_context_domain_tag_v.longname
    con_ccs
;;

let fullname con_ccs =
  List_v.name 
    Coordinate_context_domain_tag_v.fullname
    con_ccs
;;
...
let builder_tag_list_of_tag tag_ccs =
  let tag_coo = coerce_up_tag tag_ccs in
...
let builder_tag_tuple_of_tag tag_ccs =
  let tag_bui_l = builder_tag_list_of_tag tag_ccs in
  Tuple_v.tuple_of_list tag_bui_l
;;

(** {9 Building as Builder Tag tuple} *)

let building_of_tag tag_ccs =
  builder_tag_list_of_tag tag_ccs
;;

(** {6 Container} *)

let containee_up_tag_list tag_ccs =
  let tag_bui_l = builder_tag_list_of_tag tag_ccs in
...
let fence_as_list_of_tag tag_ccs =
  let tag_coo = coerce_up_tag tag_ccs in
  Coordinate_fence_by_coordinate_tag_provider_v.provide tag_coo
;;

let fence_as_tuple_of_tag tag_ccs =
  let fen_l = fence_as_list_of_tag tag_ccs in
  Tuple_v.tuple_of_list fen_l
;;

let fence_as_tuple_list_of_tag tag_ccs =
  let fen_l = fence_as_list_of_tag tag_ccs in
  Tuple_list_v.make fen_l
;;

(* generated by ./do_container_as_list_context_bud_1containee_v.sh coordinate_context_sector ccs coordinate_context_domain *)
