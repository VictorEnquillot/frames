...
testing "Coordinate_set_fence_heterogeneous_cylindrical_coefficient_container_v with
...
(* toplevel 
   #use "Coordinate_set_fence_heterogeneous_cylindrical_coefficient_container_u_point_a.ml";;
...
open Coordinate_set_fence_heterogeneous_cylindrical_coefficient_container_v;; 
     
(* Argument *)

let tag_eac = Tag_v.map_entity Coordinate_symbol_v.coordinate_set_fence_heterogeneous_cylindrical_coefficient_symbol_off_coordinate_symbol tag_coo_eac;;
...
test_number 3 (
tag_coo_eac = coerce_up_tag tag_eac
);;

(** {6 Builder Tag list} *)

let tag_bui_l = builder_tag_list_of_tag tag_eac;;
...
let tag_bui = builder_tag_uno_of_tag tag_eac;;
...
let bug_eac = building_of_tag tag_eac;;

test_number 6 (
(bug_eac : Coordinate_symbol_t.coordinate_symbol Tag_t.tag Uno_t.uno ) =
(Coordinate_symbol_t.Coordinate_fence_symbol
   (Coordinate_fence_symbol_t.Units_symbol
      (Units_symbol_t.Units_length_symbol
         Units_length_symbol_t.Bohr)),
...
let tag_bui_t = builder_tag_tuple_of_tag tag_eac;;
...
let cne_eac = containee_tag_off_builder_tag tag_bui;;
...
test_number 11 (
bug_eac = builder_tag_uno_of_tag tag_eac
);;

(** {6 Containee Tag Datastructures} *)

test_number 12 (
tag_ful = containee_tag_uno_of_tag tag_eac
);;

let tag_ful_t = containee_tag_tuple_of_tag tag_eac;;
...
let fen_eac_l = fence_as_list_of_tag tag_eac;;

test_number 14 (
(fen_eac_l : Coordinate_symbol_t.coordinate_symbol Tag_t.tag list ) =
  [(Coordinate_symbol_t.Coordinate_fence_symbol
     (Coordinate_fence_symbol_t.Units_symbol
       (Units_symbol_t.Units_length_symbol
         Units_length_symbol_t.Bohr)),
...
let fen_eac_u = fence_as_uno_of_tag tag_eac;;

test_number 15 (
(fen_eac_u : Coordinate_symbol_t.coordinate_symbol Tag_t.tag Uno_t.uno ) =
  (Coordinate_symbol_t.Coordinate_fence_symbol
    (Coordinate_fence_symbol_t.Units_symbol
      (Units_symbol_t.Units_length_symbol
        Units_length_symbol_t.Bohr)),
...
let fen_eac_t = fence_as_tuple_of_tag tag_eac;;

test_number 16 (
( fen_eac_t : Coordinate_symbol_t.coordinate_symbol Tag_t.tag Tuple_t.tuple ) =
  Tuple_t.Uno
   (Coordinate_symbol_t.Coordinate_fence_symbol
     (Coordinate_fence_symbol_t.Units_symbol
       (Units_symbol_t.Units_length_symbol
...
let fen_eac_tl = fence_as_tuple_list_of_tag tag_eac;;
