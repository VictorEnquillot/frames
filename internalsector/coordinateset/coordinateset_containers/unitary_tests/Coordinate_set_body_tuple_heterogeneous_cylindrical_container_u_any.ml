...
(* toplevel 
   #use "Coordinate_set_body_tuple_heterogeneous_cylindrical_container_u_any.ml";;
...
(* Argument Coordinate_set_body_tuple_heterogeneous_cylindrical_symbol BC_C *)
...
let tag_chc_bcc_l = List.map
    (Tag_v.map_entity Coordinate_symbol_v.coordinate_set_body_tuple_heterogeneous_cylindrical_symbol_off_coordinate_symbol) tag_coo_chc_bcc_l;;
