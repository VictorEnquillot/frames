...
(* toplevel 
   #use "Coordinate_set_fence_heterogeneous_cylindrical_container_u_point_a.ml";;
...
let tag_epa = Tag_v.map_entity Coordinate_symbol_v.coordinate_set_fence_heterogeneous_cylindrical_symbol_off_coordinate_symbol tag_coo_eac;;
...
test_number 3 (
tag_coo_eac = coerce_up_tag tag_epa
);;

(** {6 Builder Tag list} *)

let tag_bui_l = builder_tag_list_of_tag tag_epa;;
...
let tag_bui = builder_tag_uno_of_tag tag_epa;;
...
let bug_epa = building_of_tag tag_epa;;

test_number 6 (
(bug_epa : Coordinate_symbol_t.coordinate_symbol Tag_t.tag Uno_t.uno ) =
(Coordinate_symbol_t.Coordinate_fence_symbol
   (Coordinate_fence_symbol_t.Units_symbol
      (Units_symbol_t.Units_length_symbol
         Units_length_symbol_t.Bohr)),
...
let tag_bui_t = builder_tag_tuple_of_tag tag_epa;;
...
let cne_epa = containee_tag_off_builder_tag tag_bui;;
...
test_number 11 (
bug_epa = builder_tag_uno_of_tag tag_epa
);;

(** {6 Containee Tag Datastructures} *)

test_number 12 (
tag_ful = containee_tag_uno_of_tag tag_epa
);;

let tag_ful_t = containee_tag_tuple_of_tag tag_epa;;
...
let fen_epa_l = fence_as_list_of_tag tag_epa;;

test_number 14 (
(fen_epa_l : Coordinate_symbol_t.coordinate_symbol Tag_t.tag list ) =
  [(Coordinate_symbol_t.Coordinate_fence_symbol
     (Coordinate_fence_symbol_t.Units_symbol
       (Units_symbol_t.Units_length_symbol
         Units_length_symbol_t.Bohr)),
...
let fen_epa_u = fence_as_uno_of_tag tag_epa;;

test_number 15 (
(fen_epa_u : Coordinate_symbol_t.coordinate_symbol Tag_t.tag Uno_t.uno ) =
  (Coordinate_symbol_t.Coordinate_fence_symbol
    (Coordinate_fence_symbol_t.Units_symbol
      (Units_symbol_t.Units_length_symbol
        Units_length_symbol_t.Bohr)),
...
let fen_epa_t = fence_as_tuple_of_tag tag_epa;;

test_number 16 (
( fen_epa_t : Coordinate_symbol_t.coordinate_symbol Tag_t.tag Tuple_t.tuple ) =
  Tuple_t.Uno
   (Coordinate_symbol_t.Coordinate_fence_symbol
     (Coordinate_fence_symbol_t.Units_symbol
       (Units_symbol_t.Units_length_symbol
...
let fen_epa_tl = fence_as_tuple_list_of_tag tag_epa;;
