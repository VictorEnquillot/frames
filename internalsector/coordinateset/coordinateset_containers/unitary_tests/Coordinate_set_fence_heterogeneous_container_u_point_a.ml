...
testing "Coordinate_set_fence_heterogeneous_container_v with
    Coordinate_set_fence_heterogeneous_container_u_point_a.ml";;
...
(* toplevel 
   #use "Coordinate_set_fence_heterogeneous_container_u_point_a.ml";;

*)

open Coordinate_set_fence_heterogeneous_container_v;; 
...
let tag_cfh = Tag_v.map_entity Coordinate_symbol_v.coordinate_set_fence_heterogeneous_symbol_off_coordinate_symbol tag_coo_rho;;
...
let tag_bui = builder_tag_of_tag tag_cfh;;
...
test_number 6 (
tag_coo = builder_tag_of_tag tag_cfh
);;

(** {6 Builder Tag list} *)

let tag_bui_l = builder_tag_list_of_tag tag_cfh;;
...
let tag_bui = builder_tag_uno_of_tag tag_cfh;;
...
let bug_cfh = building_of_tag tag_cfh;;

test_number 9 (
(bug_cfh : Coordinate_symbol_t.coordinate_symbol Tag_t.tag Uno_t.uno ) =
  (Coordinate_symbol_t.Coordinate_set_symbol
    (Coordinate_set_symbol_t.Coordinate_set_fence_symbol
      (Coordinate_set_fence_symbol_t.Coordinate_set_fence_heterogeneous_symbol
        (Coordinate_set_fence_heterogeneous_symbol_t.Coordinate_set_fence_heterogeneous_spherical_symbol
...
let tag_bui_t = builder_tag_tuple_of_tag tag_cfh;;
...
let con_cfh = container_of_tag tag_cfh;;

test_number 13 (
(con_cfh :
  Coordinate_set_fence_heterogeneous_container_t.coordinate_set_fence_heterogeneous_container ) =
...
let cne_cfh = containee_tag_off_builder_tag tag_bui;;
...
test_number 15 (
bug_cfh = builder_tag_uno_of_tag tag_cfh
);;

(** {6 Containee Tag Datastructures} *)

let tag_con_u = containee_tag_uno_of_tag tag_cfh;;
...
let tag_cne_t = containee_tag_tuple_of_tag tag_cfh;;
...
let fen_cfh_l = fence_as_list_of_tag tag_cfh;;

test_number 18 (
(fen_cfh_l : Coordinate_symbol_t.coordinate_symbol Tag_t.tag list ) =
  [(Coordinate_symbol_t.Coordinate_set_symbol
     (Coordinate_set_symbol_t.Coordinate_set_fence_symbol
       (Coordinate_set_fence_symbol_t.Coordinate_set_fence_heterogeneous_symbol
         (Coordinate_set_fence_heterogeneous_symbol_t.Coordinate_set_fence_heterogeneous_spherical_symbol
...
let fen_cfh_u = fence_as_uno_of_tag tag_cfh;;

test_number 19 (
(fen_cfh_u : Coordinate_symbol_t.coordinate_symbol Tag_t.tag Uno_t.uno ) =
  (Coordinate_symbol_t.Coordinate_set_symbol
    (Coordinate_set_symbol_t.Coordinate_set_fence_symbol
      (Coordinate_set_fence_symbol_t.Coordinate_set_fence_heterogeneous_symbol
        (Coordinate_set_fence_heterogeneous_symbol_t.Coordinate_set_fence_heterogeneous_spherical_symbol
...
let fen_cfh_t = fence_as_tuple_of_tag tag_cfh;;

test_number 20 (
( fen_cfh_t : Coordinate_symbol_t.coordinate_symbol Tag_t.tag Tuple_t.tuple ) =
  Tuple_t.Uno
   (Coordinate_symbol_t.Coordinate_set_symbol
     (Coordinate_set_symbol_t.Coordinate_set_fence_symbol
       (Coordinate_set_fence_symbol_t.Coordinate_set_fence_heterogeneous_symbol
...
let fen_cfh_tl = fence_as_tuple_list_of_tag tag_cfh;;
