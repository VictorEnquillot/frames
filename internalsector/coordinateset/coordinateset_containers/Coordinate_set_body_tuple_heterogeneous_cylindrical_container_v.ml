(** {3 Coordinate_set_body_tuple_heterogeneous_cylindrical_container_v} *)

(** {6 Documenting_for_container} *)

let documentation () = 
  [
   "Current : FCOO:Coordinate_set_body_tuple_heterogeneous_cylindrical_container_v";
   ...
   "Needs : FCOO:Coordinate_set_fence_heterogeneous_cylindrical for son list predicate";
   ...
   "What-is-it : it is a Body Bud container of Border sub-Types and thus a Triplet of (Coordinate_set_fence_heterogeneous_cylindrical_rho_tag, Coordinate_set_fence_heterogeneous_cylindrical_phi_tag, Conee3_tag )";
 ]
;;
...
let name con_chc =
  Triplet_v.name 
    Coordinate_set_fence_heterogeneous_cylindrical_rho_tag_v.name
    Coordinate_set_fence_heterogeneous_cylindrical_phi_tag_v.name
...
let string_off con_chc =
  Triplet_v.name 
    Coordinate_set_fence_heterogeneous_cylindrical_rho_tag_v.string_off
    Coordinate_set_fence_heterogeneous_cylindrical_phi_tag_v.string_off
...
let longname con_chc =
  Triplet_v.name 
    Coordinate_set_fence_heterogeneous_cylindrical_rho_tag_v.longname
    Coordinate_set_fence_heterogeneous_cylindrical_phi_tag_v.longname
...
let fullname con_chc =
  Triplet_v.name 
    Coordinate_set_fence_heterogeneous_cylindrical_rho_tag_v.fullname
    Coordinate_set_fence_heterogeneous_cylindrical_phi_tag_v.fullname
...
let coerce_up_tag tag_chc =
  Tag_v.map_entity 
    Coordinate_symbol_v.coordinate_symbol_of_coordinate_set_body_tuple_heterogeneous_cylindrical_symbol 
    tag_chc
;;
...
let first_containee_tag_off_containee_up_tag tag_cnu =
  ...
  | Coordinate_set_fence_heterogeneous_cylindrical_symbol_t.Coordinate_set_fence_heterogeneous_cylindrical_rho_symbol sym_ccr ->
      Tag_v.make sym_ccr soi_cnu
	
  | _ -> 
      failwith "Not_a_Coordinate_set_fence_heterogeneous_cylindrical_rho_symbol:Coordinate_set_fence_heterogeneous_cylindrical_container_v.first_containee_tag_off_containee_up_tag"
;;
...
let second_containee_tag_off_containee_up_tag tag_cnu =
  ...
  | Coordinate_set_fence_heterogeneous_cylindrical_symbol_t.Coordinate_set_fence_heterogeneous_cylindrical_phi_symbol sym_ccp ->
      Tag_v.make sym_ccp soi_cnu
	
  | _ -> 
      failwith "Not_a_Coordinate_set_fence_heterogeneous_cylindrical_phi_symbol:Coordinate_set_fence_heterogeneous_cylindrical_container_v.seond_containee_tag_off_containee_up_tag"
;;
...
let third_containee_tag_off_containee_up_tag tag_cnu =
  ...
  | _ -> 
      failwith "Not_a_Coordinate_set_fence_heterogeneous_cylindrical_zed_symbol:Coordinate_set_fence_heterogeneous_cylindrical_container_v.third_containee_tag_off_containee_up_tag"
;;
...
(* generated by ./do_container_as_triplet_body_bud_3containee_v.sh coordinate_set_body_tuple_heterogeneous_cylindrical chc coordinate_set_fence_heterogeneous_cylindrical_rho ccr coordinate_set_fence_heterogeneous_cylindrical_phi ccp coordinate_set_fence_heterogeneous_cylindrical_zed ccz coordinate_set_fence_heterogeneous_cylindrical *)
