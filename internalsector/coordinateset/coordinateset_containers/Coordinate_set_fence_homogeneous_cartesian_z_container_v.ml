(** {3 Coordinate_set_fence_homogeneous_cartesian_z_container_v} *)

(** {6 Documenting_for_container} *)

let documentation () = 
  [
   "Current : FCOO:Coordinate_set_fence_homogeneous_cartesian_z_container_v";
   "Needs : TCOO:Coordinate_set_fence_homogeneous_cartesian_z_tag_v.coordinate_set_fence_homogeneous_cartesian_z_tag_off_coordinate_tag";
   "Needed-by: ";
...
(** {6 Coercing Up Coordinate_set_fence_homogeneous_cartesian_z Tag} *)

let coerce_up_tag tag_ccz =
  Coordinate_set_fence_homogeneous_cartesian_z_tag_v.coordinate_tag_of_coordinate_set_fence_homogeneous_cartesian_z_tag
    tag_ccz
;;

(** {6 Coercing Down Coordinate Tag to Coordinate_set_fence_homogeneous_cartesian_z Tag} *)

let coerce_down_tag tag_coo =
  Coordinate_set_fence_homogeneous_cartesian_z_tag_v.coordinate_set_fence_homogeneous_cartesian_z_tag_off_coordinate_tag
    tag_coo
;;
...
(* generated by ./do_container_as_uno_fence_bud_1containee_v.sh coordinate_set_fence_homogeneous_cartesian_z ccz *)
