(** {3 Coordinate_set_body_tuple_heterogeneous_polar_container_v} *)

(** {6 Documenting_for_container} *)

let documentation () = 
  [
   "Current : FCOO:Coordinate_set_body_tuple_heterogeneous_polar_container_v";
   ...
   "Needs : FCOO:Coordinate_set_fence_heterogeneous_polar : for son list predicate";
   ...
   "What-is-it : it is a Body Bud container of Border sub-Types and thus a Doublet of (Coordinate_set_fence_heterogeneous_polar_rho_tag, Coordinate_set_fence_heterogeneous_polar_theta_tag)";
...
let coerce_up_tag tag_chp =
  Tag_v.map_entity 
    Coordinate_symbol_v.coordinate_symbol_of_coordinate_set_body_tuple_heterogeneous_polar_symbol 
    tag_chp
;;
...
let first_containee_tag_off_containee_up_tag tag_cnu =
  ...
  | Coordinate_set_fence_heterogeneous_polar_symbol_t.Coordinate_set_fence_heterogeneous_polar_rho_symbol sym_cpr ->
      Tag_v.make sym_cpr soi_cnu
	
  | _ -> 
      failwith "Not_a_Coordinate_set_fence_heterogeneous_polar_rho_symbol:Coordinate_set_fence_heterogeneous_polar_container_v.first_containee_tag_off_containee_up_tag"
;;
...
let second_containee_tag_off_containee_up_tag tag_cnu =
  ...
  | Coordinate_set_fence_heterogeneous_polar_symbol_t.Coordinate_set_fence_heterogeneous_polar_theta_symbol sym_cpt ->
      Tag_v.make sym_cpt soi_cnu
	
  | _ -> 
      failwith "Not_a_Coordinate_set_fence_heterogeneous_polar_theta_symbol:Coordinate_set_fence_heterogeneous_polar_container_v.seond_containee_tag_off_containee_up_tag"
;;
...
(* generated by ./do_container_as_doublet_body_bud_2containee_v.sh coordinate_set_body_tuple_heterogeneous_polar chp coordinate_set_fence_heterogeneous_polar_rho cpr coordinate_set_fence_heterogeneous_polar_theta cpt coordinate_set_fence_heterogeneous_polar      *)
