...
let documentation () = 
  [
   ...
   "What-is-it : it is a Body Bud container of Border sub-Types and thus a Singlet of Conee_1_tag";
...
let builder_tag_tuple_of_tag tag_ttt =
  let tag_bui_d = builder_tag_uno_of_tag tag_ttt in
...
let containee_up_tag_uno tag_ttt =
...
let first_containee_tag tag_ttt =
  ...
  Singlet_v.first_off_singlet con_ttt
;;
