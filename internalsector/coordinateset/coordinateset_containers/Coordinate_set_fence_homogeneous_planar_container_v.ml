(** {3 Coordinate_set_fence_homogeneous_planar_container_v} *)

(** {6 Documenting_for_container} *)

let documentation () = 
  [
   "Current : FCOO:Coordinate_set_fence_homogeneous_planar_container_v";
...
let container_of_tag tag_chp =
  ...
  | Coordinate_set_fence_homogeneous_planar_symbol_t.Coordinate_set_fence_homogeneous_planar_x_symbol sym_cpx ->
      let tag_cpx = Tag_v.make sym_cpx soi_chp in
      let con_cpx = Coordinate_set_fence_homogeneous_planar_x_container_v.container_of_tag tag_cpx in
      Coordinate_set_fence_homogeneous_planar_container_t.Coordinate_set_fence_homogeneous_planar_x_container con_cpx

  | Coordinate_set_fence_homogeneous_planar_symbol_t.Coordinate_set_fence_homogeneous_planar_y_symbol sym_cpy ->
      let tag_cpy = Tag_v.make sym_cpy soi_chp in
      let con_cpy = Coordinate_set_fence_homogeneous_planar_y_container_v.container_of_tag tag_cpy in
      Coordinate_set_fence_homogeneous_planar_container_t.Coordinate_set_fence_homogeneous_planar_y_container con_cpy
;;
...
let name = function
  | Coordinate_set_fence_homogeneous_planar_container_t.Coordinate_set_fence_homogeneous_planar_x_container con_cpx ->
      (Coordinate_set_fence_homogeneous_planar_x_container_v.name con_cpx)
        
  | Coordinate_set_fence_homogeneous_planar_container_t.Coordinate_set_fence_homogeneous_planar_y_container con_cpy ->
      (Coordinate_set_fence_homogeneous_planar_y_container_v.name con_cpy)
;;

let string_off = function
  | Coordinate_set_fence_homogeneous_planar_container_t.Coordinate_set_fence_homogeneous_planar_x_container con_cpx ->
      (Coordinate_set_fence_homogeneous_planar_x_container_v.string_off con_cpx)
        
  | Coordinate_set_fence_homogeneous_planar_container_t.Coordinate_set_fence_homogeneous_planar_y_container con_cpy ->
      (Coordinate_set_fence_homogeneous_planar_y_container_v.string_off con_cpy)
;;

let longname = function
  | Coordinate_set_fence_homogeneous_planar_container_t.Coordinate_set_fence_homogeneous_planar_x_container con_cpx ->
      (Coordinate_set_fence_homogeneous_planar_x_container_v.longname con_cpx)
        
  | Coordinate_set_fence_homogeneous_planar_container_t.Coordinate_set_fence_homogeneous_planar_y_container con_cpy ->
      (Coordinate_set_fence_homogeneous_planar_y_container_v.longname con_cpy)
;;

let fullname = function
  | Coordinate_set_fence_homogeneous_planar_container_t.Coordinate_set_fence_homogeneous_planar_x_container con_cpx ->
      (Coordinate_set_fence_homogeneous_planar_x_container_v.fullname con_cpx)
        
  | Coordinate_set_fence_homogeneous_planar_container_t.Coordinate_set_fence_homogeneous_planar_y_container con_cpy ->
      (Coordinate_set_fence_homogeneous_planar_y_container_v.fullname con_cpy)
;;


(* generated by ./do_container_as_uno_fence_trunc_2sibling_1containee_v.sh coordinate_set_fence_homogeneous_planar chp coordinate_set_fence_homogeneous_planar_x cpx coordinate_set_fence_homogeneous_planar_y cpy *)
