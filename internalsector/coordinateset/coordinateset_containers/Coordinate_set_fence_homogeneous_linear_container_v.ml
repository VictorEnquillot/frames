(** {3 Coordinate_set_fence_homogeneous_linear_container_v} *)

(** {6 Documenting_for_container} *)

let documentation () = 
  [
   "Current : FCOO:Coordinate_set_fence_homogeneous_linear_container_v";
...
let builder_tag_of_tag tag_chl =
  coerce_up_tag tag_chl
;;
...
let builder_tag_tuple_of_tag tag_chl =
  let tag_bui_u = builder_tag_uno_of_tag tag_chl in
...
let container_of_tag tag_chl =
  let (sym_chl, soi_chl) = tag_chl in
  match sym_chl with
  | Coordinate_set_fence_homogeneous_linear_symbol_t.Coordinate_set_fence_homogeneous_linear_x_symbol sym_clx ->
      let tag_clx = Tag_v.make sym_clx soi_chl in
      let con_clx = Coordinate_set_fence_homogeneous_linear_x_container_v.container_of_tag tag_clx in
      Coordinate_set_fence_homogeneous_linear_container_t.Coordinate_set_fence_homogeneous_linear_x_container con_clx
;;

(** {6 Containee Tag Datastructure} *)

let containee_tag_uno_of_tag tag_chl =
  container_of_tag tag_chl
;;

(** {6 Containee Tag Tuple} *)

let containee_tag_tuple_of_tag tag_chl =
  let tag_cne_u = containee_tag_uno_of_tag tag_chl in
...
let name = function
  | Coordinate_set_fence_homogeneous_linear_container_t.Coordinate_set_fence_homogeneous_linear_x_container con_clx ->
      (Coordinate_set_fence_homogeneous_linear_x_container_v.name con_clx)
;;

let string_off = function
  | Coordinate_set_fence_homogeneous_linear_container_t.Coordinate_set_fence_homogeneous_linear_x_container con_clx ->
      (Coordinate_set_fence_homogeneous_linear_x_container_v.string_off con_clx)
;;

let longname = function
  | Coordinate_set_fence_homogeneous_linear_container_t.Coordinate_set_fence_homogeneous_linear_x_container con_clx ->
      (Coordinate_set_fence_homogeneous_linear_x_container_v.longname con_clx)
;;

let fullname = function
  | Coordinate_set_fence_homogeneous_linear_container_t.Coordinate_set_fence_homogeneous_linear_x_container con_clx ->
      (Coordinate_set_fence_homogeneous_linear_x_container_v.fullname con_clx)
;;


(* generated by ./do_container_as_uno_fence_trunc_1sibling_1containee_v.sh coordinate_set_fence_homogeneous_linear chl coordinate_set_fence_homogeneous_linear_x clx *)
(* using template_container_as_uno_fence_trunc_1sibling_1containee_v.ml *)
