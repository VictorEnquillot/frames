...
testing "Coordinate_set_body_tuple_measure_conversions_v with
        Coordinate_set_body_tuple_measure_conversions_u_segment_bc.ml";;
...
(* toplevel 
   #use "Coordinate_set_body_tuple_measure_conversions_u_segment_bc.ml";;

*)

open Coordinate_set_body_tuple_measure_conversions_v;;
