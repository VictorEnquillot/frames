(** {3 Global_parameters_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : COM:Global_parameters_register_v";
   "Needed-by :"; 
   "What-is-it :";
   "Invariant :";
 ]
...
let nam_reg = "Global_parameters_register_v";;
...
(* done with do_register.sh on jeudi 19 mai 2016, 19:26:06 (UTC+0200) *)
