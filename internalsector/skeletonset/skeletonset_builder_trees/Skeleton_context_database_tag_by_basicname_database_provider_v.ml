(** {3 Skeleton_context_database_tag_by_basicname_database_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BSKE:Skeleton_context_database_tag_by_basicname_database_provider_v";
...
(* done with do_provider_without_register.sh Skeleton_context_database_tag_by_basicname_database_provider_v.ml force on mercredi 12 octobre 2016, 16:11:20 (UTC+0200) *)
