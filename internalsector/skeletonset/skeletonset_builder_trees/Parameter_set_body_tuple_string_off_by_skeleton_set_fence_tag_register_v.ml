(** {3 Parameter_set_body_tuple_string_off_by_skeleton_set_fence_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BSKE:Parameter_set_body_tuple_string_off_by_skeleton_set_fence_tag_register_v";
   "Author : François Colonna 10 janvier 2017 at 11:51:34+01:00";
 ]
;;
