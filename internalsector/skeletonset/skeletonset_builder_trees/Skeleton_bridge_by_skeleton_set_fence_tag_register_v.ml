(** {3 Skeleton_bridge_by_skeleton_set_fence_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BSKE:Skeleton_bridge_by_skeleton_set_fence_tag_register_v";
   "Author : François Colonna 30 décembre 2016 at 16:56:21+01:00";
 ]
;;
...
let register : 
    (Skeleton_set_fence_tag_t.skeleton_set_fence_tag,
     Parameter_tag_t.parameter_tag
    ) 
    Register_t.register = 
...
let name_of_key key =
  Skeleton_set_fence_tag_v.fullname key
;;

let name_of_value val_ =
  Parameter_tag_v.fullname val_
;;
...
(* done with do_register.sh force on mercredi 12 octobre 2016, 16:11:13 (UTC+0200) *)
