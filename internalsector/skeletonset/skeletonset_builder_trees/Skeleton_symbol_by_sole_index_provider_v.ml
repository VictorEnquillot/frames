...
let documentation () = 
  [
   "Current : BSKE:Skeleton_symbol_by_sole_index_provider_v";
   "Needs : BSKE:Skeleton_symbol_by_sole_index_register_filler_v";
   "Needed-by : BSKE:";
...
(* done with do_dddd_symbol_by_sole_index_provider.sh force on mardi 11 octobre 2016, 15:02:13 (UTC+0200) *)
