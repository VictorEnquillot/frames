(** {3 Skeleton_as_context_databox_tag_by_basicname_databox_n_basicname_database_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BSKE:Skeleton_as_context_databox_tag_by_basicname_databox_n_basicname_database_provider_v";
...
let build (bna_dbo, bna_dba) =
  ...
  let sym_coo_fbo = 
    Skeleton_symbol_v.skeleton_context_databox_constructor 
      nam_dbo
  in
...
(* done with do_provider_without_register.sh Skeleton_as_context_databox_tag_by_basicname_databox_n_basicname_database_provider_v.ml force on mercredi 12 octobre 2016, 16:11:19 (UTC+0200) *)
