(** {3 Skeleton_set_fence_tag_list_by_skeleton_tag_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BSKE:Skeleton_set_fence_tag_list_by_skeleton_tag_provider_v";
   "Register : BSKE:Skeleton_set_fence_tag_list_by_skeleton_tag_register_v";
...
let store tag_ske val_ =
  ...
  Skeleton_set_fence_tag_list_by_skeleton_tag_register_v.store nam_mod tag_ske val_;
...
let retrieve tag_ske =
  ...
  let pro_cpu = Management_v.entering_of_module_name_of_function_name nam_mod nam_fun in
  let result = Skeleton_set_fence_tag_list_by_skeleton_tag_register_v.retrieve nam_mod tag_ske in
  Management_v.exiting_of_process_times_of_module_name_of_function_name pro_cpu nam_mod nam_fun;
  result
;;
...
let provide_without_trace tag_ske =
  if Skeleton_set_fence_tag_list_by_skeleton_tag_register_v.is_stored tag_ske
...
(* done with do_provider_with_register.sh Skeleton_set_fence_tag_list_by_skeleton_tag_provider_v.ml force on mardi 11 octobre 2016, 15:02:07 (UTC+0200) *)
