(** {3 Skeleton_context_sector_tag_by_unit_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BFIG:Skeleton_context_sector_tag_by_unit_provider_v";
   "Needs : BFIG:Skeleton_basicname_sector_by_unit_provider_v";
...
(* done with do_provider_without_register.sh Skeleton_context_sector_tag_by_unit_provider_v.ml force on mercredi 12 octobre 2016, 16:11:21 (UTC+0200) *)
