...
let documentation () = 
  [
   "Current : BSKE:Skeleton_as_context_domain_tag_by_unit_provider_v";
...
let build () =
  ...
  let sym_coo_fcd = 
    Skeleton_symbol_v.skeleton_context_domain_constructor 
      nam_dom 
  in
...
(* done with do_provider_without_register.sh Skeleton_as_context_domain_tag_by_unit_provider_v.ml force on mercredi 12 octobre 2016, 16:11:19 (UTC+0200) *)
