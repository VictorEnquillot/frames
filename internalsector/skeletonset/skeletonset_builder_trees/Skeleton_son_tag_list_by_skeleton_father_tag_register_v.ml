(** {3 Skeleton_son_tag_list_by_skeleton_father_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
[
 "Current : BSKE:Skeleton_son_tag_list_by_skeleton_father_tag_register_v";
 "Needed-by: ";
 "What-is-it: ";
 "How-is-it-done: ";
 "Example: ";
