(** {3 Basicname_databox_n_basicname_database_by_skeleton_context_databox_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BSKE:Basicname_databox_n_basicname_database_by_skeleton_context_databox_tag_register_v";
 ]
;;
...
let name_of_key key =
  Skeleton_context_databox_tag_v.fullname key
;;
