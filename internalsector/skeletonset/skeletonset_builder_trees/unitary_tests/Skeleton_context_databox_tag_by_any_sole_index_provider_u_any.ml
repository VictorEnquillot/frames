...
testing "Skeleton_context_databox_tag_by_any_sole_index_provider_v with
    Skeleton_context_databox_tag_by_any_sole_index_provider_u_any.ml";;
...
(* toplevel 
   #use "Skeleton_context_databox_tag_by_any_sole_index_provider_u_any.ml";; 

*)

open Skeleton_context_databox_tag_by_any_sole_index_provider_v;;
...
let sym_nbo = Skeleton_context_databox_symbol_by_any_sole_index_provider_v.provide soi_any;;

test_number 3 (
(sym_nbo : Skeleton_context_databox_symbol_t.skeleton_context_databox_symbol ) =
