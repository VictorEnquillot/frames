...
testing "Skeleton_symbol_subtree_by_basicname_databox_n_basicname_database_provider_v with
    Skeleton_symbol_subtree_by_basicname_databox_n_basicname_database_provider_u_try_ao_analysis.ml";;
...
(* toplevel 
   #use "Skeleton_symbol_subtree_by_basicname_databox_n_basicname_database_provider_u_try_ao_analysis.ml";; 
...
(tag_pcb : Skeleton_context_databox_symbol_t.skeleton_context_databox_symbol Tag_t.tag ) =
  (Skeleton_context_databox_symbol_t.Skeleton_context_databox_constructor "try_ao",
   [6; 5; 19])
);;
...
(nam_ske_l : string list ) =
 ["Skeleton_symbol_t.Skeleton_context_databox_constructor \"try_ao\"";
   "Skeleton_symbol_t.Skeleton_body_centered_aopefset_anycenter_constructor \"try_ao\"";
   ...
   "Skeleton_symbol_t.Skeleton_body_centered_ecppefset_constructor \"try_ao\""]
);;
