...
test_number 2 (
(sym_ske_eba : Skeleton_symbol_t.skeleton_symbol ) =
...
let tag_ske_eba = Tag_v.make sym_ske_eba soi_eba;;

test_number 3 (
(tag_ske_eba : Skeleton_symbol_t.skeleton_symbol
  Tag_t.tag ) =
  (Skeleton_symbol_t.Skeleton_context_symbol
    (Skeleton_context_symbol_t.Skeleton_context_database_symbol
      (Skeleton_context_database_symbol_t.Skeleton_context_database_constructor
