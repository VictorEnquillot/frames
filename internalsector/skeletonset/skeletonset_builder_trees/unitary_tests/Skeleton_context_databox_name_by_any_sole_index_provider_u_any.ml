...
testing "Skeleton_context_databox_name_by_any_sole_index_provider_v with
    Skeleton_context_databox_name_by_any_sole_index_provider_u_any.ml";;
...
(* toplevel 
   #use "Skeleton_context_databox_name_by_any_sole_index_provider_u_any.ml";; 

*)


open Skeleton_context_databox_name_by_any_sole_index_provider_v;;
