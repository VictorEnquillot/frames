...
testing "Skeleton_tag_tree_by_basicname_databox_n_basicname_database_provider_v with
    Skeleton_tag_tree_by_basicname_databox_n_basicname_database_provider_u_try_ao.ml";;
...
(* toplevel 
   #use "Skeleton_tag_tree_by_basicname_databox_n_basicname_database_provider_u_try_ao.ml";; 
...
test_number 2 (
( sym_ske_sbo_st : Skeleton_symbol_t.skeleton_symbol Tree_t.tree ) =
  Tree_t.Inner
   (Skeleton_symbol_t.Skeleton_context_symbol
     (Skeleton_context_symbol_t.Skeleton_context_databox_symbol
       (Skeleton_context_databox_symbol_t.Skeleton_context_databox_constructor
...
test_number 4 (
(soi_ske_sbo_st : Sole_index_t.sole_index Tree_t.tree ) =
  Tree_t.Inner ([26; 5; 19; 5],
   [Tree_t.Inner ([1; 26; 5; 19; 5],
     [Tree_t.Inner ([1; 1; 26; 5; 19; 5],
       [Tree_t.Inner ([1; 1; 1; 26; 5; 19; 5],
         [Tree_t.Inner ([1; 1; 1; 1; 26; 5; 19; 5],
           [Tree_t.Leaf [1; 1; 1; 1; 1; 26; 5; 19; 5];
            Tree_t.Leaf [2; 1; 1; 1; 1; 26; 5; 19; 5]]);
          Tree_t.Inner ([2; 1; 1; 1; 26; 5; 19; 5],
           [Tree_t.Leaf [1; 2; 1; 1; 1; 26; 5; 19; 5]])]);
        Tree_t.Inner ([2; 1; 1; 26; 5; 19; 5],
         [Tree_t.Inner ([1; 2; 1; 1; 26; 5; 19; 5],
           [Tree_t.Leaf [1; 1; 2; 1; 1; 26; 5; 19; 5];
            Tree_t.Leaf [2; 1; 2; 1; 1; 26; 5; 19; 5]]);
          Tree_t.Inner ([2; 2; 1; 1; 26; 5; 19; 5],
           [Tree_t.Leaf [1; 2; 2; 1; 1; 26; 5; 19; 5]])])])]);
    Tree_t.Leaf [2; 26; 5; 19; 5]])
);;
...
let tag_ske_sba_tsn_l  = Tree_v.root_topson_node_list_off_tree tag_ske_sba_st;;

test_number 5 (
(tag_ske_sba_tsn_l : Skeleton_symbol_t.skeleton_symbol Tag_t.tag list ) =
  [(Skeleton_symbol_t.Skeleton_context_symbol
     (Skeleton_context_symbol_t.Skeleton_context_database_symbol
       (Skeleton_context_database_symbol_t.Skeleton_context_database_constructor
         "nwchem")),
...
let tag_ske_scd_tsn_l  = Tree_v.root_topson_node_list_off_tree tag_ske_scd_st;;

test_number 6 (
(tag_ske_scd_tsn_l : Skeleton_symbol_t.skeleton_symbol Tag_t.tag list ) =
  [(Skeleton_symbol_t.Skeleton_context_symbol
     (Skeleton_context_symbol_t.Skeleton_context_domain_symbol
       (Skeleton_context_domain_symbol_t.Skeleton_context_domain_constructor
         "skeleton")),
...
let tag_ske_he_s_st = Tree_v.subtree_of_node_predicate_off_tree (fun (s, i)  ->
  Skeleton_symbol_v.skeleton_set_body_centered_aopefset_shellsymmetry_constructor "he s" = s)
    tag_ske_t;;

test_number 8 (
(tag_ske_he_s_st : Skeleton_symbol_t.skeleton_symbol Tag_t.tag Tree_t.tree ) =
  Tree_t.Inner
   ((Skeleton_symbol_t.Skeleton_set_symbol
      (Skeleton_set_symbol_t.Skeleton_set_body_symbol
        (Skeleton_set_body_symbol_t.Skeleton_set_body_centered_symbol
