...
testing "Skeleton_context_databox_tag_by_basicname_databox_n_basicname_database_provider_v with
        Skeleton_context_databox_tag_by_basicname_databox_n_basicname_database_provider_u_any.ml";;
...
(* toplevel 
   #use "Skeleton_context_databox_tag_by_basicname_databox_n_basicname_database_provider_u_any.ml";; 

*)

open Skeleton_context_databox_tag_by_basicname_databox_n_basicname_database_provider_v;;

let nam_ebo = "try_ao";;

let nam_eba = "nwchem";;

let nam_qua = Skeleton_context_name_quatuor_by_basicname_databox_n_basicname_database_provider_v.provide
      (nam_ebo, nam_eba) ;;
...
test_number 3 (
(sym_ebo : Skeleton_context_databox_symbol_t.skeleton_context_databox_symbol ) =
  Skeleton_context_databox_symbol_t.Skeleton_context_databox_constructor
   "try_ao"
);;
 
let tag_sbo = Tag_v.make sym_ebo soi_ebo;;

test_number 4 (
(tag_sbo : Skeleton_context_databox_symbol_t.skeleton_context_databox_symbol
  Tag_t.tag ) =
  (Skeleton_context_databox_symbol_t.Skeleton_context_databox_constructor
    "try_ao",
   [16; 5; 20; 5])
...
test_number 5 (
tag_sbo = provide (nam_ebo, nam_eba)
);;
