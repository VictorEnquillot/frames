...
let documentation () = 
  [
   "Current : BSKE:Skeleton_symbol_by_sole_index_register_v";
 ]
;;
...
(* done with do_dddd_symbol_by_sole_index_register.sh force on mardi 11 octobre 2016, 15:02:14 (UTC+0200) *)
