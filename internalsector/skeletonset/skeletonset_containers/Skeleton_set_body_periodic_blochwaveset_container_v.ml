(** {3 Skeleton_set_body_periodic_blochwaveset_container_v} *)

(** {6 Documenting_for_container} *)

let documentation () = 
  [
   "Current : FSKE:Skeleton_set_body_periodic_blochwaveset_container_v";
   ...
   "What-is-it : it is a container of a Bud Type as a List of Skeleton_set_fence_periodic_blochwave_tag";
...
let fence_as_tuple_of_tag tag_sbs =
  ...
  Tuple_v.map
    Skeleton_set_fence_periodic_blochwave_container_v.fence_as_list_of_tag
    tag_cne_t
;;
...
let fence_as_tuple_list_of_tag tag_sbs =
  let tag_cne_l = containee_tag_list_of_tag tag_sbs in
  List_v.map
    Skeleton_set_fence_periodic_blochwave_container_v.fence_as_tuple_of_tag
    tag_cne_l
;;


(* generated by ./do_container_as_list_body_bud_1containee_v.sh skeleton_set_body_periodic_blochwaveset sbs skeleton_set_fence_periodic_blochwave spb *)
