(** {3 Skeleton_context_databox_container_v} *)

(** {6 Documenting_for_container} *)

let documentation () = 
  [
   "Current : FSKE:Skeleton_context_databox_container_v";
   ...
   "Containee_tag : Skeleton_set_body_tag";
   ...
   "What-is-it : it is a container of a Bud Type as a List of Skeleton_set_body_tag";
...
let name con_sds =
  List_v.name 
    Skeleton_set_body_tag_v.name
    con_sds
;;

let string_off con_sds =
  List_v.name 
    Skeleton_set_body_tag_v.string_off
    con_sds
;;

let longname con_sds =
  List_v.name 
    Skeleton_set_body_tag_v.longname
    con_sds
;;

let fullname con_sds =
  List_v.name 
    Skeleton_set_body_tag_v.fullname
    con_sds
;;

(** {6 Coercing Up Tag} *)

let coerce_up_of_tag tag_sds =
  Tag_v.map_entity 
...
let building_of_tag tag_sds =
  let tag_ske = coerce_up_of_tag tag_sds in
  Skeleton_son_tag_list_by_skeleton_father_tag_provider_v.provide tag_ske
;;

(** {6 Builder Tag Datastructures} *)

let builder_tag_list_of_tag tag_sds =
  building_of_tag tag_sds
;;

let builder_tag_tuple_of_tag tag_sds =
  let tag_bui_l = builder_tag_list_of_tag tag_sds in
  Tuple_v.tuple_of_list tag_bui_l
;;

(** {6 Container_of_tag : Containee Datastructure} *)

let container_of_tag tag_sds =
  let bug = building_of_tag tag_sds in
...
let containee_tag_list_of_tag tag_sds =
  container_of_tag tag_sds
;;

let containee_tag_tuple tag_sds =
  let tag_cne_l = containee_tag_list_of_tag tag_sds in
  Tuple_v.tuple_of_list tag_cne_l
;;

(** {6 Fence list *)

let fence_as_list_of_tag tag_sds =
  let tag_ske = coerce_up_of_tag tag_sds in
  Skeleton_fence_by_skeleton_tag_provider_v.provide tag_ske
;;

let fence_as_tuple_of_tag tag_sds =
  let tag_cne_t = containee_tag_tuple tag_sds in
  Tuple_v.map
    Skeleton_set_body_container_v.fence_as_list_of_tag
    tag_cne_t
;;

let fence_as_tuple_list_of_tag tag_sds =
  let tag_cne_l = containee_tag_list_of_tag tag_sds in
  List_v.map
    Skeleton_set_body_container_v.fence_as_tuple_of_tag
    tag_cne_l
;;


(* generated by ./do_container_as_list_context_bud_1containee_v.sh skeleton_context_databox sds skeleton_set_body sbo *)
