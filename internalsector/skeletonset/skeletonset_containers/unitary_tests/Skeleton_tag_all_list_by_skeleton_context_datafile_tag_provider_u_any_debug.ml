...
testing "Skeleton_tag_all_list_by_skeleton_context_datafile_tag_provider_v with
...
(* toplevel 
   #use "Skeleton_tag_all_list_by_skeleton_context_datafile_tag_provider_u_any_debug.ml";; 
...
open Skeleton_tag_all_list_by_skeleton_context_datafile_tag_provider_v;;

let tag_prt_t = 
  Skeleton_tag_tree_by_skeleton_context_datafile_tag_provider_v.provide
    tag_pcb;;
