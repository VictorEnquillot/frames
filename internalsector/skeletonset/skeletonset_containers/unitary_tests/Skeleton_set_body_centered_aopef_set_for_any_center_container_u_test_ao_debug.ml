...
testing "Skeleton_set_body_centered_aopef_set_for_any_center_container_v with
...
(* toplevel 
   #use "Skeleton_set_body_centered_aopef_set_for_any_center_container_u_test_ao_debug.ml";;
...
let pre_tag_pac_sof sof (s, i) = 
  (Skeleton_symbol_v.is_skeleton_set_body_centered_aopef_set_for_any_center_symbol_off_skeleton_symbol s)
    && 
  (Skeleton_symbol_v.string_off s = sof)
;;
 
let sof_pac = "test_ao";;
let tag_prt_pac = List_v.only_element_of_predicate_off_list (pre_tag_pac_sof sof_pac) tag_prt_l;;

test_number 1 (
(tag_prt_pac : Skeleton_symbol_t.skeleton_symbol Tag_t.tag ) =
...
open Skeleton_set_body_centered_aopef_set_for_any_center_container_v;;

(* Argument *)

let tag_pac = Tag_v.map_entity Skeleton_symbol_v.skeleton_set_body_centered_aopef_set_for_any_center_symbol_off_skeleton_symbol tag_prt_pac;;

test_number 2 (  
( tag_pac :
  Skeleton_set_body_centered_aopef_set_for_any_center_symbol_t.skeleton_set_body_centered_aopef_set_for_any_center_symbol
  Tag_t.tag ) =
  (Skeleton_set_body_centered_aopef_set_for_any_center_symbol_t.Skeleton_set_body_centered_aopef_set_for_any_center_constructor
    "test_ao",
   [1; 6; 5; 19])
...
test_number 3 (
tag_prt_pac = coerce_up_tag tag_pac
);;

(** {6 Builder Tag Datastructures : Building} *)

let bug_pac = building_of_tag tag_pac;;
...
let bui_t = builder_tag_tuple tag_pac ;;
...
let con_pac = container_of_tag tag_pac ;;
...
let fen_pac_l = fence_as_list tag_pac;;

test_number 7 (
(fen_pac_l : Skeleton_symbol_t.skeleton_symbol Tag_t.tag list ) =
...
let fen_pac_t = fence_as_tuple tag_pac;;

test_number 8 (
(fen_pac_t : Skeleton_symbol_t.skeleton_symbol Tag_t.tag list Tuple_t.tuple ) =
  Tuple_t.Uno
   [(Skeleton_symbol_t.Skeleton_set_fence_symbol
      (Skeleton_set_fence_symbol_t.Skeleton_set_fence_centered_symbol
        (Skeleton_set_fence_centered_symbol_t.Skeleton_set_fence_centered_aopef_symbol
...
let fen_pac_tl = fence_as_tuple_list tag_pac;;
