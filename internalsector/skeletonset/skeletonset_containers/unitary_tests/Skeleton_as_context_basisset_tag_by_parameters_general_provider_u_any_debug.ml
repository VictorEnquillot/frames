...
testing "Skeleton_as_context_basisset_tag_by_parameters_general_provider_v with
...
(* toplevel 
   #use "Skeleton_as_context_basisset_tag_by_parameters_general_provider_u_any_debug.ml";; 

*)

open Skeleton_as_context_basisset_tag_by_parameters_general_provider_v;;
...
let tag_prt_bas = Skeleton_as_context_basisset_tag_by_database_name_n_basisset_name_provider_v.provide (nam_dba, nam_bas);;
