...
testing "Skeleton_symbol_subtree_by_database_name_n_basisset_name_provider_v with
...
(* toplevel 
   #use "Skeleton_symbol_subtree_by_database_name_n_basisset_name_provider_u_any_debug.ml";; 
...
open Skeleton_symbol_subtree_by_database_name_n_basisset_name_provider_v;;

(* Basisset *)

let tag_pcb = 
  Skeleton_context_datafile_tag_by_database_name_n_basisset_name_provider_v.provide 
    (nam_dba, nam_bas);;
...
let sym_prt_st = Skeleton_symbol_subtree_by_skeleton_context_datafile_tag_provider_v.provide tag_pcb;;

let boo = sym_prt_st = provide (nam_dba, nam_bas);;
