...
testing "Skeleton_set_body_centered_aopef_set_for_one_shell_ordinal_container_v with
...
(* toplevel 
   #use "Skeleton_set_body_centered_aopef_set_for_one_shell_ordinal_container_u_test_ao_debug.ml";;
...
let pre_tag_pso_sof sof (s, i) = 
  (Skeleton_symbol_v.is_skeleton_set_body_centered_aopef_set_for_one_shell_ordinal_symbol_off_skeleton_symbol s)
    && 
  (Skeleton_symbol_v.string_off s = sof)
;;
 
let sof_pso = "he s 1";;
let tag_prt_pso = List_v.only_element_of_predicate_off_list (pre_tag_pso_sof sof_pso) tag_prt_l;;

test_number 1 (
(tag_prt_pso : Skeleton_symbol_t.skeleton_symbol Tag_t.tag ) =
...
open Skeleton_set_body_centered_aopef_set_for_one_shell_ordinal_container_v;;

(* Argument *)

let tag_pso = Tag_v.map_entity Skeleton_symbol_v.skeleton_set_body_centered_aopef_set_for_one_shell_ordinal_symbol_off_skeleton_symbol tag_prt_pso;;

test_number 2 (  
( tag_pso :
 Skeleton_set_body_centered_aopef_set_for_one_shell_ordinal_symbol_t.skeleton_set_body_centered_aopef_set_for_one_shell_ordinal_symbol
  Tag_t.tag ) =
  (Skeleton_set_body_centered_aopef_set_for_one_shell_ordinal_symbol_t.Skeleton_set_body_centered_aopef_set_for_one_shell_ordinal_constructor
    "he s 1",
   [1; 1; 1; 1; 6; 5; 19])
...
test_number 3 (
tag_prt_pso = coerce_up_tag tag_pso
);;

(** {6 Builder Tag Datastructures : Building} *)

let bug_pso = building_of_tag tag_pso;;
...
let bui_t = builder_tag_tuple tag_pso ;;
...
let con_pso = container_of_tag tag_pso ;;
...
let fen_pso_l = fence_as_list tag_pso;;

test_number 7 (
(fen_pso_l : Skeleton_symbol_t.skeleton_symbol Tag_t.tag list ) =
  [(Skeleton_symbol_t.Skeleton_set_fence_symbol
     (Skeleton_set_fence_symbol_t.Skeleton_set_fence_centered_symbol
       (Skeleton_set_fence_centered_symbol_t.Skeleton_set_fence_centered_aopef_symbol
         (Skeleton_set_fence_centered_aopef_symbol_t.Skeleton_set_fence_centered_aopef_constructor
...
let fen_pso_t = fence_as_tuple tag_pso;;

test_number 9 (
(fen_pso_t : Skeleton_symbol_t.skeleton_symbol Tag_t.tag list Tuple_t.tuple ) =
  Tuple_t.Duo
   ([(Skeleton_symbol_t.Skeleton_set_fence_symbol
       (Skeleton_set_fence_symbol_t.Skeleton_set_fence_centered_symbol
         (Skeleton_set_fence_centered_symbol_t.Skeleton_set_fence_centered_aopef_symbol
...
let fen_pso_tl = fence_as_tuple_list tag_pso;;
