...
testing "Skeleton_context_datafile_tag_by_unit_provider_v with
...
(* toplevel 
   #use "Skeleton_context_datafile_tag_by_unit_provider_u_any_debug.ml";; 
...
open Skeleton_context_datafile_tag_by_unit_provider_v;;

let nam_bas = Parameters_general_provider_v.provide "datafile-name";;

let tag_prt_bas = Skeleton_as_context_basisset_tag_by_basisset_name_provider_v.provide nam_bas;;
