(** {3 Skeleton_domain_name_by_unit_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BDB1:Skeleton_domain_name_by_unit_provider_v";
...
(* done with do_provider_without_register.sh Skeleton_domain_name_by_unit_provider_v.ml on jeudi 19 mai 2016, 18:29:52 (UTC+0200) *)
