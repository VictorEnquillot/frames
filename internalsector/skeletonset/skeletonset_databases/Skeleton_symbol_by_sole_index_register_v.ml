(** {3 Skeleton_symbol_by_sole_index_register_v} *)
...
let documentation () = 
  [
   "Needs: ";
   "Current : DSKE:Skeleton_symbol_by_sole_index_register_v";
   "Needed-by: ";
   "What-is-it: ";
   "How-is-it-done: ";
   "Example: ";
   "Invariant : the Key list is a Once list";
   "Remark : the Value list is NOT a Once list : the same Symbols are used for any Brother";
 ]
;;
...
let name_of_value val_  =
  Skeleton_symbol_v.fullname val_
;;
