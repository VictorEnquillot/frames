(** {3 Database_name_n_databox_name_by_skeleton_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BNWC:Database_name_n_databox_name_by_skeleton_tag_register_v";
 ]
;;
...
(* done with do_register.sh on mardi 31 mai 2016, 16:45:45 (UTC+0200) *)
