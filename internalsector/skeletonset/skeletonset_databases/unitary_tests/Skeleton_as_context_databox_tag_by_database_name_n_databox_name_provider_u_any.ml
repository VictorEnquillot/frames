...
testing "Skeleton_as_context_databox_tag_by_database_name_n_databox_name_provider_v with
...
(* toplevel 
   #use "Skeleton_as_context_databox_tag_by_database_name_n_databox_name_provider_u_any.ml";; 

*)

open Skeleton_as_context_databox_tag_by_database_name_n_databox_name_provider_v;;
...
let sym_ske_bas = Skeleton_symbol_v.skeleton_context_databox_constructor nam_bas;;
...
let tag_ske_bas = Tag_v.make sym_ske_bas soi_bas;;
...
let boo = tag_ske_bas = provide (nam_dba, nam_bas);;
