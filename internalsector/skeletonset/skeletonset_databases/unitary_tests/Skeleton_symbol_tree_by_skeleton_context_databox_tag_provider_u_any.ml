...
testing "Skeleton_symbol_tree_by_skeleton_context_databox_tag_provider_v with
    Skeleton_symbol_tree_by_skeleton_context_databox_tag_provider_u_any.ml";;
...
(* toplevel 
   #use "Skeleton_symbol_tree_by_skeleton_context_databox_tag_provider_u_any.ml";; 
...
open Skeleton_symbol_tree_by_skeleton_context_databox_tag_provider_v;;
...
let sof_dcb = Skeleton_context_databox_tag_v.string_off tag_dcb ;;
let sym_ske_bas = Skeleton_symbol_v.skeleton_context_databox_constructor sof_dcb;; 

test_number 2 (
(sym_ske_bas : Skeleton_symbol_t.skeleton_symbol ) =
...
let tag_dgn_l = 
  Dgn_tag_all_list_by_skeleton_context_databox_tag_provider_v.provide
    tag_dcb;;
...
let nam_cen = "ne";;
let sym_ske_cen = Skeleton_symbol_v.skeleton_body_centered_aopefset_onecenter nam_cen;;

test_number 5 (
(sym_ske_cen : Skeleton_symbol_t.skeleton_symbol ) =
   ...
   (Skeleton_symbol_t.Skeleton_body_symbol
     (Skeleton_body_symbol_t.Skeleton_body_centered_symbol
       (Skeleton_body_centered_symbol_t.Skeleton_body_centered_aopef_symbol
         (Skeleton_body_centered_aopef_symbol_t.Skeleton_body_centered_aopefset_onecenter
           "ne"))))
);;
...
let she_sym_l = shell_symmetry_list_of_skeleton_as_center_symbol sym_ske_cen;;
...
let sof_ske_ssy_l = skeleton_as_shell_symmetry_string_off_list_of_skeleton_as_center_symbol sym_ske_cen;;

test_number 8 (
(sof_ske_ssy_l : string list ) = 
["ne s"; "ne p"]
);;

let sym_ske_ssy_l = skeleton_as_shell_symmetry_symbol_list_of_skeleton_as_center_symbol sym_ske_cen;;
 
test_number 9 (
(sym_ske_ssy_l : Skeleton_symbol_t.skeleton_symbol list ) =
  [Skeleton_symbol_t.Skeleton_symbol
    (Skeleton_symbol_t.Skeleton_body_symbol
      (Skeleton_body_symbol_t.Skeleton_body_centered_symbol
        (Skeleton_body_centered_symbol_t.Skeleton_body_centered_aopef_symbol
          (Skeleton_body_centered_aopef_symbol_t.Skeleton_body_centered_aopefset_shellsymmetry
            "ne s"))));
   Skeleton_symbol_t.Skeleton_symbol
    (Skeleton_symbol_t.Skeleton_body_symbol
      (Skeleton_body_symbol_t.Skeleton_body_centered_symbol
...
let sym_ske_ssy = Skeleton_symbol_v.skeleton_body_centered_aopefset_shellsymmetry "ne s";;

test_number 10 (
( sym_ske_ssy : Skeleton_symbol_t.skeleton_symbol ) =
  Skeleton_symbol_t.Skeleton_symbol
   (Skeleton_symbol_t.Skeleton_body_symbol
     (Skeleton_body_symbol_t.Skeleton_body_centered_symbol
       (Skeleton_body_centered_symbol_t.Skeleton_body_centered_aopef_symbol
...
let sof_ssy = Skeleton_symbol_v.string_off sym_ske_ssy;;
...
let dgn_n_ske_ssy_l = dgn_shell_string_off_n_skeleton_shell_ordinal_string_off_list_of_center_name_of_shell_symmetry nam_cen str_sym;;

test_number 17 (
(dgn_n_ske_ssy_l : (string * string) list ) =
  [("Ne P 4 GAUSSIAN", "ne p 2"); ("Ne P 5 GAUSSIAN", "ne p 3")]
);;

let sym_ske_l = List.map Skeleton_symbol_v.skeleton_body_centered_aopefset_shellordinal  prt_sof_ssy_l;;
...
let sym_ske_sor = Skeleton_symbol_v.skeleton_body_centered_aopefset_shellordinal "ne s 2";;

test_number 22 (
( sym_ske_sor : Skeleton_symbol_t.skeleton_symbol ) =
  Skeleton_symbol_t.Skeleton_symbol
   (Skeleton_symbol_t.Skeleton_body_symbol
     (Skeleton_body_symbol_t.Skeleton_body_centered_symbol
       (Skeleton_body_centered_symbol_t.Skeleton_body_centered_aopef_symbol
...
let son_l = skeleton_as_aopef_single_scaled_symbol_list_of_skeleton_as_a_shell_ordinal_symbol sym_ske_sor;;
...
( son_l : Skeleton_symbol_t.skeleton_symbol list ) =
  [Skeleton_symbol_t.Skeleton_symbol
    (Skeleton_symbol_t.Skeleton_body_symbol
      (Skeleton_body_symbol_t.Skeleton_body_centered_symbol
        (Skeleton_body_centered_symbol_t.Skeleton_body_centered_aopef_symbol
          (Skeleton_body_centered_aopef_symbol_t.Skeleton_body_centered_aopef_single_scaled
            "ne s 2 1"))));
   Skeleton_symbol_t.Skeleton_symbol
    (Skeleton_symbol_t.Skeleton_body_symbol
      (Skeleton_body_symbol_t.Skeleton_body_centered_symbol
...
let sym_ske_sor = Skeleton_symbol_v.skeleton_body_centered_aopefset_shellordinal "ne p 2";;
...
let sof_sor = Skeleton_symbol_v.string_off sym_ske_sor;;

let dgn_n_ske_sof_l = dgn_shell_string_off_n_skeleton_shell_ordinal_string_off_list_of_center_name_of_shell_symmetry nam_cen str_sym;;

let sof_dgn = Duo_list_v.left_of_right_off_duo_list sof_sor dgn_n_ske_sof_l;;
...
let sym_ske_ssy = Skeleton_symbol_v.skeleton_body_centered_aopefset_shellsymmetry "au s";;
...
let sym_ske_sor = Skeleton_symbol_v.skeleton_body_centered_aopefset_shellordinal "au s 2";;
...
let sym_ske_sor = Skeleton_symbol_v.skeleton_body_centered_aopefset_shellordinal "au p 2";;
...
let sym_ske_sor = Skeleton_symbol_v.skeleton_body_centered_aopefset_shellordinal sof_sor;;
...
let sym_ske_sor = Skeleton_symbol_v.skeleton_fence_centered_aopef_single_scaled_constructor sof_sor;;
...
let sym_ske_t = skeleton_symbol_subtree_of_skeleton_as_context_databox_symbol sym_ske_bas;;

let tag_dgn_tso_l = Tree_v.root_topson_node_list_off_tree sym_ske_t;;
