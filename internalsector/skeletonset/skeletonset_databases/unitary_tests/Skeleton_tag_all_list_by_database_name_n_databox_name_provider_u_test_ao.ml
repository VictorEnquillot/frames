...
(* toplevel 
   #use "Skeleton_tag_all_list_by_database_name_n_databox_name_provider_u_test_ao.ml";; 
...
let tag_ske_t = Skeleton_tag_tree_by_database_name_n_databox_name_provider_v.provide
      (nam_dba, nam_dbo);;
...
test_number 3 (
tag_ske_l = provide (nam_dba, nam_dbo)
);;
