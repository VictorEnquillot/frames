(** {3 Skeleton_context_databox_tag_by_database_name_n_databox_name_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : DSKE:Skeleton_context_databox_tag_by_database_name_n_databox_name_provider_v";
...
let build (nam_dba, nam_dfi) =
  ...
  then
	...
	Context_databox_nameoffile_by_database_name_n_databox_name_provider_v.provide
      ...
      let sym_ske_dfi = Skeleton_context_databox_symbol_v.skeleton_context_databox_constructor nam_dfi in
...
(* done with do_provider_without_register.sh Skeleton_context_databox_tag_by_database_name_n_databox_name_provider_v.ml on jeudi 19 mai 2016, 18:29:51 (UTC+0200) *)
