...
let documentation () = 
  [
   "Current : DSKE:Database_name_n_databox_name_by_skeleton_tag_provider_v";
   "Register : DSKE:Database_name_n_databox_name_by_skeleton_tag_register_v";
...
let build tag_ske =
  ...
  Database_name_n_databox_name_by_skeleton_context_databox_tag_provider_v.provide tag_sbo 
;;
...
let store tag_ske val_ =
  ...
  Database_name_n_databox_name_by_skeleton_tag_register_v.store nam_mod tag_ske val_;
...
let retrieve tag_ske =
  ...
  let pro_cpu = Management_v.entering_of_module_name_of_function_name nam_mod nam_fun in
  let result = Database_name_n_databox_name_by_skeleton_tag_register_v.retrieve nam_mod tag_ske in
  Management_v.exiting_of_process_times_of_module_name_of_function_name pro_cpu nam_mod nam_fun;
  result
;;
...
let provide_without_trace tag_ske =
  if Database_name_n_databox_name_by_skeleton_tag_register_v.is_stored tag_ske
...
(* done with do_provider_with_register.sh Database_name_n_databox_name_by_skeleton_tag_provider_v.ml on mardi 31 mai 2016, 16:45:31 (UTC+0200) *)
