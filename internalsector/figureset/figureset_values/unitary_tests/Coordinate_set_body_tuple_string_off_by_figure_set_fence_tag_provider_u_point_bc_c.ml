...
(* toplevel 
   #use "Coordinate_set_body_tuple_string_off_by_figure_set_fence_tag_provider_u_point_bc_c.ml";; 
...
let idx_fsf = Sole_index_v.head_index soi_fsf;; 
...
let nam_fig = Figure_name_by_figure_set_fence_tag_provider_v.provide tag_fsf;;
...
let tag_db1_dcv = List_v.only_element_of_predicate_off_list (pre_tag_dcv_sof nam_fig) tag_db1_l;;
...
let soi_db1_drv = Sole_index_v.make idx_fsf soi_db1_dcv;;
