...
(* Triangle_isosceles BC as Figure_field_body_triangle_isosceles *)
...
(tag_fti : Figure_field_body_triangle_isosceles_symbol_t.figure_field_body_triangle_isosceles_symbol Tag_t.tag ) =
  (Figure_field_body_triangle_isosceles_symbol_t.Figure_field_body_triangle_isosceles_constructor "BC", [4; 1; 6])
);;
...
let clo_poi_l = figure_field_fence_point_closure_list_off_figure_field_body_triangle_isosceles_tag tag_fti;;
...
let clo_poi_t = figure_field_fence_point_closure_tuple_off_figure_field_body_triangle_isosceles_tag tag_fti;;
...
let clo_poi_a = figure_field_fence_point_a_closure_off_figure_field_body_triangle_isosceles_tag tag_fti;;
...
let clo_poi_b = figure_field_fence_point_b_closure_off_figure_field_body_triangle_isosceles_tag tag_fti;;
