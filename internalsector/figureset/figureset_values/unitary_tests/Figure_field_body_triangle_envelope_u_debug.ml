...
testing "Figure_field_body_triangle_closure_v with
...
(* toplevel 
   #use "Figure_field_body_triangle_envelope_u_debug.ml";;
...
(tag_fig_tri : Figure_symbol_t.figure_symbol Tag_t.tag ) =
  (Figure_symbol_t.Figure_field_symbol
    (Figure_field_symbol_t.Figure_body_symbol
      (Figure_body_symbol_t.Figure_field_body_triangle_symbol
        (Figure_field_body_triangle_symbol_t.Figure_field_body_triangle_isosceles_symbol
          (Figure_field_body_triangle_isosceles_symbol_t.Figure_field_body_triangle_isosceles_acute
            "T")))),
   [2; 1; 6])
);;

(* Triangle_isosceles_acute T as Figure_field_body_triangle *)

let tag_ftr = Figure_field_body_triangle_tag_v.figure_field_body_triangle_tag_off_figure_tag tag_fig_tri;; 

test_number 3 (
(tag_ftr : Figure_field_body_triangle_symbol_t.figure_field_body_triangle_symbol Tag_t.tag ) =
  (Figure_field_body_triangle_symbol_t.Figure_field_body_triangle_isosceles_symbol
    (Figure_field_body_triangle_isosceles_symbol_t.Figure_field_body_triangle_isosceles_acute "T"),
   [2; 1; 6])
);;

open Figure_field_body_triangle_envelope_v;; 
  
let env_ftr = build tag_ftr;;

test_number 4 (
( env_ftr : Figure_field_body_triangle_envelope_t.figure_field_body_triangle_envelope ) =
  Figure_field_body_triangle_envelope_t.Figure_field_body_triangle_isosceles_envelope
   ([(0.1,
...
let env_fti = figure_field_body_triangle_isosceles_envelope_off_figure_field_body_triangle_envelope env_ftr;;

test_number 7 (
( env_fti :
  Figure_field_body_triangle_isosceles_envelope_t.figure_field_body_triangle_isosceles_envelope ) =
  ([(0.1,
     Elementary_units_symbol_t.Elementary_units_length_symbol
      Elementary_units_length_symbol_t.Nanometer);
    (0.2,
...
test_number 8 (
env_ftr = figure_field_body_triangle_envelope_of_figure_field_body_triangle_isosceles_envelope env_fti
);;
...
let mea_fpo_tl = figure_field_fence_point_measure_tuple_list_off_figure_field_body_triangle_tag tag_ftr;;
...
let mea_fpo_tt = figure_field_fence_point_measure_tuple_tuple_off_figure_field_body_triangle_tag tag_ftr;;
