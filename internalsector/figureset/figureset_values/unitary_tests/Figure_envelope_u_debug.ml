...
(* toplevel 
   #use "Figure_envelope_u_debug.ml";;
...
let env_fig = build tag_fig;;

test_number 3 (
( env_fig : Figure_field_body_triangle_envelope_t.figure_field_body_triangle_envelope ) =
...
let ent_fig = envelope_as_tuple tag_fig ;;

test_number 4 ( 
(ent_fig : Measure_t.measure list Tuple_t.tuple ) =
  Tuple_t.Trio
   ([(0.1,
      Elementary_units_symbol_t.Elementary_units_length_symbol
       Elementary_units_length_symbol_t.Nanometer);
...
let env_fti = figure_field_body_triangle_isosceles_envelope_off_figure_field_body_triangle_envelope env_fig;;
...
test_number 6 (
env_fig = figure_field_body_triangle_envelope_of_figure_field_body_triangle_isosceles_envelope env_fti
);;

let cun_fig = closure_units tag_fig;;

test_number 7 (
( cun_fig : Measure_t.measure list ) =
  [(0.1,
    Elementary_units_symbol_t.Elementary_units_length_symbol
     Elementary_units_length_symbol_t.Nanometer);
   (0.2,
...
let mea_fpo_tl = figure_field_fence_point_measure_tuple_list_off_figure_field_body_triangle_tag tag_fig;;
...
let mea_fpo_tt = figure_field_fence_point_measure_tuple_tuple_off_figure_field_body_triangle_tag tag_fig;;
