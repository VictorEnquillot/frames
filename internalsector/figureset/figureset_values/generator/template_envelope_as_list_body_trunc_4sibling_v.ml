...
let documentation () = 
  [
   ...
   "Needs : VMMM:Sibling_2_envelope_v";
   "Needs : VMMM:Sibling_3_envelope_v";
   "Needs : VMMM:Sibling_4_envelope_v";
   "What-is-it : a Trunc Entity i.e. Up Coercion from its 4 Siblings";
 ]
;;
...
let envelope_of_tag tag_ttt =
  ...
  | This_symbol_t.Sibling_4_symbol sym_sib_4 ->
      let tag_sib_4 = Tag_v.make sym_sib_4 soi_ttt in
      Sibling_4_envelope_v.envelope_of_tag tag_sib_4
;;
...
let border_of_tag tag_ttt =
  ...
  | This_symbol_t.Sibling_2_symbol sym_sib_2 ->
      let tag_sib_2 = Tag_v.make sym_sib_2 soi_ttt in
      Sibling_2_envelope_v.border_of_tag tag_sib_2

  | This_symbol_t.Sibling_3_symbol sym_sib_3 ->
      let tag_sib_3 = Tag_v.make sym_sib_3 soi_ttt in
      Sibling_3_envelope_v.border_of_tag tag_sib_3

  | This_symbol_t.Sibling_4_symbol sym_sib_4 ->
      let tag_sib_4 = Tag_v.make sym_sib_4 soi_ttt in
      Sibling_4_envelope_v.border_of_tag tag_sib_4
;;
...
let closure_of_tag tag_ttt =
  ...
  | This_symbol_t.Sibling_2_symbol sym_sib_2 ->
      let tag_sib_2 = Tag_v.make sym_sib_2 soi_ttt in
      Sibling_2_envelope_v.closure_of_tag tag_sib_2

  | This_symbol_t.Sibling_3_symbol sym_sib_3 ->
      let tag_sib_3 = Tag_v.make sym_sib_3 soi_ttt in
      Sibling_3_envelope_v.closure_of_tag tag_sib_3

  | This_symbol_t.Sibling_4_symbol sym_sib_4 ->
      let tag_sib_4 = Tag_v.make sym_sib_4 soi_ttt in
      Sibling_4_envelope_v.closure_of_tag tag_sib_4
;;
...
let float_list_of_tag tag_ttt  =
  ...
  | This_symbol_t.Sibling_2_symbol sym_sib_2 ->
      let tag_sib_2 = Tag_v.make sym_sib_2 soi_ttt in
      Sibling_2_envelope_v.float_list_of_tag tag_sib_2

  | This_symbol_t.Sibling_3_symbol sym_sib_3 ->
      let tag_sib_3 = Tag_v.make sym_sib_3 soi_ttt in
      Sibling_3_envelope_v.float_list_of_tag tag_sib_3

  | This_symbol_t.Sibling_4_symbol sym_sib_4 ->
      let tag_sib_4 = Tag_v.make sym_sib_4 soi_ttt in
      Sibling_4_envelope_v.float_list_of_tag tag_sib_4
;;
...
let elementary_fence_units_actual_tag_list_of_tag tag_ttt =
  ...
  | This_symbol_t.Sibling_2_symbol sym_sib_2 ->
      let tag_sib_2 = Tag_v.make sym_sib_2 soi_ttt in
      Sibling_2_envelope_v.elementary_fence_units_actual_tag_list_of_tag tag_sib_2

  | This_symbol_t.Sibling_3_symbol sym_sib_3 ->
      let tag_sib_3 = Tag_v.make sym_sib_3 soi_ttt in
      Sibling_3_envelope_v.elementary_fence_units_actual_tag_list_of_tag tag_sib_3

  | This_symbol_t.Sibling_4_symbol sym_sib_4 ->
      let tag_sib_4 = Tag_v.make sym_sib_4 soi_ttt in
      Sibling_4_envelope_v.elementary_fence_units_actual_tag_list_of_tag tag_sib_4
;;
...
let text_of_tag tag_ttt =
  ...
  | This_symbol_t.Sibling_4_symbol sym_sib_4 ->
      let tag_sib_4 = Tag_v.make sym_sib_4 soi_ttt in
      Sibling_4_envelope_v.text_of_tag tag_sib_4
;;
