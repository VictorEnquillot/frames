...
let documentation () = 
  [
   "Current : VFIG:This_envelope_v";
   "Needs : VFIG:This_sibling_1_envelope_v";
   "Needs : VFIG:This_sibling_2_envelope_v";
   "Remark : a Figure Fence Envelope is the same as its Bridge Envelope";
