...
let documentation () = 
  [
   ...
   "Needs : FMMM:This_container_v";
   "Needs : DMMM:Database_name_n_databox_name_by_skeleton_tag_provider_v";
   "Needs : VMMM:Brdup_envelope_v";
   "Remark : a Skeleton Fence Envelope is the same as its Bridge Envelope";
   "What-is-it : This_envelope is a list of Envelopee";
...
let bridge_of_tag tag_yyy =
  let sof_yyy = This_tag_v.string_off tag_yyy in
  ...
  let pre_tag_yyy_sof sof (s, i) = 
    (Elementary_symbol_v.is_brdup_symbol_off_elementary_symbol s)
      && 
...
let bridge_as_brdup_tag_of_tag tag_yyy =
  let tag_ele_yyy = bridge_of_tag tag_yyy in
  Tag_v.map_entity 
    Elementary_symbol_v.brdup_symbol_off_elementary_symbol
    tag_ele_yyy 
;;
...
let envelope_of_tag tag_yyy =
  let bri_yyy = bridge_as_brdup_tag_of_tag tag_yyy in
  Brdup_envelope_v.envelope_of_tag bri_yyy
;;
...
let border_of_tag tag_yyy =
  let bri_yyy = bridge_as_brdup_tag_of_tag tag_yyy in
  Brdup_envelope_v.border_of_tag bri_yyy
;;
