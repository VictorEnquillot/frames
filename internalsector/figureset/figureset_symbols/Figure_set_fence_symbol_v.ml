...
let longname sym_fsf =
  Format.sprintf "Figure_set_fence_symbol_t.%s" (String.capitalize (name sym_fsf))
;;
...
let make_of_topson_notleaf nam s =
  ...
  with Failure "Not_a_figure_set_fence_point_symbol:Figure_set_fence_point_symbol_v.ml:make" ->
...
let make nam s =
  ...
  with Failure "Not_a_topson_bare:Figure_set_fence_symbol_v.ml:make_of_topson_bare" ->
  try make_of_topson_ofstring nam s
  with Failure "Not_a_topson_ofstring:Figure_set_fence_symbol_v.ml:make_of_topson_ofstring" ->
  try make_of_topson_notleaf nam s
  with Failure "Not_a_topson_notleaf:Figure_set_fence_symbol_v.ml:make_of_topson_notleaf" ->
   let _ =
      Error_messages_v.print_error nam_cod "make"
      (Format.sprintf "strings \"%s\" and \"%s\" represent an existing Figure_set_fence subtype" nam s)
      "it does not exists"
      "Check file Figure_set_fence_symbol_v.ml"
    in
    failwith "Not_a_figure_set_fence_symbol:Figure_set_fence_symbol_v.ml:make"
;;
