...
testing "Figure_set_body_triangle closure_v with
   Figure_set_body_triangle_envelope_u_any.ml"
;;

(* toplevel 
   #use "Figure_set_body_triangle_closure_v.ml";; 
...
=
  (Figure_symbol_t.Figure_set_body_triangle_symbol
    (Figure_set_body_triangle_symbol_t.Figure_set_body_triangle_isosceles_symbol
      (Figure_set_body_triangle_isosceles_symbol_t.Figure_set_body_triangle_isosceles_equilateral "T")),
   [1; 1; 3])
);;
...
test_number 5 (
tag_tri 
(* : Figure_set_body_triangle_symbol_t.triangle_symbol Tag_t.tag *)
=
  (Figure_set_body_triangle_symbol_t.Figure_set_body_triangle_isosceles_symbol
    (Figure_set_body_triangle_isosceles_symbol_t.Figure_set_body_triangle_isosceles_equilateral "T"),
   [1; 1; 3])
...
let val_tri = Figure_set_body_triangle_closure_v.retrieve tag_tri;;
