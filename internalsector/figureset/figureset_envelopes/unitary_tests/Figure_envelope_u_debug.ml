...
test_number 3 (
( env_fig : Figure_set_body_triangle_envelope_t.figure_set_body_triangle_envelope ) =
...
let env_fti = figure_set_body_triangle_isosceles_envelope_off_figure_set_body_triangle_envelope env_fig;;
...
test_number 6 (
env_fig = figure_set_body_triangle_envelope_of_figure_set_body_triangle_isosceles_envelope env_fti
);;
...
let mea_fpo_tl = figure_set_fence_point_measure_tuple_list_off_figure_set_body_triangle_tag tag_fig;;
...
let mea_fpo_tt = figure_set_fence_point_measure_tuple_tuple_off_figure_set_body_triangle_tag tag_fig;;
