...
testing "Figure_set_body_segment_closure_v with
...
(* toplevel 
   #use "Figure_set_body_segment_envelope_u_debug.ml";;
...
(* Segment BC as Figure_set_body_segment *)
...
let tag_fse = Figure_set_body_segment_tag_v.figure_set_body_segment_tag_off_figure_tag tag_fig_seg;;

test_number 2 (
(tag_fse : Figure_set_body_segment_symbol_t.figure_set_body_segment_symbol Tag_t.tag ) =
  (Figure_set_body_segment_symbol_t.Figure_set_body_segment_constructor "BC", [1; 1; 6])
);;

open Figure_set_body_segment_envelope_v;;
...
let ent_fpo_l = figure_set_fence_point_envelope_as_tuple_list_off_figure_set_body_segment_tag tag_fse;;
...
let ent_fpo_tt = figure_set_fence_point_envelope_as_tuple_tuple_off_figure_set_body_segment_tag tag_fse;;
...
let ent_fpo_a = figure_set_fence_point_a_envelope_as_tuple_off_figure_set_body_segment_tag tag_fse;;
...
let ent_fpo_b = figure_set_fence_point_b_envelope_as_tuple_off_figure_set_body_segment_tag tag_fse;;
...
let mea_fpo_l = figure_set_fence_point_measure_list_off_figure_set_body_segment_tag tag_fse;;
...
let mea_fpo_t = figure_set_fence_point_measure_tuple_off_figure_set_body_segment_tag tag_fse;;
...
let mea_fpo_tl = figure_set_fence_point_measure_tuple_list_off_figure_set_body_segment_tag tag_fse;;
...
let mea_fpo_tt = figure_set_fence_point_measure_tuple_tuple_off_figure_set_body_segment_tag tag_fse;;
