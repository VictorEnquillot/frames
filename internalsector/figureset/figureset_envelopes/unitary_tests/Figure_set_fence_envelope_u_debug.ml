...
testing "Figure_set_fence_closure_v with
...
(* toplevel 
   #use "Figure_set_fence_envelope_u_debug.ml";;
...
let tag_fpo = Figure_set_fence_point_tag_v.figure_set_fence_point_tag_off_figure_tag tag_fig_poi;;

test_number 2 (
(tag_fpo : Figure_set_fence_point_symbol_t.figure_set_fence_point_symbol Tag_t.tag ) =
  (Figure_set_fence_point_symbol_t.Figure_set_fence_point_constructor "T_A", [1; 2; 1; 6])
);;

let tag_ffe = Figure_set_fence_tag_v.figure_set_fence_tag_off_figure_tag tag_fig_poi;; 

test_number 3 (
(tag_ffe : Figure_set_fence_symbol_t.figure_set_fence_symbol Tag_t.tag ) =
  (Figure_set_fence_symbol_t.Figure_set_fence_point_symbol
    (Figure_set_fence_point_symbol_t.Figure_set_fence_point_constructor "T_A"),
   [1; 2; 1; 6])
);;
...
test_number 4 (
(env_ffe : Figure_set_fence_envelope_t.figure_set_fence_envelope ) =
  Figure_set_fence_envelope_t.Figure_set_fence_point_envelope
   [(0.1,
...
let env_fpo = figure_set_fence_point_envelope_off_figure_set_fence_envelope env_ffe;;

test_number 6 (
(env_fpo : Figure_set_fence_point_envelope_t.figure_set_fence_point_envelope ) =
  [(0.1,
    Elementary_units_symbol_t.Elementary_units_length_symbol
     Elementary_units_length_symbol_t.Nanometer);
   (0.2,
...
test_number 7 (
env_ffe = figure_set_fence_envelope_of_figure_set_fence_point_envelope env_fpo
);;
