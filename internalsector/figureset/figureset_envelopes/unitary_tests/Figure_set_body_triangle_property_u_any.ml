...
module Figure_set_body_triangle_property_v = Figure_set_body_triangle_property_v
...
let per_tri = Figure_set_body_triangle_property_v.perimeter tag_tri;; 
(* let sur_tri = Figure_set_body_triangle_property_v.surface tag_tri;; *)
