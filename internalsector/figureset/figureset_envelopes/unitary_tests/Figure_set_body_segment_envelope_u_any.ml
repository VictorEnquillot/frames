...
testing "Figure_set_body_segment closure_v with
   Figure_set_body_segment_envelope_u_any.ml"
;;

(* toplevel 
   #use "Figure_set_body_segment_closure_v.ml";; 
...
=
 (Figure_symbol_t.Figure_set_body_segment_symbol (Figure_set_body_segment_symbol_t.Figure_set_body_segment_constructor "bc"),
   [1; 1; 3])
);;
...
test_number 5 (
tag_vec 
(* : Figure_set_body_segment_symbol_t.segment_symbol Tag_t.tag *)
=
(Figure_set_body_segment_symbol_t.Figure_set_body_segment_constructor "bc", [1; 1; 3])
);; 

let val_vec = Figure_set_body_segment_closure_v.retrieve tag_vec;;
