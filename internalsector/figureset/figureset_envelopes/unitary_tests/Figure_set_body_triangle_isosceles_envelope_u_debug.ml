...
(* Triangle_isosceles T as Figure_set_body_triangle_isosceles *)
...
(tag_fti : Figure_set_body_triangle_isosceles_symbol_t.figure_set_body_triangle_isosceles_symbol Tag_t.tag ) =
  (Figure_set_body_triangle_isosceles_symbol_t.Figure_set_body_triangle_isosceles_acute "T", [2; 1; 6])
);;
...
let ent_fpo_l = figure_set_fence_point_envelope_as_tuple_list_off_figure_set_body_triangle_isosceles_tag tag_fti;;
...
let ent_fpo_t = figure_set_fence_point_envelope_as_tuple_tuple_off_figure_set_body_triangle_isosceles_tag tag_fti;;
...
let ent_fpo_a = figure_set_fence_point_a_envelope_as_tuple_off_figure_set_body_triangle_isosceles_tag tag_fti;;
...
let mea_fpo_tl = figure_set_fence_point_measure_tuple_list_off_figure_set_body_triangle_isosceles_tag tag_fti;;
...
let mea_fpo_tt = figure_set_fence_point_measure_tuple_tuple_off_figure_set_body_triangle_isosceles_tag tag_fti;;
