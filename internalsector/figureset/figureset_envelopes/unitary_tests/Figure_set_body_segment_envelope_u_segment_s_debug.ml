...
testing "Figure_set_body_segment_envelope_v with
...
(* toplevel 
   #use "Figure_set_body_segment_envelope_u_segment_s_debug.ml";;
...
( tag_fig_l : Figure_symbol_t.figure_symbol Tag_t.tag list ) =
  [(Figure_symbol_t.Figure_context_symbol
   ...
   (Figure_symbol_t.Figure_field_symbol
     (Figure_field_symbol_t.Figure_set_body_symbol
    ...
    [1; 3; 1; 8]);
   (Figure_symbol_t.Figure_field_symbol
     (Figure_field_symbol_t.Figure_set_fence_symbol
...
test_number 2 (
(tag_fbs : Figure_set_body_segment_symbol_t.figure_set_body_segment_symbol Tag_t.tag ) =
...
test_number 4 (
(con_fbs :
  Figure_set_fence_point_symbol_t.figure_set_fence_point_symbol Tag_t.tag
  list ) =
  [(Figure_set_fence_point_symbol_t.Figure_set_fence_point_constructor
     "S_B",
    [1; 1; 3; 1; 8]);
