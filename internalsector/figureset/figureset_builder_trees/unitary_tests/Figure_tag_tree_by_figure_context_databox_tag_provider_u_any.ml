...
(* toplevel 
   #use "Figure_tag_tree_by_figure_context_databox_tag_provider_u_any.ml";; 
...
let tag_fig_rtl = Tree_v.root_topson_node_list_off_tree tag_fig_t;;

test_number 3 (
( tag_fig_rtl : Figure_symbol_t.figure_symbol Tag_t.tag list ) =
