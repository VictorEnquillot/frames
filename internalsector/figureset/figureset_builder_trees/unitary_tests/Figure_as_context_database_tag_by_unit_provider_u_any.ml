...
testing "Figure_as_context_database_tag_by_unit_provider_v with
    Figure_as_context_database_tag_by_unit_provider_u_any.ml";;
...
(* toplevel 
   #use "Figure_as_context_database_tag_by_unit_provider_u_any.ml";; 

*)

open Figure_as_context_database_tag_by_unit_provider_v;;
...
test_number 3 (
(sym_nwc_fba : Figure_symbol_t.figure_symbol ) =
...
let tag_nwc_fba = Tag_v.make sym_nwc_fba soi_dba;;

test_number 4 (
(tag_nwc_fba : Figure_symbol_t.figure_symbol Tag_t.tag ) =
  (Figure_symbol_t.Figure_context_symbol
    (Figure_context_symbol_t.Figure_context_database_symbol
      (Figure_context_database_symbol_t.Figure_context_database_constructor
        "db1points")),
