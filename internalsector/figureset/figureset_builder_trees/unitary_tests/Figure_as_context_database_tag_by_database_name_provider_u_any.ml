...
testing "Figure_as_context_database_tag_by_database_name_provider_v with
...
(* toplevel 
   #use "Figure_as_context_database_tag_by_database_name_provider_u_any.ml";; 

*)

open Figure_as_context_database_tag_by_database_name_provider_v;;
...
let sym_fig_fba = 
  Figure_symbol_v.figure_context_database_constructor 
    nam_fba 
;;

test_number 2 (
(sym_fig_fba : Figure_symbol_t.figure_symbol ) =
...
let tag_fig_fba = Tag_v.make sym_fig_fba soi_fba;;

test_number 3 (
(tag_fig_fba : Figure_symbol_t.figure_symbol
  Tag_t.tag ) =
  (Figure_symbol_t.Figure_context_symbol
    (Figure_context_symbol_t.Figure_context_database_symbol
      (Figure_context_database_symbol_t.Figure_context_database_constructor
