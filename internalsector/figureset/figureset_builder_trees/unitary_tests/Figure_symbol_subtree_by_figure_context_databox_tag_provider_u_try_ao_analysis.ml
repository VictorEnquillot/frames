...
testing "Figure_symbol_subtree_by_figure_context_databox_tag_provider_v with
    Figure_symbol_subtree_by_figure_context_databox_tag_provider_u_segment_BC_analysis.ml";;
...
(* toplevel 
   #use "Figure_symbol_subtree_by_figure_context_databox_tag_provider_u_segment_BC_analysis.ml";; 
