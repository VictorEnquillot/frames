...
testing "Figure_context_sector_tag_by_unit_provider_v with
...
(* toplevel 
   #use "Figure_context_sector_tag_by_unit_provider_u_any.ml";; 

*)

open Figure_context_sector_tag_by_unit_provider_v;;
...
let sym_ncs = 
    Figure_context_sector_symbol_v.figure_context_sector_constructor 
      nam_fcs;;

test_number 3 (
( sym_ncs :
  Figure_context_sector_symbol_t.figure_context_sector_symbol ) =
  Figure_context_sector_symbol_t.Figure_context_sector_constructor
   "internal"
);;
 
let tag_ncs = Tag_v.make sym_ncs soi_fcs;;
