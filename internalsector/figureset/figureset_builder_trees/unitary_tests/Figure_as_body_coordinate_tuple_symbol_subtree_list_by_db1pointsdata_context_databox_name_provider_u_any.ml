...
testing "Figure_as_body_coordinate_tuple_symbol_subtree_list_by_db1pointsdata_context_databox_name_provider_v with
        Figure_as_body_coordinate_tuple_symbol_subtree_list_by_db1pointsdata_context_databox_name_provider_u_any.ml";;
...
(* toplevel 
   #use "Figure_as_body_coordinate_tuple_symbol_subtree_list_by_db1pointsdata_context_databox_name_provider_u_any.ml";; 

*)

open Figure_as_body_coordinate_tuple_symbol_subtree_list_by_db1pointsdata_context_databox_name_provider_v;;
...
let sym_fig_ect_stl = List.map
      (fun n -> 
	Figure_as_body_coordinate_tuple_symbol_subtree_by_vertex_name_n_databox_name_provider_v.provide
	  (n, nam_dbo)
      )
      nam_ver_l;;
...
test_number 4 (
sym_fig_ect_stl = provide nam_dbo
);;
