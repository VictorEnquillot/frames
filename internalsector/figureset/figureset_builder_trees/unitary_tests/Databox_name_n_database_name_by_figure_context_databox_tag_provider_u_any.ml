...
testing "Databox_name_n_database_name_by_figure_context_databox_tag_provider_v with
    Databox_name_n_database_name_by_figure_context_databox_tag_provider_u_any.ml";;
...
(* toplevel 
   #use "Databox_name_n_database_name_by_figure_context_databox_tag_provider_u_any.ml";; 

*)

open Databox_name_n_database_name_by_figure_context_databox_tag_provider_v;;
...
let nam_fbo = Figure_context_databox_tag_v.string_off tag_fbo;;
...
let nam_fba = 
  Database_name_by_figure_context_databox_tag_provider_v.provide 
    tag_fbo;;
...
test_number 4 (
(nam_fbo, nam_fba) = provide tag_fbo
);;
