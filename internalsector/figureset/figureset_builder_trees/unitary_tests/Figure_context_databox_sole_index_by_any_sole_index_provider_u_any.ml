...
testing "Figure_context_databox_sole_index_by_any_sole_index_provider_v with
...
(* toplevel 
   #use "Figure_context_databox_sole_index_by_any_sole_index_provider_u_any.ml";; 

*)


open Figure_context_databox_sole_index_by_any_sole_index_provider_v;;
...
let nam_con_t = Figure_context_name_quatuor_by_basicname_databox_n_basicname_database_provider_v.provide () ;;
