...
testing "Figure_context_databox_symbol_by_any_sole_index_provider_v with
...
(* toplevel 
   #use "Figure_context_databox_symbol_by_any_sole_index_provider_u_any.ml";; 

*)


open Figure_context_databox_symbol_by_any_sole_index_provider_v;;
...
let nam_nbo = 
    Figure_context_databox_name_by_any_sole_index_provider_v.provide 
      soi_any;;
...
let sym_nbo = Figure_context_databox_symbol_v.figure_context_databox_constructor 
      nam_nbo;;
