...
(* toplevel 
   #use "Figure_symbol_tree_by_database_db1_database_tag_provider_u_any.ml";;
...
let tag_dd1_db1 = List.find (fun (s, i) -> Database_db1_symbol_v.is_database_db1_database_symbol_off_database_db1_symbol s) tag_dd1_l;;
...
let tag_dd1_t = Database_db1_tag_tree_by_database_db1_database_tag_provider_v.provide tag_d1d;;
     ...
     [Tree_t.Inner
       ...
       [Tree_t.Leaf
           (Figure_symbol_t.Figure_set_fence_symbol
             (Figure_set_fence_symbol_t.Figure_point_symbol
...
test_number 4 (
(sym_fig_roo : Figure_symbol_t.figure_symbol ) =
Figure_symbol_t.Figure_context_symbol
  (Figure_context_symbol_t.Figure_domain_symbol
     (Figure_domain_symbol_t.Figure_domain_constructor "figure"))
);;
