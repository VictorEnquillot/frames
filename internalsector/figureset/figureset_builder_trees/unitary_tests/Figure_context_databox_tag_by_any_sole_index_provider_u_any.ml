...
testing "Figure_context_databox_tag_by_any_sole_index_provider_v with
...
(* toplevel 
   #use "Figure_context_databox_tag_by_any_sole_index_provider_u_any.ml";; 

*)

open Figure_context_databox_tag_by_any_sole_index_provider_v;;
...
let sym_nbo = Figure_context_databox_symbol_by_any_sole_index_provider_v.provide soi_any;;

test_number 3 (
(sym_nbo : Figure_context_databox_symbol_t.figure_context_databox_symbol ) =
