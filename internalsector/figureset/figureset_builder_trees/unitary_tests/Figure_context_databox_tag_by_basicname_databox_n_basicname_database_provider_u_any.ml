...
testing "Figure_context_databox_tag_by_basicname_databox_n_basicname_database_provider_v with
...
(* toplevel 
   #use "Figure_context_databox_tag_by_basicname_databox_n_basicname_database_provider_u_any.ml";; 

*)

open Figure_context_databox_tag_by_basicname_databox_n_basicname_database_provider_v;;

let nam_fbo = "segment_BC";;

let nam_fba = "db1points";;

let nam_qua = Figure_context_name_quatuor_by_basicname_databox_n_basicname_database_provider_v.provide
      (nam_fbo, nam_fba) ;;
...
let sym_fbo = 
    Figure_context_databox_symbol_v.figure_context_databox_constructor 
      nam_fbo;;

test_number 3 (
(sym_fbo : Figure_context_databox_symbol_t.figure_context_databox_symbol ) =
  Figure_context_databox_symbol_t.Figure_context_databox_constructor
   "segment_BC"
);;
 
let tag_fbo = Tag_v.make sym_fbo soi_fbo;;

test_number 4 (
(tag_fbo : Figure_context_databox_symbol_t.figure_context_databox_symbol
  Tag_t.tag ) =
  (Figure_context_databox_symbol_t.Figure_context_databox_constructor
    "segment_BC",
   [15; 1; 7; 5])
...
test_number 5 (
tag_fbo = provide (nam_fbo, nam_fba)
);;
