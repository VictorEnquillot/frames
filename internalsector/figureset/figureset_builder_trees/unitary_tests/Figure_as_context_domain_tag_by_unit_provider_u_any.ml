...
testing "Figure_as_context_domain_tag_by_unit_provider_v with
...
(* toplevel 
   #use "Figure_as_context_domain_tag_by_unit_provider_u_any.ml";; 

*)

open Figure_as_context_domain_tag_by_unit_provider_v;;
...
test_number 5 (
( sym_fig_fcd : Figure_symbol_t.figure_symbol ) =
...
let tag_fig_fcd  = Tag_v.make sym_fig_fcd soi_dom;;
