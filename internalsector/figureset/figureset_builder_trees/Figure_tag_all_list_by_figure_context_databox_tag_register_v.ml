(** {3 Figure_tag_all_list_by_figure_context_databox_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BFIG:Figure_tag_all_list_by_figure_context_databox_tag_register_v";
   "Author : François Colonna 13 octobre 2016 at 10:34:04+02:00";
 ]
;;
