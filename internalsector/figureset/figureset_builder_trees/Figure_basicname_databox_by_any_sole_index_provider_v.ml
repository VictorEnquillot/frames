(** {3 Figure_basicname_databox_by_any_sole_index_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BFIG:Figure_basicname_databox_by_any_sole_index_provider_v";
...
(* done with do_provider_without_register.sh Figure_basicname_databox_by_any_sole_index_provider_v.ml force on mardi 15 novembre 2016, 16:37:12 (UTC+0100) *)
