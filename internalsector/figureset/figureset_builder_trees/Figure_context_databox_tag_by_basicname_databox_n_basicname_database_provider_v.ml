(** {3 Figure_context_databox_tag_by_basicname_databox_n_basicname_database_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BFIG:Figure_context_databox_tag_by_basicname_databox_n_basicname_database_provider_v";
...
(* done with do_provider_without_register.sh Figure_context_databox_tag_by_basicname_databox_n_basicname_database_provider_v.ml force on mercredi 12 octobre 2016, 16:11:20 (UTC+0200) *)
