(** {3 Basicname_databox_n_basicname_database_by_figure_context_databox_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BFIG:Basicname_databox_n_basicname_database_by_figure_context_databox_tag_register_v";
...
let register : 
    (
     Figure_context_databox_tag_t.figure_context_databox_tag,
...
let name_of_key key =
  Figure_context_databox_tag_v.fullname key
;;
