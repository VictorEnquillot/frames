(** {3 Figure_set_fence_tag_list_by_figure_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BSKE:Figure_set_fence_tag_list_by_figure_tag_register_v";
...
let register : 
    (Figure_tag_t.figure_tag,
     Figure_set_fence_tag_t.figure_set_fence_tag list
    ) 
    Register_t.register = 
...
let name_of_key key =
  Figure_tag_v.name key
;;

let name_of_value val_ =
  List_v.name
    Figure_set_fence_tag_v.name
    val_
;;
