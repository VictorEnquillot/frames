(** {3 Coordinate_set_body_tuple_string_off_by_figure_set_fence_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BFIG:Coordinate_set_body_tuple_string_off_by_figure_set_fence_tag_register_v";
...
let register : 
    (Figure_set_fence_tag_t.figure_set_fence_tag,
     string
    ) 
    Register_t.register = 
...
let name_of_key key =
  Figure_set_fence_tag_v.fullname key
;;
