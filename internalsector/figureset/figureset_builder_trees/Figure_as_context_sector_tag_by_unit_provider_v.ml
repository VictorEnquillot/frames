(** {3 Figure_as_context_sector_tag_by_unit_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
    "Current : BFIG:Figure_as_context_sector_tag_by_unit_provider_v";
...
(* done with do_provider_without_register.sh Figure_as_context_sector_tag_by_unit_provider_v.ml force on mercredi 12 octobre 2016, 16:11:19 (UTC+0200) *)
