...
let documentation () = 
  [
   "Current : BFIG:Figure_symbol_by_sole_index_register_filler_v";
   ...
   "Author : François Colonna 09 avril 2017 at 13:07:35+02:00";
 ]
;;
...
let fill soi_any =
  ...
  then
	...
	Basicname_databox_n_basicname_database_by_any_sole_index_provider_v.provide
	  soi_any 
      in
      ignore (Figure_tag_all_list_by_basicname_databox_n_basicname_database_provider_v.provide 
		(bna_box, bna_box)
	     );
    end
  else ();
...
(* done with do_extractor_filling_register.sh force on mercredi 12 octobre 2016, 16:11:23 (UTC+0200) *)
