...
let documentation () = 
  [
   "Current : BFIG:Figure_symbol_by_sole_index_register_v";
 ]
;;
...
(* done with do_dddd_symbol_by_sole_index_register.sh force on mercredi 12 octobre 2016, 16:11:23 (UTC+0200) *)
