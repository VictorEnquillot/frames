(** {3 Figure_tag_tree_by_basicname_databox_n_basicname_database_register_v} *)

(** {6 Documenting} *)

let documentation () = 
[
 "Current : BFIG:Figure_tag_tree_by_basicname_databox_n_basicname_database_register_v";
