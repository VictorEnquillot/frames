...
let documentation () = 
  [
   "Current : BFIG:Figure_symbol_by_sole_index_provider_v";
   "Needs : BFIG:Figure_symbol_by_sole_index_register_filler_v";
   "Needed-by : BFIG:";
   "What-is-it : the provider of Figure_symbol by any sole_index";
   "Author : François Colonna 13 octobre 2016 at 12:13:54+02:00";
 ]
;;
...
(* done with do_dddd_symbol_by_sole_index_provider.sh force on mercredi 12 octobre 2016, 16:11:23 (UTC+0200) *)
