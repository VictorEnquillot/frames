...
testing "Figure_fence_point formula_v with
   Figure_fence_point_formula_u_any.ml";;
...
(* toplevel 
   #use "Figure_fence_point_formula_u_any.ml";; 
...
let tag_fig = Doublet_list_v.find_if_left (fun s -> Figure_symbol_v.string_off s = "T_A") tag_fig_l;;
...
=
  (Figure_symbol_t.Figure_builder_symbol
    (Figure_builder_symbol_t.Figure_fence_point_symbol
      (Figure_fence_point_symbol_t.Figure_fence_point_constructor "T_A")),
   [1; 1; 1; 6])
);;

let tag_fpo = Tag_v.map_entity Figure_symbol_v.figure_fence_point_symbol_off_figure_symbol tag_fig;;
...
let con_fpo = Figure_fence_point_container_v.container_of_tag tag_fpo;;

test_number 4 (
 con_fpo 
(* : Coordinate_tuple_symbol_t.coordinate_tuple_symbol Tag_t.tag
  Uno_t.uno *)
=
  Uno_t.Uno
...
let for_fpo = Figure_fence_point_formula_v.container_of_tag tag_fpo;;

test_number 5 (
 for_fpo 
(* : (Figure_fence_point_symbol_t.figure_fence_point_symbol,
   Coordinate_tuple_symbol_t.coordinate_tuple_symbol Tag_t.tag
   Uno_t.uno) Doublet_t.doublet *)
=
(Figure_fence_point_symbol_t.Figure_fence_point_constructor "T_A",
 Uno_t.Uno
   (Coordinate_tuple_symbol_t.Coordinate_tuple_homogeneous_symbol
