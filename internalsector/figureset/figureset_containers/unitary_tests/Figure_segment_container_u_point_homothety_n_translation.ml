...
(* toplevel 
   #use "Figure_segment_container_u_point_homothety_n_translation.ml";;
...
let nam_ivn_seg = "Seg_bc";;
let tag_fig_seg = 
    Figure_tag_in_database_by_external_input_variable_name_provider_v.provide 
      nam_ivn_seg;;

test_number 3 (
( tag_fig_seg : Figure_symbol_t.figure_symbol Tag_t.tag ) =
   (
...
let tag_fse = Tag_v.map_entity 
    Figure_symbol_v.figure_segment_symbol_off_figure_symbol 
    tag_fig_seg
;; 
