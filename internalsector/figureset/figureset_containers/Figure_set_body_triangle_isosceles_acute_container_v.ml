(** {3 Figure_set_body_triangle_isosceles_acute_container_v} *)

(** {6 Documenting_for_container} *)

let documentation () = 
  [
   "Current : FFIG:Figure_set_body_triangle_isosceles_acute_container_v";
...
let coerce_up_tag tag_fia =
  Tag_v.map_entity 
    Figure_symbol_v.figure_symbol_of_figure_set_body_triangle_isosceles_acute_symbol 
    tag_fia
;;
...
let builder_tag_list_of_tag tag_fia =
  let tag_fig = coerce_up_tag tag_fia in
  Figure_son_tag_list_by_figure_father_tag_provider_v.provide tag_fig
;;

(** {9 Builder Tag Datastructures} *)

let builder_tag_trio tag_fia =
  let tag_bui_l = builder_tag_list_of_tag tag_fia in
  Trio_v.trio_of_list tag_bui_l
;;

(** {9 Builder Tag Tuple} *)

let builder_tag_tuple tag_fia =
  let tag_bui_d = builder_tag_trio tag_fia in
  Tuple_v.tuple_of_trio tag_bui_d
;;

(** {9 Building as Builder Tag trio} *)

let building_of_tag tag_fia =
  builder_tag_trio tag_fia
;;
...
let containee_tag_list_of_tag tag_fia =
  let tag_bui_l = builder_tag_list_of_tag tag_fia in
...
let containee_tag_trio tag_fia =
  let tag_cnu_l = containee_tag_list_of_tag tag_fia in
...
let container_of_tag tag_fia =
  containee_tag_trio tag_fia 
;;

(** {9 Extracting Containees off Tag} *)

let first_containee_tag tag_fia =
  let con_fia = container_of_tag tag_fia in
  Trio_v.first_off_trio con_fia
;;

let second_containee_tag tag_fia =
  let con_fia = container_of_tag tag_fia in
  Trio_v.second_off_trio con_fia
;;

let third_containee_tag tag_fia =
  let con_fia = container_of_tag tag_fia in
  Trio_v.third_off_trio con_fia
;;

(** {6 Fence *)

let fence_as_list_of_tag tag_fia =
  let tag_fig = coerce_up_tag tag_fia in
  Figure_fence_by_figure_tag_provider_v.provide tag_fig
;;

let fence_as_trio tag_fia =
  let fen_fia = fence_as_list_of_tag tag_fia in
  Trio_v.trio_of_list fen_fia
;;

let fence_as_tuple_of_tag tag_fia =
  let fen_l = fence_as_list_of_tag tag_fia in
  Tuple_v.tuple_of_list fen_l
;;

let fence_as_tuple_list_of_tag tag_fia =
  let fen_l = fence_as_list_of_tag tag_fia in
  Tuple_list_v.make fen_l
;;

(* generated by ./do_container_as_trio_body_bud_1containee_v.sh figure_set_body_triangle_isosceles_acute fia figure_set_fence_point fpa fpb fpc *)
