(** {3 Figure_set_body_triangle_scalene_right_container_v} *)

(** {6 Documenting_for_container} *)

let documentation () = 
  [
   "Current : FFIG:Figure_set_body_triangle_scalene_right_container_v";
...
let coerce_up_tag tag_fsr =
  Tag_v.map_entity 
    Figure_symbol_v.figure_symbol_of_figure_set_body_triangle_scalene_right_symbol 
    tag_fsr
;;
...
let builder_tag_list_of_tag tag_fsr =
  let tag_fig = coerce_up_tag tag_fsr in
  Figure_son_tag_list_by_figure_father_tag_provider_v.provide tag_fig
;;

(** {9 Builder Tag Datastructures} *)

let builder_tag_trio tag_fsr =
  let tag_bui_l = builder_tag_list_of_tag tag_fsr in
  Trio_v.trio_of_list tag_bui_l
;;

(** {9 Builder Tag Tuple} *)

let builder_tag_tuple tag_fsr =
  let tag_bui_d = builder_tag_trio tag_fsr in
  Tuple_v.tuple_of_trio tag_bui_d
;;

(** {9 Building as Builder Tag trio} *)

let building_of_tag tag_fsr =
  builder_tag_trio tag_fsr
;;
...
let containee_tag_list_of_tag tag_fsr =
  let tag_bui_l = builder_tag_list_of_tag tag_fsr in
...
let containee_tag_trio tag_fsr =
  let tag_cnu_l = containee_tag_list_of_tag tag_fsr in
...
let container_of_tag tag_fsr =
  containee_tag_trio tag_fsr 
;;

(** {9 Extracting Containees off Tag} *)

let first_containee_tag tag_fsr =
  let con_fsr = container_of_tag tag_fsr in
  Trio_v.first_off_trio con_fsr
;;

let second_containee_tag tag_fsr =
  let con_fsr = container_of_tag tag_fsr in
  Trio_v.second_off_trio con_fsr
;;

let third_containee_tag tag_fsr =
  let con_fsr = container_of_tag tag_fsr in
  Trio_v.third_off_trio con_fsr
;;

(** {6 Fence *)

let fence_as_list_of_tag tag_fsr =
  let tag_fig = coerce_up_tag tag_fsr in
  Figure_fence_by_figure_tag_provider_v.provide tag_fig
;;

let fence_as_trio tag_fsr =
  let fen_fsr = fence_as_list_of_tag tag_fsr in
  Trio_v.trio_of_list fen_fsr
;;

let fence_as_tuple_of_tag tag_fsr =
  let fen_l = fence_as_list_of_tag tag_fsr in
  Tuple_v.tuple_of_list fen_l
;;

let fence_as_tuple_list_of_tag tag_fsr =
  let fen_l = fence_as_list_of_tag tag_fsr in
  Tuple_list_v.make fen_l
;;

(* generated by ./do_container_as_trio_body_bud_1containee_v.sh figure_set_body_triangle_scalene_right fsr figure_set_fence_point fpa fpb fpc *)
