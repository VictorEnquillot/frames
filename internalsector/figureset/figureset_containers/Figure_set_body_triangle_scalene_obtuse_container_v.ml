(** {3 Figure_set_body_triangle_scalene_obtuse_container_v} *)

(** {6 Documenting_for_container} *)

let documentation () = 
  [
   "Current : FFIG:Figure_set_body_triangle_scalene_obtuse_container_v";
...
let coerce_up_tag tag_fso =
  Tag_v.map_entity 
    Figure_symbol_v.figure_symbol_of_figure_set_body_triangle_scalene_obtuse_symbol 
    tag_fso
;;
...
let builder_tag_list_of_tag tag_fso =
  let tag_fig = coerce_up_tag tag_fso in
  Figure_son_tag_list_by_figure_father_tag_provider_v.provide tag_fig
;;

(** {9 Builder Tag Datastructures} *)

let builder_tag_trio tag_fso =
  let tag_bui_l = builder_tag_list_of_tag tag_fso in
  Trio_v.trio_of_list tag_bui_l
;;

(** {9 Builder Tag Tuple} *)

let builder_tag_tuple tag_fso =
  let tag_bui_d = builder_tag_trio tag_fso in
  Tuple_v.tuple_of_trio tag_bui_d
;;

(** {9 Building as Builder Tag trio} *)

let building_of_tag tag_fso =
  builder_tag_trio tag_fso
;;
...
let containee_tag_list_of_tag tag_fso =
  let tag_bui_l = builder_tag_list_of_tag tag_fso in
...
let containee_tag_trio tag_fso =
  let tag_cnu_l = containee_tag_list_of_tag tag_fso in
...
let container_of_tag tag_fso =
  containee_tag_trio tag_fso 
;;

(** {9 Extracting Containees off Tag} *)

let first_containee_tag tag_fso =
  let con_fso = container_of_tag tag_fso in
  Trio_v.first_off_trio con_fso
;;

let second_containee_tag tag_fso =
  let con_fso = container_of_tag tag_fso in
  Trio_v.second_off_trio con_fso
;;

let third_containee_tag tag_fso =
  let con_fso = container_of_tag tag_fso in
  Trio_v.third_off_trio con_fso
;;

(** {6 Fence *)

let fence_as_list_of_tag tag_fso =
  let tag_fig = coerce_up_tag tag_fso in
  Figure_fence_by_figure_tag_provider_v.provide tag_fig
;;

let fence_as_trio tag_fso =
  let fen_fso = fence_as_list_of_tag tag_fso in
  Trio_v.trio_of_list fen_fso
;;

let fence_as_tuple_of_tag tag_fso =
  let fen_l = fence_as_list_of_tag tag_fso in
  Tuple_v.tuple_of_list fen_l
;;

let fence_as_tuple_list_of_tag tag_fso =
  let fen_l = fence_as_list_of_tag tag_fso in
  Tuple_list_v.make fen_l
;;

(* generated by ./do_container_as_trio_body_bud_1containee_v.sh figure_set_body_triangle_scalene_obtuse fso figure_set_fence_point fpa fpb fpc *)
