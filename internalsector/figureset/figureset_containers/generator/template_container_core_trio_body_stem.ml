...
let buldr_bui_3_tag_off_this_container con_ttt =
  Trio_v.right_off_trio con_ttt
;;

(** {6 Builder Main Tag of Container} *)

let mainb_tag_trio_off_this_container con_ttt =
...
let mainb_tag_tuple_off_this_container con_ttt =
  let tag_mbu_t = mainb_tag_trio_off_this_container con_ttt in
  Tuple_t.Trio tag_mbu_t
;;
...
let elementary_units_tag_bui_3_off_this_container con_ctc =
  let tag_bui_3 = buldr_bui_3_tag_off_this_container con_ctc in
  let con_bui_3 = Buldr_container_v.container_of_tag tag_bui_3 in
  Buldr_container_v.elementary_units_tag_off_buldr_container con_bui_3
;;
