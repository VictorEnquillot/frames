...
let documentation () = 
  [
   ...
   "Needed-by: ";
   "What-is-it : Up_coercion to This type from This_sibext_1 ...sibext_2 ...sibext_3 ...sibext_4";
   "What-is-it : it is a Body container as a Trio of Conee_1 and thus a List Conee_up Tag";
 ]
;;
