...
testing "Figure_symbol_subtree_by_input_fullnameoffile_provider_v with
   Figure_symbol_subtree_by_input_fullnameoffile_provider_u_point_homothety_n_translation_debug.ml";;
...
(* toplevel 
   #use "Figure_symbol_subtree_by_input_fullnameoffile_provider_u_point_homothety_n_translation_debug.ml";;
