...
testing "Figure_symbol_subtree_by_target_input_variable_name_provider_v with
   Figure_symbol_subtree_by_target_input_variable_name_provider_u_point_homothety_debug.ml";;
...
(* toplevel 
   #use "Figure_symbol_subtree_by_target_input_variable_name_provider_u_point_homothety_debug.ml";;
...
let sym_fig_st = Figure_symbol_subtree_by_input_variable_name_provider_v.provide nam_ivn;;
...
let sym_fig_st = Figure_symbol_subtree_by_target_input_variable_name_provider_v.provide nam_ivn_tar;;
