...
testing "Figure_symbol_tree_by_database_db1_database_tag_provider_v with
   Figure_tag_tree_by_database_db1_database_tag_provider_u_point_homothety_debug.ml";;
...
(* toplevel 
   #use "Figure_symbol_tree_by_database_db1_database_tag_provider_u_point_homothety_debug.ml";;

*)

open Figure_symbol_tree_by_database_db1_database_tag_provider_v;;
...
(tag_d1d :
  ...
  let tag_d1d_t =
    Database_db1_tag_subtree_by_database_db1_database_tag_provider_v.provide 
      tag_d1d;;

let sym_fig_st = figure_symbol_subtree_of_database_db1_tag_tree tag_d1d_t;;
...
let sym_fig_stl = [Tree_v.remove_empty_subtree_off_tree sym_fig_st];;
let sym_fdo = Figure_symbol_v.figure_domain_constructor "figure";;

let sym_fig_t = Figure_symbol_tree_by_database_db1_database_tag_provider_v.provide tag_d1d;;
