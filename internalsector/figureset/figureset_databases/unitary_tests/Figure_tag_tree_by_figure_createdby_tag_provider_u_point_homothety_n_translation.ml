...
testing "Figure_tag_tree_by_figure_createdby_tag_provider_v with
    Figure_tag_tree_by_figure_createdby_tag_provider_u_point_homothety_n_translation_debug.ml";;
...
(* toplevel 
   #use "Figure_tag_tree_by_figure_createdby_tag_provider_u_point_homothety_n_translation_debug.ml";;
