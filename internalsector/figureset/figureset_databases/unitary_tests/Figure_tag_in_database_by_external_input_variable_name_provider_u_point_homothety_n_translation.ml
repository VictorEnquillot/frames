...
testing "Figure_tag_in_database_by_external_input_variable_name_provider_v with
    Figure_tag_in_database_by_external_input_variable_name_provider_u_point_homothety_n_translation_debug.ml";;
...
(* toplevel 
   #use "Figure_tag_in_database_by_external_input_variable_name_provider_u_point_homothety_n_translation_debug.ml";;
