...
testing "Figure_symbol_subtree_by_external_input_variable_name_provider_v with
   Figure_symbol_subtree_by_external_input_variable_name_provider_u_point_homothety_debug.ml";;
...
(* toplevel 
   #use "Figure_symbol_subtree_by_external_input_variable_name_provider_u_point_homothety_debug.ml";;
...
let nam_ivn_tar = "Poi_a";;

let sof_fig_ext = Figure_string_off_by_input_variable_name_provider_v.provide nam_ivn_tar;;
let sym_fig_ext_st = Figure_symbol_subtree_by_external_input_variable_name_provider_v.provide nam_ivn_tar;;

test_number 5 (
(sym_fig_ext_st : Figure_symbol_t.figure_symbol Tree_t.tree ) =
  Tree_t.Leaf
