...
testing "Figure_symbol_tree_by_database_db1_database_tag_provider_v with
   Figure_tag_tree_by_database_db1_database_tag_provider_u_point_print_debug.ml";;
...
(* toplevel 
   #use "Figure_symbol_tree_by_database_db1_database_tag_provider_u_point_print_debug.ml";;
