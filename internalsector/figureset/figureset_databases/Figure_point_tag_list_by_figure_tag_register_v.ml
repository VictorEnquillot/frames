(** {3 Figure_point_tag_list_by_figure_tag_register_v} *)
...
[
  "Needs: ";
  "Current : DFIG:Figure_point_tag_list_by_figure_tag_register_v";
  "Needed-by: ";
  "What-is-it: ";
  "How-is-it-done: ";
  "Example: ";
...
let register : 
    (Figure_tag_t.figure_tag,
     Figure_point_tag_t.figure_point_tag list
    ) 
    Register_t.register = 
...
let name_of_key key =
  Figure_tag_v.fullname key
;;

let name_of_value val_ =
  List_v.name
    Figure_point_tag_v.name 
    val_
;;
