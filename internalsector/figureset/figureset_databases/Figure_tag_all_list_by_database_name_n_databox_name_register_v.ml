(** {3 Figure_tag_all_list_by_database_name_n_databox_name_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BDB1:Figure_tag_all_list_by_database_name_n_databox_name_register_v";
 ]
;;
...
let name_of_key key =
  Duo_v.name (fun s->s) key
;;

let name_of_value val_ =
  List_v.name Figure_tag_v.fullname val_
;;
