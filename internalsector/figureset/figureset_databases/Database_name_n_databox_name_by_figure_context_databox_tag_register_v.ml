(** {3 Database_name_n_databox_name_by_figure_context_databox_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BNWC:Database_name_n_databox_name_by_figure_context_databox_tag_register_v";
 ]
;;
...
(* done with do_register.sh on jeudi 19 mai 2016, 18:35:52 (UTC+0200) *)
