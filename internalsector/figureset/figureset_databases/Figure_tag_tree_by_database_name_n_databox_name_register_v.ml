(** {3 Figure_tag_tree_by_database_name_n_databox_name_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BDB1:Figure_tag_tree_by_database_name_n_databox_name_register_v";
 ]
;;
...
let name_of_value val_ =
  Tree_v.name Figure_tag_v.fullname val_
;;
