(** {3 Figure_tag_subtree_by_figure_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BDB1:Figure_tag_subtree_by_figure_tag_register_v";
   "Author : François Colonna 02 mai 2016 at 08:45:15+02:00";
]
;;
