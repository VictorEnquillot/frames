(** {3 Figure_tag_all_list_by_database_name_n_databox_name_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : DFIG:Figure_tag_all_list_by_database_name_n_databox_name_provider_v";
   "Register : DFIG:Figure_tag_all_list_by_database_name_n_databox_name_register_v";
   "Register : DFIG:Figure_creation_module_name_by_sole_index_register_v";
   "Register : DFIG:Figure_symbol_by_sole_index_register_v";
   "Needs : DFIG:Figure_tag_tree_by_database_name_n_databox_name_provider_v";
   "Needed-by : DFIG:";
...
let build (nam_dba, nam_dbo) =
  let tag_db1_t = 
    Figure_tag_tree_by_database_name_n_databox_name_provider_v.provide
      (nam_dba, nam_dbo)
  in
...
let store (nam_dba, nam_dbo) tag_db1_l =
  ...
  let pro_cpu = Management_v.entering_of_module_name_of_function_name nam_mod nam_fun in
  Figure_tag_all_list_by_database_name_n_databox_name_register_v.store nam_mod (nam_dba, nam_dbo) tag_db1_l; 
  Management_v.exiting_of_process_times_of_module_name_of_function_name pro_cpu nam_mod nam_fun;
;;
...
let retrieve (nam_dba, nam_dbo) =
  ...
  let pro_cpu = Management_v.entering_of_module_name_of_function_name nam_mod nam_fun in
  let result = 
    Figure_tag_all_list_by_database_name_n_databox_name_register_v.retrieve 
      nam_mod 
      (nam_dba, nam_dbo) 
  in
  Management_v.exiting_of_process_times_of_module_name_of_function_name pro_cpu nam_mod nam_fun;
...
let provide_without_trace (nam_dba, nam_dbo) =
  if Figure_tag_all_list_by_database_name_n_databox_name_register_v.is_stored (nam_dba, nam_dbo)
...
(* done with do_provider_tag_all_list_by_database_name_n_databox_name.sh on jeudi 19 mai 2016, 18:35:59 (UTC+0200) *)
