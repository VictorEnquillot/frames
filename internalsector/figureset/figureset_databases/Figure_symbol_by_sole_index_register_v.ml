(** {3 Figure_symbol_by_sole_index_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : DFIG:Figure_symbol_by_sole_index_register_v";
 ]
;;

(** {6 Register.} *)

let nam_reg = "Figure_symbol_by_sole_index_register_v";;
...
(* done with do_dddd_symbol_by_sole_index_register.sh on jeudi 19 mai 2016, 18:35:59 (UTC+0200) *)
