...
ocamlopt \
-o figureset_generate_symbols_${file}.bin  \
unix.cmxa str.cmxa \
...
Do_figureset_symbols_${file}.cmx

echo "figureset_generate_symbols_${file}.bin done"

ls -alt figureset_generate_symbols_${file}.bin