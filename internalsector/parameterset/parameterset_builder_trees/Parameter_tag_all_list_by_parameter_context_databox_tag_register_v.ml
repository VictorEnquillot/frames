(** {3 Parameter_tag_all_list_by_parameter_context_databox_tag_register_v} *)
...
[
  "Needs : ";
   "Current : BPAR:Parameter_tag_all_list_by_parameter_context_databox_tag_register_v";
  "Needed-by: ";
  "What-is-it: ";
  "How-is-it-done: ";
  "Example: ";
...
let register : 
    (Parameter_context_databox_tag_t.parameter_context_databox_tag,
     Parameter_tag_t.parameter_tag list
    ) 
    Register_t.register = 
