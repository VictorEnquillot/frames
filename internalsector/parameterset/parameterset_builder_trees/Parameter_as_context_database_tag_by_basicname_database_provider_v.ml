(** {3 Parameter_as_context_database_tag_by_basicname_database_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BPAR:Parameter_as_context_database_tag_by_basicname_database_provider_v";
...
let build bna_dba =
  ...
  let sym_par_pba = 
    Parameter_symbol_v.parameter_context_database_constructor 
      nam_dba
  in
  Tag_v.make sym_par_pba soi_dba
;;
...
(* done with do_provider_without_register.sh Parameter_as_context_database_tag_by_basicname_database_provider_v.ml force on lundi 10 octobre 2016, 09:13:00 (UTC+0200) *)
