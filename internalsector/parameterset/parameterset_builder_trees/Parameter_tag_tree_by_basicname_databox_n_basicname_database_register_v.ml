(** {3 Parameter_tag_tree_by_basicname_databox_n_basicname_database_register_v} *)

(** {6 Documenting} *)

let documentation () = 
[
 "Current : BPAR:Parameter_tag_tree_by_basicname_databox_n_basicname_database_register_v";
