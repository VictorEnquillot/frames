(** {3 Basicname_databox_n_basicname_database_by_parameter_context_databox_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BPAR:Basicname_databox_n_basicname_database_by_parameter_context_databox_tag_register_v";
   "Author : François Colonna 02 avril 2017 at 12:42:28+02:00";
 ]
;;
...
let register : 
    (
     Parameter_context_databox_tag_t.parameter_context_databox_tag,
...
let name_of_key key =
  Parameter_context_databox_tag_v.fullname key
;;
...
(* done with do_register.sh force on lundi 10 octobre 2016, 09:12:53 (UTC+0200) *)
