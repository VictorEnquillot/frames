...
(* toplevel 
   #use "Parameter_tag_tree_by_parameter_context_databox_tag_provider_u_cc_pVTZ_analysis_tree.ml";; 
...
( tag_ncb : Parameter_context_databox_symbol_t.parameter_context_databox_symbol Tag_t.tag ) =
  (Parameter_context_databox_symbol_t.Parameter_context_databox_constructor "cc_pVTZ",
   [4; 5; 19; 5])
);;
...
(tag_nwc_tso_l : Parameter_symbol_t.parameter_symbol Tag_t.tag list ) =
  [(Parameter_symbol_t.Parameter_set_symbol ( Parameter_set_symbol_t.Parameter_set_body_symbol 
     (Parameter_set_body_symbol_t.Parameter_set_body_node_symbol
       (Parameter_set_body_node_symbol_t.Parameter_set_body_node_aoset_block "cc-pvtz")),
    [2; 2; 4; 5; 19; 5]);
   (Parameter_symbol_t.Parameter_set_symbol ( Parameter_set_symbol_t.Parameter_set_body_symbol 
     (Parameter_set_body_symbol_t.Parameter_set_body_node_symbol
...
(* Parameter_set_body_node_aoset_numericalvalues "ne p 4 gaussian 1" <=> "ne p 2 1" *)

let tag_nwc_tso_l = Tree_v.root_topson_node_list_of_subtree_node_predicate_off_tree 
    (fun (s, i) ->
      (Parameter_symbol_v.is_parameter_set_body_node_aoset_numericalvalues s)
	&& 
      (Parameter_symbol_v.string_off s = "ne p 4 gaussian 1")
    ) 
    tag_nwc_t;; 
...
( tag_nwc_tso_l : Parameter_symbol_t.parameter_symbol Tag_t.tag list ) =
  [(Parameter_symbol_t.Parameter_set_symbol ( Parameter_set_symbol_t.Parameter_set_body_symbol 
   ...
   (Parameter_symbol_t.Parameter_set_symbol ( Parameter_set_symbol_t.Parameter_set_fence_symbol 
     (Parameter_set_fence_symbol_t.Parameter_fence_float_positive "54.7000000"),
    [1; 1; 2; 4; 2; 10; 2; 2; 2; 4; 5; 19; 5]);
   (Parameter_symbol_t.Parameter_set_symbol ( Parameter_set_symbol_t.Parameter_set_fence_symbol 
     (Parameter_set_fence_symbol_t.Parameter_fence_float_positive "0.0171510"),
...
test_number 13 (
(tag_nwc_nep4_st : Parameter_symbol_t.parameter_symbol Tag_t.tag Tree_t.tree ) =
  Tree_t.Inner
   ((Parameter_symbol_t.Parameter_set_symbol ( Parameter_set_symbol_t.Parameter_set_body_symbol 
      (Parameter_set_body_symbol_t.Parameter_set_body_node_symbol
        (Parameter_set_body_node_symbol_t.Parameter_set_body_node_aoset_numericalvalues
...
test_number 14 (
(tag_fen : Parameter_symbol_t.parameter_symbol Tag_t.tag list ) =
  [(Parameter_symbol_t.Parameter_set_symbol ( Parameter_set_symbol_t.Parameter_set_fence_symbol 
     (Parameter_set_fence_symbol_t.Parameter_fence_float_positive "54.7000000"),
    [1; 1; 2; 4; 2; 10; 2; 2; 2; 4; 5; 19; 5]);
   (Parameter_symbol_t.Parameter_set_symbol ( Parameter_set_symbol_t.Parameter_set_fence_symbol 
...
let str_flo_fen = List.map Parameter_tag_v.string_off tag_fen;;
