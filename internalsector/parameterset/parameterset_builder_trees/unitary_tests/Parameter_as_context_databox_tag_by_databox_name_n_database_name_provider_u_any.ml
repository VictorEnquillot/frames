...
testing "Parameter_as_context_databox_tag_by_databox_name_n_database_name_provider_v with
...
(* toplevel 
   #use "Parameter_as_context_databox_tag_by_databox_name_n_database_name_provider_u_any.ml";; 

*)


open Parameter_as_context_databox_tag_by_databox_name_n_database_name_provider_v;;

let nam_dbo = "try_ao";;
let nam_dba = "nwchem";;

let nam_qua = 
  Parameter_context_name_quatuor_by_databox_name_n_database_name_provider_v.provide (nam_dbo, nam_dba) 
;;
...
let tag_par_pbo = Tag_v.make sym_par_pbo soi_pbo;;
...
test_number 5 (
tag_par_pbo = provide (nam_dbo, nam_dba)
);;
