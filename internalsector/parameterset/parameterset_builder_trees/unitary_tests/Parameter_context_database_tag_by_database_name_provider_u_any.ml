...
testing "Parameter_context_database_tag_by_database_name_provider_v with
...
(* toplevel 
   #use "Parameter_context_database_tag_by_database_name_provider_u_any.ml";; 

*)

open Parameter_context_database_tag_by_database_name_provider_v;;
...
test_number 2 (
(sym_pba : Parameter_context_database_symbol_t.parameter_context_database_symbol ) =
...
test_number 3 (
(tag_pba : Parameter_context_database_symbol_t.parameter_context_database_symbol
  Tag_t.tag ) =
  (Parameter_context_database_symbol_t.Parameter_context_database_constructor
    "nwchem",
   [5; 6; 5])
