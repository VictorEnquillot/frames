...
testing "Parameter_context_sector_name_by_unit_provider_v with
...
(* toplevel 
   #use "Parameter_context_sector_name_by_unit_provider_u_any.ml";; 

*)

open Parameter_context_sector_name_by_unit_provider_v;;
  
let fnd_cur = Unix.getenv ("BELE");;

test_number 1 (
(fnd_cur : string ) =
  "/home/colonna/sources/ocaml_top/setup/frames/internalsector/parameterset/parameterset_builder_trees"
);;
