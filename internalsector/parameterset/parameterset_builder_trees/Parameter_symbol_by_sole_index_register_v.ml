(** {3 Parameter_symbol_by_sole_index_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BPAR:Parameter_symbol_by_sole_index_register_v";
 ]
;;

(** {6 Register.} *)

let nam_reg = "Parameter_symbol_by_sole_index_register_v";;
...
let name_of_value val_ =
  Parameter_symbol_v.fullname val_
;;
