(** {3 Parameter_fence_by_parameter_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BPAR:Parameter_fence_by_parameter_tag_register_v";
   "Author : François Colonna 05 décembre 2016 at 07:26:41+01:00";
 ]
;;
...
let name_of_key key =
  Parameter_tag_v.name key
;;

let name_of_value val_ =
  List_v.name
    Parameter_tag_v.name
    val_
;;
