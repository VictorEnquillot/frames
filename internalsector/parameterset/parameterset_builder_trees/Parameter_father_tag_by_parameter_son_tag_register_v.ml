(** {3 Parameter_father_tag_by_parameter_son_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BPAR:Parameter_father_tag_by_parameter_son_tag_register_v";
   "Author : François Colonna 28 décembre 2016 at 19:20:54+01:00";
 ]
;;
