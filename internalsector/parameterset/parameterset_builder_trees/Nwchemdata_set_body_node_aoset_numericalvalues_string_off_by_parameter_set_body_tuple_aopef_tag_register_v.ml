(** {3 Nwchemdata_set_body_aoset_numericalvalues_string_off_by_parameter_set_body_tuple_aopef_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BPAR:Nwchemdata_set_body_aoset_numericalvalues_string_off_by_parameter_set_body_tuple_aopef_tag_register_v";
   "Author : François Colonna 06 décembre 2016 at 08:19:52+01:00";
 ]
;;
...
let register : 
    (Parameter_set_body_tuple_aopef_tag_t.parameter_set_body_tuple_aopef_tag,
     string
    ) 
    Register_t.register = 
...
let name_of_key key =
  Parameter_set_body_tuple_aopef_tag_v.fullname key
;;
