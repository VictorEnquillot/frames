(** {3 Parameter_tag_tree_by_parameter_context_databox_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BPAR:Parameter_tag_tree_by_parameter_context_databox_tag_register_v";
...
let register : 
    (
     ...
     Parameter_tag_t.parameter_tag Tree_t.tree 
    ) 
    Register_t.register = 
