(** {3 Parameter_basicname_domain_by_unit_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BPAR:Parameter_basicname_domain_by_unit_provider_v";
...
(* done with do_provider_without_register.sh Parameter_basicname_domain_by_unit_provider_v.ml force on lundi 10 octobre 2016, 09:13:01 (UTC+0200) *)
