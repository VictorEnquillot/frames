...
let documentation () = 
  [
   ...
   "Definition : a  Parameter_envelopee = (This_tag, Readee). It is NOT coerced";
...
(** {9 This_tag off Envelope} *)

let this_tag_off_envelope env_ttt =
  let eee_par = parameter_envelopee_off_envelope env_ttt in
  Parameter_envelopee_v.this_tag_off_parameter_envelopee eee_par
;;
