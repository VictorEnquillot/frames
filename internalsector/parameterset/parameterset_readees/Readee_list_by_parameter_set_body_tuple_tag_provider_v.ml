(** {3 Readee_list_by_parameter_set_body_tuple_tag_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : VPAR:Readee_list_by_parameter_set_body_tuple_tag_provider_v";
   "Needs : DPAR:Measure_list_by_parameter_set_body_tuple_tag_provider_v";
