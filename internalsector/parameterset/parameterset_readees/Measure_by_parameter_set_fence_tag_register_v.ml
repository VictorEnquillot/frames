(** {3 Measure_by_parameter_set_fence_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : VCOO:Measure_by_parameter_set_fence_tag_register_v";
   "Needed-by: ";
]
;;
...
let register : 
    (Parameter_set_fence_tag_t.parameter_set_fence_tag,
     Measure_t.measure
    ) 
    Register_t.register = 
...
let name_of_key key =
  Parameter_set_fence_tag_v.fullname key
;;
