(** {3 Elementary_units_envelope_operation_v} *)

(** {6 Documenting_for_formula} *)

let documentation () = 
[
 "Current : PELE:Elementary_units_envelope_operation_v";
 "Needs: ";
 "Needed-by: ";
 "What-is-it: ";
 "How-is-it-done: ";
...
(*   let flo_tra_l =  *)
(*     Float_operation_v.translated_point_list_of_operand_point_list_of_segment_list_duo *)
(*       flo_opd_l flo_vec_l  *)
(*   in *)
...
(*   let flo_per =  *)
(*     Float_operation_v.perimeter_of_point_list_of_point_list_of_point_list flo_poi_a_l flo_poi_b_l flo_poi_c_l *)
(*   in *)
