(** {3 Parameter_set_fence_aopef_container_v} *)

(** {6 Documenting_for_container} *)

let documentation () = 
  [
   "Current : FPAR:Parameter_set_fence_aopef_container_v";
...
let name = function
  | Parameter_set_fence_aopef_container_t.Parameter_set_fence_aopef_coefficient_container con_pac ->
      (Parameter_set_fence_aopef_coefficient_container_v.name con_pac)
        
  | Parameter_set_fence_aopef_container_t.Parameter_set_fence_aopef_exponent_container con_pae ->
      (Parameter_set_fence_aopef_exponent_container_v.name con_pae)
;;

let string_off = function
  | Parameter_set_fence_aopef_container_t.Parameter_set_fence_aopef_coefficient_container con_pac ->
      (Parameter_set_fence_aopef_coefficient_container_v.string_off con_pac)
        
  | Parameter_set_fence_aopef_container_t.Parameter_set_fence_aopef_exponent_container con_pae ->
      (Parameter_set_fence_aopef_exponent_container_v.string_off con_pae)
;;

let longname = function
  | Parameter_set_fence_aopef_container_t.Parameter_set_fence_aopef_coefficient_container con_pac ->
      (Parameter_set_fence_aopef_coefficient_container_v.longname con_pac)
        
  | Parameter_set_fence_aopef_container_t.Parameter_set_fence_aopef_exponent_container con_pae ->
      (Parameter_set_fence_aopef_exponent_container_v.longname con_pae)
;;

let fullname = function
  | Parameter_set_fence_aopef_container_t.Parameter_set_fence_aopef_coefficient_container con_pac ->
      (Parameter_set_fence_aopef_coefficient_container_v.fullname con_pac)
        
  | Parameter_set_fence_aopef_container_t.Parameter_set_fence_aopef_exponent_container con_pae ->
      (Parameter_set_fence_aopef_exponent_container_v.fullname con_pae)
;;

(** {6 Coercing Up Tag} *)

let coerce_up_tag tag_pfa =
  Tag_v.map_entity 
...
let builder_tag_of_containee_tag tag_pfa =
  Tag_v.map_entity 
    Parameter_symbol_v.parameter_symbol_of_parameter_set_fence_aopef_symbol 
    tag_pfa
;;
...
let builder_tag_list_of_tag tag_pfa =
  let tag_par = coerce_up_tag tag_pfa in
...
let builder_tag_uno_of_tag tag_pfa =
  let tag_bui_l = builder_tag_list_of_tag tag_pfa in
  Uno_v.uno_of_list tag_bui_l
;;

(** {6 Builder Tag Tuple} *)

let builder_tag_tuple_of_tag tag_pfa =
  let tag_bui_u = builder_tag_uno_of_tag tag_pfa in
  Tuple_v.tuple_of_uno tag_bui_u
;;

(** {6 Building as Builder Tag uno} *)

let building_of_tag tag_pfa =
  builder_tag_uno_of_tag tag_pfa
;;
...
let container_of_tag tag_pfa =
  let bug = building_of_tag tag_pfa in
...
let containee_tag_uno_of_tag tag_pfa =
  container_of_tag tag_pfa
;;

(** {6 Containee Tag Tuple} *)

let containee_tag_tuple_of_tag tag_pfa =
  let tag_cne_u = containee_tag_uno_of_tag tag_pfa in
  Tuple_v.tuple_of_uno tag_cne_u
;;

(** {6 Fence *)

let fence_as_list_of_tag tag_pfa =
  let tag_par = coerce_up_tag tag_pfa in
  [tag_par]
;;

let fence_as_uno_of_tag tag_pfa =
  let fen_pfa = fence_as_list_of_tag tag_pfa in
  Uno_v.uno_of_list fen_pfa
;;

let fence_as_tuple_of_tag tag_pfa =
  let fen_l = fence_as_list_of_tag tag_pfa in
  Tuple_v.tuple_of_list fen_l
;;

let fence_as_tuple_list_of_tag tag_pfa =
  let fen_l = fence_as_list_of_tag tag_pfa in
  Tuple_list_v.make fen_l
;;

(* generated by ./do_container_as_uno_fence_trunc_2sibling_1containee_v.sh parameter_set_fence_aopef pfa parameter_set_fence_aopef_coefficient pac parameter_set_fence_aopef_exponent pae *)
