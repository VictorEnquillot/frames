...
testing "Parameter_set_fence_aopef_coefficient_container_v with
    Parameter_set_fence_aopef_coefficient_container_u_test_ao_debug.ml";;
...
(* toplevel 
   #use "Parameter_set_fence_aopef_coefficient_container_u_test_ao_debug.ml";;
...
open Parameter_set_fence_aopef_coefficient_container_v;; 
     
(* Argument *)

let tag_eac = Tag_v.map_entity Parameter_symbol_v.parameter_set_fence_aopef_coefficient_symbol_off_parameter_symbol tag_par_eac;;
...
test_number 3 (
tag_par_eac = coerce_up_tag tag_eac
);;

(** {6 Builder Tag list} *)

let tag_bui_l = builder_tag_list tag_eac;;
...
let tag_bui = builder_tag_uno tag_eac;;
...
test_number 6 (
(bug_eac : Parameter_symbol_t.parameter_symbol Tag_t.tag Uno_t.uno ) =
(Parameter_symbol_t.Parameter_fence_symbol
   (Parameter_fence_symbol_t.Units_symbol
      (Units_symbol_t.Units_length_symbol
         Units_length_symbol_t.Bohr)),
...
let tag_bui_t = builder_tag_tuple tag_eac;;
...
test_number 11 (
bug_eac = builder_tag_uno tag_eac
);;

(** {6 Containee Tag Datastructures} *)

test_number 12 (
tag_ful = containee_tag_uno tag_eac
);;

let tag_ful_t = containee_tag_tuple tag_eac;;
...
let fen_eac_l = fence_as_list tag_eac;;

test_number 14 (
(fen_eac_l : Parameter_symbol_t.parameter_symbol Tag_t.tag list ) =
  [(Parameter_symbol_t.Parameter_fence_symbol
     (Parameter_fence_symbol_t.Units_symbol
       (Units_symbol_t.Units_length_symbol
         Units_length_symbol_t.Bohr)),
...
let fen_eac_u = fence_as_uno tag_eac;;

test_number 15 (
(fen_eac_u : Parameter_symbol_t.parameter_symbol Tag_t.tag Uno_t.uno ) =
  (Parameter_symbol_t.Parameter_fence_symbol
    (Parameter_fence_symbol_t.Units_symbol
      (Units_symbol_t.Units_length_symbol
        Units_length_symbol_t.Bohr)),
...
let fen_eac_t = fence_as_tuple tag_eac;;

test_number 16 (
( fen_eac_t : Parameter_symbol_t.parameter_symbol Tag_t.tag Tuple_t.tuple ) =
  Tuple_t.Uno
   (Parameter_symbol_t.Parameter_fence_symbol
     (Parameter_fence_symbol_t.Units_symbol
       (Units_symbol_t.Units_length_symbol
...
let fen_eac_tl = fence_as_tuple_list tag_eac;;
