...
testing "Parameter_set_fence_aopef_container_v with
    Parameter_set_fence_aopef_container_u_test_ao_debug.ml";;
...
(* toplevel 
   #use "Parameter_set_fence_aopef_container_u_test_ao_debug.ml";;
...
let tag_epa = Tag_v.map_entity Parameter_symbol_v.parameter_set_fence_aopef_symbol_off_parameter_symbol tag_par_eac;;
...
test_number 3 (
tag_par_eac = coerce_up_tag tag_epa
);;
...
test_number 6 (
(bug_epa : Parameter_symbol_t.parameter_symbol Tag_t.tag Uno_t.uno ) =
(Parameter_symbol_t.Parameter_fence_symbol
   (Parameter_fence_symbol_t.Units_symbol
      (Units_symbol_t.Units_length_symbol
         Units_length_symbol_t.Bohr)),
...
test_number 14 (
(fen_epa_l : Parameter_symbol_t.parameter_symbol Tag_t.tag list ) =
  [(Parameter_symbol_t.Parameter_fence_symbol
     (Parameter_fence_symbol_t.Units_symbol
       (Units_symbol_t.Units_length_symbol
         Units_length_symbol_t.Bohr)),
...
test_number 15 (
(fen_epa_u : Parameter_symbol_t.parameter_symbol Tag_t.tag Uno_t.uno ) =
  (Parameter_symbol_t.Parameter_fence_symbol
    (Parameter_fence_symbol_t.Units_symbol
      (Units_symbol_t.Units_length_symbol
        Units_length_symbol_t.Bohr)),
...
test_number 16 (
( fen_epa_t : Parameter_symbol_t.parameter_symbol Tag_t.tag Tuple_t.tuple ) =
  Tuple_t.Uno
   (Parameter_symbol_t.Parameter_fence_symbol
     (Parameter_fence_symbol_t.Units_symbol
       (Units_symbol_t.Units_length_symbol
