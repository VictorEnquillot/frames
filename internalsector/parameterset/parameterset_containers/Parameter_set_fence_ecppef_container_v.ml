(** {3 Parameter_set_fence_ecppef_container_v} *)

(** {6 Documenting_for_container} *)

let documentation () = 
  [
   "Current : FPAR:Parameter_set_fence_ecppef_container_v";
...
let name = function
  | Parameter_set_fence_ecppef_container_t.Parameter_set_fence_ecppef_coefficient_container con_pae ->
      (Parameter_set_fence_ecppef_coefficient_container_v.name con_pae)
        
  | Parameter_set_fence_ecppef_container_t.Parameter_set_fence_ecppef_exponent_container con_pee ->
      (Parameter_set_fence_ecppef_exponent_container_v.name con_pee)
;;

let string_off = function
  | Parameter_set_fence_ecppef_container_t.Parameter_set_fence_ecppef_coefficient_container con_pae ->
      (Parameter_set_fence_ecppef_coefficient_container_v.string_off con_pae)
        
  | Parameter_set_fence_ecppef_container_t.Parameter_set_fence_ecppef_exponent_container con_pee ->
      (Parameter_set_fence_ecppef_exponent_container_v.string_off con_pee)
;;

let longname = function
  | Parameter_set_fence_ecppef_container_t.Parameter_set_fence_ecppef_coefficient_container con_pae ->
      (Parameter_set_fence_ecppef_coefficient_container_v.longname con_pae)
        
  | Parameter_set_fence_ecppef_container_t.Parameter_set_fence_ecppef_exponent_container con_pee ->
      (Parameter_set_fence_ecppef_exponent_container_v.longname con_pee)
;;

let fullname = function
  | Parameter_set_fence_ecppef_container_t.Parameter_set_fence_ecppef_coefficient_container con_pae ->
      (Parameter_set_fence_ecppef_coefficient_container_v.fullname con_pae)
        
  | Parameter_set_fence_ecppef_container_t.Parameter_set_fence_ecppef_exponent_container con_pee ->
      (Parameter_set_fence_ecppef_exponent_container_v.fullname con_pee)
;;
...
(* generated by ./do_container_as_uno_fence_trunc_2sibling_1containee_v.sh parameter_set_fence_ecppef pfe parameter_set_fence_ecppef_coefficient pae parameter_set_fence_ecppef_exponent pee *)
