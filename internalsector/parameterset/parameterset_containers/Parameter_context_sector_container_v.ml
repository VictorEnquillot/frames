(** {3 Parameter_context_sector_container_v} *)

(** {6 Documenting_for_container} *)

let documentation () = 
  [
   "Current : FPAR:Parameter_context_sector_container_v";
   "Needs : FPAR:Parameter_context_domain_tag_v";
   ...
   "What-is-it : it is a Bud container of Context sub-Types and thus a List of its Parameter_context_domain Tag";
...
let name con_pcs =
  List_v.name 
    Parameter_context_domain_tag_v.name
    con_pcs
;;
...
let longname con_pcs =
  List_v.name 
    Parameter_context_domain_tag_v.longname
    con_pcs
;;

let fullname con_pcs =
  List_v.name 
    Parameter_context_domain_tag_v.fullname
    con_pcs
;;
...
let builder_tag_list_of_tag tag_pcs =
  let tag_par = coerce_up_tag tag_pcs in
...
let building_of_tag tag_pcs =
  builder_tag_list_of_tag tag_pcs
;;

(** {6 Container} *)

let containee_up_tag_list tag_pcs =
  let tag_bui_l = builder_tag_list_of_tag tag_pcs in
...
(* generated by ./do_container_as_list_context_bud_1containee_v.sh parameter_context_sector pcs parameter_context_domain *)
