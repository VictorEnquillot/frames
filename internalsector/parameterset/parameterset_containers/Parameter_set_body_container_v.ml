(** {3 Parameter_set_body_container_v} *)

(** {6 Documenting_for_container} *)

let documentation () = 
  [
   "Current : FPAR:Parameter_set_body_container_v";
   "Needs : FPAR:Parameter_set_fence_tag_v";
   "Needs : FPAR:Parameter_set_body_tuple_container_v";
...
let name = function
  | Parameter_set_body_container_t.Parameter_set_body_tuple_container con_pbt ->
      (Parameter_set_body_tuple_container_v.name con_pbt)
        
;;

let string_off = function
  | Parameter_set_body_container_t.Parameter_set_body_tuple_container con_pbt ->
      (Parameter_set_body_tuple_container_v.string_off con_pbt)
;;

let longname = function
  | Parameter_set_body_container_t.Parameter_set_body_tuple_container con_pbt ->
      (Parameter_set_body_tuple_container_v.longname con_pbt)
;;

let fullname = function
  | Parameter_set_body_container_t.Parameter_set_body_tuple_container con_pbt ->
      (Parameter_set_body_tuple_container_v.fullname con_pbt)
;;
...
let builder_tag_list_of_tag tag_pbo =
  ...
  | Parameter_set_body_symbol_t.Parameter_set_body_tuple_symbol sym_pbt ->
      let tag_pbt = Tag_v.make sym_pbt soi_pbo in
      Parameter_set_body_tuple_container_v.builder_tag_list_of_tag tag_pbt
;;
...
let builder_tag_tuple_of_tag tag_pbo =
  ...
  | Parameter_set_body_symbol_t.Parameter_set_body_tuple_symbol sym_pbt ->
      let tag_pbt = Tag_v.make sym_pbt soi_pbo in
      Parameter_set_body_tuple_container_v.builder_tag_tuple_of_tag tag_pbt
;;
...
(* generated by ./do_container_as_tuple_body_trunc_1sibling_1containee_v.sh parameter_set_body pbo parameter_set_body_tuple pbt parameter_set_fence psf *)
(* using ./template_container_as_tuple_body_trunc_1sibling_1containee_v.ml *)
