(** {3 Context_name_duo_by_fullnameofdirectory_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : CONS:Context_name_duo_by_fullnameofdirectory_provider_v";
   ...
   "Author : François Colonna 01 avril 2017 at 18:28:58+02:00";
 ]
;;
...
(* done with do_provider_without_register.sh Context_name_duo_by_fullnameofdirectory_provider_v.ml force on samedi 8 octobre 2016, 18:52:58 (UTC+0200) *)
