(** {3 Sector_ordinal_by_sector_name_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : CONS:Sector_ordinal_by_sector_name_register_v";
   "Author : François Colonna 27 avril 2017 at 08:52:11+02:00";
 ]
;;
...
let name_of_value val_ =
  String_v.string_of_integer val_
;;
...
(* done with do_register.sh force on lundi 17 octobre 2016, 10:47:30 (UTC+0200) *)
