(** {3 Context_sole_index_by_basicname_domain_n_basicname_sector_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : CONS:Context_sole_index_by_basicname_domain_n_basicname_sector_provider_v";
   "Needs : CONS:Context_sole_index_by_context_name_quatuor_provider_v";
   "What-is-it : the Sole_index for any Basicname quatuor";
   "Author : François Colonna 31 mars 2017 at 12:44:06+02:00";
 ]
;;
