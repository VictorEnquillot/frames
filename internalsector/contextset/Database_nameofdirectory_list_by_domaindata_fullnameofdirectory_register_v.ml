(** {3 Database_nameofdirectory_list_by_domaindata_fullnameofdirectory_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : CONS:Database_nameofdirectory_list_by_domaindata_fullnameofdirectory_register_v";
