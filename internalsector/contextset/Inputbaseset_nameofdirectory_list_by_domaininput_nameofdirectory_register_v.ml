(** {3 Inputbaseset_nameofdirectory_list_by_domaininput_nameofdirectory_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : CONS:Inputbaseset_nameofdirectory_list_by_domaininput_nameofdirectory_register_v";
