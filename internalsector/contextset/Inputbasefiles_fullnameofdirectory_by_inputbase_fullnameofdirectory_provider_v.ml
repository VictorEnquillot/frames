(** {3 Inputbasefiles_fullnameofdirectory_by_inputbase_fullnameofdirectory_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : CONS:Inputbasefiles_fullnameofdirectory_by_inputbase_fullnameofdirectory_provider_v";
...
(* done with do_provider_without_register.sh Inputbasefiles_fullnameofdirectory_by_inputbase_fullnameofdirectory_provider_v.ml force on samedi 8 octobre 2016, 18:53:00 (UTC+0200) *)
