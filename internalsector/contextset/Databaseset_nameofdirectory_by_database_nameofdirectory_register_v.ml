(** {3 Databaseset_nameofdirectory_by_database_nameofdirectory_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : CONS:Databaseset_nameofdirectory_by_database_nameofdirectory_register_v";
   "Author : François Colonna 08 octobre 2016 at 13:36:14+02:00";
 ]
;;
