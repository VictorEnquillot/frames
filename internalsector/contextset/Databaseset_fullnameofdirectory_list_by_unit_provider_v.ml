(** {3 Databaseset_fullnameofdirectory_list_by_unit_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : CONS:Databaseset_fullnameofdirectory_list_by_unit_provider_v";
...
(* done with do_provider_without_register.sh Databaseset_fullnameofdirectory_list_by_unit_provider_v.ml force on samedi 8 octobre 2016, 18:52:51 (UTC+0200) *)
