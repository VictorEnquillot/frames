(** {3 Inputbox_nameoffile_list_by_inputbasefiles_fullnameofdirectory_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : CONS:Inputbox_nameoffile_list_by_inputbasefiles_fullnameofdirectory_register_v";
   "Author : François Colonna 02 juillet 2016 at 12:37:54+02:00";
 ]
;;
