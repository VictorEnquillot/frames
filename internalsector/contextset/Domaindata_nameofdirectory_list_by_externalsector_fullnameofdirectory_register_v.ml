(** {3 Domaindata_nameofdirectory_list_by_externalsector_fullnameofdirectory_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : CONS:Domaindata_nameofdirectory_list_by_externalsector_fullnameofdirectory_register_v";
