(** {3 Inputbaseset_nameofdirectory_by_inputbase_nameofdirectory_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : CONS:Inputbaseset_nameofdirectory_by_inputbase_nameofdirectory_register_v";
   "Author : François Colonna 08 octobre 2016 at 13:36:56+02:00";
 ]
;;
