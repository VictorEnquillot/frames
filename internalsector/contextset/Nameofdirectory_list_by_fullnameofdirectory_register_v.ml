(** {3 Nameofdirectory_list_by_fullnameofdirectory_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : CONS:Nameofdirectory_list_by_fullnameofdirectory_register_v";
   "Author : François Colonna 10 juin 2016 at 12:12:56+02:00";
 ]
;;
...
(* done with do_register.sh force on lundi 17 octobre 2016, 10:47:29 (UTC+0200) *)
