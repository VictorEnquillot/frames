(** {3 Inputbase_nameofdirectory_list_by_domaininput_nameofdirectory_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : CONS:Inputbase_nameofdirectory_list_by_domaininput_nameofdirectory_register_v";
   "Author : François Colonna 21 août 2016 at 12:03:46+02:00";
 ]
;;
