(** {3 Domaindata_fullnameofdirectory_list_by_externalsector_fullnameofdirectory_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : CONS:Domaindata_fullnameofdirectory_list_by_externalsector_fullnameofdirectory_register_v";
...
(* done with do_register.sh force on lundi 17 octobre 2016, 10:47:25 (UTC+0200) *)
