(** {3 Databox_nameoffile_list_by_database_nameofdirectory_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : CONS:Databox_nameoffile_list_by_database_nameofdirectory_register_v";
   "Author : François Colonna 08 octobre 2016 at 13:32:06+02:00";
 ]
;;
