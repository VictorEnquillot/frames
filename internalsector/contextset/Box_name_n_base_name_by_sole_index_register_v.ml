(** {3 Box_name_n_base_name_by_sole_index_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : CONS:Box_name_n_base_name_by_sole_index_register_v";
   "Author : François Colonna 01 mai 2016 at 12:52:39+02:00";
 ]
;;
...
(* done with do_register.sh force on lundi 17 octobre 2016, 10:47:22 (UTC+0200) *)
