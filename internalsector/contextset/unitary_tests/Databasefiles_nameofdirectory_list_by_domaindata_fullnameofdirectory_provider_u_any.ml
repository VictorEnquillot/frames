...
testing "Databasefiles_nameofdirectory_list_by_domaindata_fullnameofdirectory_provider_v
...
(* toplevel 
   #use "Databasefiles_nameofdirectory_list_by_domaindata_fullnameofdirectory_provider_u_any.ml";;

*)

open Databasefiles_nameofdirectory_list_by_domaindata_fullnameofdirectory_provider_v;;

let fnd_dda_l = Domaindata_fullnameofdirectory_list_by_unit_provider_v.provide ();;

test_number 1 (
(fnd_dda_l : string list ) =
...
let fnd_dda = List_v.last_element_off_list fnd_dda_l;;
...
test_number 4 (
(nod_dbf_nsl : String.t list ) =
 ["g9xdatafiles"; "molprodatafiles"; "nwchemdatafiles"]
);;

let nod_dbf_l = List.sort String.compare nod_dbf_nsl;;

test_number 5 (
nod_dbf_l = provide fnd_dda
);;
