...
testing "Inputbaseset_fullnameofdirectory_by_inputbaseset_nameofdirectory_provider_v
...
(* toplevel 
   #use "Inputbaseset_fullnameofdirectory_by_inputbaseset_nameofdirectory_provider_u_any.ml";;

*)

open Inputbaseset_fullnameofdirectory_by_inputbaseset_nameofdirectory_provider_v;;

let fnd_ibs_l = Inputbaseset_fullnameofdirectory_list_by_unit_provider_v.provide ();;

test_number 1 (
( fnd_ibs_l : string list ) =
 ["/home/colonna/sources/ocaml_top/setup/frames/entrysector/userinput/localinput/localinputset"]
);;

let nod_ibs = "localinputset";;
let fnd_ibs = List_v.only_element_of_predicate_off_list (fun f -> Filename.basename f = nod_ibs) fnd_ibs_l;;
