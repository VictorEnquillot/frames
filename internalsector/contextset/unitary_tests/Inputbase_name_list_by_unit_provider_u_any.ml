...
testing "Inputbase_name_list_by_unit_provider_v
...
(* toplevel 
   #use "Inputbase_name_list_by_unit_provider_u_any.ml";;

*)

open Inputbase_name_list_by_unit_provider_v;;

let nof_iba_l = Inputbase_nameofdirectory_list_by_unit_provider_v.provide ();;

test_number 1 (
( nof_iba_l : String.t list ) =
  ["localinput"]
);;

let nam_iba_l = List.map Context_name_by_context_nameofdirectory_provider_v.provide nof_iba_l;;

test_number 2 (
( nam_iba_l : String.t list ) =
  ["local"]
);;
