...
testing "Context_name_databox_by_databox_fullnameoffile_provider_v
...
(* toplevel 
   #use "Context_name_databox_by_databox_fullnameoffile_provider_u_any.ml";;

*)

open Context_name_databox_by_databox_fullnameoffile_provider_v;;

(* Nwchemset *)

let env_var = "NWCF";;
let fnd = Sys.getenv env_var ;;
let fno_dbo = fnd ^ "/cc_pVTZ.nwc";;
...
test_number 2 (
 List.mem fno_dbo fno_dbo_l
);;

let wor_l = String_v.split_of_character_of_string '/' fno_dbo;;

test_number 3 (
(wor_l : string list ) =
  ["home"; "colonna"; "sources"; "ocaml_top"; "setup"; "frames";
   "externalsector"; "skeletondata"; "nwchemdata"; "nwchemdatafiles";
   "cc_pVTZ.nwc"]
);;

let nof_dbo = List_v.last_element_off_list wor_l;;
...
let nam_dbo = Context_name_by_context_nameoffile_provider_v.provide nof_dbo;;
