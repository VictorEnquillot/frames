...
testing "Inputbase_nameofdirectory_list_by_domaininput_fullnameofdirectory_provider_v
...
(* toplevel 
   #use "Inputbase_nameofdirectory_list_by_domaininput_fullnameofdirectory_provider_u_any.ml";;

*)

open Inputbase_nameofdirectory_list_by_domaininput_fullnameofdirectory_provider_v;;
...
let nod_iba_l = Nameofdirectory_list_by_fullnameofdirectory_provider_v.provide fnd_din ;;
...
let nod_iba_nsl = List.filter is_inputdirectory_of_nameofdirectory nod_iba_l;;

test_number 3 (
( nod_iba_nsl : String.t list ) = 
["localinput"]
);;

let nod_iba_l = List.sort String.compare nod_iba_nsl;;
