...
testing "Context_sole_index_by_domain_name_n_sector_name_provider_v
...
(* toplevel 
   #use "Context_sole_index_by_domain_name_n_sector_name_provider_u_any.ml";;

*)

open Context_sole_index_by_domain_name_n_sector_name_provider_v;;
...
test_number 5 (
soi_con = provide (nam_dom, nam_sec)
);;
