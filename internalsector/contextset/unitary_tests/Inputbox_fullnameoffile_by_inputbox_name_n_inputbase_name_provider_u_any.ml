...
testing "Inputbox_fullnameoffile_by_inputbox_name_n_inputbase_name_provider_v
...
(* toplevel 
   #use "Inputbox_fullnameoffile_by_inputbox_name_n_inputbase_name_provider_u_any.ml";;

*)

open Inputbox_fullnameoffile_by_inputbox_name_n_inputbase_name_provider_v;;

let fno_ibo_l = Inputbox_fullnameoffile_list_by_unit_provider_v.provide ();;

test_number 1 (
( fno_ibo_l : String.t list ) =
...
let nam_iba = "local";;
let nam_ibo = "Write";;  (* <== Capitalized *)

let nof_ibo = 
  Inputbox_nameoffile_by_inputbox_name_n_inputbase_name_provider_v.provide
    (nam_ibo, nam_iba);;
...
let fno_ibo = Inputbox_fullnameoffile_by_inputbox_nameoffile_provider_v.provide nof_ibo;;
...
test_number 4 (
fno_ibo = provide (nam_ibo, nam_iba)
);;

let nam_ibo = "Point_a_print";;

let fno_ibo = provide (nam_ibo, nam_iba);;
