...
testing "Inputbasefiles_nameofdirectory_list_by_domaininput_fullnameofdirectory_provider_v
...
(* toplevel 
   #use "Inputbasefiles_nameofdirectory_list_by_domaininput_fullnameofdirectory_provider_u_any.ml";;

*)

open Inputbasefiles_nameofdirectory_list_by_domaininput_fullnameofdirectory_provider_v;;

let fnd_din_l = Domaininput_fullnameofdirectory_list_by_unit_provider_v.provide ();;

test_number 1 (
(fnd_din_l : string list ) =
  ["/home/colonna/sources/ocaml_top/setup/frames/entrysector/userinput"]
);;

let fnd_din = List.hd fnd_din_l;;
...
test_number 3 (
(nod_ibf_nsl : String.t list) = 
["localinputfiles"]
);;

let nod_ibf_l = List.sort String.compare nod_ibf_nsl;;
