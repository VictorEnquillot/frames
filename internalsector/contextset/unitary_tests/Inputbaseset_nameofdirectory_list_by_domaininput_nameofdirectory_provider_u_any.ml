...
testing "Inputbaseset_nameofdirectory_list_by_domaininput_nameofdirectory_provider_v
...
(* toplevel 
   #use "Inputbaseset_nameofdirectory_list_by_domaininput_nameofdirectory_provider_u_any.ml";;

*)

open Inputbaseset_nameofdirectory_list_by_domaininput_nameofdirectory_provider_v;;
...
let nod_ibs_l = Inputbaseset_nameofdirectory_list_by_domaininput_fullnameofdirectory_provider_v.provide fnd_din;;

test_number 2 (
(nod_ibs_l : string list) = 
  ["localinputset"]
);;

test_number 3 (
nod_ibs_l = provide nod_din
);;
