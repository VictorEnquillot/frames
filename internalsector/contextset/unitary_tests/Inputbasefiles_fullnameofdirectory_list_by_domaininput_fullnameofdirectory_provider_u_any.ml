...
testing "Inputbasefiles_fullnameofdirectory_list_by_domaininput_fullnameofdirectory_provider_v
...
(* toplevel 
   #use "Inputbasefiles_fullnameofdirectory_list_by_domaininput_fullnameofdirectory_provider_u_any.ml";;

*)

open Inputbasefiles_fullnameofdirectory_list_by_domaininput_fullnameofdirectory_provider_v;;
...
test_number 3 (
(fnd_ibf_nsl : string list ) =
 ["/home/colonna/sources/ocaml_top/setup/frames/entrysector/userinput/localinput/localinputfiles"]
);;

let fnd_ibf_l = List.sort String.compare fnd_ibf_nsl;;

test_number 4 (
(fnd_ibf_l : String.t list ) =
 ["/home/colonna/sources/ocaml_top/setup/frames/entrysector/userinput/localinput/localinputfiles"]
);;

test_number 5 (
fnd_ibf_l = provide fnd_din
);;
