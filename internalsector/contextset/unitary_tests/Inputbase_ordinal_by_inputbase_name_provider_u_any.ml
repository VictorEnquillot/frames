...
testing "Inputbase_ordinal_by_inputbase_name_provider_v
...
(* toplevel 
   #use "Inputbase_ordinal_by_inputbase_name_provider_u_any.ml";;

*)

open Inputbase_ordinal_by_inputbase_name_provider_v;;
...
let nam_iba = List_v.last_element_off_list nam_iba_l;;
...
let ord_iba = List_v.int_ordinal_of_element_of_list nam_iba nam_iba_l;;
