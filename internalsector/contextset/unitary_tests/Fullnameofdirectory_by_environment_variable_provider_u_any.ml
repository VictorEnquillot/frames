...
testing "Fullnameofdirectory_by_environment_variable_provider_v
...
(* toplevel 
   #use "Fullnameofdirectory_by_environment_variable_provider_u_any.ml";;

*)

open Fullnameofdirectory_by_environment_variable_provider_v;;

let fnd_fra = provide "FRA";;
