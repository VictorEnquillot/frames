...
testing "Sector_fullnameofdirectory_by_sector_nameofdirectory_provider_v
...
(* toplevel 
   #use "Sector_fullnameofdirectory_by_sector_nameofdirectory_provider_u_any.ml";;

*)

open Sector_fullnameofdirectory_by_sector_nameofdirectory_provider_v;;

let fnd_fra = Frames_fullnameofdirectory_by_unit_provider_v.provide ();;
...
let nod_sec = "entry";;
let fnd_sec = fnd_fra ^ "/" ^ nod_sec;;

test_number 2 (
(fnd_sec : string ) =
"/home/colonna/sources/ocaml_top/setup/frames/entry"
);;

test_number 3 (
fnd_sec = provide nod_sec
);;
