...
testing "Inputbasefiles_fullnameofdirectory_by_inputbase_fullnameofdirectory_provider_v
...
(* toplevel 
   #use "Inputbasefiles_fullnameofdirectory_by_inputbase_fullnameofdirectory_provider_u_any.ml";;

*)

open Inputbasefiles_fullnameofdirectory_by_inputbase_fullnameofdirectory_provider_v;;
...
let fnd_ibf =  fnd_iba ^ "/" ^ (nod_iba ^ "files");;
