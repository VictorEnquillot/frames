...
testing "Databox_fullnameoffile_by_databox_name_n_database_name_provider_v
...
(* toplevel 
   #use "Databox_fullnameoffile_by_databox_name_n_database_name_provider_u_any.ml";;

*)

open Databox_fullnameoffile_by_databox_name_n_database_name_provider_v;;
...
let nof_dbo = Databox_nameoffile_by_databox_name_n_database_name_provider_v.provide (nam_dbo, nam_dba);;
...
let fno_dbo =  Databox_fullnameoffile_by_databox_nameoffile_provider_v.provide nof_dbo;;
...
test_number 3 (
fno_dbo = provide (nam_dbo, nam_dba)
);;
