...
testing "Inputbaseset_nameofdirectory_list_by_domaininput_fullnameofdirectory_provider_v
...
(* toplevel 
   #use "Inputbaseset_nameofdirectory_list_by_domaininput_fullnameofdirectory_provider_u_any.ml";;

*)

open Inputbaseset_nameofdirectory_list_by_domaininput_fullnameofdirectory_provider_v;;
...
test_number 3 (
(nod_ibs_nsl : String.t list ) = 
["localinputset"]
);;

let nod_ibs_l = List.sort String.compare nod_ibs_nsl;;

test_number 4 (
(nod_ibs_l : String.t list ) = 
["localinputset"]
);;

test_number 5 (
nod_ibs_l = provide fnd_din
);;
