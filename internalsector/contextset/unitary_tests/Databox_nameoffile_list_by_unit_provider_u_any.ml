...
testing "Databox_nameoffile_list_by_unit_provider_v
...
(* toplevel 
   #use "Databox_nameoffile_list_by_unit_provider_u_any.ml";;

*)

open Databox_nameoffile_list_by_unit_provider_v;;

let nod_dbf_l = Databasefiles_nameofdirectory_list_by_unit_provider_v.provide ();;

test_number 1 (
(nod_dbf_l : string list ) =
...
let nof_dbo_l = List.flatten nof_dbo_ll;;

test_number 2 (
(nof_dbo_l : String.t list ) =
  ["Point_a.db1"; "segment_BC.db1"; "segment_S.db1"; "triangle_isoacute.db1";
   "triangle_isoobtuse.db1"; "triangle_isoright.db1"; "triangle_ire.db2";
   "triangle_iso.db2"; "3_21G.g9x"; "STO_3G.g9x"; "VTZ.g9x"; "cc_pVTZ.g9x";
   "3_21G.nwc"; "6_31GSS.nwc"; "6_31GSSP.nwc"; "LANL2DZ.nwc"; "cc_pVTZ.nwc";
   "try_ao.nwc"; "try_ao_ecp.nwc"; "try_ecp.nwc"]
);;

test_number 3 (
List.sort String.compare nof_dbo_l = provide ()
);;
