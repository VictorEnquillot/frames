...
testing "Inputbase_fullnameofdirectory_by_inputbase_nameofdirectory_provider_v
...
(* toplevel 
   #use "Inputbase_fullnameofdirectory_by_inputbase_nameofdirectory_provider_u_any.ml";;

*)

open Inputbase_fullnameofdirectory_by_inputbase_nameofdirectory_provider_v;;
...
let nod_iba = "localinput";;
let fnd_iba = List_v.only_element_of_predicate_off_list (fun f -> Filename.basename f = nod_iba) fnd_iba_l;;
