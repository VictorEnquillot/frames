...
testing "Inputbasefiles_fullnameofdirectory_by_inputbasefiles_nameofdirectory_provider_v
...
(* toplevel 
   #use "Inputbasefiles_fullnameofdirectory_by_inputbasefiles_nameofdirectory_provider_u_any.ml";;

*)

open Inputbasefiles_fullnameofdirectory_by_inputbasefiles_nameofdirectory_provider_v;;

let nod_ibf = "localinputfiles";;

let fnd_dbs_l = Inputbasefiles_fullnameofdirectory_list_by_unit_provider_v.provide ();;
...
let fnd_ibf = List_v.only_element_of_predicate_off_list (fun f -> Filename.basename f = nod_ibf) fnd_dbs_l;;
