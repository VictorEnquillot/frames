...
testing "Databox_fullnameoffile_by_databox_nameoffile_provider_v
...
(* toplevel 
   #use "Databox_fullnameoffile_by_databox_nameoffile_provider_u_any.ml";;

*)

open Databox_fullnameoffile_by_databox_nameoffile_provider_v;;

let fnd_dbo_l = Databox_fullnameoffile_list_by_unit_provider_v.provide ();;

(* "cc_pVTZ.nwc" *)

let nof_dbo = "cc_pVTZ.nwc";;

let fno_dbo = List_v.only_element_of_predicate_off_list (fun f -> Filename.basename f = nof_dbo) fnd_dbo_l;;
...
test_number 2 (
fno_dbo = provide nof_dbo
);;

(* "cc_pVTZ.g9x" *)

let nof_dbo = "cc_pVTZ.g9x";;
