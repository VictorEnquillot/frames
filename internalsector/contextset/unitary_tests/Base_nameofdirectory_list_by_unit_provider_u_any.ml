...
testing "Base_nameofdirectory_list_by_unit_provider_v
...
(* toplevel 
   #use "Base_nameofdirectory_list_by_unit_provider_u_any.ml";;

*)

open Base_nameofdirectory_list_by_unit_provider_v;;
...
test_number 2 (
(nod_iba_l : string list ) =
["localinput"]
);;

let nod_bas_nsl =
    (Database_nameofdirectory_list_by_unit_provider_v.provide ()) @ 
    (Inputbase_nameofdirectory_list_by_unit_provider_v.provide ());;

test_number 3 (
(nod_bas_nsl : string list ) =
  ["db1pointsdata"; "db2geometrydata"; "g9xdata"; "molprodata"; "nwchemdata";
   "localinput"]
);;

let nod_bas_l = List.sort compare nod_bas_nsl;;

test_number 4 (
(nod_bas_l : string list ) =
  ["db1pointsdata"; "db2geometrydata"; "g9xdata"; "localinput"; "molprodata";
   "nwchemdata"]
);;
