...
testing "Check_is_inputbox_name_by_name_provider_v
...
(* toplevel 
   #use "Check_is_inputbox_name_by_name_provider_u_any.ml";;

*)

open Check_is_inputbox_name_by_name_provider_v;;
  
let nam_dom_l =  Inputbox_name_list_by_unit_provider_v.provide ();;
