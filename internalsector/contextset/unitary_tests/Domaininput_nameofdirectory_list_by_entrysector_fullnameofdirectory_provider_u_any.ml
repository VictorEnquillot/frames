...
testing "Domaininput_nameofdirectory_list_by_entrysector_fullnameofdirectory_provider_v
...
(* toplevel 
   #use "Domaininput_nameofdirectory_list_by_entrysector_fullnameofdirectory_provider_u_any.ml";;

*)

open Domaininput_nameofdirectory_list_by_entrysector_fullnameofdirectory_provider_v;;

let fno_ens = Entrysector_fullnameofdirectory_by_unit_provider_v.provide ();;
...
let nod_ens_l = Nameofdirectory_list_by_fullnameofdirectory_provider_v.provide fno_ens;; 

test_number 2 (
(nod_ens_l : string list) =
[ "userinput"]
);;

let nod_din_l = List.filter is_inputdirectory_of_nameofdirectory nod_ens_l;;
