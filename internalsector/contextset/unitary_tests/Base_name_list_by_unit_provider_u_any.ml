...
testing "Base_name_list_by_unit_provider_v
...
(* toplevel 
   #use "Base_name_list_by_unit_provider_u_any.ml";;

*)

open Base_name_list_by_unit_provider_v;;
...
test_number 3 (
(nam_bas_nsl : string list ) =
  ["db1points"; "db2geometry"; "g9x"; "molpro"; "nwchem"; "local"]
);;

let nam_bas_l = List.sort compare nam_bas_nsl;;

test_number 4 (
(nam_bas_l : string list ) =
  ["db1points"; "db2geometry"; "g9x"; "local"; "molpro"; "nwchem"]
);;
