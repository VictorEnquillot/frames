...
testing "Sector_ordinal_by_sector_name_provider_v
...
(* toplevel 
   #use "Sector_ordinal_by_sector_name_provider_u_any.ml";;

*)

open Sector_ordinal_by_sector_name_provider_v;;

let nam_sec = "internal";;

let nam_sec_l = Sector_name_list_by_unit_provider_v.provide ();;
  
test_number 1 (
( nam_sec_l : String.t list ) =
  ["entry"; "external"; "general"; "generator"; "internal"; "product"]
);;

let ord_sec = List_v.int_ordinal_of_element_of_list nam_sec nam_sec_l;;
