...
testing "Check_is_inputbase_name_by_name_provider_v
...
(* toplevel 
   #use "Check_is_inputbase_name_by_name_provider_u_any.ml";;

*)

open Check_is_inputbase_name_by_name_provider_v;;
  
let nam_dom_l =  Inputbase_name_list_by_unit_provider_v.provide ();;

let nam_dom = List.hd nam_dom_l;;

test_number 1 (
List.mem nam_dom nam_dom_l
);;
