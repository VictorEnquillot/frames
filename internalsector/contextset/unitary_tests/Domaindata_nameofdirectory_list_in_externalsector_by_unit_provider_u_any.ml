...
testing "Domaindata_nameofdirectory_list_in_externalsector_by_unit_provider_v
...
(* toplevel 
   #use "Domaindata_nameofdirectory_list_in_externalsector_by_unit_provider_u_any.ml";;

*)

open Domaindata_nameofdirectory_list_in_externalsector_by_unit_provider_v;;

let fno_exs = Externalsector_fullnameofdirectory_by_unit_provider_v.provide ();;

test_number 1 (
(fno_exs : string ) =
  "/home/colonna/sources/ocaml_top/setup/frames/externalsector"
);;

let nod_exs_l = Nameofdirectory_list_by_fullnameofdirectory_provider_v.provide fno_exs;; 

test_number 2 (
(nod_exs_l : String.t list ) =
  [ "chemicaldata"; "figuredata"; "skeletondata"]
);;

let nod_dda_l = List.filter is_datadirectory_of_nameofdirectory nod_exs_l;;
...
let inv = invariant_of_domaindata_nameofdirectory_list nod_dda_l;
