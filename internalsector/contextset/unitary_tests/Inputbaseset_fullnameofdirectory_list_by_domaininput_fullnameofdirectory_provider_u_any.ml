...
testing "Inputbaseset_fullnameofdirectory_list_by_domaininput_fullnameofdirectory_provider_v
...
(* toplevel 
   #use "Inputbaseset_fullnameofdirectory_list_by_domaininput_fullnameofdirectory_provider_u_any.ml";;

*)

open Inputbaseset_fullnameofdirectory_list_by_domaininput_fullnameofdirectory_provider_v;;

let nod_din = "userinput";;
...
test_number 3 (
(fnd_ibs_nsl : String.t list ) = 
  ["/home/colonna/sources/ocaml_top/setup/frames/entrysector/userinput/localinput/localinputset"]
);;

let fnd_ibs_l = List.sort String.compare fnd_ibs_nsl;;

test_number 4 (
(fnd_ibs_l : String.t list ) = 
  ["/home/colonna/sources/ocaml_top/setup/frames/entrysector/userinput/localinput/localinputset"]
);;

test_number 5 (
fnd_ibs_l = provide fnd_din
);;
