...
testing "Check_is_database_fullnameofdirectory_by_fullnameofdirectory_provider_v
...
(* toplevel 
   #use "Check_is_database_fullnameofdirectory_by_fullnameofdirectory_provider_u_any.ml";;

*)

open Check_is_database_fullnameofdirectory_by_fullnameofdirectory_provider_v;;
