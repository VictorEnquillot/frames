...
testing "Databox_ordinal_by_databox_name_provider_v
...
(* toplevel 
   #use "Databox_ordinal_by_databox_name_provider_u_any.ml";;

*)

open Databox_ordinal_by_databox_name_provider_v;;
...
let ord_dbo = List_v.int_ordinal_of_element_of_list nam_dbo nam_dbo_l;;
