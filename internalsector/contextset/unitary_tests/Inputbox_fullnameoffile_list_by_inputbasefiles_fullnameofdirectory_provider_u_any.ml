...
testing "Inputbox_fullnameoffile_list_by_inputbasefiles_fullnameofdirectory_provider_v
...
(* toplevel 
   #use "Inputbox_fullnameoffile_list_by_inputbasefiles_fullnameofdirectory_provider_u_any.ml";;

*)

open Inputbox_fullnameoffile_list_by_inputbasefiles_fullnameofdirectory_provider_v;;
...
let fnf_ibo_l = List.map (fun n -> fnd_ibf ^ "/" ^ n) nof_ibo_l;;

test_number 3 (
(fnf_ibo_l : string list ) =
