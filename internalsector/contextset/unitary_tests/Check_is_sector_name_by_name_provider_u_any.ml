...
testing "Check_is_sector_name_by_name_provider_v
...
(* toplevel 
   #use "Check_is_sector_name_by_name_provider_u_any.ml";;

*)

open Check_is_sector_name_by_name_provider_v;;
  
let nam_sec_l =  Sector_name_list_by_unit_provider_v.provide ();;

let nam_sec = List.hd nam_sec_l;;

test_number 1 (
List.mem nam_sec nam_sec_l
);;
