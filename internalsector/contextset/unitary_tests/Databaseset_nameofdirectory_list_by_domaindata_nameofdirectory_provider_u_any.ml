...
testing "Databaseset_nameofdirectory_list_by_domaindata_nameofdirectory_provider_v
...
(* toplevel 
   #use "Databaseset_nameofdirectory_list_by_domaindata_nameofdirectory_provider_u_any.ml";;

*)

open Databaseset_nameofdirectory_list_by_domaindata_nameofdirectory_provider_v;;
...
let nod_dbs_l = Databaseset_nameofdirectory_list_by_domaindata_fullnameofdirectory_provider_v.provide fnd_dda;;

test_number 2 (
(nod_dbs_l : string list) = 
  ["db1pointsdataset"; "db2geometrydataset"]
);;

test_number 3 (
nod_dbs_l = provide nod_dda
);;
