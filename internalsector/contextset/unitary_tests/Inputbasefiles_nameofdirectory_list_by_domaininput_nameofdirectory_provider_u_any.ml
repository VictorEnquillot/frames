...
testing "Inputbasefiles_nameofdirectory_list_by_domaininput_nameofdirectory_provider_v
...
(* toplevel 
   #use "Inputbasefiles_nameofdirectory_list_by_domaininput_nameofdirectory_provider_u_any.ml";;

*)

open Inputbasefiles_nameofdirectory_list_by_domaininput_nameofdirectory_provider_v;;

let nof_din = "userinput";;

let fnd_din = Domaininput_fullnameofdirectory_by_domaininput_nameofdirectory_provider_v.provide nof_din;;
...
let nod_dbf_l = Inputbasefiles_nameofdirectory_list_by_domaininput_fullnameofdirectory_provider_v.provide fnd_din;;
