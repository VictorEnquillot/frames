...
testing "Context_name_trio_by_fullnameofdirectory_provider_v
...
(* toplevel 
   #use "Context_name_trio_by_fullnameofdirectory_provider_u_any.ml";;

*)

open Context_name_trio_by_fullnameofdirectory_provider_v;;
...
let nam_con_t = Trio_v.trio_of_list nam_con_l;;
