...
testing "Context_ordinal_quatuor_by_box_fullnameoffile_provider_v
...
(* toplevel 
   #use "Context_ordinal_quatuor_by_box_fullnameoffile_provider_u_any.ml";;

*)

open Context_ordinal_quatuor_by_box_fullnameoffile_provider_v;;

let nam_ibo = "Point_a_print";;
let nam_iba = "local";;

let fno_box = Inputbox_fullnameoffile_by_inputbox_name_n_inputbase_name_provider_v.provide (nam_ibo, nam_iba);;
...
let nam_qua = Context_name_quatuor_by_box_fullnameoffile_provider_v.provide fno_box;;
...
let ord_qua = Context_ordinal_quatuor_by_context_name_quatuor_provider_v.provide nam_qua;;
