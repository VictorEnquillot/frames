...
testing "Inputbaseset_fullnameofdirectory_by_inputbase_fullnameofdirectory_provider_v
...
(* toplevel 
   #use "Inputbaseset_fullnameofdirectory_by_inputbase_fullnameofdirectory_provider_u_any.ml";;

*)

open Inputbaseset_fullnameofdirectory_by_inputbase_fullnameofdirectory_provider_v;;

let fnd_iba_l = Inputbase_fullnameofdirectory_list_by_unit_provider_v.provide ();;
...
let fnd_iba = List.hd fnd_iba_l;;

let nod_iba = Filename.basename fnd_iba ;;
...
let fnd_ibs = fnd_iba ^ "/" ^ (nod_iba ^ "set");;
