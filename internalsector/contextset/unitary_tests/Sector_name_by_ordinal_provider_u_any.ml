...
testing "Sector_name_by_ordinal_provider_v
...
(* toplevel 
   #use "Sector_name_by_ordinal_provider_u_any.ml";;

*)

open Sector_name_by_ordinal_provider_v;;
...
let nam_sec = List.nth nam_sec_l (ord_sec -1) ;;
