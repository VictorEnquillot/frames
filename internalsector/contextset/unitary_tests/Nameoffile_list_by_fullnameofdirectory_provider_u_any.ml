...
testing "Nameoffile_list_by_fullnameofdirectory_provider_v
...
(* toplevel 
   #use "Nameoffile_list_by_fullnameofdirectory_provider_u_any.ml";;

*)

open Nameoffile_list_by_fullnameofdirectory_provider_v;;

let fnd = Frames_fullnameofdirectory_by_unit_provider_v.provide ();;
...
let nof_a = Sys.readdir fnd;;

let nof_l = Array.to_list nof_a;;

test_number 2 (
(nof_l : String.t list ) =  
["Documentation"; "functional_tests"; "needed_dirs.mk"; "internalsector";
   ".toplevel-history"; "generalsector"; "figureset"; "fake_v.ml";
   ".depend-rebuild"; "Active_sets.sh"; "externalsector"; "files_mli.mk";
   "configure_local"; "configure"; "Makefile"; ".depend"; "unitary_tests";
   ".gitignore"; "Architecture"; "entrysector"; "diagrams";
   "included_dirs.mk"; "productsector"; "generatorsector"]
);;

test_number 3 (
List.sort String.compare nof_l = provide fnd
);;
