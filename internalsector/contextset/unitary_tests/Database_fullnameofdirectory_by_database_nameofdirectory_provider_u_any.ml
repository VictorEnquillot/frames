...
testing "Database_fullnameofdirectory_by_database_nameofdirectory_provider_v
...
(* toplevel 
   #use "Database_fullnameofdirectory_by_database_nameofdirectory_provider_u_any.ml";;

*)

open Database_fullnameofdirectory_by_database_nameofdirectory_provider_v;;
...
let nod_dba = "nwchemdata";;
let fnd_dba = List_v.only_element_of_predicate_off_list (fun f -> Filename.basename f = nod_dba) fnd_dba_l;;
