...
testing "Inputbase_fullnameofdirectory_list_by_domaininput_fullnameofdirectory_provider_v
...
(* toplevel 
   #use "Inputbase_fullnameofdirectory_list_by_domaininput_fullnameofdirectory_provider_u_any.ml";;

*)

open Inputbase_fullnameofdirectory_list_by_domaininput_fullnameofdirectory_provider_v;;
...
let nod_iba_l = Inputbase_nameofdirectory_list_by_domaininput_fullnameofdirectory_provider_v.provide fnd_din;;
...
let fnd_iba_l = List.map (fun n -> fnd_din ^ "/" ^ n) nod_iba_l;;
