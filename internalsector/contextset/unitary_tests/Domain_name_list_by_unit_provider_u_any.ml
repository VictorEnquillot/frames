...
testing "Domain_name_list_by_unit_provider_v
...
(* toplevel 
   #use "Domain_name_list_by_unit_provider_u_any.ml";;

*)

open Domain_name_list_by_unit_provider_v;;

let nod_dse_l = Domainset_nameofdirectory_list_by_unit_provider_v.provide ();;
...
( nod_dse_l : String.t list ) =
  ["basisfunctionset"; "chemicalset"; "commonset"; "contextset";
   ...
   "operatorset"; "parameterset"; "primitiveset"; "propertyset"; "readeeset";
   "skeletonset"; "wavefunctionset"; "wikitoolset"]
);;
...
( nam_dse_l : string list ) =
  ["basisfunction"; "chemical"; "common"; "context"; "coordinate";
   ...
   "music"; "natural"; "operator"; "parameter"; "primitive"; "property";
   "readee"; "skeleton"; "wavefunction"; "wikitool"]
);;

let nod_din_l = Domaininput_nameofdirectory_list_by_unit_provider_v.provide ();;
...
let nam_dom_nsl = nam_din_l @ nam_dse_l;;

test_number 5 (
(nam_dom_nsl : string list ) =
  ["user"; "basisfunction"; "chemical"; "common"; "context"; "coordinate";
   "elementary"; "figure"; "ghost"; "global"; "logic"; "measure"; "molecule";
   "music"; "natural"; "operator"; "parameter"; "primitive"; "property";
   "readee"; "skeleton"; "wavefunction"; "wikitool"]
);;

let nam_dom_l = List.sort String.compare nam_dom_nsl;;

test_number 6 (
(nam_dom_l : String.t list ) =
  ["basisfunction"; "chemical"; "common"; "context"; "coordinate";
   "elementary"; "figure"; "ghost"; "global"; "logic"; "measure"; "molecule";
   "music"; "natural"; "operator"; "parameter"; "primitive"; "property";
   "readee"; "skeleton"; "user"; "wavefunction"; "wikitool"]
);;
