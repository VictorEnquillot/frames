...
testing "Box_nameoffile_by_box_name_n_base_name_provider_v
...
(* toplevel 
   #use "Box_nameoffile_by_box_name_n_base_name_provider_u_any.ml";;

*)

open Box_nameoffile_by_box_name_n_base_name_provider_v;;

let nof_dbo_l = Box_nameoffile_list_by_unit_provider_v.provide ();;
...
let ext_dba = String_v.substring nam_dba 0 3;;
...
let nof_dbo = List_v.only_element_of_predicate_off_list (fun n -> n = nof_dbo) nof_dbo_l;;
...
test_number 4 (
nof_dbo = provide (nam_dbo, nam_dba)
);;
