...
testing "Domainset_nameofdirectory_list_in_internalsector_by_unit_provider_v
...
(* toplevel 
   #use "Domainset_nameofdirectory_list_in_internalsector_by_unit_provider_u_any.ml";;

*)

open Domainset_nameofdirectory_list_in_internalsector_by_unit_provider_v;;

let fno_ins = Internalsector_fullnameofdirectory_by_unit_provider_v.provide ();;
...
let nod_ins_l = Nameofdirectory_list_by_fullnameofdirectory_provider_v.provide fno_ins;;

test_number 2 (
(nod_ins_l : String.t list ) =
...
test_number 3 (
List.filter is_setdirectory_of_nameofdirectory nod_ins_l = provide ()
);;
