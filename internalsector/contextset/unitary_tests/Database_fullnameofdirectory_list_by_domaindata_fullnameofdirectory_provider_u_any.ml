...
testing "Database_fullnameofdirectory_list_by_domaindata_fullnameofdirectory_provider_v
...
(* toplevel 
   #use "Database_fullnameofdirectory_list_by_domaindata_fullnameofdirectory_provider_u_any.ml";;

*)

open Database_fullnameofdirectory_list_by_domaindata_fullnameofdirectory_provider_v;;
...
let nod_dba_l = Database_nameofdirectory_list_by_domaindata_fullnameofdirectory_provider_v.provide fnd_dda;;
...
let fnd_dba_l = List.map (fun n -> fnd_dda ^ "/" ^ n) nod_dba_l;;
