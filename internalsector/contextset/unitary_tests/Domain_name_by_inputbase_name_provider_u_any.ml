...
testing "Domain_name_by_inputbase_name_provider_v
...
(* toplevel 
   #use "Domain_name_by_inputbase_name_provider_u_any.ml";;

*)

open Domain_name_by_inputbase_name_provider_v;;
...
let nam_iba = List.hd nam_iba_l;;

let suffix = "input";;
let nod_iba = nam_iba ^ suffix;;
...
let nam_dom = String_v.cut_last_n_characters_of_count_of_string (String.length suffix) nod_din;;
