...
testing "Inputbox_nameoffile_list_by_inputbasefiles_nameofdirectory_provider_v
...
(* toplevel 
   #use "Inputbox_nameoffile_list_by_inputbasefiles_nameofdirectory_provider_u_any.ml";;

*)

open Inputbox_nameoffile_list_by_inputbasefiles_nameofdirectory_provider_v;;

let nod_ibf_l = Inputbasefiles_nameofdirectory_list_by_unit_provider_v.provide ();;

test_number 1 (
(nod_ibf_l : String.t list ) =
["localinputfiles"]
);;

let nod_ibf = List.hd nod_ibf_l;;

let fnd_ibf = Inputbasefiles_fullnameofdirectory_by_inputbasefiles_nameofdirectory_provider_v.provide nod_ibf;;
...
let nof_ibo_l = Inputbox_nameoffile_list_by_inputbasefiles_fullnameofdirectory_provider_v.provide fnd_ibf;;
