...
testing "Domaininput_fullnameofdirectory_list_by_entrysector_fullnameofdirectory_provider_v
...
(* toplevel 
   #use "Domaininput_fullnameofdirectory_list_by_entrysector_fullnameofdirectory_provider_u_any.ml";;

*)

open Domaininput_fullnameofdirectory_list_by_entrysector_fullnameofdirectory_provider_v;;

let fnd_ens = Entrysector_fullnameofdirectory_by_unit_provider_v.provide ();;

test_number 1 ( 
(fnd_ens : string ) =
  "/home/colonna/sources/ocaml_top/setup/frames/entrysector"
);;
...
test_number 2 (
(nod_din_l : string list) =
[ "userinput"]
);;


let fnd_din_l = List.map (fun n -> fnd_ens ^ "/" ^ n) nod_din_l;;
