...
testing "Domaininput_nameofdirectory_list_in_entrysector_by_unit_provider_v
...
(* toplevel 
   #use "Domaininput_nameofdirectory_list_in_entrysector_by_unit_provider_u_any.ml";;

*)

open Domaininput_nameofdirectory_list_in_entrysector_by_unit_provider_v;;
...
let nsd_ens_l = List.filter is_inputdirectory_of_nameofdirectory nod_ens_l;;

test_number 3 (
(nsd_ens_l : String.t list ) =
["userinput"]
);;
