...
testing "Nameofdirectory_list_by_fullnameofdirectory_provider_v
...
(* toplevel 
   #use "Nameofdirectory_list_by_fullnameofdirectory_provider_u_any.ml";;

*)

open Nameofdirectory_list_by_fullnameofdirectory_provider_v;;
...
let nod_fra_l = provide fnd_fra;;

test_number 2 (
( nod_fra_l : String.t list ) =
  ["Architecture"; "Documentation"; "diagrams"; "entrysector";
   "externalsector"; "figureset"; "functional_tests"; "generalsector";
   "generatorsector"; "internalsector"; "productsector"; "unitary_tests"]
);;
...
let nof_con_l = provide fnd_con;;

test_number 4 (
(nof_con_l : string list ) =
 [ "KEEP"; "generator"; "unitary_tests"]
);;
...
let nof_sdb1_l = provide fnd_sdb1;;

test_number 6 (
(nof_sdb1_l : string list ) =
["KEEP"; "generator"; "unitary_tests"]
);;
