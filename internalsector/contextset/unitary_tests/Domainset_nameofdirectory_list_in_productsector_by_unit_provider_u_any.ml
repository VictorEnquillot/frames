...
testing "Domainset_nameofdirectory_list_in_productsector_by_unit_provider_v
...
(* toplevel 
   #use "Domainset_nameofdirectory_list_in_productsector_by_unit_provider_u_any.ml";;

*)

open Domainset_nameofdirectory_list_in_productsector_by_unit_provider_v;;

let fno_prs = Productsector_fullnameofdirectory_by_unit_provider_v.provide ();;
...
let nod_prs_l = Nameofdirectory_list_by_fullnameofdirectory_provider_v.provide fno_prs;; 

test_number 2 (
(nod_prs_l : string list) =
["operatorset"; "propertyset"]
);;

let nsd_prs_l = List.filter is_setdirectory_of_nameofdirectory nod_prs_l;;
