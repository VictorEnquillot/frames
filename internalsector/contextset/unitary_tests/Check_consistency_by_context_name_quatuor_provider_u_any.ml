...
testing "Check_consistency_by_context_name_quatuor_provider_v
...
(* toplevel 
   #use "Check_consistency_by_context_name_quatuor_provider_u_any.ml";;

*)

open Check_consistency_by_context_name_quatuor_provider_v;;
...
let nam_box = List_v.last_element_off_list nam_ibo_l;;
