...
testing "Inputbox_nameoffile_by_inputbox_name_n_inputbase_name_provider_v
...
(* toplevel 
   #use "Inputbox_nameoffile_by_inputbox_name_n_inputbase_name_provider_u_any.ml";;

*)

open Inputbox_nameoffile_by_inputbox_name_n_inputbase_name_provider_v;;
...
let ext_iba = String_v.substring nam_iba 0 3;;
...
let nof_ibo = List_v.only_element_of_predicate_off_list (fun n -> n = nof_ibo) nof_ibo_l;;
...
test_number 5 (
nof_ibo = provide (nam_ibo, nam_iba)
);;
