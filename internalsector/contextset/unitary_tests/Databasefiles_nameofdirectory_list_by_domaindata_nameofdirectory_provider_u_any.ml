...
testing "Databasefiles_nameofdirectory_list_by_domaindata_nameofdirectory_provider_v
...
(* toplevel 
   #use "Databasefiles_nameofdirectory_list_by_domaindata_nameofdirectory_provider_u_any.ml";;

*)

open Databasefiles_nameofdirectory_list_by_domaindata_nameofdirectory_provider_v;;

let nam_dda = "figuredata";;

let fnd_dda = Domaindata_fullnameofdirectory_by_domaindata_nameofdirectory_provider_v.provide nam_dda;;
...
let nod_dbf_l = Databasefiles_nameofdirectory_list_by_domaindata_fullnameofdirectory_provider_v.provide fnd_dda;;

test_number 2 (
(nod_dbf_l : String.t list ) =
 ["db1pointsdatafiles"; "db2geometrydatafiles"]
);;

test_number 3 (
nod_dbf_l = provide nam_dda
);;
