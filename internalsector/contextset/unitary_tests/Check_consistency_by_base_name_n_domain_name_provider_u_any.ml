...
testing "Check_consistency_by_base_name_n_domain_name_provider_v
...
(* toplevel 
   #use "Check_consistency_by_base_name_n_domain_name_provider_u_any.ml";;

*)

open Check_consistency_by_base_name_n_domain_name_provider_v;;
...
let nam_bas = "local";;
let nam_dom = "product";;
test_raises_some_exc provide (nam_bas, nam_dom);;
