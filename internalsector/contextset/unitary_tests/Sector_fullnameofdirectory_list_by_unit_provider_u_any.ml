...
testing "Sector_fullnameofdirectory_list_by_unit_provider_v
...
(* toplevel 
   #use "Sector_fullnameofdirectory_list_by_unit_provider_u_any.ml";;

*)

open Sector_fullnameofdirectory_list_by_unit_provider_v;;
  
let nod_sec_l = Sector_nameofdirectory_list_by_unit_provider_v.provide () ;;

test_number 1 (
(nod_sec_l : String.t list ) =
  ["entrysector"; "externalsector"; "generalsector"; "generatorsector";
   "internalsector"; "productsector"]
);;

let fnd_sec_l = List.map 
    Sector_fullnameofdirectory_by_sector_nameofdirectory_provider_v.provide
    nod_sec_l;;

test_number 2 (
(fnd_sec_l : string list) =
  ["/home/colonna/sources/ocaml_top/setup/frames/entrysector";
   "/home/colonna/sources/ocaml_top/setup/frames/externalsector";
   "/home/colonna/sources/ocaml_top/setup/frames/generalsector";
   "/home/colonna/sources/ocaml_top/setup/frames/generatorsector";
   "/home/colonna/sources/ocaml_top/setup/frames/internalsector";
   "/home/colonna/sources/ocaml_top/setup/frames/productsector"]
);;
