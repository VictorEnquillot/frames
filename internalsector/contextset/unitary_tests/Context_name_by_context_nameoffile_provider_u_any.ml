...
testing "Context_name_by_context_nameoffile_provider_v
...
(* Trace_what_by_module_name_register_v.store "Nameoffile_frames_list_by_fullnameoffile_provider_v" "cpu debug";; *)

(* toplevel 
   #use "Context_name_by_context_nameoffile_provider_u_any.ml";;

*)

open Context_name_by_context_nameoffile_provider_v;;
...
let nof = "skeletondata";;
let boo = Context_name_by_context_nameoffile_register_v.is_stored nof;;
