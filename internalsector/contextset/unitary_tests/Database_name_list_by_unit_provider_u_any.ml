...
testing "Database_name_list_by_unit_provider_v
...
(* toplevel 
   #use "Database_name_list_by_unit_provider_u_any.ml";;

*)

open Database_name_list_by_unit_provider_v;;

let nof_dba_l = Database_nameofdirectory_list_by_unit_provider_v.provide ();;

test_number 1 (
( nof_dba_l : String.t list ) =
  ["db1pointsdata"; "db2geometrydata"; "g9xdata"; "molprodata"; "nwchemdata"]
);;

let nam_dba_l = List.map Context_name_by_context_nameofdirectory_provider_v.provide nof_dba_l;;

test_number 2 (
( nam_dba_l : String.t list ) =
