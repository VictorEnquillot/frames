...
testing "Database_nameofdirectory_list_by_domaindata_fullnameofdirectory_provider_v
...
(* toplevel 
   #use "Database_nameofdirectory_list_by_domaindata_fullnameofdirectory_provider_u_any.ml";;

*)

open Database_nameofdirectory_list_by_domaindata_fullnameofdirectory_provider_v;;

let fnd_dda = "/home/colonna/sources/ocaml_top/setup/frames/externalsector/figuredata";;
...
let nod_dba_l = Nameofdirectory_list_by_fullnameofdirectory_provider_v.provide fnd_dda ;;
...
let nod_dba_nsl = List.filter is_datadirectory_of_nameofdirectory nod_dba_l;;
