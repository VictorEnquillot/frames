...
testing "Inputbasefiles_nameofdirectory_by_inputbase_fullnameofdirectory_provider_v
...
(* toplevel 
   #use "Inputbasefiles_nameofdirectory_by_inputbase_fullnameofdirectory_provider_u_any.ml";;

*)

open Inputbasefiles_nameofdirectory_by_inputbase_fullnameofdirectory_provider_v;;
