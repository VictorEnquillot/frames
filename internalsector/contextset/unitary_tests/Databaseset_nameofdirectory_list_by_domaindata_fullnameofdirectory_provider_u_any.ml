...
testing "Databaseset_nameofdirectory_list_by_domaindata_fullnameofdirectory_provider_v
...
(* toplevel 
   #use "Databaseset_nameofdirectory_list_by_domaindata_fullnameofdirectory_provider_u_any.ml";;

*)

open Databaseset_nameofdirectory_list_by_domaindata_fullnameofdirectory_provider_v;;
...
test_number 3 (
(nod_dbs_nsl : String.t list ) = 
["db1pointsdataset"; "db2geometrydataset"]
);;

let nod_dbs_l = List.sort String.compare nod_dbs_nsl;;

test_number 4 (
(nod_dbs_l : String.t list ) = 
["db1pointsdataset"; "db2geometrydataset"]
);;

test_number 5 (
nod_dbs_l = provide fnd_dda
);;
