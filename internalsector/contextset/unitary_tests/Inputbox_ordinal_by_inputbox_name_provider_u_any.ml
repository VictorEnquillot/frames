...
testing "Inputbox_ordinal_by_inputbox_name_provider_v
...
(* toplevel 
   #use "Inputbox_ordinal_by_inputbox_name_provider_u_any.ml";;

*)

open Inputbox_ordinal_by_inputbox_name_provider_v;;
...
let nam_ibo = List_v.last_element_off_list nam_ibo_l;;
