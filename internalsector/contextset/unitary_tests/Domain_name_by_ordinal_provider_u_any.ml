...
testing "Domain_name_by_ordinal_provider_v
...
(* toplevel 
   #use "Domain_name_by_ordinal_provider_u_any.ml";;

*)

open Domain_name_by_ordinal_provider_v;;
...
let nam_dom = List.nth nam_dom_l (ord_dom -1) ;;
