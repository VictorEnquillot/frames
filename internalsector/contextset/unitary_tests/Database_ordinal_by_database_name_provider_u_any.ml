...
testing "Database_ordinal_by_database_name_provider_v
...
(* toplevel 
   #use "Database_ordinal_by_database_name_provider_u_any.ml";;

*)

open Database_ordinal_by_database_name_provider_v;;
...
let ord_dba = List_v.int_ordinal_of_element_of_list nam_dba nam_dba_l;;
