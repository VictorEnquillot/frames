...
testing "Domaindata_fullnameofdirectory_by_domaindata_nameofdirectory_provider_v
...
(* toplevel 
   #use "Domaindata_fullnameofdirectory_by_domaindata_nameofdirectory_provider_u_any.ml";;

*)

open Domaindata_fullnameofdirectory_by_domaindata_nameofdirectory_provider_v;;
...
test_number 3 (
fnd_dda = provide nam_dda
);;

(* let nam_dda = "inputdata";; *)
