...
testing "Context_name_by_context_nameofdirectory_provider_v
...
(* Trace_what_by_module_name_register_v.store "any" "any";; *)
(* Trace_what_by_module_name_register_v.store "Nameofdirectory_frames_list_by_fullnameofdirectory_provider_v" "cpu debug";; *)

(* toplevel 
   #use "Context_name_by_context_nameofdirectory_provider_u_any.ml";;

*)

open Context_name_by_context_nameofdirectory_provider_v;;
...
(* Check Register behavior *)

let nod = "skeletondata";;
let boo = Context_name_by_context_nameofdirectory_register_v.is_stored nod;;
