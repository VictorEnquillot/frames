...
testing "Databox_name_list_by_unit_provider_v
...
(* toplevel 
   #use "Databox_name_list_by_unit_provider_u_any.ml";;

*)

open Databox_name_list_by_unit_provider_v;;

let nof_dbo_l = Databox_nameoffile_list_by_unit_provider_v.provide ();;

test_number 1 (
( nof_dbo_l : String.t list ) =  ["3_21G.g9x"; "3_21G.nwc"; "6_31GSS.nwc"; "6_31GSSP.nwc"; "LANL2DZ.nwc";
...
test_number 2 (
(nam_nun_dbo_l : string list ) =  
["3_21G"; "3_21G"; "6_31GSS"; "6_31GSSP"; "LANL2DZ"; "Point_a"; "STO_3G";
 "VTZ"; "cc_pVTZ"; "cc_pVTZ"; "segment_BC"; "segment_S"; "triangle_ire";
 "triangle_iso"; "triangle_isoacute"; "triangle_isoobtuse";
 "triangle_isoright"; "try_ao"; "try_ao_ecp"; "try_ecp"]
);;

let nam_dbo_l = List_v.left_once_list_off_list nam_nun_dbo_l;;

test_number 3 (
(nam_dbo_l : string list ) =
  ["3_21G"; "6_31GSS"; "6_31GSSP"; "LANL2DZ"; "Point_a"; "STO_3G"; "VTZ";
