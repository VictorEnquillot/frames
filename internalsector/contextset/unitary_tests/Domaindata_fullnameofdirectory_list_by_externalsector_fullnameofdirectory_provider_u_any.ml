...
testing "Domaindata_fullnameofdirectory_list_by_externalsector_fullnameofdirectory_provider_v
...
(* toplevel 
   #use "Domaindata_fullnameofdirectory_list_by_externalsector_fullnameofdirectory_provider_u_any.ml";;

*)

open Domaindata_fullnameofdirectory_list_by_externalsector_fullnameofdirectory_provider_v;;

let fnd_exs = Externalsector_fullnameofdirectory_by_unit_provider_v.provide ();;
...
let fnd_dda_l = List.map (fun n -> fnd_exs ^ "/" ^ n) nod_dda_l;;
