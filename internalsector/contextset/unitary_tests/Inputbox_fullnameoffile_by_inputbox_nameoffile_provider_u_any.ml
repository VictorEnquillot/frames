...
testing "Inputbox_fullnameoffile_by_inputbox_nameoffile_provider_v
...
(* toplevel 
   #use "Inputbox_fullnameoffile_by_inputbox_nameoffile_provider_u_any.ml";;

*)

open Inputbox_fullnameoffile_by_inputbox_nameoffile_provider_v;;

let nof_ibo_l = Inputbox_nameoffile_list_by_unit_provider_v.provide ();;

let nof_ibo = List.hd nof_ibo_l;;
...
let fnd_ibo_l = Inputbox_fullnameoffile_list_by_unit_provider_v.provide () ;;
let fno_ibo = List_v.only_element_of_predicate_off_list (fun f -> Filename.basename f = nof_ibo) fnd_ibo_l;;
