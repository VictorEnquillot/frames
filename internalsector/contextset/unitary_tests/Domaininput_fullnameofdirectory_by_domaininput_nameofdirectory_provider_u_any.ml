...
testing "Domaininput_fullnameofdirectory_by_domaininput_nameofdirectory_provider_v
...
(* toplevel 
   #use "Domaininput_fullnameofdirectory_by_domaininput_nameofdirectory_provider_u_any.ml";;

*)

open Domaininput_fullnameofdirectory_by_domaininput_nameofdirectory_provider_v;;
...
test_number 3 (
fnd_din = provide nod_din
);;

(* let nod_din = "inputinput";; *)
