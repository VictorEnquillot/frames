...
testing "Databaseset_fullnameofdirectory_by_database_fullnameofdirectory_provider_v
...
(* toplevel 
   #use "Databaseset_fullnameofdirectory_by_database_fullnameofdirectory_provider_u_any.ml";;

*)

open Databaseset_fullnameofdirectory_by_database_fullnameofdirectory_provider_v;;
...
let fnd_dba = List.hd fnd_dba_l;;

let nod_dba = Filename.basename fnd_dba;;
...
let fnd_dbs = fnd_dba ^ "/" ^ (nod_dba ^ "set");;
