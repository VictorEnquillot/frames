...
testing "Databox_sole_index_by_context_name_quatuor_provider_v
...
(* toplevel 
   #use "Databox_sole_index_by_context_name_quatuor_provider_u_any.ml";;

*)

open Databox_sole_index_by_context_name_quatuor_provider_v;;

let nam_con_qua = ("Point_a_print", "local", "user", "entry");;

let soi_con = Context_sole_index_by_context_name_quatuor_provider_v.provide nam_con_qua;;
