...
testing "Context_name_quatuor_by_context_ordinal_quatuor_provider_v
...
(* toplevel 
   #use "Context_name_quatuor_by_context_ordinal_quatuor_provider_u_any.ml";;

*)

open Context_name_quatuor_by_context_ordinal_quatuor_provider_v;;
...
let ord_qua = Context_ordinal_quatuor_by_box_fullnameoffile_provider_v.provide fno_ibo;;
