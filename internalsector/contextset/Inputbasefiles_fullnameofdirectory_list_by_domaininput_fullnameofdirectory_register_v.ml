(** {3 Inputbasefiles_fullnameofdirectory_list_by_domaininput_fullnameofdirectory_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : CONS:Inputbasefiles_fullnameofdirectory_list_by_domaininput_fullnameofdirectory_register_v";
   "Author : François Colonna 25 juin 2016 at 17:05:11+02:00";
 ]
;;
...
(* done with do_register.sh force on lundi 17 octobre 2016, 10:47:27 (UTC+0200) *)
