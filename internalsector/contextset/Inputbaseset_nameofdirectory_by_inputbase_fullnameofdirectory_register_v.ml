(** {3 Inputbaseset_nameofdirectory_by_inputbase_fullnameofdirectory_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : CONS:Inputbaseset_nameofdirectory_by_inputbase_fullnameofdirectory_register_v";
   "Author : François Colonna 08 octobre 2016 at 14:38:23+02:00";
 ]
;;
