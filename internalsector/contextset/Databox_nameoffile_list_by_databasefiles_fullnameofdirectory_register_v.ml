(** {3 Databox_nameoffile_list_by_databasefiles_fullnameofdirectory_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : CONS:Databox_nameoffile_list_by_databasefiles_fullnameofdirectory_register_v";
   "Author : François Colonna 25 juin 2016 at 18:39:56+02:00";
 ]
;;
