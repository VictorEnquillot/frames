(** {3 Basicname_duo_by_context_name_duo_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : CONS:Basicname_duo_by_context_name_duo_provider_v";
   "Definition : a Context duo has the same order as a Sole_index : (Domain, Sector)";
   "Author : François Colonna 01 avril 2017 at 12:10:51+02:00";
 ]
;;
