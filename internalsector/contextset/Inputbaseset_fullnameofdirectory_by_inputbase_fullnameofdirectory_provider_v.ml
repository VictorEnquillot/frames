(** {3 Inputbaseset_fullnameofdirectory_by_inputbase_fullnameofdirectory_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : CONS:Inputbaseset_fullnameofdirectory_by_inputbase_fullnameofdirectory_provider_v";
...
(* done with do_provider_without_register.sh Inputbaseset_fullnameofdirectory_by_inputbase_fullnameofdirectory_provider_v.ml force on samedi 8 octobre 2016, 18:53:03 (UTC+0200) *)
