(** {3 Sector_ordinal_by_basicname_sector_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : CONS:Sector_ordinal_by_basicname_sector_provider_v";
   "Needs : CONS:Sector_name_list_by_unit_provider_v";
   "Register : CONS:Sector_ordinal_by_basicname_sector_register_v";
...
let store nam_sec result =
  ...
  Sector_ordinal_by_basicname_sector_register_v.store nam_mod nam_sec result;
...
let retrieve nam_sec =
  ...
  let pro_cpu = Management_v.entering_of_module_name_of_function_name nam_mod nam_fun in
  let result = Sector_ordinal_by_basicname_sector_register_v.retrieve nam_mod nam_sec in
  Management_v.exiting_of_process_times_of_module_name_of_function_name pro_cpu nam_mod nam_fun;
  result
;;
...
let provide_without_trace nam_sec =
  if Sector_ordinal_by_basicname_sector_register_v.is_stored nam_sec
...
(* done with do_provider_with_register.sh Sector_ordinal_by_basicname_sector_provider_v.ml force on samedi 8 octobre 2016, 18:52:40 (UTC+0200) *)
