(** {3 Domaindata_nameofdirectory_list_in_externalsector_by_unit_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : CONS:Domaindata_nameofdirectory_list_in_externalsector_by_unit_register_v";
   "Author : François Colonna 22 juin 2016 at 16:56:54+02:00";
 ]
;;
...
(* done with do_register.sh force on lundi 17 octobre 2016, 10:47:26 (UTC+0200) *)
