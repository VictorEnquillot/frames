(** {3 Sector_fullnameofdirectory_list_by_unit_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : CONS:Sector_fullnameofdirectory_list_by_unit_register_v";
   "Author : François Colonna 01 mai 2016 at 12:49:20+02:00";
 ]
;;
