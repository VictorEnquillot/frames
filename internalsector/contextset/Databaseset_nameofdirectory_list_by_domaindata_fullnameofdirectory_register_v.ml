(** {3 Databaseset_nameofdirectory_list_by_domaindata_fullnameofdirectory_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : CONS:Databaseset_nameofdirectory_list_by_domaindata_fullnameofdirectory_register_v";
...
(* done with do_register.sh force on lundi 17 octobre 2016, 10:47:24 (UTC+0200) *)
