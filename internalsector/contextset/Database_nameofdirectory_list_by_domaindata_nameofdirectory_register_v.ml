(** {3 Database_nameofdirectory_list_by_domaindata_nameofdirectory_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : CONS:Database_nameofdirectory_list_by_domaindata_nameofdirectory_register_v";
