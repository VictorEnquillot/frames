(** {3 Inputbasefiles_nameofdirectory_list_by_domaininput_nameofdirectory_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : CONS:Inputbasefiles_nameofdirectory_list_by_domaininput_nameofdirectory_register_v";
   "Author : François Colonna 21 juin 2016 at 09:06:03+02:00";
 ]
;;
