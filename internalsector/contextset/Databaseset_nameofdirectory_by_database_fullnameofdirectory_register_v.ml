(** {3 Databaseset_nameofdirectory_by_database_fullnameofdirectory_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : CONS:Databaseset_nameofdirectory_by_database_fullnameofdirectory_register_v";
