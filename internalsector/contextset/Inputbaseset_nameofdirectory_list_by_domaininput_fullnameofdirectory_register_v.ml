(** {3 Inputbaseset_nameofdirectory_list_by_domaininput_fullnameofdirectory_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : CONS:Inputbaseset_nameofdirectory_list_by_domaininput_fullnameofdirectory_register_v";
