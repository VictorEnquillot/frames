(** {3 Databasefiles_nameofdirectory_by_database_nameofdirectory_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : CONS:Databasefiles_nameofdirectory_by_database_nameofdirectory_register_v";
   "Author : François Colonna 08 octobre 2016 at 13:34:56+02:00";
 ]
;;
