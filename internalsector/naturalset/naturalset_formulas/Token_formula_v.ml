...
let symbol_of_formula = function
  | Token_formula_t.Operation_formula for_ope ->
  Token_symbol_t.Operation_symbol
      (Operation_formula_v.symbol_of_formula for_ope)
...
let make sym_tok soi_tok =
  ...
  | Token_symbol_t.Operation_symbol sym_ope ->
    Token_formula_t.Operation_formula
      (Operation_formula_v.make sym_ope soi_tok)
  | Token_symbol_t.Leftparenthesis ->
...
let string_tag_list_off_token_formula = function
  | Token_formula_t.Operation_formula for_ope ->
      Operation_formula_v.string_tag_list_off_operation_formula for_ope
...
(** Token_formula_v at 9:38:27 on 16 Jul 2013. created by version v2.4 of generator *)
