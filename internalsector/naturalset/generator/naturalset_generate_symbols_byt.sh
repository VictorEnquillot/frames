...
ocamlc -warn-error A -g \
-o naturalset_generate_symbols_${file}.byt  \
Do_naturalset_symbols_${file}.cmo

echo "naturalset_generate_symbols_${file}.byt done"

ls -alt naturalset_generate_symbols_${file}.byt