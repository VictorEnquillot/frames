...
-c Do_naturalset_symbols_${file}.ml

ocamlopt \
-o naturalset_generate_symbols_${file}.bin  \
unix.cmxa str.cmxa \
...
Do_naturalset_symbols_${file}.cmx

echo "naturalset_generate_symbols_${file}.bin done"

ls -alt naturalset_generate_symbols_${file}.bin