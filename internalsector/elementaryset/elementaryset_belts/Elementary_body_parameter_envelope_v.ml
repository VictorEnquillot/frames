(** {3 Elementary_body_parameter_envelope_v} *)

(** {6 Documenting_for_envelope} *)

let documentation () = 
  [
   "Current : VELE:Elementary_body_parameter_envelope_v";
   "Needs : VELE:Envelopee_v";
   "Needs : VELE:Elementary_border_envelope_v";
   "Needs : FELE:Elementary_body_parameter_container_v";
   "Needed-by: ";
   ...
   "What-is-it : it is the Envelope for Elementary_body_parameter";
   "How-is-it-done: ";
]
;;
...
let border_as_list_of_tag tag_ebp =
  Elementary_body_parameter_container_v.border_as_list tag_ebp
;;
...
let border_as_tuple_of_tag tag_ebp =
  Elementary_body_parameter_container_v.border_as_tuple tag_ebp
;;
...
(* generated by ./do_envelope_as_tuple_body_bud_measure_units_float_v.sh elementary_body_parameter *)
(* using ./template_envelope_as_tuple_body_bud_measure_units_float_v.ml *)
(* Done on mercredi 27 janvier 2016, 12:07:43 (UTC+0100) *)
