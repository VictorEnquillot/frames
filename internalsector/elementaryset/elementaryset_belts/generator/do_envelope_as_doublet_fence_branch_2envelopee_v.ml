...
plugprovider=`capitalize_first.sh ${plugprovider}`

if [ "${5}" == "" ] 
then 
    echo "$0 : plugprovider (5th argument) is missing"
    exit
fi
...
sed -e "s/this/$this/g"     -e "s/ttt/$ttt/g" -e "s/This/$This/g" \
    ...
    -e "s/plugprovider/$plugprovider/g" -e "s/plugprovider/$plugprovider/g" \
    -e "s/conee_1/$conee_1/g" -e "s/Conee_1/$Conee_1/g" -e "s/cnn_1/$cnn_1/g" \
    -e "s/conee_2/$conee_2/g" -e "s/Conee_2/$Conee_2/g" -e "s/cnn_2/$cnn_2/g" \
    -e "s/conee_3/$conee_3/g" -e "s/Conee_3/$Conee_3/g" -e "s/cnn_3/$cnn_3/g" \
...
echo "" >> ${File}
echo "(* generated by $0 ${1} ${2} ${3} ${4} ${5} ${6} ${7} *)" >> ${File}
