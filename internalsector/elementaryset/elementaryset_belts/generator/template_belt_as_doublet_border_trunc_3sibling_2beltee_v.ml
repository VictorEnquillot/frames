...
let belt_of_tag tag_ttt =
  ...
  | This_symbol_t.Sibling_3_symbol sym_eae ->
      ...
      (Sibling_3_belt_v.belt_of_tag tag_sig_3)
;;
...
let measure_actual_length_of_tag tag_ttt =
  ...
  | This_symbol_t.Sibling_1_symbol sym_sig_1 ->
      let tag_sig_1 = Tag_v.make sym_sig_1 soi_ttt in
      Sibling_1_belt_v.measure_actual_length_of_tag tag_sig_1

  | This_symbol_t.Sibling_2_symbol sym_eae ->
      let tag_sig_2 = Tag_v.make sym_eae soi_ttt in
      Sibling_2_belt_v.measure_actual_length_of_tag tag_sig_2


  | This_symbol_t.Sibling_3_symbol sym_eae ->
      let tag_sig_3 = Tag_v.make sym_eae soi_ttt in
      Sibling_3_belt_v.measure_actual_length_of_tag tag_sig_3
;;
...
let measure_actual_length_off_belt bel_ttt =
  Doublet_v.right_off_doublet bel_ttt
;;

let measure_actual_off_belt bel_ttt =
  let mea_len = measure_actual_length_off_belt bel_ttt in
  Measure_actual_length_v.measure_actual_of_measure_length mea_len
;;
...
let measure_canonical_off_belt_of_calculation_name bel_ttt =
  let mea = measure_off_belt bel_ttt in
...
let name bel_ttt =
  Doublet_v.name This_tag_v.name Measure_actual_length_v.name bel_ttt
;;
