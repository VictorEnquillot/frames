...
let measure_actual_unts_1_of_tag tag_ttt =
  ...
  | This_symbol_t.Sibling_2_symbol sym_ttt ->
      let tag_sib_2 = Tag_v.make sym_ttt soi_ttt in
      Sibling_2_belt_v.measure_actual_unts_1_of_tag tag_sib_2
;;
...
let measure_actual_unts_1_off_belt = function
  ...
  | This_belt_t.Sibling_2_belt bel_sib_2 ->
      Sibling_2_belt_v.measure_actual_unts_1_off_belt bel_sib_2
;;
...
let readee_off_belt = function
  | This_belt_t.Sibling_1_belt bel_sib_1 ->
      Sibling_1_belt_v.readee_off_belt bel_sib_1

  | This_belt_t.Sibling_2_belt bel_sib_2 ->
      Sibling_2_belt_v.readee_off_belt bel_sib_2
;;
