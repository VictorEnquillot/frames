...
(** {6 Tagged_measure List} *)

let tagged_measure_list_of_tag tag_ttt =
  let tag_ebo_l = envee_1_tag_list_of_tag tag_ttt in
  (List.map
     Envee_1_envelope_v.tagged_measure_of_tag
     tag_ebo_l)
;;
...
let measure_unts_1_list_of_tag tag_ttt =
  let tag_ebo_l = envee_1_tag_list_of_tag tag_ttt in
  List.map
    Envee_1_envelope_v.measure_unts_1_of_tag
    tag_ebo_l
;;
