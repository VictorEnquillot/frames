...
let sibling_3_tag_off_this_tag tag_ttt =
  ...
  | _ -> failwith 
      "Not_a_sibling_3_tag:This_belt_v.sibling_3_tag_off_this_tag"
;;
...
let measure_actual_length_of_tag tag_ttt =
  ...
  | This_symbol_t.Sibling_1_symbol sym_sib_1 ->
      let tag_sib_1 = Tag_v.make sym_sib_1 soi_ttt in
      Sibling_1_belt_v.measure_actual_length_of_tag tag_sib_1

  | This_symbol_t.Sibling_2_symbol sym_ttt ->
      let tag_sib_2 = Tag_v.make sym_ttt soi_ttt in
      Sibling_2_belt_v.measure_actual_length_of_tag tag_sib_2

  | This_symbol_t.Sibling_3_symbol sym_ttt ->
      let tag_sib_3 = Tag_v.make sym_ttt soi_ttt in
      Sibling_3_belt_v.measure_actual_length_of_tag tag_sib_3
;;
...
let measure_actual_length_off_belt = function
  | This_belt_t.Sibling_1_belt bel_sib_1 ->
      Sibling_1_belt_v.measure_actual_length_off_belt bel_sib_1

  | This_belt_t.Sibling_2_belt bel_sib_2 ->
      Sibling_2_belt_v.measure_actual_length_off_belt bel_sib_2

  | This_belt_t.Sibling_3_belt bel_sib_3 ->
      Sibling_3_belt_v.measure_actual_length_off_belt bel_sib_3
;;

let measure_actual_off_belt bel_ttt =
  let mle = measure_actual_length_off_belt bel_ttt in
  Measure_actual_length_v.measure_actual_of_measure_actual_length mle
;;
...
let readee_of_tag tag_ttt =
  ...
  | This_symbol_t.Sibling_3_symbol sym_sib_3 ->
      ...
      Sibling_3_belt_v.readee_of_tag tag_sib_3
;;
...
let closure_off_belt = function
  ...
  | This_belt_t.Sibling_3_belt bel_sib_3 ->
      Sibling_3_belt_v.closure_off_belt bel_sib_3
;;
...
let sibling_3_belt_off_this_belt bel_ttt =
  let tag_ttt = Doublet_v.left_off_doublet bel_ttt in
  let (sym_ttt, soi_ttt) = tag_ttt in
  ...
  | _ -> failwith 
      "Not_a_sibling_3_tag:This_belt_v.sibling_3_belt_off_this_belt"
;;
...
let text_of_tag tag_ttt =
  ...
  | This_symbol_t.Sibling_3_symbol sym_sib_3 ->
      let tag_sib_3 = Tag_v.make sym_sib_3 soi_ttt in
      Sibling_3_belt_v.text_of_tag tag_sib_3
;;
