...
testing "Elementary_fence_units_belt_v with
    Elementary_fence_units_belt_u_test_ao.ml";;
...
(* toplevel 
   #use "Elementary_fence_units_belt_u_test_ao.ml";;
...
test_number 2 (  
( tag_efu :
  Elementary_fence_units_actual_symbol_t.elementary_fence_units_actual_symbol Tag_t.tag ) =
  (Elementary_fence_units_actual_symbol_t.Elementary_fence_units_actual_length_symbol
    Elementary_fence_units_actual_length_symbol_t.Bohr,
   [1; 1; 5; 6; 5; 7])
);;
...
let ben_efu = belt_of_tag tag_efu;;

test_number 3 (
( ben_efu :
  Elementary_fence_units_belt_t.elementary_fence_units_belt ) =
  Elementary_fence_units_belt_t.Elementary_fence_units_actual_length_belt
...
let mea_efu = measure_actual_off_belt ben_efu;;
...
let mca_efu = measure_canonical_off_belt_of_calculation_name ben_efu nam_cal;;
...
let clo_efu = closure_off_belt ben_efu;;

test_number 6 (
( clo_efu : Readee_t.readee list ) =
...
test_number 7 (
clo_efu = closure_of_tag tag_efu
);;
