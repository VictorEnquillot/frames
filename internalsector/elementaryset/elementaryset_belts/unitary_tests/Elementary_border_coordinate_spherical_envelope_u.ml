...
testing "Elementary_border_coordinate_spherical_formula_v with
   Elementary_border_coordinate_spherical_envelope_u.ml";;
...
(* toplevel 
   #use "Elementary_border_coordinate_spherical_envelope_u.ml";;
...
(* Elementary_border_coordinate_spherical Tag : Spherical_phi *)
...
let tag_ele_csp_l = List.filter (fun (s, i) -> Elementary_symbol_v.is_spherical_phi s) tag_ele_l;;
...
let tag_ecs = Tag_v.map_entity Elementary_symbol_v.elementary_border_coordinate_spherical_symbol_off_elementary_symbol tag_ele_phi;;

test_number 3 (
( tag_ecs : Elementary_border_coordinate_spherical_symbol_t.elementary_border_coordinate_spherical_symbol
  Tag_t.tag ) =
  (Elementary_border_coordinate_spherical_symbol_t.Spherical_phi "spherical_phi",
   [2; 12; 1; 4])
);;

open Elementary_border_coordinate_spherical_envelope_v;;

let fen_l = Elementary_border_coordinate_spherical_container_v.fence_list tag_ecs;;
...
let dfe_l = Elementary_border_coordinate_spherical_container_v.deepfence_list tag_ecs;;
...
let con_ecs = Elementary_border_coordinate_spherical_container_v.container_of_tag tag_ecs;;
