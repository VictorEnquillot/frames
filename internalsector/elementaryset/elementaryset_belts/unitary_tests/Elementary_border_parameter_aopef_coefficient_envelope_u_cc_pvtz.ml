...
(* toplevel 
   #use "Elementary_border_parameter_aopef_coefficient_envelope_u_cc_pvtz.ml";;
...
let tag_pac = Tag_v.map_entity Elementary_symbol_v.elementary_border_parameter_aopef_coefficient_symbol_off_elementary_symbol tag_ele_pac;;
let env_pac = build tag_pac;;

test_number 6 (
( env_pac : Measure_t.measure list Uno_t.uno ) =
  [(0.017151,
...
let env_pac_t = envelope_as_tuple tag_pac;;

test_number 7 (
( env_pac_t : Measure_t.measure list Uno_t.uno Tuple_t.tuple ) =
  Tuple_t.Uno
   [(0.017151,
     Elementary_fence_units_actual_symbol_t.Elementary_fence_units_actual_length_symbol
      Elementary_fence_units_actual_length_symbol_t.Bohr)]
...
let cun_pac_l = closure_units_as_list tag_pac;;

test_number 8 (
( cun_pac_l : Measure_t.measure list ) =
  [(0.017151,
    Elementary_fence_units_actual_symbol_t.Elementary_fence_units_actual_length_symbol
     Elementary_fence_units_actual_length_symbol_t.Bohr)]
);;

let cun_pac_t = closure_units_as_tuple tag_pac;;

test_number 9 (
(cun_pac_t : Measure_t.measure Tuple_t.tuple) =
Tuple_t.Uno
  (0.017151,
   Elementary_fence_units_actual_symbol_t.Elementary_fence_units_actual_length_symbol
     Elementary_fence_units_actual_length_symbol_t.Bohr)
...
let cun_pac_tl = closure_units_as_tuple_list tag_pac;;

test_number 10 (
(cun_pac_tl : Measure_t.measure Tuple_t.tuple list ) =
  [Tuple_t.Uno
    (0.017151,
     Elementary_fence_units_actual_symbol_t.Elementary_fence_units_actual_length_symbol
      Elementary_fence_units_actual_length_symbol_t.Bohr)]
...
let mea_u = measure_uno_of_elementary_border_parameter_aopef_coefficient_tag tag_pac;;
...
let mea_t = measure_tuple_of_elementary_border_parameter_aopef_coefficient_tag tag_pac;;
...
let mea_tl = measure_tuple_list_of_elementary_border_parameter_aopef_coefficient_tag tag_pac;;
...
let mea_l = measure_list_of_elementary_border_parameter_aopef_coefficient_tag tag_pac;;
...
let bou_u = boundary_uno tag_pac;;
...
let bou_l = boundary_list tag_pac;;
