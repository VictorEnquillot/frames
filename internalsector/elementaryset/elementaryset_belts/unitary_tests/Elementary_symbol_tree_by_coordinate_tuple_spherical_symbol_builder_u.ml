...
testing "Elementary_symbol_tree_by_coordinate_tuple_spherical_symbol_builder_v with
   Elementary_symbol_tree_by_coordinate_tuple_spherical_symbol_builder_u.ml";;

(* toplevel 
   #use "Elementary_symbol_tree_by_coordinate_tuple_spherical_symbol_builder_u.ml";;

*)


(* Elementary_body_coordinate_tuple_spherical Symbol *)
...
let sym_ctu = Elementary_body_coordinate_tuple_symbol_v.elementary_body_coordinate_tuple_symbol_of_elementary_body_coordinate_tuple_spherical_symbol sym_cts;;
