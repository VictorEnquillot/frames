(** {3 Elementary_border_coordinate_homogeneous_cartesian_z_belt_v} *)

(** {6 Documenting_for_belt} *)

let documentation () = 
  [
   "Current : VELE:Elementary_border_coordinate_homogeneous_cartesian_z_belt_v";
   "Needs : TELE:Thup_tag_v";
   "Needs : VELE:Elementary_border_coordinate_homogeneous_cartesian_z_container_v";
   "Needed-by: ";
...
let measure_actual_length_of_tag tag_ecz =
  let tag_fal = 
    Elementary_border_coordinate_homogeneous_cartesian_z_container_v.container_of_tag 
      tag_ecz
  in
...
let longname bel_ecz =
  Format.sprintf "Elementary_border_coordinate_homogeneous_cartesian_z_belt_t.%s" (String.capitalize (name bel_ecz))
;;


(* generated by ./do_belt_as_doublet_border_bud_1sibling_1units_2beltee_v.sh elementary_border_coordinate_homogeneous_cartesian ehz z ecz elementary_fence_units_actual efa length fal mle *)
