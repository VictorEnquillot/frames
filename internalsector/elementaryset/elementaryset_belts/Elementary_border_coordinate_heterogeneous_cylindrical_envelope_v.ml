(** {3 Elementary_border_coordinate_heterogeneous_cylindrical_envelope_v} *)

(** {6 Documenting_for_envelope} *)

let documentation () = 
[
 "Current : VELE:Elementary_border_coordinate_heterogeneous_cylindrical_envelope_v";
 "Needs: VELE:Elementary_border_coordinate_heterogeneous_cylindrical_belt_v";
 "Needed-by: ";
...
(* generated by ./do_envelope_as_list_border_trunc_units_v.sh elementary_border_coordinate_heterogeneous_cylindrical ehc elementary_fence_units_actual *)
