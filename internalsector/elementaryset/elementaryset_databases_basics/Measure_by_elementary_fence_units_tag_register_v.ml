(** {3 Measure_by_elementary_fence_units_tag_register_v} *)
...
[
  "Needs: ";
   "Current : DELE:Measure_by_elementary_fence_units_tag_register_v";
  "Needed-by: ";
  "What-is-it: ";
  "How-is-it-done: ";
  "Example: ";
...
let register : 
    (Elementary_fence_units_tag_t.elementary_fence_units_tag,
     Measure_t.measure
    ) 
    Register_t.register = 
...
let name_of_key key =
  Elementary_fence_units_tag_v.name key
;;
