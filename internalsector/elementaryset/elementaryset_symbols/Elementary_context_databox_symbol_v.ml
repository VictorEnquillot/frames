...
let name = function
  | Elementary_context_databox_symbol_t.Elementary_context_databox_constructor _ -> "elementary_context_databox_constructor"
;;
...
let string_off = function
  | Elementary_context_databox_symbol_t.Elementary_context_databox_constructor s -> s
;;
...
let is_elementary_context_databox_constructor = function
  | Elementary_context_databox_symbol_t.Elementary_context_databox_constructor _ -> true
;;
...
let elementary_context_databox_constructor s = Elementary_context_databox_symbol_t.Elementary_context_databox_constructor s;;
...
let make_of_topson_ofstring nam s =
  let nam_low = String.lowercase nam in
  match nam_low with
  | "elementary_context_databox_constructor" -> elementary_context_databox_constructor s
  | _ ->
...
(** Elementary_context_databox_symbol_v at 9:51:53 on 27 Sep 2016. created by version v2.4 of generator *)
