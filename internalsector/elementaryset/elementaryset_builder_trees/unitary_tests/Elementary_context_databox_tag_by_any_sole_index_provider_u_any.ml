...
testing "Elementary_context_databox_tag_by_any_sole_index_provider_v with
    Elementary_context_databox_tag_by_any_sole_index_provider_u_any.ml";;
...
(* toplevel 
   #use "Elementary_context_databox_tag_by_any_sole_index_provider_u_any.ml";; 

*)

open Elementary_context_databox_tag_by_any_sole_index_provider_v;;
...
let sym_nbo = Elementary_context_databox_symbol_by_any_sole_index_provider_v.provide soi_any;;

test_number 3 (
(sym_nbo : Elementary_context_databox_symbol_t.elementary_context_databox_symbol ) =
  Elementary_context_databox_symbol_t.Elementary_context_databox_constructor
   "cc_pVTZ"
);;

let soi_nbo = 
    Elementary_context_databox_sole_index_by_any_sole_index_provider_v.provide 
      soi_any;;
