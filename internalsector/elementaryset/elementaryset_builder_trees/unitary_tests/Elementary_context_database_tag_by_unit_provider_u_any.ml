...
testing "Elementary_context_database_tag_by_unit_provider_v with
    Elementary_context_database_tag_by_unit_provider_u_any.ml";;
...
(* toplevel 
   #use "Elementary_context_database_tag_by_unit_provider_u_any.ml";; 

*)

open Elementary_context_database_tag_by_unit_provider_v;;
...
test_number 3 (
(sym_eba : Elementary_context_database_symbol_t.elementary_context_database_symbol ) =
  Elementary_context_database_symbol_t.Elementary_context_database_constructor
   "nwchem"
);;
 
let tag_eba = Tag_v.make sym_eba soi_dba;;

test_number 4 (
(tag_eba : Elementary_context_database_symbol_t.elementary_context_database_symbol
  Tag_t.tag ) =
  (Elementary_context_database_symbol_t.Elementary_context_database_constructor
    "nwchem",
   [5; 20; 2])
