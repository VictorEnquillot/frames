...
testing "Elementary_context_database_tag_by_database_name_provider_v with
...
(* toplevel 
   #use "Elementary_context_database_tag_by_database_name_provider_u_any.ml";; 

*)

open Elementary_context_database_tag_by_database_name_provider_v;;
...
let tag_eba = Tag_v.make sym_eba soi_eba;;
