...
testing "Elementary_context_databox_tag_by_databox_name_n_database_name_provider_v with
...
(* toplevel 
   #use "Elementary_context_databox_tag_by_databox_name_n_database_name_provider_u_any.ml";; 

*)

open Elementary_context_databox_tag_by_databox_name_n_database_name_provider_v;;

let nam_ebo = "try_ao";;

let nam_eba = "nwchem";;

let nam_qua = Elementary_context_name_quatuor_by_databox_name_n_database_name_provider_v.provide
      (nam_ebo, nam_eba) ;;
...
test_number 3 (
(sym_ebo : Elementary_context_databox_symbol_t.elementary_context_databox_symbol ) =
  Elementary_context_databox_symbol_t.Elementary_context_databox_constructor
   "try_ao"
);;
 
let tag_ebo = Tag_v.make sym_ebo soi_ebo;;

test_number 4 (
(tag_ebo : Elementary_context_databox_symbol_t.elementary_context_databox_symbol
  Tag_t.tag ) =
  (Elementary_context_databox_symbol_t.Elementary_context_databox_constructor
    "try_ao",
   [16; 5; 6; 5])
...
test_number 5 (
tag_ebo = provide (nam_ebo, nam_eba)
);;
