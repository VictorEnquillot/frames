...
let documentation () = 
  [
   "Current : BELE:Elementary_tag_subtree_by_elementary_tag_provider_v";
   "Needs : BELE:Elementary_tag_tree_by_elementary_context_databox_tag_provider_v";
   "Register : BELE:Elementary_tag_subtree_by_elementary_tag_register_v";
   "Needed-by :"; 
...
(* done with do_provider_with_register.sh Elementary_tag_subtree_by_elementary_tag_provider_v.ml force on lundi 10 octobre 2016, 09:12:58 (UTC+0200) *)
