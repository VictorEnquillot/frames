...
let documentation () = 
  [
   "Current : BELE:Elementary_as_context_database_tag_by_database_name_provider_v";
...
let build nam_eba =
  ...
  let sym_ele_eba = 
    Elementary_symbol_v.elementary_context_database_constructor 
      nam_eba
  in
  Tag_v.make sym_ele_eba soi_eba
;;
...
(* done with do_provider_without_register.sh Elementary_as_context_database_tag_by_database_name_provider_v.ml force on lundi 10 octobre 2016, 09:13:00 (UTC+0200) *)
