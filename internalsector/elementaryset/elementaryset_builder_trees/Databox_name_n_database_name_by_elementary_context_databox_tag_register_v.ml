(** {3 Databox_name_n_database_name_by_elementary_context_databox_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BELE:Databox_name_n_database_name_by_elementary_context_databox_tag_register_v";
 ]
;;
