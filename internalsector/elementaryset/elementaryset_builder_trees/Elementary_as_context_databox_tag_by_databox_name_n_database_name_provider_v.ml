...
let documentation () = 
  [
   "Current : BELE:Elementary_as_context_databox_tag_by_databox_name_n_database_name_provider_v";
   "Needs : BELE:Elementary_context_name_quatuor_by_databox_name_n_database_name_provider_v";
...
let build (nam_ebo, nam_eba) =
  ...
  let sym_ele_ebo = 
    Elementary_symbol_v.elementary_context_databox_constructor 
      nam_ebo
  in
  Tag_v.make sym_ele_ebo soi_ebo
;;
...
(* done with do_provider_without_register.sh Elementary_as_context_databox_tag_by_databox_name_n_database_name_provider_v.ml force on lundi 10 octobre 2016, 09:13:00 (UTC+0200) *)
