(** {3 Elementary_context_domain_tag_by_unit_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BELE:Elementary_context_domain_tag_by_unit_provider_v";
...
let build () =
  ...
  in
  let sym_ecd = 
    Elementary_context_domain_symbol_v.elementary_context_domain_constructor 
      nam_dom 
  in
...
(* done with do_provider_without_register.sh Elementary_context_domain_tag_by_unit_provider_v.ml force on lundi 10 octobre 2016, 09:13:01 (UTC+0200) *)
