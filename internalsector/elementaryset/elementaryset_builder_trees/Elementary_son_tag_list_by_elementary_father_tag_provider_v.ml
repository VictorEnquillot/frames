...
let documentation () = 
  [
   "Current : BELE:Elementary_son_tag_list_by_elementary_father_tag_provider_v";
   "Needs : BELE:Elementary_tag_tree_by_elementary_context_databox_tag_provider_v";
   "Register : BELE:Elementary_son_tag_list_by_elementary_father_tag_register_v";
...
(* done with do_provider_with_register.sh Elementary_son_tag_list_by_elementary_father_tag_provider_v.ml force on lundi 10 octobre 2016, 09:12:57 (UTC+0200) *)
