(** {3 Elementary_as_context_domain_tag_by_unit_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BELE:Elementary_as_context_domain_tag_by_unit_provider_v";
...
let build () =
  ...
  let sym_ele_ecd = 
    Elementary_symbol_v.elementary_context_domain_constructor 
      nam_dom 
  in
  Tag_v.make sym_ele_ecd soi_dom
;;
...
(* done with do_provider_without_register.sh Elementary_as_context_domain_tag_by_unit_provider_v.ml force on lundi 10 octobre 2016, 09:13:00 (UTC+0200) *)
