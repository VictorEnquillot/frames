...
let documentation () = 
  [
   ...
   "Register : DELE:Elementary_tag_tree_by_elementary_context_databox_skeletondata_tag_register_v";
   "Needed-by : DELE:";
   "What-is-it : the list of all Nodes of the Tag Builder-tree for a Databox";
...
let build_n_store tag_eba =
  let tag_ele_l = build tag_eba in
  Elementary_tag_all_list_by_elementary_context_databox_skeletondata_tag_register_v.store tag_eba tag_ele_l; 
  store_all tag_eba;
  tag_ele_l
;;
...
let provide_without_trace tag_eba =
  ...
  then Elementary_tag_all_list_by_elementary_context_databox_skeletondata_tag_register_v.retrieve tag_eba
