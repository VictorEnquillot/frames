...
(* toplevel 
   #use "Coordinate_envelope_u_segment_bc.ml";;
...
let tag_coo_sbc = List_v.only_element_of_predicate_off_list
    (fun (s, i) -> 
      (Coordinate_symbol_v.string_off s = "segment_BC") 
        && 
      (Coordinate_symbol_v.is_coordinate_set_fence_heterogeneous_cylindrical_rho_constructor s)
    )
    tag_coo_l;;
...
test_number 17 (
(nam_env : string ) =
  " [\n   (coordinate_set_fence_heterogeneous_cylindrical_rho_constructor, (1.000000, meter))\n  ]"
);;
...
test_number 19 (
(fna : string ) =
  " [\n   ((Coordinate_set_fence_symbol_t.Coordinate_set_fence_heterogeneous_cylindrical_rho_constructor \"A_A\", [1; 1; 10; 1; 5; 5]), Readee_measure_t.Readee_measure of Measure_actual_t.(1.000000, meter))\n  ]"
);;
...
test_number 20 (
(lna : string ) =
  " [\n   (Coordinate_set_fence_symbol_t.Coordinate_set_fence_heterogeneous_cylindrical_rho_constructor Tag_t.tag, Readee_measure_t.Readee_measure of Measure_actual_t.(1.000000, meter))\n  ]"
);;
