...
testing "Measure_by_coordinate_tag_provider_v with
   Measure_by_coordinate_tag_provider_u_any.ml";;

(* toplevel 
   #use "Measure_by_coordinate_tag_provider_u_any.ml";; 
...
let mea = Measure_by_coordinate_tag_provider_v.provide tag_coo;;


test_number 3 (
sym_ele
(* : Measure_by_coordinate_tag_provider_t.elementary *)
= 
  Measure_by_coordinate_tag_provider_t.Units_symbol
