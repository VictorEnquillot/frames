...
let documentation () = 
  [
   "Current : DELE:Elementary_symbol_tree_by_db1figure_local_database_tag_provider_v";
   "Needs : DB1DBA:Db1figure_tag_tree_by_db1figure_local_database_tag_provider_v";
...
let elementary_symbol_of_db1figure_local_database_tag tag_dld =
...
let build tag_dld =
  let tag_den_t = 
    Db1figure_tag_tree_by_db1figure_local_database_tag_provider_v.provide 
      tag_dld 
  in
  ...
  let sym_ele_dba = elementary_symbol_of_db1figure_local_database_tag tag_dld in
