(** {3 Elementary_symbol_from_db1figure_tag_translations_v} *)
...
let elementary_as_body_coordinate_tuple_symbol_of_db1figure_coordinates_kind_of_db1figure_as_body_sequence_float_symbol db1_dck = function
  | Db1figure_symbol_t.Db1figure_body_symbol
      (Db1figure_body_symbol_t.Db1figure_body_sequence_symbol
		 ...
		 begin
		   ...
		   | Db1figure_fence_token_coordinates_kind_symbol_t.Db1figure_fence_token_coordinates_kind_cylindrical ->
		       Elementary_symbol_v.elementary_body_coordinate_tuple_heterogeneous_cylindrical_constructor 
			 sof_db1_dsf
			 
		   | Db1figure_fence_token_coordinates_kind_symbol_t.Db1figure_fence_token_coordinates_kind_polar ->
...
let elementary_as_border_coordinate_of_vertex_name_of_db1figure_coordinates_kind_of_db1figure_as_fence_basic_numerical_float_tag nam_ver sym_dck tag_db1_dnf =
let nam_fun = "elementary_as_border_coordinate_of_vertex_name_of_db1figure_coordinates_kind_of_db1figure_as_fence_basic_numerical_float_tag" in
  ...
  | _ -> failwith "Not_a_Db1figure_fence_basic_numerical_float_constructor:Elementary_symbol_from_db1figure_tag_translations_v"
;;
...
let elementary_fence_units_length_symbol_of_db1figure_as_fence_token_coordinates_units_length_symbol = function
  | Db1figure_fence_token_coordinates_units_length_symbol_t.Db1figure_fence_token_coordinates_units_length_angstrom ->
      Elementary_fence_units_length_symbol_v.make "angstrom" ""

  | Db1figure_fence_token_coordinates_units_length_symbol_t.Db1figure_fence_token_coordinates_units_length_bohr ->
      Elementary_fence_units_length_symbol_v.make "bohr" ""
	
  | Db1figure_fence_token_coordinates_units_length_symbol_t.Db1figure_fence_token_coordinates_units_length_meter ->
      Elementary_fence_units_length_symbol_v.make "meter" ""
;;

let elementary_fence_units_angle_symbol_of_db1figure_as_fence_token_coordinates_units_angle_symbol = function
  | Db1figure_fence_token_coordinates_units_angle_symbol_t.Db1figure_fence_token_coordinates_units_angle_degree ->
      Elementary_fence_units_angle_symbol_v.make "degree" ""
	
  | Db1figure_fence_token_coordinates_units_angle_symbol_t.Db1figure_fence_token_coordinates_units_angle_radian ->
      Elementary_fence_units_angle_symbol_v.make "radian" ""
;;

let elementary_fence_units_symbol_of_db1figure_fence_token_coordinates_units_angle_symbol_of_db1figure_fence_token_coordinates_units_length_symbol_of_coordinate_symbol_of_elementary_as_border_coordinate_symbol sym_db1_dua sym_db1_dul sym_ele_ebc =
  let nam_fun = "elementary_fence_units_symbol_of_db1figure_fence_token_coordinates_units_angle_symbol_of_db1figure_fence_token_coordinates_units_length_symbol_of_coordinate_symbol_of_elementary_as_border_coordinate_symbol" in
  ...
  | Elementary_border_coordinate_symbol_t.Elementary_border_coordinate_heterogeneous_symbol 
	 ...
	 let sym_eul = 
	   elementary_fence_units_length_symbol_of_db1figure_as_fence_token_coordinates_units_length_symbol 
	     sym_db1_dul
	 in
	 Elementary_fence_units_symbol_v.elementary_fence_units_symbol_of_elementary_fence_units_length_symbol sym_eul
  ...
  | Elementary_border_coordinate_symbol_t.Elementary_border_coordinate_heterogeneous_symbol 
	 ...
	 (Elementary_border_coordinate_heterogeneous_polar_symbol_t.Elementary_border_coordinate_heterogeneous_polar_theta_symbol _))  ->
	   ...
	   let sym_eua = 
	     elementary_fence_units_angle_symbol_of_db1figure_as_fence_token_coordinates_units_angle_symbol 
	       sym_db1_dua
	   in
	   Elementary_fence_units_symbol_v.elementary_fence_units_symbol_of_elementary_fence_units_angle_symbol sym_eua
	     
  | _ -> 
      Error_messages_v.print_fatal_error __LOC__ nam_fun 
	"Elementary_border_coordinate_symbol were any Cartesian Cylindrical rho phi zed Polar rho theta Spherical rho phi theta" 
	(Format.sprintf "%s" (Elementary_border_coordinate_symbol_v.fullname sym_ebc))
	"Check"		   
;;
