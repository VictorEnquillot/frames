(** {3 Readee_basic_by_elementary_fence_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : DELE:Readee_basic_by_elementary_fence_tag_register_v";
...
let register : 
    (Elementary_fence_tag_t.elementary_fence_tag,
...
let name_of_key key =
  Elementary_fence_tag_v.name key
;;
