...
let string_off = function
  ...
  | Readee_t.Readee_units bun ->
      (Measure_actual_v.string_off bun)
;;
...
let readee_of_measure_actual mea =
  Readee_t.Readee_units mea 
;;
...
let measure_actual_off_readee rea = readee_units_off_readee rea;;

let measure_actual_off_readee_units plu_uni = plu_uni;;
...
let make nam s v w =
  ...
  | "units" -> Readee_t.Readee_units (Measure_actual_v.make_of_string_of_string_of_string s v w)
  | "measure" -> Readee_t.Readee_units (Measure_actual_v.make_of_string_of_string_of_string s v w )
  | _ ->
