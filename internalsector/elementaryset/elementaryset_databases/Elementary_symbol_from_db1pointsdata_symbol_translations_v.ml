(** {3 Elementary_symbol_from_db1pointsdata_symbol_translations_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : DELE:Elementary_symbol_from_db1pointsdata_symbol_translations_v";
   "Needs : ";
   "Needed-by :"; 
...
let elementary_as_body_coordinate_tuple_symbol_of_db1pointsdata_coordinates_kind_of_db1pointsdata_as_body_sequence_float_symbol db1_dck sym_db1_dsf = 

  match sym_db1_dsf with 
