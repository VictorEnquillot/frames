(** {3 Readee_basic_by_elementary_fence_basic_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : DELE:Readee_basic_by_elementary_fence_basic_tag_register_v";
   "Author : François Colonna 10 mai 2016 at 10:37:26+02:00";
 ]
;;
...
let register : 
    (Elementary_fence_basic_tag_t.elementary_fence_basic_tag,
     Readee_basic_t.readee_basic
    ) 
    Register_t.register = 
...
let name_of_key key =
  Elementary_fence_basic_tag_v.name key
;;

let name_of_value val_ =
  Readee_basic_v.name val_
;;
