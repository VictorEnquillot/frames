...
let documentation () = 
  [
   "Current : DELE:Elementary_context_databox_tag_by_databox_name_n_database_name_provider_v";
   "Needs : DELE:Elementary_context_databox_figuredata_tag_by_databox_name_n_database_name_provider_v";
   "Needs : DELE:Elementary_context_databox_skeletondata_tag_by_databox_name_n_database_name_provider_v";
   "Needed-by :"; 
...
let build (nam_dbo, nam_dba) =
  ...
  | "figure" ->
      let tag_edf = 
	Elementary_context_databox_figuredata_tag_by_databox_name_n_database_name_provider_v.provide
	  (nam_dbo, nam_dba)
      in
  ...
  | "skeleton" ->
      let tag_eds = 
	Elementary_context_databox_skeletondata_tag_by_databox_name_n_database_name_provider_v.provide
	  (nam_dbo, nam_dba)
      in
      Tag_v.map_entity (* Coerce Up *)
...
(* done with do_provider_without_register.sh Elementary_context_databox_tag_by_databox_name_n_database_name_provider_v.ml on mercredi 25 mai 2016, 10:04:04 (UTC+0200) *)
