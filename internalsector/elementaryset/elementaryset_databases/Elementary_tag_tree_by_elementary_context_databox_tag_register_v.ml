(** {3 Elementary_tag_tree_by_elementary_context_databox_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : DELE:Elementary_tag_tree_by_elementary_context_databox_tag_register_v";
   "Author : François Colonna 09 mai 2016 at 10:30:38+02:00";
 ]
;;
...
let register : 
    (Elementary_context_databox_tag_t.elementary_context_databox_tag,
     Elementary_tag_t.elementary_tag Tree_t.tree
    ) 
    Register_t.register = 
...
let name_of_key key =
  Elementary_context_databox_tag_v.fullname key
;;
...
(* done with do_register.sh on mercredi 25 mai 2016, 10:03:57 (UTC+0200) *)
