(** {3 Database_name_n_databox_name_by_elementary_context_databox_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : DELE:Database_name_n_databox_name_by_elementary_context_databox_tag_register_v";
 ]
;;
