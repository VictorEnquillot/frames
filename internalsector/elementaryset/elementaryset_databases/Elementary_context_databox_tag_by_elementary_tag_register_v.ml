(** {3 Elementary_context_databox_tag_by_elementary_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : DELE:Elementary_context_databox_tag_by_elementary_tag_register_v";
   "Author : François Colonna 10 mai 2016 at 11:01:47+02:00";
 ]
;;
...
let name_of_key key =
  Elementary_tag_v.fullname key
;;

let name_of_value val_ =
  Elementary_context_databox_tag_v.fullname
    val_
;;
