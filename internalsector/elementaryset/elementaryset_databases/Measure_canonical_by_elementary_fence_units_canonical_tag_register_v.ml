(** {3 Measure_canonical_by_elementary_fence_units_canonical_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : DELE:Measure_canonical_by_elementary_fence_units_canonical_tag_register_v";
 ]
;;
...
let register : 
    (Elementary_fence_units_canonical_tag_t.elementary_fence_units_canonical_tag,
     Measure_canonical_t.measure_canonical
    ) 
    Register_t.register = 
...
let name_of_key key =
  Elementary_fence_units_canonical_tag_v.name key
;;

let name_of_value val_ =
  Measure_canonical_v.name val_
;;
