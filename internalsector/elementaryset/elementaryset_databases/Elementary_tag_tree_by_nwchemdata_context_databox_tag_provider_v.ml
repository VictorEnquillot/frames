(** {3 Elementary_tag_tree_by_nwchemdata_context_databox_tag_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : DELE:Elementary_tag_tree_by_nwchemdata_context_databox_tag_provider_v";
   "Needed-by : DELE:";
   "Needs : DELE:Elementary_as_context_tag_trio_by_nwchemdata_context_databox_tag_provider_v";
   ...
   "Needs : DELE:Elementary_symbol_subtree_by_nwchemdata_context_databox_tag_provider_v";
   "Needs : DELE:Nwchemdata_context_databox_tag_v";
   ...
   "Abbreviation : ndb = nwchemdata_context_database";
...
let build tag_ndf =
  let sym_ele_edf_st =
    Elementary_symbol_subtree_by_nwchemdata_context_databox_tag_provider_v.provide
      tag_ndf
  in

  let (tag_ele_ecd, tag_ele_edb, tag_ele_edf) = 
    Elementary_as_context_tag_trio_by_nwchemdata_context_databox_tag_provider_v.provide
      tag_ndf 
  in
...
(* done with do_provider_without_register.sh Elementary_tag_tree_by_nwchemdata_context_databox_tag_provider_v.ml on mercredi 25 mai 2016, 10:04:06 (UTC+0200) *)
