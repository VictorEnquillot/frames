(** {3 Readee_by_elementary_fence_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : DELE:Readee_by_elementary_fence_tag_register_v";
   "Author : François Colonna 10 mai 2016 at 10:36:38+02:00";
 ]
;;
