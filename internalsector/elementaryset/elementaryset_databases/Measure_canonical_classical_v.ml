...
let documentation () = 
  [
   "Current : DELE:Measure_canonical_classical_v";
   "Needed-by: ";
   "What-is-it: the coupling of a float and an Elementary_fence_units_canonical_classical_symbol"; 
   "Remark : a Measure is NOT an Entity NO Coercision";
   "Remark : it is a Datastructure. Coercion is done on Elementary_fence_units_canonical_classical_symbol";
...
let float_off_measure_canonical_classical mea_ccl =
  Doublet_v.left_off_doublet mea_ccl
;;

(** {6 Elementary_fence_units_canonical_classical_symbol} *)

let elementary_fence_units_canonical_classical_symbol_off_measure_canonical_classical mea_ccl =
  Doublet_v.right_off_doublet mea_ccl
;;
...
let measure_canonical_classical_off_measure_canonical mca =
  Doublet_v.map_right 
    Elementary_fence_units_canonical_symbol_v.elementary_fence_units_canonical_classical_symbol_off_elementary_fence_units_canonical_symbol 
    mca
;;
...
let measure_of_measure_canonical_classical mcc =
  Doublet_v.map_right 
    Elementary_fence_units_canonical_classical_conversion_v.elementary_fence_units_actual_symbol_of_elementary_fence_units_canonical_classical_symbol
  mcc
;;
...
let name mea_ccl =
  Doublet_v.name String_v.string_of_float Elementary_fence_units_canonical_classical_symbol_v.name mea_ccl
;;

let string_off mea_ccl = "";;

let longname mea_ccl =
  Format.sprintf "Measure_canonical_classical_t.%s" (String.capitalize (name mea_ccl))
;;
...
let write och mea_ccl =
  let flo = float_off_measure_canonical_classical mea_ccl in
  let sym_ecc = elementary_fence_units_canonical_classical_symbol_off_measure_canonical_classical mea_ccl in
