(** {3 Elementary_as_context_tag_trio_by_nwchemdata_context_databox_tag_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : DELE:Elementary_as_context_tag_trio_by_nwchemdata_context_databox_tag_provider_v";
...
let build tag_ndf =
  ...
  let nam_dbo = Nwchemdata_context_databox_tag_v.string_off tag_ndf in
  let tag_eba = 
...
(* done with do_provider_without_register.sh Elementary_as_context_tag_trio_by_nwchemdata_context_databox_tag_provider_v.ml on mercredi 25 mai 2016, 10:04:03 (UTC+0200) *)
