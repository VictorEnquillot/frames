...
let elementary_as_body_coordinate_tuple_symbol_of_db1figure_coordinates_kind_of_db1figure_as_body_sequence_float_symbol db1_dck = function
  ...
  | sym_db1 -> 
      let nam_fun = "elementary_as_body_coordinate_tuple_symbol_of_db1figure_coordinates_kind_of_db1figure_as_body_sequence_float_symbol" in
      Error_messages_v.print_fatal_error __LOC__ nam_fun 
	"Db1figure_body_sequence_float_constructor"
...
(*    Elementary_fence_units_actual_length                <=|  Db1figure_fence_token_units_actual_length *)
(*    Elementary_body_coordinate_tuple_homogeneous <=|  Db1figure_body_sequence_float      *)

let elementary_fence_units_actual_length_symbol_of_db1figure_as_fence_token_coordinates_units_length_symbol = function
...
let elementary_fence_units_actual_angle_symbol_of_db1figure_as_fence_token_coordinates_units_angle_symbol = function
  ...
  | _ ->
      failwith "No_angle:Elementary_symbol_from_db1figure_tag_translations_v:elementary_fence_units_actual_angle_symbol_of_db1figure_as_fence_token_coordinates_units_angle_symbol"
;;

let elementary_fence_units_actual_symbol_of_db1figure_fence_token_coordinates_units_angle_symbol_of_db1figure_fence_token_coordinates_units_length_symbol_of_coordinate_symbol_of_elementary_as_border_coordinate_symbol sym_db1_dua sym_db1_dul sym_ele_ebc =
  ...
  | Elementary_border_coordinate_symbol_t.Elementary_border_coordinate_homogeneous_symbol _ ->
      let sym_eul = 
	elementary_fence_units_actual_length_symbol_of_db1figure_as_fence_token_coordinates_units_length_symbol 
	  sym_db1_dul
      in
  ...
  | Elementary_border_coordinate_symbol_t.Elementary_border_coordinate_heterogeneous_symbol sym_ehe ->
	  ...
	  (Elementary_border_coordinate_heterogeneous_polar_symbol_t.Elementary_border_coordinate_heterogeneous_polar_theta_symbol _)  ->
	    ...
	    let sym_eua = 
	      elementary_fence_units_actual_angle_symbol_of_db1figure_as_fence_token_coordinates_units_angle_symbol 
		sym_db1_dua
	    in
