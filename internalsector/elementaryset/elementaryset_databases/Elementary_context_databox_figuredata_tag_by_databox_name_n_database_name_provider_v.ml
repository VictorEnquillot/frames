(** {3 Elementary_context_databox_figuredata_tag_by_databox_name_n_database_name_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : DELE:Elementary_context_databox_figuredata_tag_by_databox_name_n_database_name_provider_v";
   ...
   "Needs : SELE:Elementary_context_databox_figuredata_symbol_v";
   "Needed-by :"; 
...
let build (nam_dbo, nam_dba) =
  ...
  in
  let sym_edf = 
    Elementary_context_databox_figuredata_symbol_v.elementary_context_databox_figuredata_constructor 
      nam_dbo 
  in
  Tag_v.make sym_edf soi_dfi_ele
;;
...
(* done with do_provider_without_register.sh Elementary_context_databox_figuredata_tag_by_databox_name_n_database_name_provider_v.ml on mercredi 25 mai 2016, 10:04:04 (UTC+0200) *)
