(** {3 Elementary_string_off_by_nwchemdata_body_node_aoset_numerical_values_string_off_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : DELE:Elementary_string_off_by_nwchemdata_body_node_aoset_numerical_values_string_off_register_v";
   "Author : François Colonna 09 mai 2016 at 10:04:28+02:00";
 ]
;;
