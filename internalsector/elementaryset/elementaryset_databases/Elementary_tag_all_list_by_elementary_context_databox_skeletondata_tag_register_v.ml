(** {3 Elementary_tag_all_list_by_elementary_context_databox_skeletondata_tag_register_v} *)
...
[
  "Needs : ";
   "Current : DELE:Elementary_tag_all_list_by_elementary_context_databox_skeletondata_tag_register_v";
  "Needed-by: ";
  "What-is-it: ";
  "How-is-it-done: ";
  "Example: ";
...
let register : 
    (Elementary_context_databox_skeletondata_tag_t.elementary_context_databox_skeletondata_tag,
     Elementary_tag_t.elementary_tag list
    ) 
    Register_t.register = 
...
let name_of_key key =
  Elementary_context_databox_skeletondata_tag_v.fullname key
;;

let name_of_value val_ =
  List_v.name_in_column
    Elementary_tag_v.fullname 
    val_
;;
...
(* done with do_register.sh on mercredi 25 mai 2016, 10:03:56 (UTC+0200) *)
