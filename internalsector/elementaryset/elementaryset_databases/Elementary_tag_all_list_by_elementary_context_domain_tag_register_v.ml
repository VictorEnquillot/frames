(** {3 Elementary_tag_all_list_by_elementary_context_domain_tag_register_v} *)
...
[
  "Needs : ";
   "Current : DELE:Elementary_tag_all_list_by_elementary_context_domain_tag_register_v";
  "Needed-by: ";
  "What-is-it: ";
  "How-is-it-done: ";
  "Example: ";
...
let register : 
    (Elementary_context_domain_tag_t.elementary_context_domain_tag,
...
let name_of_key key =
  Elementary_context_domain_tag_v.fullname key
;;
