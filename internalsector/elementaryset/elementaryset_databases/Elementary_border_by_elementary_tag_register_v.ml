(** {3 Elementary_border_by_elementary_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : DELE:Elementary_border_by_elementary_tag_register_v";
   "Author : François Colonna 09 mai 2016 at 10:13:32+02:00";
 ]
;;
...
let register : 
    (Elementary_tag_t.elementary_tag,
     Elementary_border_tag_t.elementary_border_tag list
    ) 
    Register_t.register = 
