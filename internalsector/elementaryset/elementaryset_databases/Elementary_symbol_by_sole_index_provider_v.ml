...
let documentation () = 
  [
   "Current : DELE:Elementary_symbol_by_sole_index_provider_v";
   "Needs : DELE:Elementary_symbol_by_sole_index_register_filler_v";
   "Needed-by : DELE:";
...
(* done with do_dddd_symbol_by_sole_index_provider.sh on mercredi 25 mai 2016, 10:04:08 (UTC+0200) *)
