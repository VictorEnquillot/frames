(** {3 Elementary_tag_tree_by_databox_name_n_database_name_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : DELE:Elementary_tag_tree_by_databox_name_n_database_name_provider_v";
   "Needs : DELE:Elementary_context_databox_tag_by_databox_name_n_database_name_provider_v";
...
(* done with do_provider_without_register.sh Elementary_tag_tree_by_databox_name_n_database_name_provider_v.ml on mercredi 25 mai 2016, 10:04:05 (UTC+0200) *)
