...
testing "Elementary_context_databox_tag_by_databox_name_provider with
...
(* toplevel 
   #use "Elementary_context_databox_tag_by_database_name_n_databox_name_provider_u_triangle_isoright.ml";;
...
open Elementary_context_databox_tag_by_database_name_n_databox_name_provider_v;;
...
test_number 1 (
(soi_dfi_glo : int list ) = 
[6; 1; 8]

);;

let soi_dom_glo = [List_v.last_element_off_list soi_dfi_glo];; 

test_number 2 ( 
(soi_dom_glo : int list ) =
 [8]
);;
