...
testing "Elementary_symbol_subtree_by_elementary_body_coordinate_tuple_elementary_border_coordinate_cartesian_symbol_builder_v with
   Elementary_symbol_subtree_by_elementary_body_coordinate_tuple_elementary_border_coordinate_cartesian_symbol_builder_u_any.ml";;
...
(* toplevel 
   #use "Elementary_symbol_subtree_by_elementary_body_coordinate_tuple_elementary_border_coordinate_cartesian_symbol_builder_u_any.ml";;
...
open Elementary_symbol_subtree_by_elementary_body_coordinate_tuple_elementary_border_coordinate_cartesian_symbol_builder_v;;
...
let tag_nwchem_l = Nwchem_tag_all_list_by_elementary_body_coordinate_tuple_elementary_border_coordinate_cartesian_symbol_builder_v.provide tag_dcb;;
  
let tag_nwchem_anv_l = List.filter 
      (fun (s, i) -> Nwchem_symbol_v.is_nwchem_body_node_aoset_numerical_values s)
      tag_nwchem_l;;

let sof_nwchem_anv_l = List.map Nwchem_tag_v.string_off tag_nwchem_anv_l;;

test_number 2 (
(sof_nwchem_anv_l : string list ) =
  ["Ne S 1 GAUSSIAN 1"; "Ne S 1 GAUSSIAN 2"; "Ne S 1 GAUSSIAN 3";
   "Ne S 1 GAUSSIAN 4"; "Ne S 2 GAUSSIAN 1"; "Ne S 2 GAUSSIAN 2";
   "Ne S 2 GAUSSIAN 3"; "Ne S 3 GAUSSIAN 1"; "Ne P 4 GAUSSIAN 1";
   "Ne P 4 GAUSSIAN 2"; "Ne P 5 GAUSSIAN 1"; "Au S 1 GAUSSIAN 1";
   "Au S 1 GAUSSIAN 2"; "Au S 1 GAUSSIAN 3"; "Au S 2 GAUSSIAN 1";
   "Au P 3 GAUSSIAN 1"; "Au P 3 GAUSSIAN 2"; "Au P 4 GAUSSIAN 1";
   "Au P 4 GAUSSIAN 2"; "Au P 5 GAUSSIAN 1"; "Au D 6 GAUSSIAN 1";
   "Au D 6 GAUSSIAN 2"; "Au D 7 GAUSSIAN 1"]
);;
...
let sym_ele_bas_st = provide tag_dcb;;
...
let sym_ele_st = Tree_v.subtree_find_of_node_predicate_off_tree (fun s -> Elementary_symbol_v.string_off s = "Au D 6 GAUSSIAN 1") sym_ele_bas_st;;
