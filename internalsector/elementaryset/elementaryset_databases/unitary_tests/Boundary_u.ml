...
(* toplevel 
   #use "Boundary_u_any.ml";;

*)

let tag_dom = Domain_tag_v.make_of_domain_name_of_string_of_sole_index_up "elementary" "" [];;
...
let tag_ele_dom = Boundary_from_domain_tag_translator_v.translate tag_dom;;
