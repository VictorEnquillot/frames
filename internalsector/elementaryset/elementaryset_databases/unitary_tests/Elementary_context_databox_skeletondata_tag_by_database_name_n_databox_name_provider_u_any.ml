...
testing "Elementary_context_databox_skeletondata_tag_by_databox_name_provider with
   Elementary_context_databox_skeletondata_tag_by_database_name_n_databox_name_provider_u_any.ml";;
...
(* toplevel 
   #use "Elementary_context_databox_skeletondata_tag_by_database_name_n_databox_name_provider_u_any.ml";;

*)

open Elementary_context_databox_skeletondata_tag_by_database_name_n_databox_name_provider_v;;

let nam_dba = "nwchem";;
let nam_dbo = "cc_pvtz";;

let tag_ele_bas = 
  Elementary_as_basisset_tag_by_database_name_n_databox_name_provider_v.provide
    (nam_dna, nam_dna);;
...
let tag_eba = Tag_v.map_entity 
    Elementary_symbol_v.elementary_context_databox_skeletondata_symbol_off_elementary_symbol 
    tag_ele_bas
;;
...
let boo = tag_eba = provide (nam_dna, nam_dna);;
