...
testing "Measure_canonical_by_elementary_fence_units_actual_tag_provider_v with
...
Trace_what_by_module_name_register_v.store "Measure_canonical_by_elementary_fence_units_actual_tag_provider_v" "cpu any";;
...
*)
(* toplevel 
   #use "Measure_canonical_by_elementary_fence_units_actual_tag_provider_u_point_a.ml";;
...
open Measure_canonical_by_elementary_fence_units_actual_tag_provider_v;;
