...
let fen_ele = Elementary_border_by_elementary_tag_provider_v.provide tag_ele;;
...
let dfe_ele = provide tag_ele;;

test_number 3 (
(dfe_ele : Elementary_symbol_t.elementary_symbol Tag_t.tag list ) =
