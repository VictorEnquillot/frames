...
(* toplevel 
   #use "Elementary_tag_tree_by_elementary_createdby_tag_provider_u_coordinate_tuple_print.ml";;
...
open Elementary_tag_tree_by_elementary_createdby_tag_provider_v;;

let tag_ele_t = provide tag_ecr;;
...
Elementary_tag_subtree_by_elementary_tag_register_v.dump ();;
Elementary_symbol_by_sole_index_register_v.dump ();;
Elementary_creation_module_name_by_sole_index_register_v.dump ();;
