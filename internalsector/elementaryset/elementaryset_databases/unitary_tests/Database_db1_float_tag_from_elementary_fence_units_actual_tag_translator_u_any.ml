...
testing "Db1figure_float_tag_from_elementary_fence_units_actual_tag_translator_v with
   Db1figure_float_tag_from_elementary_fence_units_actual_tag_translator_u_any.ml";;
...
(* toplevel 
   #use "Db1figure_float_tag_from_elementary_fence_units_actual_tag_translator_u_any.ml";;
...
let (tag_uni_rho, tag_uni_phi, tag_uni_theta) = Trio_v.trio_off_list tag_uni_dfe;;

(* Phi *)

let soi_uni_phi = Tag_v.sole_index_off_tag tag_uni_phi;;
let tag_ctu = Elementary_any_category_by_sole_index_extractor_v.coordinate_tuple_tag_off_sole_index soi_uni_phi;;
...
let tag_flo_clo = Db1figure_float_tag_closure_from_elementary_body_coordinate_tuple_tag_translator_v.translate tag_ctu;;

test_number 7 (
tag_flo_clo 
(* : Db1figure_float_symbol_t.db1figure_float_symbol Tag_t.tag list *)
=
...
let idx_uni = List_v.index_of_element_of_list tag_uni_phi tag_uni_dfe;;
let tag_flo_phi = List.nth tag_flo_clo idx_uni;;
...
let tag_flo_phi = Db1figure_float_tag_from_elementary_fence_units_actual_tag_translator_v.translate tag_uni_phi;;
test_number 9 (
tag_flo_phi
(* : Db1figure_float_symbol_t.db1figure_float_symbol Tag_t.tag *)
=
