...
testing "Elementary_tag_all_list_by_elementary_context_databox_skeletondata_tag_provider_v with
...
(* toplevel 
   #use "Elementary_tag_all_list_by_elementary_context_databox_skeletondata_tag_provider_u_any.ml";;
...
let tag_ele_t = Elementary_tag_tree_by_elementary_context_databox_skeletondata_tag_provider_v.provide tag_eba;;
...
let tag_ele_l = Elementary_tag_all_list_by_elementary_context_databox_skeletondata_tag_provider_v.provide tag_eba;;
...
let tag_ele_bas = Tag_v.map_entity Elementary_symbol_v.elementary_symbol_of_elementary_context_databox_skeletondata_symbol tag_eba;;
