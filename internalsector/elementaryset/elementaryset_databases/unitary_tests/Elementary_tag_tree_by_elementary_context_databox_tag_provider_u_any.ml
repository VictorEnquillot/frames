...
(* toplevel 
   #use "Elementary_tag_tree_by_elementary_context_databox_tag_provider_u_any.ml";;
...
let sym_edf = Tag_v.entity_off_tag tag_edf;;
let sym_eba = Elementary_context_databox_symbol_v.elementary_context_databox_skeletondata_symbol_off_elementary_context_databox_symbol sym_edf;;
let soi_edf = Tag_v.sole_index_off_tag tag_edf;;

let tag_eba = Tag_v.make sym_eba soi_edf;;
