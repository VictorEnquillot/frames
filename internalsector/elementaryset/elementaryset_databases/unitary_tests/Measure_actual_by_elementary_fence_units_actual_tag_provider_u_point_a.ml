...
testing "Measure_actual_by_elementary_fence_units_actual_tag_provider_v with
...
Trace_what_by_module_name_register_v.store "Measure_actual_by_elementary_fence_units_actual_tag_provider_v" "cpu any";;
...
*)
(* toplevel 
   #use "Measure_actual_by_elementary_fence_units_actual_tag_provider_u_point_a.ml";;

*)

let nam_dba = "db1figure";;
let nam_dbo = "point_a";;
let nam_mod = "Measure_actual_by_elementary_fence_units_actual_tag_provider_v";;
...
let tag_ele_eua = Tag_v.make sym_ele_eua soi_ele_eua;;

open Measure_actual_by_elementary_fence_units_actual_tag_provider_v;;

(* Argument tag_eua *)

let soi_eua = soi_ele_eua;;
let sym_eua = Elementary_symbol_v.elementary_fence_units_actual_symbol_off_elementary_symbol sym_ele_eua;;
let tag_eua = Tag_v.make sym_eua soi_eua;;
...
let tag_db1_anv_st = 
	db1figure_as_body_sequence_float_tag_subtree_of_db1figure_tag_tree_of_elementary_body_coordinate_tuple 
      ...
      let idx_epa = List.nth soi_eua 1;;
      let flo = List.nth flo_l (idx_epa-1);;
      let sym_eua = Tag_v.entity_off_tag tag_eua;;

let mea_act_eua = Measure_actual_v.make flo sym_eua;;
