...
testing "Elementary_context_domain_tag_by_unit_provider with
...
(* toplevel 
   #use "Elementary_context_domain_tag_by_unit_provider_u_any.ml";;

*)

open Elementary_context_domain_tag_by_unit_provider_v;;

let tag_ele_dom = Elementary_as_context_domain_tag_by_unit_provider_v.provide ();;
