...
testing "Elementary_tag_all_list_by_database_name_provider_v with
   Elementary_tag_all_list_by_database_name_provider_u_any.ml";;
...
(* toplevel 
   #use "Elementary_tag_all_list_by_database_name_provider_u_any.ml";;
...
let tag_ecr = Database_name_by_database_name_provider_v.provide nam_dba;;

test_number 1 (
(tag_ecr : Database_name_symbol_t.database_name_symbol Tag_t.tag ) =
  (Database_name_symbol_t.Elementary_context_database "nwchem",
   [5; 4])
);;
