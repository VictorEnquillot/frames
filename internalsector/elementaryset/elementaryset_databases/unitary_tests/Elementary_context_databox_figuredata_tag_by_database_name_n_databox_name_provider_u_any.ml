...
testing "Elementary_context_databox_figuredata_tag_by_databox_name_provider with
   Elementary_context_databox_figuredata_tag_by_database_name_n_databox_name_provider_u_any.ml";;
...
(* toplevel 
   #use "Elementary_context_databox_figuredata_tag_by_database_name_n_databox_name_provider_u_any.ml";;
...
test_number 2 (
(tag_eba :
  Elementary_context_databox_figuredata_symbol_t.elementary_context_databox_figuredata_symbol Tag_t.tag ) =
  (Elementary_context_databox_figuredata_symbol_t.Elementary_context_databox_figuredata_constructor "cc_pvtz",
   [4; 5; 7])
);;
