(** {3 Elementary_symbol_by_sole_index_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : DELE:Elementary_symbol_by_sole_index_register_v";
 ]
;;

(** {6 Register.} *)

let nam_reg = "Elementary_symbol_by_sole_index_register_v";;
...
let name_of_value val_ =
  Elementary_symbol_v.fullname val_
;;
...
(* done with do_dddd_symbol_by_sole_index_register.sh on mercredi 25 mai 2016, 10:04:08 (UTC+0200) *)

(* done with /home/colonna/sources/ocaml_top/setup/utilities/template_dddd_symbol_by_sole_index_register_v.ml *)
