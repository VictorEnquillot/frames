(** {3 Measure_actual_by_elementary_fence_units_actual_tag_register_v} *)
...
[
  "Needs : ";
   "Current : DELE:Measure_actual_by_elementary_fence_units_actual_tag_register_v";
  "Needed-by: ";
  "What-is-it: ";
  "How-is-it-done: ";
  "Example: ";
...
let register : 
    (Elementary_fence_units_actual_tag_t.elementary_fence_units_actual_tag,
     Measure_actual_t.measure_actual
    ) 
    Register_t.register = 
...
let name_of_key key =
  Elementary_fence_units_actual_tag_v.name key
;;

let name_of_value val_ =
  Measure_actual_v.name val_
;;
