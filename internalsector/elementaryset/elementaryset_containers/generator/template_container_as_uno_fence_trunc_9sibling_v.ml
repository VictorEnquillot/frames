...
let documentation () = 
  [
   ...
   "Needs : FMMM:Sibling_6_container_v";
   "Needs : FMMM:Sibling_7_container_v";
   "Needs : FMMM:Sibling_8_container_v";
   "Needs : FMMM:Sibling_9_container_v";
...
let name = function
  ...
  | This_container_t.Sibling_6_container con_sib_6 ->
      (Sibling_6_container_v.name con_sib_6)

  | This_container_t.Sibling_7_container con_sib_7 ->
      (Sibling_7_container_v.name con_sib_7)
	
  | This_container_t.Sibling_8_container con_sib_8 ->
      (Sibling_8_container_v.name con_sib_8)

  | This_container_t.Sibling_9_container con_sib_9 ->
      (Sibling_9_container_v.name con_sib_9)
;;
...
let string_off = function
  ...
  | This_container_t.Sibling_6_container con_sib_6 ->
      (Sibling_6_container_v.string_off con_sib_6)

  | This_container_t.Sibling_7_container con_sib_7 ->
      (Sibling_7_container_v.string_off con_sib_7)
	
  | This_container_t.Sibling_8_container con_sib_8 ->
      (Sibling_8_container_v.string_off con_sib_8)
	
  | This_container_t.Sibling_9_container con_sib_9 ->
      (Sibling_9_container_v.string_off con_sib_9)
;;
...
let longname = function
  ...
  | This_container_t.Sibling_6_container con_sib_6 ->
      (Sibling_6_container_v.longname con_sib_6)

  | This_container_t.Sibling_7_container con_sib_7 ->
      (Sibling_7_container_v.longname con_sib_7)
	
  | This_container_t.Sibling_8_container con_sib_8 ->
      (Sibling_8_container_v.longname con_sib_8)
	
  | This_container_t.Sibling_9_container con_sib_9 ->
      (Sibling_9_container_v.longname con_sib_9)
;;
...
let fullname = function
  ...
  | This_container_t.Sibling_6_container con_sib_6 ->
      (Sibling_6_container_v.fullname con_sib_6)

  | This_container_t.Sibling_7_container con_sib_7 ->
      (Sibling_7_container_v.fullname con_sib_7)
	
  | This_container_t.Sibling_8_container con_sib_8 ->
      (Sibling_8_container_v.fullname con_sib_8)
	
  | This_container_t.Sibling_9_container con_sib_9 ->
      (Sibling_9_container_v.fullname con_sib_9)
;;
...
let container_of_tag tag_ttt =
  ...
  | This_symbol_t.Sibling_6_symbol sym_sib_6 ->
      let tag_sib_6 = Tag_v.make sym_sib_6 soi_ttt in
      This_container_t.Sibling_6_container
	(Sibling_6_container_v.container_of_tag tag_sib_6)

  | This_symbol_t.Sibling_7_symbol sym_sib_7 ->
      let tag_sib_7 = Tag_v.make sym_sib_7 soi_ttt in
      This_container_t.Sibling_7_container
	(Sibling_7_container_v.container_of_tag tag_sib_7)

  | This_symbol_t.Sibling_8_symbol sym_sib_8 ->
      let tag_sib_8 = Tag_v.make sym_sib_8 soi_ttt in
      This_container_t.Sibling_8_container
	(Sibling_8_container_v.container_of_tag tag_sib_8)

  | This_symbol_t.Sibling_9_symbol sym_sib_9 ->
      let tag_sib_9 = Tag_v.make sym_sib_9 soi_ttt in
      This_container_t.Sibling_9_container
	(Sibling_9_container_v.container_of_tag tag_sib_9)
;;
...
let this_container_of_sibling_6_container con_sib_6 =
  This_container_t.Sibling_6_container con_sib_6 
;;

let this_container_of_sibling_7_container con_sib_7 =
  This_container_t.Sibling_7_container con_sib_7 
;;

let this_container_of_sibling_8_container con_sib_8 =
  This_container_t.Sibling_8_container con_sib_8 
;;

let this_container_of_sibling_9_container con_sib_9 =
  This_container_t.Sibling_9_container con_sib_9 
;;
...
let sibling_5_container_off_this_container = function
  ...
  | _ -> failwith "Not_a_sibling_5:This_container.sibling_5_container_off_this_container"
;;

let sibling_6_container_off_this_container = function
  | This_container_t.Sibling_6_container con_sib_6 -> con_sib_6
  | _ -> failwith "Not_a_sibling_6:This_container.sibling_6_container_off_this_container"
;;

let sibling_7_container_off_this_container = function
  | This_container_t.Sibling_7_container con_sib_7 -> con_sib_7
  | _ -> failwith "Not_a_sibling_7:This_container.sibling_7_container_off_this_container"
;;

let sibling_8_container_off_this_container = function
  | This_container_t.Sibling_8_container con_sib_8 -> con_sib_8
  | _ -> failwith "Not_a_sibling_8:This_container.sibling_8_container_off_this_container"
;;

let sibling_9_container_off_this_container = function
  | This_container_t.Sibling_9_container con_sib_9 -> con_sib_9
  | _ -> failwith "Not_a_sibling_9:This_container.sibling_9_container_off_this_container"
;;
