(** {3 Elementary_border_coordinate_heterogeneous_polar_theta_container_v} *)

(** {6 Documenting_for_container} *)

let documentation () = 
  [
   "Current : FELE:Elementary_border_coordinate_heterogeneous_polar_theta_container_v";
...
let string_off con_ept =
  Uno_v.name 
    Elementary_fence_units_actual_angle_tag_v.string_off
    con_ept
;;

let longname con_ept =
  Uno_v.name 
    Elementary_fence_units_actual_angle_tag_v.longname
    con_ept
;;

let fullname con_ept =
  Uno_v.name 
    Elementary_fence_units_actual_angle_tag_v.fullname
    con_ept
;;

(** {6 Coercing Up Elementary_border_coordinate_heterogeneous_polar_theta Tag} *)

let coerce_up_tag tag_ept =
  Tag_v.map_entity 
    Elementary_symbol_v.elementary_symbol_of_elementary_border_coordinate_heterogeneous_polar_theta_symbol 
    tag_ept
;;
...
let building_of_tag tag_ept =
  builder_tag_uno tag_ept
;;

(** {6 Builder Tag tuple} *)

let builder_tag_tuple tag_ept =
  let tag_bui_u = builder_tag_uno tag_ept in
...
let container_of_tag tag_ept =
  let bug = building_of_tag tag_ept in
...
let containee_tag_uno tag_ept =
  container_of_tag tag_ept
;;

let containee_tag_tuple tag_ept =
  let tag_cne_u = containee_tag_uno tag_ept in
...
let fence_as_uno tag_ept =
  let fen_ept = fence_as_list tag_ept in
  Uno_v.uno_of_list fen_ept
;;
...
(* generated by ./do_container_as_uno_border_bud_1containee_v.sh elementary_border_coordinate_heterogeneous_polar_theta ept elementary_fence_units_actual_angle eaa *)
