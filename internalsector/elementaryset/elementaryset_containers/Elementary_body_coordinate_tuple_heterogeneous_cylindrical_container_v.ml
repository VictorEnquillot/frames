(** {3 Elementary_body_coordinate_tuple_heterogeneous_cylindrical_container_v} *)

(** {6 Documenting_for_container} *)

let documentation () = 
  [
   "Current : FELE:Elementary_body_coordinate_tuple_heterogeneous_cylindrical_container_v";
   "Needs : FELE:Elementary_border_coordinate_heterogeneous_cylindrical_rho_tag_v";
   "Needs : FELE:Elementary_border_coordinate_heterogeneous_cylindrical_phi_tag_v";
   "Needs : FELE:Elementary_border_coordinate_heterogeneous_cylindrical_zed_tag_v";
   "Needs : FELE:Elementary_border_coordinate_heterogeneous_cylindrical for son list predicate";
   ...
   "What-is-it : it is a Body Bud container of Border sub-Types and thus a Triplet of (Elementary_border_coordinate_heterogeneous_cylindrical_rho_tag, Elementary_border_coordinate_heterogeneous_cylindrical_phi_tag, Conee3_tag )";
 ]
;;
...
let string_off con_ehc =
  Triplet_v.name 
    Elementary_border_coordinate_heterogeneous_cylindrical_rho_tag_v.string_off
    Elementary_border_coordinate_heterogeneous_cylindrical_phi_tag_v.string_off
    Elementary_border_coordinate_heterogeneous_cylindrical_zed_tag_v.string_off
    con_ehc
;;

let longname con_ehc =
  Triplet_v.name 
    Elementary_border_coordinate_heterogeneous_cylindrical_rho_tag_v.longname
    Elementary_border_coordinate_heterogeneous_cylindrical_phi_tag_v.longname
    Elementary_border_coordinate_heterogeneous_cylindrical_zed_tag_v.longname
    con_ehc
;;

let fullname con_ehc =
  Triplet_v.name 
    Elementary_border_coordinate_heterogeneous_cylindrical_rho_tag_v.fullname
    Elementary_border_coordinate_heterogeneous_cylindrical_phi_tag_v.fullname
    Elementary_border_coordinate_heterogeneous_cylindrical_zed_tag_v.fullname
    con_ehc
;;
...
let coerce_up_tag tag_ehc =
  Tag_v.map_entity 
    Elementary_symbol_v.elementary_symbol_of_elementary_body_coordinate_tuple_heterogeneous_cylindrical_symbol 
    tag_ehc
;;
...
let builder_tag_of_containee_up_tag tag_cnu =
  Tag_v.map_entity 
    Elementary_symbol_v.elementary_symbol_of_elementary_border_coordinate_heterogeneous_cylindrical_symbol
    tag_cnu
;;
...
let containee_up_tag_off_builder_tag tag_bui =
  Tag_v.map_entity 
    Elementary_symbol_v.elementary_border_coordinate_heterogeneous_cylindrical_symbol_off_elementary_symbol
    tag_bui
;;
...
let first_containee_tag_off_containee_up_tag tag_cnu =
  ...
  | Elementary_border_coordinate_heterogeneous_cylindrical_symbol_t.Elementary_border_coordinate_heterogeneous_cylindrical_rho_symbol sym_ecr ->
      Tag_v.make sym_ecr soi_cnu
	
  | _ -> 
      failwith "Not_a_Elementary_border_coordinate_heterogeneous_cylindrical_rho_symbol:Elementary_border_coordinate_heterogeneous_cylindrical_container_v.first_containee_tag_off_containee_up_tag"
;;
...
let second_containee_tag_off_containee_up_tag tag_cnu =
  ...
  | Elementary_border_coordinate_heterogeneous_cylindrical_symbol_t.Elementary_border_coordinate_heterogeneous_cylindrical_phi_symbol sym_ecp ->
      Tag_v.make sym_ecp soi_cnu
	
  | _ -> 
      failwith "Not_a_Elementary_border_coordinate_heterogeneous_cylindrical_phi_symbol:Elementary_border_coordinate_heterogeneous_cylindrical_container_v.seond_containee_tag_off_containee_up_tag"
;;
...
let third_containee_tag_off_containee_up_tag tag_cnu =
  ...
  | _ -> 
      failwith "Not_a_Elementary_border_coordinate_heterogeneous_cylindrical_zed_symbol:Elementary_border_coordinate_heterogeneous_cylindrical_container_v.third_containee_tag_off_containee_up_tag"
;;
...
(* generated by ./do_container_as_triplet_body_bud_3containee_v.sh elementary_body_coordinate_tuple_heterogeneous_cylindrical ehc elementary_border_coordinate_heterogeneous_cylindrical_rho ecr elementary_border_coordinate_heterogeneous_cylindrical_phi ecp elementary_border_coordinate_heterogeneous_cylindrical_zed ecz *)
