(** {3 Elementary_body_coordinate_tuple_homogeneous_planar_container_v} *)

(** {6 Documenting_for_container} *)

let documentation () = 
  [
   "Current : FELE:Elementary_body_coordinate_tuple_homogeneous_planar_container_v";
   "Needs : FELE:Elementary_border_coordinate_homogeneous_planar_x_tag_v";
   "Needs : FELE:Elementary_border_coordinate_homogeneous_planar_y_tag_v";
   "Needs : FELE:Elementary_border_coordinate_homogeneous_planar for son list predicate";
   ...
   "What-is-it : it is a Body Bud container of Border sub-Types and thus a Doublet of (Elementary_border_coordinate_homogeneous_planar_x_tag, Elementary_border_coordinate_homogeneous_planar_y_tag)";
 ]
;;
...
let string_off con_ehp =
  Doublet_v.name 
    Elementary_border_coordinate_homogeneous_planar_x_tag_v.string_off
    Elementary_border_coordinate_homogeneous_planar_y_tag_v.string_off
    con_ehp
;;

let longname con_ehp =
  Doublet_v.name 
    Elementary_border_coordinate_homogeneous_planar_x_tag_v.longname
    Elementary_border_coordinate_homogeneous_planar_y_tag_v.longname
    con_ehp
;;

let fullname con_ehp =
  Doublet_v.name 
    Elementary_border_coordinate_homogeneous_planar_x_tag_v.fullname
    Elementary_border_coordinate_homogeneous_planar_y_tag_v.fullname
    con_ehp
;;
...
let coerce_up_tag tag_ehp =
  Tag_v.map_entity 
    Elementary_symbol_v.elementary_symbol_of_elementary_body_coordinate_tuple_homogeneous_planar_symbol 
    tag_ehp
;;
...
let containee_up_tag_off_builder_tag tag_bui =
  Tag_v.map_entity 
    Elementary_symbol_v.elementary_border_coordinate_homogeneous_planar_symbol_off_elementary_symbol
    tag_bui
;;
...
let first_containee_tag_off_containee_up_tag tag_cnu =
  ...
  | Elementary_border_coordinate_homogeneous_planar_symbol_t.Elementary_border_coordinate_homogeneous_planar_x_symbol sym_epx ->
      Tag_v.make sym_epx soi_cnu
	
  | _ -> 
      failwith "Not_a_Elementary_border_coordinate_homogeneous_planar_x_symbol:Elementary_border_coordinate_homogeneous_planar_container_v.first_containee_tag_off_containee_up_tag"
;;
...
let second_containee_tag_off_containee_up_tag tag_cnu =
  ...
  | Elementary_border_coordinate_homogeneous_planar_symbol_t.Elementary_border_coordinate_homogeneous_planar_y_symbol sym_epy ->
      Tag_v.make sym_epy soi_cnu
	
  | _ -> 
      failwith "Not_a_Elementary_border_coordinate_homogeneous_planar_y_symbol:Elementary_border_coordinate_homogeneous_planar_container_v.seond_containee_tag_off_containee_up_tag"
;;
...
(* generated by ./do_container_as_doublet_body_bud_2containee_v.sh elementary_body_coordinate_tuple_homogeneous_planar ehp elementary_border_coordinate_homogeneous_planar_x epx elementary_border_coordinate_homogeneous_planar_y epy elementary_border_coordinate_homogeneous_planar *)
