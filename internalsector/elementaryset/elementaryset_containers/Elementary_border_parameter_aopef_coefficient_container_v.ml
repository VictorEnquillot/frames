(** {3 Elementary_border_parameter_aopef_coefficient_container_v} *)

(** {6 Documenting_for_container} *)

let documentation () = 
  [
   "Current : FELE:Elementary_border_parameter_aopef_coefficient_container_v";
...
let coerce_up_tag tag_eac =
  Tag_v.map_entity 
    Elementary_symbol_v.elementary_symbol_of_elementary_border_parameter_aopef_coefficient_symbol 
    tag_eac
;;
...
let builder_tag_uno tag_eac =
  let tag_bui_l = builder_tag_list tag_eac in
...
let building_of_tag tag_eac =
  builder_tag_uno tag_eac
;;

(** {6 Builder Tag tuple} *)

let builder_tag_tuple tag_eac =
  let tag_bui_u = builder_tag_uno tag_eac in
...
let containee_tag_uno tag_eac =
  container_of_tag tag_eac
;;

let containee_tag_tuple tag_eac =
  let tag_cne_u = containee_tag_uno tag_eac in
...
let fence_as_uno tag_eac =
  let fen_eac = fence_as_list tag_eac in
  Uno_v.uno_of_list fen_eac
;;
...
(* generated by ./do_container_as_uno_border_bud_1containee_v.sh elementary_border_parameter_aopef_coefficient eac elementary_fence_units_actual_length eal *)
