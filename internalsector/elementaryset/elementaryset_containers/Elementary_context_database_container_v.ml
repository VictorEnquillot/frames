(** {3 Elementary_context_database_container_v} *)

(** {6 Documenting_for_container} *)

let documentation () = 
  [
   "Current : FELE:Elementary_context_database_container_v";
   ...
   "What-is-it : it is a Bud container of Context sub-Types and thus a List of its Elementary_context_databox Tag";
 ]
;;
...
let name con_ecd =
  List_v.name 
    Elementary_context_databox_tag_v.name
    con_ecd
;;
...
let longname con_ecd =
  List_v.name 
    Elementary_context_databox_tag_v.longname
    con_ecd
;;
...
(* generated by ./do_container_as_list_context_bud_1containee_v.sh elementary_context_database ecd elementary_context_databox *)
