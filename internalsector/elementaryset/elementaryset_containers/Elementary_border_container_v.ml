(** {3 Elementary_border_container_v} *)

(** {6 Documenting_for_container} *)

let documentation () = 
  [
   "Current : FELE:Elementary_border_container_v";
...
let name = function
  | Elementary_border_container_t.Elementary_border_parameter_container con_ebp ->
      (Elementary_border_parameter_container_v.name con_ebp)
        
  | Elementary_border_container_t.Elementary_border_coordinate_container con_ebc ->
      (Elementary_border_coordinate_container_v.name con_ebc)
;;

let string_off = function
  | Elementary_border_container_t.Elementary_border_parameter_container con_ebp ->
      (Elementary_border_parameter_container_v.string_off con_ebp)
        
  | Elementary_border_container_t.Elementary_border_coordinate_container con_ebc ->
      (Elementary_border_coordinate_container_v.string_off con_ebc)
;;

let longname = function
  | Elementary_border_container_t.Elementary_border_parameter_container con_ebp ->
      (Elementary_border_parameter_container_v.longname con_ebp)
        
  | Elementary_border_container_t.Elementary_border_coordinate_container con_ebc ->
      (Elementary_border_coordinate_container_v.longname con_ebc)
;;

let fullname = function
  | Elementary_border_container_t.Elementary_border_parameter_container con_ebp ->
      (Elementary_border_parameter_container_v.fullname con_ebp)
        
  | Elementary_border_container_t.Elementary_border_coordinate_container con_ebc ->
      (Elementary_border_coordinate_container_v.fullname con_ebc)
;;
...
let coerce_up_tag tag_ebo =
  Tag_v.map_entity 
    Elementary_symbol_v.elementary_symbol_of_elementary_border_symbol 
    tag_ebo
;;
...
let builder_tag_tuple tag_ebo =
  let tag_bui_u = builder_tag_uno tag_ebo in
...
let building_of_tag tag_ebo =
  builder_tag_uno tag_ebo
;;

(** {6 Container_of_tag : Containee Datastructure} *)

let container_of_tag tag_ebo =
  let bug = building_of_tag tag_ebo in
...
let containee_tag_uno tag_ebo =
  container_of_tag tag_ebo
;;

(** {6 Containee Tag Tuple} *)

let containee_tag_tuple tag_ebo =
  let tag_cne_u = containee_tag_uno tag_ebo in
...
let fence_as_uno tag_ebo =
  let fen_ebo = fence_as_list tag_ebo in
  Uno_v.uno_of_list fen_ebo
;;
...
(* generated by ./do_container_as_uno_border_trunc_2sibling_1containee_v.sh elementary_border ebo elementary_border_parameter ebp elementary_border_coordinate ebc elementary_fence_units_actual_length eal   *)
