(** {3 Elementary_fence_units_actual_angle_container_v} *)

(** {6 Documenting_for_container} *)

let documentation () = 
  [
   "Current : FELE:Elementary_fence_units_actual_angle_container_v";
...
(* generated by ./do_container_as_uno_fence_branch_v.sh elementary_fence_units_actual_angle *)
