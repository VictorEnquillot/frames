(** {3 Elementary_border_coordinate_heterogeneous_cylindrical_container_v} *)

(** {6 Documenting_for_container} *)

let documentation () = 
  [
   "Current : FELE:Elementary_border_coordinate_heterogeneous_cylindrical_container_v";
...
let name = function
  | Elementary_border_coordinate_heterogeneous_cylindrical_container_t.Elementary_border_coordinate_heterogeneous_cylindrical_rho_container con_ecr ->
      (Elementary_border_coordinate_heterogeneous_cylindrical_rho_container_v.name con_ecr)
        
  | Elementary_border_coordinate_heterogeneous_cylindrical_container_t.Elementary_border_coordinate_heterogeneous_cylindrical_phi_container con_ecp ->
      (Elementary_border_coordinate_heterogeneous_cylindrical_phi_container_v.name con_ecp)

  | Elementary_border_coordinate_heterogeneous_cylindrical_container_t.Elementary_border_coordinate_heterogeneous_cylindrical_zed_container con_ecz ->
      (Elementary_border_coordinate_heterogeneous_cylindrical_zed_container_v.name con_ecz)
;;

let string_off = function
  | Elementary_border_coordinate_heterogeneous_cylindrical_container_t.Elementary_border_coordinate_heterogeneous_cylindrical_rho_container con_ecr ->
      (Elementary_border_coordinate_heterogeneous_cylindrical_rho_container_v.string_off con_ecr)
        
  | Elementary_border_coordinate_heterogeneous_cylindrical_container_t.Elementary_border_coordinate_heterogeneous_cylindrical_phi_container con_ecp ->
      (Elementary_border_coordinate_heterogeneous_cylindrical_phi_container_v.string_off con_ecp)

  | Elementary_border_coordinate_heterogeneous_cylindrical_container_t.Elementary_border_coordinate_heterogeneous_cylindrical_zed_container con_ecz ->
      (Elementary_border_coordinate_heterogeneous_cylindrical_zed_container_v.string_off con_ecz)
;;

let longname = function
  | Elementary_border_coordinate_heterogeneous_cylindrical_container_t.Elementary_border_coordinate_heterogeneous_cylindrical_rho_container con_ecr ->
      (Elementary_border_coordinate_heterogeneous_cylindrical_rho_container_v.longname con_ecr)
        
  | Elementary_border_coordinate_heterogeneous_cylindrical_container_t.Elementary_border_coordinate_heterogeneous_cylindrical_phi_container con_ecp ->
      (Elementary_border_coordinate_heterogeneous_cylindrical_phi_container_v.longname con_ecp)

  | Elementary_border_coordinate_heterogeneous_cylindrical_container_t.Elementary_border_coordinate_heterogeneous_cylindrical_zed_container con_ecz ->
      (Elementary_border_coordinate_heterogeneous_cylindrical_zed_container_v.longname con_ecz)
;;

let fullname = function
  | Elementary_border_coordinate_heterogeneous_cylindrical_container_t.Elementary_border_coordinate_heterogeneous_cylindrical_rho_container con_ecr ->
      (Elementary_border_coordinate_heterogeneous_cylindrical_rho_container_v.fullname con_ecr)
        
  | Elementary_border_coordinate_heterogeneous_cylindrical_container_t.Elementary_border_coordinate_heterogeneous_cylindrical_phi_container con_ecp ->
      (Elementary_border_coordinate_heterogeneous_cylindrical_phi_container_v.fullname con_ecp)

  | Elementary_border_coordinate_heterogeneous_cylindrical_container_t.Elementary_border_coordinate_heterogeneous_cylindrical_zed_container con_ecz ->
      (Elementary_border_coordinate_heterogeneous_cylindrical_zed_container_v.fullname con_ecz)
;;
...
(* generated by ./do_container_as_uno_border_trunc_3sibling_2containee_v.sh elementary_border_coordinate_heterogeneous_cylindrical ehc elementary_border_coordinate_heterogeneous_cylindrical_rho ecr elementary_border_coordinate_heterogeneous_cylindrical_phi ecp elementary_border_coordinate_heterogeneous_cylindrical_zed ecz elementary_fence_units_actual_length eal elementary_fence_units_actual_angle eaa *)
(* using ./template_container_as_uno_border_trunc_3sibling_2containee_v.ml *)
(* Done on mercredi 11 mai 2016, 10:51:51 (UTC+0200) *)
