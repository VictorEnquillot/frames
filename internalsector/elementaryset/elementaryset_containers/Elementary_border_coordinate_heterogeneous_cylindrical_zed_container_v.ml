(** {3 Elementary_border_coordinate_heterogeneous_cylindrical_zed_container_v} *)

(** {6 Documenting_for_container} *)

let documentation () = 
  [
   "Current : FELE:Elementary_border_coordinate_heterogeneous_cylindrical_zed_container_v";
...
(** {6 Coercing Up Elementary_border_coordinate_heterogeneous_cylindrical_zed Tag} *)

let coerce_up_tag tag_ecz =
  Tag_v.map_entity 
    Elementary_symbol_v.elementary_symbol_of_elementary_border_coordinate_heterogeneous_cylindrical_zed_symbol 
    tag_ecz
;;
...
(* generated by ./do_container_as_uno_border_bud_1containee_v.sh elementary_border_coordinate_heterogeneous_cylindrical_zed ecz elementary_fence_units_actual_length eal *)
