(** {3 Elementary_context_databox_figuredata_container_v} *)

(** {6 Documenting_for_container} *)

let documentation () = 
  [
   "Current : FELE:Elementary_context_databox_figuredata_container_v";
   ...
   "What-is-it : it is a Bud container of Context sub-Types and thus a List of its Elementary_body_coordinate_tuple Tag";
 ]
;;
...
let name con_edf =
  List_v.name 
    Elementary_body_coordinate_tuple_tag_v.name
    con_edf
;;

let string_off con_edf =
  List_v.name 
    Elementary_body_coordinate_tuple_tag_v.string_off
    con_edf
;;

let longname con_edf =
  List_v.name 
    Elementary_body_coordinate_tuple_tag_v.longname
    con_edf
;;

let fullname con_edf =
  List_v.name 
    Elementary_body_coordinate_tuple_tag_v.fullname
    con_edf
;;
...
(* generated by ./do_container_as_list_context_bud_1containee_v.sh elementary_context_databox_figuredata edf elementary_body_coordinate_tuple *)
