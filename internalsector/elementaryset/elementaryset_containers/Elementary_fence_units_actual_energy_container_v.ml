(** {3 Elementary_fence_units_actual_energy_container_v} *)

(** {6 Documenting_for_container} *)

let documentation () = 
  [
   "Current : FELE:Elementary_fence_units_actual_energy_container_v";
   "Needs : FELE:Elementary_fence_units_actual_energy_tag_v";
...
let name con_eae =
  Uno_v.name 
    Elementary_fence_units_actual_energy_tag_v.name
    con_eae
;;

let string_off con_eae =
  Uno_v.name 
    Elementary_fence_units_actual_energy_tag_v.string_off
    con_eae
;;

let longname con_eae =
  Uno_v.name 
    Elementary_fence_units_actual_energy_tag_v.longname
    con_eae
;;

let fullname con_eae =
  Uno_v.name 
    Elementary_fence_units_actual_energy_tag_v.fullname
    con_eae
;;
...
let coerce_up_tag tag_eae =
  Tag_v.map_entity 
    Elementary_symbol_v.elementary_symbol_of_elementary_fence_units_actual_energy_symbol 
    tag_eae
;;

(** {6 Coercing Up Containee} *)

let builder_tag_of_containee_tag tag_eae =
  Tag_v.map_entity 
    Elementary_symbol_v.elementary_symbol_of_elementary_fence_units_actual_energy_symbol 
    tag_eae
;;
...
let containee_tag_off_builder_tag tag_ele =
  Tag_v.map_entity
    Elementary_symbol_v.elementary_fence_units_actual_energy_symbol_off_elementary_symbol
    tag_ele
;;
...
let building_of_tag tag_eae =
  let tag_ele = builder_tag_of_containee_tag tag_eae in
  Uno_v.make tag_ele
;;

let builder_tag_uno tag_eae =
  building_of_tag tag_eae
;;
...
let fence_as_list tag_eae =
  builder_tag_list tag_eae
;;

let fence_as_tuple tag_eae =
  builder_tag_tuple tag_eae 
;;
...
(* generated by ./do_container_as_uno_fence_branch_v.sh elementary_fence_units_actual_energy *)
