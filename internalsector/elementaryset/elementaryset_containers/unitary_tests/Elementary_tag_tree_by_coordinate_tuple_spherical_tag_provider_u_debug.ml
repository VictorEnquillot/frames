...
(* toplevel 
   #use "Elementary_tag_tree_by_coordinate_tuple_spherical_tag_provider_u_debug.ml";;
...
let sym_cts = Elementary_symbol_v.elementary_symbol_of_elementary_coordinate_tuple_spherical_symbol sym_cts;;

Elementary_symbol_by_sole_index_register_v.store soi_cts sym_cts;
Elementary_symbol_by_sole_index_register_v.dump ();;

let tag_cts = Elementary_any_category_by_sole_index_extractor_v.elementary_coordinate_tuple_spherical_tag_off_sole_index soi_cts;;

test_number 2 (
tag_cts
(* :  Elementary_coordinate_tuple_spherical_symbol_t.coordinate_tuple_spherical_symbol
  Tag_t.tag *)
=
