...
(* toplevel 
   #use "Elementary_fence_units_container_u_test_ao_debug.ml";;
...
let tag_efu = Tag_v.map_entity Elementary_symbol_v.elementary_fence_units_symbol_off_elementary_symbol tag_ele_ful;;

test_number 2 (  
(tag_efu :
  Elementary_fence_units_symbol_t.elementary_fence_units_symbol
  Tag_t.tag ) =
  (Elementary_fence_units_symbol_t.Elementary_fence_units_length_symbol
    Elementary_fence_units_length_symbol_t.Bohr,
   [1; 1; 5; 6; 5; 6])
