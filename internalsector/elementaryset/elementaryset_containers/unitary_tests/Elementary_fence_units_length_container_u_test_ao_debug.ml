...
testing "Elementary_fence_units_length_container_v with
...
(* toplevel 
   #use "Elementary_fence_units_length_container_u_test_ao_debug.ml";;
...
open Elementary_fence_units_length_container_v;; 
     
(* Argument *)

let tag_ful = Tag_v.map_entity Elementary_symbol_v.elementary_fence_units_length_symbol_off_elementary_symbol tag_ele_ful;;
...
let con_ful = container_of_tag tag_ful;;
