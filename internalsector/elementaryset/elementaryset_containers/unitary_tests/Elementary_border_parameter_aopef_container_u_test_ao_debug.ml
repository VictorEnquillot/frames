...
testing "Elementary_border_parameter_aopef_container_v with
...
(* toplevel 
   #use "Elementary_border_parameter_aopef_container_u_test_ao_debug.ml";;
...
open Elementary_border_parameter_aopef_container_v;; 
...
test_number 3 (
tag_ele_eac = coerce_up_tag tag_epa
);;

(** {6 Builder Tag list} *)

let tag_bui_l = builder_tag_list tag_epa;;
...
let tag_bui = builder_tag_uno tag_epa;;
...
test_number 6 (
(bug_epa : Elementary_symbol_t.elementary_symbol Tag_t.tag Uno_t.uno ) =
(Elementary_symbol_t.Elementary_fence_symbol
   (Elementary_fence_symbol_t.Elementary_fence_units_symbol
      (Elementary_fence_units_symbol_t.Elementary_fence_units_length_symbol
         Elementary_fence_units_length_symbol_t.Bohr)),
...
let tag_bui_t = builder_tag_tuple tag_epa;;
...
test_number 11 (
bug_epa = builder_tag_uno tag_epa
);;

(** {6 Containee Tag Datastructures} *)

test_number 12 (
tag_ful = containee_tag_uno tag_epa
);;

let tag_ful_t = containee_tag_tuple tag_epa;;
...
let fen_epa_l = fence_as_list tag_epa;;

test_number 14 (
(fen_epa_l : Elementary_symbol_t.elementary_symbol Tag_t.tag list ) =
  [(Elementary_symbol_t.Elementary_fence_symbol
     (Elementary_fence_symbol_t.Elementary_fence_units_symbol
       (Elementary_fence_units_symbol_t.Elementary_fence_units_length_symbol
         Elementary_fence_units_length_symbol_t.Bohr)),
...
let fen_epa_u = fence_as_uno tag_epa;;

test_number 15 (
(fen_epa_u : Elementary_symbol_t.elementary_symbol Tag_t.tag Uno_t.uno ) =
  (Elementary_symbol_t.Elementary_fence_symbol
    (Elementary_fence_symbol_t.Elementary_fence_units_symbol
      (Elementary_fence_units_symbol_t.Elementary_fence_units_length_symbol
        Elementary_fence_units_length_symbol_t.Bohr)),
...
let fen_epa_t = fence_as_tuple tag_epa;;

test_number 16 (
( fen_epa_t : Elementary_symbol_t.elementary_symbol Tag_t.tag Tuple_t.tuple ) =
  Tuple_t.Uno
   (Elementary_symbol_t.Elementary_fence_symbol
     (Elementary_fence_symbol_t.Elementary_fence_units_symbol
       (Elementary_fence_units_symbol_t.Elementary_fence_units_length_symbol
...
let fen_epa_tl = fence_as_tuple_list tag_epa;;
