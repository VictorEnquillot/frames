...
testing "Elementary_coordinate_tuple_spherical_container_v with
...
(* toplevel 
   #use "Elementary_coordinate_tuple_spherical_container_u_debug.ml";;
...
(* Elementary_coordinate_tuple_spherical Tag *)
...
open Elementary_coordinate_tuple_spherical_container_v;;
...
let tag_ets = Tag_v.map_entity Elementary_symbol_v.elementary_coordinate_tuple_spherical_symbol_off_elementary_symbol tag_ele_cts;;

test_number 3 (
(tag_ets : Elementary_coordinate_tuple_spherical_symbol_t.elementary_coordinate_tuple_spherical_symbol Tag_t.tag ) =
(Elementary_coordinate_tuple_spherical_symbol_t.Elementary_coordinate_tuple_spherical_constructor
   "A_A",
 [12; 1; 4])
);;

let tag_ele_cts_st = Tree_v.subtree_of_node_predicate_off_tree (fun (s, i) -> Elementary_symbol_v.is_elementary_coordinate_tuple_spherical_symbol_off_elementary_symbol s) tag_ele_t;;
...
let con_cts = Elementary_coordinate_tuple_spherical_container_v.container_of_tag tag_ets;;
...
let tag_bui_l = Elementary_coordinate_tuple_spherical_container_v.builder_tag_list tag_ets;;
...
let tag_ets_theta = Elementary_coordinate_tuple_spherical_container_v.elementary_coordinate_spherical_theta_tag_off_elementary_coordinate_tuple_spherical_container con_cts;;

test_number 7 (
tag_ets_theta 

(* : Elementary_coordinate_spherical_symbol_t.coordinate_spherical_symbol Tag_t.tag *)
=
  (Elementary_coordinate_spherical_symbol_t.Spherical_theta "spherical_theta", [3; 12; 1; 4])
);;

let tag_ets_theta =Elementary_coordinate_tuple_spherical_container_v.elementary_coordinate_spherical_theta_tag_off_elementary_coordinate_tuple_spherical_tag tag_ets;;
...
let fen_l = fence_list tag_ets;;

test_number 9 (
(fen_l : Elementary_coordinate_symbol_t.elementary_coordinate_symbol Tag_t.tag list ) =
  [(Elementary_coordinate_symbol_t.Elementary_coordinate_heterogeneous_symbol
     (Elementary_coordinate_heterogeneous_symbol_t.Elementary_coordinate_spherical_symbol
       (Elementary_coordinate_spherical_symbol_t.Spherical_rho
         "spherical_rho")),
...
let dfe_l = deepfence_list tag_ets;;
...
let dfe_t = deepfence_tuple tag_ets;;
