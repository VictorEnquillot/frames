...
testing "Elementary_coordinate_heterogeneous_container_v with
...
(* toplevel 
   #use "Elementary_coordinate_heterogeneous_container_u_debug.ml";;
...
(* Elementary_coordinate_heterogeneous Tag *)
...
let tag_ele_ccs_l = List.filter (fun (s, i) -> Elementary_symbol_v.is_elementary_coordinate_spherical_symbol_off_elementary_symbol s) tag_ele_l;;

test_number 2 (
( tag_ele_ccs_l : Elementary_symbol_t.elementary_symbol Tag_t.tag list ) =
...
(* Only Phi of Db1 in Vertex A *)

let tag_ele_phi = List_v.only_element_of_predicate_off_list (fun (s, i) -> Elementary_symbol_v.is_spherical_phi s) tag_ele_l;;
...
let tag_ecs = Tag_v.map_entity Elementary_symbol_v.elementary_coordinate_spherical_symbol_off_elementary_symbol tag_ele_phi;;

test_number 4 (
( tag_ecs : Elementary_coordinate_spherical_symbol_t.elementary_coordinate_spherical_symbol Tag_t.tag ) =
  (Elementary_coordinate_spherical_symbol_t.Spherical_phi "spherical_phi",
   [2; 12; 1; 4])
);;

let tag_ele_phi_st = Tree_v.subtree_of_node_off_tree tag_ele_phi tag_ele_t;;
    
test_number 5 (
(tag_ele_phi_st : Elementary_symbol_t.elementary_symbol Tag_t.tag Tree_t.tree ) =
  Tree_t.Inner
   ((Elementary_symbol_t.Elementary_body_symbol
      (Elementary_body_symbol_t.Elementary_coordinate_symbol
        (Elementary_coordinate_symbol_t.Elementary_coordinate_heterogeneous_symbol
...
let con_cts = Elementary_coordinate_spherical_container_v.container_of_tag tag_ecs;;
