...
testing "Elementary_coordinate_tuple_homogeneous_container_v with
...
(* toplevel 
   #use "Elementary_coordinate_tuple_homogeneous_container_u_debug.ml";;
...
test_number 7 (
( con_ctc :
  Elementary_coordinate_cartesian_symbol_t.elementary_coordinate_cartesian_symbol
