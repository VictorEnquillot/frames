...
(** {3 The functionalities for a Symbol for a File_id3v1.} *)

let nam_cod = "file_id3v1_symbol_v.ml";;
...
(** created by ./generator file_id3v1 implementation symbol at 17:43 6 Jun 2012. *)
