...
ocamlopt \
-o logicset_generate_symbols_${file}.bin  \
unix.cmxa str.cmxa \
...
Do_logicset_symbols_${file}.cmx

echo "logicset_generate_symbols_${file}.bin done"

ls -alt logicset_generate_symbols_${file}.bin