...
-c Do_logicset_symbols_${file}.ml

ocamlc -warn-error A -g \
-o logicset_generate_symbols_${file}.byt  \
Do_logicset_symbols_${file}.cmo

echo "logicset_generate_symbols_${file}.byt done"

ls -alt logicset_generate_symbols_${file}.byt