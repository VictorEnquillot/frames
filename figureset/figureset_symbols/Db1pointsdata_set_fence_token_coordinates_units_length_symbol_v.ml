...
let longname sym_dul =
  Format.sprintf "Db1pointsdata_set_fence_token_coordinates_units_length_symbol_t.%s" (String.capitalize_ascii (name sym_dul))
;;
...
(** Db1pointsdata_set_fence_token_coordinates_units_length_symbol_v at 15:7:20 on 31 Oct 2018. created by version v2.5 of generator *)
