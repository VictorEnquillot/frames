...
let longname sym_dbc =
  Format.sprintf "Db1pointsdata_set_body_cluster_symbol_t.%s" (String.capitalize_ascii (name sym_dbc))
;;
...
(** Db1pointsdata_set_body_cluster_symbol_v at 15:7:18 on 31 Oct 2018. created by version v2.5 of generator *)
