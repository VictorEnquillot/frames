...
let longname sym_dfb =
  Format.sprintf "Db1pointsdata_set_fence_basic_symbol_t.%s" (String.capitalize_ascii (name sym_dfb))
;;
...
(** Db1pointsdata_set_fence_basic_symbol_v at 15:7:19 on 31 Oct 2018. created by version v2.5 of generator *)
