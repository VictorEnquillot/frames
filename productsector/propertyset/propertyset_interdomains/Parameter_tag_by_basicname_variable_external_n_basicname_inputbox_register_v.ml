(** {3 Parameter_tag_by_basicname_variable_external_n_basicname_inputbox_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : DELE:Parameter_tag_by_basicname_variable_external_n_basicname_inputbox_register_v";
 ]
;;
