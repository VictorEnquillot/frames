(** {3 Skeleton_tag_by_basicname_variable_external_n_basicname_inputbox_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : VPRO:Skeleton_tag_by_basicname_variable_external_n_basicname_inputbox_register_v";
 ]
;;
...
(* done with do_register.sh on jeudi 9 juin 2016, 15:30:05 (UTC+0200) *)
