...
testing "Skeleton_tag_by_basicname_variable_external_n_basicname_inputbox_provider_v with
    Skeleton_tag_by_basicname_variable_external_n_basicname_inputbox_provider_u_skeleton_fence_centered_aopef_hes11_copy.ml";;
...
(* toplevel 
   #use "Skeleton_tag_by_basicname_variable_external_n_basicname_inputbox_provider_u_skeleton_fence_centered_aopef_hes11_copy.ml";; 

*)

(* Input File *)

let nam_ibo = "Print_copy_aopef_hes11";;
