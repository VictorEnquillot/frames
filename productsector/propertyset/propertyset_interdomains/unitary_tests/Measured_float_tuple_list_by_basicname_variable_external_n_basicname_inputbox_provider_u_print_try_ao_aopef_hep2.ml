...
testing "Measured_float_tuple_list_by_basicname_variable_external_n_basicname_inputbox_provider_v with
        Measured_float_tuple_list_by_basicname_variable_external_n_basicname_inputbox_provider_u_print_try_ao_aopef_hep21.ml";;
...
(* toplevel 
   #use "Measured_float_tuple_list_by_basicname_variable_external_n_basicname_inputbox_provider_u_print_try_ao_aopef_hep21.ml";;

*)

open Measured_float_tuple_list_by_basicname_variable_external_n_basicname_inputbox_provider_v;;

let nam_ibo = "Print_try_ao_aopef_hep21";;
let bna_ibo = Basicname_v.basicname_inputbox_of_string nam_ibo;;

test_number 1 (
(bna_ibo : Basicname_t.basicname ) =
Basicname_t.Inputbox "Print_try_ao_aopef_hep21"
);;
