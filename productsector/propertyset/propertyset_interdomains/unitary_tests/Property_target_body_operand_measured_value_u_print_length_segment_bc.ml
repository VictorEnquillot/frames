...
testing "Property_target_body_operand_value_value_v with
        Property_target_body_operand_value_value_u_print_length_segment_bc.ml";;
...
(* toplevel 
   #use "Property_target_body_operand_value_value_u_print_length_segment_bc.ml";; 
...
let pre_tag_ptm_sof sof (s, i) = (Property_symbol_v.property_target_body_measured_constructor sof = s);;
