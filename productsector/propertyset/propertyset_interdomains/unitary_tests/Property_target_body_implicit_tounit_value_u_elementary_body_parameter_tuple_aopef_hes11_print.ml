...
(* toplevel 
   #use "Property_target_body_implicit_tounit_value_u_elementary_body_parameter_tuple_aopef_hes11_print.ml";; 
   ...
   (Property_symbol_t.Property_context_symbol
     (Property_context_symbol_t.Property_context_inputfile_symbol
       (Property_context_inputfile_symbol_t.Property_context_inputfile_constructor
         "/home/colonna/sources/ocaml_top/setup/frames/inputset/files/Elementary_body_parameter_tuple_aopef_hes11_print.inp")),
    [24; 20]);
...
let tag_edb =
  Elementary_context_databox_skeletondata_tag_by_database_name_n_basisset_name_provider_v.provide
    (nam_dba, nam_dbo)
;;
...
let tag_eta_opd =
	Elementary_body_parameter_tuple_aopef_tag_v.elementary_body_parameter_tuple_aopef_tag_off_elementary_tag
	  tag_ele_opd;;
...
let env = Elementary_body_parameter_tuple_aopef_envelope_v.envelope_of_tag tag_eta_opd;;

test_number 15 (
(env :
  (Measure_length_t.measure_length Uno_t.uno Uno_t.uno,
   Measure_length_t.measure_length Uno_t.uno Uno_t.uno)
  Doublet_t.doublet ) =
