...
test_number 8 (
(mak_arg : string ) = 
"elementary_skeleton_fence_centered_aopef_constructor"
);;
...
( sym_ele_opd : Elementary_symbol_t.elementary_symbol ) =
  Elementary_symbol_t.Elementary_body_symbol
   (Elementary_body_symbol_t.Elementary_skeleton_fence_centered_symbol
     (Elementary_skeleton_fence_centered_symbol_t.Elementary_skeleton_fence_centered_aopef_symbol
       (Elementary_skeleton_fence_centered_aopef_symbol_t.Elementary_skeleton_fence_centered_aopef_constructor
         "he s 1 1")))
);;
