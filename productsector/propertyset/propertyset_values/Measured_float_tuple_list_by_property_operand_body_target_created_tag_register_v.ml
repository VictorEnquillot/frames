(** {3 Measured_float_tuple_list_by_property_operand_body_target_created_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
[
 "Current : BPRO:Measured_float_tuple_list_by_property_operand_body_target_created_tag_register_v";
 "Author : François Colonna 31 mai 2017 at 15:06:17+02:00";
...
let register : 
    (Property_operand_body_target_created_tag_t.property_operand_body_target_created_tag,
     Measured_float_tuple_t.measured_float_tuple list
    ) 
    Register_t.register = 
...
let name_of_key key =
  Property_operand_body_target_created_tag_v.fullname key
;;

let name_of_value val_ =
  List_v.name
    Measured_float_tuple_v.fullname
    val_
;;
