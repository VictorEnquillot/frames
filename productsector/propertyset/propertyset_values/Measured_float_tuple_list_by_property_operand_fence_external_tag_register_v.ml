(** {3 Measured_float_tuple_list_by_property_operand_fence_external_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
[
 "Current : BPRO:Measured_float_tuple_list_by_property_operand_fence_external_tag_register_v";
...
let register : 
    (Property_operand_fence_external_tag_t.property_operand_fence_external_tag,
...
let name_of_key key =
  Property_operand_fence_external_tag_v.fullname key
;;
