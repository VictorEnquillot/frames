...
testing "Measure_homogeneous_tuple_list_by_property_operand_body_target_created_tag_provider_v with
        Measure_homogeneous_tuple_list_by_property_operand_body_target_created_tag_provider_u_print_homothety_hom_b_2_translation_tra_s_triangle_w.ml";;
...
(* toplevel 
   #use "Measure_homogeneous_tuple_list_by_property_operand_body_target_created_tag_provider_u_print_homothety_hom_b_2_translation_tra_s_triangle_w.ml";; 
   ...
   (Property_symbol_t.Property_context_symbol
     (Property_context_symbol_t.Property_context_inputbox_symbol
       (Property_context_inputbox_symbol_t.Property_context_inputbox_constructor
         "Print_homothety_hom_b_2_translation_tra_s_triangle_w")),
    [41; 1; 17; 6]);
...
(* Path from External (Tri_w) up to Current (Tri_h) *)
...
(* Recursion on tag_ptc_l Step _1_ Tri_w -> Hom_b_2 -> Tri_h *)
...
(* Recursion on tag_ptc_l Step _2_ Tri_h -> Tra_s -> Tri_t *)
