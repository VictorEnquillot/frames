...
testing "Cofactor_entity_measured_float_tuple_list_by_property_operator_fence_creation_toentity_tag_provider_v
        Cofactor_entity_measured_float_tuple_list_by_property_operator_fence_creation_toentity_tag_provider_u_print_translation_tra_bc_point_a.ml"
...
(* toplevel 
   #use "Cofactor_entity_measured_float_tuple_list_by_property_operator_fence_creation_toentity_tag_provider_u_print_translation_tra_bc_point_a.ml";;
   
 *)

open Cofactor_entity_measured_float_tuple_list_by_property_operator_fence_creation_toentity_tag_provider_v;;
...
let tag_pct = List_v.only_element_of_predicate_off_list 
    (fun (s, i) -> (Property_symbol_v.property_operator_fence_creation_toentity_constructor nam_tar_opd = s) )
        tag_pro_l;;
