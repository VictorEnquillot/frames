(** {3 Property_symbol_by_sole_index_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BPRO:Property_symbol_by_sole_index_register_v";
 ]
;;

(** {6 Register.} *)

let nam_reg = "Property_symbol_by_sole_index_register_v";;
...
let name_of_value val_ =
  Property_symbol_v.fullname val_
;;
...
(* done with do_dddd_symbol_by_sole_index_register.sh force on mardi 15 novembre 2016, 16:37:17 (UTC+0100) *)
