...
testing "Property_tag_subtree_by_basicname_inputbox_n_basicname_inputbase_provider_v with
        Property_tag_subtree_by_basicname_inputbox_n_basicname_inputbase_provider_u_any.ml";;
...
(* toplevel 
   #use "Property_tag_subtree_by_basicname_inputbox_n_basicname_inputbase_provider_u_any.ml";; 

*)

open Property_tag_subtree_by_basicname_inputbox_n_basicname_inputbase_provider_v;;
...
let tag_pro_qua = (tag_pro_ibo, tag_pro_iba, tag_pro_pcd, tag_pro_pcs) ;;
...
(soi_pro_ibo_st : Sole_index_t.sole_index Tree_t.tree ) =
  Tree_t.Inner ([38; 1; 18; 6],
   [Tree_t.Inner ([1; 38; 1; 18; 6],
     [Tree_t.Leaf [1; 1; 38; 1; 18; 6];
      Tree_t.Inner ([2; 1; 38; 1; 18; 6],
       [Tree_t.Leaf [1; 2; 1; 38; 1; 18; 6];
        Tree_t.Leaf [2; 2; 1; 38; 1; 18; 6]])])])
);;
...
let tag_pro_st = Tree_v.make_of_node tag_pro_pcs [tag_pro_pcd_st]

test_number 4 (
tag_pro_st = provide (nam_ibo, nam_iba)
);;
