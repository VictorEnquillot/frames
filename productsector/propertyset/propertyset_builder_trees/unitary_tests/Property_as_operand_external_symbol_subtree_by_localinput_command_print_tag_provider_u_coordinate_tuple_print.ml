...
testing "Property_as_operand_external_symbol_subtree_by_localinput_command_print_tag_provider_v with
...
(* toplevel 
   #use "Property_as_operand_external_symbol_subtree_by_localinput_command_print_tag_provider_u_coordinate_tuple_print.ml";; 
     ...
     [Tree_t.Inner
      ...
      Tree_t.Leaf
       (Property_symbol_t.Property_set_body_operand_symbol
         (Property_set_body_operand_symbol_t.Property_set_body_operand_elementary_symbol
           "elementary_coordinate_tuple_cartesian_constructor T_A"))])])
);;
