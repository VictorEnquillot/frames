...
testing "Property_context_inputbox_name_by_any_sole_index_provider_v with
    Property_context_inputbox_name_by_any_sole_index_provider_u_any.ml";;
...
(* toplevel 
   #use "Property_context_inputbox_name_by_any_sole_index_provider_u_any.ml";; 

*)

open Property_context_inputbox_name_by_any_sole_index_provider_v;;
...
let soi_ibo = Property_context_inputbox_sole_index_by_any_sole_index_provider_v.provide soi_any;;
...
test_number 4 (
nam_ibo = Inputbox_name_by_ordinal_provider_v.provide ord_ibo
);;
