...
Trace_what_by_module_name_register_v.store "Property_symbol_subtree_by_localinput_set_fence_variable_name_entity_tag_provider_v" "debug";;
...
(* toplevel 
   #use "Property_symbol_subtree_by_localinput_set_fence_variable_name_entity_tag_provider_u_print_length_segment_bc.ml";; 
...
let tag_loi_len_bc_l = List.filter
    (fun (s, i) -> 
      (Localinput_symbol_v.is_localinput_set_fence_variable_name_entity_symbol_off_localinput_symbol s)
	&& (Localinput_symbol_v.string_off s = "Len_bc")
    )
    tag_loi_l
;;

test_number 1 (
(tag_loi_len_bc_l : Localinput_symbol_t.localinput_symbol Tag_t.tag list ) =
...
test_raises_some_exc Localinput_set_fence_variable_name_entity_tag_by_basicname_inputbox_n_localinput_set_body_handle_command_creation_define_symbol_provider_v.provide (bna_ibo, sym_lcd);;
