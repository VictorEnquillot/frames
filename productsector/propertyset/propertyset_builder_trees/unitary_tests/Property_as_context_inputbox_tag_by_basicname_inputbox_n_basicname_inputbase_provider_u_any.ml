...
testing "Property_as_context_inputbox_tag_by_basicname_inputbox_n_basicname_inputbase_provider_v with
...
(* toplevel 
   #use "Property_as_context_inputbox_tag_by_basicname_inputbox_n_basicname_inputbase_provider_u_any.ml";; 

*)

open Property_as_context_inputbox_tag_by_basicname_inputbox_n_basicname_inputbase_provider_v;;
...
let sym_pro_ibo = 
    Property_symbol_v.property_context_inputbox_constructor 
      nam_ibo;;

test_number 2 (
(sym_pro_ibo : Property_symbol_t.property_symbol ) =
...
let tag_pro_ibo = Tag_v.make sym_pro_ibo soi_ibo;;

test_number 3 (
(tag_pro_ibo :
  Property_symbol_t.property_symbol
  Tag_t.tag ) =
(Property_symbol_t.Property_context_symbol
   (Property_context_symbol_t.Property_context_inputbox_symbol
      (Property_context_inputbox_symbol_t.Property_context_inputbox_constructor
...
test_number 4 (
tag_pro_ibo = provide (nam_ibo, nam_iba)
);;
