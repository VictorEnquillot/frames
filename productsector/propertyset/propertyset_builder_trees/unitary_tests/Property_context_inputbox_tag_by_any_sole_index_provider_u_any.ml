...
testing "Property_context_inputbox_tag_by_any_sole_index_provider_v with
...
(* toplevel 
   #use "Property_context_inputbox_tag_by_any_sole_index_provider_u_any.ml";; 

*)

open Property_context_inputbox_tag_by_any_sole_index_provider_v;;
...
let sym_ibo = Property_context_inputbox_symbol_by_any_sole_index_provider_v.provide soi_any ;;

test_number 3 (
(sym_ibo : Property_context_inputbox_symbol_t.property_context_inputbox_symbol ) =
