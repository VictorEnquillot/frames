...
testing "Property_set_body_operand_target_symbol_by_localinput_set_fence_variable_name_entity_target_tag_provider_v with
    Property_set_body_operand_target_symbol_by_localinput_set_fence_variable_name_entity_target_tag_provider_u_any.ml";;
...
(* toplevel 
   #use "Property_set_body_operand_target_symbol_by_localinput_set_fence_variable_name_entity_target_tag_provider_u_any.ml";; 

*)

open Property_set_body_operand_target_symbol_by_localinput_set_fence_variable_name_entity_target_tag_provider_v;;
...
let sof_let = "Poi_h";;
let pre_tag_let_sof sof (s, i) = Localinput_set_fence_variable_name_entity_target_symbol_v.localinput_set_fence_variable_name_entity_target_constructor sof = s;;
...
let sym_pod = Property_set_body_operand_target_symbol_v.make str_arg sof_let;;

test_number 6 (
(sym_pod : Property_set_body_operand_target_symbol_t.property_set_body_operand_target_symbol ) =
