...
(* toplevel 
   #use "Property_symbol_leaf_by_localinput_set_fence_variable_name_operator_tag_provider_u_point_homothety_debug.ml";; 
...
(* Argument Target Implicit tag_vno *)

let sof_vno_hom_b_2 = "Hom_b_2";;
...
let tag_vno_hom_b_2 = List_v.only_element_of_predicate_off_list (pre_tag_vno_sof sof_vno_hom_b_2) tag_vno_l;;
...
let tag_vno = tag_vno_hom_b_2;;

(* Prerequisites *)

let soi_vno = Tag_v.sole_index_off_tag tag_vno;;

test_number 3 (
(soi_vno : Sole_index_t.sole_index ) = 
[1; 2; 5; 38; 11]
);;

test_number 4 (
nam_ibo = Localinput_any_category_by_sole_index_extractor_v.localinput_context_inputbox_string_off_off_sole_index soi_vno
);;
