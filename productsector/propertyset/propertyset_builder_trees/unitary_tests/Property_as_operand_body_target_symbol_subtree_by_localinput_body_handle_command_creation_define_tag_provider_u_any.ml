         ...
         (Localinput_symbol_t.Localinput_set_fence_symbol
           (Localinput_set_fence_symbol_t.Localinput_set_fence_keyword_symbol
             (Localinput_set_fence_keyword_symbol_t.Localinput_set_fence_keyword_variable_kind_symbol
               (Localinput_set_fence_keyword_variable_kind_symbol_t.Localinput_set_fence_keyword_variable_kind_target_symbol
                 (Localinput_set_fence_keyword_variable_kind_target_symbol_t.Localinput_set_fence_keyword_variable_kind_target_constructor
                   "Poi_h")))));
        Tree_t.Inner
         (Localinput_symbol_t.Localinput_body_symbol
           (Localinput_body_symbol_t.Localinput_body_block_symbol
      ...
      Tree_t.Inner
       ...
       [Tree_t.Leaf
         (Localinput_symbol_t.Localinput_set_fence_symbol
           (Localinput_set_fence_symbol_t.Localinput_set_fence_keyword_symbol
             (Localinput_set_fence_keyword_symbol_t.Localinput_set_fence_keyword_variable_kind_symbol
               (Localinput_set_fence_keyword_variable_kind_symbol_t.Localinput_set_fence_keyword_variable_kind_external_symbol
                 (Localinput_set_fence_keyword_variable_kind_external_symbol_t.Localinput_set_fence_keyword_variable_kind_external_constructor
                   "Poi_a")))));
        Tree_t.Inner
         (Localinput_symbol_t.Localinput_body_symbol
           (Localinput_body_symbol_t.Localinput_body_block_symbol
