(** {3 Property_son_tag_list_by_property_father_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
[
 "Current : BPRO:Property_son_tag_list_by_property_father_tag_register_v";
 "Needed-by: ";
]
;;
