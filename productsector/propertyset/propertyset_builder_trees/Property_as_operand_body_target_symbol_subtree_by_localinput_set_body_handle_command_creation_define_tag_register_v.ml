(** {3 Property_as_operand_body_target_symbol_subtree_by_localinput_set_body_handle_command_creation_define_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BPRO:Property_as_operand_body_target_symbol_subtree_by_localinput_set_body_handle_command_creation_define_tag_register_v";
   "Author : François Colonna 09 novembre 2016 at 15:30:00+01:00";
 ]
;;
...
let register : 
    (Localinput_set_body_handle_command_creation_define_tag_t.localinput_set_body_handle_command_creation_define_tag,
     Property_symbol_t.property_symbol Tree_t.tree
    ) 
    Register_t.register = 
...
let name_of_key key =
  Localinput_set_body_handle_command_creation_define_tag_v.name key
;;

let name_of_value val_ =
  Tree_v.name
    Property_symbol_v.name
    val_
;;
...
(* done with do_register.sh force on mardi 15 novembre 2016, 16:37:00 (UTC+0100) *)
