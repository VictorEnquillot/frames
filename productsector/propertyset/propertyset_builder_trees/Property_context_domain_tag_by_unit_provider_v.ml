(** {3 Property_context_domain_tag_by_unit_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BPRO:Property_context_domain_tag_by_unit_provider_v";
   ...
   "Author : François Colonna 03 avril 2017 at 10:24:52+02:00";
 ]
;;
...
(* done with do_provider_without_register.sh Property_context_domain_tag_by_unit_provider_v.ml force on mardi 15 novembre 2016, 16:37:11 (UTC+0100) *)
