(** {3 Property_tag_tree_by_property_context_inputbox_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BPRO:Property_tag_tree_by_property_context_inputbox_tag_register_v";
   "Author : François Colonna 05 octobre 2016 at 09:56:30+02:00";
]
;;
...
let register : 
    (
     ...
     Property_tag_t.property_tag Tree_t.tree 
    ) 
    Register_t.register = 
