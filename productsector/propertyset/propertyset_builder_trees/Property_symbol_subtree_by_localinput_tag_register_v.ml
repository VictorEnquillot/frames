(** {3 Property_symbol_subtree_by_localinput_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BPRO:Property_symbol_subtree_by_localinput_tag_register_v";
...
let register : 
    (Localinput_tag_t.localinput_tag,
