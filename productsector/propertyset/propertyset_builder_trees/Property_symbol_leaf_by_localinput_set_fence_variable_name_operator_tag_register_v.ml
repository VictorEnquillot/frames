(** {3 Property_symbol_leaf_by_localinput_set_fence_variable_name_operator_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BPRO:Property_symbol_leaf_by_localinput_set_fence_variable_name_operator_tag_register_v";
   "Needed-by: ";
 ]
;;
...
let register :
    (Localinput_set_fence_variable_name_operator_tag_t.localinput_set_fence_variable_name_operator_tag,
...
let name_of_key key =
  Localinput_set_fence_variable_name_operator_tag_v.fullname key
;;
