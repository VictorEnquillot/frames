(** {3 Property_symbol_subtree_by_localinput_set_fence_variable_name_entity_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BPRO:Property_symbol_subtree_by_localinput_set_fence_variable_name_entity_tag_register_v";
   "Needed-by: ";
   "Author : François Colonna 19 mai 2017 at 09:45:10+02:00";
...
let name_of_key key =
  Localinput_set_fence_variable_name_entity_tag_v.fullname key
;;

let name_of_value val_  =
  Tree_v.name Property_symbol_v.longname val_
;;
