(** {3 Property_tag_all_list_by_basicname_inputbox_n_basicname_inputbase_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BPRO:Property_tag_all_list_by_basicname_inputbox_n_basicname_inputbase_register_v";
   "Author : François Colonna 05 octobre 2016 at 10:03:00+02:00";
 ]
;;
