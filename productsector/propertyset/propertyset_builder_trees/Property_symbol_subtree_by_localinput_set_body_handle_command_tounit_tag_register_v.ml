(** {3 Property_symbol_subtree_by_localinput_set_body_handle_command_tounit_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BPRO:Property_symbol_subtree_by_localinput_set_body_handle_command_tounit_tag_register_v";
