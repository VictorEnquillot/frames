(** {3 Property_operator_fence_tounit_symbol_by_localinput_set_fence_variable_name_entity_implicit_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BPRO:Property_operator_fence_tounit_symbol_by_localinput_set_fence_variable_name_entity_implicit_tag_register_v";
...
let register : 
    (Localinput_set_fence_variable_name_entity_implicit_tag_t.localinput_set_fence_variable_name_entity_implicit_tag,
...
let name_of_key key =
  Localinput_set_fence_variable_name_entity_implicit_tag_v.name key
;;

let name_of_value val_ =
  Property_operator_fence_tounit_symbol_v.name
    val_
;;
...
(* done with do_register.sh force on mardi 15 novembre 2016, 16:37:01 (UTC+0100) *)
