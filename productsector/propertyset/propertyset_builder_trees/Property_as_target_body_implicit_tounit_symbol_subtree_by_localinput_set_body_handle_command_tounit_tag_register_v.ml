(** {3 Property_as_target_body_implicit_tounit_symbol_subtree_by_localinput_set_body_handle_command_tounit_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BPRO:Property_as_target_body_implicit_tounit_symbol_subtree_by_localinput_set_body_handle_command_tounit_tag_register_v";
   "Author : François Colonna 06 mars 2017 at 11:13:17+01:00";
 ]
;;
...
let register : 
    (Localinput_set_body_handle_command_tounit_tag_t.localinput_set_body_handle_command_tounit_tag,
...
let name_of_key key =
  Localinput_set_body_handle_command_tounit_tag_v.name key
;;
