(** {3 Property_as_context_inputbox_tag_by_basicname_inputbox_n_basicname_inputbase_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BPRO:Property_as_context_inputbox_tag_by_basicname_inputbox_n_basicname_inputbase_provider_v";
   ...
   "Author : François Colonna 06 avril 2017 at 15:00:03+02:00";
 ]
;;
...
let build (bna_ibo, bna_iba) =
  ...
  let sym_pro_ibo = 
    Property_symbol_v.property_context_inputbox_constructor 
      nam_ibo
  in
  Tag_v.make sym_pro_ibo soi_ibo
;;
...
(* done with do_provider_without_register.sh Property_as_context_inputbox_tag_by_basicname_inputbox_n_basicname_inputbase_provider_v.ml force on mardi 15 novembre 2016, 16:37:10 (UTC+0100) *)
