(** {3 Property_context_inputbase_tag_by_basicname_inputbase_provider_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BPRO:Property_context_inputbase_tag_by_basicname_inputbase_provider_v";
...
(* done with do_provider_without_register.sh Property_context_inputbase_tag_by_basicname_inputbase_provider_v.ml force on mardi 15 novembre 2016, 16:37:12 (UTC+0100) *)
