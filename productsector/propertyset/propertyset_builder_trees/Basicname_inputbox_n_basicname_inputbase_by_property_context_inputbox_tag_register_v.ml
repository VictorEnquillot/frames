(** {3 Basicname_inputbox_n_basicname_inputbase_by_property_context_inputbox_tag_register_v} *)

(** {6 Documenting} *)

let documentation () = 
  [
   "Current : BPRO:Basicname_inputbox_n_basicname_inputbase_by_property_context_inputbox_tag_register_v";
   "Author : François Colonna 04 avril 2017 at 09:58:37+02:00";
 ]
;;
...
let register : 
    (
     Property_context_inputbox_tag_t.property_context_inputbox_tag,
...
let name_of_key key =
  Property_context_inputbox_tag_v.fullname key
;;
