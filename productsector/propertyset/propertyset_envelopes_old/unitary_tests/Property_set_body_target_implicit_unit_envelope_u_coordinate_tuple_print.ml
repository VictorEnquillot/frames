...
(* toplevel 
   #use "Property_set_body_target_implicit_unit_envelope_u_coordinate_tuple_print.ml";; 
...
open Property_set_body_target_implicit_unit_value_v;;

(* Argument tag_tiu "Ctc_a" *)

let pre_tag_tiu_sof sof (s, i) = (Property_symbol_v.property_target_implicit_unit_constructor sof = s);;

let nam_ivn_tiu = "Ctc_a";;
...
let tag_tiu = Property_set_body_target_implicit_unit_tag_v.property_target_implicit_unit_tag_off_property_tag tag_pro_tiu;;
...
(* Property_operator Print "Ctc_a" *)

let tag_pro_opu = Property_set_body_target_implicit_unit_container_v.property_as_operator_tounit_tag tag_tiu;;
...
(* Property_set_body_operand_external "Ctc_a" *)

let tag_pro_opd = 
    Property_set_body_target_implicit_unit_container_v.property_as_operand_tag 
      tag_tiu ;;
...
(* let property_operand_external_value_of_operand_string_off "Ctc_a" *)
...
test_number 8 (
(mak_arg : string ) = 
"elementary_coordinate_tuple_cartesian_constructor"
);;
