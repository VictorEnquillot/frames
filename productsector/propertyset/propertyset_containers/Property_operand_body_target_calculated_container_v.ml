(** {3 Property_operand_body_target_calculated_container_v} *)

(** {6 Documenting_for_container} *)

let documentation () = 
  [
   "Current : FPRO:Property_operand_body_target_calculated_container_v";
   "Needs : FPRO:Property_operator_fence_creation_tobasic_tag_v";
   ...
   "What-is-it : it is a Body Bud container of Border sub-Types and thus a Doublet of (Property_operator_fence_creation_tobasic_tag, Property_operand_tag)";
...
let property_operator_fence_creation_tobasic_tag_of_tag tag_ptc =
...
(* generated by ./do_container_as_doublet_body_bud_2containee_v.sh property_operand_body_target_calculated ptc property_operator_fence_creation_tobasic pct property_operand pop *)
