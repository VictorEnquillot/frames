(** {3 Property_operator_fence_creation_toentity_container_v} *)

(** {6 Documenting_for_container} *)

let documentation () = 
  [
   "Current : FPRO:Property_operator_fence_creation_toentity_container_v";
   ...
   "Containee_tag : Property_operator_fence_creation_toentity_tag";
   ...
   "What-is-it: it is a container of a Fence Bud Type as a Uno of Property_operator_fence_creation_toentity_tag (i.e. Property_operator_fence_creation_toentity_tag)";
 ]
;;
...
(* generated by ./do_container_as_uno_fence_bud_0containee_v.sh property_operator_fence_creation_toentity pct *)
