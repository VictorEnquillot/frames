...
let documentation () = 
  [
   ...
   "What-is-it : it is a Trunc container of Border sub-Types and thus a Tuple of its Conee_up_1 Tag";
...
let containee_up_tag_off_builder_tag tag_mmm =
  Tag_v.map_entity
    Maint_symbol_v.conee_up_1_symbol_off_maint_symbol
    tag_mmm
;;

(** {9 Coercing Up Containee_up to Builder} *)

let builder_tag_of_containee_up_tag tag_cnn_up_1 =
  Tag_v.map_entity 
    Maint_symbol_v.maint_symbol_of_conee_up_1_symbol
    tag_cnn_up_1
;;
