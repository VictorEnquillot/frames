...
Register_v.delete  Input_tag_tree_by_input_as_root_tag_register_v.register;;
...
(* toplevel 
   #use "Property_target_implicit_unit_container_u_elementary_body_parameter_tuple_aopef_hes11_print_debug.ml";; 

*)

(* Input File *)

let nof_inp = "Elementary_body_parameter_tuple_aopef_hes11_print.inp";;
...
test_number 6 (
(con_tiu :
  (Property_operator_tounit_symbol_t.property_operator_tounit_symbol
