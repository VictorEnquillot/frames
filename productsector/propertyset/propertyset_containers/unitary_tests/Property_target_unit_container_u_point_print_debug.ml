...
(* toplevel 
   #use "Property_target_unit_container_u_point_print_debug.ml";; 
...
( tag_ptu :
  ...
  (Property_target_unit_symbol_t.Property_target_unit_constructor "Poi_a",
   [1; 29; 13])
);;
...
(tag_ope : Operator_symbol_t.operator_symbol Tag_t.tag ) =
  (Operator_symbol_t.Operator_body_symbol
    (Operator_body_symbol_t.Operator_tounit_symbol
      (Operator_tounit_symbol_t.Operator_print "Poi_a")),
   [1; 29; 12])
);; 
