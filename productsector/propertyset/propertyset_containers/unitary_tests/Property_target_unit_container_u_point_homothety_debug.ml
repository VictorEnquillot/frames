...
(* toplevel 
   #use "Property_target_unit_container_u_point_homothety_debug.ml";; 
         ...
         ((Property_symbol_t.Property_body_symbol
            (Property_body_symbol_t.Property_target_symbol
              (Property_target_symbol_t.Property_operand_target_created_symbol
                (Property_operand_target_created_symbol_t.Property_operand_target_created_figure_tag
                  "Poi_h"))),
           [2; 1; 27; 13]),
         [Tree_t.Leaf
           (Property_symbol_t.Property_fence_symbol
...
test_number 4 (
(tag_ptu : Property_target_unit_symbol_t.property_target_unit_symbol Tag_t.tag ) =
  (Property_target_unit_symbol_t.Property_target_unit_constructor "Poi_h",
   [1; 27; 13])
);;
...
let tag_pro_bui_l =
  Tree_v.topson_node_list_of_topson_node_predicate_off_tree
    (fun (s, i) -> 
...
let sym_pro_ope = List_v.only_element_of_predicate_off_list 
    Property_symbol_v.is_property_operator_tounit 
    sym_pro_bui_l;;
...
(tag_ope : Operator_symbol_t.operator_symbol Tag_t.tag ) =
  (Operator_symbol_t.Operator_body_symbol
    (Operator_body_symbol_t.Operator_tounit_symbol
      (Operator_tounit_symbol_t.Operator_print "Poi_h")),
   [1; 27; 12])
);; 
...
let tag_pro_opd = List_v.only_element_of_predicate_off_list 
    (fun (s, i) -> Property_symbol_v.is_property_target_created_figure_tag s) 
    tag_pro_bui_l;;
