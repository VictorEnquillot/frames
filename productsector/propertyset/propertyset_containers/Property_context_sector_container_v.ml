(** {3 Property_context_sector_container_v} *)

(** {6 Documenting_for_container} *)

let documentation () = 
  [
   "Current : FPRO:Property_context_sector_container_v";
   ...
   "Containee_tag : Property_context_domain_tag";
   ...
   "What-is-it : it is a container of a Bud Type as a List of Property_context_domain_tag";
...
let name con_pcs =
  List_v.name 
    Property_context_domain_tag_v.name
    con_pcs
;;
...
let longname con_pcs =
  List_v.name 
    Property_context_domain_tag_v.longname
    con_pcs
;;

let fullname con_pcs =
  List_v.name 
    Property_context_domain_tag_v.fullname
    con_pcs
;;

(** {6 Coercing Up Tag} *)

let coerce_up_of_tag tag_pcs =
  Tag_v.map_entity 
...
let building_of_tag tag_pcs =
  let tag_pro = coerce_up_of_tag tag_pcs in
...
let builder_tag_list_of_tag tag_pcs =
  building_of_tag tag_pcs
;;

let builder_tag_tuple_of_tag tag_pcs =
  let tag_bui_l = builder_tag_list_of_tag tag_pcs in
...
let container_of_tag tag_pcs =
  let bug = building_of_tag tag_pcs in
...
let containee_tag_list_of_tag tag_pcs =
  container_of_tag tag_pcs
;;

let containee_tag_tuple tag_pcs =
  let tag_cne_l = containee_tag_list_of_tag tag_pcs in
...
let fence_as_tuple_of_tag tag_pcs =
  let tag_cne_t = containee_tag_tuple tag_pcs in
  Tuple_v.map
    Property_context_domain_container_v.fence_as_list_of_tag
    tag_cne_t
;;
...
let fence_as_tuple_list_of_tag tag_pcs =
  let tag_cne_l = containee_tag_list_of_tag tag_pcs in
  List_v.map
    Property_context_domain_container_v.fence_as_tuple_of_tag
    tag_cne_l
;;


(* generated by ./do_container_as_list_context_bud_1containee_v.sh property_context_sector pcs property_context_domain pcd *)
